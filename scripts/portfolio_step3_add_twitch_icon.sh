...
cp "$FILE" "$FILE.bak_step3_twitch_$TS"
echo "✅ Backup created: $FILE.bak_step3_twitch_$TS"
...
echo "✅ Twitch icon added to Portfolio."
echo "🛑 STOP NOW."
echo "➡️  Run: npx expo start --tunnel"
echo "➡️  Sanity check:"
echo "    - Twitch icon visible top-right"
echo "    - Tap navigates to Twitch overview"
echo "    - No Twitch banner on Portfolio"
