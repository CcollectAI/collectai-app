...
export default function ItemsScreen() {
        ...
        >
          <View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              ...
              >
                <Text style={{ fontSize: 10, color: "#c26b00" }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#e6f7fb" }}>
      ...
      >
        {/* Header with title + share and download */}
        <View
          style={{
            flexDirection: "row",
            justifyContent: "space-between",
...
echo "Items tab updated with spacing, euro formatting, badges, share, and refined layout."
