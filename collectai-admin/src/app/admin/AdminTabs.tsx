...
// Spend Monitor
import { AdminSpendMonitor } from "@/components/AdminSpendMonitor";

// Content Machine
import { AdminContentMachine } from "@/components/AdminContentMachine";
...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "content-machine", label: "Content Machine", moduleKey: "contentMachine",
