"""
Tests for pipelines/firecrawl_events.py — event page crawler.
"""
...
class TestExtractEventsFromMarkdown:
    ...
    def test_extracts_events_from_headers(self):
        from pipelines.firecrawl_events import _extract_events_from_markdown
...
"""
    ...
    def test_limits_to_20_events(self):
        ...
        # Build markdown with many headers and dates
        lines = []
        for i in range(30):
...
"""
        ...
        # Should dedup by normalized title
...
class TestEventPageTargets:
    ...
    def test_has_pokemon_target(self):
        from pipelines.firecrawl_events import EVENT_PAGE_TARGETS
...
class TestCrawlEventPages:
    ...
    async def test_returns_empty_when_not_configured(self):
        from pipelines.firecrawl_events import _crawl_event_pages
...
""",
    ...
    async def test_deduplicates_events(self):
        ...
        # Both sources return same event
        mock_scrape = AsyncMock(return_value={
            "markdown": """
## Pokemon Regional Championship 2026
September 10, 2026
...
class TestBuildParser:
    ...
    def test_default_args(self):
        from pipelines.firecrawl_events import _build_parser
