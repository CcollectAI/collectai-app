...
curl -sS \
  "https://${SUPA_REF}.supabase.co/rest/v1/training_items?session_uuid=eq.${SUUID}&select=session_uuid,category,raw_title,raw_condition,raw_price_eur,corrected_title,corrected_condition,corrected_price_eur,created_at,updated_at" \
