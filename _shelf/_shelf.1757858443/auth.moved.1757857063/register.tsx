...
export default function Register() {
  ...
  async function onSignUp() {
    try {
      ...
      Alert.alert("Check email", "A confirmation link was sent.");
    } catch (e:any) {
  ...
  return (
    <View style={{ flex:1, backgroundColor: theme.colors.bg, padding: 16, justifyContent:"center" }}>
      <Text style={{ fontSize: 22, fontWeight:"800", marginBottom: 12 }}>Create account</Text>
      ...
      <TouchableOpacity onPress={onSignUp} style={{ marginTop: 14, backgroundColor: theme.colors.brand.base, height: 48, borderRadius:14, alignItems:"center", justifyContent:"center" }}>
        <Text style={{ color:"#0F172A", fontWeight:"800" }}>Create account</Text>
      </TouchableOpacity>
    </View>
  );
}
