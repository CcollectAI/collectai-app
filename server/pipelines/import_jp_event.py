...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ── Gundam Base Tokyo Exclusives ──────────────────────────────────
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "RX-78-2 Gundam Ver. 3.0 Clear Color (Gundam Base Tokyo LE)", "high", 120),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "RG Nu Gundam Titanium Finish (Gundam Base Exclusive)", "high", 140),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MG Freedom Gundam 2.0 Clear Color (Gundam Base Tokyo)", "high", 130),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "PG Unicorn Gundam LED Unit (Gundam Base Limited)", "grail", 350),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "HG 1/144 Gundam Aerial Permet Score Six (GB LE)", "high", 100),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MG Sazabi Ver.Ka Clear Color (Gundam Base Tokyo)", "grail", 200),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MGEX Strike Freedom Gundam Titanium Finish (GB)", "grail", 280),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "RG God Gundam Clear Color (Gundam Base Tokyo 2024)", "high", 110),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "HG The Origin Char's Zaku II Metallic (GB LE)", "high", 90),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Goods", "Gundam Base Tokyo 7th Anniversary Acrylic Stand Set", "mid", 45),
        ("Gundam Base Fukuoka", "Gundam", "Exclusive Gunpla", "MG Barbatos Lupus Rex Clear Color (GB Fukuoka)", "high", 130),
        ("Gundam Base Fukuoka", "Gundam", "Exclusive Gunpla", "RG Wing Gundam Zero EW Pearl Coat (GB Fukuoka LE)", "high", 120),
        ("Gundam Base Shanghai", "Gundam", "Exclusive Gunpla", "PG Strike Freedom Extra Finish (GB Shanghai)", "grail", 300),

        # ── Themed Cafe Items — Jujutsu Kaisen Cafe ──────────────────────
        ("Ufotable Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Ufotable Cafe Gojo Infinity Acrylic Stand", "mid", 35),
        ("Ufotable Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Ufotable Cafe Domain Expansion Coaster Set (8pc)", "mid", 30),
        ("Ufotable Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Ufotable Cafe Clear File Set (Shibuya Arc)", "mid", 25),
        ("Ufotable Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Cafe Sukuna Art Plate (Cafe LE)", "mid", 40),
        ("Ufotable Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Cafe Gojo & Geto Pair Mug Set", "mid", 38),

        # ── Themed Cafe Items — One Piece Cafe ───────────────────────────
        ("One Piece Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Cafe Luffy Gear 5 Acrylic Stand (LE)", "mid", 45),
        ("One Piece Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Cafe Straw Hat Crew Coaster Set (10pc)", "mid", 35),
        ("One Piece Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Tower Memorial Clear File Set", "mid", 30),
        ("One Piece Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Baratie Restaurant Plate Replica", "high", 80),
        ("One Piece Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Cafe Shanks & Luffy Sake Cup Set (LE)", "high", 65),

        # ── Themed Cafe Items — Demon Slayer Cafe ────────────────────────
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive Goods", "Demon Slayer Ufotable Cafe Rengoku Flame Acrylic Stand", "mid", 40),
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive Goods", "Demon Slayer Ufotable Cafe Hashira Coaster Set (9pc)", "mid", 35),
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive Goods", "Demon Slayer Cafe Tanjiro Art Plate (Hinokami Kagura LE)", "mid", 42),
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive Goods", "Demon Slayer Cafe Nezuko Sleeping Mug", "mid", 30),
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive Goods", "Demon Slayer Ufotable Cafe Infinity Castle Clear File Set", "mid", 28),

        # ── Specific Event-Exclusive Items with Years/Details ─────────────
        ("WonFes", "Fate/Grand Order", "Garage Kit", "Ishtar 1/7 GK (WonFes Summer 2024, Unpainted, 30pcs)", "grail", 380),
        ("WonFes", "Chainsaw Man", "Garage Kit", "Makima 1/8 GK (WonFes Winter 2024, Painted, 20pcs)", "grail", 450),
        ("WonFes", "Jujutsu Kaisen", "Exclusive Figure", "Gojo Hollow Purple WonFes 2024 Summer Exclusive", "high", 200),
        ("WonFes", "Frieren", "Exclusive Figure", "Frieren WonFes 2025 Winter Exclusive Nendoroid (Metallic)", "high", 130),
        ("Comiket", "Hololive", "Tapestry", "Hololive Comiket 104 Exclusive Full-Cast B2 Tapestry", "mid", 50),
        ("Comiket", "Frieren", "Doujinshi Set", "Frieren C104 Popular Circle Doujinshi Bundle (5)", "mid", 45),
        ("Comiket", "Blue Archive", "Tapestry", "Blue Archive Comiket 104 Exclusive B2 Tapestry Set", "mid", 42),
        ("Jump Festa", "Dragon Ball", "Exclusive Figure", "Dragon Ball Super Hero Gohan Beast Jump Festa 2025 LE", "high", 150),
        ("Jump Festa", "One Piece", "Exclusive Figure", "One Piece Gear 5 Luffy Jump Festa 2025 LE Figure", "high", 160),
        ("Jump Festa", "Chainsaw Man", "Exclusive Goods", "Chainsaw Man Jump Festa 2025 Pochita Plush (LE 500)", "high", 120),
        ("Tamashii Nations", "Dragon Ball Z", "Exclusive Figure", "S.H.Figuarts Super Saiyan God Vegeta (Tamashii 2024 LE)", "high", 130),
        ("Tamashii Nations", "One Piece", "Exclusive Figure", "Figuarts ZERO Kaido Dragon Form (Tamashii 2024 LE)", "high", 180),
        ("TGS", "Persona", "Exclusive Goods", "Persona 3 Reload TGS 2024 Exclusive Poster + Clear File Set", "mid", 35),
        ("TGS", "Final Fantasy", "Exclusive Goods", "FF7 Rebirth TGS 2024 Exclusive Cloud Acrylic Stand", "mid", 40),
        ("AnimeJapan", "Frieren", "Exclusive Goods", "Frieren AnimeJapan 2025 Exclusive Acrylic Diorama", "mid", 50),
        ("AnimeJapan", "Solo Leveling", "Exclusive Figure", "Solo Leveling Sung Jinwoo AnimeJapan 2025 Exclusive Mini Fig", "mid", 55),
        ("AnimeJapan", "Dandadan", "Exclusive Goods", "Dandadan AnimeJapan 2025 Exclusive Okarun Acrylic Stand", "mid", 40),

        # ── Sweets Paradise / Animate Cafe — Additional ──────────────────
        ("Sweets Paradise", "Haikyuu!!", "Cafe Exclusive Goods", "Haikyuu!! Sweets Paradise Coaster Set (Karasuno Team)", "standard", 20),
        ("Sweets Paradise", "My Hero Academia", "Cafe Exclusive Goods", "MHA Sweets Paradise Clear File Set (Class 1-A)", "standard", 18),
        ("Animate Cafe", "Blue Lock", "Cafe Exclusive Goods", "Blue Lock Animate Cafe Isagi Acrylic Stand (Cafe LE)", "mid", 30),
        ("Animate Cafe", "Oshi no Ko", "Cafe Exclusive Goods", "Oshi no Ko Animate Cafe B-Komachi Coaster Set (5pc)", "mid", 28),
        ("Square Enix Cafe", "Final Fantasy XIV", "Cafe Exclusive Goods", "FFXIV Square Enix Cafe Moogle Mug (Cafe Exclusive)", "mid", 35),
        ("Capcom Cafe", "Monster Hunter", "Cafe Exclusive Goods", "Monster Hunter Capcom Cafe Palico Plate Set (4pc)", "mid", 40),

        # ── More Gundam Base Exclusives ───────────────────────────────────
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "RG Strike Gundam Perfect Strike (GB Tokyo LE)", "high", 100),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MG Barbatos Lupus Clear Color (GB Tokyo 2025)", "high", 120),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "HG Zaku II Char Custom Metallic (GB Tokyo)", "mid", 60),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "PG Gundam Exia Lighting Model (GB Tokyo LE)", "grail", 400),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MG Wing Gundam Ver.Ka Clear Color (GB Tokyo)", "high", 130),
        ("Gundam Base Seoul", "Gundam", "Exclusive Gunpla", "RG Gundam Epyon Titanium Finish (GB Seoul LE)", "high", 110),
        ("Gundam Base Seoul", "Gundam", "Exclusive Gunpla", "MG Tallgeese Pearl Coat (GB Seoul LE)", "high", 120),

        # ── More Themed Cafe Items ────────────────────────────────────────
        ("Ufotable Cafe", "Fate/Grand Order", "Cafe Exclusive Goods", "FGO Ufotable Cafe Gilgamesh Art Plate (LE)", "mid", 45),
        ("Ufotable Cafe", "Fate/Grand Order", "Cafe Exclusive Goods", "FGO Ufotable Cafe Saber Artoria Clear File Set", "mid", 28),
        ("Square Enix Cafe", "Final Fantasy VII", "Cafe Exclusive Goods", "FF7 Remake Square Enix Cafe Cloud Acrylic Stand", "mid", 35),
        ("Square Enix Cafe", "NieR Automata", "Cafe Exclusive Goods", "NieR Automata Square Enix Cafe 2B Plate (LE)", "mid", 45),
        ("Animate Cafe", "Jujutsu Kaisen", "Cafe Exclusive Goods", "JJK Animate Cafe Shibuya Arc Coaster Set (12pc)", "mid", 32),
        ("Animate Cafe", "Haikyuu!!", "Cafe Exclusive Goods", "Haikyuu!! Animate Cafe Acrylic Stand Set (Karasuno)", "mid", 35),
        ("Tower Records Cafe", "One Piece", "Cafe Exclusive Goods", "One Piece Tower Records Cafe Coaster Set (Straw Hats)", "mid", 28),
        ("Tower Records Cafe", "Chainsaw Man", "Cafe Exclusive Goods", "Chainsaw Man Tower Records Cafe Pochita Mug", "mid", 30),
        ("Sweets Paradise", "Spy x Family", "Cafe Exclusive Goods", "Spy x Family Sweets Paradise Anya Clear File Set", "standard", 18),
        ("Sweets Paradise", "Oshi no Ko", "Cafe Exclusive Goods", "Oshi no Ko Sweets Paradise Ai Coaster Set", "standard", 20),

        # ── More Event-Exclusive Items ────────────────────────────────────
        ("Comiket", "Chainsaw Man", "Tapestry", "Chainsaw Man C105 Exclusive Makima B2 Tapestry", "mid", 48),
        ("Comiket", "Solo Leveling", "Doujinshi Set", "Solo Leveling C105 Art Doujinshi Bundle", "mid", 38),
        ("Comiket", "Dandadan", "Tapestry", "Dandadan C105 Exclusive Momo B2 Tapestry", "mid", 42),
        ("Comiket", "Kaiju No. 8", "Acrylic Stand", "Kaiju No. 8 C105 Exclusive Acrylic Set", "mid", 35),
        ("WonFes", "Solo Leveling", "Garage Kit", "Sung Jinwoo Shadow Monarch 1/8 GK (WonFes 2025)", "grail", 380),
        ("WonFes", "Blue Lock", "Exclusive Figure", "Isagi Yoichi WonFes 2025 Summer Exclusive", "high", 150),
        ("Treasure Festa", "Fate/Grand Order", "Garage Kit", "Scathach 1/7 GK (Treasure Festa 2024)", "grail", 320),
        ("Treasure Festa", "Evangelion", "Garage Kit", "Asuka Langley 1/8 GK (Treasure Festa 2024, 15pcs)", "grail", 400),
        ("Niconico Chokaigi", "Vocaloid", "Exclusive Goods", "Hatsune Miku Niconico Chokaigi 2025 Exclusive Acrylic Set", "mid", 45),
        ("Niconico Chokaigi", "Various", "Badge Set", "Niconico Chokaigi 2025 VTuber Badge Collection (20pc)", "mid", 30),
        ("Sakura-Con", "Frieren", "Exclusive Goods", "Frieren Sakura-Con 2025 Exclusive Art Print (Signed)", "high", 100),
        ("Otakon", "Demon Slayer", "Exclusive Goods", "Demon Slayer Otakon 2025 Hashira Art Print Set", "mid", 55),
        ("AGF", "Haikyuu!!", "Exclusive Goods", "Haikyuu!! AGF 2024 Exclusive Acrylic Stand Pair (Hinata & Kageyama)", "mid", 40),
        ("AGF", "Blue Lock", "Exclusive Goods", "Blue Lock AGF 2024 Exclusive Character Badge Set (12pc)", "mid", 35),

        # ── Exhibition Events ─────────────────────────────────────────────
        ("Evangelion Exhibition", "Evangelion", "Exhibition Goods", "Evangelion 3.0+1.0 Exhibition 2024 Venue Art Print Set", "high", 120),
        ("Evangelion Exhibition", "Evangelion", "Exhibition Goods", "Evangelion Exhibition Unit-01 LED Acrylic Panel", "high", 150),
        ("Ghibli Exhibition", "Studio Ghibli", "Exhibition Goods", "Ghibli Grand Exhibition 2025 Totoro Venue Plush (LE)", "high", 100),
        ("Ghibli Exhibition", "Studio Ghibli", "Exhibition Goods", "Ghibli Exhibition Spirited Away Art Print Set (6pc)", "high", 80),
        ("Kyoto Animation Event", "Violet Evergarden", "Exhibition Goods", "Violet Evergarden KyoAni Exhibition Art Print (Signed)", "grail", 200),
        ("Kyoto Animation Event", "K-On!", "Exhibition Goods", "K-On! 15th Anniversary KyoAni Exhibition Goods Set", "high", 80),

        # ── Extra items for 1020+ ─────────────────────────────────────────
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "RG 1/144 Wing Gundam Zero Custom Clear Color (GB Tokyo 2025)", "high", 110),
        ("Gundam Base Tokyo", "Gundam", "Exclusive Gunpla", "MG 1/100 Zaku II Dozle Custom (GB Tokyo LE)", "high", 130),
        ("Gundam Base Seoul", "Gundam", "Exclusive Gunpla", "HG 1/144 Gundam Aerial Rebuild Clear Color (GB Seoul)", "mid", 65),
        ("Comiket", "Genshin Impact", "Tapestry", "Genshin Impact C105 Furina B2 Tapestry", "mid", 45),
        ("Comiket", "Honkai Star Rail", "Acrylic Stand", "Honkai Star Rail C105 Firefly Acrylic Stand", "mid", 35),
        ("Comiket", "Fate/Grand Order", "Doujinshi Set", "FGO C105 Top Circle Doujinshi Bundle (5)", "mid", 42),
        ("WonFes", "Gundam", "Garage Kit", "RX-93 Nu Gundam 1/100 Full Resin GK (WonFes 2025)", "grail", 500),
        ("WonFes", "Hololive", "Exclusive Figure", "Gawr Gura WonFes 2025 Exclusive Painted GK", "high", 200),
        ("AnimeJapan", "Blue Lock", "Exclusive Goods", "Blue Lock AnimeJapan 2025 Isagi Acrylic Diorama", "mid", 45),
        ("AnimeJapan", "Kaiju No. 8", "Exclusive Figure", "Kaiju No. 8 AnimeJapan 2025 Exclusive Mini Figure", "mid", 50),
        ("TGS", "Monster Hunter Wilds", "Exclusive Goods", "MH Wilds TGS 2024 Exclusive Palico Plush (LE)", "mid", 55),
        ("TGS", "Elden Ring", "Exclusive Goods", "Elden Ring DLC TGS 2024 Miquella Acrylic Stand", "mid", 40),
        ("Jump Festa", "My Hero Academia", "Exclusive Figure", "MHA Final Jump Festa 2025 Deku LE Figure", "high", 140),
        ("Jump Festa", "Blue Lock", "Exclusive Goods", "Blue Lock Jump Festa 2025 Bachira Signed Art Print (100 copies)", "high", 180),
        ("Tamashii Nations", "Evangelion", "Exclusive Figure", "Robot Spirits EVA Unit-01 Tamashii 2025 Event Color", "high", 150),
        ("Tamashii Nations", "Gundam", "Exclusive Figure", "Metal Build Strike Freedom Tamashii 2025 LE", "grail", 300),
        ("Pokemon Center Event", "Pokemon", "Exclusive Plush", "Pikachu Pokemon Center Tokyo DX Opening LE Plush", "mid", 65),
        ("Pokemon Center Event", "Pokemon", "Exclusive Card", "Charizard Pokemon Center 25th Anniversary Promo (LE)", "high", 150),
        ("Ichiban Kuji", "Frieren", "Prize Figure", "Frieren Ichiban Kuji Last One Prize Frieren Casting", "high", 130),
        ("Ichiban Kuji", "Solo Leveling", "Prize Figure", "Solo Leveling Ichiban Kuji A Prize Sung Jinwoo", "mid", 70),
        ("Ichiban Kuji", "Blue Lock", "Prize Figure", "Blue Lock Ichiban Kuji Last One Prize Isagi Zone", "high", 110),
    ]
    ...
    # Expansion Round 9 — 200 items across Anime Expo, Comiket, Jump Festa, WonFes, etc.
    catalog.extend(_expanded_round9_jp_events())
...
def _expanded_round9_jp_events() -> list[dict]:
    """200 new JP event exclusives: Anime Expo, Comiket deep, Jump Festa,
    WonFes, AnimeJapan, game shows, museum exhibitions, concert exclusives,
    pop-up stores, regional festival items."""
    items = [
        # ── Anime Expo Exclusives (+20) ──
        ("Anime Expo", "Demon Slayer", "Exclusive Figure", "Demon Slayer AX2024 Tanjiro & Nezuko Exclusive Figure Set", "high", 150),
        ("Anime Expo", "Jujutsu Kaisen", "Exclusive Print", "Jujutsu Kaisen AX2024 Gojo Satoru Ltd Art Print (Signed)", "high", 120),
        ("Anime Expo", "My Hero Academia", "Exclusive Figure", "MHA AX2024 Deku Full Cowling Exclusive Nendoroid", "high", 95),
        ("Anime Expo", "One Piece", "Exclusive Print", "One Piece AX2024 Gear 5 Luffy A2 Art Print (Numbered)", "high", 100),
        ("Anime Expo", "Dragon Ball", "Exclusive Figure", "Dragon Ball AX2024 Goku Ultra Instinct Mini Figure", "mid", 65),
        ("Anime Expo", "Spy x Family", "Exclusive Goods", "Spy x Family AX2024 Anya Forger Exclusive Plush (30cm)", "mid", 55),
        ("Anime Expo", "Chainsaw Man", "Exclusive Print", "Chainsaw Man AX2024 Makima A2 Art Print (Ltd 300)", "high", 110),
        ("Anime Expo", "Attack on Titan", "Exclusive Goods", "AoT AX2023 Final Season Memorial Acrylic Stand Set", "high", 85),
        ("Anime Expo", "Bocchi the Rock!", "Exclusive Goods", "Bocchi the Rock! AX2024 Gotoh Hitori Exclusive Tapestry", "mid", 50),
        ("Anime Expo", "Frieren", "Exclusive Figure", "Frieren AX2024 Beyond Journey's End Exclusive Mini Figure", "high", 90),
        ("Anime Expo", "Blue Lock", "Exclusive Print", "Blue Lock AX2024 Isagi A2 Art Print (Numbered)", "mid", 75),
        ("Anime Expo", "Vinland Saga", "Exclusive Goods", "Vinland Saga AX2024 Thorfinn Memorial Acrylic Stand", "mid", 60),
        ("Anime Expo", "Aniplex", "Exclusive Figure", "Aniplex Booth AX2024 Exclusive Nendoroid Mystery Box", "high", 120),
        ("Anime Expo", "Crunchyroll", "Exclusive Goods", "Crunchyroll AX2024 Exclusive Hime Merch Box Set", "mid", 65),
        ("Anime Expo", "Evangelion", "Exclusive Print", "Evangelion AX2024 NERV Anniversary A1 Art Print (Signed)", "high", 140),
        ("Anime Expo", "Gundam", "Exclusive Model", "Gundam AX2024 RX-78-2 Clear Color HG 1/144", "mid", 55),
        ("Anime Expo", "Made in Abyss", "Exclusive Goods", "Made in Abyss AX2024 Nanachi Exclusive Plush", "mid", 50),
        ("Anime Expo", "Oshi no Ko", "Exclusive Print", "Oshi no Ko AX2024 Ai Hoshino A2 Memorial Print", "high", 95),
        ("Anime Expo", "Mob Psycho 100", "Exclusive Goods", "Mob Psycho 100 AX2023 Mob Exclusive Acrylic Stand", "mid", 45),
        ("Anime Expo", "Ranking of Kings", "Exclusive Figure", "Ranking of Kings AX2024 Bojji Exclusive Mini Figure", "mid", 60),

        # ── Comiket Deep Catalog (+25) ──
        ("Comiket", "Touhou Project", "Doujinshi Bundle", "Touhou C104 Premium Circle Doujinshi Bundle (10pc)", "mid", 75),
        ("Comiket", "Fate/Grand Order", "Exclusive Tapestry", "FGO C104 Artoria Pendragon B1 Exclusive Tapestry", "high", 100),
        ("Comiket", "Genshin Impact", "Doujinshi Bundle", "Genshin Impact C105 Top Circle Bundle (8pc)", "mid", 65),
        ("Comiket", "Hololive", "Exclusive Goods", "Hololive C104 Pekora Exclusive Dakimakura Cover (Both Sides)", "high", 130),
        ("Comiket", "Blue Archive", "Exclusive Tapestry", "Blue Archive C105 Sensei's Office B2 Tapestry", "mid", 55),
        ("Comiket", "Oshi no Ko", "Doujinshi Bundle", "Oshi no Ko C105 Premium Circle Bundle (6pc)", "mid", 50),
        ("Comiket", "Original", "Artist Alley", "Comiket C104 Featured Artist Illustration Board Set (5pc)", "mid", 80),
        ("Comiket", "Vocaloid", "Exclusive Goods", "Hatsune Miku C104 Snow Miku Exclusive Acrylic Stand Set", "mid", 60),
        ("Comiket", "Corporate", "Gashapon Set", "Comiket C105 Corporate Booth Gashapon Complete Set (20pc)", "high", 100),
        ("Comiket", "Jujutsu Kaisen", "Exclusive Tapestry", "JJK C105 Gojo vs Sukuna B2 Tapestry (Corporate)", "mid", 65),
        ("Comiket", "Chainsaw Man", "Doujinshi Bundle", "CSM C105 Top Circle Doujinshi Bundle (8pc)", "mid", 55),
        ("Comiket", "Frieren", "Exclusive Tapestry", "Frieren C105 Party Journey B2 Tapestry", "mid", 50),
        ("Comiket", "Love Live!", "Exclusive Goods", "Love Live! C104 Liella! Exclusive Clear File Set (10pc)", "mid", 40),
        ("Comiket", "Bocchi the Rock!", "Doujinshi Bundle", "Bocchi the Rock! C105 Premium Circle Bundle (6pc)", "mid", 45),
        ("Comiket", "Azur Lane", "Exclusive Tapestry", "Azur Lane C104 Enterprise B1 Tapestry (Ltd 500)", "high", 110),
        ("Comiket", "Touhou Project", "Music CD Bundle", "Touhou C105 Doujin Music CD Mega Bundle (15pc)", "mid", 80),
        ("Comiket", "Type-Moon", "Exclusive Goods", "Type-Moon C104 Tsukihime Remake Exclusive Shikishi Set", "high", 90),
        ("Comiket", "NicoNico", "Exclusive Goods", "Comiket C105 NicoNico Booth Exclusive Merch Bundle", "mid", 45),
        ("Comiket", "Various", "Catalog", "Comiket C105 Official Catalog (DVD-ROM Edition)", "standard", 25),
        ("Comiket", "Various", "Corporate", "Comiket C105 Corporate Clear File Mega Set (30pc)", "high", 120),
        ("Comiket", "Spy x Family", "Exclusive Tapestry", "Spy x Family C105 Yor Forger B2 Tapestry", "mid", 55),
        ("Comiket", "Fate/Grand Order", "Doujinshi Bundle", "FGO C105 Premium Doujinshi Anthology Bundle (10pc)", "mid", 70),
        ("Comiket", "Kancolle", "Exclusive Tapestry", "Kancolle C104 Shimakaze 10th Anniv B1 Tapestry", "high", 95),
        ("Comiket", "Idolmaster", "Exclusive Goods", "iM@S C105 Shiny Colors Exclusive Bromide Set (20pc)", "mid", 55),
        ("Comiket", "Arknights", "Exclusive Tapestry", "Arknights C105 Amiya & Doctor B2 Tapestry", "mid", 50),

        # ── Jump Festa Exclusives (+20) ──
        ("Jump Festa", "One Piece", "Exclusive Figure", "One Piece Jump Festa 2025 Gear 5 Luffy Exclusive Figure", "high", 150),
        ("Jump Festa", "One Piece", "Exclusive Goods", "One Piece Jump Festa 2025 Straw Hat Crew A2 Art Board", "high", 100),
        ("Jump Festa", "Jujutsu Kaisen", "Exclusive Figure", "JJK Jump Festa 2025 Gojo Satoru Exclusive Mini Figure", "high", 120),
        ("Jump Festa", "Jujutsu Kaisen", "Exclusive Print", "JJK Jump Festa 2025 Shibuya Incident A2 Art Print", "mid", 75),
        ("Jump Festa", "My Hero Academia", "Exclusive Figure", "MHA Jump Festa 2025 Deku Final Battle Exclusive Figure", "high", 110),
        ("Jump Festa", "Dragon Ball", "Exclusive Figure", "Dragon Ball Super Jump Festa 2025 Gohan Beast Figure", "high", 130),
        ("Jump Festa", "Dragon Ball", "Exclusive Goods", "Dragon Ball Jump Festa 2025 Capsule Corp Mug Set", "mid", 45),
        ("Jump Festa", "Chainsaw Man", "Exclusive Print", "CSM Jump Festa 2025 Denji & Pochita Art Print (Ltd 500)", "high", 90),
        ("Jump Festa", "Spy x Family", "Exclusive Figure", "Spy x Family Jump Festa 2025 Anya Exclusive Nendoroid", "high", 100),
        ("Jump Festa", "Bleach TYBW", "Exclusive Figure", "Bleach Jump Festa 2025 Ichigo Bankai Exclusive Figure", "high", 120),
        ("Jump Festa", "Naruto", "Exclusive Goods", "Naruto Jump Festa 2025 20th Anniversary Art Board Set", "mid", 65),
        ("Jump Festa", "Demon Slayer", "Exclusive Print", "Demon Slayer Jump Festa 2025 Hashira Assembly A2 Print", "mid", 80),
        ("Jump Festa", "Undead Unluck", "Exclusive Goods", "Undead Unluck Jump Festa 2025 Exclusive Acrylic Stand Set", "mid", 50),
        ("Jump Festa", "Mashle", "Exclusive Goods", "Mashle Jump Festa 2025 Mash Exclusive Mini Figure", "mid", 55),
        ("Jump Festa", "Black Clover", "Exclusive Print", "Black Clover Jump Festa 2025 Asta Final Form Art Print", "mid", 60),
        ("Jump Festa", "Sakamoto Days", "Exclusive Goods", "Sakamoto Days Jump Festa 2025 Exclusive Acrylic Stand", "mid", 45),
        ("Jump Festa", "Kaiju No. 8", "Exclusive Figure", "Kaiju No.8 Jump Festa 2025 Kafka Exclusive Mini Figure", "mid", 65),
        ("Jump Festa", "Dandadan", "Exclusive Print", "Dandadan Jump Festa 2025 Okarun Art Print (Ltd 300)", "mid", 70),
        ("Jump Festa", "Various", "Exclusive Bundle", "Jump Festa 2025 Super Stage Premium Goods Bundle", "high", 180),
        ("Jump Festa", "Various", "Exclusive Goods", "Jump Festa 2025 Official Shopping Bag + Pin Set", "standard", 25),

        # ── Wonder Festival Exclusives (+20) ──
        ("WonFes", "Evangelion", "Garage Kit", "EVA Unit-01 Test Type 1/6 Resin GK (WonFes 2025W)", "grail", 400),
        ("WonFes", "Fate/Grand Order", "Garage Kit", "Jeanne d'Arc Alter 1/7 GK (WonFes 2025W Exclusive)", "grail", 380),
        ("WonFes", "Berserk", "Garage Kit", "Guts Berserker Armor 1/6 Resin GK (WonFes 2025W)", "grail", 500),
        ("WonFes", "Gundam", "Garage Kit", "Nu Gundam HWS 1/100 Resin Conversion GK (WonFes)", "grail", 420),
        ("WonFes", "Chainsaw Man", "Exclusive Figure", "Chainsaw Man WonFes 2025W Exclusive Nendoroid (Pochita)", "high", 100),
        ("WonFes", "Jujutsu Kaisen", "Exclusive Figure", "JJK Gojo WonFes 2025W Exclusive 1/7 Scale Prototype", "high", 250),
        ("WonFes", "Touhou Project", "Garage Kit", "Reimu Hakurei 1/7 Resin GK (WonFes 2025W)", "high", 280),
        ("WonFes", "Vocaloid", "Exclusive Figure", "Hatsune Miku WonFes 2025W Exclusive Scale Figure", "high", 160),
        ("WonFes", "Fate/Grand Order", "Painted Prototype", "Scathach-Skadi Painted Prototype Display (WonFes 2025W)", "high", 200),
        ("WonFes", "Original", "Sculptor Exclusive", "WonFes 2025W Grand Prize Sculptor's Original 1/6 GK", "grail", 600),
        ("WonFes", "Demon Slayer", "Garage Kit", "Rengoku Flame Hashira 1/6 GK (WonFes 2025S)", "grail", 350),
        ("WonFes", "Dragon Ball", "Garage Kit", "Vegeta SSJ Blue 1/6 Resin GK (WonFes 2025S)", "grail", 380),
        ("WonFes", "One Piece", "Garage Kit", "Kaido Dragon Form 1/8 Resin GK (WonFes 2025S)", "grail", 450),
        ("WonFes", "Spy x Family", "Exclusive Figure", "Spy x Family WonFes 2025S Yor Exclusive Figure", "high", 130),
        ("WonFes", "Frieren", "Exclusive Figure", "Frieren WonFes 2025S Exclusive 1/7 Prototype Display", "high", 180),
        ("WonFes", "Made in Abyss", "Garage Kit", "Nanachi 1/7 Resin GK (WonFes 2025S)", "high", 250),
        ("WonFes", "Attack on Titan", "Garage Kit", "Levi Ackerman 1/6 Resin GK (WonFes 2024W)", "grail", 380),
        ("WonFes", "Elden Ring", "Garage Kit", "Malenia Blade of Miquella 1/7 GK (WonFes 2025S)", "grail", 450),
        ("WonFes", "NieR Automata", "Garage Kit", "2B YoRHa No.2 Type B 1/6 Resin GK (WonFes)", "grail", 400),
        ("WonFes", "Bocchi the Rock!", "Exclusive Figure", "Bocchi the Rock! WonFes 2025S Gotoh Hitori Exclusive", "high", 110),

        # ── AnimeJapan Exclusives (+15) ──
        ("AnimeJapan", "Jujutsu Kaisen", "Exclusive Goods", "JJK AnimeJapan 2025 Exclusive Clear File Set (10pc)", "mid", 45),
        ("AnimeJapan", "Demon Slayer", "Exclusive Goods", "Demon Slayer AnimeJapan 2025 Hashira Acrylic Stand Set", "mid", 65),
        ("AnimeJapan", "Spy x Family", "Exclusive Goods", "Spy x Family AnimeJapan 2025 Forger Family Tapestry", "mid", 50),
        ("AnimeJapan", "Chainsaw Man", "Exclusive Goods", "CSM AnimeJapan 2025 Pochita Giant Plush (50cm)", "high", 90),
        ("AnimeJapan", "Frieren", "Exclusive Goods", "Frieren AnimeJapan 2025 Party B2 Tapestry", "mid", 48),
        ("AnimeJapan", "Blue Lock", "Exclusive Goods", "Blue Lock AnimeJapan 2025 Field Acrylic Diorama Set", "mid", 55),
        ("AnimeJapan", "Oshi no Ko", "Exclusive Goods", "Oshi no Ko AnimeJapan 2025 B-Komachi Stage Goods Set", "mid", 60),
        ("AnimeJapan", "Bocchi the Rock!", "Exclusive Goods", "Bocchi the Rock! AnimeJapan 2025 Band Acrylic Stand Set", "mid", 45),
        ("AnimeJapan", "Various", "Stage Goods", "AnimeJapan 2025 Main Stage Premium Seat Goods Bundle", "high", 120),
        ("AnimeJapan", "Evangelion", "Exclusive Goods", "Evangelion AnimeJapan 2025 NERV 30th Anniversary Set", "high", 100),
        ("AnimeJapan", "One Piece", "Exclusive Goods", "One Piece AnimeJapan 2025 Straw Hat Crew Clear File Set", "mid", 40),
        ("AnimeJapan", "Attack on Titan", "Exclusive Goods", "AoT AnimeJapan 2024 Final Memorial Acrylic Set", "mid", 55),
        ("AnimeJapan", "Vinland Saga", "Exclusive Goods", "Vinland Saga AnimeJapan 2025 Exclusive Art Board", "mid", 50),
        ("AnimeJapan", "Gundam", "Exclusive Model", "Gundam AnimeJapan 2025 Aerial Clear Color HG 1/144", "mid", 45),
        ("AnimeJapan", "Made in Abyss", "Exclusive Goods", "Made in Abyss AnimeJapan 2025 Abyss Map B2 Tapestry", "mid", 48),

        # ── Game Shows (+15) ──
        ("TGS", "Final Fantasy XVI", "Exclusive Goods", "FF16 TGS2024 Clive Exclusive Figure (Venue Only)", "high", 130),
        ("TGS", "Elden Ring", "Exclusive Goods", "Elden Ring TGS2024 Tarnished Exclusive Acrylic Stand", "mid", 55),
        ("TGS", "Monster Hunter", "Exclusive Goods", "MH Wilds TGS2024 Exclusive Hunter Figure Set", "high", 100),
        ("TGS", "Persona", "Exclusive Goods", "Persona 6 TGS2025 Exclusive Reveal Poster (A2)", "high", 90),
        ("TGS", "NieR", "Exclusive Goods", "NieR TGS2024 2B & 9S Exclusive Acrylic Diorama", "mid", 65),
        ("TGS", "Zelda", "Exclusive Goods", "Zelda TGS2024 Echoes of Wisdom Exclusive Pin Set", "mid", 45),
        ("TGS", "Various", "Exclusive Bundle", "TGS2024 Premium Business Day Goods Bundle", "high", 150),
        ("Gamescom", "Bandai Namco", "Exclusive Goods", "Gamescom 2024 Bandai Namco Exclusive Merch Box", "mid", 65),
        ("Gamescom", "Square Enix", "Exclusive Goods", "Gamescom 2024 Square Enix Exclusive Figure Blind Box Set", "mid", 75),
        ("PAX", "Various", "Exclusive Goods", "PAX West 2024 Indie Game Pin Collection (Complete Set)", "mid", 50),
        ("PAX", "Hollow Knight", "Exclusive Goods", "Hollow Knight Silksong PAX Demo Exclusive Art Print", "mid", 60),
        ("TGS", "Capcom", "Exclusive Goods", "Capcom TGS2024 Exclusive 40th Anniversary Merch Set", "high", 100),
        ("TGS", "Sonic", "Exclusive Goods", "Sonic x TGS2024 Exclusive Mini Figure Set (5pc)", "mid", 55),
        ("TGS", "Dragon Quest", "Exclusive Goods", "DQ XII TGS2025 Exclusive Reveal Merchandise Set", "high", 120),
        ("TGS", "Tekken", "Exclusive Goods", "Tekken 8 TGS2024 Exclusive Arcade Stick Decal Set", "mid", 40),

        # ── Museum Exhibitions (+15) ──
        ("Ghibli Museum", "Spirited Away", "Museum Exclusive", "Ghibli Museum Spirited Away Exclusive Cel Art Print", "high", 150),
        ("Ghibli Museum", "My Neighbor Totoro", "Museum Exclusive", "Ghibli Museum Totoro Exclusive Stained Glass Ornament", "high", 120),
        ("Ghibli Museum", "Castle in the Sky", "Museum Exclusive", "Ghibli Museum Laputa Robot Soldier Exclusive Figure", "high", 130),
        ("Ghibli Museum", "Various", "Museum Exclusive", "Ghibli Museum Exclusive Film Strip Bookmark Set (12pc)", "mid", 65),
        ("One Piece Tower", "One Piece", "Venue Exclusive", "One Piece Tower Closing Memorial Complete Goods Set (OOP)", "grail", 350),
        ("One Piece Tower", "One Piece", "Venue Exclusive", "One Piece Tower Exclusive Luffy Bronze Mini Statue", "high", 180),
        ("Evangelion Exhibition", "Evangelion", "Exhibition Exclusive", "EVA Exhibition 2024 Original Cel Reproduction Print (Numbered)", "high", 200),
        ("Evangelion Exhibition", "Evangelion", "Exhibition Exclusive", "EVA Exhibition 2024 NERV ID Card Replica Set", "mid", 55),
        ("JoJo Exhibition", "JoJo's Bizarre Adventure", "Exhibition Exclusive", "JoJo Exhibition Ripples of Adventure Exclusive Art Print", "high", 130),
        ("Berserk Exhibition", "Berserk", "Exhibition Exclusive", "Berserk Exhibition 2024 Kentaro Miura Reproduction Print", "grail", 300),
        ("Gundam Factory", "Gundam", "Venue Exclusive", "Gundam Factory Yokohama Exclusive 1/100 RX-78F00", "high", 180),
        ("Pokemon Center", "Pokemon", "Event Exclusive", "Pokemon Center Tokyo DX Grand Opening Exclusive Pikachu", "mid", 75),
        ("Dragon Ball Museum", "Dragon Ball", "Museum Exclusive", "Dragon Ball Museum Exclusive Shenron Diorama Figure", "high", 150),
        ("Naruto Exhibition", "Naruto", "Exhibition Exclusive", "Naruto 20th Anniversary Exhibition Exclusive Art Board Set", "high", 100),
        ("KyoAni Shop", "Violet Evergarden", "Shop Exclusive", "KyoAni Shop Violet Evergarden Movie Memorial Set", "high", 120),

        # ── Festival/Concert Exclusives (+20) ──
        ("Animelo Summer Live", "Various", "Concert Goods", "Animelo Summer Live 2024 Official T-Shirt", "mid", 45),
        ("Animelo Summer Live", "Various", "Concert Goods", "Animelo Summer Live 2024 Penlight", "mid", 38),
        ("Animelo Summer Live", "Various", "Concert Goods", "Animelo Summer Live 2024 Premium Seat Goods Set", "high", 90),
        ("Lisani Live", "Various", "Concert Goods", "LisAni! LIVE 2025 Official T-Shirt + Towel Set", "mid", 55),
        ("Lisani Live", "Various", "Concert Goods", "LisAni! LIVE 2025 Artist Collaboration Tapestry Set", "mid", 65),
        ("Anime Song Festival", "Various", "Concert Goods", "Lantis Matsuri 2024 Exclusive Penlight", "mid", 35),
        ("Anime Song Festival", "Various", "Concert Goods", "Anisong World Matsuri AX Edition Goods Set", "mid", 50),
        ("Voice Actor Event", "Hanazawa Kana", "Event Exclusive", "Hanazawa Kana Live 2024 Exclusive Photo Set + Goods", "mid", 55),
        ("Voice Actor Event", "Aoi Yuki", "Event Exclusive", "Aoi Yuki Birthday Event 2024 Exclusive Merch Set", "mid", 50),
        ("Voice Actor Event", "Uesaka Sumire", "Event Exclusive", "Uesaka Sumire Concert 2024 Exclusive Tapestry", "mid", 45),
        ("VTuber Concert", "Hololive", "Concert Goods", "Hololive Countdown Live 2024 Exclusive Penlight", "mid", 42),
        ("VTuber Concert", "Nijisanji", "Concert Goods", "Nijisanji New Year Live 2025 Exclusive Goods Set", "high", 80),
        ("Anime Film Premiere", "Fate/stay night HF", "Premiere Goods", "Fate HF III Premiere Exclusive Film Frame + Booklet", "high", 100),
        ("Anime Film Premiere", "Evangelion 3.0+1.0", "Premiere Goods", "Eva 3.0+1.0 Opening Day Exclusive Memorial Goods Set", "high", 120),
        ("Anime Film Premiere", "Demon Slayer Mugen Train", "Premiere Goods", "Demon Slayer Mugen Train First Screening Goods Set", "high", 95),
        ("Anime Film Premiere", "One Piece Film Red", "Premiere Goods", "OP Film Red Premiere Exclusive Uta Acrylic Stand", "mid", 55),
        ("Anime Film Premiere", "Suzume", "Premiere Goods", "Suzume Shinkai Exclusive Premiere Clear File Set", "mid", 45),
        ("Anime Film Premiere", "The Boy and the Heron", "Premiere Goods", "Boy & Heron Miyazaki Final Film Premiere Goods Set", "high", 130),
        ("Anime Film Premiere", "Jujutsu Kaisen 0", "Premiere Goods", "JJK 0 Movie Premiere Exclusive Goods Set (Theater Ltd)", "mid", 65),
        ("Anime Film Premiere", "Dragon Ball Super: Super Hero", "Premiere Goods", "DBS Super Hero Premiere Exclusive Mini Figure Set", "mid", 55),

        # ── Pop-up Store Items (+15) ──
        ("Animate", "Jujutsu Kaisen", "Store Exclusive", "JJK Animate Only Shop Exclusive Acrylic Stand Set (8pc)", "mid", 60),
        ("Animate", "Demon Slayer", "Store Exclusive", "Demon Slayer Animate Exclusive Clear File Collection (12pc)", "mid", 50),
        ("Animate", "Chainsaw Man", "Store Exclusive", "CSM Animate Cafe Exclusive Menu Acrylic Stand Set", "mid", 45),
        ("GraffArt", "Spy x Family", "Store Exclusive", "Spy x Family GraffArt Shop Exclusive Goods Set", "mid", 40),
        ("GraffArt", "Oshi no Ko", "Store Exclusive", "Oshi no Ko GraffArt Exclusive Acrylic Stand Collection", "mid", 42),
        ("Themed Cafe", "Frieren", "Cafe Exclusive", "Frieren x Cafe Collaboration Menu Exclusive Coaster Set (6pc)", "mid", 35),
        ("Themed Cafe", "Bocchi the Rock!", "Cafe Exclusive", "Bocchi Cafe Collaboration Exclusive Acrylic Keychain Set", "mid", 30),
        ("Pop-up Store", "One Piece", "Store Exclusive", "One Piece Mugiwara Store Pop-up Exclusive Goods Bundle", "mid", 65),
        ("Pop-up Store", "Dragon Ball", "Store Exclusive", "Dragon Ball Pop-up Store Exclusive Capsule Figure Set", "mid", 50),
        ("Pop-up Store", "Evangelion", "Store Exclusive", "EVA Store Pop-up Tokyo Exclusive NERV Goods Set", "mid", 55),
        ("Pop-up Store", "Haikyuu!!", "Store Exclusive", "Haikyuu!! Pop-up Store Exclusive Team Acrylic Set", "mid", 48),
        ("Pop-up Store", "Blue Lock", "Store Exclusive", "Blue Lock Pop-up Store Exclusive Acrylic Diorama", "mid", 45),
        ("Themed Cafe", "Jujutsu Kaisen", "Cafe Exclusive", "JJK x Tower Records Cafe Exclusive Goods Set", "mid", 55),
        ("Themed Cafe", "My Hero Academia", "Cafe Exclusive", "MHA x Animate Cafe Exclusive Coaster + Drink Set", "mid", 38),
        ("Pop-up Store", "Naruto", "Store Exclusive", "Naruto Pop-up Store 20th Anniversary Exclusive Bundle", "mid", 60),

        # ── Regional Festival Items (+15) ──
        ("Anime Pilgrimage", "Your Name", "Regional Exclusive", "Your Name Hida Takayama Pilgrimage Exclusive Goods Set", "mid", 55),
        ("Anime Pilgrimage", "Laid-Back Camp", "Regional Exclusive", "Yuru Camp Yamanashi Prefecture Collab Exclusive Goods", "mid", 45),
        ("Anime Pilgrimage", "A Place Further Than Universe", "Regional Exclusive", "Yorimoi Tatebayashi City Collab Exclusive Set", "mid", 40),
        ("Anime Pilgrimage", "Lucky Star", "Regional Exclusive", "Lucky Star Washinomiya Shrine Anniversary Goods (OOP)", "high", 90),
        ("Anime Pilgrimage", "Love Live! Sunshine!!", "Regional Exclusive", "Aqours Numazu Collab Exclusive Goods Set (Annual)", "mid", 50),
        ("Stamp Rally", "Evangelion", "Regional Exclusive", "Evangelion x Hakone Stamp Rally Complete Set + Prize", "mid", 65),
        ("Stamp Rally", "Demon Slayer", "Regional Exclusive", "Demon Slayer x Nara Stamp Rally Exclusive Pin Set", "mid", 40),
        ("Regional Collab", "One Piece", "Regional Exclusive", "One Piece x Kumamoto Prefecture Collab Luffy Statue Goods", "mid", 55),
        ("Regional Collab", "Detective Conan", "Regional Exclusive", "Conan x Tottori Prefecture Collab Exclusive Set", "mid", 45),
        ("Regional Collab", "GeGeGe no Kitaro", "Regional Exclusive", "Kitaro Sakaiminato Yokai Village Exclusive Goods Set", "mid", 50),
        ("Regional Collab", "Initial D", "Regional Exclusive", "Initial D x Gunma Prefecture Mt. Haruna Collab Set", "mid", 55),
        ("Anime Pilgrimage", "Suzume", "Regional Exclusive", "Suzume Kyushu Pilgrimage Collab Exclusive Goods Set", "mid", 48),
        ("Regional Collab", "Slam Dunk", "Regional Exclusive", "Slam Dunk Kamakura Crossing Collab Exclusive Set", "mid", 60),
        ("Regional Collab", "Dragon Ball", "Regional Exclusive", "Dragon Ball Nagoya Collab Exclusive Goods Set", "mid", 45),
        ("Anime Pilgrimage", "Weathering With You", "Regional Exclusive", "Weathering With You Shinjuku Pilgrimage Goods Set", "mid", 50),

        # ── Additional Event Goods (+25) ──
        ("Tamashii Nations", "Dragon Ball", "Exclusive Figure", "Tamashii Nations 2024 Goku SSJ4 S.H.Figuarts Exclusive", "high", 120),
        ("Tamashii Nations", "One Piece", "Exclusive Figure", "Tamashii Nations 2024 Luffy Gear 5 Figuarts ZERO", "high", 130),
        ("Tamashii Nations", "Kamen Rider", "Exclusive Figure", "Tamashii Nations 2024 Kamen Rider Geats S.H.Figuarts", "high", 100),
        ("Tamashii Nations", "Gundam", "Exclusive Figure", "Tamashii Nations 2024 Strike Freedom Metal Build", "grail", 350),
        ("Tamashii Nations", "Evangelion", "Exclusive Figure", "Tamashii Nations 2024 EVA-01 Metal Build", "grail", 300),
        ("Character1", "Hololive", "Acrylic Stand", "Character1 2024 Hololive Exclusive Trading Acrylic Set", "mid", 55),
        ("Character1", "Blue Archive", "Acrylic Stand", "Character1 2024 Blue Archive Exclusive Acrylic Set", "mid", 45),
        ("Character1", "Genshin Impact", "Trading Card", "Character1 2024 Genshin Impact Exclusive Card Set", "mid", 50),
        ("GSC Festival", "Various", "Nendoroid", "Good Smile Fest 2024 Exclusive Nendoroid (Mystery)", "high", 120),
        ("GSC Festival", "Hatsune Miku", "Exclusive Figure", "GSC Fest 2024 Hatsune Miku 16th Anniversary Figure", "high", 150),
        ("Treasure Festa", "Fate/Grand Order", "Garage Kit", "Treasure Festa 2024 FGO Morgan 1/7 GK", "grail", 380),
        ("Treasure Festa", "Original", "Garage Kit", "Treasure Festa 2024 Best Sculptor Award Winner GK", "grail", 500),
        ("Niconico Chokaigi", "Vocaloid", "Exclusive Goods", "Niconico Chokaigi 2024 Hatsune Miku Stage Exclusive Set", "mid", 55),
        ("Niconico Chokaigi", "VTuber", "Exclusive Goods", "Niconico Chokaigi 2024 VTuber Booth Exclusive Acrylic Set", "mid", 45),
        ("AGF", "Ensemble Stars", "Exclusive Goods", "AGF 2024 Ensemble Stars Exclusive Bromide Set (20pc)", "mid", 60),
        ("AGF", "Twisted Wonderland", "Exclusive Goods", "AGF 2024 Twisted Wonderland Exclusive Clear File Set", "mid", 50),
        ("AGF", "Hypnosis Mic", "Exclusive Goods", "AGF 2024 Hypnosis Mic All Division Goods Set", "mid", 55),
        ("Ufotable Cafe", "Demon Slayer", "Cafe Exclusive", "Ufotable Cafe Demon Slayer Hashira Complete Set (9 plates)", "high", 120),
        ("Ufotable Cafe", "Fate/stay night", "Cafe Exclusive", "Ufotable Cafe Fate HF Sakura Menu Exclusive Set", "mid", 55),
        ("Square Enix Cafe", "Final Fantasy VII", "Cafe Exclusive", "SE Cafe FFVII Rebirth Launch Exclusive Goods Set", "mid", 65),
        ("Capcom Cafe", "Monster Hunter", "Cafe Exclusive", "Capcom Cafe MH Wilds Launch Exclusive Plate Set", "mid", 55),
        ("Sweets Paradise", "Jujutsu Kaisen", "Cafe Exclusive", "Sweets Paradise JJK Collab Exclusive Coaster Full Set", "mid", 40),
