...
def _variant_expansion() -> list[dict]:
    ...
    extra = [
        {"name": "Survive: Escape from CollectAI (30th Anniversary)", "publisher": "Stronghold Games", "designer": "Julian Courtland-Smith", "year": 2012, "player_count": "2-4", "play_time": "60min", "bgg_rating": "7.1", "edition": "30th Anniversary", "condition": "complete", "price_eur": 55, "rarity": "Uncommon", "image_url": "https://cf.geekdo-images.com/placeholder"},
