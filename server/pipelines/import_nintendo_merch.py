...
def get_curated_catalog() -> list[dict]:
    ...
    merch = [
        ...
        # ── Amiibo — Rare / Valuable (Batch 13) ───────────────────────────
        ("Mario", "Amiibo", "Gold Mario (1st Print)", "Walmart Exclusive", "high", 95),
        ("Mario", "Amiibo", "Silver Mario (1st Print)", "Exclusive", "high", 100),
        ("Nintendo", "Amiibo", "Qbby (BoxBoy JP Exclusive)", "Nintendo Store JP", "grail", 250),
        ("Mario", "Amiibo", "Mega Yarn Yoshi", "Toys R Us Exclusive", "grail", 200),
        ("Nintendo", "Amiibo", "Navirou (Monster Hunter Stories JP)", "Nintendo Store JP", "high", 120),
        ("Nintendo", "Amiibo", "Solaire of Astora (Dark Souls)", "", "high", 80),
        ("Pokemon", "Amiibo", "Detective Pikachu Amiibo", "", "mid", 45),
        ("Animal Crossing", "Amiibo", "Lottie Amiibo (Animal Crossing)", "", "mid", 35),
        ("Nintendo", "Amiibo", "Joker Amiibo (Smash Ultimate)", "", "mid", 40),
        ("Nintendo", "Amiibo", "Hero Amiibo (Smash Ultimate Dragon Quest)", "", "mid", 38),
        ("Nintendo", "Amiibo", "Banjo & Kazooie Amiibo (Smash Ultimate)", "", "mid", 42),
        ("Nintendo", "Amiibo", "Terry Bogard Amiibo (Smash Ultimate)", "", "mid", 38),
        ("Nintendo", "Amiibo", "Min Min Amiibo (Smash Ultimate)", "", "mid", 35),
        ("Nintendo", "Amiibo", "Pyra Amiibo (Smash Ultimate)", "", "mid", 42),
        ("Nintendo", "Amiibo", "Mythra Amiibo (Smash Ultimate)", "", "mid", 42),
        ("Nintendo", "Amiibo", "Sora Amiibo (Smash Ultimate)", "", "mid", 55),
        ("Nintendo", "Amiibo", "Kazuya Amiibo (Smash Ultimate)", "", "mid", 38),
        ("Nintendo", "Amiibo", "Steve Amiibo (Smash Ultimate Minecraft)", "", "mid", 45),
        ("Nintendo", "Amiibo", "Sephiroth Amiibo (Smash Ultimate)", "", "mid", 48),
        ("Nintendo", "Amiibo", "Cloud Player 2 Amiibo (Smash Ultimate)", "", "mid", 50),
        ("Pokemon", "Amiibo", "Shadow Mewtwo Amiibo Card (Pokken)", "Exclusive", "high", 85),
        ("Zelda", "Amiibo", "Guardian Amiibo (Breath of the Wild)", "", "high", 80),
        ("Zelda", "Amiibo", "Link (Skyward Sword) Amiibo", "", "mid", 55),
        ("Zelda", "Amiibo", "Zelda & Loftwing Amiibo", "", "mid", 48),
        ("Splatoon", "Amiibo", "Callie & Marie 2-Pack Amiibo (Splatoon)", "", "high", 90),
        ("Nintendo", "Amiibo", "Mega Man Gold Amiibo", "Exclusive", "high", 110),
        ("Mario", "Amiibo", "Mario (Wedding) Amiibo (Super Mario Odyssey)", "", "mid", 35),
        ("Mario", "Amiibo", "Bowser (Wedding) Amiibo (Super Mario Odyssey)", "", "mid", 35),
        ("Nintendo", "Amiibo", "Complete Smash Bros Ultimate Amiibo Set (80+ figures)", "", "grail", 3500),
        ("Mario", "Amiibo", "Cat Mario & Cat Peach 2-Pack Amiibo", "", "mid", 45),

        # ── Club Nintendo / My Nintendo Exclusive Rewards ──────────────────
        ("Nintendo", "Club Nintendo", "Club Nintendo Game & Watch Ball Replica", "Club Nintendo", "grail", 280),
        ("Nintendo", "Club Nintendo", "Club Nintendo Hanafuda Cards (Mario)", "Club Nintendo", "high", 120),
        ("Nintendo", "Club Nintendo", "Club Nintendo Platinum Reward Poster Set", "Club Nintendo", "mid", 65),
        ("Nintendo", "Club Nintendo", "Club Nintendo Gold Nunchuk", "Club Nintendo", "high", 150),
        ("Nintendo", "Club Nintendo", "Club Nintendo SNES Classic Controller", "Club Nintendo", "high", 90),
        ("Nintendo", "My Nintendo", "My Nintendo Mario Pin Set (Complete)", "My Nintendo", "mid", 55),
        ("Nintendo", "My Nintendo", "My Nintendo Zelda TOTK Poster Set", "My Nintendo", "mid", 40),
        ("Nintendo", "My Nintendo", "My Nintendo Pikmin Coaster Set", "My Nintendo", "standard", 28),
        ("Nintendo", "Store Exclusive", "Nintendo NY Store Exclusive Mario Statue", "Nintendo NY", "high", 180),
        ("Nintendo", "Store Exclusive", "Nintendo NY Store Exclusive Link Statue", "Nintendo NY", "high", 160),
        ("Nintendo", "My Nintendo", "My Nintendo Animal Crossing Tote Bag", "My Nintendo", "standard", 25),
        ("Nintendo", "Club Nintendo", "Club Nintendo Luigi's Mansion Figurine", "Club Nintendo", "high", 95),

        # ── Pokémon Center Exclusive (Batch 13) ────────────────────────────
        ("Pokemon", "Plush", "Ditto Transform Bulbasaur Plush", "Pokemon Center", "mid", 38),
        ("Pokemon", "Plush", "Ditto Transform Charmander Plush", "Pokemon Center", "mid", 38),
        ("Pokemon", "Plush", "Ditto Transform Squirtle Plush", "Pokemon Center", "mid", 38),
        ("Pokemon", "Plush", "Ditto Transform Clefairy Plush", "Pokemon Center", "mid", 38),
        ("Pokemon", "Plush", "Pokemon Fit Complete Kanto Set (151 Plush)", "Pokemon Center JP", "grail", 600),
        ("Pokemon", "Plush", "Life-Size Pikachu Plush (40cm)", "Pokemon Center", "high", 180),
        ("Pokemon", "Plush", "Detective Pikachu Life-Size Plush", "Pokemon Center", "high", 160),
        ("Pokemon", "Merch", "Pokemon Cafe Pikachu Latte Art Mug Set", "Pokemon Cafe", "mid", 55),
        ("Pokemon", "Merch", "Pokemon Center Tokyo DX Opening Pikachu Plush", "Pokemon Center Tokyo", "high", 95),
        ("Pokemon", "Merch", "Pokemon Center Osaka DX Gyarados Plush", "Pokemon Center Osaka", "high", 85),
        ("Pokemon", "Merch", "Pokemon Center Kyoto Geisha Pikachu Plush", "Pokemon Center Kyoto", "high", 90),
        ("Pokemon", "Merch", "Pokemon Center Okinawa Alolan Exeggutor Plush", "Pokemon Center Okinawa", "high", 80),
        ("Pokemon", "Plush", "Scarlet & Violet Koraidon Plush (Large)", "Pokemon Center", "mid", 65),
        ("Pokemon", "Plush", "Scarlet & Violet Miraidon Plush (Large)", "Pokemon Center", "mid", 65),
        ("Pokemon", "Plush", "Legendary Rayquaza Plush (6ft)", "Pokemon Center", "grail", 350),
        ("Pokemon", "Figure", "Pokemon Center Lucario Premium Figure 1/8", "Pokemon Center", "high", 85),
        ("Pokemon", "Figure", "Pokemon Center Gardevoir Premium Figure 1/8", "Pokemon Center", "high", 85),
        ("Pokemon", "Figure", "Pokemon Center Gallery DX Charizard vs Dragonite", "Pokemon Center", "high", 120),
        ("Pokemon", "Merch", "Pokemon Center Canvas Art Series (Complete Set)", "Pokemon Center", "high", 150),
        ("Pokemon", "TCG Accessory", "Pokemon Center Japan Exclusive Playmat (Pikachu Mimikyu)", "Pokemon Center JP", "mid", 55),

        # ── Zelda Collectibles (Batch 13) ──────────────────────────────────
        ("Zelda", "Figure", "First4Figures Master Sword Life-Size Replica", "First4Figures", "grail", 450),
        ("Zelda", "Figure", "Dark Horse Hylian Shield 1:1 Replica", "Dark Horse", "grail", 300),
        ("Zelda", "Figure", "First4Figures Link on Epona Statue", "First4Figures", "grail", 500),
        ("Zelda", "Figure", "First4Figures Zelda (BOTW) PVC Statue", "First4Figures", "high", 120),
        ("Zelda", "Merch", "TOTK Collector's Edition Items (Steelbook + Poster)", "", "high", 90),
        ("Zelda", "Merch", "Zelda 35th Anniversary Pin Set", "Nintendo Store", "mid", 45),
        ("Zelda", "Controller", "Tears of the Kingdom Pro Controller", "", "mid", 75),
        ("Zelda", "Figure", "First4Figures Fierce Deity Link Statue", "First4Figures", "grail", 550),
        ("Zelda", "Figure", "First4Figures Urbosa (BOTW) Statue", "First4Figures", "high", 180),
        ("Zelda", "Merch", "Hyrule Historia (1st Print Hardcover)", "Dark Horse", "mid", 55),
        ("Zelda", "Merch", "Zelda Encyclopedia Deluxe Edition", "Dark Horse", "mid", 50),
        ("Zelda", "Figure", "First4Figures Majora's Mask Life-Size Replica", "First4Figures", "grail", 400),
        ("Zelda", "Figure", "Legend of Zelda Hyrule Fantasy Famicom Complete", "", "grail", 350),
        ("Zelda", "Merch", "Zelda Twilight Princess HD Amiibo Bundle", "", "high", 80),
        ("Zelda", "Figure", "First4Figures Link (Twilight Princess) Statue", "First4Figures", "grail", 480),

        # ── Mario Collectibles (Batch 13) ──────────────────────────────────
        ("Mario", "Figure", "Super Mario Bros Movie Mario Figure (Jakks Pacific 12in)", "", "mid", 35),
        ("Mario", "Figure", "Super Mario Bros Movie Bowser Figure (Jakks Pacific Fire Breathing)", "", "mid", 40),
        ("Mario", "Merch", "Super Mario Bros Movie Collector's Popcorn Bucket", "Theater Exclusive", "mid", 45),
        ("Mario", "Hardware", "Mario Kart LIVE Home Circuit (Mario Set)", "", "mid", 60),
        ("Mario", "Hardware", "Mario Kart LIVE Home Circuit (Luigi Set)", "", "mid", 60),
        ("Mario", "Merch", "Super Nintendo World Power-Up Band (Mario)", "Universal Studios", "mid", 40),
        ("Mario", "Merch", "Super Nintendo World Power-Up Band (Peach)", "Universal Studios", "mid", 40),
        ("Mario", "Merch", "Super Nintendo World Mario Kart Bowser's Challenge Merch Set", "Universal Studios", "high", 85),
        ("Mario", "Merch", "Mario 35th Anniversary Pin Set (Complete 5 Waves)", "Nintendo Store", "high", 150),
        ("Mario", "Merch", "LEGO Super Mario Bowser's Airship Expansion 71391", "", "high", 100),
        ("Mario", "Merch", "LEGO Super Mario Mighty Bowser 71411", "", "high", 130),
        ("Mario", "Merch", "LEGO Super Mario 64 Question Mark Block 71395", "", "high", 110),
        ("Mario", "Figure", "Super Mario Galaxy Mario & Luma Figure (First4Figures)", "First4Figures", "grail", 350),
        ("Mario", "Figure", "Super Mario Odyssey Cappy Mario Figure", "", "mid", 38),
        ("Mario", "Merch", "Super Nintendo World Exclusive Yoshi Ride Toy", "Universal Studios", "mid", 55),

        # ── Animal Crossing Merch (Batch 13) ───────────────────────────────
        ("Animal Crossing", "Plush", "Tom Nook Plush 12in", "", "standard", 25),
        ("Animal Crossing", "Plush", "Tom Nook Plush (Timmy & Tommy Set)", "Nintendo Store", "mid", 55),
        ("Animal Crossing", "Figure", "Isabelle Nendoroid (Good Smile Company)", "", "mid", 55),
        ("Animal Crossing", "Merch", "K.K. Slider Music Box", "Nintendo Store", "high", 85),
        ("Animal Crossing", "Merch", "Nook Inc. Hawaiian Shirt (Official)", "Nintendo Store", "mid", 48),
        ("Animal Crossing", "Plush", "Build-A-Bear Tom Nook Plush", "Build-A-Bear", "mid", 60),
        ("Animal Crossing", "Plush", "Build-A-Bear Isabelle Plush", "Build-A-Bear", "mid", 60),
        ("Animal Crossing", "Plush", "Build-A-Bear KK Slider Plush", "Build-A-Bear", "mid", 65),
        ("Animal Crossing", "Merch", "Animal Crossing Sanrio Collaboration Amiibo Cards (Complete Set)", "Target Exclusive", "high", 80),
        ("Animal Crossing", "Merch", "Animal Crossing New Horizons Original Soundtrack (8-CD Box)", "", "high", 95),
        ("Animal Crossing", "Figure", "Isabelle (Winter) Nendoroid", "", "mid", 60),
        ("Animal Crossing", "Merch", "Animal Crossing New Horizons Art & Design Book", "", "mid", 35),
        ("Animal Crossing", "Merch", "Animal Crossing Happy Home Designer NFC Reader Bundle", "", "mid", 45),
        ("Animal Crossing", "Plush", "Celeste Plush 8in", "Pokemon Center/Nintendo", "mid", 35),
        ("Animal Crossing", "Plush", "Blathers Plush 12in", "", "mid", 38),

        # ── Fire Emblem / Splatoon / Other Franchises (Batch 13) ───────────
        ("Fire Emblem", "Merch", "Fire Emblem Engage Collector's Edition Items", "", "high", 90),
        ("Fire Emblem", "Figure", "Fire Emblem Marth Figma (Good Smile)", "", "high", 85),
        ("Fire Emblem", "Merch", "Fire Emblem Three Houses Steelbook", "", "mid", 45),
        ("Splatoon", "Controller", "Splatoon 3 Pro Controller (Special Edition)", "", "mid", 75),
        ("Splatoon", "Merch", "Splatoon 3 Squid Plush Set (3-Pack)", "", "mid", 55),
        ("Splatoon", "Merch", "Splatoon 3 Collector's Edition Artbook + Stickers", "", "mid", 40),
        ("Kirby", "Merch", "Kirby 30th Anniversary Medal Collection", "Nintendo Store", "high", 85),
        ("Kirby", "Plush", "Kirby 30th Anniversary Classic Plush Set", "Nintendo Store", "mid", 65),
        ("Pikmin", "Merch", "Pikmin Bloom Flower Pot (Full Set)", "", "mid", 45),
        ("Pikmin", "Figure", "Pikmin 4 Oatchi & Pikmin Figurine Set", "", "mid", 55),
        ("Metroid", "Merch", "Metroid Dread Collector's Edition (Steelbook + Art Cards)", "", "high", 95),
        ("Metroid", "Figure", "First4Figures Samus Varia Suit Statue", "First4Figures", "grail", 400),
        ("Xenoblade", "Merch", "Xenoblade Chronicles 3 Collector's Edition (Art Book + Steelbook)", "", "high", 90),
        ("Xenoblade", "Figure", "Xenoblade Chronicles 2 Pyra Figure (Good Smile)", "", "high", 130),
        ("Fire Emblem", "Figure", "Fire Emblem Byleth Figma", "", "high", 80),

        # ── Retro Nintendo Hardware / Memorabilia (Batch 13) ───────────────
        ("Nintendo", "Hardware", "NES Classic Edition (New in Box)", "", "high", 100),
        ("Nintendo", "Hardware", "SNES Classic Edition (New in Box)", "", "high", 120),
        ("Nintendo", "Hardware", "Game & Watch Super Mario Bros (2020)", "", "mid", 55),
        ("Nintendo", "Hardware", "Game & Watch The Legend of Zelda (2021)", "", "mid", 55),
        ("Nintendo", "Hardware", "Game & Watch Donkey Kong (Limited)", "", "mid", 60),
        ("Nintendo", "Merch", "Nintendo Power Magazine Complete Collection", "", "grail", 500),
        ("Nintendo", "Merch", "Nintendo Power Volume 1 (NM Condition)", "", "high", 120),
        ("Nintendo", "Merch", "Original Nintendo Store Display (Standee)", "", "grail", 300),
        ("Nintendo", "Merch", "Nintendo 64 Promotional VHS Tape (Sealed)", "", "high", 80),
        ("Nintendo", "Merch", "Nintendo World Championships 1990 Cartridge (Reproduction)", "", "mid", 45),
        ("Nintendo", "Hardware", "Nintendo Switch OLED Splatoon 3 Edition", "", "high", 80),
        ("Nintendo", "Hardware", "Nintendo Switch OLED Pokemon Scarlet & Violet Edition", "", "high", 85),
        ("Nintendo", "Merch", "Super Mario Bros 2 Original Marketing Poster (1988)", "", "high", 95),
        ("Nintendo", "Merch", "Legend of Zelda Original Gold Cartridge Display", "", "high", 140),
        ("Nintendo", "Hardware", "Game Boy Micro (20th Anniversary Famicom Edition)", "", "grail", 280),

        # ── Smash Bros amiibo (every character) ────────────────────────────
        ("Nintendo", "amiibo", "amiibo Sora (Super Smash Bros)", "", "high", 30),
        ("Nintendo", "amiibo", "amiibo Kazuya (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Steve (Super Smash Bros)", "", "high", 35),
        ("Nintendo", "amiibo", "amiibo Alex (Super Smash Bros)", "", "mid", 28),
        ("Nintendo", "amiibo", "amiibo Min Min (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Pyra (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Mythra (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Sephiroth (Super Smash Bros)", "", "high", 35),
        ("Nintendo", "amiibo", "amiibo Banjo & Kazooie (Super Smash Bros)", "", "high", 40),
        ("Nintendo", "amiibo", "amiibo Terry (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Byleth (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Hero (Super Smash Bros DQ)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Joker (Super Smash Bros Persona)", "", "high", 38),
        ("Nintendo", "amiibo", "amiibo Piranha Plant (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo King K. Rool (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Simon Belmont (Super Smash Bros)", "", "mid", 20),
        ("Nintendo", "amiibo", "amiibo Richter (Super Smash Bros)", "", "mid", 20),
        ("Nintendo", "amiibo", "amiibo Dark Samus (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Chrom (Super Smash Bros)", "", "mid", 20),
        ("Nintendo", "amiibo", "amiibo Isabelle (Super Smash Bros)", "", "mid", 20),
        ("Nintendo", "amiibo", "amiibo Incineroar (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Ken (Super Smash Bros)", "", "standard", 18),
        ("Nintendo", "amiibo", "amiibo Young Link (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Ice Climbers (Super Smash Bros)", "", "mid", 28),
        ("Nintendo", "amiibo", "amiibo Ridley (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Inkling (Super Smash Bros)", "", "standard", 18),
        ("Nintendo", "amiibo", "amiibo Daisy (Super Smash Bros)", "", "standard", 18),
        ("Nintendo", "amiibo", "amiibo Wolf (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Snake (Super Smash Bros)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Ivysaur (Super Smash Bros)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Squirtle (Super Smash Bros)", "", "mid", 22),

        # ── Nintendo TOKYO Store Exclusives ────────────────────────────────
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Splatoon Inkling Plush", "Nintendo TOKYO", "high", 55),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Kirby Chef Plush", "Nintendo TOKYO", "high", 50),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Animal Crossing Isabelle Mug", "Nintendo TOKYO", "mid", 35),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Pikmin Garden Tee", "Nintendo TOKYO", "mid", 40),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Mario Kart Pin Set", "Nintendo TOKYO", "high", 45),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Zelda Hylian Shield Keychain", "Nintendo TOKYO", "mid", 30),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Super Mario Flower Power Hoodie", "Nintendo TOKYO", "high", 65),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Metroid Samus Aran Poster", "Nintendo TOKYO", "mid", 25),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Fire Emblem Engage Art Print", "Nintendo TOKYO", "mid", 30),
        ("Nintendo", "Merch", "Nintendo TOKYO Exclusive Xenoblade Chronicles Tee", "Nintendo TOKYO", "mid", 38),

        # ── Super Nintendo World Items ─────────────────────────────────────
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Mario)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Luigi)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Peach)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Toad)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Yoshi)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Power-Up Band (Daisy)", "Super Nintendo World", "mid", 35),
        ("Nintendo", "Merch", "Super Nintendo World Coin Block Popcorn Bucket", "Super Nintendo World", "high", 50),
        ("Nintendo", "Merch", "Super Nintendo World Mario Kart Bowser Popcorn Bucket", "Super Nintendo World", "high", 55),
        ("Nintendo", "Merch", "Super Nintendo World 1-Up Mushroom Drink Bottle", "Super Nintendo World", "mid", 28),
        ("Nintendo", "Merch", "Super Nintendo World Fire Flower Churros Container", "Super Nintendo World", "mid", 22),
        ("Nintendo", "Merch", "Super Nintendo World ? Block Tiramisu Cup", "Super Nintendo World", "mid", 20),
        ("Nintendo", "Merch", "Super Nintendo World Piranha Plant Cookie Tin", "Super Nintendo World", "mid", 25),
        ("Nintendo", "Merch", "Super Nintendo World Star Bit Candy Bag", "Super Nintendo World", "standard", 15),
        ("Nintendo", "Merch", "Super Nintendo World Toadstool Cafe Menu Placemat", "Super Nintendo World", "mid", 30),
        ("Nintendo", "Merch", "Super Nintendo World DK Country Mine Cart Keychain", "Super Nintendo World", "mid", 22),

        # ── Nintendo x Uniqlo UT ───────────────────────────────────────────
        ("Nintendo", "Merch", "Uniqlo UT x Splatoon 3 Graphic Tee (Inkling)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Splatoon 3 Graphic Tee (Octoling)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Animal Crossing New Horizons Tee (Tom Nook)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Animal Crossing New Horizons Tee (KK Slider)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Pikmin Tee (Red Pikmin)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Pikmin Tee (Onion Ship)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Super Mario Tee (Pixel Mario)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Super Mario Tee (Power Star)", "Uniqlo", "standard", 20),
        ("Nintendo", "Merch", "Uniqlo UT x Zelda Tears of the Kingdom Tee (Master Sword)", "Uniqlo", "standard", 22),
        ("Nintendo", "Merch", "Uniqlo UT x Zelda Tears of the Kingdom Tee (Ultrahand)", "Uniqlo", "standard", 22),
        ("Nintendo", "Merch", "Uniqlo UT x Nintendo Heritage Tee (NES Controller)", "Uniqlo", "mid", 25),

        # ── Nintendo Game Soundtracks on CD ────────────────────────────────
        ("Nintendo", "Merch", "Super Mario Galaxy Original Soundtrack (2-CD)", "", "high", 80),
        ("Nintendo", "Merch", "The Legend of Zelda 25th Anniversary Orchestra CD", "", "high", 70),
        ("Nintendo", "Merch", "Splatoon 3 Original Soundtrack (3-CD)", "", "mid", 55),
        ("Nintendo", "Merch", "Animal Crossing: New Horizons Soundtrack (4-CD)", "", "high", 90),
        ("Nintendo", "Merch", "Super Smash Bros Ultimate Soundtrack (OST Box)", "", "high", 120),
        ("Nintendo", "Merch", "Kirby Star Allies Original Soundtrack (3-CD)", "", "mid", 55),
        ("Nintendo", "Merch", "Fire Emblem Three Houses Soundtrack (4-CD)", "", "high", 80),
        ("Nintendo", "Merch", "Xenoblade Chronicles 3 OST (6-CD Box Set)", "", "grail", 150),
        ("Nintendo", "Merch", "Zelda: Breath of the Wild OST (5-CD Limited)", "", "grail", 180),
        ("Nintendo", "Merch", "Metroid Dread Original Soundtrack (2-CD)", "", "mid", 50),
        ("Nintendo", "Merch", "Pokemon Scarlet & Violet OST (4-CD)", "", "high", 75),
        ("Nintendo", "Merch", "Super Mario Odyssey OST (4-CD)", "", "high", 85),
        ("Nintendo", "Merch", "Octopath Traveler Original Soundtrack (4-CD)", "", "high", 90),

        # ── More amiibo (Special/Store Exclusives) ─────────────────────────
        ("Nintendo", "amiibo", "amiibo Zelda & Loftwing (Skyward Sword HD)", "", "high", 45),
        ("Nintendo", "amiibo", "amiibo Ganondorf (Tears of the Kingdom)", "", "high", 40),
        ("Nintendo", "amiibo", "amiibo Splatoon 3 Octoling (Blue)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Splatoon 3 Inkling (Yellow)", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Splatoon 3 Smallfry", "", "mid", 28),
        ("Nintendo", "amiibo", "amiibo Metroid Dread Samus", "", "high", 40),
        ("Nintendo", "amiibo", "amiibo Metroid Dread E.M.M.I.", "", "high", 38),
        ("Nintendo", "amiibo", "amiibo Min Min (ARMS)", "", "mid", 22),
        ("Nintendo", "amiibo", "amiibo Monster Hunter Rise Palamute", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Monster Hunter Rise Palico", "", "mid", 25),
        ("Nintendo", "amiibo", "amiibo Monster Hunter Rise Magnamalo", "", "mid", 28),
        ("Nintendo", "amiibo", "amiibo Noah (Xenoblade 3)", "", "mid", 30),
        ("Nintendo", "amiibo", "amiibo Mio (Xenoblade 3)", "", "mid", 30),
        ("Nintendo", "amiibo", "amiibo Pikmin (Pikmin 4)", "", "mid", 28),
        ("Nintendo", "amiibo", "amiibo Oatchi (Pikmin 4)", "", "mid", 28),

        # ── More Nintendo TOKYO/Store Items ────────────────────────────────
        ("Nintendo", "Merch", "Nintendo OSAKA Exclusive Super Mario Takoyaki Keychain", "Nintendo OSAKA", "mid", 25),
        ("Nintendo", "Merch", "Nintendo OSAKA Exclusive Kirby Kushikatsu Plush", "Nintendo OSAKA", "mid", 35),
        ("Nintendo", "Merch", "Nintendo KYOTO Exclusive Zelda Kinkakuji Pin", "Nintendo KYOTO", "high", 40),
        ("Nintendo", "Merch", "Nintendo KYOTO Exclusive Mario Fushimi Inari Towel", "Nintendo KYOTO", "mid", 28),
        ("Nintendo", "Merch", "Nintendo NY Exclusive Statue of Liberty Mario Figure", "Nintendo NY", "high", 55),
        ("Nintendo", "Merch", "Nintendo NY Exclusive NYC Subway Map Tote Bag", "Nintendo NY", "mid", 30),

        # ── Club Nintendo / My Nintendo Rewards ────────────────────────────
        ("Nintendo", "Merch", "Club Nintendo Game & Watch Ball (Reissue)", "", "grail", 200),
        ("Nintendo", "Merch", "Club Nintendo Platinum Playing Cards Set", "", "high", 80),
        ("Nintendo", "Merch", "Club Nintendo Luigi's Mansion Diorama", "", "high", 95),
        ("Nintendo", "Merch", "Club Nintendo Hanafuda Cards (Mario Edition)", "", "high", 70),
        ("Nintendo", "Merch", "My Nintendo Rewards Mario Pin Set (2024)", "", "mid", 35),
        ("Nintendo", "Merch", "My Nintendo Rewards Zelda Poster Set (3 prints)", "", "mid", 30),
        ("Nintendo", "Merch", "My Nintendo Rewards Animal Crossing Notepad Set", "", "standard", 15),

        # ── Vintage Nintendo Collectibles ──────────────────────────────────
        ("Nintendo", "Merch", "Original Famicom Disk System (CIB)", "", "grail", 250),
        ("Nintendo", "Merch", "Nintendo Playing Cards (Hanafuda, Vintage 1970s)", "", "grail", 300),
        ("Nintendo", "Merch", "Nintendo Ultra Hand (1966 Original)", "", "grail", 400),
        ("Nintendo", "Merch", "Nintendo Love Tester (1969 Original)", "", "grail", 500),
        ("Nintendo", "Merch", "Game & Watch Oil Panic (OC-22, CIB)", "", "grail", 180),
        ("Nintendo", "Merch", "Game & Watch Donkey Kong (DK-52, CIB)", "", "grail", 200),
        ("Nintendo", "Merch", "Game & Watch Zelda (ZL-65, CIB)", "", "grail", 220),
        ("Nintendo", "Merch", "Nintendo e-Reader (GBA, CIB)", "", "high", 80),
        ("Nintendo", "Merch", "Virtual Boy (CIB, All 22 NA Games)", "", "grail", 800),
        ("Nintendo", "Merch", "Super Scope (SNES, CIB)", "", "high", 60),
        ("Nintendo", "Merch", "R.O.B. Robot (NES, CIB)", "", "grail", 300),

        # ── More Plush & Figures ───────────────────────────────────────────
        ("Nintendo", "Merch", "San-ei Kirby All Star Collection Waddle Dee Plush", "", "standard", 18),
        ("Nintendo", "Merch", "San-ei Kirby All Star Collection Meta Knight Plush", "", "mid", 22),
        ("Nintendo", "Merch", "San-ei Kirby All Star Collection King Dedede Plush", "", "mid", 25),
        ("Nintendo", "Merch", "San-ei Mario All Star Collection Chain Chomp Plush", "", "mid", 22),
        ("Nintendo", "Merch", "San-ei Mario All Star Collection Boo Ghost Plush", "", "standard", 18),
        ("Nintendo", "Merch", "San-ei Pikmin All Star Red Pikmin Plush", "", "standard", 16),
        ("Nintendo", "Merch", "San-ei Pikmin All Star Blue Pikmin Plush", "", "standard", 16),
        ("Nintendo", "Merch", "San-ei Pikmin All Star Yellow Pikmin Plush", "", "standard", 16),
        ("Nintendo", "Merch", "San-ei Splatoon 3 Smallfry Plush", "", "mid", 20),
        ("Nintendo", "Merch", "San-ei Animal Crossing Tom Nook Plush (30cm)", "", "mid", 25),
        ("Nintendo", "Merch", "San-ei Animal Crossing Isabelle Plush (30cm)", "", "mid", 25),
        ("Nintendo", "Merch", "Jakks Pacific World of Nintendo Mario 4-inch Figure", "", "standard", 15),
        ("Nintendo", "Merch", "Jakks Pacific World of Nintendo Link 4-inch Figure", "", "standard", 15),
        ("Nintendo", "Merch", "Jakks Pacific World of Nintendo Donkey Kong 6-inch Figure", "", "standard", 18),
        ("Nintendo", "Merch", "Jakks Pacific World of Nintendo Bowser 6-inch Figure", "", "standard", 18),
        ("Nintendo", "Merch", "Good Smile Nendoroid Kirby", "", "mid", 42),
        ("Nintendo", "Merch", "Good Smile Nendoroid Link (Tears of the Kingdom)", "", "mid", 48),
