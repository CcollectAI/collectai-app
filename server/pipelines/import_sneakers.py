...
def _most_searched_expansion_r9() -> list[tuple]:
    """165 most-searched sneakers — Round 9 expansion.

    Covers: Travis Scott full line, Off-White The Ten, Yeezy deep cuts,
    SB Dunk grails, Jordan 1 iconic colorways, women's popular.
    """
    return [
        # ── Travis Scott — Remaining Collabs ──────────────────────────────
        ("Jordan", "Air Jordan 1 High", "Travis Scott Fragment Low Friends", "F&F (Friends & Family)",
         "DM7866-F&F", 5000),
        ("Nike", "Air Trainer 1", "Travis Scott Chocolate", "Collaboration",
         "DR7515-200", 320),
        ("Nike", "Air Trainer 1", "Travis Scott Wheat", "Collaboration",
         "DR7515-700", 340),
        ("Jordan", "Air Jordan 4", "Travis Scott Purple Friends & Family", "F&F (Friends & Family)",
         "FZ5498-F&F", 3500),
        ("Jordan", "Air Jordan 6", "Travis Scott Khaki", "Collaboration",
         "DH0690-100", 420),
        ("Nike", "Air Max 1", "Travis Scott Cave Stone", "Collaboration",
         "DO9392-003", 360),
        ("Jordan", "Air Jordan 1 Low", "Travis Scott Medium Olive", "Collaboration",
         "DZ4137-110", 580),
        ("Jordan", "Air Jordan 5", "Travis Scott Sail", "Collaboration",
         "DV4982-175", 450),
        ("Jordan", "Air Jordan 2", "Travis Scott Muslin", "Collaboration",
         "DV7128-010-R", 380),
        ("Nike", "Air Max 270", "Travis Scott Cactus Trails", "Collaboration",
         "CT2864-200", 500),
        # ── Off-White — The Ten Collection ────────────────────────────────
        ("Nike", "Air Jordan 1", "Off-White NRG White", "Collaboration",
         "AQ0818-100", 2800),
        ("Nike", "Air Presto", "Off-White White", "Collaboration",
         "AA3830-100", 1200),
        ("Nike", "Air Presto", "Off-White Black", "Collaboration",
        ...
        ("Nike", "Blazer Mid", "Off-White All Hallows Eve", "Collaboration",
         "AA3832-700", 900),
        ("Nike", "Blazer Mid", "Off-White Grim Reapers", "Collaboration",
         "AA3832-001", 850),
        ("Nike", "Air VaporMax", "Off-White White 2018", "Collaboration",
         "AA3831-100", 700),
        ("Nike", "Air VaporMax", "Off-White Black 2018", "Collaboration",
         "AA3831-002", 750),
        ("Nike", "Air Max 97", "Off-White Menta", "Collaboration",
         "AJ4585-101", 950),
        ("Nike", "Air Max 97", "Off-White Queen", "Collaboration",
         "AJ4585-001", 800),
        ("Nike", "Air Max 90", "Off-White Desert Ore", "Collaboration",
         "AA7293-200", 650),
        ("Nike", "Air Max 90", "Off-White Black", "Collaboration",
        ...
        ("Nike", "Zoom Fly", "Off-White Tulip Pink", "Collaboration",
         "AJ4588-600", 500),
        ("Nike", "Zoom Fly", "Off-White Black", "Collaboration",
         "AJ4588-001", 450),
        ("Nike", "Air Force 1 Low", "Off-White The Ten Volt", "Collaboration",
         "AO4606-700", 1500),
        ("Nike", "Air Force 1 Low", "Off-White MCA Blue", "Collaboration",
         "CI1173-400", 2500),
        ("Nike", "Air Force 1 Mid", "Off-White Pine Green", "Collaboration",
         "DR0500-300", 600),
        ("Jordan", "Air Jordan 4", "Off-White Sail", "Collaboration",
         "CV9388-100", 1600),
        ("Jordan", "Air Jordan 5", "Off-White Black Muslin", "Collaboration",
         "CT8480-001", 450),
        ("Jordan", "Air Jordan 2 Low", "Off-White White Red", "Collaboration",
         "DJ4375-160", 550),
        ("Jordan", "Air Jordan 2 Low", "Off-White Black Blue", "Collaboration",
         "DJ4375-004", 500),
        # ── Yeezy — Deep Cuts ─────────────────────────────────────────────
        ("Yeezy", "Yeezy 350 V2", "Beluga 1.0", "Limited Release",
         "BB1826", 550),
        ("Yeezy", "Yeezy 350 V2", "Beluga 2.0", "Limited Release",
         "AH2203", 350),
        ("Yeezy", "Yeezy 350 V2", "Semi Frozen Yellow", "Limited Release",
         "B37572", 380),
        ("Yeezy", "Yeezy 350 V2", "Blue Tint", "Limited Release",
         "B37571", 350),
        ("Yeezy", "Yeezy 350 V2", "Sesame", "Limited Release",
         "F99710", 300),
        ("Yeezy", "Yeezy 350 V2", "Butter", "Limited Release",
         "F36980", 280),
        ("Yeezy", "Yeezy 350 V2", "Clay", "Limited Release",
         "EG7490", 300),
        ("Yeezy", "Yeezy 350 V2", "True Form", "Limited Release",
         "EG7492", 320),
        ("Yeezy", "Yeezy 350 V2", "Hyperspace", "Limited Release",
         "EG7491", 340),
        ("Yeezy", "Yeezy 350 V2", "Lundmark", "Limited Release",
         "FU9161", 280),
        ("Yeezy", "Yeezy 350 V2", "Cloud White", "Limited Release",
         "FW3043", 290),
        ("Yeezy", "Yeezy 350 V2", "Citrin", "Limited Release",
         "FW3042", 280),
        ("Yeezy", "Yeezy 350 V2", "Yecheil", "Limited Release",
         "FW5190", 350),
        ("Yeezy", "Yeezy 350 V2", "Yeshaya", "Limited Release",
         "FX4348", 270),
        ("Yeezy", "Yeezy 350 V2", "Earth", "Limited Release",
         "FX9033", 280),
        ("Yeezy", "Yeezy 350 V2", "Tail Light", "Limited Release",
         "FX9017", 290),
        ("Yeezy", "Yeezy 350 V2", "Flax", "Limited Release",
         "FX9028", 260),
        ("Yeezy", "Yeezy 350 V2", "Israfil", "Limited Release",
         "FZ5421", 260),
        ("Yeezy", "Yeezy 350 V2", "Carbon", "Limited Release",
         "FZ5000", 250),
        ("Yeezy", "Yeezy 350 V2", "Natural", "Limited Release",
         "FZ5246", 260),
        ("Yeezy", "Yeezy 350 V2", "Ash Pearl", "Limited Release",
         "GY7658", 280),
        ("Yeezy", "Yeezy 350 V2", "Ash Blue", "Limited Release",
         "GY7657", 280),
        ("Yeezy", "Yeezy 350 V2", "Ash Stone", "Limited Release",
         "GW0089", 270),
        ("Yeezy", "Yeezy 350 V2", "MX Rock", "Limited Release",
         "GW3774", 300),
        ("Yeezy", "Yeezy 350 V2", "MX Oat", "Limited Release",
         "GW3773", 280),
        ("Yeezy", "Yeezy 350 V2", "Light", "Limited Release",
         "GY3438", 320),
        ("Yeezy", "Yeezy 350 V2", "Bone", "Limited Release",
         "HQ6316", 270),
        ("Yeezy", "Yeezy 350 V2", "Slate", "Limited Release",
        ...
        ("Yeezy", "Yeezy 350 V2", "Granite", "Limited Release",
         "HQ2059", 260),
        ("Yeezy", "Yeezy 500", "Blush", "Limited Release",
         "DB2908", 300),
        ("Yeezy", "Yeezy 500", "Salt", "Limited Release",
         "EE7287", 250),
        ("Yeezy", "Yeezy 500", "Soft Vision", "Limited Release",
         "FW2656", 260),
        ("Yeezy", "Yeezy 500", "Stone", "Limited Release",
         "FW4839", 240),
        ("Yeezy", "Yeezy 500", "Enflame", "Limited Release",
         "GZ5541", 250),
        ("Yeezy", "Yeezy Foam Runner", "Stone Sage", "Limited Release",
         "GX4472", 200),
        ("Yeezy", "Yeezy Foam Runner", "Sand", "Limited Release",
        ...
        ("Yeezy", "Yeezy Foam Runner", "Onyx", "Limited Release",
         "HP8739", 180),
        ("Yeezy", "Yeezy Foam Runner", "Vermillion", "Limited Release",
         "GW3355", 200),
        ("Yeezy", "Yeezy Foam Runner", "Mineral Blue", "Limited Release",
         "GV7903", 190),
        ("Yeezy", "Yeezy Foam Runner", "MX Carbon", "Limited Release",
         "IG9562", 170),
        ("Yeezy", "Yeezy Slide", "Onyx", "Limited Release",
         "HQ6448", 150),
        ("Yeezy", "Yeezy Slide", "Bone", "Limited Release",
        ...
        ("Yeezy", "Yeezy Slide", "Pure", "Limited Release",
         "GW1934", 140),
        ("Yeezy", "Yeezy Slide", "Resin", "Limited Release",
         "FX0494", 150),
        # ── SB Dunk Grails — Most Searched ────────────────────────────────
        ("Nike", "SB Dunk Low", "Paris", "Hyperstrike",
         "308270-111", 15000),
        ("Nike", "SB Dunk Low", "NYC Pigeon", "Quickstrike",
         "304292-011", 8000),
        ("Nike", "SB Dunk Low", "Tiffany Diamond (2005)", "Quickstrike",
         "304292-402", 5000),
        ("Nike", "SB Dunk Low", "Tiffany Diamond (2023)", "Collaboration",
         "DZ1382-001", 600),
        ("Nike", "SB Dunk Low", "What The Dunk", "Quickstrike",
         "318403-141", 4000),
        ("Nike", "SB Dunk Low", "Grateful Dead Green Bear", "Collaboration",
         "CJ5378-300", 1200),
        ("Nike", "SB Dunk Low", "Grateful Dead Yellow Bear", "Collaboration",
         "CJ5378-700", 1500),
        ("Nike", "SB Dunk Low", "Grateful Dead Orange Bear", "Collaboration",
         "CJ5378-800", 2000),
        ("Nike", "SB Dunk Low", "Lobster Red", "Quickstrike",
         "313170-661", 3000),
        ("Nike", "SB Dunk Low", "Lobster Blue", "Quickstrike",
         "313170-342", 3500),
        ("Nike", "SB Dunk Low", "Lobster Purple", "Quickstrike",
         "BV1310-555", 2500),
        ("Nike", "SB Dunk Low", "Lobster Green", "Collaboration",
         "FD8776-300", 500),
        ("Nike", "SB Dunk Low", "Supreme Red Cement", "Collaboration",
         "304292-131", 3000),
        ("Nike", "SB Dunk Low", "Supreme Black Cement", "Collaboration",
         "304292-131B", 2800),
        ("Nike", "SB Dunk Low", "Freddy Krueger", "Quickstrike",
         "313170-202", 10000),
        ("Nike", "SB Dunk Low", "Staple Panda Pigeon", "Collaboration",
         "BV1310-013", 2200),
        ("Nike", "SB Dunk Low", "Travis Scott (Regular Box)", "Collaboration",
         "CT5053-001", 1800),
        ("Nike", "SB Dunk Low", "Travis Scott (Special Box)", "Collaboration",
         "CT5053-001S", 2500),
        ("Nike", "SB Dunk Low", "Ben & Jerry's Chunky Dunky (F&F Box)", "F&F (Friends & Family)",
         "CU3244-100F", 8000),
        ("Nike", "SB Dunk Low", "Heineken", "Quickstrike",
         "304292-302", 6000),
        # ── Jordan 1 — Most Searched Colorways ───────────────────────────
        ("Jordan", "Air Jordan 1 High", "University Blue", "Retro",
         "555088-134", 340),
        ("Jordan", "Air Jordan 1 High", "Dark Mocha", "Retro",
         "555088-105", 380),
        ...
        ("Jordan", "Air Jordan 1 High", "Hyper Royal", "Retro",
         "555088-402", 300),
        ("Jordan", "Air Jordan 1 High", "Bred Patent", "Retro",
         "555088-063", 280),
        ("Jordan", "Air Jordan 1 High", "Taxi", "Retro",
         "555088-711", 250),
        ("Jordan", "Air Jordan 1 High", "Yellow Toe", "Retro",
         "555088-711Y", 260),
        ("Jordan", "Air Jordan 1 High", "Metallic Navy", "Retro",
         "555088-106", 220),
        ("Jordan", "Air Jordan 1 High", "Pollen", "Retro",
         "555088-701", 230),
        ("Jordan", "Air Jordan 1 High", "Heritage", "Retro",
         "555088-161", 200),
        ("Jordan", "Air Jordan 1 High", "Lost & Found", "Retro",
         "DZ5485-612", 350),
        ("Jordan", "Air Jordan 1 High", "Satin Black Toe", "OG Colorway",
         "CD0461-016", 800),
        ("Jordan", "Air Jordan 1 High", "Satin Bred", "OG Colorway",
         "CD0461-601", 700),
        ("Jordan", "Air Jordan 1 High", "Trophy Room Chicago", "Collaboration",
         "DA2728-100", 1500),
        # ── Women's Popular — Most Searched ───────────────────────────────
        ("Jordan", "Air Jordan 1 High", "Satin Snake", "OG Colorway",
         "CD0461-601S", 450),
        ("Nike", "Dunk Low", "Panda (W)", "GR (General Release)",
         "DD1503-101W", 120),
        ("Nike", "Dunk Low", "Rose Whisper (W)", "GR (General Release)",
         "DD1503-118", 130),
        ("Nike", "Dunk Low", "Grey Fog (W)", "GR (General Release)",
         "DD1503-001W", 110),
        ("Nike", "Dunk Low", "Next Nature White Mint (W)", "GR (General Release)",
         "DN1431-102", 100),
        ("Jordan", "Air Jordan 1 Low", "Mocha (W)", "Retro",
         "DC0774-200", 160),
        ("Jordan", "Air Jordan 1 Low", "Wolf Grey (W)", "Retro",
        ...
        ("Jordan", "Air Jordan 4", "Canyon Purple (W)", "Retro",
         "AQ9129-500", 300),
        ("Nike", "Air Max 97", "Silver Bullet (W)", "OG Colorway",
         "DM0028-002", 200),
    ]
...
def get_curated_catalog() -> list[tuple]:
    ...
    # --- Expansion Round 9 (~165 most-searched items) ---
    catalog.extend(_most_searched_expansion_r9())
