...
def _round8_plush_expansion() -> list[tuple]:
    """Round 8 expansion: ~330 items across Jellycat, Build-A-Bear, Squishmallows rare/retired,
    Sanrio vintage, Pokemon Center Japan, San-X full lines, KAWS, Disney Parks Duffy & Friends,
    Studio Ghibli, vintage Steiff/Merrythought/Ty, Line Friends/BT21."""
    return [
        # ── Jellycat — Bashful extended colours & Odell/Flower Parsley/If I Were a (40) ─────
        ("Bashful Bunny Silver", "Jellycat", "Bashful", 'Medium 31cm', 30, "Common", False, "Silver grey bunny"),
        ("Bashful Bunny Truffle", "Jellycat", "Bashful", 'Medium 31cm', 30, "Common", False, "Deep brown bunny"),
        ("Bashful Bunny Cream", "Jellycat", "Bashful", 'Medium 31cm', 32, "Common", False, "Cream/ivory bunny variant"),
        ("Bashful Bunny Mint", "Jellycat", "Bashful", 'Medium 31cm', 45, "Uncommon", True, "Retired mint green variant"),
        ("Bashful Bunny Forest", "Jellycat", "Bashful", 'Medium 31cm', 55, "Rare", True, "Retired forest green bunny"),
        ("Bashful Bunny Peach", "Jellycat", "Bashful", 'Medium 31cm', 50, "Uncommon", True, "Retired peach bunny"),
        ("Bashful Bunny Luxe Rosa", "Jellycat", "Bashful Luxe", 'Medium 31cm', 65, "Rare", True, "Rose metallic luxe"),
        ("Bashful Bunny Luxe Twilight", "Jellycat", "Bashful Luxe", 'Medium 31cm', 68, "Rare", True, "Navy shimmer luxe, retired"),
        ("Bashful Snow Tiger", "Jellycat", "Bashful", 'Medium 31cm', 40, "Uncommon", False, "White tiger cub variant"),
        ("Bashful Koala Medium", "Jellycat", "Bashful", 'Medium 31cm', 32, "Common", False, "Grey koala with ears"),
        ("Bashful Lion Medium", "Jellycat", "Bashful", 'Medium 31cm', 34, "Common", False, "Tawny lion with mane"),
        ("Bashful Otter Medium", "Jellycat", "Bashful", 'Medium 31cm', 32, "Common", False, "Brown otter with flippers"),
        ("Bashful Unicorn Medium", "Jellycat", "Bashful", 'Medium 31cm', 32, "Common", False, "White with pink horn"),
        ("Bashful Shark Medium", "Jellycat", "Bashful", 'Medium 31cm', 34, "Common", False, "Grey shark, friendly face"),
        ("Bashful Highland Cow Medium", "Jellycat", "Bashful", 'Medium 31cm', 38, "Common", False, "Ginger shaggy highland cow"),
        ("Odell Octopus Small", "Jellycat", "Odell", 'Small 16cm', 25, "Common", False, "Orange curly-tentacle octopus"),
        ("Odell Octopus Medium", "Jellycat", "Odell", 'Medium 23cm', 40, "Common", False, "Orange octopus, 8 cordy legs"),
        ("Odell Octopus Large", "Jellycat", "Odell", 'Large 45cm', 60, "Uncommon", False, "Orange oversize octopus"),
        ("If I Were a Bunny Book", "Jellycat", "If I Were a", 'Book 22cm', 22, "Common", False, "Board book with plush bunny"),
        ("If I Were a Mouse Book", "Jellycat", "If I Were a", 'Book 22cm', 22, "Common", False, "Board book plush mouse"),
        ("If I Were a Cat Book", "Jellycat", "If I Were a", 'Book 22cm', 22, "Common", False, "Board book plush cat"),
        ("If I Were a Unicorn Book", "Jellycat", "If I Were a", 'Book 22cm', 22, "Common", False, "Board book plush unicorn"),
        ("If I Were a Dog Book", "Jellycat", "If I Were a", 'Book 22cm', 22, "Common", False, "Board book plush puppy"),
        ("Flower Parsley Phil", "Jellycat", "Flower Parsley", 'Small 13cm', 22, "Common", False, "Parsley-pot character"),
        ("Flower Tulip Tom", "Jellycat", "Flower Parsley", 'Small 20cm', 24, "Common", False, "Tulip plush in pot"),
        ("Flower Daisy Dan", "Jellycat", "Flower Parsley", 'Small 20cm', 24, "Common", False, "Daisy potted plush"),
        ("Flower Sunflower Sam", "Jellycat", "Flower Parsley", 'Medium 30cm', 30, "Uncommon", False, "Large smiling sunflower"),
        ("Amuseable Pear", "Jellycat", "Amuseable", 'Small 20cm', 22, "Common", False, "Green pear with stem"),
        ("Amuseable Peach", "Jellycat", "Amuseable", 'Small 18cm', 24, "Common", False, "Pink peach character"),
        ("Amuseable Mango", "Jellycat", "Amuseable", 'Medium 22cm', 26, "Common", False, "Yellow mango plush"),
        ("Amuseable Coconut", "Jellycat", "Amuseable", 'Medium 20cm', 28, "Uncommon", False, "Split coconut smiling"),
        ("Amuseable Coffee To Go", "Jellycat", "Amuseable", 'Medium 20cm', 28, "Common", False, "Take-away cup with sleeve"),
        ("Amuseable Espresso Cup", "Jellycat", "Amuseable", 'Small 10cm', 20, "Common", False, "Mini espresso cup"),
        ("Amuseable Croissant", "Jellycat", "Amuseable", 'Medium 15cm', 26, "Common", False, "Buttery croissant plush"),
        ("Amuseable Bagel", "Jellycat", "Amuseable", 'Small 14cm', 22, "Common", False, "Sesame bagel character"),
        ("Amuseable Pancakes", "Jellycat", "Amuseable", 'Small 12cm', 24, "Common", False, "Stack of pancakes with butter"),
        ("Amuseable Ramen", "Jellycat", "Amuseable", 'Small 12cm', 28, "Uncommon", False, "Bowl of ramen character"),
        ("Amuseable Boba Tea", "Jellycat", "Amuseable", 'Small 16cm', 28, "Uncommon", False, "Bubble tea with pearls"),
        ("Jellycat Harrods Bear London", "Jellycat", "Harrods Exclusive", 'Medium 30cm', 55, "Rare", False, "Harrods London exclusive bear"),
        ("Jellycat Liberty Betsy Bunny", "Jellycat", "Liberty Collab", 'Medium 30cm', 60, "Rare", True, "Liberty Betsy floral, retired"),

        # ── Build-A-Bear licensed deep cuts (35) ─────────────────────────────
        ("Build-A-Bear Charizard", "Build-A-Bear", "Pokemon", 'Standard 45cm', 70, "Rare", False, "Flame-tail Charizard"),
        ("Build-A-Bear Mew", "Build-A-Bear", "Pokemon", 'Standard 35cm', 60, "Rare", True, "Pink Mew, online exclusive"),
        ("Build-A-Bear Meowth", "Build-A-Bear", "Pokemon", 'Standard 35cm', 55, "Uncommon", False, "Gold coin forehead"),
        ("Build-A-Bear Dragonair", "Build-A-Bear", "Pokemon", 'Standard 40cm', 58, "Uncommon", False, "Blue serpent Pokemon"),
        ("Build-A-Bear Sylveon", "Build-A-Bear", "Pokemon", 'Standard 40cm', 55, "Uncommon", False, "Fairy-type Eeveelution"),
        ("Build-A-Bear Umbreon", "Build-A-Bear", "Pokemon", 'Standard 40cm', 58, "Uncommon", False, "Dark Eeveelution"),
        ("Build-A-Bear Flareon", "Build-A-Bear", "Pokemon", 'Standard 40cm', 55, "Uncommon", False, "Fire Eeveelution"),
        ("Build-A-Bear Vaporeon", "Build-A-Bear", "Pokemon", 'Standard 40cm', 55, "Uncommon", False, "Water Eeveelution"),
        ("Build-A-Bear Jolteon", "Build-A-Bear", "Pokemon", 'Standard 40cm', 55, "Uncommon", False, "Electric Eeveelution"),
        ("Build-A-Bear Mimikyu", "Build-A-Bear", "Pokemon", 'Standard 35cm', 60, "Rare", False, "Disguised Mimikyu"),
        ("Build-A-Bear Mickey Mouse 90th", "Build-A-Bear", "Disney", 'Standard 40cm', 60, "Rare", True, "90th anniversary Mickey, retired"),
        ("Build-A-Bear Minnie Mouse Classic", "Build-A-Bear", "Disney", 'Standard 40cm', 45, "Common", False, "Polka-dot Minnie"),
        ("Build-A-Bear Angel (Lilo & Stitch)", "Build-A-Bear", "Disney", 'Standard 40cm', 50, "Uncommon", True, "Pink Angel Stitch, retired"),
        ("Build-A-Bear Scrump (Lilo & Stitch)", "Build-A-Bear", "Disney", 'Standard 38cm', 55, "Rare", True, "Ragdoll Scrump, exclusive"),
        ("Build-A-Bear Simba", "Build-A-Bear", "Disney", 'Standard 40cm', 45, "Uncommon", False, "Lion King cub"),
        ("Build-A-Bear Nala", "Build-A-Bear", "Disney", 'Standard 40cm', 45, "Uncommon", False, "Lion King Nala"),
        ("Build-A-Bear Darth Vader", "Build-A-Bear", "Star Wars", 'Standard 45cm', 60, "Rare", True, "Vader with helmet and cape, retired"),
        ("Build-A-Bear Chewbacca", "Build-A-Bear", "Star Wars", 'Standard 45cm', 55, "Uncommon", True, "Wookiee plush, retired"),
        ("Build-A-Bear Porg", "Build-A-Bear", "Star Wars", 'Standard 30cm', 50, "Uncommon", True, "Last Jedi porg, retired"),
        ("Build-A-Bear BB-8", "Build-A-Bear", "Star Wars", 'Standard 35cm', 50, "Uncommon", True, "Droid BB-8 plush"),
        ("Build-A-Bear Harry Potter Hedwig", "Build-A-Bear", "Harry Potter", 'Standard 35cm', 55, "Uncommon", True, "Snowy owl with letter"),
        ("Build-A-Bear Hogwarts Bear (Gryffindor)", "Build-A-Bear", "Harry Potter", 'Standard 40cm', 60, "Rare", False, "Bear in Gryffindor robes"),
        ("Build-A-Bear Hogwarts Bear (Slytherin)", "Build-A-Bear", "Harry Potter", 'Standard 40cm', 60, "Rare", False, "Bear in Slytherin robes"),
        ("Build-A-Bear Hogwarts Bear (Ravenclaw)", "Build-A-Bear", "Harry Potter", 'Standard 40cm', 65, "Rare", True, "Bear in Ravenclaw robes"),
        ("Build-A-Bear Hogwarts Bear (Hufflepuff)", "Build-A-Bear", "Harry Potter", 'Standard 40cm', 60, "Rare", False, "Bear in Hufflepuff robes"),
        ("Build-A-Bear Fluffy Three-Headed Dog", "Build-A-Bear", "Harry Potter", 'Large 40cm', 80, "Rare", True, "Three-head Fluffy, retired"),
        ("Build-A-Bear Captain America Bear", "Build-A-Bear", "Marvel", 'Standard 40cm', 55, "Uncommon", True, "Shield accessory, retired"),
        ("Build-A-Bear Iron Man Bear", "Build-A-Bear", "Marvel", 'Standard 40cm', 55, "Uncommon", True, "Armor suit bear, retired"),
        ("Build-A-Bear Hulk Bear", "Build-A-Bear", "Marvel", 'Standard 40cm', 55, "Uncommon", True, "Green Hulk bear, retired"),
        ("Build-A-Bear Thor Bear", "Build-A-Bear", "Marvel", 'Standard 40cm', 55, "Uncommon", True, "Mjolnir hammer included"),
        ("Build-A-Bear Halloween Pumpkin Bear", "Build-A-Bear", "Seasonal", 'Standard 35cm', 45, "Uncommon", True, "Seasonal pumpkin bear"),
        ("Build-A-Bear Easter Bunny 2023", "Build-A-Bear", "Seasonal", 'Standard 38cm', 42, "Uncommon", True, "Pastel Easter bunny"),
        ("Build-A-Bear Christmas Polar Bear", "Build-A-Bear", "Seasonal", 'Standard 40cm', 45, "Uncommon", True, "Holiday white polar bear"),
        ("Build-A-Bear Thanksgiving Turkey", "Build-A-Bear", "Seasonal", 'Standard 35cm', 50, "Rare", True, "Turkey plush, very limited"),
        ("Build-A-Bear Valentine Heart Bear", "Build-A-Bear", "Seasonal", 'Standard 38cm', 40, "Uncommon", False, "Red bear with hearts"),

        # ── Squishmallows rare/retired (30) ───────────────────────────────────
        ("Avocado Austin the Avocado", "Squishmallows", "Fruit Squad", '16"', 85, "Rare", True, "Retired avocado, HTF 16in"),
        ("Axolotl Archie Tie-Dye", "Squishmallows", "Select Series", '16"', 95, "Rare", True, "Tie-dye Archie variant"),
        ("Cam the Cat Original 16in", "Squishmallows", "Original Squad", '16"', 80, "Rare", True, "Calico Cam, 16in retired"),
        ("Dante Dinosaur Green", "Squishmallows", "Original Squad", '16"', 55, "Uncommon", False, "Green dino"),
        ("Hans the Hippo", "Squishmallows", "Original Squad", '12"', 35, "Uncommon", False, "Grey hippo"),
        ("Leonard the Lion", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Tawny lion"),
        ("Prince the Frog (Crowned)", "Squishmallows", "Select Series", '12"', 75, "Rare", True, "Crowned frog, retired 2021"),
        ("Ricky the Raccoon", "Squishmallows", "Original Squad", '12"', 32, "Uncommon", False, "Grey raccoon"),
        ("Stan the Stegosaurus", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Green stegosaurus"),
        ("Tally the Turkey", "Squishmallows", "Thanksgiving Squad", '12"', 55, "Rare", True, "Fall seasonal, retired"),
        ("Vanellope the Ghost", "Squishmallows", "Halloween Squad", '12"', 65, "Rare", True, "White ghost, retired 2020"),
        ("Winston the Owl", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Brown owl"),
        ("Yuki the Yeti", "Squishmallows", "Mystical Squad", '12"', 40, "Uncommon", False, "White yeti"),
        ("Zara the Zebra", "Squishmallows", "Original Squad", '12"', 32, "Uncommon", False, "Black/white zebra"),
        ("Athena the Owl", "Squishmallows", "Original Squad", '12"', 40, "Uncommon", True, "Grey owl, retired"),
        ("Brooklynn the Shark", "Squishmallows", "Sea Life Squad", '12"', 35, "Uncommon", False, "Pink whale shark"),
        ("Cameron the Cat (Purple)", "Squishmallows", "Valentine Squad", '12"', 45, "Rare", True, "Purple Cam Valentine"),
        ("Dao the Red Panda", "Squishmallows", "Original Squad", '12"', 40, "Uncommon", False, "Red panda"),
        ("Fifi the Fox Jumbo", "Squishmallows", "Original Squad", '24" Jumbo', 180, "HTF", True, "Jumbo retired Fifi"),
        ("Holiday Gingerbread Nadine", "Squishmallows", "Holiday Squad", '12"', 65, "Rare", True, "Gingerbread girl, retired"),
        ("Jerome the Giraffe", "Squishmallows", "Original Squad", '12"', 35, "Uncommon", False, "Tall giraffe"),
        ("Karina the Koala", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Grey koala"),
        ("Mason the Mallard", "Squishmallows", "Original Squad", '12"', 28, "Common", False, "Standard mallard duck"),
        ("Naomi the Narwhal", "Squishmallows", "Sea Life Squad", '12"', 35, "Uncommon", False, "Pink narwhal"),
        ("Osbourne the Owl (Pink)", "Squishmallows", "Select Series", '12"', 55, "Rare", True, "Pink owl variant"),
        ("Pandora the Panda", "Squishmallows", "Original Squad", '12"', 28, "Common", False, "Black/white panda"),
        ("Quinton the Rabbit", "Squishmallows", "Easter Squad", '12"', 35, "Uncommon", False, "White bunny, Easter"),
        ("Rosie the Fox (Red)", "Squishmallows", "Original Squad", '12"', 35, "Uncommon", True, "Classic red fox, retired"),
        ("Sabrina the Spooky Cat", "Squishmallows", "Halloween Squad", '12"', 45, "Uncommon", False, "Black witch cat"),
        ("Trish the Triceratops", "Squishmallows", "Original Squad", '12"', 32, "Common", False, "Pink triceratops"),

        # ── Sanrio full roster (30) ─────────────────────────────────────────
        ("Hello Kitty Vintage 1976 Repro", "Sanrio", "Hello Kitty Vintage", 'Small 20cm', 75, "Rare", False, "Reproduction of 1976 first plush"),
        ("Hello Kitty Mohair Deluxe", "Sanrio", "Hello Kitty Premium", 'Medium 25cm', 120, "Rare", True, "Mohair plush, retired"),
        ("Hello Kitty Cheerleader", "Sanrio", "Hello Kitty", 'Medium 22cm', 28, "Common", False, "Pom-poms and uniform"),
        ("Hello Kitty Sushi Chef", "Sanrio", "Hello Kitty Japan", 'Medium 22cm', 40, "Uncommon", False, "Sushi hat and apron"),
        ("Hello Kitty Kimono Plush", "Sanrio", "Hello Kitty Japan", 'Medium 25cm', 50, "Uncommon", False, "Pink floral kimono"),
        ("Hello Kitty Angel Wings", "Sanrio", "Hello Kitty", 'Medium 25cm', 30, "Common", False, "White wings and halo"),
        ("Hello Kitty Devil Horns", "Sanrio", "Hello Kitty", 'Medium 25cm', 32, "Common", False, "Red devil outfit"),
        ("Hello Kitty Mermaid", "Sanrio", "Hello Kitty", 'Medium 25cm', 32, "Common", False, "Sparkle mermaid tail"),
        ("Cinnamoroll Large Sitting", "Sanrio", "Cinnamoroll", 'Large 40cm', 55, "Uncommon", False, "Large seated Cinnamoroll"),
        ("Cinnamoroll Cafe Apron", "Sanrio", "Cinnamoroll", 'Medium 25cm', 32, "Common", False, "Barista cinnamoroll"),
        ("Cinnamoroll Strawberry", "Sanrio", "Cinnamoroll", 'Medium 22cm', 30, "Common", False, "Strawberry costume"),
        ("Cinnamoroll Sleeping Mascot", "Sanrio", "Cinnamoroll", 'Small 18cm', 26, "Common", False, "Sleeping pose"),
        ("Kuromi Gothic Dress", "Sanrio", "Kuromi", 'Medium 28cm', 38, "Uncommon", False, "Gothic lolita outfit"),
        ("Kuromi Halloween Pumpkin", "Sanrio", "Kuromi", 'Medium 28cm', 40, "Uncommon", True, "Halloween 2023 retired"),
        ("Kuromi Large Sitting", "Sanrio", "Kuromi", 'Large 40cm', 55, "Uncommon", False, "Large Kuromi sitting"),
        ("Kuromi Baku Companion Set", "Sanrio", "Kuromi", 'Set 20cm/12cm', 50, "Uncommon", False, "Kuromi + Baku pair"),
        ("My Melody Pink Hoodie", "Sanrio", "My Melody", 'Medium 25cm', 30, "Common", False, "Pink hoodie My Melody"),
        ("My Melody Chef Hat", "Sanrio", "My Melody", 'Medium 25cm', 32, "Common", False, "Chef outfit, whisk"),
        ("My Melody Vintage 1980s Repro", "Sanrio", "My Melody Vintage", 'Small 18cm', 65, "Rare", False, "Repro of 1980s original"),
        ("My Melody Large Plush", "Sanrio", "My Melody", 'Large 40cm', 55, "Uncommon", False, "Oversized My Melody"),
        ("Pompompurin Pudding Cup", "Sanrio", "Pompompurin", 'Medium 22cm', 30, "Common", False, "Inside pudding cup"),
        ("Pompompurin Sleeping", "Sanrio", "Pompompurin", 'Medium 25cm', 28, "Common", False, "Lying down pose"),
        ("Pompompurin Large Deluxe", "Sanrio", "Pompompurin", 'Large 40cm', 55, "Uncommon", False, "Deluxe large size"),
        ("Pompompurin 25th Anniversary", "Sanrio", "Pompompurin Anniversary", 'Medium 28cm', 60, "Rare", True, "25th anniversary gold tag"),
        ("Keroppi Classic Plush", "Sanrio", "Keroppi", 'Medium 22cm', 28, "Common", False, "Green frog classic"),
        ("Keroppi Rain Boots", "Sanrio", "Keroppi", 'Medium 22cm', 30, "Common", False, "Raincoat and boots"),
        ("Keroppi Vintage 1988 Plush", "Sanrio", "Keroppi Vintage", 'Small 18cm', 70, "Rare", True, "Vintage 1988 original, retired"),
        ("Keroppi Large Sitting", "Sanrio", "Keroppi", 'Large 38cm', 50, "Uncommon", False, "Oversized Keroppi"),
        ("Chococat Classic Plush", "Sanrio", "Chococat", 'Medium 22cm', 30, "Common", False, "Black cat with big eyes"),
        ("Hangyodon Classic Plush", "Sanrio", "Hangyodon", 'Medium 22cm', 30, "Common", False, "Blue fish-man Sanrio"),

        # ── Pokemon Center Japan deep cuts (35) ──────────────────────────────
        ("Sleeping Pikachu Plush (Japan)", "Pokémon Center", "Sleeping Pikachu", 'Medium 30cm', 45, "Uncommon", False, "Curled-up sleeping Pikachu"),
        ("Sleeping Eevee Plush", "Pokémon Center", "Sleeping Series", 'Medium 28cm', 45, "Uncommon", False, "Sleeping curled Eevee"),
        ("Sleeping Snorlax Plush", "Pokémon Center", "Sleeping Series", 'Medium 30cm', 48, "Uncommon", False, "Belly-up sleeping Snorlax"),
        ("Pokemon Fit Bulbasaur", "Pokémon Center", "Pokemon Fit", 'Small 12cm', 22, "Common", False, "Pokemon Fit Kanto #001"),
        ("Pokemon Fit Ivysaur", "Pokémon Center", "Pokemon Fit", 'Small 14cm', 22, "Common", False, "Pokemon Fit Kanto #002"),
        ("Pokemon Fit Venusaur", "Pokémon Center", "Pokemon Fit", 'Small 16cm', 26, "Uncommon", False, "Pokemon Fit Kanto #003"),
        ("Pokemon Fit Charmander", "Pokémon Center", "Pokemon Fit", 'Small 12cm', 22, "Common", False, "Pokemon Fit Kanto #004"),
        ("Pokemon Fit Charmeleon", "Pokémon Center", "Pokemon Fit", 'Small 14cm', 24, "Common", False, "Pokemon Fit Kanto #005"),
        ("Pokemon Fit Charizard", "Pokémon Center", "Pokemon Fit", 'Small 18cm', 40, "Rare", True, "Pokemon Fit, highly sought"),
        ("Pokemon Fit Squirtle", "Pokémon Center", "Pokemon Fit", 'Small 12cm', 22, "Common", False, "Pokemon Fit Kanto #007"),
        ("Pokemon Fit Wartortle", "Pokémon Center", "Pokemon Fit", 'Small 14cm', 24, "Common", False, "Pokemon Fit Kanto #008"),
        ("Pokemon Fit Blastoise", "Pokémon Center", "Pokemon Fit", 'Small 16cm', 28, "Uncommon", False, "Pokemon Fit Kanto #009"),
        ("Pokemon Fit Mewtwo", "Pokémon Center", "Pokemon Fit", 'Small 16cm', 36, "Uncommon", False, "Pokemon Fit legendary"),
        ("Pokemon Fit Mew", "Pokémon Center", "Pokemon Fit", 'Small 12cm', 32, "Uncommon", False, "Pokemon Fit pink Mew"),
        ("Pokemon Fit Jigglypuff", "Pokémon Center", "Pokemon Fit", 'Small 12cm', 22, "Common", False, "Pokemon Fit Jigglypuff"),
        ("Pokemon Fit Gengar", "Pokémon Center", "Pokemon Fit", 'Small 14cm', 28, "Uncommon", False, "Pokemon Fit ghost"),
        ("Life-Size Eevee Plush", "Pokémon Center", "Life-Size", 'Life-Size 40cm', 220, "Rare", False, "Real-size Eevee, Japan"),
        ("Life-Size Pikachu Plush", "Pokémon Center", "Life-Size", 'Life-Size 40cm', 200, "Rare", False, "Real-size Pikachu, Japan"),
        ("Life-Size Mimikyu Plush", "Pokémon Center", "Life-Size", 'Life-Size 40cm', 250, "Rare", True, "Real-size Mimikyu, retired"),
        ("Life-Size Psyduck Plush", "Pokémon Center", "Life-Size", 'Life-Size 55cm', 230, "Rare", False, "Real-size Psyduck"),
        ("Life-Size Cubone Plush", "Pokémon Center", "Life-Size", 'Life-Size 40cm', 240, "Rare", True, "Real-size Cubone, retired"),
        ("Pikachu Cafe Plush (Japan Cafe)", "Pokémon Center", "Pokemon Cafe", 'Medium 25cm', 60, "Rare", True, "Pokemon Cafe exclusive"),
        ("Eevee Cafe Plush (Japan Cafe)", "Pokémon Center", "Pokemon Cafe", 'Medium 25cm', 55, "Rare", True, "Pokemon Cafe exclusive"),
        ("Hisuian Zorua Plush", "Pokémon Center", "Legends Arceus", 'Medium 25cm', 40, "Uncommon", False, "Legends Arceus exclusive"),
        ("Paldean Wooper Plush", "Pokémon Center", "Scarlet/Violet", 'Medium 22cm', 32, "Common", False, "Brown Paldean Wooper"),
        ("Applin Plush", "Pokémon Center", "Galar", 'Small 15cm', 28, "Common", False, "Apple Pokemon"),
        ("Wooloo Plush Large", "Pokémon Center", "Galar", 'Large 35cm', 55, "Uncommon", False, "Fluffy Wooloo sheep"),
        ("Scorbunny Plush", "Pokémon Center", "Galar", 'Medium 25cm', 35, "Uncommon", False, "Galar fire starter"),
        ("Grookey Plush", "Pokémon Center", "Galar", 'Medium 25cm', 35, "Uncommon", False, "Galar grass starter"),
        ("Sobble Plush", "Pokémon Center", "Galar", 'Medium 25cm', 35, "Uncommon", False, "Galar water starter"),
        ("Sprigatito Plush", "Pokémon Center", "Paldea", 'Medium 25cm', 38, "Uncommon", False, "Paldea grass starter"),
        ("Fuecoco Plush", "Pokémon Center", "Paldea", 'Medium 25cm', 38, "Uncommon", False, "Paldea fire starter"),
        ("Quaxly Plush", "Pokémon Center", "Paldea", 'Medium 25cm', 38, "Uncommon", False, "Paldea water starter"),
        ("Ditto Transform Pikachu", "Pokémon Center", "Ditto Transform", 'Small 15cm', 30, "Uncommon", False, "Ditto as Pikachu"),
        ("Ditto Transform Eevee", "Pokémon Center", "Ditto Transform", 'Small 15cm', 30, "Uncommon", False, "Ditto as Eevee"),

        # ── San-X full Rilakkuma / Sumikko / Afro Ken / Kutusita Nyanko (30) ─
        ("Rilakkuma Classic Medium", "San-X", "Rilakkuma", 'Medium 30cm', 35, "Common", False, "Classic brown Rilakkuma"),
        ("Rilakkuma Large Sitting", "San-X", "Rilakkuma", 'Large 45cm', 60, "Uncommon", False, "Oversized sitting Rilakkuma"),
        ("Korilakkuma Classic Medium", "San-X", "Rilakkuma", 'Medium 28cm', 32, "Common", False, "White baby bear"),
        ("Korilakkuma Large", "San-X", "Rilakkuma", 'Large 40cm', 55, "Uncommon", False, "Large Korilakkuma"),
        ("Kiiroitori Small", "San-X", "Rilakkuma", 'Small 15cm', 18, "Common", False, "Small yellow chick"),
        ("Rilakkuma Strawberry Day", "San-X", "Rilakkuma Seasonal", 'Medium 25cm', 40, "Uncommon", True, "Strawberry series, retired"),
        ("Rilakkuma Onsen Hot Spring", "San-X", "Rilakkuma Seasonal", 'Medium 25cm', 42, "Uncommon", False, "Onsen towel theme"),
        ("Rilakkuma Sakura Spring", "San-X", "Rilakkuma Seasonal", 'Medium 25cm', 40, "Uncommon", True, "Cherry blossom theme"),
        ("Rilakkuma Halloween Pumpkin", "San-X", "Rilakkuma Seasonal", 'Medium 25cm', 42, "Uncommon", True, "Halloween retired"),
        ("Rilakkuma Christmas Santa", "San-X", "Rilakkuma Seasonal", 'Medium 25cm', 40, "Uncommon", True, "Santa hat, retired"),
        ("Sumikko Gurashi Shirokuma", "San-X", "Sumikko Gurashi", 'Medium 22cm', 30, "Common", False, "Shy polar bear corner"),
        ("Sumikko Gurashi Penguin?", "San-X", "Sumikko Gurashi", 'Medium 22cm', 30, "Common", False, "Uncertain penguin"),
        ("Sumikko Gurashi Tonkatsu", "San-X", "Sumikko Gurashi", 'Medium 18cm', 28, "Common", False, "Pork cutlet corner"),
        ("Sumikko Gurashi Neko", "San-X", "Sumikko Gurashi", 'Medium 22cm', 30, "Common", False, "Ginger cat corner"),
        ("Sumikko Gurashi Tokage Lizard", "San-X", "Sumikko Gurashi", 'Medium 22cm', 30, "Common", False, "Hiding dino as lizard"),
        ("Sumikko Gurashi Ebifurai no Shippo", "San-X", "Sumikko Gurashi", 'Small 15cm', 22, "Common", False, "Shrimp tail corner"),
        ("Sumikko Gurashi Hokori Dust", "San-X", "Sumikko Gurashi", 'Small 12cm', 18, "Common", False, "Dust bunny character"),
        ("Sumikko Gurashi Zasso Weed", "San-X", "Sumikko Gurashi", 'Small 15cm', 20, "Common", False, "Shy weed character"),
        ("Sumikko Gurashi Furoshiki Set", "San-X", "Sumikko Gurashi", 'Set 12cm each', 60, "Uncommon", True, "All 5 in furoshiki, retired"),
        ("Sumikko Gurashi Tapioka Pink", "San-X", "Sumikko Gurashi", 'Mini 8cm', 12, "Common", False, "Pink tapioca ball"),
        ("Sumikko Gurashi Tapioka White", "San-X", "Sumikko Gurashi", 'Mini 8cm', 12, "Common", False, "White tapioca ball"),
        ("Afro Ken Classic Plush", "San-X", "Afro Ken", 'Medium 20cm', 28, "Common", False, "Rainbow afro dog"),
        ("Afro Ken Rainbow Large", "San-X", "Afro Ken", 'Large 35cm', 55, "Uncommon", True, "Large rainbow afro, retired"),
        ("Afro Ken Pastel Variant", "San-X", "Afro Ken", 'Medium 20cm', 35, "Uncommon", True, "Pastel color retired"),
        ("Kutusita Nyanko Black", "San-X", "Kutusita Nyanko", 'Medium 20cm', 32, "Uncommon", False, "Black cat in socks"),
        ("Kutusita Nyanko White", "San-X", "Kutusita Nyanko", 'Medium 20cm', 32, "Uncommon", False, "White cat in socks"),
        ("Kutusita Nyanko Chef", "San-X", "Kutusita Nyanko", 'Medium 20cm', 38, "Uncommon", True, "Chef outfit retired"),
        ("Mamegoma Baby Seal Pink", "San-X", "Mamegoma", 'Small 15cm', 22, "Common", False, "Pink baby seal"),
        ("Mamegoma Baby Seal White", "San-X", "Mamegoma", 'Small 15cm', 22, "Common", False, "White baby seal"),
        ("Mamegoma Baby Seal Set (5pc)", "San-X", "Mamegoma", 'Set 12cm each', 55, "Uncommon", True, "All 5 colors, retired"),

        # ── KAWS plush (15) ─────────────────────────────────────────────────
        ("KAWS BFF Brown", "KAWS", "BFF", 'Large 33cm', 320, "HTF", True, "Brown BFF, retired drop"),
        ("KAWS BFF Pink", "KAWS", "BFF", 'Large 33cm', 380, "HTF", True, "Pink BFF, retired"),
        ("KAWS BFF Blue", "KAWS", "BFF", 'Large 33cm', 350, "HTF", True, "Blue BFF, retired"),
        ("KAWS Holiday UK Plush", "KAWS", "Holiday", 'Large 34cm', 420, "Grail", True, "UK Tower Bridge, LE"),
        ("KAWS Holiday Japan Plush", "KAWS", "Holiday", 'Large 34cm', 450, "Grail", True, "Mt. Fuji Japan, LE"),
        ("KAWS Holiday Hong Kong Plush", "KAWS", "Holiday", 'Large 34cm', 400, "Grail", True, "Victoria Harbour, LE"),
        ("KAWS Holiday Taipei Plush", "KAWS", "Holiday", 'Large 34cm', 420, "Grail", True, "Taipei exclusive, LE"),
        ("KAWS Holiday Changbai Mountain", "KAWS", "Holiday", 'Large 34cm', 380, "Grail", True, "Changbai mountain LE"),
        ("KAWS What Party Pink Plush", "KAWS", "What Party", 'Medium 25cm', 220, "Rare", True, "What Party pink"),
        ("KAWS What Party Black Plush", "KAWS", "What Party", 'Medium 25cm', 200, "Rare", True, "What Party black"),
        ("KAWS What Party White Plush", "KAWS", "What Party", 'Medium 25cm', 240, "Rare", True, "What Party white"),
        ("KAWS Sesame Street Elmo", "KAWS", "Sesame Street", 'Medium 30cm', 180, "Rare", True, "KAWS x Uniqlo Elmo"),
        ("KAWS Sesame Street Cookie Monster", "KAWS", "Sesame Street", 'Medium 30cm', 180, "Rare", True, "KAWS x Uniqlo Cookie Monster"),
        ("KAWS Sesame Street Bert & Ernie Set", "KAWS", "Sesame Street", 'Medium 30cm set', 280, "Rare", True, "KAWS x Uniqlo B&E pair"),
        ("KAWS Accomplice Plush", "KAWS", "Accomplice", 'Medium 28cm', 300, "HTF", True, "Bunny Accomplice figure"),

        # ── Disney Parks Duffy & Friends (20) ────────────────────────────────
        ("Duffy the Disney Bear Classic", "Disney", "Duffy & Friends", 'Medium 28cm', 55, "Uncommon", False, "Classic brown Duffy, Disney Parks"),
        ("Duffy Bear Large Deluxe", "Disney", "Duffy & Friends", 'Large 45cm', 95, "Rare", False, "Large Duffy, Disney Parks"),
        ("ShellieMay Bear Classic", "Disney", "Duffy & Friends", 'Medium 28cm', 55, "Uncommon", False, "Duffy's friend pink bear"),
        ("ShellieMay Bear Large", "Disney", "Duffy & Friends", 'Large 45cm', 90, "Rare", False, "Large ShellieMay"),
        ("Gelatoni Cat Classic", "Disney", "Duffy & Friends", 'Medium 28cm', 60, "Rare", False, "Green artist cat, Japan parks"),
        ("Gelatoni Cat Large", "Disney", "Duffy & Friends", 'Large 45cm', 110, "Rare", True, "Oversized Gelatoni, retired"),
        ("StellaLou Rabbit Classic", "Disney", "Duffy & Friends", 'Medium 30cm', 65, "Rare", False, "Purple ballet rabbit"),
        ("StellaLou Rabbit Large", "Disney", "Duffy & Friends", 'Large 50cm', 120, "Rare", True, "Oversized StellaLou, retired"),
        ("CookieAnn Dog Classic", "Disney", "Duffy & Friends", 'Medium 28cm', 60, "Rare", False, "Yellow chef dog"),
        ("CookieAnn Dog Large", "Disney", "Duffy & Friends", 'Large 45cm', 110, "Rare", True, "Large CookieAnn"),
        ("Olu Mel Turtle Classic", "Disney", "Duffy & Friends", 'Medium 28cm', 65, "Rare", False, "Aulani green turtle"),
        ("Olu Mel Turtle Large", "Disney", "Duffy & Friends", 'Large 45cm', 120, "Rare", True, "Large Olu Mel, retired"),
        ("Linabell Pink Fox", "Disney", "Duffy & Friends", 'Medium 30cm', 85, "Rare", False, "Linabell pink fox, Shanghai"),
        ("Linabell Large Deluxe", "Disney", "Duffy & Friends", 'Large 45cm', 180, "HTF", False, "Large Linabell, scalped"),
        ("Linabell Jumbo", "Disney", "Duffy & Friends", 'Jumbo 60cm', 320, "HTF", False, "Jumbo Linabell, Shanghai LE"),
        ("Linabell Costume Apron Set", "Disney", "Duffy & Friends", 'Medium 30cm', 110, "Rare", True, "With outfit, Shanghai exclusive"),
        ("Duffy Halloween Costume 2023", "Disney", "Duffy & Friends", 'Medium 28cm', 75, "Rare", True, "Halloween costume Duffy"),
        ("ShellieMay Christmas 2022", "Disney", "Duffy & Friends", 'Medium 28cm', 70, "Rare", True, "Christmas ShellieMay retired"),
        ("Gelatoni Artist Smock Edition", "Disney", "Duffy & Friends", 'Medium 28cm', 75, "Rare", True, "Paint palette accessory"),
        ("StellaLou Ballet Tutu Edition", "Disney", "Duffy & Friends", 'Medium 30cm', 80, "Rare", True, "Tutu outfit, Tokyo LE"),

        # ── Studio Ghibli plush (25) ─────────────────────────────────────────
        ("Totoro Big Grey Classic", "Ghibli", "My Neighbor Totoro", 'Medium 30cm', 45, "Uncommon", False, "Classic O-Totoro"),
        ("Totoro Medium Blue (Chu-Totoro)", "Ghibli", "My Neighbor Totoro", 'Medium 25cm', 40, "Uncommon", False, "Blue medium Chu-Totoro"),
        ("Totoro White Small (Chibi-Totoro)", "Ghibli", "My Neighbor Totoro", 'Small 18cm', 30, "Common", False, "White Chibi-Totoro"),
        ("Totoro Large Deluxe", "Ghibli", "My Neighbor Totoro", 'Large 50cm', 95, "Rare", False, "Oversized grey Totoro"),
        ("Totoro Jumbo Sitting", "Ghibli", "My Neighbor Totoro", 'Jumbo 70cm', 220, "HTF", False, "Jumbo Totoro Japan"),
        ("Totoro With Leaf Umbrella", "Ghibli", "My Neighbor Totoro", 'Medium 28cm', 55, "Rare", False, "Totoro holding leaf"),
        ("Catbus Plush", "Ghibli", "My Neighbor Totoro", 'Large 40cm', 75, "Rare", False, "Catbus with windows"),
        ("Catbus Jumbo", "Ghibli", "My Neighbor Totoro", 'Jumbo 60cm', 180, "HTF", True, "Jumbo Catbus retired"),
        ("Soot Sprite Makkurokurosuke Set", "Ghibli", "Ghibli Characters", 'Set Mini 10cm', 40, "Common", False, "Black soot sprite set"),
        ("Kiki from Kiki's Delivery Service", "Ghibli", "Kiki's Delivery Service", 'Medium 30cm', 55, "Rare", False, "Kiki in red bow"),
        ("Jiji Black Cat Classic", "Ghibli", "Kiki's Delivery Service", 'Medium 28cm', 45, "Uncommon", False, "Jiji black cat plush"),
        ("Jiji Large Sitting", "Ghibli", "Kiki's Delivery Service", 'Large 40cm', 80, "Rare", False, "Large Jiji"),
        ("Jiji Lying Down", "Ghibli", "Kiki's Delivery Service", 'Medium 30cm', 50, "Uncommon", False, "Lying Jiji pose"),
        ("Calcifer Fire Demon Plush", "Ghibli", "Howl's Moving Castle", 'Small 18cm', 55, "Rare", False, "Calcifer fire demon"),
        ("Calcifer Large Plush", "Ghibli", "Howl's Moving Castle", 'Medium 28cm', 80, "Rare", True, "Large Calcifer, retired"),
        ("No-Face Kaonashi Classic", "Ghibli", "Spirited Away", 'Medium 30cm', 55, "Rare", False, "Classic No-Face"),
        ("No-Face Large Plush", "Ghibli", "Spirited Away", 'Large 45cm', 95, "Rare", False, "Large No-Face"),
        ("No-Face Jumbo Sitting", "Ghibli", "Spirited Away", 'Jumbo 60cm', 200, "HTF", True, "Jumbo No-Face, retired"),
        ("Boh Mouse Plush", "Ghibli", "Spirited Away", 'Small 15cm', 35, "Uncommon", False, "Tiny mouse Boh"),
        ("Haku Dragon Plush", "Ghibli", "Spirited Away", 'Medium 30cm', 60, "Rare", False, "White dragon Haku"),
        ("Ponyo Classic Plush", "Ghibli", "Ponyo", 'Medium 25cm', 40, "Uncommon", False, "Red fish-girl Ponyo"),
        ("Kodama Princess Mononoke Set", "Ghibli", "Princess Mononoke", 'Small 12cm set', 50, "Uncommon", False, "Tree spirit set of 3"),
        ("Heen Dog Howl's Castle", "Ghibli", "Howl's Moving Castle", 'Medium 22cm', 50, "Rare", True, "Grandma's dog, retired"),
        ("Marco Porco Rosso Plush", "Ghibli", "Porco Rosso", 'Medium 25cm', 55, "Rare", True, "Porco Rosso pig, retired"),
        ("Laputa Robot Soldier Plush", "Ghibli", "Castle in the Sky", 'Medium 30cm', 70, "Rare", True, "Laputa robot, retired"),

        # ── Vintage teddy bears Steiff/Merrythought (20) ─────────────────────
        ("Steiff Original Teddy Button-In-Ear 28cm", "Steiff", "Classic", 'Medium 28cm', 180, "Uncommon", False, "Classic gold mohair, button-in-ear"),
        ("Steiff Original Teddy 35cm", "Steiff", "Classic", 'Medium 35cm', 230, "Uncommon", False, "Classic 35cm gold mohair"),
        ("Steiff Jackie Bear 50th Anniversary", "Steiff", "Heritage", 'Medium 30cm', 280, "Rare", True, "Jackie anniversary, LE 1953"),
        ("Steiff Zotty Bear Vintage", "Steiff", "Heritage", 'Medium 28cm', 240, "Rare", True, "Vintage Zotty with open mouth"),
        ("Steiff Charly Bear Vintage", "Steiff", "Heritage", 'Medium 30cm', 200, "Rare", True, "Vintage Charly brown bear"),
        ("Steiff 100 Years Teddy", "Steiff", "Anniversary", 'Medium 32cm', 350, "Grail", True, "100 year LE, certificate"),
        ("Steiff Petsy Bear Replica", "Steiff", "Replica", 'Medium 28cm', 260, "Rare", True, "1928 Petsy replica"),
        ("Steiff Alfonzo Red Mohair", "Steiff", "Replica", 'Medium 30cm', 400, "Grail", True, "Alfonzo red mohair replica"),
        ("Steiff Happy Anniversary Bear", "Steiff", "Anniversary", 'Medium 30cm', 220, "Rare", True, "Wedding anniversary bear"),
        ("Merrythought Cheeky Bear Classic", "Merrythought", "Cheeky", 'Medium 28cm', 180, "Rare", False, "Bells in ears, UK heritage"),
        ("Merrythought Cheeky Bear Jumbo", "Merrythought", "Cheeky", 'Large 45cm', 320, "Rare", True, "Jumbo Cheeky, retired"),
        ("Merrythought Punkinhead Bear", "Merrythought", "Punkinhead", 'Medium 28cm', 200, "Rare", True, "Vintage Punkinhead replica"),
        ("Merrythought Edward Bear", "Merrythought", "Edward", 'Medium 30cm', 220, "Rare", True, "English Edward mohair"),
        ("Merrythought Harrods Annual 2022", "Merrythought", "Harrods", 'Medium 30cm', 240, "Rare", True, "Harrods 2022 annual bear"),
        ("Merrythought Harrods Annual 2023", "Merrythought", "Harrods", 'Medium 30cm', 220, "Rare", False, "Harrods 2023 annual bear"),
        ("Merrythought Guardsman Teddy", "Merrythought", "Licensed", 'Medium 28cm', 160, "Uncommon", False, "Royal Guard uniform"),
        ("Steiff Original Golden Teddy 40cm", "Steiff", "Classic", 'Large 40cm', 260, "Uncommon", False, "40cm gold mohair"),
        ("Steiff Teddy Baby Replica", "Steiff", "Replica", 'Small 20cm', 160, "Rare", True, "Vintage Teddy Baby replica"),
        ("Steiff Teddy Rose Replica", "Steiff", "Replica", 'Medium 26cm', 240, "Rare", True, "1925 Teddy Rose replica"),
        ("Steiff Paddington 50th", "Steiff", "Licensed", 'Medium 28cm', 200, "Rare", True, "Paddington 50th LE"),

        # ── Ty Beanie Babies rare (15) ───────────────────────────────────────
        ("Princess Diana Bear Purple", "TY Beanie Babies", "Princess", 'Standard 20cm', 150, "Rare", True, "Royal purple Diana bear"),
        ("Halo the Angel Bear", "TY Beanie Babies", "Retired", 'Standard 20cm', 80, "Uncommon", True, "White angel with halo"),
        ("Hope the Prayer Bear", "TY Beanie Babies", "Retired", 'Standard 20cm', 60, "Uncommon", True, "Brown praying hands bear"),
        ("1997 Teddy Holiday Bear", "TY Beanie Babies", "Holiday", 'Standard 20cm', 75, "Uncommon", True, "1997 red Xmas teddy"),
        ("Glory the Bear (USA flag)", "TY Beanie Babies", "Retired", 'Standard 20cm', 90, "Rare", True, "USA flag teddy, retired"),
        ("Maple the Bear (Canada)", "TY Beanie Babies", "Exclusive", 'Standard 20cm', 120, "Rare", True, "Canadian exclusive bear"),
        ("Britannia the Bear (UK)", "TY Beanie Babies", "Exclusive", 'Standard 20cm', 110, "Rare", True, "UK exclusive bear"),
        ("Germania the Bear (Germany)", "TY Beanie Babies", "Exclusive", 'Standard 20cm', 130, "Rare", True, "Germany exclusive bear"),
        ("Osito the Bear (Mexico)", "TY Beanie Babies", "Exclusive", 'Standard 20cm', 100, "Rare", True, "Mexico exclusive bear"),
        ("Spangle the Bear White Face", "TY Beanie Babies", "Retired", 'Standard 20cm', 80, "Rare", True, "USA spangle variant"),
        ("Royal Blue Peanut Elephant", "TY Beanie Babies", "Error", 'Standard 20cm', 2500, "Grail", True, "Royal blue dark variant, grail"),
        ("Old Face Teddy Brown", "TY Beanie Babies", "Original 9", 'Standard 20cm', 900, "HTF", True, "Old-face Teddy brown"),
        ("Chilly the Polar Bear 1st Gen", "TY Beanie Babies", "Retired", 'Standard 20cm', 700, "HTF", True, "1st gen polar bear"),
        ("Digger the Crab (Orange)", "TY Beanie Babies", "Retired", 'Standard 20cm', 120, "Rare", True, "Orange variant, retired"),
        ("Tabasco the Bull", "TY Beanie Babies", "Retired", 'Standard 20cm', 150, "Rare", True, "Red bull, renamed Snort"),

        # ── Line Friends / BT21 (25) ────────────────────────────────────────
        ("Line Friends Brown Bear Standard", "Line Friends", "Brown & Friends", 'Medium 30cm', 40, "Common", False, "Brown bear mascot"),
        ("Line Friends Brown Large", "Line Friends", "Brown & Friends", 'Large 45cm', 65, "Uncommon", False, "Large Brown sitting"),
        ("Line Friends Cony Rabbit Standard", "Line Friends", "Brown & Friends", 'Medium 30cm', 40, "Common", False, "White rabbit mascot"),
        ("Line Friends Cony Large", "Line Friends", "Brown & Friends", 'Large 45cm', 65, "Uncommon", False, "Large Cony rabbit"),
        ("Line Friends Sally Duck", "Line Friends", "Brown & Friends", 'Medium 25cm', 35, "Common", False, "Yellow duck Sally"),
        ("Line Friends Sally Large", "Line Friends", "Brown & Friends", 'Large 40cm', 55, "Uncommon", False, "Large Sally duck"),
        ("Line Friends Moon Plush", "Line Friends", "Brown & Friends", 'Medium 25cm', 32, "Common", False, "Yellow moon-faced Moon"),
        ("Line Friends Choco Bear", "Line Friends", "Brown & Friends", 'Medium 28cm', 38, "Uncommon", False, "Brown's sister Choco"),
        ("Line Friends Leonard Frog", "Line Friends", "Brown & Friends", 'Medium 25cm', 35, "Uncommon", False, "Green Leonard frog"),
        ("Line Friends Edward Koala", "Line Friends", "Brown & Friends", 'Medium 25cm', 35, "Uncommon", False, "Edward grey koala"),
        ("BT21 Tata Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 40, "Common", False, "V's Tata red heart alien"),
        ("BT21 Cooky Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 40, "Common", False, "Jungkook's Cooky pink bunny"),
        ("BT21 Chimmy Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 40, "Common", False, "Jimin's Chimmy yellow puppy"),
        ("BT21 Koya Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 40, "Common", False, "RM's Koya blue koala"),
        ("BT21 Shooky Plush Standard", "Line Friends", "BT21", 'Medium 25cm', 40, "Common", False, "Suga's Shooky brown cookie"),
        ("BT21 Mang Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 42, "Common", False, "J-Hope's Mang horse mask"),
        ("BT21 RJ Plush Standard", "Line Friends", "BT21", 'Medium 30cm', 42, "Common", False, "Jin's RJ white alpaca"),
        ("BT21 Van Robot Plush", "Line Friends", "BT21", 'Medium 28cm', 45, "Uncommon", False, "BTS Army robot Van"),
        ("BT21 Tata Large", "Line Friends", "BT21", 'Large 45cm', 75, "Rare", False, "Large BT21 Tata"),
        ("BT21 Cooky Large", "Line Friends", "BT21", 'Large 45cm', 75, "Rare", False, "Large BT21 Cooky"),
        ("BT21 Chimmy Large", "Line Friends", "BT21", 'Large 45cm', 75, "Rare", False, "Large BT21 Chimmy"),
        ("BT21 Baby Tata", "Line Friends", "BT21 Baby", 'Small 18cm', 30, "Common", False, "Baby version Tata"),
        ("BT21 Baby Cooky", "Line Friends", "BT21 Baby", 'Small 18cm', 30, "Common", False, "Baby version Cooky"),
        ("BT21 7-Piece Set Standard", "Line Friends", "BT21", 'Set 20cm each', 250, "Rare", False, "All 7 BT21 characters"),
        ("BT21 7-Piece Baby Set", "Line Friends", "BT21 Baby", 'Set 15cm each', 180, "Uncommon", False, "Baby set of 7"),

        # ── Squishmallow extra seasonal/themed (15) ────────────────────────────
        ("Yetta the Yeti 16in Blue", "Squishmallows", "Mystical Squad", '16"', 65, "Rare", True, "Blue yeti 16in retired"),
        ("Ariella the Axolotl Clip", "Squishmallows", "Original Squad", 'Clip 3.5"', 12, "Common", False, "Axolotl backpack clip"),
        ("Austin the Avocado 8in", "Squishmallows", "Fruit Squad", '8"', 25, "Common", False, "Small avocado"),
        ("Bubba Plum Purple Cow Mini", "Squishmallows", "Original Squad", '5"', 12, "Common", False, "Mini purple cow"),
        ("Elton the Turtle", "Squishmallows", "Sea Life Squad", '12"', 30, "Common", False, "Green turtle"),
        ("Farryn the Fox (Fuzz-a-Mallow)", "Squishmallows", "Fuzzmallow", '12"', 45, "Uncommon", False, "Fuzzy fox variant"),
        ("Gordon the Shark Jumbo", "Squishmallows", "Sea Life Squad", '24" Jumbo', 120, "HTF", False, "Jumbo shark"),
        ("Hannah the Hippo", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Pink hippo"),
        ("Imani the Panther", "Squishmallows", "Original Squad", '12"', 35, "Uncommon", False, "Black panther"),
        ("Jolyne the Jellyfish", "Squishmallows", "Sea Life Squad", '12"', 35, "Uncommon", False, "Pink jellyfish"),
        ("Kevin the Koala", "Squishmallows", "Original Squad", '12"', 30, "Common", False, "Grey koala"),
        ("Libby the Lamb (Fuzzy)", "Squishmallows", "Fuzzmallow", '12"', 40, "Uncommon", False, "Fluffy lamb"),
        ("Mitch the Moose", "Squishmallows", "Original Squad", '12"', 35, "Uncommon", False, "Brown moose"),
        ("Nichelle the Narwhal Pink", "Squishmallows", "Sea Life Squad", '12"', 32, "Common", False, "Pink narwhal"),
        ("Omar the Orca", "Squishmallows", "Sea Life Squad", '12"', 35, "Uncommon", False, "Orca whale"),
    ]
...
def get_curated_catalog() -> list[dict]:
    ...
    # ── Round 8 expansion: ~285 items ──
    items += _round8_plush_expansion()
