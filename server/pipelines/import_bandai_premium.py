...
def _expansion_1000_round35() -> list[tuple]:
    """Round 35 expansion — push to 1000+ items: S.H.Figuarts Marvel/Star Wars,
    Kamen Rider, DX Chogokin Macross, Metal Build Gundam, CSM belts, Proplica."""
    return [
        # ── S.H.Figuarts Marvel ───────────────────────────────────────────
        ("S.H.Figuarts", "Iron Man Mk 50 (Nano Weapon Set)", "Avengers: Infinity War", "Standard", "mid", 90),
        ("S.H.Figuarts", "Iron Man Mk 85 (Final Battle)", "Avengers: Endgame", "Standard", "mid", 95),
        ("S.H.Figuarts", "Spider-Man (No Way Home) Final Swing", "Spider-Man: No Way Home", "Standard", "mid", 80),
        ("S.H.Figuarts", "Captain America (Endgame) Final Battle", "Avengers: Endgame", "Standard", "mid", 85),
        ("S.H.Figuarts", "Thor (Love and Thunder)", "Thor: Love and Thunder", "Standard", "mid", 80),
        ("S.H.Figuarts", "Thanos (Endgame) Final Battle", "Avengers: Endgame", "Standard", "high", 120),
        ("S.H.Figuarts", "Doctor Strange (Multiverse of Madness)", "Doctor Strange MoM", "Standard", "mid", 80),
        ("S.H.Figuarts", "Black Panther (Wakanda Forever)", "Black Panther 2", "Standard", "mid", 85),
        ("S.H.Figuarts", "Deadpool (Movie)", "Deadpool", "Standard", "mid", 90),
        ("S.H.Figuarts", "Wolverine (Deadpool & Wolverine)", "Deadpool & Wolverine", "Standard", "mid", 90),
        ("S.H.Figuarts", "Scarlet Witch (WandaVision)", "WandaVision", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Loki (TVA Variant)", "Loki", "P-Bandai", "mid", 95),

        # ── S.H.Figuarts Star Wars ───────────────────────────────────────
        ("S.H.Figuarts", "Darth Vader (ROTJ) Ver.", "Star Wars: ROTJ", "Standard", "high", 110),
        ("S.H.Figuarts", "Luke Skywalker (ROTJ) Jedi Knight", "Star Wars: ROTJ", "Standard", "mid", 90),
        ("S.H.Figuarts", "Boba Fett (The Book of Boba Fett)", "The Book of Boba Fett", "Standard", "mid", 95),
        ("S.H.Figuarts", "Ahsoka Tano (Ahsoka Series)", "Ahsoka", "Standard", "mid", 85),
        ("S.H.Figuarts", "Obi-Wan Kenobi (ANH)", "Star Wars: ANH", "Standard", "high", 100),
        ("S.H.Figuarts", "Clone Trooper Phase II", "Star Wars: ROTS", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "General Grievous", "Star Wars: ROTS", "Standard", "high", 130),
        ("S.H.Figuarts", "Mace Windu (ROTS)", "Star Wars: ROTS", "P-Bandai", "high", 100),
        ("S.H.Figuarts", "Count Dooku", "Star Wars: AOTC", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Emperor Palpatine (Throne Room)", "Star Wars: ROTJ", "P-Bandai", "high", 100),

        # ── S.H.Figuarts Kamen Rider (More Heisei/Reiwa) ─────────────────
        ("S.H.Figuarts", "Kamen Rider W FangJoker", "Kamen Rider W", "Standard", "mid", 80),
        ("S.H.Figuarts", "Kamen Rider W CycloneJoker Gold Xtreme", "Kamen Rider W", "P-Bandai", "high", 120),
        ("S.H.Figuarts", "Kamen Rider OOO TaJaDor Combo (Eternity)", "Kamen Rider OOO", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Kamen Rider Fourze Base States", "Kamen Rider Fourze", "Standard", "mid", 75),
        ("S.H.Figuarts", "Kamen Rider Wizard Flame Style", "Kamen Rider Wizard", "Standard", "mid", 70),
        ("S.H.Figuarts", "Kamen Rider Gaim Orange Arms", "Kamen Rider Gaim", "Standard", "mid", 75),
        ("S.H.Figuarts", "Kamen Rider Ghost Ore Damashii", "Kamen Rider Ghost", "Standard", "mid", 70),
        ("S.H.Figuarts", "Kamen Rider Ex-Aid Action Gamer Lv. 2", "Kamen Rider Ex-Aid", "Standard", "mid", 75),
        ("S.H.Figuarts", "Kamen Rider Build RabbitTank Sparkling", "Kamen Rider Build", "P-Bandai", "high", 100),
        ("S.H.Figuarts", "Kamen Rider Zi-O (Grand Zi-O)", "Kamen Rider Zi-O", "P-Bandai", "high", 120),
        ("S.H.Figuarts", "Kamen Rider Saber Emotional Dragon", "Kamen Rider Saber", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kamen Rider Revice Rex Genome", "Kamen Rider Revice", "Standard", "mid", 80),

        # ── DX Chogokin Macross ───────────────────────────────────────────
        ("DX Chogokin", "VF-1S Strike Valkyrie (Ichijo)", "Macross", "Standard", "grail", 350),
        ("DX Chogokin", "VF-1A Valkyrie (Hikaru)", "Macross", "Standard", "high", 280),
        ("DX Chogokin", "VF-1J Armored Valkyrie", "Macross", "P-Bandai", "grail", 380),
        ("DX Chogokin", "YF-29 Durandal (Alto Custom)", "Macross Frontier", "Standard", "high", 300),
        ("DX Chogokin", "VF-31J Siegfried (Hayate Custom)", "Macross Delta", "Standard", "high", 280),
        ("DX Chogokin", "VF-31AX Kairos Plus (Hayate)", "Macross Delta Movie", "Standard", "high", 300),
        ("DX Chogokin", "SV-262Hs Draken III (Keith)", "Macross Delta", "P-Bandai", "high", 280),
        ("DX Chogokin", "VF-25F Messiah (Alto) Renewal", "Macross Frontier", "Standard", "high", 280),
        ("DX Chogokin", "VF-25S Messiah (Ozma) Armored Pack", "Macross Frontier", "P-Bandai", "grail", 350),
        ("DX Chogokin", "VF-171EX Nightmare Plus (Luca)", "Macross Frontier", "P-Bandai", "high", 260),

        # ── Metal Build Gundam ────────────────────────────────────────────
        ("Metal Build", "Strike Freedom Gundam (Soul Blue Ver.)", "Gundam SEED Destiny", "P-Bandai", "grail", 400),
        ("Metal Build", "Destiny Gundam (Full Package)", "Gundam SEED Destiny", "P-Bandai", "grail", 380),
        ("Metal Build", "Astray Red Frame Kai", "Gundam SEED Astray", "Standard", "high", 280),
        ("Metal Build", "Astray Blue Frame Second Revise", "Gundam SEED Astray", "P-Bandai", "high", 300),
        ("Metal Build", "00 QAN[T] Full Saber (Trans-Am)", "Gundam 00 Movie", "P-Bandai", "grail", 400),
        ("Metal Build", "Crossbone Gundam X1 Full Cloth", "Crossbone Gundam", "P-Bandai", "grail", 350),
        ("Metal Build", "Wing Gundam Zero (EW) Snow White Prelude", "Gundam Wing EW", "P-Bandai", "grail", 420),
        ("Metal Build", "Hi-Nu Gundam", "Gundam CCA Beltorchika's Children", "Standard", "grail", 380),
        ("Metal Build", "Dragon Gundam (Real Type)", "G Gundam", "P-Bandai", "high", 280),
        ("Metal Build", "Eva Unit-01", "Evangelion", "Standard", "grail", 400),

        # ── CSM (Complete Selection Modification) Kamen Rider Belts ───────
        ("CSM", "Decadriver (Ver. 2)", "Kamen Rider Decade", "P-Bandai", "grail", 350),
        ("CSM", "OOO Driver (Complete Set)", "Kamen Rider OOO", "P-Bandai", "grail", 380),
        ("CSM", "Wizard Driver", "Kamen Rider Wizard", "P-Bandai", "grail", 320),
        ("CSM", "Sengoku Driver (Gaim)", "Kamen Rider Gaim", "P-Bandai", "grail", 350),
        ("CSM", "Gamer Driver (Ex-Aid)", "Kamen Rider Ex-Aid", "P-Bandai", "grail", 350),
        ("CSM", "Build Driver", "Kamen Rider Build", "P-Bandai", "grail", 350),
        ("CSM", "Ziku Driver (Zi-O)", "Kamen Rider Zi-O", "P-Bandai", "grail", 380),
        ("CSM", "Den-O Belt (Ver. 2)", "Kamen Rider Den-O", "P-Bandai", "grail", 350),
        ("CSM", "Kaixa Gear", "Kamen Rider 555", "P-Bandai", "high", 300),
        ("CSM", "Henshin Belt Typhoon (Kamen Rider 1)", "Kamen Rider", "P-Bandai", "grail", 400),
        ("CSM", "V Buckle (Kamen Rider Ryuki)", "Kamen Rider Ryuki", "P-Bandai", "grail", 350),
        ("CSM", "Buggle Driver II + Gashat Set", "Kamen Rider Ex-Aid", "P-Bandai", "high", 280),

        # ── Proplica (Sailor Moon, Demon Slayer, Dragon Ball) ─────────────
        ("Proplica", "Moon Stick (Brilliant Color Edition)", "Sailor Moon", "Standard", "high", 120),
        ("Proplica", "Spiral Heart Moon Rod", "Sailor Moon S", "Standard", "high", 130),
        ("Proplica", "Kaleidoscope", "Sailor Moon SuperS", "Standard", "high", 120),
        ("Proplica", "Moon Gorgeous Meditation", "Sailor Moon SuperS", "P-Bandai", "high", 150),
        ("Proplica", "Cutie Moon Rod (Brilliant Color)", "Sailor Moon R", "Standard", "high", 130),
        ("Proplica", "Crisis Moon Compact", "Sailor Moon Stars", "P-Bandai", "high", 140),
        ("Proplica", "Nichirin Sword (Rengoku Kyojuro)", "Demon Slayer", "Standard", "high", 130),
        ("Proplica", "Nichirin Sword (Zenitsu Agatsuma)", "Demon Slayer", "Standard", "high", 120),
        ("Proplica", "Nichirin Sword (Inosuke Hashibira)", "Demon Slayer", "Standard", "high", 130),
        ("Proplica", "Nichirin Sword (Giyu Tomioka)", "Demon Slayer", "P-Bandai", "high", 140),
        ("Proplica", "Dragon Radar", "Dragon Ball", "Standard", "mid", 80),
        ("Proplica", "Zangetsu (Tensa Zangetsu)", "Bleach TYBW", "P-Bandai", "high", 150),
        ("Proplica", "Jujutsu Kaisen Slaughter Demon", "Jujutsu Kaisen", "P-Bandai", "high", 140),
        ("Proplica", "Power Pole (Dragon Ball)", "Dragon Ball", "Standard", "mid", 90),

        # ── S.H.MonsterArts Additional ────────────────────────────────────
        ("S.H.MonsterArts", "Godzilla (2019 King of Monsters)", "Godzilla: KotM", "Standard", "high", 120),
        ("S.H.MonsterArts", "King Ghidorah (2019)", "Godzilla: KotM", "Standard", "grail", 350),
        ("S.H.MonsterArts", "Mothra (2019)", "Godzilla: KotM", "Standard", "mid", 80),
        ("S.H.MonsterArts", "Rodan (2019)", "Godzilla: KotM", "Standard", "mid", 80),
        ("S.H.MonsterArts", "Mechagodzilla (Godzilla vs Kong)", "Godzilla vs Kong", "Standard", "high", 130),
        ("S.H.MonsterArts", "Kong (Godzilla x Kong)", "Godzilla x Kong", "Standard", "high", 110),
        ("S.H.MonsterArts", "Godzilla Ultima (Singular Point)", "Godzilla Singular Point", "P-Bandai", "high", 140),
        ("S.H.MonsterArts", "Biollante Special Color Ver.", "Godzilla vs Biollante", "P-Bandai", "grail", 300),
        ("S.H.MonsterArts", "Destoroyah (Complete Form)", "Godzilla vs Destoroyah", "Standard", "high", 180),
        ("S.H.MonsterArts", "SpaceGodzilla", "Godzilla vs SpaceGodzilla", "P-Bandai", "high", 160),

        # ── More S.H.Figuarts Dragon Ball ─────────────────────────────────
        ("S.H.Figuarts", "Android 18 (Universe Survival Saga)", "Dragon Ball Super", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Krillin (Earth's Strongest)", "Dragon Ball Z", "P-Bandai", "mid", 75),
        ("S.H.Figuarts", "Tien Shinhan & Chiaotzu", "Dragon Ball Z", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Vegeta (Namek Saga) Scouter", "Dragon Ball Z", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Bardock", "Dragon Ball Z", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Goku Black (Rose)", "Dragon Ball Super", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Zamasu (Merged)", "Dragon Ball Super", "P-Bandai", "high", 100),
        ("S.H.Figuarts", "Jiren (Full Power)", "Dragon Ball Super", "P-Bandai", "high", 110),

        # ── More Gunpla P-Bandai HG/MG ───────────────────────────────────
        ("HG 1/144", "Nightingale (P-Bandai)", "Gundam CCA", "P-Bandai", "mid", 65),
        ("HG 1/144", "Moon Gundam", "Moon Gundam", "Standard", "mid", 35),
        ("HG 1/144", "Kshatriya", "Gundam Unicorn", "Standard", "mid", 45),
        ("HG 1/144", "Penelope", "Gundam Hathaway", "Standard", "mid", 55),
        ("MG 1/100", "Hyaku-Shiki 2.0", "Zeta Gundam", "Standard", "mid", 60),
        ("MG 1/100", "Geara Doga", "Gundam CCA", "Standard", "mid", 55),
        ("MG 1/100", "Turn A Gundam", "Turn A Gundam", "Standard", "mid", 60),
        ("MG 1/100", "Crossbone Gundam X1 Ver.Ka", "Crossbone Gundam", "Standard", "mid", 55),
        ("MG 1/100", "Gundam Heavyarms EW (Igel Unit)", "Gundam Wing EW", "P-Bandai", "mid", 70),
        ("MG 1/100", "Gundam Sandrock EW (Armadillo Unit)", "Gundam Wing EW", "P-Bandai", "mid", 70),
        ("MG 1/100", "Rick Dom (P-Bandai)", "Mobile Suit Gundam", "P-Bandai", "mid", 55),
        ("MG 1/100", "Gundam F91 Ver. 2.0", "Gundam F91", "Standard", "mid", 55),

        # ── Figure-rise Standard ──────────────────────────────────────────
        ("Figure-rise Standard", "Ultraman Suit Ver. 7.5", "Ultraman", "Standard", "standard", 35),
        ("Figure-rise Standard", "Kamen Rider W CycloneJoker", "Kamen Rider W", "Standard", "standard", 38),
        ("Figure-rise Standard", "Son Goku (Ultra Instinct)", "Dragon Ball Super", "Standard", "standard", 32),
        ("Figure-rise Standard", "Vegeta (SSBE)", "Dragon Ball Super", "Standard", "standard", 32),
        ("Figure-rise Standard", "Frieza Final Form", "Dragon Ball Z", "Standard", "standard", 30),
        ("Figure-rise Standard", "Amplified Omegamon", "Digimon", "Standard", "mid", 50),
        ("Figure-rise Standard", "Amplified MetalGarurumon", "Digimon", "Standard", "mid", 45),

        # ── Figuarts ZERO One Piece Extended ──────────────────────────────
        ("Figuarts ZERO", "Kaido of the Beasts (Extra Battle)", "One Piece", "Standard", "high", 150),
        ("Figuarts ZERO", "Big Mom (Charlotte Linlin) Extra Battle", "One Piece", "Standard", "high", 140),
        ("Figuarts ZERO", "Sanji Diable Jambe (Extra Battle)", "One Piece", "Standard", "high", 120),
        ("Figuarts ZERO", "Trafalgar Law (Extra Battle)", "One Piece", "Standard", "high", 110),
        ("Figuarts ZERO", "Sabo Fire Fist (Extra Battle)", "One Piece", "Standard", "high", 120),
        ("Figuarts ZERO", "Zoro Three Sword Style (Extra Battle)", "One Piece", "Standard", "high", 130),
        ("Figuarts ZERO", "Nami Cat Burglar (Extra Battle)", "One Piece", "Standard", "mid", 90),
        ("Figuarts ZERO", "Nico Robin (Devil Child Extra Battle)", "One Piece", "Standard", "mid", 95),

        # ── SMP (Super MiniPla) & Ichiban Kuji ────────────────────────────
        ("SMP", "King Brachion (Zyuranger)", "Super Sentai", "P-Bandai", "mid", 70),
        ("SMP", "Gaogaigar (Super MiniPla)", "GaoGaiGar", "Standard", "mid", 55),
        ("SMP", "Dancouga (Super MiniPla)", "Dancouga", "P-Bandai", "mid", 65),
        ("SMP", "Combattler V (Super MiniPla)", "Combattler V", "P-Bandai", "mid", 60),
        ("Ichiban Kuji", "Goku Ultra Instinct Last One Prize", "Dragon Ball Super", "Prize", "high", 120),
        ("Ichiban Kuji", "Luffy Gear 5 Last One Prize", "One Piece", "Prize", "high", 130),
        ("Ichiban Kuji", "Gojo Satoru Last One Prize", "Jujutsu Kaisen", "Prize", "high", 110),
        ("Ichiban Kuji", "Tanjiro Hinokami Last One Prize", "Demon Slayer", "Prize", "high", 100),

        # ── More S.H.Figuarts Anime Expanded ──────────────────────────────
        ("S.H.Figuarts", "Tanjiro Kamado (Hinokami Kagura)", "Demon Slayer", "Standard", "mid", 80),
        ("S.H.Figuarts", "Rengoku Kyojuro", "Demon Slayer", "Standard", "mid", 85),
        ("S.H.Figuarts", "Zenitsu Agatsuma (Thunder Breathing)", "Demon Slayer", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Nezuko Kamado (Awakened)", "Demon Slayer", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Tengen Uzui", "Demon Slayer", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Naruto Uzumaki (Baryon Mode)", "Naruto Shippuden", "P-Bandai", "high", 120),
        ("S.H.Figuarts", "Sasuke Uchiha (Eternal Mangekyou)", "Naruto Shippuden", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Itachi Uchiha (Susano'o Ver.)", "Naruto Shippuden", "P-Bandai", "high", 130),
        ("S.H.Figuarts", "Kakashi Hatake (Anbu)", "Naruto Shippuden", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Monkey D. Luffy (Gear 5 Nika)", "One Piece", "Standard", "mid", 90),
        ("S.H.Figuarts", "Roronoa Zoro (Wano Country)", "One Piece", "Standard", "mid", 80),
        ("S.H.Figuarts", "Sanji (Wano Country)", "One Piece", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Trafalgar Law (Wano Country)", "One Piece", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Shanks", "One Piece Film Red", "Standard", "mid", 85),
        ("S.H.Figuarts", "Chainsaw Man (Denji)", "Chainsaw Man", "Standard", "mid", 80),
        ("S.H.Figuarts", "Makima", "Chainsaw Man", "Standard", "mid", 85),
        ("S.H.Figuarts", "Power", "Chainsaw Man", "Standard", "mid", 80),
        ("S.H.Figuarts", "Gojo Satoru (Jujutsu Kaisen S2)", "Jujutsu Kaisen", "Standard", "mid", 85),
        ("S.H.Figuarts", "Sukuna (Incarnated)", "Jujutsu Kaisen", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Geto Suguru", "Jujutsu Kaisen", "P-Bandai", "mid", 95),

        # ── More Robot Spirits / Metal Build ──────────────────────────────
        ("Robot Spirits", "Aerial (Gundam Allows Score Five)", "Gundam: Witch from Mercury", "P-Bandai", "mid", 70),
        ("Robot Spirits", "Pharact", "Gundam: Witch from Mercury", "Standard", "mid", 65),
        ("Robot Spirits", "Calibarn", "Gundam: Witch from Mercury", "Standard", "mid", 70),
        ("Robot Spirits", "Lfrith", "Gundam: Witch from Mercury", "P-Bandai", "mid", 65),
        ("Metal Build", "Justice Gundam", "Gundam SEED", "P-Bandai", "high", 280),
        ("Metal Build", "Infinite Justice Gundam", "Gundam SEED Freedom", "Standard", "grail", 350),
        ("Metal Build", "Strike Noir Gundam", "Gundam SEED Stargazer", "P-Bandai", "high", 300),
        ("Metal Build", "Aile Strike Gundam (Metal Build)", "Gundam SEED", "Standard", "high", 250),

        # ── More Proplica & CSM ───────────────────────────────────────────
        ("Proplica", "Millennium Rod (Marik)", "Yu-Gi-Oh!", "P-Bandai", "high", 130),
        ("Proplica", "Duel Disk (Kaiba Corp)", "Yu-Gi-Oh!", "Standard", "high", 150),
        ("CSM", "Arcle (Kamen Rider Kuuga)", "Kamen Rider Kuuga", "P-Bandai", "grail", 380),
        ("CSM", "Blade Buckle", "Kamen Rider Blade", "P-Bandai", "grail", 350),
        ("CSM", "Faiz Gear (Complete Set)", "Kamen Rider 555", "P-Bandai", "grail", 400),
        ("CSM", "Kabuto Zecter", "Kamen Rider Kabuto", "P-Bandai", "grail", 380),
        ("CSM", "Lost Driver", "Kamen Rider W", "P-Bandai", "high", 300),
        ("CSM", "Kivat Belt", "Kamen Rider Kiva", "P-Bandai", "grail", 350),
        ("CSM", "Accel Driver", "Kamen Rider W", "P-Bandai", "high", 280),
        ("CSM", "Birth Driver", "Kamen Rider OOO", "P-Bandai", "high", 280),

        # ── Additional S.H.Figuarts / Robot Spirits ───────────────────────
        ("S.H.Figuarts", "Frieza (First Form)", "Dragon Ball Z", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Piccolo (Proud Namekian)", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Yamcha", "Dragon Ball Z", "P-Bandai", "mid", 75),
        ("S.H.Figuarts", "Captain Ginyu", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Recoome", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Ginyu Force Set (5 Figures)", "Dragon Ball Z", "P-Bandai", "grail", 400),
        ("Robot Spirits", "RX-93ff Nu Gundam (Fukuoka Ver.)", "Gundam CCA", "Event Exclusive", "high", 150),
        ("Robot Spirits", "Gundam Aerial (Permet Score 5)", "Gundam: Witch from Mercury", "P-Bandai", "mid", 80),
        ("Robot Spirits", "RX-78GP01 Gundam Zephyranthes", "Gundam 0083", "Standard", "mid", 65),
        ("Robot Spirits", "RX-78GP02A Gundam Physalis", "Gundam 0083", "Standard", "mid", 70),
        ("Robot Spirits", "Sazabi (Char's Counterattack)", "Gundam CCA", "Standard", "mid", 75),
        ("Robot Spirits", "Sinanju (Full Frontal Custom)", "Gundam Unicorn", "P-Bandai", "mid", 80),
        ("Robot Spirits", "Xi Gundam", "Gundam Hathaway", "Standard", "high", 100),
        ("Robot Spirits", "Penelope (Gundam Hathaway)", "Gundam Hathaway", "Standard", "high", 110),
        ("Robot Spirits", "Turn A Gundam", "Turn A Gundam", "Standard", "mid", 70),
        ("S.H.Figuarts", "Kamen Rider Black Sun", "Kamen Rider Black Sun", "Standard", "mid", 80),
        ("S.H.Figuarts", "Ultraman Trigger Multi Type", "Ultraman Trigger", "Standard", "mid", 75),
    ]


def _expansion_1150_round35b() -> list[tuple]:
    """Round 35b expansion — push to 1150+ items: more SHF Dragon Ball, SHF Naruto,
    SHF Kamen Rider Reiwa, DX Chogokin Macross, Metal Build Gundam, CSM belts,
    Proplica, S.H.MonsterArts Godzilla."""
    return [
        # ── S.H.Figuarts Dragon Ball — More Figures (+14) ──
        ("S.H.Figuarts", "Ultra Instinct Goku (Mastered)", "Dragon Ball Super", "Standard", "mid", 95),
        ("S.H.Figuarts", "Ultra Instinct Goku -Sign- (Silver Hair)", "Dragon Ball Super", "P-Bandai", "high", 120),
        ("S.H.Figuarts", "Super Saiyan Blue Vegito", "Dragon Ball Super", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Broly Full Power (Movie)", "Dragon Ball Super: Broly", "Standard", "high", 130),
        ("S.H.Figuarts", "Cell Perfect Form (Premium Color)", "Dragon Ball Z", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Super Buu (Gotenks Absorbed)", "Dragon Ball Z", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Super Buu (Gohan Absorbed)", "Dragon Ball Z", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Kid Buu", "Dragon Ball Z", "Standard", "mid", 90),
        ("S.H.Figuarts", "Burter (Ginyu Force)", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Jeice (Ginyu Force)", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Guldo (Ginyu Force)", "Dragon Ball Z", "P-Bandai", "mid", 75),
        ("S.H.Figuarts", "Super Saiyan 4 Goku (GT)", "Dragon Ball GT", "Standard", "mid", 90),
        ("S.H.Figuarts", "Super Saiyan 4 Gogeta", "Dragon Ball GT", "P-Bandai", "high", 140),
        ("S.H.Figuarts", "Orange Piccolo (Super Hero Movie)", "Dragon Ball Super: Super Hero", "Standard", "mid", 85),

        # ── S.H.Figuarts Naruto — More Figures (+10) ──
        ("S.H.Figuarts", "Naruto Uzumaki Baryon Mode", "Naruto Shippuden", "P-Bandai", "high", 150),
        ("S.H.Figuarts", "Sasuke Uchiha (Rinnegan / Susanoo)", "Naruto Shippuden", "P-Bandai", "high", 130),
        ("S.H.Figuarts", "Itachi Uchiha (Anbu Ver.)", "Naruto Shippuden", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Madara Uchiha (Reanimation)", "Naruto Shippuden", "P-Bandai", "high", 140),
        ("S.H.Figuarts", "Pain (Tendo / Deva Path)", "Naruto Shippuden", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Kakashi Hatake (DMS / Susanoo)", "Naruto Shippuden", "P-Bandai", "high", 130),
        ("S.H.Figuarts", "Gaara (Kazekage)", "Naruto Shippuden", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Rock Lee (8 Gates)", "Naruto Shippuden", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Jiraiya (Sage Mode)", "Naruto Shippuden", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Obito Uchiha (Masked Man)", "Naruto Shippuden", "P-Bandai", "mid", 110),

        # ── S.H.Figuarts Kamen Rider Reiwa Era (+12) ──
        ("S.H.Figuarts", "Kamen Rider Saber Emotional Dragon", "Kamen Rider Saber", "Standard", "mid", 70),
        ("S.H.Figuarts", "Kamen Rider Saber Xross Saber", "Kamen Rider Saber", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kamen Rider Vice Barid Rex", "Kamen Rider Revice", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Kamen Rider Geats Magnum Boost", "Kamen Rider Geats", "Standard", "mid", 75),
        ("S.H.Figuarts", "Kamen Rider Geats Mk IX", "Kamen Rider Geats", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Kamen Rider Gotchard Appareskebow", "Kamen Rider Gotchard", "Standard", "mid", 70),
        ("S.H.Figuarts", "Kamen Rider Gotchard Platinum Gotchard", "Kamen Rider Gotchard", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kamen Rider Gavv (Final Form)", "Kamen Rider Gavv", "P-Bandai", "mid", 95),

        # ── DX Chogokin Macross — More VF Units (+8) ──
        ("DX Chogokin", "VF-1S Strike Valkyrie (Roy Focker Special)", "Macross", "Standard", "grail", 380),
        ("DX Chogokin", "VF-1J Armored Valkyrie (Hikaru Ichijo)", "Macross", "P-Bandai", "grail", 350),
        ("DX Chogokin", "YF-29 Durandal (Alto Saotome Full Set)", "Macross Frontier", "P-Bandai", "grail", 400),
        ("DX Chogokin", "VF-25F Messiah (Alto Custom Super Parts)", "Macross Frontier", "P-Bandai", "high", 280),
        ("DX Chogokin", "VF-25S Messiah (Ozma Lee Custom)", "Macross Frontier", "P-Bandai", "high", 300),
        ("DX Chogokin", "VF-31AX Kairos Plus (Hayate Immelman)", "Macross Delta", "Standard", "high", 260),
        ("DX Chogokin", "VF-31F Siegfried (Messer Ihlefeld)", "Macross Delta", "P-Bandai", "high", 280),

        # ── Metal Build Gundam — More Premium Figures (+10) ──
        ("Metal Build", "Freedom Gundam Concept 2.0", "Gundam SEED", "P-Bandai", "grail", 450),
        ("Metal Build", "00 Raiser (Designer's Blue Ver.)", "Gundam 00", "P-Bandai", "grail", 380),
        ("Metal Build", "Destiny Gundam (Full Package)", "Gundam SEED Destiny", "Standard", "grail", 350),
        ("Metal Build", "Strike Rouge Ootori", "Gundam SEED", "P-Bandai", "high", 300),
        ("Metal Build", "Justice Gundam", "Gundam SEED", "Standard", "high", 280),
        ("Metal Build", "Crossbone Gundam X-1 Full Cloth", "Crossbone Gundam", "P-Bandai", "grail", 380),
        ("Metal Build", "Hi-Nu Gundam", "Gundam CCA Beltorchika's Children", "P-Bandai", "grail", 420),
        ("Metal Build", "Great Mazinger (Infinity Ver.)", "Mazinger", "Standard", "high", 280),
        ("Metal Build", "Laevatein (Full Metal Panic)", "Full Metal Panic", "Standard", "high", 260),
        ("Metal Build", "EVA-01 (Evangelion Test Type)", "Evangelion", "P-Bandai", "grail", 400),

        # ── CSM (Complete Selection Modification) Belts — More Rider Belts (+10) ──
        ("CSM", "DecaDriver (Kamen Rider Decade)", "Kamen Rider Decade", "P-Bandai", "grail", 380),
        ("CSM", "W Driver (Kamen Rider W)", "Kamen Rider W", "P-Bandai", "grail", 400),
        ("CSM", "OOO Driver (Kamen Rider OOO)", "Kamen Rider OOO", "P-Bandai", "grail", 420),
        ("CSM", "OOO Driver Complete Set (w/ All Core Medals)", "Kamen Rider OOO", "P-Bandai", "grail", 500),
        ("CSM", "Fourze Driver", "Kamen Rider Fourze", "P-Bandai", "grail", 380),
        ("CSM", "Wizard Driver", "Kamen Rider Wizard", "P-Bandai", "grail", 350),
        ("CSM", "Sengoku Driver (Kamen Rider Gaim)", "Kamen Rider Gaim", "P-Bandai", "grail", 400),
        ("CSM", "Ghost Driver", "Kamen Rider Ghost", "P-Bandai", "grail", 320),
        ("CSM", "Build Driver", "Kamen Rider Build", "P-Bandai", "grail", 380),
        ("CSM", "Ziku Driver (Kamen Rider Zi-O)", "Kamen Rider Zi-O", "P-Bandai", "grail", 400),

        # ── Proplica — More Prop Replicas (+10) ──
        ("Proplica", "Moon Stick (Sailor Moon)", "Sailor Moon", "Standard", "high", 120),
        ("Proplica", "Moon Kaleidoscope (Sailor Moon SuperS)", "Sailor Moon", "Standard", "high", 130),
        ("Proplica", "Spiral Heart Moon Rod", "Sailor Moon S", "Standard", "high", 120),
        ("Proplica", "Nichirin Blade (Tanjiro Kamado)", "Demon Slayer", "Standard", "high", 130),
        ("Proplica", "Nichirin Blade (Rengoku Kyojuro)", "Demon Slayer", "Standard", "high", 140),
        ("Proplica", "Nichirin Blade (Zenitsu Agatsuma)", "Demon Slayer", "Standard", "high", 130),
        ("Proplica", "Licht Schwert (Attack on Titan)", "Attack on Titan", "Standard", "mid", 110),
        ("Proplica", "Night Sky Star Globe Necklace (Frieren)", "Frieren", "P-Bandai", "high", 150),
        ("Proplica", "Zangetsu (Ichigo Kurosaki Bankai)", "Bleach TYBW", "Standard", "high", 140),

        # ── S.H.MonsterArts Godzilla (+14) ──
        ("S.H.MonsterArts", "Shin Godzilla (2016 4th Form)", "Shin Godzilla", "Standard", "high", 150),
        ("S.H.MonsterArts", "Shin Godzilla (2nd & 3rd Form)", "Shin Godzilla", "P-Bandai", "high", 130),
        ("S.H.MonsterArts", "Godzilla Minus One", "Godzilla Minus One", "Standard", "high", 160),
        ("S.H.MonsterArts", "Godzilla Minus One (Thermae Ver.)", "Godzilla Minus One", "P-Bandai", "high", 180),
        ("S.H.MonsterArts", "Kong (Godzilla x Kong: The New Empire)", "GxK: The New Empire", "Standard", "high", 140),
        ("S.H.MonsterArts", "Godzilla (Godzilla x Kong: The New Empire)", "GxK: The New Empire", "Standard", "high", 150),
        ("S.H.MonsterArts", "Skar King", "GxK: The New Empire", "Standard", "mid", 120),
        ("S.H.MonsterArts", "Mothra (Godzilla: King of the Monsters)", "Godzilla KOTM", "Standard", "high", 130),
        ("S.H.MonsterArts", "King Ghidorah (Godzilla: KOTM) Special Color", "Godzilla KOTM", "P-Bandai", "grail", 350),
        ("S.H.MonsterArts", "Mechagodzilla (Ready Player One)", "Ready Player One", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Mechagodzilla (GvK)", "Godzilla vs. Kong", "Standard", "high", 140),
        ("S.H.MonsterArts", "Godzilla (2014)", "Godzilla 2014", "Standard", "high", 130),
        ("S.H.MonsterArts", "Rodan (Godzilla: KOTM)", "Godzilla KOTM", "Standard", "mid", 110),
        ("S.H.MonsterArts", "Biollante (Special Color)", "Godzilla vs. Biollante", "P-Bandai", "grail", 300),

        # ── More S.H.Figuarts One Piece (+8) ──
        ("S.H.Figuarts", "Monkey D. Luffy (Gear 5 Nika)", "One Piece", "Standard", "mid", 95),
        ("S.H.Figuarts", "Roronoa Zoro (Wano Kuni)", "One Piece", "Standard", "mid", 85),
        ("S.H.Figuarts", "Trafalgar Law (Wano Kuni)", "One Piece", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Sanji (Wano Kuni)", "One Piece", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Nico Robin (Wano Kuni)", "One Piece", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Kaido (Dragon Form Set)", "One Piece", "P-Bandai", "grail", 300),
        ("S.H.Figuarts", "Shanks (Film Red Ver.)", "One Piece Film Red", "Standard", "mid", 90),
        ("S.H.Figuarts", "Uta (Film Red Ver.)", "One Piece Film Red", "Standard", "mid", 80),

        # ── More S.H.Figuarts Anime (+8) ──
        ("S.H.Figuarts", "Denji (Chainsaw Man)", "Chainsaw Man", "Standard", "mid", 75),
        ("S.H.Figuarts", "Makima", "Chainsaw Man", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Yuji Itadori (Jujutsu Kaisen)", "Jujutsu Kaisen", "Standard", "mid", 75),
        ("S.H.Figuarts", "Satoru Gojo (Hollow Purple)", "Jujutsu Kaisen", "P-Bandai", "high", 120),
        ("S.H.Figuarts", "Levi Ackerman (Attack on Titan Final Season)", "Attack on Titan", "Standard", "mid", 80),
        ("S.H.Figuarts", "Tanjiro Kamado (Hinokami Kagura)", "Demon Slayer", "Standard", "mid", 75),
        ("S.H.Figuarts", "Rengoku Kyojuro (Flame Hashira)", "Demon Slayer", "Standard", "mid", 80),
        ("S.H.Figuarts", "Giyu Tomioka (Water Hashira)", "Demon Slayer", "P-Bandai", "mid", 85),

        # ── Metal Robot Spirits & MGEX (+7) ──
        ("Metal Robot Spirits", "Strike Freedom Gundam", "Gundam SEED Destiny", "Standard", "high", 150),
        ("Metal Robot Spirits", "Destiny Gundam (Heine Custom)", "Gundam SEED Destiny", "P-Bandai", "high", 160),
        ("Metal Robot Spirits", "Wing Gundam Zero Custom", "Gundam Wing EW", "Standard", "high", 140),
        ("Metal Robot Spirits", "Full Armor ZZ Gundam", "Gundam ZZ", "P-Bandai", "high", 170),
        ("MGEX", "Unicorn Gundam Ver.Ka", "Gundam Unicorn", "Standard", "high", 230),
        ("MGEX", "Strike Freedom Gundam", "Gundam SEED Destiny", "Standard", "high", 250),
        ("PG Unleashed", "RX-78-2 Gundam", "Mobile Suit Gundam", "Standard", "grail", 350),

        # ── More Ultraman (+8) ──
        ("S.H.Figuarts", "Ultraman (Shin Ultraman Movie)", "Shin Ultraman", "Standard", "mid", 80),
        ("S.H.Figuarts", "Ultraman Tiga Multi Type", "Ultraman Tiga", "Standard", "mid", 75),
        ("S.H.Figuarts", "Ultraman Zero Beyond", "Ultraman Zero", "Standard", "mid", 70),
        ("S.H.Figuarts", "Ultraman Blazar", "Ultraman Blazar", "Standard", "mid", 70),
        ("S.H.Figuarts", "Ultraman Arc", "Ultraman Arc", "Standard", "mid", 70),
        ("Ultra-Act", "Ultraman Decker Flash Type", "Ultraman Decker", "Standard", "mid", 65),
        ("S.H.Figuarts", "Zetton (Ultraman)", "Ultraman", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Baltan Seijin", "Ultraman", "P-Bandai", "mid", 80),

        # ── FiguartsZERO Demon Slayer (+8) ──
        ("FiguartsZERO", "Tanjiro Kamado (Water Surface Slash)", "Demon Slayer", "Standard", "mid", 80),
        ("FiguartsZERO", "Kyojuro Rengoku (Flame Breathing)", "Demon Slayer", "Standard", "mid", 85),
        ("FiguartsZERO", "Zenitsu Agatsuma (Thunder Breathing)", "Demon Slayer", "Standard", "mid", 80),
        ("FiguartsZERO", "Inosuke Hashibira (Beast Breathing)", "Demon Slayer", "Standard", "mid", 80),
        ("FiguartsZERO", "Tengen Uzui (Sound Breathing)", "Demon Slayer", "Standard", "mid", 85),
        ("FiguartsZERO", "Gyomei Himejima (Stone Breathing)", "Demon Slayer", "Standard", "mid", 90),
        ("FiguartsZERO", "Muzan Kibutsuji (Final Battle)", "Demon Slayer", "P-Bandai", "high", 120),
        ("FiguartsZERO", "Akaza (Upper Three)", "Demon Slayer", "Standard", "mid", 95),

        # ── More Super Sentai / Power Rangers (+6) ──
        ("S.H.Figuarts", "AkaRed (Super Sentai Anniversary)", "Super Sentai", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kiramai Red (Kiramager)", "Super Sentai", "Standard", "mid", 70),
        ("S.H.Figuarts", "Zenkaizer", "Super Sentai (Zenkaiger)", "Standard", "mid", 70),
        ("S.H.Figuarts", "Don Momotaro (DonBrothers)", "Super Sentai", "Standard", "mid", 75),
        ("S.H.Figuarts", "King-Ohger", "Super Sentai", "Standard", "mid", 75),
        ("Soul of Chogokin", "GX-100 GaoGaiGar (King of Braves)", "GaoGaiGar", "Standard", "grail", 350),

        # ── More CSM Accessories (+4) ──
        ("CSM", "Rider Card Set (Kamen Rider Decade)", "Kamen Rider Decade", "P-Bandai", "high", 180),
        ("CSM", "Core Medal Set (Kamen Rider OOO Complete)", "Kamen Rider OOO", "P-Bandai", "high", 200),
        ("CSM", "Gaia Memory Set (Kamen Rider W)", "Kamen Rider W", "P-Bandai", "high", 220),
        ("CSM", "Astro Switch Set (Kamen Rider Fourze)", "Kamen Rider Fourze", "P-Bandai", "high", 180),
    ]


def _expansion_round12_bandai() -> list[tuple]:
    """Round 12 — ~400 items: more Metal Build, Robot Spirits, S.H.MonsterArts,
    CSM Kamen Rider belts, Super Mini-Pla, SHFiguarts exclusives, P-Bandai exclusives."""
    return [
        # ── Metal Build — More Premium Gundam (+20) ──────────────────────
        ("Metal Build", "Wing Gundam Zero (EW)", "Gundam Wing: Endless Waltz", "Standard", "grail", 380),
        ("Metal Build", "Destiny Gundam (Soul Blue Ver.)", "Gundam SEED Destiny", "P-Bandai", "grail", 400),
        ("Metal Build", "Justice Gundam", "Gundam SEED", "Standard", "high", 280),
        ("Metal Build", "Buster Gundam", "Gundam SEED", "P-Bandai", "high", 260),
        ("Metal Build", "Duel Gundam Assault Shroud", "Gundam SEED", "P-Bandai", "high", 270),
        ("Metal Build", "Blitz Gundam", "Gundam SEED", "P-Bandai", "high", 260),
        ("Metal Build", "Aegis Gundam", "Gundam SEED", "P-Bandai", "high", 250),
        ("Metal Build", "Gundam F91 (Harrison Maddin Custom)", "Gundam F91", "P-Bandai", "grail", 380),
        ("Metal Build", "Gundam F91", "Gundam F91", "Standard", "high", 280),
        ("Metal Build", "00 Gundam Seven Sword", "Gundam 00", "Standard", "high", 300),
        ("Metal Build", "00 Qan[T] (Full Saber)", "Gundam 00", "P-Bandai", "grail", 420),
        ("Metal Build", "Astray Blue Frame (Second Revise)", "Gundam SEED Astray", "P-Bandai", "high", 300),
        ("Metal Build", "Astray Gold Frame Amatsu Mina", "Gundam SEED Astray", "P-Bandai", "grail", 380),
        ("Metal Build", "Gundam Dynames Repair III", "Gundam 00", "P-Bandai", "high", 300),
        ("Metal Build", "Crossbone Gundam X-3", "Crossbone Gundam", "P-Bandai", "high", 280),
        ("Metal Build", "Lancelot (Code Geass)", "Code Geass", "Standard", "high", 250),
        ("Metal Build", "Lancelot Albion (Code Geass)", "Code Geass", "P-Bandai", "high", 300),
        ("Metal Build", "Mazinger Z (Infinity Ver.)", "Mazinger Z: Infinity", "Standard", "high", 260),
        ("Metal Build", "Gundam Barbatos Lupus Rex", "Iron-Blooded Orphans", "P-Bandai", "grail", 400),
        ("Metal Build", "Gundam Vidar", "Iron-Blooded Orphans", "P-Bandai", "high", 300),

        # ── Robot Spirits — Expanded Gundam UC/SEED/00 (+15) ────────────
        ("Robot Spirits", "RX-78GP01Fb Full Burnern ver. A.N.I.M.E.", "Gundam 0083", "Standard", "mid", 75),
        ("Robot Spirits", "RX-78GP02A Gundam ver. A.N.I.M.E.", "Gundam 0083", "Standard", "mid", 80),
        ("Robot Spirits", "Kampfer ver. A.N.I.M.E.", "Gundam 0080", "P-Bandai", "mid", 90),
        ("Robot Spirits", "Gelgoog (Char Custom) ver. A.N.I.M.E.", "Mobile Suit Gundam", "P-Bandai", "mid", 85),
        ("Robot Spirits", "GM Custom ver. A.N.I.M.E.", "Gundam 0083", "P-Bandai", "mid", 80),
        ("Robot Spirits", "Xi Gundam ver. A.N.I.M.E.", "Gundam Hathaway", "Standard", "high", 150),
        ("Robot Spirits", "Penelope ver. A.N.I.M.E.", "Gundam Hathaway", "Standard", "high", 160),
        ("Robot Spirits", "Messer Type-F01 ver. A.N.I.M.E.", "Gundam Hathaway", "P-Bandai", "mid", 90),
        ("Robot Spirits", "Freedom Gundam ver. A.N.I.M.E.", "Gundam SEED", "Standard", "mid", 85),
        ("Robot Spirits", "Justice Gundam ver. A.N.I.M.E.", "Gundam SEED", "P-Bandai", "mid", 90),
        ("Robot Spirits", "Strike Freedom Gundam ver. A.N.I.M.E.", "Gundam SEED Destiny", "Standard", "high", 110),
        ("Robot Spirits", "Infinite Justice Gundam ver. A.N.I.M.E.", "Gundam SEED Destiny", "P-Bandai", "high", 120),
        ("Robot Spirits", "Destiny Gundam ver. A.N.I.M.E.", "Gundam SEED Destiny", "P-Bandai", "mid", 95),
        ("Robot Spirits", "00 Raiser + GN Sword III ver. A.N.I.M.E.", "Gundam 00", "Standard", "mid", 90),
        ("Robot Spirits", "Cherudim Gundam GNHW/R ver. A.N.I.M.E.", "Gundam 00", "P-Bandai", "mid", 95),

        # ── S.H.MonsterArts — Expanded Godzilla & Kaiju (+18) ──────────
        ("S.H.MonsterArts", "Godzilla (1954 Original)", "Godzilla", "Standard", "high", 140),
        ("S.H.MonsterArts", "Godzilla (1964 Mothra vs Godzilla)", "Godzilla Showa", "Standard", "high", 130),
        ("S.H.MonsterArts", "Godzilla (1995 Burning Godzilla)", "Godzilla vs Destoroyah", "Standard", "high", 160),
        ("S.H.MonsterArts", "Godzilla (2019 KOTM)", "Godzilla KOTM", "Standard", "high", 140),
        ("S.H.MonsterArts", "SpaceGodzilla", "Godzilla vs SpaceGodzilla", "Standard", "high", 140),
        ("S.H.MonsterArts", "Destoroyah (Complete Form)", "Godzilla vs Destoroyah", "Standard", "high", 160),
        ("S.H.MonsterArts", "Destoroyah (Aggregate Form)", "Godzilla vs Destoroyah", "P-Bandai", "high", 150),
        ("S.H.MonsterArts", "Hedorah (Smog Monster)", "Godzilla vs Hedorah", "P-Bandai", "high", 130),
        ("S.H.MonsterArts", "Battra (Larva & Imago Set)", "Godzilla vs Mothra", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Mechagodzilla (2021 GvK)", "Godzilla vs Kong", "Standard", "high", 140),
        ("S.H.MonsterArts", "Mechagodzilla (Type-3 Kiryu)", "Godzilla Against Mechagodzilla", "Standard", "high", 150),
        ("S.H.MonsterArts", "Anguirus (2004 Final Wars)", "Godzilla Final Wars", "P-Bandai", "mid", 110),
        ("S.H.MonsterArts", "Gigan (2004 Final Wars)", "Godzilla Final Wars", "Standard", "high", 130),
        ("S.H.MonsterArts", "King Caesar (Showa)", "Godzilla vs Mechagodzilla", "P-Bandai", "mid", 110),
        ("S.H.MonsterArts", "Titanosaurus", "Terror of Mechagodzilla", "P-Bandai", "mid", 120),
        ("S.H.MonsterArts", "Jet Jaguar", "Godzilla vs Megalon", "P-Bandai", "mid", 100),
        ("S.H.MonsterArts", "Mothra (2019 KOTM)", "Godzilla KOTM", "Standard", "high", 120),
        ("S.H.MonsterArts", "King Ghidorah (2019 KOTM)", "Godzilla KOTM", "Standard", "grail", 300),

        # ── CSM Kamen Rider Belts — Showa & Early Heisei (+14) ─────────
        ("CSM", "Typhoon Belt (Kamen Rider 1)", "Kamen Rider", "P-Bandai", "grail", 350),
        ("CSM", "Typhoon Belt (Kamen Rider 2)", "Kamen Rider", "P-Bandai", "grail", 350),
        ("CSM", "V3 Belt (Kamen Rider V3)", "Kamen Rider V3", "P-Bandai", "grail", 350),
        ("CSM", "Amazon Belt (Kamen Rider Amazon)", "Kamen Rider Amazon", "P-Bandai", "grail", 380),
        ("CSM", "Henshin Belt Typhoon (Kamen Rider Black)", "Kamen Rider Black", "P-Bandai", "grail", 380),
        ("CSM", "King Stone (Kamen Rider Black RX)", "Kamen Rider Black RX", "P-Bandai", "grail", 350),
        ("CSM", "Arcle (Kamen Rider Kuuga)", "Kamen Rider Kuuga", "P-Bandai", "grail", 400),
        ("CSM", "Arcle (Kamen Rider Kuuga) Ver.2", "Kamen Rider Kuuga", "P-Bandai", "grail", 420),
        ("CSM", "Bug Visor (Kamen Rider 555)", "Kamen Rider 555", "P-Bandai", "high", 280),
        ("CSM", "Kabuto Zecter (Kamen Rider Kabuto)", "Kamen Rider Kabuto", "P-Bandai", "grail", 380),
        ("CSM", "Den-O Belt (Kamen Rider Den-O)", "Kamen Rider Den-O", "P-Bandai", "grail", 400),
        ("CSM", "Kiva Belt (Kamen Rider Kiva)", "Kamen Rider Kiva", "P-Bandai", "grail", 380),
        ("CSM", "Lost Driver (Kamen Rider W)", "Kamen Rider W", "P-Bandai", "high", 280),
        ("CSM", "Accel Driver (Kamen Rider Accel)", "Kamen Rider W", "P-Bandai", "high", 280),

        # ── Super Mini-Pla / SMP (+15) ──────────────────────────────────
        ("Super Mini-Pla", "Daizyujin (MMPR Megazord)", "Super Sentai", "Standard", "mid", 65),
        ("Super Mini-Pla", "Dragon Caesar (MMPR Dragonzord)", "Super Sentai", "Standard", "mid", 55),
        ("Super Mini-Pla", "King Brachion (Titanus)", "Super Sentai", "Standard", "mid", 60),
        ("Super Mini-Pla", "Won Tiger (White Tigerzord)", "Super Sentai", "Standard", "mid", 55),
        ("Super Mini-Pla", "Galaxy Mega (Mega Voyager)", "Super Sentai", "Standard", "mid", 50),
        ("Super Mini-Pla", "Gaogaigar (King of Braves)", "GaoGaiGar", "Standard", "high", 120),
        ("Super Mini-Pla", "Star Gaogaigar", "GaoGaiGar", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "Genesic Gaogaigar", "GaoGaiGar FINAL", "P-Bandai", "grail", 200),
        ("Super Mini-Pla", "Voltron (Beast King GoLion)", "Beast King GoLion", "Standard", "high", 100),
        ("Super Mini-Pla", "Getter Robo Armageddon", "Getter Robo", "Standard", "mid", 65),
        ("Super Mini-Pla", "Mazinger Z (Super Robot)", "Mazinger Z", "Standard", "mid", 55),
        ("Super Mini-Pla", "Great Mazinger", "Great Mazinger", "Standard", "mid", 55),
        ("Super Mini-Pla", "Dangaioh", "Dangaioh", "P-Bandai", "mid", 70),
        ("Super Mini-Pla", "Combattler V", "Combattler V", "Standard", "mid", 60),
        ("Super Mini-Pla", "Zambot 3", "Zambot 3", "P-Bandai", "mid", 65),

        # ── S.H.Figuarts — Marvel & Star Wars P-Bandai (+12) ───────────
        ("S.H.Figuarts", "Iron Man Mk 85 (Avengers: Endgame)", "Avengers: Endgame", "Standard", "mid", 90),
        ("S.H.Figuarts", "Spider-Man (No Way Home Final Swing)", "Spider-Man: No Way Home", "Standard", "mid", 80),
        ("S.H.Figuarts", "Spider-Man (Tobey Maguire)", "Spider-Man (2002)", "P-Bandai", "high", 130),
        ("S.H.Figuarts", "Spider-Man (Andrew Garfield)", "Amazing Spider-Man", "P-Bandai", "high", 130),
        ("S.H.Figuarts", "Captain America (Avengers: Endgame)", "Avengers: Endgame", "Standard", "mid", 85),
        ("S.H.Figuarts", "Thor (Avengers: Endgame)", "Avengers: Endgame", "Standard", "mid", 85),
        ("S.H.Figuarts", "Thanos (Avengers: Endgame)", "Avengers: Endgame", "Standard", "mid", 95),
        ("S.H.Figuarts", "Darth Vader (Return of the Jedi)", "Star Wars ROTJ", "Standard", "mid", 80),
        ("S.H.Figuarts", "Luke Skywalker (Return of the Jedi)", "Star Wars ROTJ", "Standard", "mid", 80),
        ("S.H.Figuarts", "Boba Fett (The Mandalorian)", "The Mandalorian", "Standard", "mid", 85),
        ("S.H.Figuarts", "The Mandalorian (Beskar Armor)", "The Mandalorian", "Standard", "mid", 80),
        ("S.H.Figuarts", "Ahsoka Tano (Rosario Dawson)", "Ahsoka", "Standard", "mid", 85),

        # ── S.H.Figuarts — Bleach & JoJo (+10) ─────────────────────────
        ("S.H.Figuarts", "Ichigo Kurosaki (Bankai TYBW)", "Bleach TYBW", "Standard", "mid", 80),
        ("S.H.Figuarts", "Byakuya Kuchiki (TYBW)", "Bleach TYBW", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Toshiro Hitsugaya (TYBW)", "Bleach TYBW", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Kenpachi Zaraki (TYBW)", "Bleach TYBW", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Sosuke Aizen (TYBW)", "Bleach TYBW", "P-Bandai", "high", 110),
        ("S.H.Figuarts", "Jotaro Kujo (Part 3)", "JoJo's Bizarre Adventure", "Standard", "mid", 80),
        ("S.H.Figuarts", "DIO (Part 3)", "JoJo's Bizarre Adventure", "Standard", "mid", 85),
        ("S.H.Figuarts", "Josuke Higashikata (Part 4)", "JoJo's Bizarre Adventure", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Giorno Giovanna (Part 5)", "JoJo's Bizarre Adventure", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Bruno Bucciarati (Part 5)", "JoJo's Bizarre Adventure", "P-Bandai", "mid", 85),

        # ── Proplica — More Props & Sailor Moon (+10) ───────────────────
        ("Proplica", "Cutie Moon Rod (Sailor Moon R)", "Sailor Moon", "Standard", "high", 120),
        ("Proplica", "Moon Stick (Sailor Moon, Brilliant Color)", "Sailor Moon", "P-Bandai", "high", 150),
        ("Proplica", "Moon Princess Halation (Sailor Moon)", "Sailor Moon", "P-Bandai", "high", 140),
        ("Proplica", "Cosmic Heart Compact (Sailor Moon S)", "Sailor Moon", "Standard", "mid", 95),
        ("Proplica", "Crisis Moon Compact (Sailor Moon SuperS)", "Sailor Moon", "Standard", "mid", 95),
        ("Proplica", "Dragon Radar (Dragon Ball)", "Dragon Ball", "Standard", "mid", 80),
        ("Proplica", "Power Pole (Dragon Ball)", "Dragon Ball", "Standard", "mid", 90),
        ("Proplica", "Tanjiro Kamado (Water Breathing)", "Demon Slayer", "Standard", "high", 130),
        ("Proplica", "Zangetsu (Shikai Form, Bleach)", "Bleach TYBW", "Standard", "high", 130),
        ("Proplica", "Sailor V Compact (Codename: Sailor V)", "Sailor Moon", "P-Bandai", "high", 120),

        # ── DX Chogokin Macross Expanded (+10) ──────────────────────────
        ("DX Chogokin", "VF-1J Valkyrie (Hikaru Ichijo)", "Macross", "Standard", "high", 260),
        ("DX Chogokin", "VF-1A Valkyrie (Cannon Fodder)", "Macross", "P-Bandai", "high", 220),
        ("DX Chogokin", "VF-1S Strike Valkyrie (Roy Focker) Renewal", "Macross", "Standard", "grail", 400),
        ("DX Chogokin", "VF-25G Messiah (Michael Blanc Custom)", "Macross Frontier", "P-Bandai", "high", 260),
        ("DX Chogokin", "VF-27 Lucifer (Brera Sterne Custom)", "Macross Frontier", "P-Bandai", "high", 280),
        ("DX Chogokin", "VF-31J Siegfried (Hayate Custom Super Parts)", "Macross Delta", "P-Bandai", "high", 280),
        ("DX Chogokin", "VF-31S Siegfried (Arad Molders Custom)", "Macross Delta", "P-Bandai", "high", 260),
        ("DX Chogokin", "SV-262Hs Draken III (Keith Custom)", "Macross Delta", "P-Bandai", "high", 270),
        ("DX Chogokin", "YF-19 Excalibur (Isamu Alva Dyson)", "Macross Plus", "Standard", "grail", 380),
        ("DX Chogokin", "YF-21 Sturmvogel II (Guld Goa Bowman)", "Macross Plus", "P-Bandai", "grail", 380),

        # ── Figure-rise Standard / LABO (+8) ────────────────────────────
        ("Figure-rise Standard", "Kamen Rider W CycloneJoker", "Kamen Rider W", "Standard", "mid", 45),
        ("Figure-rise Standard", "Kamen Rider Kuuga Mighty Form", "Kamen Rider Kuuga", "Standard", "mid", 45),
        ("Figure-rise Standard", "Ultraman Suit Tiga", "Ultraman", "Standard", "mid", 50),
        ("Figure-rise Standard", "Amplified WarGreymon", "Digimon", "Standard", "mid", 55),
        ("Figure-rise Standard", "Amplified MetalGarurumon", "Digimon", "Standard", "mid", 55),
        ("Figure-rise Standard", "Amplified BlackWarGreymon", "Digimon", "P-Bandai", "mid", 65),
        ("Figure-rise LABO", "Hatsune Miku (V4X)", "Vocaloid", "Standard", "mid", 55),
        ("Figure-rise LABO", "Fumina Hoshino", "Gundam Build Fighters Try", "Standard", "mid", 50),

        # ── P-Bandai HG/MG Web Exclusives (+15) ────────────────────────
        ("HG 1/144", "Moon Gundam", "Gundam Moon", "P-Bandai", "mid", 35),
        ("HG 1/144", "Penelope (Gundam Hathaway)", "Gundam Hathaway", "Standard", "mid", 45),
        ("HG 1/144", "Xi Gundam (Gundam Hathaway)", "Gundam Hathaway", "Standard", "mid", 45),
        ("HG 1/144", "Nightingale", "Gundam CCA-MSV", "P-Bandai", "high", 55),
        ("HG 1/144", "Gundam Calibarn (WfM)", "Gundam: Witch from Mercury", "Standard", "mid", 30),
        ("HG 1/144", "Schwarzette (WfM)", "Gundam: Witch from Mercury", "Standard", "mid", 28),
        ("HG 1/144", "Darilbalde (WfM)", "Gundam: Witch from Mercury", "Standard", "mid", 28),
        ("MG 1/100", "Wing Gundam Zero EW Ver.Ka", "Gundam Wing: Endless Waltz", "Standard", "mid", 65),
        ("MG 1/100", "Tallgeese (EW)", "Gundam Wing: Endless Waltz", "Standard", "mid", 55),
        ("MG 1/100", "Sazabi Ver.Ka", "Gundam CCA", "Standard", "high", 95),
        ("MG 1/100", "Nu Gundam Ver.Ka", "Gundam CCA", "Standard", "high", 85),
        ("MG 1/100", "Unicorn Gundam Ver.Ka", "Gundam Unicorn", "Standard", "mid", 75),
        ("MG 1/100", "Banshee Ver.Ka", "Gundam Unicorn", "Standard", "mid", 75),
        ("MG 1/100", "Full Armor Unicorn Ver.Ka (P-Bandai)", "Gundam Unicorn", "P-Bandai", "high", 110),
        ("MG 1/100", "Eclipse Gundam", "Gundam SEED Eclipse", "Standard", "mid", 65),

        # ── RG 1/144 P-Bandai Exclusives (+10) ──────────────────────────
        ("RG 1/144", "Crossbone Gundam X1", "Crossbone Gundam", "Standard", "mid", 40),
        ("RG 1/144", "Hi-Nu Gundam", "Gundam CCA Beltorchika", "Standard", "mid", 50),
        ("RG 1/144", "Wing Gundam Zero (EW)", "Gundam Wing: Endless Waltz", "Standard", "mid", 40),
        ("RG 1/144", "God Gundam", "G Gundam", "Standard", "mid", 40),
        ("RG 1/144", "Zeong (P-Bandai)", "Mobile Suit Gundam", "P-Bandai", "mid", 55),
        ("RG 1/144", "Full Armor Unicorn Gundam (P-Bandai)", "Gundam Unicorn", "P-Bandai", "mid", 55),
        ("RG 1/144", "Gundam Mk-II (Titans) (P-Bandai)", "Gundam Zeta", "P-Bandai", "mid", 45),
        ("RG 1/144", "Freedom Gundam (SEED Freedom Movie Ver.)", "Gundam SEED Freedom", "Standard", "mid", 40),
        ("RG 1/144", "Mighty Strike Freedom Gundam", "Gundam SEED Freedom", "Standard", "mid", 45),
        ("RG 1/144", "Gundam Astray Red Frame", "Gundam SEED Astray", "Standard", "mid", 38),

        # ── S.H.Figuarts — Demon Slayer Expanded (+10) ──────────────────
        ("S.H.Figuarts", "Tanjiro Kamado (Hinokami Kagura Ver.)", "Demon Slayer", "Standard", "mid", 80),
        ("S.H.Figuarts", "Zenitsu Agatsuma (Thunder Breathing)", "Demon Slayer", "Standard", "mid", 75),
        ("S.H.Figuarts", "Inosuke Hashibira (Beast Breathing)", "Demon Slayer", "Standard", "mid", 75),
        ("S.H.Figuarts", "Kyojuro Rengoku (Flame Hashira)", "Demon Slayer", "Standard", "mid", 85),
        ("S.H.Figuarts", "Giyu Tomioka (Water Hashira, Kizuna no Sou)", "Demon Slayer", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Tengen Uzui (Sound Hashira)", "Demon Slayer", "Standard", "mid", 85),
        ("S.H.Figuarts", "Muichiro Tokito (Mist Hashira)", "Demon Slayer", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Mitsuri Kanroji (Love Hashira)", "Demon Slayer", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Obanai Iguro (Serpent Hashira)", "Demon Slayer", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Sanemi Shinazugawa (Wind Hashira)", "Demon Slayer", "P-Bandai", "mid", 90),

        # ── S.H.Figuarts — My Hero Academia (+8) ───────────────────────
        ("S.H.Figuarts", "Izuku Midoriya (Deku, Full Cowl)", "My Hero Academia", "Standard", "mid", 70),
        ("S.H.Figuarts", "Katsuki Bakugo", "My Hero Academia", "Standard", "mid", 70),
        ("S.H.Figuarts", "Shoto Todoroki", "My Hero Academia", "Standard", "mid", 70),
        ("S.H.Figuarts", "All Might (Buff Form)", "My Hero Academia", "Standard", "mid", 95),
        ("S.H.Figuarts", "All For One", "My Hero Academia", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Tomura Shigaraki (Final War)", "My Hero Academia", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Endeavor (Pro Hero)", "My Hero Academia", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Hawks (Pro Hero)", "My Hero Academia", "P-Bandai", "mid", 90),

        # ── S.H.Figuarts — Dragon Ball Expanded (+12) ──────────────────
        ("S.H.Figuarts", "Super Saiyan 2 Gohan (Cell Saga)", "Dragon Ball Z", "Standard", "mid", 85),
        ("S.H.Figuarts", "Piccolo (Proud Namekian)", "Dragon Ball Z", "Standard", "mid", 75),
        ("S.H.Figuarts", "Nappa", "Dragon Ball Z", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Raditz", "Dragon Ball Z", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Zarbon (Transformed)", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Dodoria", "Dragon Ball Z", "P-Bandai", "mid", 75),
        ("S.H.Figuarts", "King Cold", "Dragon Ball Z", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Android 17 (Universe Survival Saga)", "Dragon Ball Super", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Android 18 (Universe Survival Saga)", "Dragon Ball Super", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Gamma 1 (Super Hero Movie)", "Dragon Ball Super: Super Hero", "Standard", "mid", 75),
        ("S.H.Figuarts", "Gamma 2 (Super Hero Movie)", "Dragon Ball Super: Super Hero", "Standard", "mid", 75),
        ("S.H.Figuarts", "Gohan Beast (Super Hero Movie)", "Dragon Ball Super: Super Hero", "Standard", "mid", 90),

        # ── Ichiban Kuji / Premium Candy Toys (+10) ─────────────────────
        ("Ichiban Kuji", "Super Saiyan Son Goku (Last One Prize)", "Dragon Ball Z", "Ichiban Kuji", "high", 120),
        ("Ichiban Kuji", "Roronoa Zoro (Wano, Last One Prize)", "One Piece", "Ichiban Kuji", "high", 130),
        ("Ichiban Kuji", "Monkey D. Luffy Gear 5 (A Prize)", "One Piece", "Ichiban Kuji", "mid", 80),
        ("Ichiban Kuji", "Vegeta Ultra Ego (A Prize)", "Dragon Ball Super", "Ichiban Kuji", "mid", 85),
        ("Ichiban Kuji", "Gojo Satoru (Last One Prize)", "Jujutsu Kaisen", "Ichiban Kuji", "high", 140),
        ("Ichiban Kuji", "Sukuna (A Prize)", "Jujutsu Kaisen", "Ichiban Kuji", "mid", 90),
        ("SMP", "Turboranger Robo", "Super Sentai", "Standard", "mid", 50),
        ("SMP", "Jetman Jet Garuda", "Super Sentai", "Standard", "mid", 55),
        ("SMP", "Goggle-V Robo", "Super Sentai", "Standard", "mid", 50),
        ("SMP", "Battle Fever Robo", "Super Sentai", "P-Bandai", "mid", 60),

        # ── Soul of Chogokin Expanded (+10) ──────────────────────────────
        ("Soul of Chogokin", "GX-01R Mazinger Z (Renewal)", "Mazinger Z", "Standard", "high", 200),
        ("Soul of Chogokin", "GX-02R Great Mazinger (Renewal)", "Great Mazinger", "Standard", "high", 200),
        ("Soul of Chogokin", "GX-04S UFO Robot Grendizer Spacer", "UFO Robot Grendizer", "Standard", "high", 250),
        ("Soul of Chogokin", "GX-85 Titanus", "MMPR", "Standard", "grail", 320),
        ("Soul of Chogokin", "GX-87 Getter Emperor", "Getter Robo", "Standard", "grail", 350),
        ("Soul of Chogokin", "GX-88 Dairugger XV (Vehicle Voltron)", "Armored Fleet Dairugger", "Standard", "high", 280),
        ("Soul of Chogokin", "GX-68 GaoGaiGar", "GaoGaiGar", "Standard", "grail", 300),
        ("Soul of Chogokin", "GX-69 Goldran", "Brave of Gold Goldran", "Standard", "high", 250),
        ("Soul of Chogokin", "GX-71 Voltron", "Beast King GoLion", "Standard", "high", 250),
        ("Soul of Chogokin", "GX-93 Space Pirate Battleship Arcadia", "Captain Harlock", "Standard", "grail", 380),

        # ── Figuarts ZERO Extra Battle Expanded (+8) ────────────────────
        ("Figuarts ZERO", "Portgas D. Ace -Commander of the 2nd Division-", "One Piece", "Standard", "mid", 85),
        ("Figuarts ZERO", "Sabo -Fire Fist Inheritance-", "One Piece", "Standard", "mid", 80),
        ("Figuarts ZERO", "Boa Hancock -Love Hurricane-", "One Piece", "Standard", "mid", 90),
        ("Figuarts ZERO", "Shanks -Sovereign Haki-", "One Piece", "Standard", "high", 110),
        ("Figuarts ZERO", "Whitebeard Edward Newgate", "One Piece", "Standard", "high", 120),
        ("Figuarts ZERO", "Kozuki Oden -Thunder Bagua-", "One Piece", "Standard", "mid", 95),
        ("Figuarts ZERO", "Yamato -Thunder Bagua-", "One Piece", "Standard", "mid", 90),
        ("Figuarts ZERO", "Gol D. Roger -Pirate King-", "One Piece", "Standard", "high", 110),
    ]


def _expansion_800_metal_build() -> list[tuple]:
    """Round 50k expansion — Metal Build + GFFMC variants (unique coatings/versions)."""
    return [
        ("Metal Build", "RX-78-2 Gundam 20th Anniversary Ver.", "Mobile Suit Gundam", "P-Bandai", "grail", 430),
        ("Metal Build", "Strike Freedom Gundam Immortal Wing Ver.", "Gundam SEED Destiny", "P-Bandai", "grail", 460),
        ("Metal Build", "Wing Gundam Zero EW Noble Color Ver.", "Gundam Wing EW", "P-Bandai", "grail", 470),
        ("Metal Build", "Astray Red Frame Inversion", "Gundam SEED Astray", "P-Bandai", "grail", 440),
        ("Metal Build", "Astray Blue Frame Second Revise Full Weapon", "Gundam SEED Astray", "P-Bandai", "grail", 420),
        ("Metal Build", "Astray Gold Frame Amatsu Mina", "Gundam SEED Astray", "P-Bandai", "grail", 450),
        ("Metal Build", "Gundam Exia Trans-AM Seven Sword Ver.", "Gundam 00", "P-Bandai", "grail", 420),
        ("Metal Build", "00 Qan[T] Full Saber", "Gundam 00 Awakening", "P-Bandai", "grail", 460),
        ("Metal Build", "Destiny Gundam SOUL RED Ver.", "Gundam SEED Destiny", "P-Bandai", "grail", 450),
        ("Metal Build", "Justice Gundam SOUL GREEN Ver.", "Gundam SEED", "P-Bandai", "grail", 440),
        ("Metal Build", "Providence Gundam", "Gundam SEED", "Standard", "grail", 400),
        ("Metal Build", "Freedom Gundam Concept 2 Snow Sparkle Ver.", "Gundam SEED", "P-Bandai", "grail", 470),
        ("Metal Build", "Lightning Strike Gundam IWSP", "Gundam SEED Astray", "P-Bandai", "grail", 410),
        ("Metal Build", "Perfect Strike Gundam Full Package", "Gundam SEED", "P-Bandai", "grail", 420),
        ("Metal Build", "Gundam Dynames Repair III", "Gundam 00", "P-Bandai", "grail", 410),
        ("Metal Build", "Raider Gundam", "Gundam SEED", "P-Bandai", "grail", 400),
        ("Metal Build", "Forbidden Gundam", "Gundam SEED", "P-Bandai", "grail", 390),
        ("Metal Build", "Calamity Gundam", "Gundam SEED", "P-Bandai", "grail", 380),
        ("Metal Build", "Gundam Virtue", "Gundam 00", "P-Bandai", "grail", 410),
        ("Metal Build", "Gundam Kyrios", "Gundam 00", "P-Bandai", "grail", 380),
        ("GFFMC", "RX-93 Nu Gundam Evolution Spec", "Gundam CCA", "P-Bandai", "grail", 500),
        ("GFFMC", "Crossbone Gundam X-0 Full Cloth", "Crossbone Gundam", "P-Bandai", "grail", 490),
        ("GFFMC", "Wing Gundam Zero Custom EW", "Gundam Wing EW", "P-Bandai", "grail", 480),
        ("GFFMC", "Gundam F91 Harrison Custom", "Gundam F91", "P-Bandai", "grail", 450),
        ("GFFMC", "Unicorn Gundam Phenex Destroy Mode Narrative Ver.", "Gundam NT", "P-Bandai", "grail", 520),
        ("GFFMC", "Sinanju Full Psycho-Frame", "Gundam UC", "P-Bandai", "grail", 500),
        ("GFFMC", "Banshee Norn Awakening Ver.", "Gundam UC", "P-Bandai", "grail", 490),
        ("GFFMC", "Zeta Gundam Biosensor Image Color Ver.", "Zeta Gundam", "P-Bandai", "grail", 470),
        ("GFFMC", "Double Zeta Gundam Full Armor", "ZZ Gundam", "P-Bandai", "grail", 480),
    ]


def _expansion_800_robot_spirits() -> list[tuple]:
    """Round 50k — Robot Spirits Macross/Patlabor/VOTOMS/Gundam."""
    return [
        ("Robot Spirits", "VF-0S Valkyrie (Roy Focker)", "Macross Zero", "P-Bandai", "high", 170),
        ("Robot Spirits", "VF-1S Super Valkyrie (Roy Focker)", "Macross", "P-Bandai", "high", 160),
        ("Robot Spirits", "VF-1J Super Valkyrie (Hikaru Ichijyo)", "Macross", "P-Bandai", "high", 150),
        ("Robot Spirits", "SV-51 Gamma (Nora Polyansky)", "Macross Zero", "P-Bandai", "high", 160),
        ("Robot Spirits", "Ingram Unit 1 (Noa Izumi Custom)", "Patlabor", "Standard", "mid", 110),
        ("Robot Spirits", "Ingram Unit 2 (Ohta Custom)", "Patlabor", "Standard", "mid", 105),
        ("Robot Spirits", "Ingram Unit 3 (Shinohara)", "Patlabor", "P-Bandai", "mid", 115),
        ("Robot Spirits", "Griffon (Black Labor)", "Patlabor", "P-Bandai", "high", 155),
        ("Robot Spirits", "Pyro Buster (Labor)", "Patlabor 2", "P-Bandai", "mid", 120),
        ("Robot Spirits", "Scopedog Red Shoulder Ver.", "Armored Trooper VOTOMS", "P-Bandai", "mid", 110),
        ("Robot Spirits", "Scopedog Turbo Custom", "Armored Trooper VOTOMS", "P-Bandai", "mid", 115),
        ("Robot Spirits", "Rabidly Dog (Chirico Custom)", "VOTOMS", "P-Bandai", "high", 150),
        ("Robot Spirits", "Berserga Testa Rossa", "VOTOMS", "P-Bandai", "high", 160),
        ("Robot Spirits", "Strike Dog (Ypsilon Custom)", "VOTOMS", "P-Bandai", "high", 170),
        ("Robot Spirits", "Fatty Ground Type", "VOTOMS", "P-Bandai", "mid", 110),
        ("Robot Spirits", "RX-78NT-1 Alex ver. A.N.I.M.E. (Chobham Armor)", "Gundam 0080", "P-Bandai", "mid", 95),
        ("Robot Spirits", "MS-18E Kampfer ver. A.N.I.M.E.", "Gundam 0080", "P-Bandai", "mid", 90),
        ("Robot Spirits", "MS-14JG Gelgoog Jager ver. A.N.I.M.E.", "Gundam 0080", "P-Bandai", "mid", 85),
        ("Robot Spirits", "RGM-79C GM Type C ver. A.N.I.M.E.", "Gundam 0083", "P-Bandai", "mid", 75),
        ("Robot Spirits", "RX-78GP04G Gerbera ver. A.N.I.M.E.", "Gundam 0083", "P-Bandai", "mid", 95),
        ("Robot Spirits", "MSN-03 Jagd Doga (Gyunei) ver. A.N.I.M.E.", "Gundam CCA", "P-Bandai", "mid", 95),
        ("Robot Spirits", "MSN-03 Jagd Doga (Quess) ver. A.N.I.M.E.", "Gundam CCA", "P-Bandai", "mid", 95),
        ("Robot Spirits", "RGZ-91 Re-GZ ver. A.N.I.M.E.", "Gundam CCA", "P-Bandai", "mid", 80),
        ("Robot Spirits", "AMX-104 R-Jarja ver. A.N.I.M.E.", "ZZ Gundam", "P-Bandai", "mid", 80),
        ("Robot Spirits", "AMX-011 Zaku III ver. A.N.I.M.E.", "ZZ Gundam", "P-Bandai", "mid", 80),
        ("Robot Spirits", "MSZ-010 ZZ Gundam ver. A.N.I.M.E.", "ZZ Gundam", "Standard", "mid", 120),
        ("Robot Spirits", "AMX-014 Doven Wolf ver. A.N.I.M.E.", "ZZ Gundam", "P-Bandai", "mid", 85),
        ("Robot Spirits", "MSK-008 Dijeh ver. A.N.I.M.E.", "Char's Counterattack", "P-Bandai", "mid", 75),
        ("Robot Spirits", "RX-178 Gundam Mk-II (Titans) ver. A.N.I.M.E.", "Zeta Gundam", "Standard", "mid", 90),
        ("Robot Spirits", "RX-160 Byarlant ver. A.N.I.M.E.", "Zeta Gundam", "P-Bandai", "mid", 85),
        ("Robot Spirits", "RX-160S Byarlant Custom ver. A.N.I.M.E.", "Gundam UC", "P-Bandai", "mid", 95),
        ("Robot Spirits", "NZ-666 Kshatriya Repaired ver. A.N.I.M.E.", "Gundam UC", "P-Bandai", "high", 155),
        ("Robot Spirits", "RGM-96X Jesta Cannon ver. A.N.I.M.E.", "Gundam UC", "P-Bandai", "mid", 85),
        ("Robot Spirits", "RX-0 Unicorn Gundam 03 Phenex ver. A.N.I.M.E.", "Gundam NT", "P-Bandai", "high", 170),
        ("Robot Spirits", "EVA Unit-00 Prototype Rebuild Ver.", "Evangelion Rebuild", "P-Bandai", "mid", 90),
        ("Robot Spirits", "EVA Unit-02 Beast Mode", "Evangelion Rebuild", "P-Bandai", "mid", 110),
        ("Robot Spirits", "EVA Unit-08 Gamma", "Evangelion 3.0+1.0", "P-Bandai", "mid", 115),
        ("Robot Spirits", "Mass Production Evangelion Set", "Evangelion EoE", "P-Bandai", "high", 180),
        ("Robot Spirits", "EVA Unit-04 Angel Carrier Ver.", "Evangelion", "P-Bandai", "mid", 100),
    ]


def _expansion_800_shf_exclusives() -> list[tuple]:
    """Round 50k — S.H.Figuarts exclusives Kamen Rider/Dragon Ball/One Piece/Naruto/JJK."""
    return [
        ("S.H.Figuarts", "Kamen Rider Gaim Kiwami Arms Premium Ver.", "Kamen Rider Gaim", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Kamen Rider Drive Type Tridoron", "Kamen Rider Drive", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Kamen Rider Ex-Aid Muteki Gamer", "Kamen Rider Ex-Aid", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Kamen Rider Build RabbitTank Sparkling", "Kamen Rider Build", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Kamen Rider Build Genius Form", "Kamen Rider Build", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Kamen Rider Zi-O Trinity", "Kamen Rider Zi-O", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Kamen Rider Zi-O Grand Zi-O", "Kamen Rider Zi-O", "P-Bandai", "high", 150),
        ("S.H.Figuarts", "Kamen Rider Zero-One Shining Assault Hopper", "Kamen Rider Zero-One", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Kamen Rider Zero-One Metalcluster Hopper", "Kamen Rider Zero-One", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Kamen Rider Saber Primitive Dragon", "Kamen Rider Saber", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Kamen Rider Saber Xross Saber", "Kamen Rider Saber", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Kamen Rider Revice Rex Genome", "Kamen Rider Revice", "Standard", "mid", 85),
        ("S.H.Figuarts", "Kamen Rider Evil Bat Genome", "Kamen Rider Revice", "Standard", "mid", 85),
        ("S.H.Figuarts", "Kamen Rider Jeanne Cobra Genome", "Kamen Rider Revice", "Standard", "mid", 85),
        ("S.H.Figuarts", "Kamen Rider Geats Boost Form Mark II", "Kamen Rider Geats", "Standard", "mid", 90),
        ("S.H.Figuarts", "Kamen Rider Tycoon Ninja Form", "Kamen Rider Geats", "Standard", "mid", 80),
        ("S.H.Figuarts", "Kamen Rider Buffa Zombie Form", "Kamen Rider Geats", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kamen Rider Gotchard Steamhopper", "Kamen Rider Gotchard", "Standard", "mid", 85),
        ("S.H.Figuarts", "Kamen Rider Gotchard Super Alchemist", "Kamen Rider Gotchard", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Super Saiyan Blue Kaioken Goku", "Dragon Ball Super", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Super Saiyan Blue Evolved Vegeta", "Dragon Ball Super", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Jiren Full Power", "Dragon Ball Super", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Toppo God of Destruction Mode", "Dragon Ball Super", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Hit (Universe 6 Assassin)", "Dragon Ball Super", "Standard", "mid", 85),
        ("S.H.Figuarts", "Caulifla Super Saiyan 2", "Dragon Ball Super", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kale Super Saiyan Berserk", "Dragon Ball Super", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Kefla Super Saiyan", "Dragon Ball Super", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Zamasu Fused", "Dragon Ball Super", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Black Goku Super Saiyan Rose", "Dragon Ball Super", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Ultra Ego Vegeta", "Dragon Ball Super", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "SSGSS Goku Premium Color Edition", "Dragon Ball Super", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Android 21 Lab Coat Ver.", "Dragon Ball FighterZ", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Trafalgar Law Gear 5 Reaction Ver.", "One Piece Wano", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Monkey D. Luffy Gear 4 Snakeman", "One Piece WCI", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Monkey D. Luffy Gear 4 Tankman", "One Piece WCI", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Charlotte Katakuri", "One Piece WCI", "P-Bandai", "high", 155),
        ("S.H.Figuarts", "Portgas D. Ace Premium Color Edition", "One Piece Marineford", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Sabo Flame Emperor", "One Piece Dressrosa", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Roronoa Zoro Enma Ver.", "One Piece Wano", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Sanji Germa 66 Raid Suit", "One Piece WCI", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Nico Robin Time Skip Ver.", "One Piece Post Timeskip", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Nami Time Skip Ver.", "One Piece Post Timeskip", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Usopp Time Skip Ver.", "One Piece Post Timeskip", "P-Bandai", "mid", 80),
        ("S.H.Figuarts", "Shanks Film Red Ver.", "One Piece Film Red", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Uta (Film Red)", "One Piece Film Red", "P-Bandai", "mid", 90),
        ("S.H.Figuarts", "Kaido King of the Beasts Hybrid Form", "One Piece Wano", "P-Bandai", "high", 170),
        ("S.H.Figuarts", "Yamato Beast Form", "One Piece Wano", "P-Bandai", "high", 150),
        ("S.H.Figuarts", "Naruto Uzumaki Kurama Link Mode", "Naruto Shippuden", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Naruto Uzumaki Sage Mode Advent", "Naruto Shippuden", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Sasuke Uchiha Susanoo Ver.", "Naruto Shippuden", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Sasuke Uchiha The Last Ver.", "The Last Naruto", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Kakashi Hatake Double Sharingan", "Naruto Shippuden", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Jiraiya Sage Mode", "Naruto Shippuden", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Pain Tendo", "Naruto Shippuden", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Madara Uchiha Edo Tensei", "Naruto Shippuden", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Obito Uchiha Ten Tails Jinchuriki", "Naruto Shippuden", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Hashirama Senju", "Naruto Shippuden", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Tobirama Senju", "Naruto Shippuden", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Gaara Kazekage Ver.", "Naruto Shippuden", "P-Bandai", "mid", 85),
        ("S.H.Figuarts", "Boruto Uzumaki Karma Ver.", "Boruto", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Yuji Itadori Black Flash Ver.", "Jujutsu Kaisen", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Megumi Fushiguro Shikigami Set", "Jujutsu Kaisen", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Nobara Kugisaki Straw Doll Technique", "Jujutsu Kaisen", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Satoru Gojo Hollow Purple Ver.", "Jujutsu Kaisen", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Satoru Gojo Domain Expansion Ver.", "Jujutsu Kaisen", "P-Bandai", "high", 170),
        ("S.H.Figuarts", "Suguru Geto Shibuya Arc Ver.", "Jujutsu Kaisen", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Ryomen Sukuna True Form", "Jujutsu Kaisen", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Kento Nanami Ratio Technique", "Jujutsu Kaisen", "P-Bandai", "mid", 100),
        ("S.H.Figuarts", "Maki Zenin Toji's Weapons Ver.", "Jujutsu Kaisen", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Toji Fushiguro", "Jujutsu Kaisen 0", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Yuta Okkotsu & Rika", "Jujutsu Kaisen 0", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Mahito Transfigured Form", "Jujutsu Kaisen", "P-Bandai", "mid", 105),
        ("S.H.Figuarts", "Choso Blood Manipulation", "Jujutsu Kaisen", "P-Bandai", "mid", 95),
    ]


def _expansion_800_shmonsterarts() -> list[tuple]:
    """Round 50k — S.H.MonsterArts full Godzilla kaiju lineup."""
    return [
        ("S.H.MonsterArts", "Godzilla 1954 Memorial Ver.", "Gojira 1954", "P-Bandai", "grail", 320),
        ("S.H.MonsterArts", "Godzilla 1964 (Mothra vs Godzilla)", "Mothra vs Godzilla", "P-Bandai", "high", 220),
        ("S.H.MonsterArts", "Godzilla 1968 (Destroy All Monsters)", "Destroy All Monsters", "P-Bandai", "high", 210),
        ("S.H.MonsterArts", "Godzilla 1989 (Biollante Edition)", "Godzilla vs Biollante", "P-Bandai", "high", 200),
        ("S.H.MonsterArts", "Godzilla 1991 (Ghidorah Edition)", "Godzilla vs King Ghidorah", "P-Bandai", "high", 210),
        ("S.H.MonsterArts", "Godzilla 1993 (Mechagodzilla Edition)", "Godzilla vs Mechagodzilla II", "P-Bandai", "high", 215),
        ("S.H.MonsterArts", "Godzilla 1994 (SpaceGodzilla Edition)", "Godzilla vs SpaceGodzilla", "P-Bandai", "high", 220),
        ("S.H.MonsterArts", "Godzilla 2000 Millennium", "Godzilla 2000", "P-Bandai", "high", 180),
        ("S.H.MonsterArts", "Godzilla 2001 (GMK)", "GMK", "P-Bandai", "high", 200),
        ("S.H.MonsterArts", "Godzilla 2002 (Kiryu Saga)", "Godzilla Against Mechagodzilla", "P-Bandai", "high", 190),
        ("S.H.MonsterArts", "Godzilla 2004 Final Wars Poster Color", "Godzilla Final Wars", "P-Bandai", "high", 200),
        ("S.H.MonsterArts", "Godzilla Heisei Memorial Set", "Heisei Godzilla", "P-Bandai", "grail", 380),
        ("S.H.MonsterArts", "Godzilla Earth (Godzilla Anime)", "Godzilla: Planet of the Monsters", "Standard", "grail", 350),
        ("S.H.MonsterArts", "Mechagodzilla City", "Godzilla City on the Edge", "P-Bandai", "grail", 330),
        ("S.H.MonsterArts", "Godzilla Ultima", "Godzilla Singular Point", "Standard", "high", 180),
        ("S.H.MonsterArts", "Jet Jaguar PP (Singular Point)", "Godzilla Singular Point", "Standard", "high", 150),
        ("S.H.MonsterArts", "Rodan (Showa 1956)", "Rodan 1956", "P-Bandai", "high", 170),
        ("S.H.MonsterArts", "Rodan (Final Wars)", "Godzilla Final Wars", "P-Bandai", "mid", 120),
        ("S.H.MonsterArts", "Anguirus (Showa 1955)", "Godzilla Raids Again", "P-Bandai", "high", 170),
        ("S.H.MonsterArts", "King Ghidorah (Showa)", "Ghidorah the Three-Headed Monster", "P-Bandai", "grail", 360),
        ("S.H.MonsterArts", "King Ghidorah (Heisei)", "Godzilla vs King Ghidorah", "P-Bandai", "grail", 360),
        ("S.H.MonsterArts", "Mecha King Ghidorah", "Godzilla vs King Ghidorah", "P-Bandai", "grail", 380),
        ("S.H.MonsterArts", "Keizer Ghidorah", "Godzilla Final Wars", "P-Bandai", "grail", 340),
        ("S.H.MonsterArts", "Mothra Leo", "Rebirth of Mothra", "P-Bandai", "high", 180),
        ("S.H.MonsterArts", "Mothra (Imago 1964)", "Mothra vs Godzilla", "P-Bandai", "high", 190),
        ("S.H.MonsterArts", "Mothra (Larva & Imago) 2019", "Godzilla KOTM", "P-Bandai", "high", 200),
        ("S.H.MonsterArts", "Battra (Imago)", "Godzilla vs Mothra 1992", "P-Bandai", "high", 175),
        ("S.H.MonsterArts", "Megalon (1973)", "Godzilla vs Megalon", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Gigan (Final Wars Modified)", "Godzilla Final Wars", "P-Bandai", "mid", 140),
        ("S.H.MonsterArts", "MOGUERA (vs SpaceGodzilla)", "Godzilla vs SpaceGodzilla", "P-Bandai", "high", 180),
        ("S.H.MonsterArts", "Super MechaGodzilla (1993)", "Godzilla vs Mechagodzilla II", "P-Bandai", "grail", 310),
        ("S.H.MonsterArts", "Kiryu Heavy Armor Ver.", "Godzilla Tokyo SOS", "P-Bandai", "high", 220),
        ("S.H.MonsterArts", "Kong (Skull Island)", "Kong Skull Island", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Kong (Hollow Earth Axe Ver.)", "Godzilla vs Kong", "P-Bandai", "high", 170),
        ("S.H.MonsterArts", "Beast Glove Kong", "Godzilla x Kong New Empire", "P-Bandai", "mid", 140),
        ("S.H.MonsterArts", "Godzilla Evolved Fire Form", "Godzilla x Kong New Empire", "P-Bandai", "high", 170),
        ("S.H.MonsterArts", "Scar King & Shimo Set", "Godzilla x Kong New Empire", "P-Bandai", "high", 220),
        ("S.H.MonsterArts", "Godzilla 2019 Heat Ray Ver.", "Godzilla KOTM", "P-Bandai", "high", 180),
        ("S.H.MonsterArts", "Burning Godzilla 2019", "Godzilla KOTM", "P-Bandai", "high", 200),
        ("S.H.MonsterArts", "Titanosaurus (Showa)", "Terror of Mechagodzilla", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Gabara", "All Monsters Attack", "P-Bandai", "mid", 120),
        ("S.H.MonsterArts", "Ebirah (Showa)", "Godzilla vs the Sea Monster", "P-Bandai", "mid", 140),
        ("S.H.MonsterArts", "Minilla (Showa)", "Son of Godzilla", "P-Bandai", "mid", 95),
        ("S.H.MonsterArts", "Orga", "Godzilla 2000", "P-Bandai", "high", 160),
        ("S.H.MonsterArts", "Megaguirus", "Godzilla vs Megaguirus", "P-Bandai", "high", 170),
        ("S.H.MonsterArts", "Godzilla Minus One 2023", "Godzilla Minus One", "Standard", "grail", 320),
        ("S.H.MonsterArts", "Godzilla Minus One Heat Ray Ver.", "Godzilla Minus One", "P-Bandai", "grail", 340),
    ]


def _expansion_800_csm() -> list[tuple]:
    """Round 50k — Complete Selection Modification Kamen Rider belts."""
    return [
        ("CSM", "Faiz Driver Complete Selection", "Kamen Rider 555", "P-Bandai", "grail", 420),
        ("CSM", "Faiz Gear Phone Blaster", "Kamen Rider 555", "P-Bandai", "high", 260),
        ("CSM", "Faiz Axel & Blaster Gear Set", "Kamen Rider 555", "P-Bandai", "grail", 450),
        ("CSM", "Kaixa Driver Complete Selection", "Kamen Rider 555", "P-Bandai", "grail", 400),
        ("CSM", "Delta Driver Complete Selection", "Kamen Rider 555", "P-Bandai", "high", 290),
        ("CSM", "Psyga & Orga Driver Set", "Kamen Rider 555", "P-Bandai", "grail", 430),
        ("CSM", "Kabuto Zecter Complete Selection", "Kamen Rider Kabuto", "P-Bandai", "grail", 410),
        ("CSM", "Hyper Zecter", "Kamen Rider Kabuto", "P-Bandai", "high", 290),
        ("CSM", "Gatack Zecter", "Kamen Rider Kabuto", "P-Bandai", "high", 250),
        ("CSM", "TheBee Zecter Renewal", "Kamen Rider Kabuto", "P-Bandai", "high", 220),
        ("CSM", "Dark Kabuto Zecter", "Kamen Rider Kabuto", "P-Bandai", "high", 240),
        ("CSM", "Den-O Belt & Terminal Buckle", "Kamen Rider Den-O", "P-Bandai", "grail", 380),
        ("CSM", "Zeronos Belt & ZeroGasher", "Kamen Rider Den-O", "P-Bandai", "grail", 360),
        ("CSM", "K-Touch 21 (Decade Complete)", "Kamen Rider Decade", "P-Bandai", "high", 270),
        ("CSM", "Decadriver & Rider Card Set", "Kamen Rider Decade", "P-Bandai", "grail", 380),
        ("CSM", "Double Driver Memorial Ver.", "Kamen Rider W", "P-Bandai", "grail", 400),
        ("CSM", "Gaia Memory Complete Set 01", "Kamen Rider W", "P-Bandai", "grail", 350),
        ("CSM", "Gaia Memory Complete Set 02", "Kamen Rider W", "P-Bandai", "grail", 360),
        ("CSM", "Accel Driver", "Kamen Rider W", "P-Bandai", "high", 250),
        ("CSM", "Lost Driver", "Kamen Rider W", "P-Bandai", "high", 230),
        ("CSM", "OOO Driver Complete Selection", "Kamen Rider OOO", "P-Bandai", "grail", 420),
        ("CSM", "Core Medal Full Set", "Kamen Rider OOO", "P-Bandai", "grail", 450),
        ("CSM", "Birth Driver & CLAWs", "Kamen Rider OOO", "P-Bandai", "high", 290),
        ("CSM", "Fourze Driver & Switch Set", "Kamen Rider Fourze", "P-Bandai", "grail", 380),
        ("CSM", "Meteor Driver & Switch", "Kamen Rider Fourze", "P-Bandai", "high", 250),
        ("CSM", "Wizardriver Complete Selection", "Kamen Rider Wizard", "P-Bandai", "grail", 350),
        ("CSM", "Beast Driver", "Kamen Rider Wizard", "P-Bandai", "high", 250),
        ("CSM", "Sengoku Driver & Lockseeds", "Kamen Rider Gaim", "P-Bandai", "grail", 400),
        ("CSM", "Genesis Driver & Energy Lockseeds", "Kamen Rider Gaim", "P-Bandai", "grail", 370),
        ("CSM", "Drive Driver & Shift Cars", "Kamen Rider Drive", "P-Bandai", "grail", 390),
        ("CSM", "Mach Driver Honoh", "Kamen Rider Drive", "P-Bandai", "high", 260),
        ("CSM", "Gamer Driver & Gashats", "Kamen Rider Ex-Aid", "P-Bandai", "grail", 380),
        ("CSM", "Build Driver & Full Bottles", "Kamen Rider Build", "P-Bandai", "grail", 380),
        ("CSM", "Sclash Driver", "Kamen Rider Build", "P-Bandai", "high", 260),
        ("CSM", "Evol Driver", "Kamen Rider Build", "P-Bandai", "high", 280),
        ("CSM", "Ziku-Driver & Ridewatch Set", "Kamen Rider Zi-O", "P-Bandai", "grail", 380),
        ("CSM", "Beyondriver & Miride Watch", "Kamen Rider Zi-O", "P-Bandai", "high", 280),
        ("CSM", "Neo Decadriver & Ride Book", "Kamen Rider Decade", "P-Bandai", "high", 290),
        ("CSM", "Kuuga Arcle Memorial Ver.", "Kamen Rider Kuuga", "P-Bandai", "grail", 380),
        ("CSM", "Agito Alter Ring Complete", "Kamen Rider Agito", "P-Bandai", "grail", 370),
        ("CSM", "Ryuki Drag Visor & Card Deck", "Kamen Rider Ryuki", "P-Bandai", "grail", 400),
        ("CSM", "Blade Buckle Complete Selection", "Kamen Rider Blade", "P-Bandai", "grail", 360),
        ("CSM", "Hibiki Ongekido Set", "Kamen Rider Hibiki", "P-Bandai", "high", 260),
    ]


def _expansion_800_smp_ichiban() -> list[tuple]:
    """Round 50k — Super Mini-Pla + Ichiban Kuji Last One prizes."""
    return [
        ("Super Mini-Pla", "Daizyujin (Gosei Sentai Dairanger)", "Mighty Morphin Megazord", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "Dragon Caesar", "Zyuranger", "P-Bandai", "high", 140),
        ("Super Mini-Pla", "Kakure Daishogun", "Kakuranger", "P-Bandai", "high", 180),
        ("Super Mini-Pla", "Muteki Shogun", "Dairanger", "P-Bandai", "high", 200),
        ("Super Mini-Pla", "Daibouken", "Boukenger", "P-Bandai", "high", 170),
        ("Super Mini-Pla", "Ohranger Robo", "Ohranger", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "GaoKing", "Gaoranger", "P-Bandai", "high", 170),
        ("Super Mini-Pla", "Abaranger Abarenoh", "Abaranger", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "Dekaranger Robo", "Dekaranger", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "Magiking", "Magiranger", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "Super King Brothers VF Set", "Go-Busters", "P-Bandai", "grail", 320),
        ("Super Mini-Pla", "Victory Robo", "Carranger", "P-Bandai", "high", 140),
        ("Super Mini-Pla", "Galaxy Mega", "Megaranger", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "Gaogaigar Final Fusion Set", "GaoGaiGar", "P-Bandai", "grail", 380),
        ("Super Mini-Pla", "Space Runaway Ideon", "Ideon", "P-Bandai", "grail", 300),
        ("Super Mini-Pla", "Xabungle Walker Garrier", "Combat Mecha Xabungle", "P-Bandai", "high", 180),
        ("Super Mini-Pla", "Dancouga", "Dancouga", "P-Bandai", "high", 220),
        ("Super Mini-Pla", "Dragonar-1 Custom", "Metal Armor Dragonar", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "L-Gaim Mark II", "Heavy Metal L-Gaim", "P-Bandai", "high", 170),
        ("Super Mini-Pla", "Layzner MkII", "Blue Comet SPT Layzner", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "Srungle", "Gold Lightan", "P-Bandai", "high", 150),
        ("Super Mini-Pla", "Baikanfu", "Machine Robo Revenge of Cronos", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "Trider G7", "Invincible Robo Trider G7", "P-Bandai", "high", 170),
        ("Super Mini-Pla", "Daioja", "Saikyou Robo Daioja", "P-Bandai", "high", 160),
        ("Super Mini-Pla", "Godmars Six God Fusion", "Six God Combination Godmars", "P-Bandai", "grail", 310),
        ("Ichiban Kuji", "Goku SSJ3 Last One Prize Ver.", "Dragon Ball Z", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Vegeta SSJ Blue Evolved Last One Prize", "Dragon Ball Super", "Event Exclusive", "high", 170),
        ("Ichiban Kuji", "Frieza Full Power Last One Prize", "Dragon Ball Super", "Event Exclusive", "high", 150),
        ("Ichiban Kuji", "Cell Perfect Form Last One Prize", "Dragon Ball Z", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Gohan Beast Last One Prize", "Dragon Ball Super Hero", "Event Exclusive", "high", 180),
        ("Ichiban Kuji", "Ultra Ego Vegeta Last One Prize", "Dragon Ball Super Granolah", "Event Exclusive", "high", 170),
        ("Ichiban Kuji", "Broly Full Power Last One Prize", "Dragon Ball Super Broly", "Event Exclusive", "high", 190),
        ("Ichiban Kuji", "Luffy Gear 5 Last One Prize", "One Piece Wano", "Event Exclusive", "high", 180),
        ("Ichiban Kuji", "Zoro King of Hell Last One Prize", "One Piece Wano", "Event Exclusive", "high", 170),
        ("Ichiban Kuji", "Sanji Ifrit Jambe Last One Prize", "One Piece Wano", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Kaido Dragon Form Last One Prize", "One Piece Wano", "Event Exclusive", "high", 190),
        ("Ichiban Kuji", "Shanks Film Red Last One Prize", "One Piece Film Red", "Event Exclusive", "high", 170),
        ("Ichiban Kuji", "Ace Fire Fist Last One Prize", "One Piece Marineford", "Event Exclusive", "high", 150),
        ("Ichiban Kuji", "Naruto Six Paths Sage Last One Prize", "Naruto Shippuden", "Event Exclusive", "high", 165),
        ("Ichiban Kuji", "Sasuke Rinnegan Last One Prize", "Naruto Shippuden", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Itachi Susanoo Last One Prize", "Naruto Shippuden", "Event Exclusive", "high", 175),
        ("Ichiban Kuji", "Madara Perfect Susanoo Last One Prize", "Naruto Shippuden", "Event Exclusive", "grail", 220),
        ("Ichiban Kuji", "Gojo Domain Expansion Last One Prize", "Jujutsu Kaisen", "Event Exclusive", "high", 200),
        ("Ichiban Kuji", "Sukuna True Form Last One Prize", "Jujutsu Kaisen", "Event Exclusive", "high", 190),
        ("Ichiban Kuji", "Yuji Black Flash Last One Prize", "Jujutsu Kaisen", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Tanjiro Hinokami Kagura Last One Prize", "Demon Slayer", "Event Exclusive", "high", 170),
        ("Ichiban Kuji", "Nezuko Demon Form Last One Prize", "Demon Slayer", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Rengoku Ninth Form Last One Prize", "Demon Slayer Mugen Train", "Event Exclusive", "high", 180),
        ("Ichiban Kuji", "Tengen Uzui Last One Prize", "Demon Slayer Entertainment District", "Event Exclusive", "high", 165),
        ("Ichiban Kuji", "Muichiro Tokito Last One Prize", "Demon Slayer Swordsmith", "Event Exclusive", "high", 155),
        ("Ichiban Kuji", "Deku One For All 100% Last One Prize", "My Hero Academia", "Event Exclusive", "high", 160),
        ("Ichiban Kuji", "Bakugo Howitzer Impact Last One Prize", "My Hero Academia", "Event Exclusive", "high", 155),
        ("Ichiban Kuji", "All Might Prime Last One Prize", "My Hero Academia", "Event Exclusive", "high", 180),
        ("Ichiban Kuji", "Shoto Todoroki Last One Prize", "My Hero Academia", "Event Exclusive", "high", 150),
        ("Ichiban Kuji", "Eren Titan Form Last One Prize", "Attack on Titan Final", "Event Exclusive", "high", 185),
        ("Ichiban Kuji", "Levi Ackerman Last One Prize", "Attack on Titan", "Event Exclusive", "high", 180),
        ("Ichiban Kuji", "Mikasa Ackerman Last One Prize", "Attack on Titan Final", "Event Exclusive", "high", 160),
    ]


def _expansion_800_shf_movie_premium() -> list[tuple]:
    """Round 50k — S.H.Figuarts Star Wars/Marvel movie exclusives + Premium Bandai misc."""
    return [
        ("S.H.Figuarts", "Darth Vader Obi-Wan Kenobi Ver.", "Star Wars: Obi-Wan Kenobi", "P-Bandai", "high", 170),
        ("S.H.Figuarts", "Luke Skywalker Yavin Ceremony Ver.", "Star Wars: A New Hope", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Han Solo Bespin Ver.", "Star Wars: Empire Strikes Back", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Princess Leia Boushh Disguise", "Star Wars: Return of the Jedi", "P-Bandai", "mid", 140),
        ("S.H.Figuarts", "Boba Fett Prototype Armor Ver.", "Star Wars", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Mandalorian Beskar Armor Final Ver.", "The Mandalorian S3", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Grogu & Hover Pram Set", "The Mandalorian", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Cad Bane", "The Book of Boba Fett", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Din Djarin with N-1 Starfighter Cockpit", "The Mandalorian", "P-Bandai", "high", 180),
        ("S.H.Figuarts", "Ahsoka Tano (Live Action)", "Ahsoka", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Grand Admiral Thrawn (Live Action)", "Ahsoka", "P-Bandai", "high", 155),
        ("S.H.Figuarts", "Sabine Wren (Live Action)", "Ahsoka", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Stormtrooper TK-421 Ver.", "Star Wars: A New Hope", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Death Trooper (Rogue One)", "Rogue One", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "K-2SO", "Rogue One / Andor", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Iron Man Mark 85 Final Battle Ver.", "Avengers Endgame", "P-Bandai", "high", 180),
        ("S.H.Figuarts", "Iron Man Mark 7 Battle Damage Ver.", "Avengers", "P-Bandai", "mid", 140),
        ("S.H.Figuarts", "Captain America Infinity War Scout Ver.", "Avengers Infinity War", "P-Bandai", "mid", 135),
        ("S.H.Figuarts", "Hulk Endgame Smart Hulk", "Avengers Endgame", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Thor Endgame Final Battle", "Avengers Endgame", "P-Bandai", "high", 150),
        ("S.H.Figuarts", "Spider-Man Integrated Suit", "Spider-Man No Way Home", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Spider-Man Black & Gold Suit", "Spider-Man No Way Home", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Spider-Man Final Swing Suit", "Spider-Man No Way Home", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Spider-Man 2099 Miguel O'Hara", "Across the Spider-Verse", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Miles Morales Spider-Man Across", "Across the Spider-Verse", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Doctor Strange Multiverse of Madness", "Doctor Strange 2", "P-Bandai", "mid", 120),
        ("S.H.Figuarts", "Scarlet Witch Chaos Magic Ver.", "Doctor Strange 2", "P-Bandai", "high", 160),
        ("S.H.Figuarts", "Black Panther Wakanda Forever", "Wakanda Forever", "P-Bandai", "mid", 140),
        ("S.H.Figuarts", "Namor", "Wakanda Forever", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Moon Knight", "Moon Knight", "P-Bandai", "mid", 125),
        ("S.H.Figuarts", "Mr. Knight", "Moon Knight", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Kang the Conqueror", "Quantumania", "P-Bandai", "mid", 130),
        ("S.H.Figuarts", "Loki (Variant TVA Suit)", "Loki Series", "P-Bandai", "mid", 115),
        ("S.H.Figuarts", "Sylvie Loki", "Loki Series", "P-Bandai", "mid", 110),
        ("S.H.Figuarts", "Rocket Raccoon (GOTG Vol 3)", "GOTG Vol 3", "P-Bandai", "mid", 95),
        ("S.H.Figuarts", "Star-Lord High Evolutionary Ver.", "GOTG Vol 3", "P-Bandai", "mid", 115),
        ("Figure-rise Standard", "Gohan Beast Premium Paint Ver.", "Dragon Ball Super Hero", "P-Bandai", "mid", 85),
        ("Figure-rise Standard", "Piccolo Orange Premium Paint Ver.", "Dragon Ball Super Hero", "P-Bandai", "mid", 80),
        ("Figure-rise Standard", "Gogeta SSGSS Premium Paint", "Dragon Ball Super Broly", "P-Bandai", "mid", 90),
        ("Figure-rise Standard", "Broly Full Power Premium Paint", "Dragon Ball Super Broly", "P-Bandai", "mid", 95),
        ("Figure-rise Standard", "Amazing Yamcha Last One Prize", "Dragon Ball", "P-Bandai", "mid", 75),
        ("Figure-rise Standard", "Android 17 Premium Paint Ver.", "Dragon Ball Super", "P-Bandai", "mid", 70),
        ("Figure-rise Standard", "Frieza First Form Premium Paint", "Dragon Ball Z", "P-Bandai", "mid", 80),
        ("Figure-rise Standard", "Luffy Gear 5 Awakening Premium", "One Piece Wano", "P-Bandai", "mid", 90),
        ("Figure-rise Standard", "Zoro Three Sword Style Premium", "One Piece Wano", "P-Bandai", "mid", 85),
        ("Figure-rise Standard", "Shanks Top Tier Premium Ver.", "One Piece", "P-Bandai", "mid", 95),
        ("Figure-rise Standard", "Asta Black Demon Premium Ver.", "Black Clover", "P-Bandai", "mid", 75),
        ("Figure-rise Standard", "Yuji Itadori Premium Ver.", "Jujutsu Kaisen", "P-Bandai", "mid", 70),
        ("Figure-rise Standard", "Gojo Satoru Limitless Premium", "Jujutsu Kaisen", "P-Bandai", "mid", 85),
        ("Figure-rise Standard", "Naruto Baryon Mode Premium", "Naruto Boruto", "P-Bandai", "mid", 90),
        ("Figure-rise Standard", "Tanjiro Hinokami Premium Ver.", "Demon Slayer", "P-Bandai", "mid", 75),
        ("Figure-rise Standard", "Deku OFA 100% Premium Ver.", "My Hero Academia", "P-Bandai", "mid", 70),
        ("Action Base", "Action Base 4 Clear Premium Edition", "Gundam Display", "P-Bandai", "standard", 18),
        ("Action Base", "Action Base 5 Special Anniversary", "Gundam Display", "P-Bandai", "standard", 22),
        ("Action Base", "Action Base 6 for HG Mobile Suits", "Gundam Display", "Standard", "standard", 12),
        ("Action Base", "Mega Size Action Base Display", "Gundam Display", "P-Bandai", "mid", 60),
        ("Action Base", "Tamashii Stage Act 4 Clear", "Tamashii Stage", "Standard", "standard", 15),
        ("Action Base", "Tamashii Stage Act 5 Humanoid", "Tamashii Stage", "Standard", "standard", 18),
        ("Action Base", "Tamashii Stage Act Combination Red", "Tamashii Stage", "P-Bandai", "standard", 25),
        ("Action Base", "Tamashii Stage Wings for S.H.MonsterArts", "Tamashii Stage", "P-Bandai", "mid", 45),
        ("Action Base", "Tamashii Effect Wave Clear Blue", "Tamashii Effect", "Standard", "standard", 22),
        ("Action Base", "Tamashii Effect Explosion Yellow", "Tamashii Effect", "Standard", "standard", 24),
        ("Action Base", "Tamashii Effect Burning Flame Red", "Tamashii Effect", "Standard", "standard", 22),
        ("Action Base", "Tamashii Effect Impact Grey", "Tamashii Effect", "Standard", "standard", 20),
        ("Proplica", "Henshin Belt Double Driver Memorial Edition", "Kamen Rider W", "P-Bandai", "grail", 310),
        ("Proplica", "Fourze Driver Memorial Edition", "Kamen Rider Fourze", "P-Bandai", "high", 260),
        ("Proplica", "Moon Stick Renewal Ver.", "Sailor Moon", "P-Bandai", "high", 220),
        ("Proplica", "Spiral Heart Moon Rod Renewal", "Sailor Moon S", "P-Bandai", "high", 240),
        ("Proplica", "Holy Grail Sailor Moon", "Sailor Moon S", "P-Bandai", "grail", 320),
        ("Proplica", "Crisis Moon Compact", "Sailor Moon SuperS", "P-Bandai", "high", 180),
        ("Proplica", "Eternal Tiare", "Sailor Moon Sailor Stars", "P-Bandai", "grail", 340),
        ("Proplica", "Nichirin Sword Tanjiro Ver.", "Demon Slayer", "Standard", "high", 200),
        ("Proplica", "Nichirin Sword Zenitsu Ver.", "Demon Slayer", "Standard", "high", 220),
        ("Proplica", "Nichirin Katana Rengoku Ver.", "Demon Slayer Mugen Train", "P-Bandai", "high", 260),
        ("Proplica", "Nichirin Katana Tengen Uzui Dual Swords", "Demon Slayer Entertainment", "P-Bandai", "grail", 320),
        ("Proplica", "Zanpakuto Zangetsu Renewal", "Bleach TYBW", "P-Bandai", "high", 280),
    ]


def _expansion_800_pbandai_webex() -> list[tuple]:
    """Round 50k — Premium Bandai web exclusives (limited-run kits)."""
    return [
        ("HG 1/144", "Gundam Aerial Bit on Form Ver.", "Gundam Witch from Mercury", "P-Bandai", "standard", 30),
        ("HG 1/144", "Gundam Calibarn Permet Score Six", "Gundam Witch from Mercury", "P-Bandai", "standard", 32),
        ("HG 1/144", "Gundam Lfrith Thorn", "Gundam Witch from Mercury", "P-Bandai", "standard", 28),
        ("HG 1/144", "Gundam Schwarzette Clear Color", "Gundam Witch from Mercury", "P-Bandai", "mid", 45),
        ("HG 1/144", "Michaelis Clear Color", "Gundam Witch from Mercury", "P-Bandai", "standard", 35),
        ("HG 1/144", "Beguir-Pente Clear Color", "Gundam Witch from Mercury", "P-Bandai", "standard", 32),
        ("HG 1/144", "Zowort Heavy White Ogre Ver.", "Gundam UC", "P-Bandai", "standard", 28),
        ("HG 1/144", "Geara Zulu Angelo Sauper Custom Clear Color", "Gundam UC", "P-Bandai", "mid", 42),
        ("HG 1/144", "Silver Bullet Suppressor", "Gundam NT", "P-Bandai", "standard", 38),
        ("HG 1/144", "Loto Twin Set", "Gundam UC", "P-Bandai", "mid", 45),
        ("HG 1/144", "Pale Rider Cavalry", "Gundam Side Story", "P-Bandai", "standard", 32),
        ("HG 1/144", "Pale Rider Ground Heavy Equipment", "Gundam Side Story", "P-Bandai", "standard", 34),
        ("HG 1/144", "Gundam Pixie", "Gundam MSV", "P-Bandai", "standard", 28),
        ("HG 1/144", "Gelgoog Marine (Cima Garahau)", "Gundam 0083", "P-Bandai", "standard", 30),
        ("HG 1/144", "Xeku Eins", "Gundam Senki", "P-Bandai", "standard", 32),
        ("HG 1/144", "Zudah F-Type", "MS IGLOO", "P-Bandai", "standard", 28),
        ("HG 1/144", "Psycho Zaku Twin Set (Thunderbolt Ver Ka)", "Thunderbolt", "P-Bandai", "mid", 55),
        ("HG 1/144", "Atlas Gundam Bandit Flower Ver.", "Thunderbolt", "P-Bandai", "standard", 35),
        ("HG 1/144", "Full Armor Gundam (Thunderbolt) Anime Image Color", "Thunderbolt", "P-Bandai", "mid", 48),
        ("MG 1/100", "Hyaku-Shiki Crash (Hidetoshi Uno Ver.)", "Zeta Gundam", "P-Bandai", "mid", 90),
        ("MG 1/100", "Zeta Gundam Ver.Ka Clear Color Body", "Zeta Gundam", "P-Bandai", "mid", 110),
        ("MG 1/100", "Freedom Gundam 2.0 Full Burst Mode Special Coating", "Gundam SEED", "P-Bandai", "mid", 125),
        ("MG 1/100", "RX-78-2 Gundam Ver.3.0 Mechanical Clear", "Mobile Suit Gundam", "P-Bandai", "mid", 135),
        ("MG 1/100", "MS-06S Char's Zaku II Ver.2.0 Mechanical Clear", "Mobile Suit Gundam", "P-Bandai", "mid", 130),
        ("MG 1/100", "Gouf Custom Mechanical Clear Ver.", "Gundam 08th MS Team", "P-Bandai", "mid", 120),
        ("MG 1/100", "Sazabi Ver.Ka Mechanical Clear Ver.", "Gundam CCA", "P-Bandai", "high", 180),
        ("MG 1/100", "Sazabi Ver.Ka Titanium Finish", "Gundam CCA", "P-Bandai", "high", 220),
        ("MG 1/100", "F91 Gundam Ver.2.0 Titanium Finish", "Gundam F91", "P-Bandai", "mid", 145),
        ("MG 1/100", "V2 Gundam Ver.Ka Titanium Finish", "V Gundam", "P-Bandai", "high", 160),
        ("MG 1/100", "Shining Gundam Hyper Mode Coating Ver.", "G Gundam", "P-Bandai", "mid", 115),
        ("MG 1/100", "God Gundam Hyper Mode Coating Ver.", "G Gundam", "P-Bandai", "mid", 120),
        ("MG 1/100", "Master Gundam Hyper Mode Coating Ver.", "G Gundam", "P-Bandai", "mid", 125),
        ("RG 1/144", "Sazabi Special Coating Ver.", "Gundam CCA", "P-Bandai", "mid", 85),
        ("RG 1/144", "Nu Gundam Special Coating Ver.", "Gundam CCA", "P-Bandai", "mid", 82),
        ("RG 1/144", "Hi-Nu Gundam Special Coating Ver.", "Gundam CCA", "P-Bandai", "mid", 80),
        ("RG 1/144", "Zeta Gundam Special Coating Ver.", "Zeta Gundam", "P-Bandai", "mid", 78),
        ("RG 1/144", "ZZ Gundam Special Coating Ver.", "ZZ Gundam", "P-Bandai", "mid", 85),
        ("RG 1/144", "Unicorn Gundam Perfectibility Ver.", "Gundam UC", "P-Bandai", "mid", 95),
        ("RG 1/144", "Banshee Norn Expansion Set", "Gundam UC", "P-Bandai", "mid", 70),
        ("RG 1/144", "Aile Strike Gundam Real Color Ver.", "Gundam SEED", "P-Bandai", "mid", 75),
        ("RG 1/144", "Justice Gundam Real Color Ver.", "Gundam SEED", "P-Bandai", "mid", 70),
        ("RG 1/144", "Providence Gundam Real Color Ver.", "Gundam SEED", "P-Bandai", "mid", 72),
        ("PG 1/60", "00 Raiser Clear Color Body", "Gundam 00", "P-Bandai", "grail", 420),
        ("PG 1/60", "RX-78-2 Gundam Titanium Finish", "Mobile Suit Gundam", "P-Bandai", "grail", 500),
        ("PG 1/60", "Red Frame Astray Clear Color Body", "Gundam SEED Astray", "P-Bandai", "grail", 420),
        ("PG 1/60", "Gundam Exia Lighting Model Snow White", "Gundam 00", "P-Bandai", "grail", 410),
        ("DX Chogokin", "VF-25G Super Messiah Valkyrie (Mikhail Custom)", "Macross Frontier", "P-Bandai", "high", 290),
        ("DX Chogokin", "VF-27 Lucifer Valkyrie (Brera Sterne)", "Macross Frontier", "P-Bandai", "high", 280),
        ("DX Chogokin", "VF-31A Kairos (Chuck Mustang)", "Macross Delta", "P-Bandai", "high", 260),
        ("DX Chogokin", "VF-31F Siegfried (Messer Custom)", "Macross Delta", "P-Bandai", "high", 270),
        ("DX Chogokin", "VF-31E Siegfried (Reina Custom)", "Macross Delta", "P-Bandai", "high", 260),
        ("DX Chogokin", "VF-31C Siegfried (Mirage Custom)", "Macross Delta", "P-Bandai", "high", 265),
        ("DX Chogokin", "YF-30 Chronos", "Macross 30", "P-Bandai", "grail", 320),
        ("DX Chogokin", "Sv-262Hs Draken III (Keith Custom)", "Macross Delta", "P-Bandai", "grail", 310),
        ("DX Chogokin", "VF-1J Valkyrie (Miriya Fallyna Jenius)", "Macross", "P-Bandai", "high", 290),
        ("DX Chogokin", "VF-1S Valkyrie Roy Focker Special Edition", "Macross Do You Remember Love", "P-Bandai", "grail", 350),
    ]
...
def get_curated_catalog() -> list[dict]:
    ...
    items += _expansion_1000_round35()
    items += _expansion_1150_round35b()
    items += _expansion_round12_bandai()
    items += _expansion_800_metal_build()
    items += _expansion_800_robot_spirits()
    items += _expansion_800_shf_exclusives()
    items += _expansion_800_shmonsterarts()
    items += _expansion_800_csm()
    items += _expansion_800_smp_ichiban()
    items += _expansion_800_shf_movie_premium()
    items += _expansion_800_pbandai_webex()
