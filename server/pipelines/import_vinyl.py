...
def _soundtracks_scores() -> list[tuple[str, str, str, str, float]]:
    ...
    return [
        ...
        ("John Williams", "Harry Potter: Philosopher's Stone OST (2LP)",
         "Picture Disc", "Soundtrack", 80.00),
        ("John Williams", "Harry Potter: Chamber of Secrets OST (2LP)",
         "Picture Disc", "Soundtrack", 65.00),
        ("John Williams", "Harry Potter: Prisoner of Azkaban OST (2LP)",
         "Colored/Splatter Vinyl", "Soundtrack", 55.00),
        ("Patrick Doyle", "Harry Potter: Goblet of Fire OST (2LP)",
         "Colored/Splatter Vinyl", "Soundtrack", 50.00),
        ("Nicholas Hooper", "Harry Potter: Order of the Phoenix OST (LP)",
         "Standard", "Soundtrack", 40.00),
        ("Nicholas Hooper", "Harry Potter: Half-Blood Prince OST (LP)",
         "Standard", "Soundtrack", 40.00),
        ("Alexandre Desplat", "Harry Potter: Deathly Hallows Part 1 OST (LP)",
         "Standard", "Soundtrack", 40.00),
        ("Alexandre Desplat", "Harry Potter: Deathly Hallows Part 2 OST (LP)",
         "Standard", "Soundtrack", 40.00),
        ("Various", "Harry Potter I-V Soundtracks 10LP Picture Disc Box Set",
         "Picture Disc Box Set", "Soundtrack", 250.00),
        ("Various", "Harry Potter Hogwarts House Colored Vinyl (LE 500/house)",
         "Limited Colored Vinyl", "Soundtrack", 150.00),

        # ── Lord of the Rings Soundtracks (Expanded) ───────────────────────
        ("Howard Shore", "LOTR: Fellowship Complete Recordings (5LP Red Vinyl, LE 5000)",
         "Limited Colored Vinyl", "Soundtrack", 500.00),
        ("Howard Shore", "LOTR: Two Towers Complete Recordings (5LP Blue Vinyl, LE 8000)",
         "Limited Colored Vinyl", "Soundtrack", 150.00),
        ("Howard Shore", "LOTR: Return of the King Complete Recordings (6LP Green Vinyl, LE 8000)",
         "Limited Colored Vinyl", "Soundtrack", 200.00),
        ("Howard Shore", "LOTR Motion Picture Trilogy Soundtrack (6LP Deluxe Box)",
         "Box Set", "Soundtrack", 200.00),
        ("Howard Shore", "LOTR: Fellowship OST (2LP Black)",
         "Standard", "Soundtrack", 50.00),
        ("Howard Shore", "LOTR: Two Towers OST (2LP Black)",
         "Standard", "Soundtrack", 50.00),
        ("Howard Shore", "LOTR: Return of the King OST (2LP Black)",
         "Standard", "Soundtrack", 50.00),
        ("Howard Shore", "The Hobbit: An Unexpected Journey OST (2LP)",
         "Standard", "Soundtrack", 55.00),
...
def _taylor_swift_pop_expansion() -> list[tuple[str, str, str, str, float]]:
    """66 Taylor Swift complete vinyl + modern pop expansion — colored pressings & grails."""
    return [
        # ── Taylor Swift — Complete Vinyl Collection ──────────────────────
        ("Taylor Swift", "Taylor Swift (Debut, Big Machine Original Press)", "Original 1st Pressing", "Modern Collectible", 120.00),
        ("Taylor Swift", "Taylor Swift (Debut, RSD Clear Vinyl)", "RSD Exclusive", "Modern Collectible", 80.00),
        ("Taylor Swift", "Fearless (Big Machine Original Press)", "Original 1st Pressing", "Modern Collectible", 100.00),
        ("Taylor Swift", "Fearless (Taylor's Version, Gold Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "Speak Now (Big Machine Original Press)", "Original 1st Pressing", "Modern Collectible", 200.00),
        ("Taylor Swift", "Speak Now (Taylor's Version, Orchid Marbled)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "Speak Now (Taylor's Version, Violet Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "Red (Big Machine Original Press 2LP)", "Original 1st Pressing", "Modern Collectible", 150.00),
        ("Taylor Swift", "1989 (Big Machine Original Press)", "Original 1st Pressing", "Modern Collectible", 180.00),
        ("Taylor Swift", "1989 (Taylor's Version, Aquamarine Green)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "1989 (Taylor's Version, Crystal Skies Blue)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Taylor Swift", "1989 (Taylor's Version, Sunrise Boulevard Yellow)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Taylor Swift", "Reputation (2LP, Orange FYE Exclusive)", "Colored/Splatter Vinyl", "Modern Collectible", 250.00),
        ("Taylor Swift", "Reputation (2LP, Picture Disc)", "Picture Disc", "Modern Collectible", 120.00),
        ("Taylor Swift", "Reputation (2LP, Standard Black)", "Standard", "Modern Collectible", 80.00),
        ("Taylor Swift", "Lover (2LP, Pink & Blue Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Taylor Swift", "Lover (2LP, Live From Paris Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        ("Taylor Swift", "Folklore (Hide and Seek Edition, Steal Blue)", "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        ("Taylor Swift", "Folklore (Running Like Water Edition, Green)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Taylor Swift", "Folklore (Meet Me Behind the Mall, Red)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Taylor Swift", "Folklore (Betty's Garden Edition, Purple)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Taylor Swift", "Evermore (Deluxe, Green Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Taylor Swift", "Evermore (Deluxe, Transparent Green)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Taylor Swift", "Midnights (Moonstone Blue Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "Midnights (Blood Moon Orange Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "Midnights (Mahogany Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "Midnights (Jade Green Vinyl, w/ Bonus Track)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "Midnights (Til Dawn Edition, Lavender Marbled)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Taylor Swift", "The Tortured Poets Department (Phantom Clear Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "The Tortured Poets Department (Charcoal Black Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "The Tortured Poets Department (Bolter Ink Black)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Taylor Swift", "The Tortured Poets Department (The Albatross Ghosted White)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Taylor Swift", "The Tortured Poets Department (The Anthology, 4LP)", "Numbered Limited", "Modern Collectible", 75.00),
        ("Taylor Swift", "Red (Taylor's Version, 4LP, Standard Black)", "Standard", "Modern Collectible", 45.00),
        ("Taylor Swift", "Midnights (3AM Edition, Lavender 2LP)", "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        # ── Modern Pop Expansion ─────────────────────────────────────────
        ("Billie Eilish", "Don't Smile at Me (Red Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 80.00),
        ("Billie Eilish", "Happier Than Ever (Pale Yellow Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 35.00),
        ("Billie Eilish", "Hit Me Hard and Soft (Sea Blue Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Ariana Grande", "Sweetener (Peach Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        ("Ariana Grande", "Thank U, Next (Clear Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Ariana Grande", "Positions (Clear Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Ariana Grande", "Eternal Sunshine (Alt Cover Sun Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Olivia Rodrigo", "SOUR (Blue Transparent Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Olivia Rodrigo", "GUTS (Spilled Vinyl, Target)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("SZA", "SOS (2LP, Clear Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("SZA", "Ctrl (Green Vinyl, VMP)", "Colored/Splatter Vinyl", "Modern Collectible", 70.00),
        ("Chappell Roan", "The Rise and Fall of a Midwest Princess (Pink Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Chappell Roan", "The Rise and Fall of a Midwest Princess (Hot Pink 2LP, Deluxe)", "Colored/Splatter Vinyl", "Modern Collectible", 65.00),
        ("Doja Cat", "Planet Her (Clear Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Post Malone", "Hollywood's Bleeding (Orange Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Tyler, the Creator", "Call Me If You Get Lost (Vinyl, LE Estate Sale)", "Numbered Limited", "Modern Collectible", 60.00),
        ("Tyler, the Creator", "IGOR (Mint Green Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Tyler, the Creator", "Chromakopia (Forest Green Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Frank Ocean", "Blonde (Black Friday Official, Blonde on Blonde)", "Colored/Splatter Vinyl", "Modern Collectible", 500.00),
        ("Frank Ocean", "Channel Orange (Official Orange Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 350.00),
        ("Beyonce", "Cowboy Carter (2LP Blue/Red Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Bad Bunny", "Un Verano Sin Ti (2LP, Blue Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 50.00),
        ("Dua Lipa", "Radical Optimism (Red Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 35.00),
        ("Charli XCX", "BRAT (Lime Green Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 35.00),
        ("Charli XCX", "BRAT and it's the same but there's three more songs (Clear)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Phoebe Bridgers", "Punisher (Red Vinyl, Secretly Society)", "Colored/Splatter Vinyl", "Modern Collectible", 80.00),
        ("Phoebe Bridgers", "Stranger in the Alps (Baby Blue Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        ("Mitski", "Laurel Hell (Red Vinyl)", "Colored/Splatter Vinyl", "Modern Collectible", 40.00),
        ("Mitski", "The Land Is Inhospitable (Robin's Egg Blue)", "Colored/Splatter Vinyl", "Modern Collectible", 35.00),
    ]
...
def _expanded_collectible_pressings() -> list[tuple[str, str, str, str, float]]:
    """94 additional collectible pressings — VMP, MFSL, Analogue Productions,
    Japanese OBI, RSD, limited box sets, and rare colored variants."""
    return [
        # ── VMP (Vinyl Me Please) Exclusives — Additional ──
        ("Curtis Mayfield", "Superfly (VMP Essentials Orange Vinyl)",
         "Colored/Splatter Vinyl", "Soul/Funk", 70.00),
        ("Nina Simone", "I Put a Spell on You (VMP Classics)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 65.00),
        ("Stevie Wonder", "Innervisions (VMP Essentials)",
         "Colored/Splatter Vinyl", "Soul/Funk", 80.00),
        ("Tame Impala", "Currents (VMP Essentials Gold Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 85.00),
        ("J Dilla", "Donuts (VMP Hip-Hop Smile Cover)",
         "Colored/Splatter Vinyl", "Hip-Hop", 90.00),
        ("De La Soul", "3 Feet High and Rising (VMP Hip-Hop)",
         "Colored/Splatter Vinyl", "Hip-Hop", 75.00),
        ("Alice Coltrane", "Journey in Satchidananda (VMP Classics)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 70.00),
        ("Noname", "Room 25 (VMP Rising)",
         "Colored/Splatter Vinyl", "Hip-Hop", 55.00),
        ("Sza", "Ctrl (VMP Essentials Green Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 95.00),
        ("Al Green", "Let's Stay Together (VMP Classics Green Vinyl)",
         "Colored/Splatter Vinyl", "Soul/Funk", 60.00),

        # ── MFSL (Mobile Fidelity) Pressings ──
        ("Pink Floyd", "Wish You Were Here (MFSL One-Step)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 350.00),
        ("Miles Davis", "Kind of Blue (MFSL One-Step 45RPM 2LP)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 400.00),
        ("The Beatles", "Abbey Road (MFSL One-Step)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 500.00),
        ("Dire Straits", "Brothers in Arms (MFSL One-Step 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 280.00),
        ("Fleetwood Mac", "Rumours (MFSL One-Step 45RPM 2LP)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 380.00),
        ("Bob Dylan", "Blood on the Tracks (MFSL One-Step)",
         "Audiophile (MFSL/Half-Speed)", "Country/Folk", 320.00),
        ("Elton John", "Goodbye Yellow Brick Road (MFSL)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 180.00),
        ("Simon & Garfunkel", "Bridge Over Troubled Water (MFSL)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 150.00),
        ("Cat Stevens", "Tea for the Tillerman (MFSL One-Step)",
         "Audiophile (MFSL/Half-Speed)", "Country/Folk", 250.00),
        ("Santana", "Abraxas (MFSL One-Step 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 300.00),

        # ── Analogue Productions (AP) ──
        ("John Coltrane", "A Love Supreme (AP One-Step 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 350.00),
        ("Bill Evans", "Waltz for Debby (AP 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 200.00),
        ("Art Blakey", "Moanin' (AP 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 180.00),
        ("Sonny Rollins", "Saxophone Colossus (AP 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 190.00),
        ("Dave Brubeck", "Time Out (AP 45RPM 2LP)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 160.00),
        ("Cannonball Adderley", "Somethin' Else (AP 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 175.00),
        ("Muddy Waters", "Folk Singer (AP 45RPM)",
         "Audiophile (MFSL/Half-Speed)", "Country/Folk", 200.00),
        ("Ray Charles", "The Genius of Ray Charles (AP)",
         "Audiophile (MFSL/Half-Speed)", "Soul/Funk", 120.00),

        # ── Japanese OBI Pressings ──
        ("Tatsuro Yamashita", "For You (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 450.00),
        ("Mariya Takeuchi", "Variety (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 350.00),
        ("Taeko Ohnuki", "Sunshower (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 280.00),
        ("Yellow Magic Orchestra", "Solid State Survivor (OBI 1st Press)",
         "Original 1st Pressing", "Electronic/Ambient", 200.00),
        ("Haruomi Hosono", "Hosono House (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 220.00),
        ("Minako Yoshida", "Light'n Up (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 180.00),
        ("Toshiki Kadomatsu", "Sea Is a Lady (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 160.00),
        ("Anri", "Timely!! (Japanese OBI Original)",
         "Original 1st Pressing", "Modern Collectible", 250.00),
        ("Casiopea", "Mint Jams (Japanese OBI Original)",
         "Original 1st Pressing", "Jazz", 140.00),
        ("Ryo Fukui", "Scenery (Japanese OBI Reissue)",
         "Numbered Limited", "Jazz", 120.00),

        # ── Record Store Day (RSD) 2025 Exclusives ──
        ("Radiohead", "The Bends (RSD 2025 Blue Vinyl)",
         "RSD Exclusive", "Indie/Alternative", 55.00),
        ("Daft Punk", "Random Access Memories (RSD 2025 Gold Vinyl)",
         "RSD Exclusive", "Electronic/Ambient", 75.00),
        ("Amy Winehouse", "Frank (RSD 2025 Half-Speed Master)",
         "RSD Exclusive", "Soul/Funk", 50.00),
        ("Kendrick Lamar", "good kid, m.A.A.d city (RSD 2025 Orange Vinyl)",
         "RSD Exclusive", "Hip-Hop", 60.00),
        ("Arctic Monkeys", "Whatever People Say I Am (RSD 2025 Marble)",
         "RSD Exclusive", "Indie/Alternative", 55.00),
        ("Björk", "Post (RSD 2025 Pink Vinyl)",
         "RSD Exclusive", "Electronic/Ambient", 50.00),
        ("The Smiths", "The Queen Is Dead (RSD 2025 Marbled Purple)",
         "RSD Exclusive", "Indie/Alternative", 65.00),
        ("Jeff Buckley", "Grace (RSD 2025 Lilac Vinyl)",
         "RSD Exclusive", "Indie/Alternative", 55.00),
        ("Pixies", "Doolittle (RSD 2025 35th Anniversary Yellow)",
         "RSD Exclusive", "Indie/Alternative", 50.00),
        ("Portishead", "Dummy (RSD 2025 Silver Vinyl)",
         "RSD Exclusive", "Electronic/Ambient", 60.00),

        # ── Limited Box Sets ──
        ("David Bowie", "Five Years (1969-1973) 13LP Box Set",
         "Box Set", "Classic Rock", 450.00),
        ("Bob Dylan", "The Bootleg Series Vol. 1-3 5LP Box",
         "Box Set", "Country/Folk", 280.00),
        ("The Rolling Stones", "Singles 1963-1965 10x7\" Box Set",
         "Box Set", "Classic Rock", 320.00),
        ("Depeche Mode", "Violator (12\" Singles Collection Box)",
         "Box Set", "Electronic/Ambient", 250.00),
        ("Johnny Cash", "Unearthed 9LP Box Set",
         "Box Set", "Country/Folk", 350.00),
        ("Metallica", "...And Justice for All Deluxe 6LP Box",
         "Box Set", "Metal/Heavy", 280.00),
        ("Joy Division", "Unknown Pleasures / Closer 2LP Box",
         "Box Set", "Punk/Post-Punk", 120.00),
        ("Kate Bush", "Remastered in Vinyl I (4LP Box Set)",
         "Box Set", "Classic Rock", 200.00),
        ("Prince", "Sign o' the Times (Super Deluxe 13LP+DVD Box)",
         "Box Set", "Soul/Funk", 500.00),
        ("Aphex Twin", "Selected Ambient Works 85-92 (Deluxe 2LP Remaster)",
         "Numbered Limited", "Electronic/Ambient", 85.00),

        # ── Rare Colored Pressings & Store Exclusives ──
        ("Mac DeMarco", "Salad Days (Newbury Comics Green Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 65.00),
        ("Phoebe Bridgers", "Punisher (Secretly Society Galaxy Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 80.00),
        ("King Gizzard", "Polygondwanaland (Ghostly Orange Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 60.00),
        ("The National", "Sleep Well Beast (White Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 50.00),
        ("Japanese Breakfast", "Jubilee (Clear Red Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 45.00),
        ("Turnstile", "GLOW ON (Glow-in-the-Dark Vinyl)",
         "Colored/Splatter Vinyl", "Punk/Post-Punk", 55.00),
        ("Fontaines D.C.", "Skinty Fia (Limited Deluxe Green Vinyl)",
         "Colored/Splatter Vinyl", "Punk/Post-Punk", 50.00),
        ("IDLES", "TANGK (Clear Vinyl w/ Poster)",
         "Colored/Splatter Vinyl", "Punk/Post-Punk", 40.00),
        ("Charli XCX", "Brat (Neon Green Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 55.00),
        ("Sabrina Carpenter", "Short n' Sweet (Baby Pink Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 45.00),

        # ── Blue Note Tone Poet Series ──
        ("Lee Morgan", "The Sidewinder (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 45.00),
        ("Bobby Hutcherson", "Happenings (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 42.00),
        ("Wayne Shorter", "Speak No Evil (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 48.00),
        ("Grant Green", "Green Street (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 40.00),
        ("Hank Mobley", "Soul Station (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 44.00),
        ("Joe Henderson", "Page One (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 42.00),
        ("Freddie Hubbard", "Hub-Tones (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 40.00),
        ("Herbie Hancock", "Empyrean Isles (Tone Poet)",
         "Audiophile (MFSL/Half-Speed)", "Jazz", 46.00),

        # ── Promo / Test Pressings ──
        ("Nirvana", "Nevermind (Test Pressing White Label)",
         "Promo/Test Pressing", "Indie/Alternative", 2500.00),
        ("The Clash", "London Calling (Test Pressing)",
         "Promo/Test Pressing", "Punk/Post-Punk", 1800.00),
        ("Massive Attack", "Mezzanine (Promo 2LP)",
         "Promo/Test Pressing", "Electronic/Ambient", 300.00),
        ("LCD Soundsystem", "Sound of Silver (Test Pressing)",
         "Promo/Test Pressing", "Electronic/Ambient", 400.00),

        # ── Half-Speed Masters (Abbey Road Studios) ──
        ("Oasis", "Definitely Maybe (Half-Speed Master)",
         "Audiophile (MFSL/Half-Speed)", "Indie/Alternative", 55.00),
        ("The Prodigy", "The Fat of the Land (Half-Speed Master)",
         "Audiophile (MFSL/Half-Speed)", "Electronic/Ambient", 50.00),
        ("Jamiroquai", "Travelling Without Moving (Half-Speed Master)",
         "Audiophile (MFSL/Half-Speed)", "Soul/Funk", 48.00),
        ("Noel Gallagher", "Council Skies (Half-Speed Master)",
         "Audiophile (MFSL/Half-Speed)", "Indie/Alternative", 40.00),
    ]


def _expansion_round2() -> list[tuple[str, str, str, str, float]]:
    """120+ new items across all genres: classic rock variants, jazz Blue Note
    originals, hip-hop essentials, modern indie, electronic, K-pop, and
    Record Store Day exclusives."""
    return [
        # ── Classic Rock — Pink Floyd Variants ──────────────────────────────
        ("Pink Floyd", "The Dark Side of the Moon (2023 50th Anniversary)",
         "Numbered Limited", "Classic Rock", 80.00),
        ("Pink Floyd", "The Dark Side of the Moon (UHQR Pressing)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 200.00),
        ("Pink Floyd", "The Dark Side of the Moon (Blue Triangle 1st UK)",
         "Original 1st Pressing", "Classic Rock", 3500.00),
        ("Pink Floyd", "Wish You Were Here (MFSL One-Step)",
         "Audiophile (MFSL/Half-Speed)", "Classic Rock", 150.00),
        ("Pink Floyd", "The Wall (1st US Pressing, Columbia)",
         "Original 1st Pressing", "Classic Rock", 250.00),
        ("Pink Floyd", "Animals (2022 Remix)",
         "Standard Repress", "Classic Rock", 35.00),
        ("Pink Floyd", "The Division Bell",
         "Original 1st Pressing", "Classic Rock", 350.00),
        ("Pink Floyd", "Pulse (4LP Box Set)",
         "Box Set", "Classic Rock", 500.00),

        # ── Classic Rock — Led Zeppelin OG Pressings ────────────────────────
        ("Led Zeppelin", "Led Zeppelin I (Turquoise Lettering UK)",
         "Original 1st Pressing", "Classic Rock", 2500.00),
        ("Led Zeppelin", "Led Zeppelin II (RL Hot Mix Robert Ludwig)",
         "Original 1st Pressing", "Classic Rock", 1200.00),
        ("Led Zeppelin", "Led Zeppelin IV (Misprint Labels)",
         "Original 1st Pressing", "Classic Rock", 1500.00),
        ("Led Zeppelin", "Physical Graffiti (Die-Cut Sleeve UK 1st)",
         "Original 1st Pressing", "Classic Rock", 700.00),
        ("Led Zeppelin", "How the West Was Won (4LP Box)",
         "Box Set", "Classic Rock", 120.00),

        # ── Jazz — Blue Note Originals ──────────────────────────────────────
        ("John Coltrane", "A Love Supreme (Blue Note Classic Series)",
         "Standard Repress", "Jazz", 35.00),
        ("Art Blakey", "Moanin' (Blue Note 1st Pressing)",
         "Original 1st Pressing", "Jazz", 2000.00),
        ("Horace Silver", "Song for My Father (Blue Note 1st Pressing)",
         "Original 1st Pressing", "Jazz", 1800.00),
        ("Wayne Shorter", "Speak No Evil (Blue Note 1st, ear mark)",
         "Original 1st Pressing", "Jazz", 2500.00),
        ("Lee Morgan", "The Sidewinder (Blue Note 1st)",
         "Original 1st Pressing", "Jazz", 1500.00),
        ("Cannonball Adderley", "Somethin' Else (Blue Note 1st)",
         "Original 1st Pressing", "Jazz", 3000.00),
        ("Dexter Gordon", "Go! (Blue Note 1st)",
         "Original 1st Pressing", "Jazz", 1200.00),
        ("Eric Dolphy", "Out to Lunch! (Blue Note 1st, ear mark)",
         "Original 1st Pressing", "Jazz", 2800.00),
        ("Herbie Hancock", "Maiden Voyage (Blue Note 1st)",
         "Original 1st Pressing", "Jazz", 1800.00),
        ("Andrew Hill", "Point of Departure (Blue Note 1st)",
         "Original 1st Pressing", "Jazz", 2200.00),

        # ── Jazz — Impulse! Records ─────────────────────────────────────────
        ("John Coltrane", "A Love Supreme (Impulse! 1st, orange/black)",
         "Original 1st Pressing", "Jazz", 4000.00),
        ("John Coltrane", "Crescent (Impulse! 1st Pressing)",
         "Original 1st Pressing", "Jazz", 1500.00),
        ("John Coltrane", "Ascension (Impulse! 1st, Edition I)",
         "Original 1st Pressing", "Jazz", 2000.00),
        ("Pharoah Sanders", "Karma (Impulse! 1st Pressing)",
         "Original 1st Pressing", "Jazz", 1200.00),
        ("Alice Coltrane", "Journey in Satchidananda (Impulse! 1st)",
         "Original 1st Pressing", "Jazz", 1500.00),
        ("Albert Ayler", "Spiritual Unity (ESP-Disk 1st)",
         "Original 1st Pressing", "Jazz", 3500.00),

        # ── Hip-Hop — Essential Classics ────────────────────────────────────
        ("Madvillain", "Madvillainy",
         "Original 1st Pressing", "Hip-Hop", 300.00),
        ("Madvillain", "Madvillainy (VMP Exclusive Silver Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 150.00),
        ("Wu-Tang Clan", "Enter the Wu-Tang (36 Chambers)",
         "Original 1st Pressing", "Hip-Hop", 400.00),
        ("Wu-Tang Clan", "Enter the Wu-Tang (36 Chambers, Yellow Vinyl RSD)",
         "RSD Exclusive", "Hip-Hop", 80.00),
        ("Nas", "Illmatic",
         "Original 1st Pressing", "Hip-Hop", 350.00),
        ("Nas", "Illmatic (Clear Vinyl Repress)",
         "Colored/Splatter Vinyl", "Hip-Hop", 45.00),
        ("A Tribe Called Quest", "Midnight Marauders",
         "Original 1st Pressing", "Hip-Hop", 200.00),
        ("A Tribe Called Quest", "The Low End Theory",
         "Original 1st Pressing", "Hip-Hop", 250.00),
        ("MF DOOM", "MM..FOOD (Green & Pink Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 80.00),
        ("MF DOOM", "Operation: Doomsday (Metalface Cover)",
         "Standard Repress", "Hip-Hop", 50.00),
        ("Mobb Deep", "The Infamous",
         "Original 1st Pressing", "Hip-Hop", 300.00),
        ("GZA", "Liquid Swords",
         "Original 1st Pressing", "Hip-Hop", 250.00),
        ("De La Soul", "3 Feet High and Rising",
         "Original 1st Pressing", "Hip-Hop", 200.00),
        ("Raekwon", "Only Built 4 Cuban Linx... (Purple Tape Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 120.00),
        ("J Dilla", "Donuts",
         "Original 1st Pressing", "Hip-Hop", 250.00),
        ("J Dilla", "Donuts (Donut Shop Cover, Seaglass Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 100.00),

        # ── Modern Indie / Alternative ──────────────────────────────────────
        ("Tyler, the Creator", "IGOR",
         "Standard Repress", "Modern Collectible", 30.00),
        ("Tyler, the Creator", "IGOR (Mint Green Vinyl Limited)",
         "Colored/Splatter Vinyl", "Modern Collectible", 120.00),
        ("Tyler, the Creator", "Flower Boy",
         "Standard Repress", "Modern Collectible", 28.00),
        ("Tyler, the Creator", "Flower Boy (Bee Yellow Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 100.00),
        ("Tyler, the Creator", "Call Me If You Get Lost (Estate Sale)",
         "Numbered Limited", "Modern Collectible", 60.00),
        ("Frank Ocean", "Blonde (Black Friday Edition)",
         "Numbered Limited", "Modern Collectible", 800.00),
        ("Frank Ocean", "Blonde (Official Repress)",
         "Standard Repress", "Modern Collectible", 45.00),
        ("Frank Ocean", "Channel Orange (Bootleg 2LP Orange Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 120.00),
        ("Billie Eilish", "When We All Fall Asleep, Where Do We Go?",
         "Standard Repress", "Modern Collectible", 25.00),
        ("Billie Eilish", "When We All Fall Asleep (Glow in Dark Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 60.00),
        ("Billie Eilish", "Happier Than Ever",
         "Standard Repress", "Modern Collectible", 30.00),
        ("Kendrick Lamar", "good kid, m.A.A.d city",
         "Standard Repress", "Hip-Hop", 30.00),
        ("Kendrick Lamar", "To Pimp a Butterfly",
         "Standard Repress", "Hip-Hop", 35.00),
        ("Kendrick Lamar", "Mr. Morale & The Big Steppers",
         "Standard Repress", "Hip-Hop", 40.00),
        ("Kendrick Lamar", "GNX (Translucent Red Vinyl)",
         "Colored/Splatter Vinyl", "Hip-Hop", 50.00),

        # ── Electronic — Daft Punk & Aphex Twin ─────────────────────────────
        ("Daft Punk", "Discovery",
         "Standard Repress", "Electronic", 30.00),
        ("Daft Punk", "Discovery (Original France 1st Pressing)",
         "Original 1st Pressing", "Electronic", 200.00),
        ("Daft Punk", "Random Access Memories",
         "Standard Repress", "Electronic", 35.00),
        ("Daft Punk", "Random Access Memories (10th Anniversary, Drumless)",
         "Numbered Limited", "Electronic", 60.00),
        ("Daft Punk", "Homework",
         "Original 1st Pressing", "Electronic", 150.00),
        ...
        ("Aphex Twin", "Selected Ambient Works 85-92",
         "Original 1st Pressing", "Electronic", 400.00),
        ("Aphex Twin", "Selected Ambient Works 85-92 (2022 Remaster)",
         "Standard Repress", "Electronic", 35.00),
        ("Aphex Twin", "Selected Ambient Works Volume II (4LP)",
         "Original 1st Pressing", "Electronic", 350.00),
        ("Aphex Twin", "Richard D. James Album",
         "Original 1st Pressing", "Electronic", 250.00),
        ("Aphex Twin", "Drukqs (4LP)",
         "Original 1st Pressing", "Electronic", 300.00),
        ("Aphex Twin", "Syro (3LP)",
         "Original 1st Pressing", "Electronic", 80.00),
        ("Boards of Canada", "Geogaddi",
         "Original 1st Pressing", "Electronic", 250.00),

        # ── K-pop — BTS & BLACKPINK ─────────────────────────────────────────
        ("BTS", "Map of the Soul: 7 (Limited Edition LP)",
         "Numbered Limited", "Modern Collectible", 150.00),
        ("BTS", "Love Yourself: Answer (Limited Vinyl)",
         "Numbered Limited", "Modern Collectible", 200.00),
        ("BTS", "BE (Essential Edition Vinyl)",
         "Numbered Limited", "Modern Collectible", 120.00),
        ("BTS", "Wings",
         "Numbered Limited", "Modern Collectible", 250.00),
        ("BTS", "Proof (Standard Edition 3LP)",
         "Standard Repress", "Modern Collectible", 80.00),
        ("BLACKPINK", "THE ALBUM (Vinyl, Limited Edition)",
         "Numbered Limited", "Modern Collectible", 180.00),
        ("BLACKPINK", "Born Pink (Limited Orange Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 100.00),
        ("BLACKPINK", "Born Pink (Standard Black Vinyl)",
         "Standard Repress", "Modern Collectible", 40.00),
        ("NewJeans", "Get Up (1st Mini Album Vinyl)",
         "Numbered Limited", "Modern Collectible", 90.00),
        ("NewJeans", "OMG (Blue Vinyl Limited)",
         "Colored/Splatter Vinyl", "Modern Collectible", 80.00),
        ("Stray Kids", "5-STAR (Limited Vinyl)",
         "Numbered Limited", "Modern Collectible", 100.00),
        ("aespa", "MY WORLD (Vinyl, Limited Edition)",
         "Numbered Limited", "Modern Collectible", 85.00),
        ("(G)I-DLE", "I FEEL (Limited Edition LP)",
         "Numbered Limited", "Modern Collectible", 90.00),
        ("IU", "Lilac (Limited Vinyl, Purple)",
         "Colored/Splatter Vinyl", "Modern Collectible", 120.00),
        ("SEVENTEEN", "FML (Limited Vinyl Edition)",
         "Numbered Limited", "Modern Collectible", 110.00),

        # ── Limited Color Variants & RSD Exclusives ─────────────────────────
        ("Radiohead", "OK Computer (Blue Vinyl 2LP RSD)",
         "RSD Exclusive", "Indie/Alternative", 80.00),
        ("Radiohead", "In Rainbows (Limited Red Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 100.00),
        ("Arctic Monkeys", "Whatever People Say I Am (Clear Vinyl RSD)",
         "RSD Exclusive", "Indie/Alternative", 60.00),
        ("Tame Impala", "Currents (Collector's Edition Box Set)",
         "Box Set", "Indie/Alternative", 120.00),
        ("Tame Impala", "InnerSpeaker (10th Anniversary 4LP Deluxe)",
         "Box Set", "Indie/Alternative", 90.00),
        ("The Smiths", "The Queen Is Dead (RSD 2024 Remaster)",
         "RSD Exclusive", "Indie/Alternative", 50.00),
        ("Joy Division", "Unknown Pleasures (RSD Ruby Red Vinyl)",
         "RSD Exclusive", "Punk/Post-Punk", 55.00),
        ("Nirvana", "In Utero (2023 30th Anniversary, 8LP Super Deluxe)",
         "Box Set", "Indie/Alternative", 200.00),
        ("Nirvana", "MTV Unplugged (25th Anniversary, Orange Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 50.00),
        ("Taylor Swift", "1989 (Taylor's Version, Rose Garden Pink Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Taylor Swift", "Midnights (Jade Green Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 35.00),
        ("Taylor Swift", "Folklore (RSD Exclusive Clandestine Meeting Vinyl)",
         "RSD Exclusive", "Modern Collectible", 80.00),
        ("Lana Del Rey", "Norman Fucking Rockwell! (Green Vinyl UO)",
         "Colored/Splatter Vinyl", "Modern Collectible", 90.00),
        ("Lana Del Rey", "Born to Die (Red Vinyl RSD)",
         "RSD Exclusive", "Modern Collectible", 70.00),
        ("Mac DeMarco", "Salad Days (Green Vinyl RSD)",
         "RSD Exclusive", "Indie/Alternative", 50.00),
        ("Khruangbin", "Con Todo El Mundo (Translucent Blue Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 45.00),
        ("Khruangbin", "Mordechai (Pink Translucent Vinyl)",
         "Colored/Splatter Vinyl", "Modern Collectible", 40.00),

        # ── Metal & Heavy — Additional ──────────────────────────────────────
        ("Metallica", "Master of Puppets (2023 Remaster, Battery Brick Vinyl)",
         "Colored/Splatter Vinyl", "Metal/Heavy", 50.00),
        ("Metallica", "...And Justice for All (Doomsday Clock Vinyl)",
         "Colored/Splatter Vinyl", "Metal/Heavy", 55.00),
        ("Iron Maiden", "The Number of the Beast (Picture Disc)",
         "Picture Disc", "Metal/Heavy", 35.00),
        ("Slayer", "Reign in Blood",
         "Original 1st Pressing", "Metal/Heavy", 200.00),
        ("Megadeth", "Rust in Peace",
         "Original 1st Pressing", "Metal/Heavy", 150.00),
        ("Tool", "Lateralus (2LP Picture Disc)",
         "Picture Disc", "Metal/Heavy", 120.00),
        ("Tool", "Fear Inoculum (5LP Deluxe Box Set)",
         "Box Set", "Metal/Heavy", 200.00),

        # ── Punk / Post-Punk — Additional ──────────────────────────────────
        ("The Cure", "Disintegration (2LP Remaster)",
         "Standard Repress", "Punk/Post-Punk", 30.00),
        ("Siouxsie and the Banshees", "Juju",
         "Original 1st Pressing", "Punk/Post-Punk", 150.00),
        ("Bauhaus", "In the Flat Field",
         "Original 1st Pressing", "Punk/Post-Punk", 200.00),
        ("Dead Kennedys", "Fresh Fruit for Rotting Vegetables",
         "Original 1st Pressing", "Punk/Post-Punk", 200.00),
        ("Minor Threat", "Complete Discography",
         "Standard Repress", "Punk/Post-Punk", 20.00),
        ("Fugazi", "13 Songs",
         "Original 1st Pressing", "Punk/Post-Punk", 80.00),

        # ── Soul/Funk — Additional ──────────────────────────────────────────
        ("D'Angelo", "Voodoo (2LP)",
         "Original 1st Pressing", "Soul/Funk", 200.00),
        ...
        ("Curtis Mayfield", "Superfly (Soundtrack)",
         "Original 1st Pressing", "Soul/Funk", 250.00),
        ("Stevie Wonder", "Songs in the Key of Life (2LP+7\")",
         "Original 1st Pressing", "Soul/Funk", 200.00),
        ("Sade", "Love Deluxe",
         "Original 1st Pressing", "Soul/Funk", 200.00),

        # ── Soundtracks — Additional ────────────────────────────────────────
        ("Hans Zimmer", "Interstellar OST (Illuminated Star Edition 2LP)",
         "Numbered Limited", "Soundtrack", 80.00),
        ("Hans Zimmer", "Oppenheimer OST (3LP Black Vinyl)",
         "Standard Repress", "Soundtrack", 40.00),
        ("Ennio Morricone", "The Good, the Bad and the Ugly (RSD)",
         "RSD Exclusive", "Soundtrack", 60.00),
        ("Vangelis", "Blade Runner OST",
         "Original 1st Pressing", "Soundtrack", 200.00),
        ("Joe Hisaishi", "Spirited Away OST (2LP, Japan Import)",
         "Standard Repress", "Soundtrack", 60.00),
        ("Joe Hisaishi", "My Neighbor Totoro OST (Japan Import)",
         "Standard Repress", "Soundtrack", 50.00),

        # ── Country/Folk/Blues — Additional ────────────────────────────────
        ("Robert Johnson", "King of the Delta Blues Singers",
         "Original 1st Pressing", "Country/Folk/Blues", 1500.00),
        ("Townes Van Zandt", "Our Mother the Mountain",
         "Original 1st Pressing", "Country/Folk/Blues", 300.00),
        ("Bon Iver", "For Emma, Forever Ago (Jagjaguwar 1st Press)",
         "Original 1st Pressing", "Indie/Alternative", 250.00),
        ("Bon Iver", "22, A Million (Cream Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 60.00),
        ("Sufjan Stevens", "Illinois (Marvel Cover, withdrawn)",
         "Original 1st Pressing", "Indie/Alternative", 200.00),
        ("Fleet Foxes", "Fleet Foxes (Sub Pop 1st Press)",
         "Original 1st Pressing", "Indie/Alternative", 100.00),
        ("Phoebe Bridgers", "Punisher (Red Swirl Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 80.00),
        ("Phoebe Bridgers", "Stranger in the Alps (1st Press)",
         "Original 1st Pressing", "Indie/Alternative", 120.00),
        ("Adrianne Lenker", "songs/instrumentals (2LP Red Vinyl)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 50.00),
        ("The National", "Boxer (Cherry Tree Variant)",
         "Colored/Splatter Vinyl", "Indie/Alternative", 60.00),
    ]
...
SUBCATEGORY_FUNCTIONS = [
    ...
    ("Taylor Swift & Modern Pop Expansion", _taylor_swift_pop_expansion),
    ("VMP, RSD 2024 & Limited Color Pressings", _vmp_rsd2024_limited_color),
    ("Expansion Round 2 — Additional Genres", _expansion_round2),
]
