...
def get_curated_catalog() -> list[dict]:
    ...
    kits = [
        ...
        # ── Forge World Premium Titans & Primarchs ────────────────────────
        ("fw", "Forge World", "Mars Pattern Warlord Titan (Body Only)", "Titan", 1200, 1800),
        ("fw", "Forge World", "Warlord Titan Belicosa Volcano Cannon Arms", "Titan Weapon", 300, 450),
        ("fw", "Forge World", "Warhound Scout Titan", "Titan", 400, 600),
        ("fw", "Forge World", "Thunderhawk Gunship (Resin)", "Flyer", 480, 700),
        ("fw", "Forge World", "Mastodon Super-Heavy Assault Transport", "Super-Heavy", 280, 400),
        ("fw", "Forge World", "Cerberus Heavy Tank Destroyer", "Vehicle", 120, 170),
        ("fw", "Forge World", "Sicaran Battle Tank (Resin)", "Vehicle", 65, 95),
        ("fw", "Forge World", "Deredeo Dreadnought (Resin)", "Dreadnought", 55, 80),
        ("fw", "Forge World", "Leviathan Siege Dreadnought (Resin) w/ Claw & Drill", "Dreadnought", 70, 100),
        ("fw", "Forge World", "Contemptor-Cortus Dreadnought (Resin)", "Dreadnought", 40, 60),
        ("fw", "Forge World", "Leman Russ Primarch of the Space Wolves (FW Resin)", "Character", 100, 195),
        ("fw", "Forge World", "Alpharius Primarch of the Alpha Legion (FW Resin)", "Character", 90, 170),
        ("fw", "Forge World", "Corvus Corax Primarch of the Raven Guard (FW Resin)", "Character", 95, 185),
        ("fw", "Forge World", "Konrad Curze Primarch of the Night Lords (FW Resin)", "Character", 95, 180),
        ("fw", "Forge World", "Lorgar Primarch of the Word Bearers (FW Resin)", "Character", 90, 175),

        # ── Limited Edition / Event Exclusive Models ──────────────────────
        ("40k", "Limited", "Games Day 2012 Chaos Lord on Juggernaut", "Limited", 30, 150),
        ("40k", "Limited", "Games Day 2011 Skullz Promo Space Marine Captain", "Limited", 0, 120),
        ("40k", "Limited", "Store Anniversary Space Marine Captain (2024)", "Limited", 0, 80),
        ("40k", "Limited", "Warhammer Day 2023 Primaris Lieutenant", "Limited", 0, 60),
        ("40k", "Limited", "Warhammer Day 2024 Stormcast Vindictor", "Limited", 0, 55),
        ("40k", "Limited", "25th Anniversary Primaris Intercessor Veteran Sergeant", "Limited", 25, 90),
        ("40k", "Limited", "Black Library Celebration 2024 Exclusive Commissar Cain", "Limited", 30, 110),
        ("40k", "Limited", "Warhammer Fest 2023 Exclusive Chaos Lord (Signed Box)", "Limited", 35, 130),
        ("40k", "Limited", "Made to Order: Classic Abaddon the Despoiler (Metal)", "Limited", 22, 100),
        ("40k", "Limited", "Made to Order: Classic Phoenix Lords Set (Metal, 6 models)", "Limited", 80, 250),

        # ── Age of Sigmar Centerpiece Models ──────────────────────────────
        ("aos", "Slaves to Darkness", "Archaon the Everchosen on Dorghar", "Centerpiece", 130, 160),
        ("aos", "Ossiarch Bonereapers", "Nagash Supreme Lord of the Undead", "Centerpiece", 80, 100),
        ("aos", "Sylvaneth", "Alarielle the Everqueen on Wardroth Beetle", "Centerpiece", 85, 105),
        ("aos", "Daughters of Khaine", "Morathi / The Shadow Queen", "Centerpiece", 95, 120),
        ("aos", "Destruction", "Kragnos the End of Empires", "Centerpiece", 100, 125),
        ("aos", "Sons of Behemat", "Mega-Gargant (Kraken-eater / Warstomper / Gatebreaker)", "Centerpiece", 130, 160),
        ("aos", "Orruk Warclans", "Gordrakk the Fist of Gork on Maw-krusha", "Centerpiece", 85, 105),
        ("aos", "Lumineth Realm-lords", "Avalenor the Stoneheart King", "Centerpiece", 70, 88),
        ("aos", "Nighthaunt", "Lady Olynder Mortarch of Grief", "Character", 30, 38),
        ("aos", "Maggotkin of Nurgle", "Great Unclean One (AoS)", "Centerpiece", 90, 110),

        # ── Horus Heresy Box Sets & Characters ────────────────────────────
        ("hh", "Horus Heresy", "Age of Darkness Core Box Set", "Box Set", 180, 240),
        ("hh", "Horus Heresy", "Leviathan Siege Dreadnought (Plastic)", "Dreadnought", 40, 50),
        ("hh", "Horus Heresy", "Praetor Set in Cataphractii Terminator Armour", "Character", 30, 38),
        ("hh", "Horus Heresy", "Praetor Set in Mk VI Power Armour", "Character", 25, 32),
        ("hh", "Horus Heresy", "Dark Angels Legion Inner Circle Knights Cenobium", "Elite", 42, 55),
        ("hh", "Horus Heresy", "Imperial Fists Legion Phalanx Warder Squad", "Elite", 38, 48),
        ("hh", "Horus Heresy", "Sons of Horus Justaerin Terminator Squad", "Elite", 42, 55),
        ("hh", "Horus Heresy", "World Eaters Rampager Squad", "Elite", 38, 48),
        ("hh", "Horus Heresy", "Emperor's Children Palatine Blades Squad", "Elite", 38, 48),
        ("hh", "Horus Heresy", "Kratos Heavy Assault Tank (Plastic)", "Vehicle", 60, 78),

        # ── Kill Team / Necromunda / Blood Bowl ───────────────────────────
        ("40k", "Kill Team", "Kill Team: Nightmare (Mandrakes vs Scouts)", "Box Set", 95, 120),
        ("40k", "Kill Team", "Kill Team: Ashes of Faith (Sisters vs Warp Coven)", "Box Set", 130, 170),
        ("40k", "Kill Team", "Kill Team: Shadowvaults (Kasrkin vs Genestealers)", "Box Set", 130, 165),
        ("nb", "Necromunda", "Necromunda: Ash Wastes Box Set", "Box Set", 130, 170),
        ("nb", "Necromunda", "Necromunda Squat Prospectors Gang", "Gang", 35, 45),
        ("nb", "Necromunda", "Necromunda Ironhead Squat Prospectors Nomads", "Gang", 35, 45),
        ("bb", "Blood Bowl", "Blood Bowl: Second Season Edition Core Box", "Box Set", 65, 85),
        ("bb", "Blood Bowl", "Blood Bowl Skaven Team: The Skavenblight Scramblers", "Team", 25, 32),
        ("bb", "Blood Bowl", "Blood Bowl Lizardmen Team: Lustria Croakers", "Team", 25, 32),
        ("bb", "Blood Bowl", "Blood Bowl Star Player Griff Oberwald", "Character", 18, 25),

        # ── OOP / Retired Kits ────────────────────────────────────────────
        ("40k", "OOP", "Metal Hive Tyrant (Finecast OOP)", "Character", 35, 90),
        ("40k", "OOP", "Metal Avatar of Khaine (Classic Sculpt)", "Character", 22, 80),
        ("40k", "OOP", "Finecast Urien Rakarth (OOP)", "Character", 18, 65),
        ("40k", "OOP", "Metal Commissar Yarrick (Classic Sculpt OOP)", "Character", 12, 55),
        ("40k", "OOP", "Metal Ghazghkull Thraka (Classic Sculpt OOP)", "Character", 15, 70),

        # ── Warhammer: The Old World ─────────────────────────────────────
        ("tow", "Bretonnians", "Bretonnian Knights of the Realm (12)", "Cavalry", 42, 52),
        ("tow", "Bretonnians", "Bretonnian Questing Knights (8)", "Cavalry", 40, 48),
        ("tow", "Bretonnians", "The Green Knight", "Character", 30, 42),
        ("tow", "Bretonnians", "Bretonnian Pegasus Knights (3)", "Cavalry", 38, 45),
        ("tow", "Empire", "Empire State Troops (20)", "Troops", 35, 42),
        ("tow", "Empire", "Empire Greatswords (10)", "Elite", 32, 38),
        ("tow", "Empire", "Empire War Altar of Sigmar", "Centerpiece", 45, 58),
        ("tow", "Tomb Kings", "Tomb Kings Skeleton Warriors (20)", "Troops", 35, 42),
        ("tow", "Tomb Kings", "Tomb King on Chariot", "Character", 30, 40),
        ("tow", "Tomb Kings", "Necrosphinx", "Centerpiece", 55, 72),
        ("tow", "Tomb Kings", "Casket of Souls", "Centerpiece", 35, 48),
        ("tow", "Tomb Kings", "Ushabti (3)", "Elite", 28, 35),
        ("tow", "Bretonnians", "Bretonnian Battle Pilgrims (20)", "Troops", 30, 38),
        ("tow", "The Old World", "Arcane Journal: Bretonnia", "Book", 25, 30),
        ("tow", "The Old World", "Arcane Journal: Tomb Kings of Khemri", "Book", 25, 30),

        # ── Combat Patrol Boxes ──────────────────────────────────────────
        ("40k", "Space Marines", "Combat Patrol: Space Marines", "Box Set", 110, 130),
        ("40k", "Tyranids", "Combat Patrol: Tyranids", "Box Set", 110, 130),
        ("40k", "Orks", "Combat Patrol: Orks", "Box Set", 110, 130),
        ("40k", "Necrons", "Combat Patrol: Necrons", "Box Set", 110, 130),
        ("40k", "Death Guard", "Combat Patrol: Death Guard", "Box Set", 110, 130),
        ("40k", "Thousand Sons", "Combat Patrol: Thousand Sons", "Box Set", 110, 130),
        ("40k", "Aeldari", "Combat Patrol: Aeldari", "Box Set", 110, 130),
        ("40k", "T'au Empire", "Combat Patrol: T'au Empire", "Box Set", 110, 130),
        ("40k", "Adeptus Custodes", "Combat Patrol: Adeptus Custodes", "Box Set", 110, 130),
        ("40k", "Drukhari", "Combat Patrol: Drukhari", "Box Set", 110, 130),

        # ── Warcry / Underworlds ─────────────────────────────────────────
        ("warcry", "Warcry", "Warcry: Nightmare Quest (Core Box)", "Box Set", 90, 110),
        ("warcry", "Warcry", "Jade Obelisk Warband", "Warband", 35, 42),
        ("warcry", "Warcry", "Rotmire Creed Warband", "Warband", 35, 42),
        ("warcry", "Warcry", "Hunters of Huanchi Warband", "Warband", 35, 42),
        ("uw", "Underworlds", "Underworlds: Wintermaw Core Set", "Box Set", 55, 65),
        ("uw", "Underworlds", "Zondara's Gravebreakers Warband", "Warband", 25, 30),
        ("uw", "Underworlds", "Grinkrak's Looncourt Warband", "Warband", 25, 30),
        ("uw", "Underworlds", "Domitan's Stormcoven Warband", "Warband", 25, 30),
        ("uw", "Underworlds", "Gnarlwood Core Set (OOP)", "Box Set", 55, 80),
        ("uw", "Underworlds", "Daggok's Stab-Ladz Warband", "Warband", 25, 30),

        # ── Terrain & Scenery ────────────────────────────────────────────
        ("40k", "Terrain", "Sector Mechanicus: Ferratonic Furnace", "Terrain", 42, 50),
        ("40k", "Terrain", "Sector Imperialis: Basilicanum", "Terrain", 40, 48),
        ("40k", "Terrain", "Sector Imperialis: Sanctum", "Terrain", 35, 42),
        ("kt", "Kill Team", "Octarius Terrain Set", "Terrain", 45, 55),
        ("40k", "Terrain", "Battlezone Fronteris: Nachmund", "Terrain", 50, 60),
        ("40k", "Terrain", "Aegis Defence Line", "Terrain", 25, 30),
        ("aos", "Terrain", "Realmscape: Thondian Strongpoint", "Terrain", 45, 55),
        ("40k", "Terrain", "Wall of Martyrs: Imperial Bunker", "Terrain", 30, 35),
        ("40k", "Terrain", "Munitorum Armoured Containers (3)", "Terrain", 30, 35),

        # ── Paint Sets & Hobby ───────────────────────────────────────────
        ("hobby", "Citadel", "Citadel Contrast Paints: Complete Set (36)", "Paint Set", 180, 200),
        ("hobby", "Citadel", "Citadel Shade Paints: Full Collection (14)", "Paint Set", 70, 80),
        ("hobby", "Citadel", "Citadel Layer Paints: Battle Ready Set (20)", "Paint Set", 80, 90),
        ("hobby", "Citadel", "Citadel Base Paints: Core Collection (24)", "Paint Set", 90, 100),
        ("hobby", "Army Painter", "Army Painter Speedpaint 2.0 Mega Set", "Paint Set", 100, 115),
        ("hobby", "Army Painter", "Army Painter Warpaints Fanatic Complete Set", "Paint Set", 200, 225),
        ("hobby", "Citadel", "Citadel Fine Detail Brush", "Tools", 8, 10),
        ("hobby", "Citadel", "Citadel Assembly Handle (2024)", "Tools", 6, 8),
        ("hobby", "Citadel", "Citadel Mouldline Remover", "Tools", 12, 15),
        ("hobby", "Citadel", "Citadel Colour Spray: Chaos Black (400ml)", "Spray", 18, 22),

        # ── Black Library Limited Editions ───────────────────────────────
        ("bl", "Black Library", "Siege of Terra: End and the Death Vol III (LE)", "Book", 80, 200),
        ("bl", "Black Library", "Siege of Terra: Mortis (LE, Signed)", "Book", 80, 250),
        ("bl", "Black Library", "Horus Rising (LE, Numbered)", "Book", 50, 350),
        ("bl", "Black Library", "First Heretic (LE, Numbered)", "Book", 50, 300),
        ("bl", "Black Library", "Echoes of Eternity (LE, Signed)", "Book", 80, 220),

        # ── Space Marine Chapter Upgrade Sprues & Champions ────────────────
        ("40k", "Blood Angels", "Blood Angels Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Blood Angels", "Astorath the Grim", "HQ", 25, 32),
        ("40k", "Blood Angels", "The Sanguinor", "HQ", 25, 35),
        ("40k", "Dark Angels", "Dark Angels Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Dark Angels", "Belial, Grand Master of the Deathwing", "HQ", 30, 38),
        ("40k", "Space Wolves", "Space Wolves Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Space Wolves", "Thunderwolf Cavalry (3)", "Fast Attack", 40, 52),
        ("40k", "Space Wolves", "Wulfen (5)", "Elite", 35, 45),
        ("40k", "Space Wolves", "Ragnar Blackmane", "HQ", 30, 38),
        ("40k", "Black Templars", "Black Templars Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Black Templars", "Sword Brethren (5)", "Elite", 40, 48),
        ("40k", "Black Templars", "Emperor's Champion (2024)", "HQ", 28, 35),
        ("40k", "Black Templars", "High Marshal Helbrecht", "HQ", 30, 40),
        ("40k", "Salamanders", "Salamanders Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Salamanders", "Vulkan He'stan", "HQ", 25, 32),
        ("40k", "Iron Hands", "Iron Hands Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Iron Hands", "Iron Father Feirros", "HQ", 28, 35),
        ("40k", "Raven Guard", "Raven Guard Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Raven Guard", "Kayvaan Shrike", "HQ", 28, 35),
        ("40k", "White Scars", "White Scars Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Imperial Fists", "Imperial Fists Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Ultramarines", "Ultramarines Upgrade Sprue (10)", "Upgrade", 15, 18),
        ("40k", "Ultramarines", "Chief Librarian Tigurius", "HQ", 28, 35),
        ("40k", "Ultramarines", "Captain Sicarius", "HQ", 25, 32),

        # ── Tyranid Bio-Titans & Xenos Expansion ──────────────────────────
        ("40k", "Tyranids", "Hierophant Bio-Titan (Forge World)", "Centerpiece", 280, 380),
        ("40k", "Tyranids", "Harridan (Forge World)", "Centerpiece", 200, 280),
        ("40k", "Tyranids", "Barbed Hierodule (Forge World)", "Monster", 100, 140),
        ("40k", "Tyranids", "Scythed Hierodule (Forge World)", "Monster", 100, 140),
        ("40k", "Tyranids", "Dimachaeron (Forge World)", "Monster", 80, 110),
        ("40k", "Tyranids", "Malanthrope (Forge World)", "HQ", 45, 60),
        ("40k", "Tyranids", "Stone-Crusher Carnifex (Forge World)", "Monster", 60, 80),
        ("40k", "Tyranids", "Norn Emissary", "Centerpiece", 70, 90),
        ("40k", "Tyranids", "Norn Assimilator", "Centerpiece", 70, 90),

        # ── Ork Mega Builds ────────────────────────────────────────────────
        ("40k", "Orks", "Stompa", "Centerpiece", 95, 130),
        ("40k", "Orks", "Gorkanaut", "Vehicle", 70, 90),
        ("40k", "Orks", "Morkanaut", "Vehicle", 70, 90),
        ("40k", "Orks", "Kill Rig", "Vehicle", 75, 95),
        ("40k", "Orks", "Hunta Rig", "Vehicle", 75, 95),
        ("40k", "Orks", "Mega Dread (Forge World)", "Vehicle", 85, 120),
        ("40k", "Orks", "Gargantuan Squiggoth (Forge World)", "Centerpiece", 150, 210),
        ("40k", "Orks", "Big'ed Bossbunka", "Fortification", 40, 50),
        ("40k", "Orks", "Beastboss on Squigosaur", "HQ", 35, 45),

        # ── Adeptus Mechanicus ─────────────────────────────────────────────
        ("40k", "Adeptus Mechanicus", "Belisarius Cawl", "HQ", 40, 52),
        ("40k", "Adeptus Mechanicus", "Skitarii Rangers (10)", "Troops", 30, 38),
        ("40k", "Adeptus Mechanicus", "Skitarii Vanguard (10)", "Troops", 30, 38),
        ("40k", "Adeptus Mechanicus", "Onager Dunecrawler", "Vehicle", 45, 55),
        ("40k", "Adeptus Mechanicus", "Kastelan Robots (2)", "Heavy Support", 50, 62),
        ("40k", "Adeptus Mechanicus", "Archaeopter", "Vehicle", 55, 68),
        ("40k", "Adeptus Mechanicus", "Ironstrider Ballistarius", "Fast Attack", 35, 42),
        ("40k", "Adeptus Mechanicus", "Sicarian Infiltrators (5)", "Elite", 35, 42),
        ("40k", "Adeptus Mechanicus", "Corpuscarii Electro-Priests (5)", "Elite", 30, 38),
        ("40k", "Adeptus Mechanicus", "Tech-Priest Dominus", "HQ", 28, 35),
        ("40k", "Adeptus Mechanicus", "Tech-Priest Manipulus", "HQ", 25, 32),

        # ── Imperial Knights ───────────────────────────────────────────────
        ("40k", "Imperial Knights", "Knight Castellan", "Centerpiece", 110, 140),
        ("40k", "Imperial Knights", "Knight Valiant", "Centerpiece", 110, 140),
        ("40k", "Imperial Knights", "Knight Crusader", "Centerpiece", 100, 125),
        ("40k", "Imperial Knights", "Knight Errant", "Centerpiece", 100, 125),
        ("40k", "Imperial Knights", "Knight Paladin", "Centerpiece", 100, 125),
        ("40k", "Imperial Knights", "Knight Warden", "Centerpiece", 100, 125),
        ("40k", "Imperial Knights", "Knight Gallant", "Centerpiece", 100, 125),
        ("40k", "Imperial Knights", "Armiger Warglaives (2)", "Fast Attack", 55, 68),
        ("40k", "Imperial Knights", "Armiger Helverins (2)", "Fast Attack", 55, 68),
        ("40k", "Imperial Knights", "Canis Rex", "Centerpiece", 105, 130),

        # ── Chaos Daemons ──────────────────────────────────────────────────
        ("40k", "Chaos Daemons", "Bloodthirster", "Centerpiece", 85, 110),
        ("40k", "Chaos Daemons", "Be'lakor, the Dark Master", "Centerpiece", 80, 105),
        ("40k", "Chaos Daemons", "Daemon Prince", "HQ", 35, 45),
        ("40k", "Chaos Daemons", "Skulltaker", "HQ", 25, 32),
        ("40k", "Chaos Daemons", "Changeling", "HQ", 22, 28),
        ("40k", "Chaos Daemons", "Masque of Slaanesh", "HQ", 22, 28),
        ("40k", "Chaos Daemons", "Epidemius", "HQ", 28, 35),
        ("40k", "Chaos Daemons", "Horticulous Slimux", "HQ", 30, 38),
        ("40k", "Chaos Daemons", "Flamers of Tzeentch (3)", "Elite", 30, 38),
        ("40k", "Chaos Daemons", "Fiends of Slaanesh (3)", "Elite", 35, 42),
        ("40k", "Chaos Daemons", "Bloodcrushers of Khorne (3)", "Elite", 40, 48),
        ("40k", "Chaos Daemons", "Plague Drones of Nurgle (3)", "Fast Attack", 40, 50),
        ("40k", "Chaos Daemons", "Exalted Seeker Chariot of Slaanesh", "Fast Attack", 38, 48),
        ("40k", "Chaos Daemons", "Skull Cannon of Khorne", "Heavy Support", 35, 42),
    ]
...
def _variant_expansion() -> list[dict]:
    ...
    variants = [
        ...
        # =================================================================
        # EXPANSION BATCH 2 — Most Popular / Most Searched (+250)
        # =================================================================

        # ── Space Marines — Primaris (+40) ──────────────────────────────
        ("40k", "Space Marines", "Primaris Intercessors (5)", "Troops", 32, 38),
        ("40k", "Space Marines", "Hellblasters (5)", "Heavy Support", 35, 42),
        ("40k", "Space Marines", "Inceptors (3)", "Fast Attack", 35, 42),
        ("40k", "Space Marines", "Aggressors (3)", "Elite", 35, 42),
        ("40k", "Space Marines", "Heavy Intercessors (5)", "Troops", 38, 45),
        ("40k", "Space Marines", "Storm Speeder Hailstrike", "Fast Attack", 45, 55),
        ("40k", "Space Marines", "Storm Speeder Thunderstrike", "Fast Attack", 45, 55),
        ("40k", "Space Marines", "Storm Speeder Hammerstrike", "Fast Attack", 45, 55),
        ("40k", "Space Marines", "Gladiator Reaper", "Vehicle", 50, 62),
        ("40k", "Space Marines", "Gladiator Valiant", "Vehicle", 50, 62),
        ("40k", "Space Marines", "Gladiator Lancer", "Vehicle", 50, 62),
        ("40k", "Space Marines", "Impulsor", "Transport", 42, 52),
        ("40k", "Space Marines", "Ballistus Dreadnought", "Vehicle", 40, 50),
        ("40k", "Space Marines", "Brutalis Dreadnought", "Vehicle", 42, 52),
        ("40k", "Dark Angels", "Lion El'Jonson", "Centerpiece", 42, 55),
        ("40k", "Dark Angels", "Inner Circle Companions (3)", "Elite", 38, 48),
        ("40k", "Dark Angels", "Deathwing Knights (5)", "Elite", 40, 48),
        ("40k", "Space Marines", "Captain in Gravis Armour", "HQ", 28, 35),
        ("40k", "Space Marines", "Primaris Librarian", "HQ", 25, 32),
        ("40k", "Space Marines", "Primaris Chaplain", "HQ", 25, 32),
        ("40k", "Space Marines", "Primaris Ancient", "Elite", 25, 32),
        ("40k", "Space Marines", "Primaris Apothecary", "Elite", 25, 32),
        ("40k", "Space Marines", "Ultramarines Chapter Upgrade Pack", "Upgrade", 15, 18),
        ("40k", "Space Marines", "Blood Angels Chapter Upgrade Pack", "Upgrade", 15, 18),
        ("40k", "Space Marines", "Space Wolves Chapter Upgrade Pack", "Upgrade", 15, 18),
        ("40k", "Space Marines", "Black Templars Chapter Upgrade Pack", "Upgrade", 15, 18),
        ("40k", "Space Marines", "Deathwatch Upgrade Pack", "Upgrade", 15, 18),
        ("40k", "Space Marines", "Infernus Marines (3)", "Troops", 35, 42),
        ("40k", "Space Marines", "Sternguard Veterans (5)", "Elite", 38, 45),
        ("40k", "Space Marines", "Terminator Squad (5)", "Elite", 42, 52),
        ("40k", "Space Marines", "Centurion Devastator Squad (3)", "Heavy Support", 50, 62),
        ("40k", "Space Marines", "Land Raider Redeemer", "Vehicle", 55, 68),
        ("40k", "Space Marines", "Firestrike Servo-Turret", "Heavy Support", 25, 32),
        ("40k", "Space Marines", "Invader ATV", "Fast Attack", 28, 35),
        ("40k", "Space Marines", "Phobos Librarian", "HQ", 25, 32),
        ("40k", "Space Marines", "Infiltrators (10)", "Troops", 42, 50),
        ("40k", "Space Marines", "Incursors (10)", "Troops", 42, 50),
        ("40k", "Space Marines", "Assault Intercessors (10)", "Troops", 40, 48),

        # ── Tyranids (+20) ─────────────────────────────────────────────
        ("40k", "Tyranids", "Hive Tyrant (Winged)", "HQ", 42, 52),
        ("40k", "Tyranids", "Carnifex Brood (2)", "Monster", 55, 68),
        ("40k", "Tyranids", "Trygon / Mawloc", "Monster", 45, 55),
        ("40k", "Tyranids", "Tervigon", "Monster", 45, 55),
        ("40k", "Tyranids", "Haruspex / Exocrine", "Monster", 45, 55),
        ("40k", "Tyranids", "Lictor (New Sculpt)", "Elite", 25, 32),
        ("40k", "Tyranids", "Zoanthropes (3)", "Elite", 35, 42),
        ("40k", "Tyranids", "Neurothrope", "HQ", 22, 28),
        ("40k", "Tyranids", "Tyranid Warriors (3)", "Troops", 38, 45),
        ("40k", "Tyranids", "Genestealers (10)", "Troops", 28, 35),
        ("40k", "Tyranids", "Screamer-Killers (2)", "Monster", 48, 58),
        ("40k", "Tyranids", "Von Ryan's Leapers (3)", "Fast Attack", 30, 38),
        ("40k", "Tyranids", "Barbgaunts (5)", "Troops", 28, 32),
        ("40k", "Tyranids", "Ripper Swarms (6 bases)", "Troops", 25, 28),
        ("40k", "Tyranids", "Norn Emissary / Norn Assimilator", "Centerpiece", 65, 82),
        ("40k", "Tyranids", "Deathleaper", "HQ", 28, 35),
        ("40k", "Tyranids", "Winged Tyranid Prime", "HQ", 28, 35),
        ("40k", "Tyranids", "Psychophage", "Monster", 35, 42),

        # ── Necrons (+15) ──────────────────────────────────────────────
        ("40k", "Necrons", "Void Dragon (C'tan Shard)", "Centerpiece", 42, 55),
        ("40k", "Necrons", "Nightbringer (C'tan Shard)", "Centerpiece", 28, 38),
        ("40k", "Necrons", "The Silent King", "Centerpiece", 95, 125),
        ("40k", "Necrons", "Monolith", "Vehicle", 70, 88),
        ("40k", "Necrons", "Doomsday Ark", "Vehicle", 38, 48),
        ("40k", "Necrons", "Ghost Ark", "Transport", 38, 48),
        ("40k", "Necrons", "Skorpekh Destroyers (6)", "Elite", 35, 42),
        ("40k", "Necrons", "Canoptek Doomstalker", "Heavy Support", 28, 35),
        ("40k", "Necrons", "Lokhust Heavy Destroyer", "Heavy Support", 22, 28),
        ("40k", "Necrons", "Ophydian Destroyers (3)", "Elite", 35, 42),
        ("40k", "Necrons", "Flayed Ones (5)", "Elite", 30, 38),
        ("40k", "Necrons", "Hexmark Destroyer", "Elite", 22, 28),
        ("40k", "Necrons", "Technomancer", "HQ", 22, 28),
        ("40k", "Necrons", "Chronomancer", "HQ", 22, 28),
        ("40k", "Necrons", "Overlord with Translocation Shroud", "HQ", 25, 32),

        # ── Orks (+15) ────────────────────────────────────────────────
        ("40k", "Orks", "Ghazghkull Thraka", "HQ", 42, 55),
        ("40k", "Orks", "Kill Rig / Hunta Rig", "Centerpiece", 70, 88),
        ("40k", "Orks", "Squighog Boyz (3)", "Fast Attack", 32, 40),
        ("40k", "Orks", "Meganobz (3)", "Elite", 38, 48),
        ("40k", "Orks", "Deff Dread", "Vehicle", 30, 38),
        ("40k", "Orks", "Gorkanaut / Morkanaut", "Centerpiece", 75, 95),
        ("40k", "Orks", "Flash Gitz (5)", "Heavy Support", 30, 38),
        ("40k", "Orks", "Kommandos (10)", "Elite", 35, 42),
        ("40k", "Orks", "Beast Snagga Boyz (10)", "Troops", 32, 38),
        ("40k", "Orks", "Beastboss", "HQ", 25, 32),
        ("40k", "Orks", "Mozrog Skragbad", "HQ", 38, 48),
        ("40k", "Orks", "Painboss", "HQ", 22, 28),
        ("40k", "Orks", "Zodgrod Wortsnagga", "HQ", 22, 28),
        ("40k", "Orks", "Trukk", "Transport", 28, 35),
        ("40k", "Orks", "Battlewagon", "Vehicle", 48, 60),

        # ── Chaos Space Marines (+20) ──────────────────────────────────
        ("40k", "Chaos Space Marines", "Vashtorr the Arkifane", "HQ", 42, 55),
        ("40k", "Chaos Space Marines", "Chosen (5)", "Elite", 38, 48),
        ("40k", "Chaos Space Marines", "Havocs (5)", "Heavy Support", 35, 42),
        ("40k", "Chaos Space Marines", "Obliterators (2)", "Heavy Support", 38, 48),
        ("40k", "Chaos Space Marines", "Possessed (5)", "Elite", 38, 48),
        ("40k", "Chaos Space Marines", "Helbrute (New Sculpt)", "Elite", 35, 42),
        ("40k", "Chaos Space Marines", "Maulerfiend / Forgefiend", "Vehicle", 48, 60),
        ("40k", "Chaos Space Marines", "Venomcrawler", "Vehicle", 28, 35),
        ("40k", "Chaos Space Marines", "Accursed Cultists (10)", "Troops", 35, 42),
        ("40k", "Chaos Space Marines", "Dark Commune", "HQ", 35, 42),
        ("40k", "Chaos Space Marines", "Warpsmith", "HQ", 25, 32),
        ("40k", "Chaos Space Marines", "Master of Executions", "HQ", 22, 28),
        ("40k", "Chaos Knights", "War Dog Stalker", "Vehicle", 35, 42),
        ("40k", "Chaos Knights", "War Dog Huntsman", "Vehicle", 35, 42),
        ("40k", "Chaos Knights", "War Dog Karnivore", "Vehicle", 35, 42),
        ("40k", "Chaos Knights", "Knight Desecrator", "Centerpiece", 100, 125),
        ("40k", "Chaos Knights", "Knight Abominant", "Centerpiece", 100, 125),
        ("40k", "Chaos Knights", "Knight Rampager", "Centerpiece", 100, 125),
        ("40k", "Chaos Space Marines", "Chaos Land Raider", "Vehicle", 55, 68),
        ("40k", "Chaos Space Marines", "Chaos Predator", "Vehicle", 42, 52),

        # ── Aeldari (+15) ─────────────────────────────────────────────
        ("40k", "Aeldari", "Avatar of Khaine (New Sculpt)", "Centerpiece", 70, 88),
        ("40k", "Aeldari", "Wraithknight", "Centerpiece", 80, 105),
        ("40k", "Aeldari", "Wraithguard / Wraithblades (5)", "Elite", 35, 42),
        ("40k", "Aeldari", "Warp Spiders (5)", "Fast Attack", 35, 42),
        ("40k", "Aeldari", "Howling Banshees (5)", "Elite", 32, 38),
        ("40k", "Aeldari", "Striking Scorpions (5)", "Elite", 32, 38),
        ("40k", "Aeldari", "Dire Avengers (5)", "Troops", 28, 35),
        ("40k", "Aeldari", "Windriders (3)", "Fast Attack", 28, 35),
        ("40k", "Aeldari", "Shining Spears (3)", "Fast Attack", 35, 42),
        ("40k", "Aeldari", "Wave Serpent", "Transport", 35, 42),
        ("40k", "Aeldari", "Falcon", "Vehicle", 35, 42),
        ("40k", "Aeldari", "Wraithlord", "Monster", 32, 40),
        ("40k", "Aeldari", "Autarch (New Sculpt)", "HQ", 25, 32),

        # ── T'au Empire (+15) ─────────────────────────────────────────
        ("40k", "T'au Empire", "Riptide Battlesuit", "Centerpiece", 55, 68),
        ("40k", "T'au Empire", "Stormsurge", "Centerpiece", 80, 105),
        ("40k", "T'au Empire", "Ghostkeel Battlesuit", "Elite", 48, 60),
        ("40k", "T'au Empire", "Commander Shadowsun", "HQ", 28, 35),
        ("40k", "T'au Empire", "Crisis Battlesuit Team (3)", "Elite", 48, 60),
        ("40k", "T'au Empire", "Broadside Battlesuit", "Heavy Support", 38, 48),
        ("40k", "T'au Empire", "Hammerhead Gunship", "Vehicle", 42, 52),
        ("40k", "T'au Empire", "Devilfish", "Transport", 35, 42),
        ("40k", "T'au Empire", "Pathfinder Team (10)", "Fast Attack", 30, 38),
        ("40k", "T'au Empire", "Fire Warriors / Breachers (10)", "Troops", 32, 38),
        ("40k", "T'au Empire", "Kroot Carnivores (10)", "Troops", 28, 35),
        ("40k", "T'au Empire", "Kroot Flesh Shaper", "HQ", 22, 28),
        ("40k", "T'au Empire", "Stealth Battlesuits (3)", "Elite", 28, 35),
        ("40k", "T'au Empire", "Cadre Fireblade", "HQ", 18, 22),
        ("40k", "T'au Empire", "Darkstrider", "HQ", 18, 22),

        # ── AoS — Stormcast Eternals (+20) ────────────────────────────
        ("aos", "Stormcast Eternals", "Bastian Carthalos", "HQ", 38, 48),
        ("aos", "Stormcast Eternals", "Lord-Imperatant with Gryph-hound", "HQ", 25, 32),
        ("aos", "Stormcast Eternals", "Annihilators with Meteoric Grandhammers (3)", "Elite", 38, 48),
        ("aos", "Stormcast Eternals", "Stormdrake Guard (2)", "Monster", 55, 68),
        ("aos", "Stormcast Eternals", "Dracothian Guard Fulminators (2)", "Elite", 42, 52),
        ("aos", "Stormcast Eternals", "Dracothian Guard Tempestors (2)", "Elite", 42, 52),
        ("aos", "Stormcast Eternals", "Celestant-Prime", "Centerpiece", 42, 55),
        ("aos", "Stormcast Eternals", "Lord-Celestant on Stardrake", "Centerpiece", 70, 88),
        ("aos", "Stormcast Eternals", "Knight-Vexillor with Banner of Apotheosis", "HQ", 25, 32),
        ("aos", "Stormcast Eternals", "Knight-Judicator with Gryph-hounds", "HQ", 22, 28),
        ("aos", "Stormcast Eternals", "Vanquishers (5)", "Troops", 30, 38),
        ("aos", "Stormcast Eternals", "Praetors (3)", "Elite", 32, 38),
        ("aos", "Stormcast Eternals", "Vigilors (5)", "Troops", 30, 38),
        ("aos", "Stormcast Eternals", "Vanguard-Raptors with Longstrike Crossbows (3)", "Elite", 35, 42),
        ("aos", "Stormcast Eternals", "Prosecutors with Celestial Hammers (3)", "Fast Attack", 28, 35),
        ("aos", "Stormcast Eternals", "Evocators (5)", "Elite", 32, 40),
        ("aos", "Stormcast Eternals", "Lord-Arcanum on Gryph-charger", "HQ", 28, 35),

        # ── AoS — Death / Destruction (+20) ──────────────────────────
        ("aos", "Ossiarch Bonereapers", "Nagash, Supreme Lord of the Undead", "Centerpiece", 80, 110),
        ("aos", "Ossiarch Bonereapers", "Katakros, Mortarch of the Necropolis", "HQ", 55, 72),
        ("aos", "Nighthaunt", "Lady Olynder, Mortarch of Grief", "HQ", 28, 35),
        ("aos", "Nighthaunt", "Spirit Hosts (3)", "Troops", 22, 28),
        ("aos", "Nighthaunt", "Chainrasps (10)", "Troops", 25, 30),
        ("aos", "Nighthaunt", "Krulghast Cruciator", "HQ", 28, 35),
        ("aos", "Fyreslayers", "Gotrek Gurnisson", "HQ", 25, 35),
        ("aos", "Kruleboyz", "Kragnos, the End of Empires", "Centerpiece", 80, 105),
        ("aos", "Sons of Behemat", "Mega-Gargant (Kraken-eater)", "Centerpiece", 100, 130),
        ("aos", "Sons of Behemat", "Mega-Gargant (Warstomper)", "Centerpiece", 100, 130),
        ("aos", "Sons of Behemat", "Mega-Gargant (Beast-smasher)", "Centerpiece", 100, 130),
        ("aos", "Ogor Mawtribes", "Ironguts (4)", "Elite", 30, 38),
        ("aos", "Orruk Warclans", "Ironjawz Megaboss on Maw-Krusha", "Centerpiece", 60, 78),
        ("aos", "Orruk Warclans", "Ironjawz Brutes (5)", "Elite", 28, 35),
        ("aos", "Orruk Warclans", "Ironjawz Ardboyz (10)", "Troops", 35, 42),
        ("aos", "Soulblight Gravelords", "Vampire Lord on Zombie Dragon", "Centerpiece", 50, 65),
        ("aos", "Soulblight Gravelords", "Blood Knights (5)", "Elite", 35, 42),
        ("aos", "Flesh-Eater Courts", "Ushoran, Mortarch of Delusion", "Centerpiece", 55, 72),
        ("aos", "Flesh-Eater Courts", "Varghulf Courtier", "Monster", 35, 45),

        # ── Citadel Paint Sets & Hobby Essentials (+20) ──────────────
        ("paint", "Citadel", "Citadel Base Paint Set (12 pots)", "Paint Set", 38, 42),
        ("paint", "Citadel", "Citadel Layer Paint Set (12 pots)", "Paint Set", 38, 42),
        ("paint", "Citadel", "Citadel Shade Paint Set (6 pots)", "Paint Set", 22, 25),
        ("paint", "Citadel", "Citadel Contrast Paint Set (12 pots)", "Paint Set", 42, 48),
        ("paint", "Citadel", "Citadel Technical Paint Set (6 pots)", "Paint Set", 22, 25),
        ("paint", "Citadel", "Chaos Black Spray Primer", "Spray", 15, 18),
        ("paint", "Citadel", "Wraithbone Spray Primer", "Spray", 15, 18),
        ("paint", "Citadel", "Grey Seer Spray Primer", "Spray", 15, 18),
        ("paint", "Citadel", "Citadel Texture Paint — Astrogranite Debris", "Paint", 8, 10),
        ("paint", "Citadel", "Citadel Texture Paint — Armageddon Dunes", "Paint", 8, 10),
        ("paint", "Citadel", "Citadel Technical — Blood for the Blood God", "Paint", 6, 8),
        ("paint", "Citadel", "Citadel Technical — Nihilakh Oxide", "Paint", 6, 8),
        ("paint", "Citadel", "Citadel Essential Hobby Tool Kit", "Tools", 28, 32),
        ("paint", "Citadel", "Citadel Fine Detail Cutters", "Tools", 22, 25),
        ("paint", "Citadel", "Citadel Plastic Glue (Thin)", "Tools", 8, 10),
        ("paint", "Citadel", "Citadel Mouldline Remover", "Tools", 12, 15),
        ("paint", "Citadel", "Citadel Hobby Knife", "Tools", 12, 15),
        ("paint", "Citadel", "Citadel Small Base Brush", "Brush", 8, 10),
        ("paint", "Citadel", "Citadel Medium Layer Brush", "Brush", 8, 10),
        ("paint", "Citadel", "Citadel Shade Brush", "Brush", 8, 10),

        # ── Terrain & Scenery (+15) ──────────────────────────────────
        ("40k", "Terrain", "Sector Mechanicus — Galvanic Magnavent", "Terrain", 35, 42),
        ("40k", "Terrain", "Sector Mechanicus — Alchomite Stack", "Terrain", 25, 32),
        ("40k", "Terrain", "Sector Imperialis Ruins", "Terrain", 42, 52),
        ("40k", "Terrain", "Sector Imperialis Basilicanum", "Terrain", 55, 68),
        ("40k", "Terrain", "Ork Scrap Terrain — Mekboy Workshop", "Terrain", 28, 35),
        ("40k", "Terrain", "Battlezone Fronteris — Landing Pad", "Terrain", 35, 42),
        ("40k", "Terrain", "Battlezone Fronteris — Vox-Antenna & Auspex Shrine", "Terrain", 28, 35),
        ("aos", "Terrain", "AoS Realmscape — Thondian Expansion", "Terrain", 35, 42),
        ("aos", "Terrain", "AoS Realmscape — Ghurish Expanse", "Terrain", 32, 40),
        ("aos", "Terrain", "AoS Realmscape — Hallowed Stormthane", "Terrain", 28, 35),
        ("40k", "Terrain", "Zone Mortalis — Floor Tiles Set", "Terrain", 55, 68),
        ("40k", "Terrain", "Zone Mortalis — Column & Wall Set", "Terrain", 42, 52),
        ("40k", "Terrain", "Aegis Defence Line", "Terrain", 22, 28),
        ("40k", "Terrain", "Void Shield Generator (OOP)", "Terrain", 0, 120),
        ("40k", "Terrain", "Fortified Manor (Kill Team Terrain)", "Terrain", 45, 55),
    ]
