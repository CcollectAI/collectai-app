...
def get_curated_catalog() -> list[dict]:
    ...
    pops = [
        ...
        # ── Freddy Funko Grails (~15) ───────────────────────────────────
        ("Freddy Funko", "SE", "Freddy Funko as Pennywise", "SDCC 2019", "grail", 3200),
        ("Freddy Funko", "SE", "Freddy Funko as Darth Vader", "SDCC 2015", "grail", 2500),
        ("Freddy Funko", "SE", "Freddy Funko as Boba Fett", "SDCC 2014", "grail", 4000),
        ("Freddy Funko", "SE", "Freddy Funko as Iron Man", "SDCC 2017", "grail", 2800),
        ("Freddy Funko", "SE", "Freddy Funko as Deadpool", "SDCC 2018", "grail", 1800),
        ("Freddy Funko", "SE", "Freddy Funko as Spider-Man", "SDCC 2020", "grail", 2200),
        ("Freddy Funko", "SE", "Freddy Funko as Batman", "SDCC 2016", "grail", 3000),
        ("Freddy Funko", "SE", "Freddy Funko as Superman", "SDCC 2013", "grail", 3500),
        ("Freddy Funko", "SE", "Freddy Funko as The Joker", "SDCC 2019", "grail", 2400),
        ("Freddy Funko", "SE", "Freddy Funko as Goku", "SDCC 2022", "grail", 1500),
        ("Freddy Funko", "SE", "Freddy Funko as Freddy Mercury", "SDCC 2021", "grail", 1200),
        ("Freddy Funko", "SE", "Freddy Funko as Optimus Prime", "SDCC 2023", "grail", 1000),
        ("Freddy Funko", "SE", "Freddy Funko as Venom", "SDCC 2024", "grail", 900),
        ("Freddy Funko", "SE", "Freddy Funko as All Might", "SDCC 2023", "grail", 850),
        ("Freddy Funko", "SE", "Freddy Funko as Naruto", "SDCC 2024", "grail", 1100),

        # ── Disney Parks Exclusives (~12) ───────────────────────────────
        ("Disney", "SE", "Mickey Mouse (Diamond, D23 Expo)", "D23 Expo", "grail", 600),
        ("Disney", "SE", "Genie (Diamond, Disneyland 65th)", "Disneyland", "grail", 500),
        ("Disney", "SE", "Stitch (Flocked, Disney Parks)", "Disney Parks", "high", 180),
        ("Disney", "SE", "Orange Bird (Disney Parks)", "Disney Parks", "high", 250),
        ("Disney", "SE", "Figment (Rainbow, EPCOT)", "EPCOT", "grail", 400),
        ("Disney", "SE", "Haunted Mansion Hitchhiking Ghosts 3-Pack", "Disney Parks", "grail", 350),
        ("Disney", "SE", "Maleficent Dragon (Metallic, 6\")", "Disney Parks", "high", 200),
        ("Disney", "SE", "Cinderella Castle (Disney Ultimate Princess)", "Disney Parks", "high", 160),
        ("Disney", "SE", "Hatbox Ghost (Glow)", "Disney Parks", "grail", 450),
        ("Disney", "SE", "Madame Leota (Glow)", "Disney Parks", "high", 200),
        ("Disney", "SE", "Mr. Toad (Wild Ride, Disney Parks)", "Disney Parks", "high", 150),
        ("Disney", "SE", "Dreamfinder & Figment (Ride)", "Disney Parks", "grail", 500),

        # ── SDCC/NYCC 2024-2025 Exclusives (~18) ───────────────────────
        ("Animation", "SE", "Gojo (Six Eyes, Glow)", "SDCC 2024", "high", 200),
        ("Animation", "SE", "Sukuna (True Form, 6\")", "SDCC 2024", "high", 180),
        ("Animation", "SE", "Luffy Gear 5 (Metallic)", "NYCC 2024", "high", 160),
        ("Animation", "SE", "Power (Blood Fiend, Glow)", "SDCC 2024", "high", 150),
        ("Marvel", "SE", "Deadpool (Metallic, 10\")", "SDCC 2024", "high", 120),
        ("Marvel", "SE", "Wolverine (Berserker Rage, Glow)", "SDCC 2025", "high", 140),
        ("Star Wars", "SE", "Darth Revan (Metallic)", "NYCC 2024", "high", 170),
        ("Star Wars", "SE", "Ahsoka Tano (Hooded, Glow)", "SDCC 2025", "high", 130),
        ("Games", "SE", "Master Chief (Gold, Halo)", "SDCC 2024", "high", 110),
        ("Movies", "SE", "Beetlejuice (Glow, Metallic)", "NYCC 2025", "high", 120),
        ("Television", "SE", "Eleven (Flayed, Stranger Things)", "SDCC 2025", "high", 100),
        ("Animation", "SE", "Denji (Chainsaw Head, Metallic)", "NYCC 2025", "high", 140),
        ("Animation", "SE", "Toji Fushiguro (Glow)", "SDCC 2025", "high", 170),
        ("Movies", "SE", "Ghostface (Flocked, Metallic)", "NYCC 2024", "high", 110),
        ("Animation", "SE", "Itadori Yuji (Black Flash, Glow)", "SDCC 2025", "high", 160),
        ("Marvel", "SE", "Spider-Man 2099 (Metallic)", "SDCC 2025", "high", 130),
        ("DC Heroes", "SE", "Harley Quinn (Animated Series, Glow)", "NYCC 2025", "high", 100),
        ("Animation", "SE", "Anya Forger (Starlight, Glow)", "SDCC 2025", "high", 120),

        # ── Flocked / Glow / Metallic Variants (~20) ───────────────────
        ("Animation", "1600", "Gojo Satoru (Metallic)", "Funko Shop", "high", 180),
        ("Animation", "1601", "Gojo Satoru (Flocked)", "Box Lunch", "high", 150),
        ("Animation", "SE", "Tanjiro (Hinokami Kagura, Glow)", "Hot Topic", "high", 120),
        ("Animation", "SE", "Nezuko (Demon Form, Glow)", "Entertainment Earth", "high", 130),
        ("Animation", "SE", "All Might (Silver Age, Metallic)", "Funko Shop", "high", 140),
        ("Animation", "SE", "Deku (Full Cowl, Glow)", "Hot Topic", "mid", 75),
        ("Animation", "SE", "Vegeta (Super Saiyan Blue, Metallic)", "SDCC 2023", "high", 100),
        ("Animation", "SE", "Goku Ultra Instinct (Glow)", "Chalice", "high", 110),
        ("Animation", "SE", "Broly (Legendary, 6\", Metallic)", "Funko Shop", "high", 180),
        ("Animation", "SE", "Bakugo (Explosion, Glow)", "Funko Shop", "mid", 85),
        ("Animation", "SE", "Todoroki (Ice & Fire, Glow)", "Box Lunch", "mid", 80),
        ("Animation", "SE", "Toga Himiko (Unmasked, Glow)", "Hot Topic", "mid", 70),
        ("Animation", "SE", "Naruto (Baryon Mode, Metallic)", "AAA Anime", "high", 120),
        ("Animation", "SE", "Naruto Sage Mode (Glow)", "Entertainment Earth", "high", 110),
        ("Animation", "SE", "Sasuke (Curse Mark, Glow)", "Chalice", "mid", 90),
        ("Animation", "SE", "Itachi (Susanoo, Glow, 6\")", "AAA Anime", "high", 200),
        ("Animation", "SE", "Gon Freecss (Transformation, Glow)", "Funko Shop", "high", 160),
        ("Animation", "SE", "Killua (Godspeed, Glow)", "Chalice", "high", 180),
        ("Animation", "SE", "Kurapika (Emperor Time, Glow)", "Hot Topic", "high", 140),
        ("Animation", "SE", "Hisoka (Glow)", "Entertainment Earth", "mid", 90),

        # ── TV / Movie Grails (~15) ─────────────────────────────────────
        ("Television", "SE", "Game of Thrones Iron Throne (NYCC Metallic)", "NYCC 2015", "grail", 800),
        ("Television", "SE", "Night King (Metallic, Riding Viserion)", "HBO", "grail", 600),
        ("Television", "52", "Breaking Bad Walter White (Blue Crystal)", "SDCC 2015", "grail", 500),
        ("Television", "SE", "Heisenberg (Blue Crystal, Glow)", "Gemini", "grail", 650),
        ("Television", "428", "Stranger Things Demogorgon (Metallic)", "Target", "high", 200),
        ("Television", "SE", "Stranger Things Eleven (Underwater, Chase)", "Funko Shop", "high", 180),
        ("Television", "SE", "The Office Michael Scott (Blonde, Chase)", "", "high", 120),
        ("Television", "SE", "The Office Dwight Schrute (Recyclops)", "SDCC 2020", "high", 150),
        ("Television", "SE", "Squid Game (Front Man, Metallic)", "Funko Shop", "mid", 85),
        ("Movies", "SE", "Avengers Endgame Thanos (Nano Gauntlet, 10\")", "Target", "high", 200),
        ("Movies", "SE", "Batman (1966, Metallic)", "Gemini", "grail", 500),
        ("Movies", "SE", "The Joker (Dark Knight, Bank Robber, Metallic)", "Grails", "grail", 2200),
        ("Movies", "SE", "Pennywise (Deadlights, Metallic)", "Hot Topic", "high", 120),
        ("Movies", "SE", "Ghostbusters Stay Puft (Burnt, 10\")", "SDCC", "high", 200),
        ("Movies", "SE", "E.T. (Glow)", "Target", "mid", 75),

        # ── 2025 Trending Releases (~20) ────────────────────────────────
        ("Animation", "1800", "Luffy (Gear 5 Nika, Glow)", "Funko Shop", "high", 200),
        ("Animation", "1801", "Zoro (King of Hell, Metallic)", "Chalice", "high", 150),
        ("Animation", "1802", "Makima (Control Devil)", "", "mid", 55),
        ("Animation", "1803", "Aki Hayakawa (Fox Devil)", "", "mid", 45),
        ("Animation", "1804", "Pochita (Flocked)", "Box Lunch", "mid", 60),
        ("Animation", "1805", "Sung Jin-woo (Arise, Glow)", "Entertainment Earth", "high", 130),
        ("Animation", "1806", "Igris (Shadow, Metallic)", "Funko Shop", "high", 110),
        ("Animation", "1810", "Goku (Ultra Instinct Mastered)", "", "mid", 35),
        ("Animation", "1811", "Vegeta (Ultra Ego)", "", "mid", 38),
        ("Animation", "1812", "Frieza (Black Frieza)", "", "mid", 42),
        ("Animation", "1815", "Kaneki (Half-Kakuja, Metallic)", "Funko Shop", "high", 120),
        ("Animation", "1816", "Touka Kirishima (Kagune, Glow)", "Chalice", "high", 100),
        ("Animation", "1820", "Fern (Magic Circle, Glow)", "Entertainment Earth", "mid", 65),
        ("Animation", "1821", "Himmel (The Hero, Metallic)", "Funko Shop", "mid", 55),
        ("Games", "1900", "Minecraft Creeper (Diamond, 10\")", "Target", "mid", 50),
        ("Games", "1901", "Fortnite Peely (Flocked)", "Walmart", "mid", 40),
        ("Rocks", "350", "Post Malone (Metallic)", "Funko Shop", "mid", 65),
        ("Rocks", "351", "Taylor Swift (1989 TV, Diamond)", "Target", "high", 200),
        ("Rocks", "352", "Billie Eilish (Glow)", "Hot Topic", "mid", 55),
        ("Rocks", "353", "Travis Scott (Astroworld)", "", "mid", 70),
    ]
