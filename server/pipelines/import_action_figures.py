...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ─── MAFEX (Medicom) ──────────────────────────────────────────────
        ("Medicom", "MAFEX", "Batman (The Dark Knight Returns)", '6"', "DC Comics", "Standard", "", 85),
        ("Medicom", "MAFEX", "The Joker (The Dark Knight)", '6"', "DC Comics", "Standard", "", 90),
        ("Medicom", "MAFEX", "Batman (Hush)", '6"', "DC Comics", "Standard", "", 80),
        ("Medicom", "MAFEX", "Superman (Hush)", '6"', "DC Comics", "Standard", "", 80),
        ("Medicom", "MAFEX", "Catwoman (Hush)", '6"', "DC Comics", "Standard", "", 75),
        ("Medicom", "MAFEX", "John Wick (Chapter 2)", '6"', "Movies", "Standard", "", 85),
        ("Medicom", "MAFEX", "Robocop (Murphy Head Sculpt)", '6"', "Movies", "Standard", "", 80),
        ("Medicom", "MAFEX", "Spider-Man (Comic Paint)", '6"', "Marvel", "Standard", "", 85),
        ("Medicom", "MAFEX", "Spider-Man (No Way Home Integrated Suit)", '6"', "Marvel", "Standard", "", 90),
        ("Medicom", "MAFEX", "Venom (Comic Ver.)", '6"', "Marvel", "Standard", "", 95),
        ("Medicom", "MAFEX", "Wolverine (Comic Ver.)", '6"', "Marvel", "Standard", "", 85),
        ("Medicom", "MAFEX", "Cyclops (Comic Ver.)", '6"', "Marvel", "Standard", "", 80),
        ("Medicom", "MAFEX", "Iron Man Mark 85 (Endgame)", '6"', "Marvel", "Standard", "", 95),
        ("Medicom", "MAFEX", "Captain America (Endgame)", '6"', "Marvel", "Standard", "", 85),
        ("Medicom", "MAFEX", "Darth Vader (Rogue One)", '6"', "Star Wars", "Standard", "", 90),
        ("Medicom", "MAFEX", "Boba Fett (Return of the Jedi)", '6"', "Star Wars", "Standard", "", 85),
        ("Medicom", "MAFEX", "C-3PO & R2-D2 Set", '6"', "Star Wars", "Deluxe", "", 120),

        # ─── Revoltech / Kaiyodo ──────────────────────────────────────────
        ("Kaiyodo", "Revoltech", "Evangelion Unit 01", '6"', "Evangelion", "Standard", "", 60),
        ("Kaiyodo", "Revoltech", "Evangelion Unit 02", '6"', "Evangelion", "Standard", "", 60),
        ("Kaiyodo", "Amazing Yamaguchi", "Venom", '6"', "Marvel", "Standard", "", 80),
        ("Kaiyodo", "Amazing Yamaguchi", "Carnage", '6"', "Marvel", "Standard", "", 85),
        ("Kaiyodo", "Amazing Yamaguchi", "Deadpool", '6"', "Marvel", "Standard", "", 75),
        ("Kaiyodo", "Amazing Yamaguchi", "Wolverine", '6"', "Marvel", "Standard", "", 80),
        ("Kaiyodo", "Amazing Yamaguchi", "Iron Spider", '6"', "Marvel", "Standard", "", 80),
        ("Kaiyodo", "Amazing Yamaguchi", "Batman", '6"', "DC Comics", "Standard", "", 75),
        ("Kaiyodo", "Amazing Yamaguchi", "Joker", '6"', "DC Comics", "Standard", "", 75),
        ("Kaiyodo", "Revoltech", "Woody (Toy Story, Legacy)", '6"', "Disney/Pixar", "Standard", "", 55),
        ("Kaiyodo", "Revoltech", "Buzz Lightyear (Legacy)", '6"', "Disney/Pixar", "Standard", "", 55),

        # ─── Figma (Good Smile Company) ───────────────────────────────────
        ("Good Smile", "Figma", "Link (Tears of the Kingdom)", '6"', "Legend of Zelda", "Standard", "", 70),
        ("Good Smile", "Figma", "Link (A Link Between Worlds)", '6"', "Legend of Zelda", "Standard", "", 65),
        ("Good Smile", "Figma", "Samus Aran (Metroid Prime 4)", '6"', "Metroid", "Standard", "", 75),
        ("Good Smile", "Figma", "Samus Aran (Metroid Other M)", '6"', "Metroid", "Standard", "", 90),
        ("Good Smile", "Figma", "Solid Snake (Metal Gear Solid 2)", '6"', "Metal Gear", "Standard", "", 80),
        ("Good Smile", "Figma", "Tracer (Overwatch 2)", '6"', "Overwatch", "Standard", "", 55),
        ("Good Smile", "Figma", "Genji (Overwatch 2)", '6"', "Overwatch", "Standard", "", 60),
        ("Good Smile", "Figma", "Guts (Berserker Armor)", '6"', "Berserk", "Standard", "", 110),
        ("Good Smile", "Figma", "Guts (Black Swordsman)", '6"', "Berserk", "Standard", "", 95),
        ("Good Smile", "Figma", "Griffith (Berserk)", '6"', "Berserk", "Standard", "", 70),
        ("Good Smile", "Figma", "Kirito (SAO: Alicization)", '6"', "Sword Art Online", "Standard", "", 60),

        # ─── S.H.Figuarts Dragon Ball (additional) ───────────────────────
        ("Bandai", "S.H.Figuarts", "Goku Ultra Instinct -Sign-", '6"', "Dragon Ball", "Standard", "", 65),
        ("Bandai", "S.H.Figuarts", "Goku Ultra Instinct (Mastered)", '6"', "Dragon Ball", "Standard", "", 70),
        ("Bandai", "S.H.Figuarts", "Broly (Full Power, DBS Movie)", '6"', "Dragon Ball", "Standard", "", 85),
        ("Bandai", "S.H.Figuarts", "Perfect Cell (Premium Color)", '6"', "Dragon Ball", "Standard", "", 80),
        ("Bandai", "S.H.Figuarts", "Vegeta (Super Saiyan God SS Evolved)", '6"', "Dragon Ball", "Standard", "", 65),
        ("Bandai", "S.H.Figuarts", "Frieza (Final Form, DBS Broly)", '6"', "Dragon Ball", "Standard", "", 65),
        ("Bandai", "S.H.Figuarts", "Gohan Beast (Super Hero)", '6"', "Dragon Ball", "Standard", "", 70),
        ("Bandai", "S.H.Figuarts", "Orange Piccolo (Super Hero)", '6"', "Dragon Ball", "Standard", "", 65),
        ("Bandai", "S.H.Figuarts", "Super Saiyan 4 Gogeta", '6"', "Dragon Ball", "Standard", "", 80),
        ("Bandai", "S.H.Figuarts", "Vegito (Super Saiyan Blue)", '6"', "Dragon Ball", "Standard", "", 75),

        # ─── Wrestling Figures ────────────────────────────────────────────
        ("Mattel", "WWE Ultimate Edition", "The Undertaker (WrestleMania)", '6"', "Wrestling", "Deluxe", "Walmart", 55),
        ("Mattel", "WWE Ultimate Edition", "Bret 'Hit Man' Hart", '6"', "Wrestling", "Deluxe", "", 50),
        ("Mattel", "WWE Ultimate Edition", "Mankind (Cactus Jack)", '6"', "Wrestling", "Deluxe", "", 55),
        ("Mattel", "WWE Ultimate Edition", "Stone Cold Steve Austin", '6"', "Wrestling", "Deluxe", "", 50),
        ("Mattel", "WWE Ultimate Edition", "The Rock (Attitude Era)", '6"', "Wrestling", "Deluxe", "", 55),
        ("Mattel", "WWE Ultimate Edition", "Macho Man Randy Savage", '6"', "Wrestling", "Deluxe", "", 50),
        ("Mattel", "WWE Ultimate Edition", "Ultimate Warrior", '6"', "Wrestling", "Deluxe", "", 55),
        ("Jazwares", "AEW Unrivaled", "Kenny Omega (AEW Champion)", '6"', "Wrestling", "Standard", "", 30),
        ("Jazwares", "AEW Unrivaled", "Chris Jericho (Le Champion)", '6"', "Wrestling", "Standard", "", 28),
        ("Jazwares", "AEW Unrivaled", "MJF (Pinnacle)", '6"', "Wrestling", "Standard", "", 28),
        ("Jazwares", "AEW Unrivaled", "Jon Moxley (World Champion)", '6"', "Wrestling", "Standard", "", 30),
        ("Jazwares", "AEW Unrivaled", "Will Ospreay", '6"', "Wrestling", "Standard", "", 28),
        ("Jazwares", "AEW Unrivaled", "Swerve Strickland (Champion)", '6"', "Wrestling", "Standard", "", 28),

        # ─── NECA 7-inch (additional) ─────────────────────────────────────
        ("NECA", "7-inch", "Alien Queen (Deluxe)", '7"', "Aliens", "Deluxe", "", 80),
        ("NECA", "7-inch", "Predator Trophy Wall Diorama", '7"', "Predator", "Deluxe", "", 120),
        ("NECA", "7-inch", "City Hunter Predator (Ultimate)", '7"', "Predator", "Window Box", "", 45),
        ("NECA", "7-inch", "Jungle Hunter Predator (Ultimate)", '7"', "Predator", "Window Box", "", 45),
        ("NECA", "7-inch", "Xenomorph Big Chap (Ultimate)", '7"', "Aliens", "Window Box", "", 42),
        ("NECA", "7-inch", "Alien (40th Anniversary, Ultimate)", '7"', "Aliens", "Window Box", "", 40),
        ("NECA", "7-inch", "Jason Voorhees (Ultimate Part 4)", '7"', "Horror", "Window Box", "", 42),
        ("NECA", "7-inch", "Freddy Krueger (Ultimate Part 3)", '7"', "Horror", "Window Box", "", 42),
        ("NECA", "7-inch", "Michael Myers (Halloween 2018 Ultimate)", '7"', "Horror", "Window Box", "", 42),
        ("NECA", "7-inch", "Pennywise (IT 2017 Ultimate)", '7"', "Horror", "Window Box", "", 40),
        ("NECA", "7-inch", "Leatherface (Texas Chainsaw 1974)", '7"', "Horror", "Window Box", "", 42),
        ("NECA", "7-inch", "Kratos (God of War 2018)", '7"', "Gaming", "Window Box", "", 38),
        ("NECA", "7-inch", "Dante (Devil May Cry V)", '7"', "Gaming", "Window Box", "", 35),
    ]
