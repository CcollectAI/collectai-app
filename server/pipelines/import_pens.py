...
def get_curated_catalog() -> list[dict]:
    ...
    all_tuples.extend(_expansion_1150_most_searched())
...
def _expansion_1150_most_searched() -> list[tuple]:
    """~140 most-searched pens: Montblanc classics, Pelikan Souveran, Sailor specialty,
    vintage grails, Japanese urushi, ink bottles (ink collecting is huge)."""
    return [
        # ── Montblanc Meisterstück Classics ─────────────────────────────────
        ("Meisterstück Classique 144 (Vintage 1980s)", "Montblanc", "Meisterstück", "14k Gold", "F",
         "piston", 450, False, "Standard", "1980s vintage 144, smaller size, gold trim"),
        ("Meisterstück Classique 144 (Vintage 1980s)", "Montblanc", "Meisterstück", "14k Gold", "M",
         "piston", 460, False, "Standard", "1980s vintage 144, medium nib variant"),
        ("Meisterstück Le Grand 146 (Vintage 1970s)", "Montblanc", "Meisterstück", "14k Gold", "B",
         "piston", 600, False, "Standard", "1970s vintage 146, broad nib, gold ring"),
        ("Meisterstück 146 Platinum Line", "Montblanc", "Meisterstück", "14k Gold", "EF",
         "piston", 550, False, "Standard", "Platinum trim, extra fine nib"),
        ("Bohème Bleu", "Montblanc", "Bohème", "18k Gold", "M",
         "converter", 650, True, "Limited Edition", "Blue lacquer, retractable nib"),
        ("Bohème Rouge", "Montblanc", "Bohème", "18k Gold", "F",
         "converter", 680, True, "Limited Edition", "Red lacquer, retractable nib"),
        ("StarWalker Extreme", "Montblanc", "StarWalker", "14k Gold", "M",
         "converter", 520, False, "Standard", "Carbon fiber, modern design"),
        ("StarWalker Extreme Steel", "Montblanc", "StarWalker", "Steel", "F",
         "converter", 380, False, "Standard", "Brushed steel barrel, floating logo"),
        ("StarWalker Urban Speed", "Montblanc", "StarWalker", "14k Gold", "M",
         "converter", 450, False, "Standard", "Racing-inspired, titanium clip"),
        ("Meisterstück 149 Calligraphy Flex", "Montblanc", "Meisterstück", "18k Gold", "Flex",
         "piston", 1200, True, "Limited Edition", "Calligraphy flex nib, very rare"),
        # ── Pelikan Souverän Variants ───────────────────────────────────────
        ("M400 Souverän White Tortoiseshell", "Pelikan", "Souveraen", "14k Gold", "EF",
         "piston", 380, True, "Limited Edition", "White tortoiseshell stripes, rare"),
        ("M400 Souverän Red", "Pelikan", "Souveraen", "14k Gold", "F",
         "piston", 350, False, "Standard", "Red and black stripes"),
        ("M600 Souverän Vibrant Blue", "Pelikan", "Souveraen", "14k Gold", "M",
         "piston", 420, True, "Limited Edition", "Special edition vivid blue"),
        ("M600 Souverän Vibrant Orange", "Pelikan", "Souveraen", "14k Gold", "B",
         "piston", 450, True, "Limited Edition", "Special edition vivid orange"),
        ("M600 Souverän Pink", "Pelikan", "Souveraen", "14k Gold", "F",
         "piston", 430, True, "Limited Edition", "Special edition, sold out fast"),
        ("M800 Renaissance Brown", "Pelikan", "Souveraen", "18k Gold", "M",
         "piston", 550, True, "Limited Edition", "Brown tortoiseshell, gold trim"),
        ("M805 Stresemann Anthracite", "Pelikan", "Souveraen", "18k Gold", "F",
         "piston", 500, False, "Standard", "Pinstripe grey, classic business pen"),
        ("M1000 Souverän (Broad Nib)", "Pelikan", "Souveraen", "18k Gold", "B",
         "piston", 700, False, "Standard", "Flagship, oversized broad nib"),
        ("Edelstein Ink Bottle — Olivine (2018 IOTY)", "Pelikan", "Edelstein Ink", "N/A", "N/A",
         "ink_bottle", 25, True, "Limited Edition", "Ink of the Year 2018, olive green"),
        ("Edelstein Ink Bottle — Apatite (2022 IOTY)", "Pelikan", "Edelstein Ink", "N/A", "N/A",
         "ink_bottle", 28, True, "Limited Edition", "Ink of the Year 2022, teal blue"),
        ("Edelstein Ink Bottle — Golden Beryl (2021 IOTY)", "Pelikan", "Edelstein Ink", "N/A", "N/A",
         "ink_bottle", 30, True, "Limited Edition", "Ink of the Year 2021, golden shimmer"),
        # ── Sailor Specialty ────────────────────────────────────────────────
        ("King of Pen Ebonite (Black)", "Sailor", "King of Pen", "21k Gold", "M",
         "converter", 1200, False, "Standard", "Ebonite barrel, oversized, flagship"),
        ("King of Pen Ebonite (Maroon)", "Sailor", "King of Pen", "21k Gold", "B",
         "converter", 1250, True, "Limited Edition", "Maroon ebonite, limited run"),
        ("Pro Gear Realo Black", "Sailor", "Pro Gear", "21k Gold", "MF",
         "piston", 500, False, "Standard", "Piston filler Pro Gear, rare mechanism"),
        ("Pro Gear Realo Maroon", "Sailor", "Pro Gear", "21k Gold", "M",
         "piston", 520, False, "Standard", "Maroon piston filler variant"),
        ("Pro Gear Cocktail Series — Old Fashioned", "Sailor", "Pro Gear Cocktail", "21k Gold", "MF",
         "converter", 380, True, "Limited Edition", "Amber resin, whiskey gold trim"),
        ("Pro Gear Cocktail Series — Kure Azur", "Sailor", "Pro Gear Cocktail", "21k Gold", "M",
         "converter", 380, True, "Limited Edition", "Blue lagoon resin, silver trim"),
        ("Pro Gear Cocktail Series — Tequila Sunrise", "Sailor", "Pro Gear Cocktail", "21k Gold", "F",
         "converter", 380, True, "Limited Edition", "Orange/yellow gradient resin"),
        ("Pro Gear Cocktail Series — Mojito", "Sailor", "Pro Gear Cocktail", "21k Gold", "MF",
         "converter", 380, True, "Limited Edition", "Green resin, mint-inspired"),
        ("Pro Gear Cocktail Series — Cosmopolitan", "Sailor", "Pro Gear Cocktail", "21k Gold", "F",
         "converter", 380, True, "Limited Edition", "Pink resin, cranberry hue"),
        ("Manyo Series — Haha (Mother)", "Sailor", "Manyo", "14k Gold", "MF",
         "converter", 200, True, "Limited Edition", "Botanical green, nature series"),
        ("Manyo Series — Sakura (Cherry Blossom)", "Sailor", "Manyo", "14k Gold", "F",
         "converter", 200, True, "Limited Edition", "Pale pink, cherry blossom"),
        ("Manyo Series — Nekoyanagi (Willow)", "Sailor", "Manyo", "14k Gold", "M",
         "converter", 200, True, "Limited Edition", "Soft lavender, willow catkin"),
        ("Shikiori Series — Yozakura (Night Cherry)", "Sailor", "Shikiori", "14k Gold", "MF",
         "converter", 180, True, "Limited Edition", "Deep purple, moonlit blossoms"),
        ("Shikiori Series — Shimoyo (Frosty Night)", "Sailor", "Shikiori", "14k Gold", "F",
         "converter", 180, True, "Limited Edition", "Icy blue, winter frost"),
        ("Shikiori Series — Akanezora (Sunset Sky)", "Sailor", "Shikiori", "14k Gold", "M",
         "converter", 180, True, "Limited Edition", "Orange-red, evening sky"),
        # ── Vintage Grails ──────────────────────────────────────────────────
        ("Parker Duofold Senior (1920s, Jade Green)", "Parker", "Duofold", "14k Gold (Flex)", "M",
         "button", 800, False, "Exclusive", "1920s, Big Red era, jade celluloid"),
        ("Parker Duofold Senior (1920s, Mandarin Yellow)", "Parker", "Duofold", "14k Gold (Flex)", "F",
         "button", 1200, False, "Grail", "1920s, rarest color, mandarin yellow"),
        ("Parker Vacumatic Major (1940s, Golden Pearl)", "Parker", "Vacumatic", "14k Gold", "F",
         "vacuum", 500, False, "Exclusive", "1940s, golden pearl stripes, lock-down"),
        ("Sheaffer Balance Lifetime (1930s, Marine Green)", "Sheaffer", "Balance", "14k Gold (Flex)", "F",
         "lever", 400, False, "Exclusive", "1930s, marine green striated, flex nib"),
        ("Sheaffer Balance Admiral (1930s, Ebonized Pearl)", "Sheaffer", "Balance", "14k Gold", "M",
         "lever", 350, False, "Exclusive", "1930s, ebonized pearl celluloid"),
        ("Eversharp Doric (1st Gen, Kashmir Green)", "Eversharp", "Doric", "14k Gold (Flex)", "F",
         "lever", 600, False, "Grail", "1930s, Art Deco masterpiece, adjustable nib"),
        ("Eversharp Doric (2nd Gen, Jet Black)", "Eversharp", "Doric", "14k Gold", "M",
         "lever", 450, False, "Exclusive", "1930s, jet black, faceted barrel"),
        ("Conway Stewart 58 (1950s, Blue Herringbone)", "Conway Stewart", "58", "14k Gold", "F",
         "lever", 350, False, "Exclusive", "1950s, English, blue herringbone celluloid"),
        ("Conway Stewart 58 (1950s, Green Hatched)", "Conway Stewart", "58", "14k Gold", "M",
         "lever", 380, False, "Exclusive", "1950s, green cross-hatched pattern"),
        ("Mabie Todd Swan SF2 (1930s, Red Ripple)", "Mabie Todd", "Swan", "14k Gold (Flex)", "F",
         "lever", 500, False, "Exclusive", "1930s English, red hard rubber, flexible"),
        ("Parker 51 Aerometric (1950s, Burgundy)", "Parker", "51", "14k Gold", "F",
         "aerometric", 300, False, "Standard", "1950s, classic burgundy, chrome cap"),
        ("Parker 51 Aerometric (1950s, Forest Green)", "Parker", "51", "14k Gold", "M",
         "aerometric", 320, False, "Standard", "1950s, forest green, gold filled cap"),
        ("Parker 51 Vacumatic (1940s, Dove Grey)", "Parker", "51", "14k Gold", "F",
         "vacuum", 450, False, "Exclusive", "1940s, dove grey, aluminum cap"),
        # ── Japanese Artisan / Urushi ───────────────────────────────────────
        ("Platinum 3776 Century UEF (Ultra Extra Fine)", "Platinum", "3776 Century", "14k Gold", "UEF",
         "converter", 180, False, "Standard", "Ultra extra fine, finest nib available"),
        ("Platinum 3776 Century Nice Lavande", "Platinum", "3776 Century", "14k Gold", "F",
         "converter", 200, True, "Limited Edition", "French Riviera edition, lavender"),
        ("Platinum 3776 Century Fuji (Blue)", "Platinum", "3776 Century", "14k Gold", "M",
         "converter", 160, False, "Standard", "Mt. Fuji inspired blue resin"),
        ("Pilot Custom Urushi (Black)", "Pilot", "Custom Urushi", "18k Gold", "M",
         "converter", 800, False, "Standard", "Hand-applied urushi lacquer, FM nib"),
        ("Pilot Custom Urushi (Vermillion)", "Pilot", "Custom Urushi", "18k Gold", "B",
         "converter", 850, False, "Standard", "Red urushi, oversized, smooth broad"),
        ("Namiki Chinkin Pine Tree", "Pilot", "Namiki Chinkin", "18k Gold", "M",
         "converter", 2500, True, "Grail", "Chinkin technique, incised gold leaf"),
        ("Namiki Chinkin Dragonfly", "Pilot", "Namiki Chinkin", "18k Gold", "F",
         "converter", 2200, True, "Grail", "Chinkin engraving, dragonfly motif"),
        ("Namiki Emperor Mantis & Chrysanthemum", "Pilot", "Namiki Emperor", "18k Gold", "M",
         "converter", 5000, True, "Grail", "Maki-e masterpiece, museum quality"),
        ("Pilot Custom 845 (Black Urushi)", "Pilot", "Custom 845", "18k Gold", "M",
         "converter", 550, False, "Standard", "Urushi coated ebonite, #15 nib"),
        # ── Ink Bottles (Ink Collecting) ────────────────────────────────────
        ("Iroshizuku Kon-peki (Deep Azure)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, iconic blue, best-selling ink"),
        ("Iroshizuku Shin-kai (Deep Sea)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, blue-black, classic"),
        ("Iroshizuku Yama-budo (Crimson Glory Vine)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, magenta-purple, beloved"),
        ("Iroshizuku Tsuki-yo (Moonlight)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, teal blue, popular"),
        ("Iroshizuku Asa-gao (Morning Glory)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, vivid blue, bright"),
        ("Iroshizuku Murasaki-shikibu (Lady of the Court)", "Pilot", "Iroshizuku", "N/A", "N/A",
         "ink_bottle", 22, False, "Standard", "50ml, soft purple, gentle shade"),
        ("Diamine Oxblood (80ml)", "Diamine", "Standard", "N/A", "N/A",
         "ink_bottle", 8, False, "Standard", "80ml, deep red, best-seller"),
        ("Diamine Earl Grey (80ml)", "Diamine", "Standard", "N/A", "N/A",
         "ink_bottle", 8, False, "Standard", "80ml, warm grey, popular"),
        ("Diamine Aurora Borealis (Shimmering, 50ml)", "Diamine", "Shimmertastic", "N/A", "N/A",
         "ink_bottle", 12, True, "Limited Edition", "50ml, teal shimmer, gold particles"),
        ("Diamine Skull & Roses (Shimmering, 50ml)", "Diamine", "Shimmertastic", "N/A", "N/A",
         "ink_bottle", 12, True, "Limited Edition", "50ml, red shimmer, silver particles"),
        ("Diamine Writer's Blood (80ml)", "Diamine", "Standard", "N/A", "N/A",
         "ink_bottle", 8, False, "Standard", "80ml, dark crimson, cult classic"),
        ("Noodler's Heart of Darkness (4.5oz)", "Noodler's", "Standard", "N/A", "N/A",
         "ink_bottle", 15, False, "Standard", "4.5oz, bulletproof black, ultra dark"),
        ("Noodler's 54th Massachusetts (4.5oz)", "Noodler's", "Standard", "N/A", "N/A",
         "ink_bottle", 15, False, "Standard", "4.5oz, blue-black, bulletproof"),
        ("Noodler's Apache Sunset (3oz)", "Noodler's", "Standard", "N/A", "N/A",
         "ink_bottle", 14, False, "Standard", "3oz, orange to red shading, famous"),
        ("Noodler's Baystate Blue (3oz)", "Noodler's", "Standard", "N/A", "N/A",
         "ink_bottle", 14, False, "Standard", "3oz, vivid blue, stains everything"),
        ("Robert Oster Fire & Ice (50ml)", "Robert Oster", "Signature", "N/A", "N/A",
         "ink_bottle", 18, False, "Standard", "50ml, red-blue sheen, Australian"),
        ("Robert Oster African Gold (50ml)", "Robert Oster", "Signature", "N/A", "N/A",
         "ink_bottle", 18, False, "Standard", "50ml, warm golden brown"),
        ("Robert Oster Blue Moon (50ml)", "Robert Oster", "Signature", "N/A", "N/A",
         "ink_bottle", 18, False, "Standard", "50ml, deep blue, red sheen"),
        ("Sailor Shikiori Ink — Yonaga (Long Autumn Night)", "Sailor", "Shikiori Ink", "N/A", "N/A",
         "ink_bottle", 20, True, "Limited Edition", "20ml, seasonal blue-grey"),
        ("Sailor Shikiori Ink — Tokiwa-matsu (Evergreen Pine)", "Sailor", "Shikiori Ink", "N/A", "N/A",
         "ink_bottle", 20, True, "Limited Edition", "20ml, deep forest green"),
        ("Sailor Manyo Ink — Haha", "Sailor", "Manyo Ink", "N/A", "N/A",
         "ink_bottle", 22, True, "Limited Edition", "50ml, botanical green, matching pen"),
        ("Colorverse Cat (65ml + 15ml Set)", "Colorverse", "Astrophysics", "N/A", "N/A",
         "ink_bottle", 28, True, "Limited Edition", "65ml+15ml, purple, Schrödinger's Cat"),
        ("Colorverse Gravity Wave (65ml + 15ml Set)", "Colorverse", "Astrophysics", "N/A", "N/A",
         "ink_bottle", 28, True, "Limited Edition", "65ml+15ml, blue-black shimmer"),
        ("Troublemaker Ink — Petrichor (60ml)", "Troublemaker", "Standard", "N/A", "N/A",
         "ink_bottle", 15, False, "Standard", "60ml, earthy brown, Filipino artisan ink"),
        ("Troublemaker Ink — Milky Ocean (60ml)", "Troublemaker", "Standard", "N/A", "N/A",
         "ink_bottle", 15, False, "Standard", "60ml, turquoise, sheening, popular"),
        ("Kyo-Iro Soft Snow of Ohara (40ml)", "TAG", "Kyo-Iro", "N/A", "N/A",
         "ink_bottle", 20, False, "Standard", "40ml, warm grey, Kyoto-inspired"),
        ("Kyo no Oto Adzukiiro (40ml)", "TAG", "Kyo no Oto", "N/A", "N/A",
         "ink_bottle", 18, False, "Standard", "40ml, red bean color, artisan"),
        # ── More Popular Pens ───────────────────────────────────────────────
        ("Pilot Custom 74 (Transparent)", "Pilot", "Custom 74", "14k Gold", "SF",
         "converter", 170, False, "Standard", "Demonstrator, soft fine nib"),
        ("Pilot Custom Heritage 92 (Transparent Blue)", "Pilot", "Custom Heritage 92", "14k Gold", "FM",
         "piston", 200, False, "Standard", "Piston filler, blue demonstrator"),
        ("Pilot Capless (Matte Black)", "Pilot", "Vanishing Point", "18k Gold", "F",
         "converter", 200, False, "Standard", "Retractable matte finish, stealth look"),
        ("Sailor 1911S (Transparent)", "Sailor", "1911", "14k Gold", "MF",
         "converter", 200, False, "Standard", "Demonstrator, compact size"),
        ("Lamy 2000 Stainless Steel", "Lamy", "2000", "14k Gold", "M",
         "piston", 300, False, "Standard", "Brushed SS variant, heavier feel"),
        ("TWSBI Vac700R (Clear)", "TWSBI", "Vac700R", "Steel", "M",
         "vacuum", 75, False, "Standard", "Vacuum filler demonstrator, large capacity"),
        ("TWSBI Diamond 580ALR (Navy Blue)", "TWSBI", "Diamond 580", "Steel", "F",
         "piston", 70, True, "Limited Edition", "Aluminum rings, navy blue"),
        ("Kaweco Sport Iridescent Pearl", "Kaweco", "Sport", "Steel", "M",
         "converter", 30, True, "Limited Edition", "Iridescent finish, compact"),
        ("Kaweco AL Sport Anthracite", "Kaweco", "AL Sport", "Steel", "F",
         "converter", 85, False, "Standard", "Aluminum body, anodized dark grey"),
    ]
