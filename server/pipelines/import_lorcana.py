...
def _curated_seed_cards() -> list[dict]:
    ...
    notable_cards = [
        ...
        # ══════════════════════════════════════════════════════════════════
        # SET 6 — AZURITE SEA — Full set expansion
        # ══════════════════════════════════════════════════════════════════

        # ── AZU — Amber ink cards ──────────────────────────────────────────
        ("AZU", "Winnie the Pooh - Hunny Seeker", "Super Rare", "standard", 10.0),
        ("AZU", "Piglet - Tiny Hero", "Rare", "standard", 3.0),
        ("AZU", "Eeyore - Gloomy but Loyal", "Rare", "standard", 2.5),
        ("AZU", "Tigger - Wonderful Thing", "Rare", "standard", 3.0),
        ("AZU", "Rabbit - Garden Keeper", "Uncommon", "standard", 0.50),
        ("AZU", "Christopher Robin - Thoughtful Boy", "Super Rare", "standard", 8.0),
        ("AZU", "Owl - Self-Proclaimed Genius", "Uncommon", "standard", 0.30),
        ("AZU", "Kanga - Protective Mother", "Common", "standard", 0.15),
        ("AZU", "Roo - Adventurous Joey", "Common", "standard", 0.10),
        ("AZU", "Snow White - Wishing Well Singer", "Legendary", "standard", 26.0),
        ("AZU", "Doc - Leader of the Seven", "Super Rare", "standard", 9.0),
        ("AZU", "Grumpy - Reluctant Hero", "Rare", "standard", 3.5),
        ("AZU", "Happy - Cheerful Dwarf", "Common", "standard", 0.15),
        ("AZU", "Sleepy - Drowsy Dwarf", "Common", "standard", 0.10),
        ("AZU", "Bashful - Shy Dwarf", "Common", "standard", 0.10),
        ("AZU", "Sneezy - Allergic Dwarf", "Common", "standard", 0.10),
        ("AZU", "Dopey - Lovable Fool", "Uncommon", "standard", 0.30),

        # ── AZU — Amethyst ink cards ───────────────────────────────────────
        ("AZU", "Merlin - Archimedes' Companion", "Legendary", "standard", 24.0),
        ("AZU", "Madame Mim - Magnificent Marvelous", "Super Rare", "standard", 10.0),
        ("AZU", "Arthur - Young Squire", "Rare", "standard", 3.0),
        ("AZU", "Archimedes - Highly Educated Owl", "Uncommon", "standard", 0.30),
        ("AZU", "Fairy Godmother - Bibbidi Bobbidi", "Super Rare", "standard", 9.0),
        ("AZU", "Cinderella - Glass Slipper", "Legendary", "standard", 22.0),
        ("AZU", "Anastasia Tremaine - Eager Stepsister", "Common", "standard", 0.15),
        ("AZU", "Drizella Tremaine - Jealous Stepsister", "Common", "standard", 0.10),
        ("AZU", "Jaq - Resourceful Mouse", "Uncommon", "standard", 0.30),
        ("AZU", "Gus - Cheese Lover", "Common", "standard", 0.10),
        ("AZU", "Lucifer - Pampered Cat", "Rare", "standard", 2.5),
        ("AZU", "Prince Charming - Royal Dancer", "Rare", "standard", 3.0),

        # ── AZU — Emerald ink cards ────────────────────────────────────────
        ("AZU", "Peter Pan - Boy Who Wouldn't Grow Up", "Legendary", "standard", 26.0),
        ("AZU", "Captain Hook - Crocodile Fearer", "Super Rare", "standard", 10.0),
        ("AZU", "Tinker Bell - Pixie Dust Maker", "Super Rare", "standard", 12.0),
        ("AZU", "Wendy Darling - Storyteller", "Rare", "standard", 3.0),
        ("AZU", "John Darling - Gentleman Explorer", "Common", "standard", 0.15),
        ("AZU", "Michael Darling - Youngest Adventurer", "Common", "standard", 0.10),
        ("AZU", "Tick-Tock - Hungry Crocodile", "Uncommon", "standard", 0.50),
        ("AZU", "Smee - Loyal First Mate", "Uncommon", "standard", 0.30),
        ("AZU", "Lost Boys - Brave Band", "Rare", "standard", 2.5),
        ("AZU", "Tiger Lily - Proud Warrior", "Rare", "standard", 3.0),
        ("AZU", "Nana - Faithful Nursemaid", "Common", "standard", 0.10),

        # ── AZU — Ruby ink cards ───────────────────────────────────────────
        ("AZU", "Hercules - Son of Zeus", "Legendary", "standard", 24.0),
        ("AZU", "Megara - Independent Spirit", "Super Rare", "standard", 10.0),
        ("AZU", "Phil - Satyr Trainer", "Rare", "standard", 3.0),
        ("AZU", "Pegasus - Winged Stallion", "Rare", "standard", 3.5),
        ("AZU", "Pain - Minion of Hades", "Common", "standard", 0.10),
        ("AZU", "Panic - Minion of Hades", "Common", "standard", 0.10),
        ("AZU", "Zeus - King of the Gods", "Super Rare", "standard", 12.0),
        ("AZU", "Hera - Queen of Olympus", "Rare", "standard", 3.0),
        ("AZU", "Hydra - Multi-Headed Menace", "Super Rare", "standard", 9.0),
        ("AZU", "Calliope - Muse of Epic Poetry", "Common", "standard", 0.15),
        ("AZU", "Thalia - Muse of Comedy", "Common", "standard", 0.10),

        # ── AZU — Sapphire ink cards ───────────────────────────────────────
        ("AZU", "Pocahontas - Nature's Daughter", "Legendary", "standard", 22.0),
        ("AZU", "Meeko - Curious Raccoon", "Rare", "standard", 2.5),
        ("AZU", "Flit - Protective Hummingbird", "Common", "standard", 0.10),
        ("AZU", "Grandmother Willow - Ancient Advisor", "Super Rare", "standard", 9.0),
        ("AZU", "John Smith - Adventurous Explorer", "Rare", "standard", 3.0),
        ("AZU", "Thomas - Loyal Settler", "Common", "standard", 0.15),
        ("AZU", "Governor Ratcliffe - Greedy Governor", "Rare", "standard", 2.5),
        ("AZU", "Percy - Pampered Pug", "Uncommon", "standard", 0.30),
        ("AZU", "Nakoma - Trusted Friend", "Uncommon", "standard", 0.30),

        # ── AZU — Steel ink cards ──────────────────────────────────────────
        ("AZU", "Mulan - Dragon Warrior", "Legendary", "standard", 24.0),
        ("AZU", "Shan Yu - Leader of the Huns", "Super Rare", "standard", 10.0),
        ("AZU", "Khan - Loyal Steed", "Rare", "standard", 3.0),
        ("AZU", "Cri-Kee - Lucky Cricket", "Common", "standard", 0.10),
        ("AZU", "The Emperor - Wise Ruler", "Rare", "standard", 3.5),
        ("AZU", "Chi-Fu - Imperial Advisor", "Uncommon", "standard", 0.30),
        ("AZU", "Yao - Tough Soldier", "Common", "standard", 0.15),
        ("AZU", "Ling - Comic Soldier", "Common", "standard", 0.10),
        ("AZU", "Chien-Po - Gentle Giant", "Common", "standard", 0.10),
        ("AZU", "General Li - Commanding Officer", "Rare", "standard", 2.5),

        # ── AZU — Enchanted Rares (Set 6 additional) ──────────────────────
        ("AZU", "Snow White - Wishing Well Singer", "Legendary", "enchanted", 85.0),
        ("AZU", "Peter Pan - Boy Who Wouldn't Grow Up", "Legendary", "enchanted", 90.0),
        ("AZU", "Hercules - Son of Zeus", "Legendary", "enchanted", 80.0),
        ("AZU", "Pocahontas - Nature's Daughter", "Legendary", "enchanted", 75.0),
        ("AZU", "Mulan - Dragon Warrior", "Legendary", "enchanted", 85.0),
        ("AZU", "Merlin - Archimedes' Companion", "Legendary", "enchanted", 70.0),
        ("AZU", "Cinderella - Glass Slipper", "Legendary", "enchanted", 80.0),
        ("AZU", "Winnie the Pooh - Hunny Seeker", "Super Rare", "enchanted", 55.0),
        ("AZU", "Tinker Bell - Pixie Dust Maker", "Super Rare", "enchanted", 60.0),
        ("AZU", "Megara - Independent Spirit", "Super Rare", "enchanted", 50.0),
        ("AZU", "Zeus - King of the Gods", "Super Rare", "enchanted", 55.0),

        # ── AZU — Items and Actions ───────────────────────────────────────
        ("AZU", "Trident - Weapon of the Sea King", "Legendary", "standard", 18.0),
        ("AZU", "Dinglehopper - Human Artifact", "Rare", "standard", 3.0),
        ("AZU", "Snarfblatt - Musical Instrument", "Common", "standard", 0.15),
        ("AZU", "Grimoire - Book of Spells", "Super Rare", "standard", 8.0),
        ("AZU", "Sea Witch's Cauldron", "Rare", "standard", 3.5),
        ("AZU", "Flotsam's Net", "Uncommon", "standard", 0.50),
        ("AZU", "Coral Crown", "Rare", "standard", 2.5),
        ("AZU", "Tidal Wave", "Super Rare", "standard", 7.0),
        ("AZU", "Whirlpool", "Uncommon", "standard", 0.30),
        ("AZU", "Deep Sea Dive", "Common", "standard", 0.10),
        ("AZU", "Sunken Treasure", "Rare", "standard", 3.0),
        ("AZU", "Enchanted Rose - Timeless Symbol", "Super Rare", "standard", 10.0),
        ("AZU", "Poison Apple - Deadly Gift", "Rare", "standard", 3.5),
        ("AZU", "Glass Slipper - Perfect Fit", "Rare", "standard", 3.0),
        ("AZU", "Pixie Dust Vial", "Uncommon", "standard", 0.50),

        # ══════════════════════════════════════════════════════════════════
        # D23 EXCLUSIVE CARDS
        # ══════════════════════════════════════════════════════════════════
        ("PROMO", "Mickey Mouse - Sorcerer's Apprentice (D23 2024 Exclusive)", "Legendary", "promo", 450.0),
        ("PROMO", "Goofy - Movie Star (D23 2023 Exclusive)", "Legendary", "promo", 350.0),
        ("PROMO", "Donald Duck - Three Caballeros (D23 2024 Exclusive)", "Legendary", "promo", 300.0),
        ("PROMO", "Walt Disney - Dreamer (D23 Gold Member)", "Legendary", "promo", 900.0),
        ("PROMO", "Oswald - Lucky Rabbit (D23 Expo Exclusive)", "Legendary", "promo", 700.0),
        ("PROMO", "Steamboat Willie - Mickey (D23 2023)", "Legendary", "promo", 550.0),
        ("PROMO", "Fantasia Mickey - Conductor (D23 2024)", "Legendary", "promo", 400.0),
        ("PROMO", "Tron - Digital Warrior (D23 2024 Exclusive)", "Super Rare", "promo", 180.0),
        ("PROMO", "WALL-E - Lonely Robot (D23 2024 Exclusive)", "Super Rare", "promo", 150.0),
        ("PROMO", "Figment - Imaginative Dragon (D23 2024 Exclusive)", "Super Rare", "promo", 200.0),

        # ══════════════════════════════════════════════════════════════════
        # CHALLENGE DECK EXCLUSIVE CARDS
        # ══════════════════════════════════════════════════════════════════
        ("PROMO", "Gaston - Challenge Deck Champion", "Legendary", "promo", 85.0),
        ("PROMO", "Maleficent - Challenge Deck Boss", "Legendary", "promo", 100.0),
        ("PROMO", "Ursula - Challenge Deck Villain", "Legendary", "promo", 95.0),
        ("PROMO", "Jafar - Challenge Deck Sorcerer", "Legendary", "promo", 90.0),
        ("PROMO", "Captain Hook - Challenge Deck Pirate", "Legendary", "promo", 80.0),
        ("PROMO", "Hades - Challenge Deck Overlord", "Legendary", "promo", 110.0),
        ("PROMO", "Scar - Challenge Deck Usurper", "Legendary", "promo", 85.0),
        ("PROMO", "Cruella De Vil - Challenge Deck Diva", "Super Rare", "promo", 55.0),
        ("PROMO", "Lady Tremaine - Challenge Deck Matriarch", "Super Rare", "promo", 50.0),
        ("PROMO", "Mother Gothel - Challenge Deck Captor", "Super Rare", "promo", 55.0),
        ("PROMO", "Yzma - Challenge Deck Alchemist", "Super Rare", "promo", 45.0),
        ("PROMO", "Dr. Facilier - Challenge Deck Shadowman", "Super Rare", "promo", 50.0),

        # ══════════════════════════════════════════════════════════════════
        # ILLUMINATE VARIANT CARDS
        # ══════════════════════════════════════════════════════════════════
        ("TFC", "Elsa - Spirit of Winter (Illuminate)", "Legendary", "enchanted", 220.0),
        ("TFC", "Mickey Mouse - True Friend (Illuminate)", "Legendary", "enchanted", 165.0),
        ("TFC", "Robin Hood - Unrivaled Archer (Illuminate)", "Legendary", "enchanted", 250.0),
        ("ROF", "Belle - Strange but Special (Illuminate)", "Legendary", "enchanted", 190.0),
        ("ROF", "Lilo - Making a Wish (Illuminate)", "Legendary", "enchanted", 175.0),
        ...
        ("SSK", "Moana - Born Leader (Illuminate)", "Legendary", "enchanted", 100.0),
        ("SSK", "Stitch - Carefree Surfer (Illuminate)", "Legendary", "enchanted", 110.0),
        ("SSK", "Rapunzel - Letting Down Her Hair (Illuminate)", "Legendary", "enchanted", 120.0),
        ("AZU", "Ariel - Determined Collector (Illuminate)", "Legendary", "enchanted", 80.0),
        ("AZU", "Mufasa - Great King (Illuminate)", "Legendary", "enchanted", 90.0),
        ("AZU", "Snow White - Wishing Well Singer (Illuminate)", "Legendary", "enchanted", 95.0),

        # ══════════════════════════════════════════════════════════════════
        # ADDITIONAL PROMO & ORGANIZED PLAY CARDS
        # ══════════════════════════════════════════════════════════════════
        ("PROMO", "Ariel - Singing Mermaid (League Season 1)", "Super Rare", "promo", 40.0),
        ("PROMO", "Sebastian - Crab Conductor (League Season 2)", "Super Rare", "promo", 35.0),
        ("PROMO", "Flounder - Loyal Friend (League Season 3)", "Super Rare", "promo", 30.0),
        ("PROMO", "Scuttle - Expert on Humans (League Season 4)", "Super Rare", "promo", 30.0),
        ("PROMO", "Moana - Wayfinder (Nationals 2025)", "Legendary", "promo", 280.0),
        ("PROMO", "Stitch - New Dog (Regionals 2025 Top 4)", "Legendary", "promo", 200.0),
        ("PROMO", "Elsa - Ice Queen (Set Championship 2025)", "Legendary", "promo", 160.0),
        ("PROMO", "Mulan - Imperial Guardian (Store Championship 2025)", "Legendary", "promo", 120.0),
        ("PROMO", "Rapunzel - Dream Chaser (Prerelease AZU)", "Legendary", "promo", 70.0),
        ("PROMO", "Belle - Inventive Engineer (Prerelease AZU)", "Legendary", "promo", 65.0),
        ("PROMO", "Simba - Brave Lion (Winner Promo 2025)", "Legendary", "promo", 100.0),
        ("PROMO", "Hercules - Son of Zeus (Gen Con 2025)", "Legendary", "promo", 180.0),
        ("PROMO", "Pocahontas - Nature's Daughter (Convention Promo)", "Legendary", "promo", 90.0),
        ("PROMO", "Peter Pan - Boy Who Wouldn't Grow Up (Launch Promo)", "Legendary", "promo", 110.0),

        # ── Ink-Specific League Promos ─────────────────────────────────────
        ("PROMO", "Amber Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),
        ("PROMO", "Amethyst Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),
        ("PROMO", "Emerald Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),
        ("PROMO", "Ruby Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),
        ("PROMO", "Sapphire Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),
        ("PROMO", "Steel Ink League Promo Card - Spring 2025", "Super Rare", "promo", 25.0),

        # ══════════════════════════════════════════════════════════════════
        # SEALED PRODUCT — SET 6 ADDITIONAL
        # ══════════════════════════════════════════════════════════════════
        ("AZU", "Azurite Sea Booster Display Case (4 boxes)", "Sealed Product", "sealed", 400.0),
        ("AZU", "Azurite Sea Starter Deck Ruby/Amber", "Sealed Product", "sealed", 15.0),
        ("AZU", "Azurite Sea Starter Deck Amethyst/Steel", "Sealed Product", "sealed", 15.0),
        ("AZU", "Azurite Sea Deep Dive Bundle", "Sealed Product", "sealed", 45.0),
        ("AZU", "Azurite Sea Collector's Bundle", "Sealed Product", "sealed", 65.0),

        # ── Sealed Product — Multi-Set Bundles ─────────────────────────────
        ("PROMO", "Lorcana Complete Set 1-3 Booster Box Bundle", "Sealed Product", "sealed", 600.0),
        ("PROMO", "Lorcana Complete Set 4-6 Booster Box Bundle", "Sealed Product", "sealed", 300.0),
        ("PROMO", "Lorcana Illumineer's Quest Gift Collection", "Sealed Product", "sealed", 80.0),
        ("PROMO", "Lorcana Starter Bundle - All 6 Sets", "Sealed Product", "sealed", 120.0),

        # ══════════════════════════════════════════════════════════════════
        # ADDITIONAL ACCESSORIES
        # ══════════════════════════════════════════════════════════════════
        ("PROMO", "Official Playmat - Azurite Sea Key Art", "Accessory", "accessory", 35.0),
        ("PROMO", "Official Playmat - Pocahontas Nature", "Accessory", "accessory", 35.0),
        ("PROMO", "Official Playmat - Peter Pan Neverland", "Accessory", "accessory", 35.0),
        ("PROMO", "Official Playmat - Hercules Olympus", "Accessory", "accessory", 35.0),
        ("PROMO", "Official Playmat - Snow White Forest", "Accessory", "accessory", 35.0),
        ("PROMO", "Tournament Playmat - Set Championship 2025", "Accessory", "accessory", 80.0),
        ("PROMO", "Tournament Playmat - Regionals 2025", "Accessory", "accessory", 60.0),
        ("PROMO", "Tournament Playmat - Nationals 2025", "Accessory", "accessory", 100.0),
        ("PROMO", "Official Deck Box - Snow White Apple", "Accessory", "accessory", 15.0),
        ("PROMO", "Official Deck Box - Peter Pan Shadow", "Accessory", "accessory", 15.0),
        ("PROMO", "Official Deck Box - Hercules Lightning", "Accessory", "accessory", 15.0),
        ("PROMO", "Official Deck Box - Pocahontas Wind", "Accessory", "accessory", 15.0),
        ("PROMO", "Official Card Sleeves - Snow White (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Card Sleeves - Peter Pan (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Card Sleeves - Hercules (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Card Sleeves - Pocahontas (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Card Sleeves - Mulan (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Card Sleeves - Cinderella (65 count)", "Accessory", "accessory", 11.0),
        ("PROMO", "Official Storage Box - Lorcana Logo", "Accessory", "accessory", 25.0),
        ("PROMO", "Official Portfolio Binder - 9 Pocket", "Accessory", "accessory", 20.0),
        ("PROMO", "Official Portfolio Binder - 4 Pocket", "Accessory", "accessory", 14.0),

        # ══════════════════════════════════════════════════════════════════
        # EARLIER SETS — MISSING UNCOMMON / RARE / SR FILL
        # ══════════════════════════════════════════════════════════════════

        # ── TFC — Missing character cards ──────────────────────────────────
        ("TFC", "Nala - Fierce Friend", "Rare", "standard", 3.0),
        ("TFC", "Timon - Grub Finder", "Common", "standard", 0.15),
        ("TFC", "Pumbaa - Carefree Warthog", "Common", "standard", 0.10),
        ("TFC", "Rafiki - Wise Baboon", "Rare", "standard", 2.5),
        ("TFC", "Zazu - Persistent Adviser", "Uncommon", "standard", 0.30),
        ("TFC", "Mufasa - Ghost of the Past", "Legendary", "standard", 20.0),
        ("TFC", "Merlin - Goat", "Super Rare", "standard", 8.0),
        ("TFC", "Fairy Godmother - Pure Heart", "Super Rare", "standard", 7.0),
        ("TFC", "Genie - Powers Unleashed", "Super Rare", "standard", 10.0),
        ("TFC", "Abu - Mischievous Monkey", "Uncommon", "standard", 0.30),
        ("TFC", "Iago - Loud-Mouthed Parrot", "Uncommon", "standard", 0.30),
        ("TFC", "Jasmine - Disguised", "Rare", "standard", 3.0),
        ("TFC", "Sultan - Kind Ruler", "Common", "standard", 0.15),
        ("TFC", "Chip - Enchanted Boy", "Common", "standard", 0.10),
        ("TFC", "Mrs. Potts - Warm Teapot", "Uncommon", "standard", 0.30),
        ("TFC", "Wardrobe - Belle's Confidante", "Common", "standard", 0.10),
        ("TFC", "Dory - Forgetful Fish", "Super Rare", "standard", 9.0),
        ("TFC", "Nemo - Curious Clownfish", "Rare", "standard", 3.0),
        ("TFC", "Marlin - Overprotective Father", "Rare", "standard", 2.5),

        # ── ROF — Missing character cards ──────────────────────────────────
        ("ROF", "Rapunzel - Adventurous Spirit", "Rare", "standard", 3.5),
        ("ROF", "Pascal - Sun Drop Guardian", "Common", "standard", 0.15),
        ("ROF", "Maximus - Royal Guard", "Uncommon", "standard", 0.30),
        ("ROF", "Mother Gothel - Vain Enchantress", "Super Rare", "standard", 9.0),
        ("ROF", "Snow White - Lost Princess", "Legendary", "standard", 22.0),
        ("ROF", "Dopey - Sweet and Silly", "Common", "standard", 0.10),
        ("ROF", "Grumpy - Short-Tempered Miner", "Uncommon", "standard", 0.30),
        ("ROF", "Doc - Diamond Miner", "Rare", "standard", 2.5),
        ("ROF", "Evil Queen - Disguised Peddler", "Super Rare", "standard", 10.0),
        ("ROF", "Magic Mirror - All Knowing", "Rare", "standard", 3.5),
        ("ROF", "Huntsman - Reluctant Enforcer", "Rare", "standard", 2.5),
        ("ROF", "Nala - Loyal Lioness", "Rare", "standard", 3.0),
        ("ROF", "Timon - Hyena Distracter", "Common", "standard", 0.15),
        ("ROF", "Pumbaa - Bug Connoisseur", "Common", "standard", 0.10),
        ("ROF", "Rafiki - Storyteller", "Rare", "standard", 2.5),
        ("ROF", "Zazu - Majordomo", "Uncommon", "standard", 0.30),
        ("ROF", "Shenzi - Hyena Leader", "Rare", "standard", 2.5),

        # ── ITI — Missing character cards ──────────────────────────────────
        ("ITI", "Moana - Voyager", "Legendary", "standard", 24.0),
        ("ITI", "Maui - Shapeshifter", "Legendary", "standard", 22.0),
        ("ITI", "Tamatoa - Shiny Crab", "Super Rare", "standard", 10.0),
        ("ITI", "Te Fiti - Island Goddess", "Legendary", "standard", 20.0),
        ("ITI", "Heihei - Boat Snack", "Common", "standard", 0.10),
        ("ITI", "Pua - Loyal Pig", "Uncommon", "standard", 0.30),
        ("ITI", "Gramma Tala - Spirit Guide", "Rare", "standard", 3.0),
        ("ITI", "Chief Tui - Protective Father", "Uncommon", "standard", 0.30),
        ("ITI", "Sina - Encouraging Mother", "Common", "standard", 0.10),
        ("ITI", "Kakamora - Coconut Pirates", "Common", "standard", 0.15),
        ("ITI", "Nani - Protective Sister", "Super Rare", "standard", 8.0),
        ("ITI", "Lilo - Alien Expert", "Rare", "standard", 3.5),
        ("ITI", "Jumba - Evil Genius", "Rare", "standard", 3.0),
        ("ITI", "Pleakley - Earth Expert", "Uncommon", "standard", 0.30),
        ("ITI", "Gantu - Galactic Federation Captain", "Super Rare", "standard", 7.0),

        # ── URR — Missing character cards ──────────────────────────────────
        ("URR", "Vanessa - Ursula's Disguise", "Super Rare", "standard", 10.0),
        ("URR", "Grimsby - Royal Advisor", "Common", "standard", 0.15),
        ("URR", "Max - Prince Eric's Dog", "Common", "standard", 0.10),
        ("URR", "Carlotta - Palace Maid", "Uncommon", "standard", 0.30),
        ("URR", "Chef Louis - Fish Hater", "Uncommon", "standard", 0.30),
        ("URR", "Prince Eric - Flute Player", "Rare", "standard", 3.0),
        ("URR", "Ariel - Land Explorer", "Legendary", "standard", 24.0),
        ("URR", "Triton - Protective Father", "Super Rare", "standard", 12.0),
        ("URR", "Attina - Eldest Sister", "Uncommon", "standard", 0.30),
        ("URR", "Andrina - Playful Sister", "Common", "standard", 0.10),
        ("URR", "Arista - Musical Sister", "Common", "standard", 0.10),
        ("URR", "Aquata - Responsible Sister", "Common", "standard", 0.10),
        ("URR", "Adella - Romantic Sister", "Common", "standard", 0.10),
        ("URR", "Alana - Fashionable Sister", "Common", "standard", 0.10),
        ("URR", "Flotsam - Ursula's Spy", "Uncommon", "standard", 0.50),
        ("URR", "Jetsam - Ursula's Spy", "Uncommon", "standard", 0.50),

        # ── SSK — Missing character cards ──────────────────────────────────
        ("SSK", "Pinocchio - Real Boy", "Super Rare", "standard", 9.0),
        ("SSK", "Jiminy Cricket - Official Conscience", "Super Rare", "standard", 10.0),
        ("SSK", "Geppetto - Loving Father", "Rare", "standard", 3.0),
        ("SSK", "Figaro - Pampered Kitten", "Common", "standard", 0.15),
        ("SSK", "Cleo - Goldfish Beauty", "Common", "standard", 0.10),
        ("SSK", "Blue Fairy - Kind Enchantress", "Legendary", "standard", 20.0),
        ("SSK", "Honest John - Sly Fox", "Rare", "standard", 3.0),
        ("SSK", "Gideon - Silent Partner", "Common", "standard", 0.10),
        ("SSK", "Stromboli - Puppet Master", "Rare", "standard", 2.5),
        ("SSK", "Monstro - Terrible Whale", "Super Rare", "standard", 8.0),
        ("SSK", "Lampwick - Pleasure Island Regular", "Uncommon", "standard", 0.30),
        ("SSK", "Coachman - Wicked Driver", "Rare", "standard", 3.0),
        ("SSK", "Dumbo - Flying Elephant", "Super Rare", "standard", 10.0),
        ("SSK", "Timothy Mouse - Big Top Friend", "Rare", "standard", 3.0),
        ("SSK", "Mrs. Jumbo - Devoted Mother", "Rare", "standard", 2.5),

        # ── TFC/ROF/ITI — Missing Items and Actions ────────────────────────
        ("TFC", "Lantern - Festival Light", "Uncommon", "standard", 0.30),
        ("TFC", "Frying Pan - Flynn's Weapon", "Common", "standard", 0.10),
        ("TFC", "Lucky Dime - Scrooge's Treasure", "Rare", "standard", 4.0),
        ("TFC", "Pan Flute - Lost Boys Music", "Uncommon", "standard", 0.30),
        ("TFC", "Triton's Trident", "Rare", "standard", 3.5),
        ("ROF", "Sorcerer's Hat - Unlimited Power", "Super Rare", "standard", 8.0),
        ("ROF", "Be Prepared", "Rare", "standard", 3.5),
        ("ROF", "Part of Your World", "Rare", "standard", 3.0),
        ...
        # ── URR/SSK — Missing Items and Actions ────────────────────────────
        ("URR", "Ursula's Contract", "Super Rare", "standard", 10.0),
        ("URR", "Ursula's Necklace - Voice Stealer", "Rare", "standard", 3.5),
        ("URR", "Ariel's Grotto", "Rare", "standard", 3.0),
        ("URR", "Kiss the Girl", "Uncommon", "standard", 0.50),
        ("URR", "Under the Sea", "Uncommon", "standard", 0.30),
        ("URR", "Poor Unfortunate Souls", "Super Rare", "standard", 8.0),
        ("SSK", "Zero to Hero", "Rare", "standard", 3.0),
        ("SSK", "Go the Distance", "Uncommon", "standard", 0.50),
        ("SSK", "I Won't Say I'm in Love", "Uncommon", "standard", 0.30),
        ("SSK", "Colors of the Wind", "Rare", "standard", 3.5),
        ("SSK", "Just Around the Riverbend", "Uncommon", "standard", 0.30),
        ("SSK", "Reflection", "Rare", "standard", 3.0),
        ("SSK", "I'll Make a Man Out of You", "Super Rare", "standard", 8.0),
        ("SSK", "Be Our Guest", "Super Rare", "standard", 7.0),
    ]
