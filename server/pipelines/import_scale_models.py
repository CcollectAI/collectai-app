...
def get_curated_catalog() -> list[dict]:
    ...
    kits = [
        ...
        # === ROUND 8 — 145 new items ===

        # Aircraft — 1:48 WWII (+20)
        ("Tamiya", "Aircraft", "P-51D Mustang (8th AF)", "1/48", "mid", 48),
        ("Tamiya", "Aircraft", "Spitfire Mk.Vb (Trop)", "1/48", "mid", 44),
        ("Tamiya", "Aircraft", "Bf 109 G-14", "1/48", "mid", 42),
        ("Tamiya", "Aircraft", "A6M5 Zero (Zeke) Model 52", "1/48", "mid", 40),
        ("Tamiya", "Aircraft", "F4U-1D Corsair w/ Moto-Tug", "1/48", "mid", 55),
        ("Tamiya", "Aircraft", "P-38J Lightning", "1/48", "high", 80),
        ("Tamiya", "Aircraft", "P-47D Thunderbolt Bubbletop", "1/48", "mid", 52),
        ("Hasegawa", "Aircraft", "F-14A Tomcat (Low Visibility)", "1/48", "mid", 55),
        ("Hasegawa", "Aircraft", "F-15E Strike Eagle (Dual Role)", "1/48", "mid", 58),
        ("Hasegawa", "Aircraft", "Su-33 Flanker-D", "1/48", "high", 85),
        ("Eduard", "Aircraft", "Fw 190 A-5 ProfiPACK", "1/48", "mid", 50),
        ("Eduard", "Aircraft", "Bf 109 G-10 Erla ProfiPACK", "1/48", "mid", 48),
        ("Wingnut Wings", "Aircraft", "Albatros D.Va (Jasta 5)", "1/32", "grail", 230),
        ("Wingnut Wings", "Aircraft", "SE.5a (Hisso)", "1/32", "grail", 210),
        ("Wingnut Wings", "Aircraft", "Sopwith F.1 Camel Clerget", "1/32", "grail", 200),
        ("Wingnut Wings", "Aircraft", "Roland C.II", "1/32", "grail", 250),
        ("Tamiya", "Aircraft", "Heinkel He 162 A-2 Salamander", "1/48", "mid", 38),
        ("Tamiya", "Aircraft", "Douglas A-1J Skyraider (Navy)", "1/48", "mid", 65),
        ("Hasegawa", "Aircraft", "Bf 109 K-4 (Late War Fighter)", "1/48", "mid", 42),
        ("Eduard", "Aircraft", "P-39Q Airacobra ProfiPACK", "1/48", "mid", 46),

        # Aircraft — 1:72 Jets (+10)
        ("Academy", "Aircraft", "F-22A Raptor (USAF Stealth)", "1/72", "standard", 30),
        ("Hasegawa", "Aircraft", "F-35B Lightning II (STOVL)", "1/72", "mid", 35),
        ("Tamiya", "Aircraft", "Su-57 Felon", "1/72", "mid", 42),
        ("Revell", "Aircraft", "Eurofighter Typhoon Twin-Seater", "1/72", "standard", 28),
        ("Hasegawa", "Aircraft", "VF-1S Valkyrie (Macross) Hikaru", "1/72", "high", 85),
        ("Hasegawa", "Aircraft", "VF-1J Valkyrie (Macross) Max", "1/72", "high", 80),
        ("Hasegawa", "Aircraft", "VF-1A Valkyrie (Macross) Cannon Fodder", "1/72", "mid", 65),
        ("GWH (Great Wall Hobby)", "Aircraft", "MiG-29 Fulcrum-A (9-12)", "1/72", "mid", 38),
        ("GWH (Great Wall Hobby)", "Aircraft", "F-15I Ra'am (Israeli AF)", "1/48", "high", 85),
        ("Tamiya", "Aircraft", "Lockheed Martin F-35A Lightning II", "1/72", "mid", 35),

        # Armor — 1:35 (+20)
        ("Tamiya", "Armor", "Tiger I Early Production (Tunisia)", "1/35", "mid", 58),
        ("Tamiya", "Armor", "Panther Ausf.A", "1/35", "mid", 55),
        ("Tamiya", "Armor", "M4A1 Sherman (76mm)", "1/35", "mid", 48),
        ("Tamiya", "Armor", "T-34/76 Model 1943 (ChTZ)", "1/35", "mid", 42),
        ("Tamiya", "Armor", "King Tiger (Henschel Turret) w/ Zimmerit", "1/35", "mid", 65),
        ("Tamiya", "Armor", "StuG III Ausf.B", "1/35", "mid", 45),
        ("Meng Model", "Armor", "Leopard 2A7 NATO MBT", "1/35", "high", 88),
        ("Meng Model", "Armor", "T-90A Russian MBT w/ TBS-86", "1/35", "mid", 68),
        ("RFM (Rye Field Model)", "Armor", "Sd.Kfz. 251/1 Ausf.D w/ Full Interior", "1/35", "high", 90),
        ("RFM (Rye Field Model)", "Armor", "Tiger I Early Production w/ Full Interior (Wittmann)", "1/35", "high", 95),
        ("RFM (Rye Field Model)", "Armor", "Panther Ausf.G w/ Interior & Cut-Away Parts", "1/35", "grail", 110),
        ("Takom", "Armor", "Mk.V Male WWI Heavy Tank", "1/35", "mid", 58),
        ("Takom", "Armor", "Maus V2 Super Heavy Tank", "1/35", "high", 80),
        ("Takom", "Armor", "Renault FT-17 Riveted Turret", "1/35", "mid", 42),
        ("Dragon", "Armor", "Tiger I Late Production (Zimmerit)", "1/35", "high", 78),
        ("Dragon", "Armor", "Panther Ausf.F w/ Night Sight", "1/35", "high", 85),
        ("Dragon", "Armor", "StuG III Ausf.G (Final Production)", "1/35", "mid", 65),
        ("Dragon", "Armor", "Jagdpanther Ausf.G1", "1/35", "high", 75),
        ("Dragon", "Armor", "Pz.Kpfw.IV Ausf.H (Late Production)", "1/35", "mid", 55),

        # Ships — 1:350 / 1:700 (+15)
        ("Tamiya", "Ship", "Yamato (Premium Edition 2020 Reissue)", "1/350", "grail", 220),
        ("Tamiya", "Ship", "USS Missouri BB-63 (Circa 1991)", "1/350", "high", 140),
        ("Tamiya", "Ship", "USS Enterprise CV-6 (1942)", "1/350", "high", 135),
        ("Trumpeter", "Ship", "Bismarck (German BB)", "1/350", "high", 125),
        ("Trumpeter", "Ship", "Tirpitz (German BB) (Full Hull)", "1/350", "high", 130),
        ("Trumpeter", "Ship", "HMS Hood (1941)", "1/350", "high", 120),
        ("Pontos", "Ship", "Yamato Detail-Up Set (Full)", "1/350", "grail", 300),
        ("Pontos", "Ship", "Bismarck Detail-Up Set", "1/350", "high", 180),
        ("Tamiya", "Ship", "IJN Shokaku Aircraft Carrier", "1/700", "mid", 35),
        ("Tamiya", "Ship", "IJN Mogami Heavy Cruiser", "1/700", "standard", 28),
        ("Fujimi", "Ship", "IJN Kaga Aircraft Carrier", "1/700", "mid", 40),
        ("Tamiya", "Ship", "USS Yorktown CV-5", "1/700", "standard", 30),
        ("Tamiya", "Ship", "HMS Prince of Wales", "1/700", "standard", 28),
        ("Trumpeter", "Ship", "USS Hornet CV-8", "1/350", "high", 140),
        ("Fujimi", "Ship", "IJN Zuikaku Aircraft Carrier", "1/350", "high", 145),

        # Cars — 1:24 (+15)
        ("Tamiya", "Car", "Nissan Skyline GT-R (R34) V-Spec II", "1/24", "mid", 38),
        ("Tamiya", "Car", "Toyota Supra (A80)", "1/24", "mid", 35),
        ("Tamiya", "Car", "Honda NSX (NA1)", "1/24", "mid", 38),
        ("Tamiya", "Car", "Ferrari Enzo", "1/24", "mid", 50),
        ("Tamiya", "Car", "Porsche 911 (964) Carrera 2", "1/24", "mid", 42),
        ("Hasegawa", "Car", "Mitsubishi Galant VR-4 Rally", "1/24", "mid", 52),
        ("Hasegawa", "Car", "Subaru Impreza WRC 1997 Safari Rally", "1/24", "mid", 55),
        ("Revell", "Car", "Ford Mustang Boss 429 1969", "1/24", "standard", 32),
        ("Revell", "Car", "Chevrolet Camaro ZL1 2024", "1/24", "standard", 30),
        ("Fujimi", "Car", "Honda Civic Type R (EK9)", "1/24", "standard", 28),
        ("Fujimi", "Car", "Nissan Silvia S15 Spec-R", "1/24", "standard", 30),
        ("Aoshima", "Car", "Nissan GT-R (R35) Liberty Walk LB Works", "1/24", "mid", 42),
        ("Aoshima", "Car", "Toyota AE86 Sprinter Trueno Rocket Bunny", "1/24", "mid", 40),
        ("Aoshima", "Car", "Mazda RX-7 (FD3S) RE Amemiya", "1/24", "mid", 38),

        # Figures — 1:35 (+10)
        ("MasterBox", "Figure", "US Marines Tarawa 1943 (4 Figures)", "1/35", "standard", 18),
        ("MasterBox", "Figure", "German Panzergrenadiers Kharkov 1943", "1/35", "standard", 20),
        ("Alpine Miniatures", "Figure", "WSS Panzer Commander Resin", "1/35", "mid", 48),
        ("Alpine Miniatures", "Figure", "US Armored Infantry Resin", "1/35", "mid", 45),
        ("MiniArt", "Figure", "Soviet Infantry at Rest (WWII)", "1/35", "standard", 16),
        ("MiniArt", "Figure", "German Tank Crew Normandy 1944", "1/35", "standard", 18),
        ("Tamiya", "Figure", "German Assault Troops (8 Figures)", "1/35", "standard", 18),
        ("Tamiya", "Figure", "US Modern Infantry (Iraq)", "1/35", "standard", 16),
        ("ICM", "Figure", "WWII German Paratroopers (4 Figures)", "1/35", "standard", 18),
        ("ICM", "Figure", "Soviet Sappers 1943-1945", "1/35", "standard", 16),

        # Sci-Fi / Space (+15)
        ("Bandai", "Sci-fi", "Star Wars Star Destroyer (Lighting Model)", "1/5000", "high", 120),
        ("Bandai", "Sci-fi", "Star Wars X-Wing Starfighter (Moving Edition)", "1/48", "high", 90),
        ("Bandai", "Sci-fi", "Star Wars Millennium Falcon (Perfect Grade)", "1/72", "grail", 350),
        ("Bandai", "Sci-fi", "Star Wars AT-AT (Empire Strikes Back)", "1/144", "mid", 60),
        ("Bandai", "Sci-fi", "Star Wars Slave I (Boba Fett)", "1/144", "mid", 52),
        ("Moebius", "Sci-fi", "Jupiter 2 (Lost in Space)", "1/35", "high", 95),
        ("Pegasus", "Sci-fi", "War of the Worlds (2005) Tripod", "1/144", "mid", 55),
        ("Hasegawa", "Aircraft", "Egg Plane P-51 Mustang (SD Cute)", "SD", "standard", 15),
        ("Hasegawa", "Aircraft", "Egg Plane F-14 Tomcat (SD Cute)", "SD", "standard", 15),
        ("Revell", "Sci-fi", "Space Shuttle Discovery w/ Booster Rockets", "1/144", "mid", 55),
        ("Airfix", "Sci-fi", "Apollo Saturn V Rocket", "1/144", "high", 80),
        ("Bandai", "Sci-fi", "Star Wars Razor Crest (Mandalorian)", "1/72", "mid", 48),
        ("AMT", "Sci-fi", "Star Trek USS Enterprise NCC-1701 (Refit)", "1/537", "mid", 42),

        # Tools & Paints (+10)
        ("Iwata", "Accessories", "Neo CN Gravity-Feed Airbrush", "N/A", "mid", 75),
        ("Iwata", "Accessories", "Eclipse HP-CS Gravity-Feed Airbrush", "N/A", "high", 145),
        ("Badger", "Accessories", "Patriot 105 Airbrush", "N/A", "mid", 65),
        ("Mr. Hobby", "Accessories", "Mr. Color Lacquer Paint Set (18 colors)", "N/A", "standard", 35),
        ("Tamiya", "Accessories", "Tamiya Acrylic Paint Set (23 colors)", "N/A", "standard", 30),
        ("AK Interactive", "Accessories", "Weathering Pencils Set (Basics)", "N/A", "standard", 22),
        ("Ammo by Mig", "Accessories", "Streaking & Grime Effects Set", "N/A", "standard", 25),
        ("Microscale", "Accessories", "Micro Sol & Micro Set Decal Solution Pair", "N/A", "standard", 12),
        ("Tamiya", "Accessories", "Detail Brush Set (4 sizes)", "N/A", "standard", 15),
        ("AK Interactive", "Accessories", "Aircraft Weathering Set (6 products)", "N/A", "mid", 35),

        # Diorama Supplies (+10)
        ("Vallejo", "Diorama", "Diorama Effects: European Mud Thick", "N/A", "standard", 10),
        ("Vallejo", "Diorama", "Diorama Effects: Atlantic Sand Texture", "N/A", "standard", 10),
        ("AK Interactive", "Diorama", "Terrains: Dry Ground Texture", "N/A", "standard", 12),
        ("AK Interactive", "Diorama", "Terrains: Snow Microballoons", "N/A", "standard", 12),
        ("Army Painter", "Diorama", "Static Grass Applicator", "N/A", "mid", 45),
        ("Vallejo", "Diorama", "Still Water Resin Effect (200ml)", "N/A", "standard", 15),
        ("AK Interactive", "Diorama", "Resin Water 2-Component (180ml)", "N/A", "standard", 18),
        ("Eduard", "Accessories", "Photo-Etch Bending Tool (PE Small)", "N/A", "standard", 22),
        ("Voyager Model", "Accessories", "Universal Photo-Etch Fender Set 1/35", "1/35", "standard", 25),
        ("Tamiya", "Diorama", "Plastic Card Sheet Set (0.3-1.2mm)", "N/A", "standard", 8),

        # ── 1:32 Aircraft ───────────────────────────────────────────────
        ("Revell", "Aircraft", "P-51D Mustang (Early Version)", "1/32", "high", 85),
        ("Revell", "Aircraft", "Bf 109 G-6 (Late)", "1/32", "high", 80),
        ("Trumpeter", "Aircraft", "Fw 190 D-9 (Langnasen-Dora)", "1/32", "high", 90),
        ("Trumpeter", "Aircraft", "F-14D Super Tomcat", "1/32", "grail", 180),
        ("Trumpeter", "Aircraft", "F-4E Phantom II", "1/32", "grail", 160),
        ("Trumpeter", "Aircraft", "A-10A Thunderbolt II (Warthog)", "1/32", "grail", 200),
        ("Revell", "Aircraft", "Spitfire Mk.IIa", "1/32", "high", 75),
        ("Tamiya", "Aircraft", "De Havilland Mosquito FB Mk.VI", "1/32", "grail", 155),
        ("Tamiya", "Aircraft", "Supermarine Spitfire Mk.IXc", "1/32", "high", 95),
        ("Revell", "Aircraft", "Lancaster B.III (Dambusters)", "1/32", "grail", 250),
        ("Trumpeter", "Aircraft", "SBD-3 Dauntless", "1/32", "high", 85),
        ("Revell", "Aircraft", "P-47M Thunderbolt", "1/32", "high", 80),
        ("Hasegawa", "Aircraft", "Bf 109 K-4", "1/32", "high", 90),
        ("Trumpeter", "Aircraft", "P-38L Lightning", "1/32", "grail", 170),
        ("Revell", "Aircraft", "Heinkel He 111 H-6", "1/32", "grail", 200),

        # ── Modern Armor ────────────────────────────────────────────────
        ("Rye Field", "Armor", "M1A2 SEP Abrams TUSK I/II", "1/35", "high", 85),
        ("Meng", "Armor", "Leopard 2A7+ (German MBT)", "1/35", "high", 90),
        ("Trumpeter", "Armor", "Challenger 2 (Desertised)", "1/35", "high", 80),
        ("Meng", "Armor", "Merkava Mk.IV/M w/ Trophy APS", "1/35", "high", 85),
        ("Tamiya", "Armor", "JGSDF Type 10 MBT", "1/35", "mid", 65),
        ("Trumpeter", "Armor", "T-14 Armata MBT (Russian)", "1/35", "high", 80),
        ("Academy", "Armor", "K2 Black Panther (ROK Army)", "1/35", "mid", 55),
        ("BAE Systems / Takom", "Armor", "CV90 Mk.IV IFV", "1/35", "mid", 60),
        ("Tamiya", "Armor", "M2A3 Bradley (w/ ERA)", "1/35", "mid", 65),
        ("Trumpeter", "Armor", "M1126 Stryker ICV", "1/35", "mid", 55),
        ("Meng", "Armor", "PLA ZTQ-15 Light Tank", "1/35", "mid", 60),
        ("Rye Field", "Armor", "Panther Ausf.G (Full Interior)", "1/35", "high", 95),
        ("Takom", "Armor", "Leopard 2A6 (w/ Full Interior)", "1/35", "high", 100),
        ("Meng", "Armor", "T-72B3 (Russian MBT, 2022 Mod.)", "1/35", "mid", 65),
        ("Trumpeter", "Armor", "Leclerc MBT (Series XXI)", "1/35", "high", 80),

        # ── Figurine Painting — 75mm/90mm Busts & Figures ───────────────
        ("FeR Miniatures", "Figure", "Roman Centurion (Bust, 1/12)", "1/12", "high", 85),
        ("FeR Miniatures", "Figure", "Viking Chieftain (Bust, 1/10)", "1/10", "high", 90),
        ("Nutsplanet", "Figure", "Post-Apocalyptic Survivor (75mm)", "75mm", "mid", 55),
        ("Nutsplanet", "Figure", "Samurai Warrior (90mm)", "90mm", "high", 80),
        ("Nocturna", "Figure", "Dark Angel (75mm)", "75mm", "mid", 60),
        ("Nocturna", "Figure", "Nosferatu (Bust, 1/10)", "1/10", "high", 85),
        ("Pegaso", "Figure", "Medieval Knight Templar (75mm)", "75mm", "mid", 65),
        ("Pegaso", "Figure", "Roman Legionary (90mm)", "90mm", "high", 80),
        ("Scale75", "Figure", "Steampunk Inventor (75mm)", "75mm", "mid", 55),
        ("Scale75", "Figure", "War Front Sniper (75mm)", "75mm", "mid", 50),
        ("FeR Miniatures", "Figure", "Napoleonic Hussar (Bust, 1/12)", "1/12", "high", 85),
        ("Nutsplanet", "Figure", "Cyberpunk Mercenary (75mm)", "75mm", "mid", 55),
        ("Life Miniatures", "Figure", "WWII German Officer (1/10 Bust)", "1/10", "high", 95),
        ("Young Miniatures", "Figure", "British Paratrooper Arnhem (1/10 Bust)", "1/10", "high", 90),
        ("Mr. Black Publications", "Figure", "Painting Miniatures Guide Book", "N/A", "standard", 35),

        # ── Motorsport ──────────────────────────────────────────────────
        ("Tamiya", "Cars", "Ferrari SF71H (F1, 2018 Vettel)", "1/20", "high", 80),
        ("Tamiya", "Cars", "Red Bull RB6 (F1, 2010 Vettel)", "1/20", "high", 85),
        ("Tamiya", "Cars", "McLaren MP4/6 (F1, 1991 Senna)", "1/20", "high", 90),
        ("Ebbro", "Cars", "Porsche 911 RSR (LeMans 2019)", "1/24", "mid", 55),
        ("Hasegawa", "Cars", "Lancia 037 (Rally, Martini)", "1/24", "mid", 50),
        ("Hasegawa", "Cars", "Toyota Celica GT-Four (WRC)", "1/24", "mid", 45),
        ("Model Factory Hiro", "Cars", "Ferrari 312T (1/12 Multimedia)", "1/12", "grail", 350),
        ("Model Factory Hiro", "Cars", "Porsche 917K (1/12 Multimedia)", "1/12", "grail", 380),
        ("NuNu/Platz", "Cars", "BMW M8 GTE (2019 Daytona)", "1/24", "mid", 50),
        ("Tamiya", "Cars", "Williams FW14B (F1, 1992 Mansell)", "1/20", "high", 85),

        # ── Civil Vehicles ───────────────────────────────────────────────
        ("MiniArt", "Civil", "German Delivery Car Type 170V", "1/35", "mid", 45),
        ("MiniArt", "Civil", "European Tram w/ Passengers", "1/35", "mid", 55),
        ("Italeri", "Civil", "Scania R730 V8 Topline (Truck)", "1/24", "high", 85),
        ("Italeri", "Civil", "Volvo FH16 Globetrotter XL", "1/24", "high", 80),
        ("ICM", "Civil", "Ford Model T 1911 Touring", "1/24", "mid", 45),
        ("ICM", "Civil", "Bentley 4.5L Blower (1930)", "1/24", "mid", 50),
        ("MiniArt", "Civil", "French Petrol Station 1930-40s", "1/35", "mid", 45),
        ("Bronco", "Civil", "VW Beetle Kdf-Wagen (Early)", "1/35", "standard", 35),
        ("Takom", "Civil", "Citroen Traction Avant 11CV", "1/35", "mid", 40),
        ("Italeri", "Civil", "Fiat 500F (1968)", "1/12", "high", 90),

        # ── Scratch Building & Aftermarket ───────────────────────────────
        ("Eduard", "Accessories", "Photo-Etch Set: Bismarck (1/350)", "1/350", "mid", 42),
        ("Eduard", "Accessories", "Photo-Etch Set: Spitfire Mk.IX Interior (1/48)", "1/48", "standard", 22),
        ("Flyhawk", "Accessories", "Photo-Etch Set: Yamato (1/700)", "1/700", "mid", 38),
        ("Flyhawk", "Accessories", "Photo-Etch Set: Fletcher Class DD (1/350)", "1/350", "mid", 35),
        ("RB Model", "Accessories", "Turned Metal Barrels Set: 88mm KwK 36 (1/35)", "1/35", "standard", 18),
        ("RB Model", "Accessories", "Turned Metal Barrels Set: 120mm L55 (1/35)", "1/35", "standard", 18),
        ("3D Model Works", "Accessories", "3D-Printed Cockpit Detail Set: F-14 (1/48)", "1/48", "standard", 25),
        ("3D Model Works", "Accessories", "3D-Printed Zimmerit Set: Tiger I (1/35)", "1/35", "standard", 20),
        ("Legend Productions", "Accessories", "Resin Conversion: M4 Sherman (Late) Turret (1/35)", "1/35", "mid", 45),
        ("Voyager Model", "Accessories", "Photo-Etch Set: Panther Ausf.G (Full) 1/35", "1/35", "mid", 55),

        # ── 1:48 Helicopter Kits ──────────────────────────────────────────
        ("Kitty Hawk", "Helicopter", "UH-60A Black Hawk (1/48)", "1/48", "mid", 55),
        ("Kitty Hawk", "Helicopter", "MH-60G Pave Hawk (1/48)", "1/48", "mid", 58),
        ("Kitty Hawk", "Helicopter", "AH-1Z Viper (1/48)", "1/48", "mid", 52),
        ("Kitty Hawk", "Helicopter", "SH-60B Seahawk (1/48)", "1/48", "mid", 50),
        ("Hasegawa", "Helicopter", "AH-64D Apache Longbow (1/48)", "1/48", "mid", 48),
        ("Hasegawa", "Helicopter", "UH-1H Iroquois (1/48)", "1/48", "mid", 38),
        ("Hasegawa", "Helicopter", "OH-6A Cayuse (1/48)", "1/48", "standard", 28),
        ("Academy", "Helicopter", "CH-47D Chinook (1/48)", "1/48", "mid", 55),
        ("Academy", "Helicopter", "AH-64A Apache (1/48)", "1/48", "mid", 42),
        ("Italeri", "Helicopter", "AB 205/UH-1N (1/48)", "1/48", "standard", 30),
        ("Italeri", "Helicopter", "Mil Mi-24D Hind (1/48)", "1/48", "mid", 45),
        ("Revell", "Helicopter", "Eurocopter Tiger UHT (1/48)", "1/48", "mid", 40),
        ("Revell", "Helicopter", "CH-53G Sea Stallion (1/48)", "1/48", "mid", 48),
        ("Hobby Boss", "Helicopter", "Ka-50 Black Shark (1/48)", "1/48", "mid", 42),
        ("Hobby Boss", "Helicopter", "Mi-8MT/Mi-17 Hip-H (1/48)", "1/48", "mid", 50),

        # ── 1:350 Submarine Kits ──────────────────────────────────────────
        ("Hobby Boss", "Submarine", "PLAN Type 039A Yuan Class (1/350)", "1/350", "mid", 42),
        ("Hobby Boss", "Submarine", "USS Virginia SSN-774 (1/350)", "1/350", "mid", 55),
        ("Hobby Boss", "Submarine", "DKM Type VIIC U-Boat (1/350)", "1/350", "mid", 38),
        ("Hobby Boss", "Submarine", "PLAN Type 035 Ming Class (1/350)", "1/350", "standard", 32),
        ("Bronco", "Submarine", "USS Los Angeles SSN-688 (1/350)", "1/350", "mid", 48),
        ("Bronco", "Submarine", "HMS Astute S-119 (1/350)", "1/350", "mid", 52),
        ("Trumpeter", "Submarine", "USS Seawolf SSN-21 (1/144)", "1/144", "high", 85),
        ("Trumpeter", "Submarine", "PLAN Type 092 Xia Class SSBN (1/350)", "1/350", "mid", 45),
        ("Revell", "Submarine", "Das Boot Type VIIC/41 (1/144)", "1/144", "mid", 55),
        ("Revell", "Submarine", "USS Dallas SSN-700 (1/350)", "1/350", "mid", 40),
        ("Mirage Hobby", "Submarine", "ORP Orzel Polish Submarine (1/400)", "1/400", "mid", 35),

        # ── 1:72 Multi-Engine Bombers ─────────────────────────────────────
        ("Airfix", "Bomber", "Avro Lancaster B.III (1/72)", "1/72", "high", 80),
        ("Airfix", "Bomber", "Boeing B-17G Flying Fortress (1/72)", "1/72", "high", 85),
        ("Airfix", "Bomber", "Handley Page Halifax B.III (1/72)", "1/72", "high", 75),
        ("Revell", "Bomber", "Consolidated B-24D Liberator (1/72)", "1/72", "high", 70),
        ("Revell", "Bomber", "Heinkel He-111 H-6 (1/72)", "1/72", "mid", 55),
        ("Hasegawa", "Bomber", "Mitsubishi G4M1 Betty (1/72)", "1/72", "mid", 48),
        ("Hasegawa", "Bomber", "Nakajima Ki-49 Donryu (1/72)", "1/72", "mid", 52),
        ("Italeri", "Bomber", "Junkers Ju-88A-4 (1/72)", "1/72", "mid", 42),
        ("Italeri", "Bomber", "Martin B-26B Marauder (1/72)", "1/72", "mid", 48),
        ("Trumpeter", "Bomber", "Tupolev Tu-95MS Bear-H (1/72)", "1/72", "high", 95),
        ("Trumpeter", "Bomber", "Avro Vulcan B.Mk2 (1/72)", "1/72", "high", 110),
        ("HPH Models", "Bomber", "de Havilland Mosquito NF.II (1/72 Resin)", "1/72", "high", 120),

        # ── Miniart Interior / Building Sets ──────────────────────────────
        ("Miniart", "Buildings", "European City Building (1/35)", "1/35", "mid", 55),
        ("Miniart", "Buildings", "Normandy Village House (1/35)", "1/35", "mid", 48),
        ("Miniart", "Buildings", "Ardennes Building (1/35)", "1/35", "mid", 50),
        ("Miniart", "Buildings", "Village Diorama Base (1/35)", "1/35", "mid", 45),
        ("Miniart", "Buildings", "Factory Ruins (1/35)", "1/35", "mid", 52),
        ("Miniart", "Interior", "Soviet Officers Interior Set (1/35)", "1/35", "standard", 25),
        ("Miniart", "Interior", "German Roadside Cafe Interior (1/35)", "1/35", "standard", 28),
        ("Miniart", "Interior", "Workshop Equipment & Tools (1/35)", "1/35", "standard", 22),
        ("Miniart", "Buildings", "Ruined Church (1/35)", "1/35", "mid", 58),
        ("Miniart", "Buildings", "Street Corner Diorama Set (1/35)", "1/35", "mid", 45),

        # ── Weathering Products (Ammo, AK, Vallejo) ───────────────────────
        ("Ammo by Mig", "Weathering", "Ammo Oilbrushers Full Set (20 colors)", "Multi", "mid", 65),
        ("Ammo by Mig", "Weathering", "Ammo Streaking & Staining Set", "Multi", "standard", 25),
        ("Ammo by Mig", "Weathering", "Ammo Pigments: European Earth Set (6)", "Multi", "standard", 22),
        ("Ammo by Mig", "Weathering", "Ammo Chipping Fluid Set", "Multi", "standard", 18),
        ("AK Interactive", "Weathering", "AK Real Colors WWII RAF Set", "Multi", "standard", 28),
        ("AK Interactive", "Weathering", "AK Weathering Pencils Full Set (37)", "Multi", "mid", 48),
        ("AK Interactive", "Weathering", "AK Wash Set for NATO Vehicles", "Multi", "standard", 22),
        ("AK Interactive", "Weathering", "AK True Metal Wax Set (4 colors)", "Multi", "standard", 18),
        ("Vallejo", "Weathering", "Vallejo Model Air WWII Luftwaffe Set (16)", "Multi", "mid", 42),
        ("Vallejo", "Weathering", "Vallejo Weathering Effects Complete Set", "Multi", "mid", 55),
        ("Vallejo", "Weathering", "Vallejo Metal Color Set (8 colors)", "Multi", "standard", 32),
        ("Vallejo", "Weathering", "Vallejo Pigments Desert Set (4)", "Multi", "standard", 16),

        # ── Photo-Etch Brands ─────────────────────────────────────────────
        ("Eduard", "Accessories", "Photo-Etch Set: F-14A Tomcat Interior (1/48)", "1/48", "mid", 28),
        ("Eduard", "Accessories", "Photo-Etch Set: P-51D Mustang Full (1/48)", "1/48", "standard", 22),
        ("Eduard", "Accessories", "Photo-Etch Set: Bf 109G-6 Interior (1/48)", "1/48", "standard", 20),
        ("Eduard", "Accessories", "Photo-Etch Set: HMS Hood Full (1/350)", "1/350", "high", 65),
        ("Eduard", "Accessories", "Photo-Etch Set: Tiger I Full (1/35)", "1/35", "mid", 35),
        ("Griffon Model", "Accessories", "Photo-Etch Set: King Tiger Porsche Turret (1/35)", "1/35", "mid", 38),
        ("Griffon Model", "Accessories", "Photo-Etch Set: M1A2 Abrams TUSK (1/35)", "1/35", "mid", 42),
        ("Voyager Model", "Accessories", "Photo-Etch Set: Sd.Kfz.251 Ausf.D (1/35)", "1/35", "mid", 45),
        ("Voyager Model", "Accessories", "Photo-Etch Set: T-34/85 Full (1/35)", "1/35", "mid", 40),
        ("Aber", "Accessories", "Photo-Etch Set: Panzer IV Ausf.H Full (1/35)", "1/35", "mid", 48),
        ("Aber", "Accessories", "Photo-Etch Set: 88mm Flak 36/37 (1/35)", "1/35", "mid", 35),

        # ── Additional 1:48 Aircraft ──────────────────────────────────────
        ("Tamiya", "Aircraft", "P-51D Mustang (1/48)", "1/48", "mid", 35),
        ("Tamiya", "Aircraft", "Bf 109 G-6 (1/48)", "1/48", "mid", 32),
        ("Tamiya", "Aircraft", "FW 190 A-3 (1/48)", "1/48", "mid", 35),
        ("Tamiya", "Aircraft", "Corsair F4U-1A (1/48)", "1/48", "mid", 38),
        ("Eduard", "Aircraft", "Spitfire Mk.IX ProfiPACK (1/48)", "1/48", "mid", 42),
        ("Eduard", "Aircraft", "Bf 109 E-4 ProfiPACK (1/48)", "1/48", "mid", 40),
        ("Eduard", "Aircraft", "P-39 Airacobra ProfiPACK (1/48)", "1/48", "mid", 38),
        ("Hasegawa", "Aircraft", "A6M5 Zero Type 52 (1/48)", "1/48", "mid", 35),
        ("Hasegawa", "Aircraft", "Ki-61 Hien Tony (1/48)", "1/48", "mid", 38),
        ("Hasegawa", "Aircraft", "F-104 Starfighter (1/48)", "1/48", "mid", 42),
        ("Academy", "Aircraft", "F/A-18F Super Hornet (1/48)", "1/48", "mid", 48),
        ("Academy", "Aircraft", "F-15E Strike Eagle (1/48)", "1/48", "mid", 52),

        # ── 1:700 Warships ────────────────────────────────────────────────
        ("Fujimi", "Ship", "IJN Yamato (1/700)", "1/700", "mid", 45),
        ("Fujimi", "Ship", "IJN Musashi (1/700)", "1/700", "mid", 45),
        ("Fujimi", "Ship", "IJN Akagi (1/700)", "1/700", "mid", 48),
        ("Tamiya", "Ship", "USS Enterprise CV-6 (1/700)", "1/700", "mid", 55),
        ("Tamiya", "Ship", "KMS Bismarck (1/700)", "1/700", "mid", 50),
        ("Tamiya", "Ship", "HMS Prince of Wales (1/700)", "1/700", "mid", 48),
        ("Pit-Road", "Ship", "JMSDF Kongo DDG-173 (1/700)", "1/700", "mid", 35),
        ("Pit-Road", "Ship", "JMSDF Izumo DDH-183 (1/700)", "1/700", "mid", 42),
        ("Dragon", "Ship", "USS Missouri BB-63 (1/700)", "1/700", "mid", 55),
        ("Dragon", "Ship", "HMS Hood (1/700)", "1/700", "mid", 50),

        # ── 1:35 Modern Armor ─────────────────────────────────────────────
        ("Meng", "Armor", "M1A2 SEP V2 Abrams TUSK II (1/35)", "1/35", "mid", 65),
        ("Meng", "Armor", "Leopard 2A7 (1/35)", "1/35", "mid", 62),
        ("Meng", "Armor", "T-90A Russian MBT (1/35)", "1/35", "mid", 55),
        ("Meng", "Armor", "PLA ZTQ-15 Light Tank (1/35)", "1/35", "mid", 52),
        ("Trumpeter", "Armor", "T-14 Armata MBT (1/35)", "1/35", "mid", 58),
        ("Trumpeter", "Armor", "PLA Type 99A MBT (1/35)", "1/35", "mid", 55),
        ("RFM (Rye Field)", "Armor", "M1A1/A2 Abrams w/Full Interior (1/35)", "1/35", "high", 75),
        ("RFM (Rye Field)", "Armor", "Tiger I Early w/Full Interior (1/35)", "1/35", "high", 80),
        ("RFM (Rye Field)", "Armor", "Panther Ausf.G w/Full Interior (1/35)", "1/35", "high", 78),
        ("Takom", "Armor", "King Tiger Henschel w/Zimmerit (1/35)", "1/35", "mid", 55),
        ("Takom", "Armor", "Panzer III Ausf.L (1/35)", "1/35", "mid", 48),
        ("Takom", "Armor", "Chieftain Mk.5 (1/35)", "1/35", "mid", 52),

        # ── Dioramas & Figures ────────────────────────────────────────────
        ("Miniart", "Figures", "Soviet Infantry at Rest (1/35, 4 figs)", "1/35", "standard", 18),
        ("Miniart", "Figures", "German Soldiers at Rest (1/35, 5 figs)", "1/35", "standard", 18),
        ("Miniart", "Figures", "US Tank Crew (1/35, 5 figs)", "1/35", "standard", 18),
        ("Dragon", "Figures", "German Fallschirmjager Monte Cassino (1/35, 4 figs)", "1/35", "standard", 22),
        ("Tamiya", "Figures", "British Infantry Set (1/48, 15 figs)", "1/48", "standard", 15),
        ("Tamiya", "Figures", "German Panzergrenadiers (1/48, 15 figs)", "1/48", "standard", 15),
        ("MiniArt", "Diorama", "Concrete Barricades Set (1/35)", "1/35", "standard", 15),
        ("MiniArt", "Diorama", "Street Lamps & Clocks Set (1/35)", "1/35", "standard", 12),
        ("MiniArt", "Diorama", "Wooden Barrels & Village Utensils (1/35)", "1/35", "standard", 14),

        # ── Additional Space/Sci-Fi Kits ──────────────────────────────────
        ("Bandai", "Spacecraft", "Star Wars X-Wing Starfighter (1/48)", "1/48", "mid", 38),
        ("Bandai", "Spacecraft", "Star Wars AT-AT Walker (1/144)", "1/144", "mid", 55),
        ("Revell", "Spacecraft", "Space Shuttle Discovery (1/144)", "1/144", "mid", 35),
        ("Revell", "Spacecraft", "Apollo 11 Saturn V Rocket (1/144)", "1/144", "mid", 48),
        ("Revell", "Spacecraft", "ISS International Space Station (1/144)", "1/144", "mid", 42),
