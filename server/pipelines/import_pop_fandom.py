...
def _batch_fandom_collectibles_2025() -> list[dict]:
    ...
    items = [
        ...
        # ── Mondo Posters ─────────────────────────────────────────────────
        ("Various", "poster", "Mondo Star Wars (Olly Moss) Set of 3", "Limited", "grail", 3000),
        ("Various", "poster", "Mondo Empire Strikes Back (Olly Moss)", "Limited", "grail", 1500),
        ("Various", "poster", "Mondo Return of the Jedi (Olly Moss)", "Limited", "grail", 1200),
        ("Various", "poster", "Mondo The Avengers (Tyler Stout) Regular", "Limited", "grail", 800),
        ("Various", "poster", "Mondo The Avengers (Tyler Stout) Variant", "Limited", "grail", 1500),
        ("Various", "poster", "Mondo Dracula (Martin Ansin) Screen Print", "Limited", "grail", 600),
        ("Various", "poster", "Mondo The Bride of Frankenstein (Martin Ansin)", "Limited", "grail", 500),
        ("Various", "poster", "Mondo Jaws (Laurent Durieux) Regular", "Limited", "grail", 700),
        ("Various", "poster", "Mondo Blade Runner (Grzegorz Domaradzki) Regular", "Limited", "grail", 500),
        ("Various", "poster", "Mondo The Iron Giant (Jason Edmiston)", "Limited", "grail", 400),
        ("Various", "poster", "Mondo Jurassic Park (JC Richard) Regular", "Limited", "high", 350),
        ("Various", "poster", "Mondo Spirited Away (Olly Moss)", "Limited", "grail", 900),
        ("Various", "poster", "Mondo Back to the Future (Laurent Durieux)", "Limited", "grail", 600),
        ("Various", "poster", "Mondo Alien (Martin Ansin) Regular", "Limited", "grail", 500),
        ("Various", "poster", "Mondo The Thing (Laurent Durieux)", "Limited", "high", 400),

        # ── Board Game Kickstarter Exclusives ─────────────────────────────
        ("Various", "tabletop", "Kingdom Death: Monster 1.5 (KS LE)", "Kickstarter Exclusive", "grail", 2500),
        ("Various", "tabletop", "Zombicide Season 1 (KS Exclusive, All Stretch Goals)", "Kickstarter Exclusive", "high", 200),
        ("Various", "tabletop", "Bloodborne Board Game (KS All-In)", "Kickstarter Exclusive", "high", 250),
        ("Various", "tabletop", "Tainted Grail (Kickstarter All-In)", "Kickstarter Exclusive", "high", 300),
        ("Various", "tabletop", "Etherfields (KS All-In, Stretch Goals)", "Kickstarter Exclusive", "high", 250),
        ("Various", "tabletop", "Nemesis (KS All-In, Stretch Goals)", "Kickstarter Exclusive", "grail", 400),
        ("Various", "tabletop", "Dark Souls Board Game (KS All-In)", "Kickstarter Exclusive", "high", 350),
        ("Various", "tabletop", "Cthulhu: Death May Die (KS All-In)", "Kickstarter Exclusive", "high", 200),
        ("Various", "tabletop", "Aeon's End Legacy Collection (KS All-In)", "Kickstarter Exclusive", "high", 180),

        # ── D&D Collector's Editions (5e Alt Covers) ──────────────────────
        ("Various", "tabletop", "D&D 5e Player's Handbook (Alt Cover)", "Limited Edition", "mid", 70),
        ("Various", "tabletop", "D&D 5e Dungeon Master's Guide (Alt Cover)", "Limited Edition", "mid", 70),
        ("Various", "tabletop", "D&D 5e Xanathar's Guide (Alt Cover)", "Limited Edition", "mid", 65),
        ("Various", "tabletop", "D&D 5e Tasha's Cauldron (Alt Cover)", "Limited Edition", "mid", 65),
        ("Various", "tabletop", "D&D 5e Mordenkainen Presents (Alt Cover)", "Limited Edition", "mid", 65),
        ("Various", "tabletop", "D&D 5e Fizban's Treasury (Alt Cover)", "Limited Edition", "mid", 65),
        ("Various", "tabletop", "D&D 5e Strixhaven (Alt Cover)", "Limited Edition", "mid", 60),
        ("Various", "tabletop", "D&D 5e Spelljammer Slipcase (Alt Cover)", "Limited Edition", "high", 120),
        ("Various", "tabletop", "D&D 5e Curse of Strahd Revamped (Boxed Set)", "Limited Edition", "high", 100),

        # ── Video Game Collector's Editions ───────────────────────────────
        ("Various", "collectible", "Zelda: Tears of the Kingdom Collector's Edition", "Collector's Edition", "high", 180),
        ("Various", "collectible", "Elden Ring Collector's Edition (Sealed)", "Collector's Edition", "grail", 300),
        ("Various", "collectible", "Baldur's Gate 3 Deluxe Edition (Physical)", "Collector's Edition", "high", 150),
        ("Various", "collectible", "Final Fantasy VII Rebirth Collector's Edition", "Collector's Edition", "high", 200),
        ("Various", "collectible", "God of War Ragnarok Jotnar Edition", "Collector's Edition", "grail", 350),
        ("Various", "collectible", "Metroid Dread Special Edition", "Collector's Edition", "high", 120),
        ("Various", "collectible", "Hollow Knight Collector's Edition (Fangamer)", "Collector's Edition", "grail", 250),
        ("Various", "collectible", "Persona 5 Royal Phantom Thieves Edition", "Collector's Edition", "high", 200),
        ("Various", "collectible", "Pokemon Scarlet/Violet Double Pack Steelbook", "Collector's Edition", "mid", 80),
        ("Various", "collectible", "Spider-Man 2 Collector's Edition (PS5)", "Collector's Edition", "high", 150),
        ("Various", "collectible", "Cyberpunk 2077 Collector's Edition (Sealed)", "Collector's Edition", "grail", 300),

        # ── Prop Replicas ─────────────────────────────────────────────────
        ("Various", "replica", "Indiana Jones Fedora (Signed Harrison Ford)", "Signed", "grail", 5000),
        ("Various", "replica", "Indiana Jones Fertility Idol (Sideshow 1:1)", "Limited", "grail", 400),
        ("Various", "replica", "Ghostbusters Proton Pack (Spirit Halloween Deluxe)", "Limited", "high", 200),
        ("Various", "replica", "Ghostbusters PKE Meter (Mattel Prop Replica)", "Limited", "high", 150),
        ("Various", "replica", "Ghostbusters Ghost Trap (Hasbro Prop Replica)", "Limited", "high", 120),
        ("Various", "replica", "Back to the Future Hoverboard (Mattel 1:1)", "Limited", "grail", 500),
        ("Various", "replica", "Back to the Future DeLorean Time Circuit (1:1 Scale)", "Limited", "grail", 350),
        ("Various", "replica", "Harry Potter Elder Wand (Noble Collection)", "Limited", "mid", 60),
        ("Various", "replica", "LOTR The One Ring (Noble Collection, Gold-Plated)", "Limited", "mid", 80),
        ("Various", "replica", "Lightsaber (Hasbro Force FX Elite, Luke ANH)", "Limited", "high", 250),
        ("Various", "replica", "Lightsaber (Hasbro Force FX Elite, Darth Vader)", "Limited", "high", 250),

        # ── Concert Memorabilia ───────────────────────────────────────────
        ("Taylor Swift", "merch", "Eras Tour VIP Package Box (Complete)", "Tour Exclusive", "grail", 500),
        ("Taylor Swift", "merch", "Eras Tour Signed Poster", "Signed", "grail", 400),
        ("Beyonce", "merch", "Renaissance World Tour VIP Box", "Tour Exclusive", "grail", 350),
        ("Beyonce", "merch", "Renaissance World Tour Signed Lithograph", "Signed", "grail", 300),
        ("Billie Eilish", "merch", "HTE Tour Signed Setlist", "Signed", "grail", 250),
        ("The Weeknd", "merch", "After Hours Til Dawn Tour Jacket", "Tour Exclusive", "high", 180),
        ("Harry Styles", "merch", "Love On Tour Signed Poster", "Signed", "grail", 300),
        ("Olivia Rodrigo", "merch", "GUTS Tour VIP Laminate + Poster", "Tour Exclusive", "high", 120),
        ("Bad Bunny", "merch", "Most Wanted Tour Signed Poster", "Signed", "grail", 250),
        ("Travis Scott", "merch", "Utopia Circus Maximus Tour Merch Box", "Tour Exclusive", "high", 200),

        # ── More Vinyl (Hot Sellers) ──────────────────────────────────────
        ("Kendrick Lamar", "vinyl", "GNX Clear Vinyl (Limited)", "Limited", "mid", 40),
        ("Kendrick Lamar", "vinyl", "Mr. Morale & The Big Steppers Signed Vinyl", "Signed", "grail", 300),
        ("Tyler, The Creator", "vinyl", "CHROMAKOPIA Deluxe Box Set", "Limited Edition", "high", 80),
        ("Gracie Abrams", "vinyl", "The Secret of Us Signed Vinyl", "Signed", "high", 90),
        ("Gracie Abrams", "vinyl", "The Secret of Us Clear Vinyl (UO)", "Limited", "mid", 35),
        ("Zach Bryan", "vinyl", "The Great American Bar Scene Signed Vinyl", "Signed", "high", 150),
        ("SZA", "vinyl", "SOS Deluxe Red Vinyl (Target)", "Limited", "mid", 35),
        ("Post Malone", "vinyl", "F-1 Trillion Vinyl (Signed)", "Signed", "high", 90),
        ("Tyla", "vinyl", "TYLA Standard Vinyl", "Standard", "standard", 22),
        ("Ice Spice", "vinyl", "Y2K! Clear Vinyl (Limited)", "Limited", "mid", 35),

        # ── Mondo Posters ───────────────────────────────────────────────
        ("Mondo", "poster", "Olly Moss — Star Wars: A New Hope Mondo Print", "Mondo LE", "grail", 800),
        ("Mondo", "poster", "Olly Moss — Star Wars: The Empire Strikes Back Mondo Print", "Mondo LE", "grail", 900),
        ("Mondo", "poster", "Olly Moss — Star Wars: Return of the Jedi Mondo Print", "Mondo LE", "grail", 850),
        ("Mondo", "poster", "Tyler Stout — Avengers Mondo Print (Regular)", "Mondo LE", "grail", 600),
        ("Mondo", "poster", "Tyler Stout — Avengers Mondo Print (Variant)", "Mondo LE Variant", "grail", 1000),
        ("Mondo", "poster", "Phantom City Creative — Blade Runner 2049 Mondo", "Mondo LE", "high", 200),
        ("Mondo", "poster", "Phantom City Creative — Mad Max Fury Road Mondo", "Mondo LE", "high", 250),
        ("Mondo", "poster", "DKNG — Back to the Future Mondo Print", "Mondo LE", "high", 180),
        ("Mondo", "poster", "DKNG — Jurassic Park Mondo Print", "Mondo LE", "high", 200),
        ("Mondo", "poster", "Daniel Danger — The Iron Giant Mondo Print", "Mondo LE", "high", 250),
        ("Mondo", "poster", "Martin Ansin — Dracula (Universal Monsters) Mondo", "Mondo LE", "high", 300),
        ("Mondo", "poster", "JC Richard — Jaws Mondo Print (Regular)", "Mondo LE", "high", 250),
        ("Mondo", "poster", "Aaron Horkey — Drive Mondo Print", "Mondo LE", "grail", 500),

        # ── Video Game Collector's Editions ─────────────────────────────
        ("Nintendo", "collector_edition", "Zelda: Tears of the Kingdom Collector's Edition", "Sealed CE", "high", 180),
        ("Nintendo", "collector_edition", "Zelda: Tears of the Kingdom Pro Controller", "Limited Hardware", "high", 120),
        ("FromSoftware", "collector_edition", "Elden Ring Collector's Edition (PS5)", "Sealed CE + Statue", "high", 250),
        ("FromSoftware", "collector_edition", "Elden Ring Shadow of the Erdtree CE", "Sealed CE + Helmet Statue", "grail", 300),
        ("Larian Studios", "collector_edition", "Baldur's Gate 3 Collector's Edition (PS5)", "Sealed CE + Mind Flayer", "grail", 400),
        ("Larian Studios", "collector_edition", "Baldur's Gate 3 Deluxe Edition (Physical)", "Sealed Deluxe", "high", 100),
        ("Square Enix", "collector_edition", "Final Fantasy VII Rebirth CE (PS5)", "Sealed CE + Sephiroth Figure", "high", 250),
        ("Square Enix", "collector_edition", "Final Fantasy XVI CE (PS5)", "Sealed CE + Phoenix vs Ifrit", "high", 200),
        ("Capcom", "collector_edition", "Monster Hunter Wilds Collector's Edition", "Sealed CE", "high", 180),
        ("Nintendo", "collector_edition", "Metroid Prime Remastered (Steelbook)", "Limited Steelbook", "mid", 60),

        # ── D&D Collector's Editions ────────────────────────────────────
        ("Wizards of the Coast", "book", "Player's Handbook 2024 (Alt Cover)", "5e 2024 Alt Cover", "high", 80),
        ("Wizards of the Coast", "book", "Dungeon Master's Guide 2024 (Alt Cover)", "5e 2024 Alt Cover", "high", 85),
        ("Wizards of the Coast", "book", "Monster Manual 2025 (Alt Cover)", "5e 2025 Alt Cover", "high", 80),
        ("Wizards of the Coast", "book", "Tasha's Cauldron of Everything (Alt Cover)", "5e Alt Cover", "mid", 55),
        ("Wizards of the Coast", "book", "Xanathar's Guide to Everything (Alt Cover)", "5e Alt Cover", "mid", 50),
        ("Wizards of the Coast", "book", "Fizban's Treasury of Dragons (Alt Cover)", "5e Alt Cover", "mid", 50),
        ("Wizards of the Coast", "book", "Mordenkainen Presents: Monsters of the Multiverse (Alt Cover)", "5e Alt Cover", "mid", 55),
        ("Wizards of the Coast", "book", "Curse of Strahd Revamped (Premium Box Set)", "5e Premium Box", "high", 100),
        ("Wizards of the Coast", "book", "Vecna: Eve of Ruin (Alt Cover)", "5e Alt Cover", "mid", 55),
        ("Wizards of the Coast", "book", "Strixhaven Curriculum of Chaos (Alt Cover)", "5e Alt Cover", "mid", 45),
        ("Wizards of the Coast", "book", "Spelljammer Slipcase (3 Books + DM Screen)", "5e Premium Box", "high", 80),
        ("Wizards of the Coast", "book", "Dragonlance: Shadow of the Dragon Queen (Alt Cover)", "5e Alt Cover", "mid", 50),
        ("Wizards of the Coast", "book", "Planescape Slipcase (3 Books + DM Screen)", "5e Premium Box", "high", 85),

        # ── Concert Memorabilia ─────────────────────────────────────────
        ("Taylor Swift", "merch", "Eras Tour Signed Poster (Folklore Chapter)", "Signed", "grail", 500),
        ("Taylor Swift", "merch", "Eras Tour VIP Package Box (Complete)", "Tour Exclusive", "grail", 350),
        ("Beyonce", "merch", "Cowboy Carter Tour VIP Box Set", "Tour Exclusive", "grail", 400),
        ("Billie Eilish", "merch", "HIT ME HARD AND SOFT Tour Poster (Signed)", "Signed", "grail", 300),
        ("Sabrina Carpenter", "merch", "Short n' Sweet Tour VIP Poster", "Tour Exclusive", "high", 100),
    ]
