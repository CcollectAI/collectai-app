...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ─── HasLab Crowdfunded Exclusives ──────────────────────────────
        ("HasLab", "HasLab", "Sentinel (HasLab 2020)", "", "HasLab Box", "Hasbro Pulse", True, 350),
        ("HasLab", "HasLab", "Sentinel (HasLab 2020) — All Tier Unlocks", "", "HasLab Box", "Hasbro Pulse", True, 450),
        ("HasLab", "HasLab", "Galactus (HasLab 2021)", "", "HasLab Box", "Hasbro Pulse", True, 400),
        ("HasLab", "HasLab", "Galactus (HasLab 2021) — All Tier Unlocks (Frankie Raye Nova, Silver Surfer)", "", "HasLab Box", "Hasbro Pulse", True, 550),
        ("HasLab", "HasLab", "Ghost Rider Engine of Vengeance (HasLab 2023)", "", "HasLab Box", "Hasbro Pulse", True, 380),
        ("HasLab", "HasLab", "Ghost Rider Engine of Vengeance (HasLab 2023) — All Tier Unlocks", "", "HasLab Box", "Hasbro Pulse", True, 500),
        ("HasLab", "HasLab", "GI Joe Classified HISS Tank (HasLab 2022)", "", "HasLab Box", "Hasbro Pulse", True, 300),
        ("HasLab", "HasLab", "Jabba's Sail Barge (HasLab — Star Wars Vintage Collection)", "", "HasLab Box", "Hasbro Pulse", True, 500),

        # ─── X-Men '97 Wave 2 (Animated Series) ────────────────────────
        ("Standard", "X-Men '97 Wave 2", "Beast (X-Men '97)", "Ch'od", "Standard", "", True, 30),
        ("Standard", "X-Men '97 Wave 2", "Mr. Sinister (X-Men '97)", "Ch'od", "Standard", "", True, 35),
        ("Standard", "X-Men '97 Wave 2", "Nightcrawler (X-Men '97)", "Ch'od", "Standard", "", True, 32),
        ("Standard", "X-Men '97 Wave 2", "Roberto Da Costa / Sunspot (X-Men '97)", "Ch'od", "Standard", "", True, 28),
        ("Standard", "X-Men '97 Wave 2", "Goblin Queen (X-Men '97)", "Ch'od", "Standard", "", True, 32),
        ("Standard", "X-Men '97 Wave 2", "Cable (X-Men '97)", "Ch'od", "Standard", "", True, 34),
        ("Standard", "X-Men '97 Wave 2", "Sentinel (X-Men '97 Deluxe)", "", "Deluxe Box", "", True, 55),
        ("Standard", "X-Men '97 Wave 2", "Apocalypse (X-Men '97)", "", "Standard", "", True, 38),
        ("Standard", "X-Men '97 Wave 2", "Forge (X-Men '97)", "Ch'od", "Standard", "", True, 28),
        ("Standard", "X-Men '97 Wave 2", "Professor X (X-Men '97 Hover Chair)", "", "Deluxe Box", "", True, 45),

        # ─── Spider-Man Retro Wave ──────────────────────────────────────
        ("Retro", "Spider-Man Retro", "Symbiote Spider-Man (Retro Card)", "", "Retro Card", "", True, 42),
        ("Retro", "Spider-Man Retro", "Ben Reilly Spider-Man (Retro Card)", "", "Retro Card", "", True, 38),
        ("Retro", "Spider-Man Retro", "Spider-Man 2099 (Retro Card)", "", "Retro Card", "", True, 45),
        ("Retro", "Spider-Man Retro", "Hobgoblin (Retro Card)", "", "Retro Card", "", True, 40),
        ("Retro", "Spider-Man Retro", "Electro (Retro Card)", "", "Retro Card", "", True, 35),
        ("Retro", "Spider-Man Retro", "Sandman (Retro Card)", "", "Retro Card", "", True, 35),
        ("Retro", "Spider-Man Retro", "Rhino (Retro Card)", "", "Retro Card", "", True, 38),
        ("Retro", "Spider-Man Retro", "Scorpion (Retro Card)", "", "Retro Card", "", True, 35),
        ("Retro", "Spider-Man Retro", "Lizard (Retro Card)", "", "Retro Card", "", True, 40),
        ("Retro", "Spider-Man Retro", "Shocker (Retro Card)", "", "Retro Card", "", True, 32),

        # ─── Deadpool / X-Force ─────────────────────────────────────────
        ("Standard", "Deadpool / X-Force", "Deadpool (Grey X-Force Suit)", "", "Standard", "", True, 35),
        ("Standard", "Deadpool / X-Force", "Deadpool (Classic Red)", "", "Standard", "", True, 30),
        ("Standard", "Deadpool / X-Force", "Deadpool (Movie Version)", "", "Standard", "", True, 32),
        ("Standard", "Deadpool / X-Force", "Cable (X-Force)", "Strong Guy", "Standard", "", True, 38),
        ("Standard", "Deadpool / X-Force", "Domino", "Strong Guy", "Standard", "", True, 35),
        ("Standard", "Deadpool / X-Force", "Colossus (X-Force Metallic)", "", "Standard", "", True, 42),
        ("Standard", "Deadpool / X-Force", "Psylocke (X-Force)", "Strong Guy", "Standard", "", True, 35),
        ("Standard", "Deadpool / X-Force", "Warpath (X-Force)", "Strong Guy", "Standard", "", True, 32),

        # ─── BAF Complete Sets (Additional) ─────────────────────────────
        ("Standard", "BAF Sets", "Onslaught BAF Complete (X-Men Wave)", "", "Standard", "", True, 130),
        ("Standard", "BAF Sets", "Mojo BAF Complete (X-Men Wave)", "", "Standard", "", True, 115),
        ("Standard", "BAF Sets", "Vulture BAF Complete (Spider-Man Homecoming Wave)", "", "Standard", "", True, 85),
        ("Standard", "BAF Sets", "Sauron BAF Complete (Deadpool Wave)", "", "Standard", "", True, 90),
        ("Standard", "BAF Sets", "Ursa Major BAF Complete (Iron Man Wave)", "", "Standard", "", True, 80),
        ("Standard", "BAF Sets", "Stilt-Man BAF Complete (Spider-Man Wave)", "", "Standard", "", True, 95),
        ("Standard", "BAF Sets", "Mr. Hyde BAF Complete (Shang-Chi Wave)", "", "Standard", "", True, 78),
        ("Standard", "BAF Sets", "Totally Awesome Hulk BAF Complete (Avengers Wave)", "", "Standard", "", True, 88),
        ("Standard", "BAF Sets", "Sasquatch BAF Complete (Deadpool Wave)", "", "Standard", "", True, 85),
        ("Standard", "BAF Sets", "Demogoblin BAF Complete (Spider-Man Wave)", "", "Standard", "", True, 82),
        ("Standard", "BAF Sets", "Absorbing Man BAF Complete (Spider-Man Wave)", "", "Standard", "", True, 80),
        ("Standard", "BAF Sets", "Lizard BAF Complete (Spider-Man Wave)", "", "Standard", "", True, 88),
        ("Standard", "BAF Sets", "Molten Man BAF Complete (Far From Home Wave)", "", "Standard", "", True, 85),
        ("Standard", "BAF Sets", "Joe Fixit BAF Complete (Avengers Wave)", "", "Standard", "", True, 90),
        ("Standard", "BAF Sets", "Puff Adder BAF Complete (Avengers Wave)", "", "Standard", "", True, 78),

        # ─── MCU Movie Waves ────────────────────────────────────────────
        ("Standard", "MCU Movie", "Infinity Saga Iron Man Mark III", "", "Window Box", "", True, 42),
        ("Standard", "MCU Movie", "Infinity Saga Captain America (First Avenger)", "", "Window Box", "", True, 38),
        ("Standard", "MCU Movie", "Infinity Saga Thor (Ragnarok)", "", "Window Box", "", True, 40),
        ("Standard", "MCU Movie", "Endgame 5-Pack (Exclusive Box Set)", "", "Deluxe Box", "Amazon", True, 120),
        ("Standard", "MCU Movie", "Spider-Man NWH Integrated Suit (Deluxe)", "", "Deluxe Box", "", True, 35),
        ("Standard", "MCU Movie", "Scarlet Witch (Multiverse of Madness)", "", "Standard", "", True, 32),
        ("Standard", "MCU Movie", "Thena Deluxe (Eternals)", "", "Deluxe Box", "", True, 38),
        ("Standard", "MCU Movie", "She-Hulk (Disney+ Series)", "", "Standard", "", True, 28),
        ("Standard", "MCU Movie", "Shang-Chi (Legend of the Ten Rings)", "", "Standard", "", True, 30),
        ("Standard", "MCU Movie", "Black Panther Shuri (Wakanda Forever)", "", "Standard", "", True, 32),
        ("Standard", "MCU Movie", "Star-Lord (Guardians Vol. 3)", "", "Standard", "", True, 30),
        ("Standard", "MCU Movie", "Rocket (Guardians Vol. 3)", "", "Standard", "", True, 28),
        ("Standard", "MCU Movie", "Adam Warlock (Guardians Vol. 3)", "", "Standard", "", True, 30),
        ("Standard", "MCU Movie", "Kang the Conqueror (Quantumania)", "", "Standard", "", True, 28),
        ("Standard", "MCU Movie", "Namor (Wakanda Forever Deluxe)", "", "Deluxe Box", "", True, 40),

        # ─── Exclusive / Convention ─────────────────────────────────────
        ("Fan Channel", "SDCC Exclusives", "SDCC 2019 Exclusive Hela & Skurge 2-Pack", "", "Window Box", "SDCC", True, 85),
        ("Fan Channel", "SDCC Exclusives", "SDCC 2022 Exclusive Dormammu", "", "Window Box", "SDCC", True, 65),
        ("Fan Channel", "SDCC Exclusives", "SDCC 2023 Exclusive Venom Retro", "", "Retro Card", "SDCC", True, 55),
        ("Fan Channel", "Pulse Exclusives", "Pulse Exclusive Rogue (Jim Lee)", "", "Standard", "Hasbro Pulse", True, 48),
        ("Fan Channel", "Pulse Exclusives", "Pulse Exclusive Wolverine (Tiger Stripe)", "", "Standard", "Hasbro Pulse", True, 52),
        ("Fan Channel", "Amazon Exclusives", "Amazon Exclusive Black Panther Vibranium", "", "Standard", "Amazon", True, 35),
        ("Fan Channel", "Amazon Exclusives", "Amazon Exclusive War Machine (Endgame)", "", "Standard", "Amazon", True, 38),
        ("Fan Channel", "Target Exclusives", "Target Exclusive Carnage", "", "Standard", "Target", True, 30),
        ("Fan Channel", "Walmart Exclusives", "Walmart Exclusive Toxin", "", "Standard", "Walmart", True, 32),
        ("Fan Channel", "Fan Channel", "Fan Channel Exclusive Apocalypse (Deluxe)", "", "Deluxe Box", "Fan Channel", True, 45),

        # ─── Vintage / Retro Carded Wave ────────────────────────────────
        ("Retro", "Vintage Wave", "Iron Man (Retro Carded Classic)", "", "Retro Card", "", True, 28),
        ("Retro", "Vintage Wave", "Captain America (Retro Carded Classic)", "", "Retro Card", "", True, 28),
        ("Retro", "Vintage Wave", "Thor (Retro Carded Classic)", "", "Retro Card", "", True, 28),
        ("Retro", "Vintage Wave", "Black Panther (Retro Carded Classic)", "", "Retro Card", "", True, 30),
        ("Retro", "Vintage Wave", "Storm (Retro Carded Classic)", "", "Retro Card", "", True, 32),
        ("Retro", "Vintage Wave", "Daredevil (Retro Carded Classic)", "", "Retro Card", "", True, 30),
        ("Retro", "Vintage Wave", "Punisher (Retro Carded Classic)", "", "Retro Card", "", True, 28),
        ("Retro", "Vintage Wave", "Ghost Rider (Retro Carded Classic)", "", "Retro Card", "", True, 35),
        ("Retro", "Vintage Wave", "Doctor Strange (Retro Carded Classic)", "", "Retro Card", "", True, 30),
        ("Retro", "Vintage Wave", "Silver Surfer (Retro Carded Classic)", "", "Retro Card", "", True, 32),

        # ── 90s Animated Series Waves ──────────────────────────────────────
        ("Animated", "X-Men VHS Wave", "Wolverine (90s Animated Tiger Stripe)", "Sentinel", "VHS Packaging", "", True, 38),
        ("Animated", "X-Men VHS Wave", "Cyclops (90s Animated Blue/Gold)", "Sentinel", "VHS Packaging", "", True, 35),
        ("Animated", "X-Men VHS Wave", "Jean Grey (90s Animated Green/Gold)", "Sentinel", "VHS Packaging", "", True, 35),
        ("Animated", "X-Men VHS Wave", "Rogue (90s Animated Green/Yellow)", "Sentinel", "VHS Packaging", "", True, 36),
        ("Animated", "X-Men VHS Wave", "Gambit (90s Animated Trenchcoat)", "Sentinel", "VHS Packaging", "", True, 40),
        ("Animated", "X-Men VHS Wave", "Storm (90s Animated White Costume)", "Sentinel", "VHS Packaging", "", True, 38),
        ("Animated", "X-Men VHS Wave", "Jubilee (90s Animated Yellow Coat)", "Sentinel", "VHS Packaging", "", True, 35),
        ("Animated", "X-Men VHS Wave", "Beast (90s Animated Blue Fur)", "Sentinel", "VHS Packaging", "", True, 36),
        ("Animated", "Spider-Man VHS Wave", "Spider-Man (90s Animated Classic)", "Kingpin", "VHS Packaging", "", True, 38),
        ("Animated", "Spider-Man VHS Wave", "Venom (90s Animated)", "Kingpin", "VHS Packaging", "", True, 42),
        ("Animated", "Spider-Man VHS Wave", "Carnage (90s Animated)", "Kingpin", "VHS Packaging", "", True, 45),
        ("Animated", "Spider-Man VHS Wave", "Hobgoblin (90s Animated)", "Kingpin", "VHS Packaging", "", True, 40),
        ("Animated", "Spider-Man VHS Wave", "Doctor Octopus (90s Animated)", "Kingpin", "VHS Packaging", "", True, 38),
        ("Animated", "Spider-Man VHS Wave", "Morbius (90s Animated)", "Kingpin", "VHS Packaging", "", True, 36),
        ("Animated", "Spider-Man VHS Wave", "Shocker (90s Animated Yellow)", "Kingpin", "VHS Packaging", "", True, 34),
        ("Animated", "Iron Man VHS Wave", "Iron Man (90s Animated Modular)", "Mandarin", "VHS Packaging", "", True, 38),
        ("Animated", "Iron Man VHS Wave", "War Machine (90s Animated)", "Mandarin", "VHS Packaging", "", True, 40),
        ("Animated", "Iron Man VHS Wave", "Mandarin (90s Animated)", "Mandarin", "VHS Packaging", "", True, 36),

        # ── Villains Waves ─────────────────────────────────────────────────
        ("Standard", "Villains Wave I", "Green Goblin (Classic)", "Stilt-Man", "Standard", "", True, 28),
        ("Standard", "Villains Wave I", "Doctor Doom (Classic Hooded)", "Stilt-Man", "Standard", "", True, 35),
        ("Standard", "Villains Wave I", "Magneto (Jim Lee White Costume)", "Stilt-Man", "Standard", "", True, 32),
        ("Standard", "Villains Wave I", "Mystique (Classic White Dress)", "Stilt-Man", "Standard", "", True, 30),
        ("Standard", "Villains Wave I", "Sabretooth (Classic Brown Costume)", "Stilt-Man", "Standard", "", True, 28),
        ("Standard", "Villains Wave I", "Ultron (Classic Silver)", "Stilt-Man", "Standard", "", True, 30),
        ("Standard", "Villains Wave II", "Red Skull (Classic)", "Crimson Dynamo", "Standard", "", True, 30),
        ("Standard", "Villains Wave II", "Loki (Classic Horned Helmet)", "Crimson Dynamo", "Standard", "", True, 32),
        ("Standard", "Villains Wave II", "Taskmaster (Classic)", "Crimson Dynamo", "Standard", "", True, 28),
        ("Standard", "Villains Wave II", "Baron Zemo (Classic Purple Mask)", "Crimson Dynamo", "Standard", "", True, 28),
        ("Standard", "Villains Wave II", "Bullseye (Classic)", "Crimson Dynamo", "Standard", "", True, 26),
        ("Standard", "Villains Wave II", "Elektra (Red Assassin)", "Crimson Dynamo", "Standard", "", True, 28),
        ("Standard", "Villains Wave III", "Kingpin (White Suit)", "Kingpin", "Standard", "", True, 35),
        ("Standard", "Villains Wave III", "Doctor Octopus (Superior Spider-Man)", "Kingpin", "Standard", "", True, 30),
        ("Standard", "Villains Wave III", "Vulture (Classic Green)", "Kingpin", "Standard", "", True, 28),
        ("Standard", "Villains Wave III", "Rhino (Classic Grey)", "Kingpin", "Standard", "", True, 30),
        ("Standard", "Villains Wave III", "Sandman (Classic Striped Shirt)", "Kingpin", "Standard", "", True, 28),
        ("Standard", "Villains Wave III", "Mysterio (Classic Fishbowl)", "Kingpin", "Standard", "", True, 32),
        ("Standard", "Villains Wave III", "Kraven the Hunter (Classic)", "Kingpin", "Standard", "", True, 28),

        # ── Team Packs ─────────────────────────────────────────────────────
        ("Standard", "Team Pack", "Alpha Flight 5-Pack (Guardian, Snowbird, Puck, Northstar, Aurora)", "N/A", "Team Pack Box", "Hasbro Pulse", True, 120),
        ("Standard", "Team Pack", "Excalibur 3-Pack (Captain Britain, Meggan, Nightcrawler)", "N/A", "Team Pack Box", "Hasbro Pulse", True, 75),
        ("Standard", "Team Pack", "New Mutants 3-Pack (Cannonball, Mirage, Wolfsbane)", "N/A", "Team Pack Box", "", True, 70),
        ("Standard", "Team Pack", "West Coast Avengers 3-Pack (Mockingbird, Tigra, Wonder Man)", "N/A", "Team Pack Box", "", True, 68),
        ("Standard", "Team Pack", "Sinister Six 6-Pack (Green Goblin, Doc Ock, Vulture, Electro, Sandman, Mysterio)", "N/A", "Team Pack Box", "Target", True, 160),
        ("Standard", "Team Pack", "X-Force 3-Pack (Cable, Domino, Deadpool X-Force)", "N/A", "Team Pack Box", "", True, 72),
        ("Standard", "Team Pack", "Power Pack 4-Pack (Alex, Julie, Jack, Katie)", "N/A", "Team Pack Box", "Hasbro Pulse", True, 95),
        ("Standard", "Team Pack", "Fantastic Four Retro 4-Pack (Mr. Fantastic, Invisible Woman, Thing, Torch)", "N/A", "Retro Team Box", "", True, 100),

        # ── Deluxe Figures ─────────────────────────────────────────────────
        ("Deluxe", "Deluxe", "Apocalypse (Deluxe 7-inch)", "", "Deluxe Box", "", True, 45),
        ("Deluxe", "Deluxe", "Thanos (Endgame Deluxe 8-inch)", "", "Deluxe Box", "", True, 48),
        ("Deluxe", "Deluxe", "Hulk (Immortal Hulk Deluxe)", "", "Deluxe Box", "", True, 42),
        ("Deluxe", "Deluxe", "Colossus (Deluxe 8-inch Fastball Special)", "", "Deluxe Box", "", True, 45),
        ("Deluxe", "Deluxe", "Giant-Man (Deluxe 10-inch)", "", "Deluxe Box", "", True, 50),
        ("Deluxe", "Deluxe", "Galactus (Haslab 32-inch)", "", "HasLab Crowdfund", "HasLab", True, 450),
        ("Deluxe", "Deluxe", "Sentinel (Haslab 26-inch)", "", "HasLab Crowdfund", "HasLab", True, 500),
        ("Deluxe", "Deluxe", "Robbie Reyes Ghost Rider (Deluxe w/ Hell Charger)", "", "Deluxe Box", "", True, 55),
        ("Deluxe", "Deluxe", "Venom (Deluxe Toxin Symbiote 7-inch)", "", "Deluxe Box", "", True, 42),
        ("Deluxe", "Deluxe", "Kingpin (Deluxe 8-inch White Suit)", "", "Deluxe Box", "", True, 45),

        # ── Riders Series ──────────────────────────────────────────────────
        ("Riders", "Riders", "Ghost Rider (Johnny Blaze) with Motorcycle", "", "Riders Box", "", True, 55),
        ("Riders", "Riders", "Black Panther with Vibranium Jet", "", "Riders Box", "", True, 50),
        ("Riders", "Riders", "Cosmic Ghost Rider with Space Cycle", "", "Riders Box", "", True, 58),
        ("Riders", "Riders", "Professor X with Hover Chair", "", "Riders Box", "", True, 48),
        ("Riders", "Riders", "Deadpool with Scooter", "", "Riders Box", "", True, 45),
        ("Riders", "Riders", "Punisher with Motorcycle", "", "Riders Box", "", True, 50),
        ("Riders", "Riders", "Captain America with Motorcycle (Classic)", "", "Riders Box", "", True, 52),
        ("Riders", "Riders", "Black Widow with Motorcycle", "", "Riders Box", "", True, 48),
        ("Riders", "Riders", "Wolverine with Motorcycle (Patch Logan)", "", "Riders Box", "", True, 55),
        ("Riders", "Riders", "Hawkeye with Sky-Cycle", "", "Riders Box", "", True, 50),

        # ── Fan Channel Exclusives ─────────────────────────────────────────
        ("Standard", "Fan Channel", "Wolverine (Brown Costume, Fan Channel)", "", "Standard", "Fan Channel", True, 32),
        ("Standard", "Fan Channel", "Deadpool (X-Force Gray, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Iron Man (Model 70, Fan Channel)", "", "Standard", "Fan Channel", True, 35),
        ("Standard", "Fan Channel", "Spider-Man (Symbiote, Fan Channel)", "", "Standard", "Fan Channel", True, 32),
        ("Standard", "Fan Channel", "Thor (Herald of Galactus, Fan Channel)", "", "Standard", "Fan Channel", True, 35),
        ("Standard", "Fan Channel", "Captain America (USAgent, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Vision (Classic Red/Green, Fan Channel)", "", "Standard", "Fan Channel", True, 28),
        ("Standard", "Fan Channel", "Scarlet Witch (Classic, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Moon Knight (Mr. Knight Suit, Fan Channel)", "", "Standard", "Fan Channel", True, 35),
        ("Standard", "Fan Channel", "Blade (90s Trenchcoat, Fan Channel)", "", "Standard", "Fan Channel", True, 32),
        ("Standard", "Fan Channel", "Nova (Richard Rider Classic, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Beta Ray Bill (Fan Channel)", "", "Standard", "Fan Channel", True, 35),
        ("Standard", "Fan Channel", "Namor (Classic Green Trunks, Fan Channel)", "", "Standard", "Fan Channel", True, 28),
        ("Standard", "Fan Channel", "She-Hulk (Classic, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Cable (90s X-Force, Fan Channel)", "", "Standard", "Fan Channel", True, 32),
        ("Standard", "Fan Channel", "Bishop (90s X-Men, Fan Channel)", "", "Standard", "Fan Channel", True, 30),
        ("Standard", "Fan Channel", "Archangel (Blue Skin, Fan Channel)", "", "Standard", "Fan Channel", True, 35),
        ("Standard", "Fan Channel", "Multiple Man (Fan Channel 3-Pack)", "", "Standard", "Fan Channel", True, 65),

        # ── Additional BAF Waves ───────────────────────────────────────────
        ("Standard", "Crimson Dynamo Wave", "Darkstar (Crimson Dynamo BAF)", "Crimson Dynamo", "Standard", "", True, 28),
        ("Standard", "Crimson Dynamo Wave", "Ursa Major (Crimson Dynamo BAF)", "Crimson Dynamo", "Standard", "", True, 30),
        ("Standard", "Crimson Dynamo Wave", "Red Guardian (Crimson Dynamo BAF)", "Crimson Dynamo", "Standard", "", True, 28),
        ("Standard", "Bonebreaker Wave", "Maggott (Bonebreaker BAF)", "Bonebreaker", "Standard", "", True, 28),
        ("Standard", "Bonebreaker Wave", "Havok (90s X-Factor Bonebreaker BAF)", "Bonebreaker", "Standard", "", True, 30),
        ("Standard", "Bonebreaker Wave", "Darwin (Bonebreaker BAF)", "Bonebreaker", "Standard", "", True, 26),
        ("Standard", "Zabu Wave", "Ka-Zar (Savage Land)", "Zabu", "Standard", "", True, 28),
        ("Standard", "Zabu Wave", "Shanna the She-Devil", "Zabu", "Standard", "", True, 28),
        ("Standard", "Zabu Wave", "Sauron (Pteranodon Form)", "Zabu", "Standard", "", True, 32),
        ("Standard", "Totally Awesome Hulk Wave", "Amadeus Cho Hulk", "Totally Awesome Hulk", "Standard", "", True, 30),
        ("Standard", "Totally Awesome Hulk Wave", "Ms. Marvel (Kamala Khan Classic)", "Totally Awesome Hulk", "Standard", "", True, 28),
        ("Standard", "Totally Awesome Hulk Wave", "Spider-Woman (Drew Classic)", "Totally Awesome Hulk", "Standard", "", True, 30),
        ("Standard", "Super Skrull Wave", "Fantomex", "Super Skrull", "Standard", "", True, 28),
        ("Standard", "Super Skrull Wave", "Human Torch (Classic)", "Super Skrull", "Standard", "", True, 28),
        ("Standard", "Super Skrull Wave", "Invisible Woman (Classic)", "Super Skrull", "Standard", "", True, 30),
        ("Standard", "Wendigo Wave", "Cannonball (Classic)", "Wendigo", "Standard", "", True, 28),
        ("Standard", "Wendigo Wave", "Guardian (Alpha Flight)", "Wendigo", "Standard", "", True, 30),
        ("Standard", "Wendigo Wave", "Vindicator (Alpha Flight)", "Wendigo", "Standard", "", True, 28),

        # ── Archive Series Reissues ────────────────────────────────────────
        ("Archive", "Archive Wave", "Iron Man (Modular Armor Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Spider-Man (Ben Reilly Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Wolverine (Weapon X Archive)", "", "Archive Box", "", True, 38),
        ("Archive", "Archive Wave", "Magneto (Jim Lee Archive)", "", "Archive Box", "", True, 38),
        ("Archive", "Archive Wave", "Thor (Walter Simonson Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Captain America (John Walker Archive)", "", "Archive Box", "", True, 32),
        ("Archive", "Archive Wave", "Daredevil (Armored Archive)", "", "Archive Box", "", True, 34),
        ("Archive", "Archive Wave", "Punisher (War Machine Armor Archive)", "", "Archive Box", "", True, 36),
        ("Archive", "Archive Wave", "Black Panther (90s Animated Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Hulk (Joe Fixit Grey Archive)", "", "Archive Box", "", True, 38),
        ("Archive", "Archive Wave", "Storm (Mohawk Archive)", "", "Archive Box", "", True, 36),
        ("Archive", "Archive Wave", "Psylocke (Jim Lee Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Cyclops (Jim Lee Blue Archive)", "", "Archive Box", "", True, 35),
        ("Archive", "Archive Wave", "Doctor Doom (Secret Wars Archive)", "", "Archive Box", "", True, 40),
        ("Archive", "Archive Wave", "Venom (Eddie Brock Classic Archive)", "", "Archive Box", "", True, 38),

        # ── Walmart / Amazon / Target Exclusives ───────────────────────────
        ("Standard", "Walmart Exclusive", "Hulk (Smart Professor Hulk, Walmart)", "", "Standard", "Walmart", True, 35),
        ("Standard", "Walmart Exclusive", "Iron Man (Mark I, Walmart)", "", "Standard", "Walmart", True, 32),
        ("Standard", "Walmart Exclusive", "Ant-Man (Giant-Man Helmet, Walmart)", "", "Standard", "Walmart", True, 30),
        ("Standard", "Amazon Exclusive", "War Machine (Don Cheadle, Amazon)", "", "Standard", "Amazon", True, 32),
        ("Standard", "Amazon Exclusive", "Winter Soldier (Amazon Chrome Arm)", "", "Standard", "Amazon", True, 30),
        ("Standard", "Amazon Exclusive", "Shang-Chi (Amazon LE)", "", "Standard", "Amazon", True, 28),
        ("Standard", "Target Exclusive", "Scarlet Spider (Ben Reilly, Target)", "", "Standard", "Target", True, 35),
        ("Standard", "Target Exclusive", "Agent Venom (Flash Thompson, Target)", "", "Standard", "Target", True, 38),
        ("Standard", "Target Exclusive", "Silk (Cindy Moon, Target)", "", "Standard", "Target", True, 32),
        ("Standard", "Target Exclusive", "Spider-Gwen (Unhooded, Target)", "", "Standard", "Target", True, 30),

        # ── 20th Anniversary / Retro Reissues ──────────────────────────────
        ("Retro", "20th Anniversary", "Spider-Man (Classic, 20th Anniversary)", "", "Retro Card", "", True, 35),
        ("Retro", "20th Anniversary", "Wolverine (Tiger Stripe, 20th Anniversary)", "", "Retro Card", "", True, 38),
        ("Retro", "20th Anniversary", "Captain America (Classic, 20th Anniversary)", "", "Retro Card", "", True, 35),
        ("Retro", "20th Anniversary", "Iron Man (Modular, 20th Anniversary)", "", "Retro Card", "", True, 35),
        ("Retro", "20th Anniversary", "Hulk (Savage, 20th Anniversary)", "", "Retro Card", "", True, 38),
        ("Retro", "20th Anniversary", "Thor (Beta Ray Bill, 20th Anniversary)", "", "Retro Card", "", True, 36),
        ("Standard", "Mojo Wave", "Longshot (Mojo BAF)", "Mojo", "Standard", "", True, 30),
        ("Standard", "Mojo Wave", "Dazzler (Mojo BAF)", "Mojo", "Standard", "", True, 28),
        ("Standard", "Mojo Wave", "Spiral (Mojo BAF)", "Mojo", "Standard", "", True, 32),
        ("Standard", "Mojo Wave", "Strong Guy (Mojo BAF)", "Mojo", "Standard", "", True, 30),
        ("Standard", "Mojo Wave", "Sunspot (Mojo BAF)", "Mojo", "Standard", "", True, 28),
        ("Standard", "Mojo Wave", "Shatterstar (Mojo BAF)", "Mojo", "Standard", "", True, 28),
    ]
