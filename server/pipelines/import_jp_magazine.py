...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ── Anime/Manga Magazines — Additional (+40) ─────────────────────
        ("Newtype", "Gundam", "Magazine Issue", "Newtype Gundam SEED Destiny Cover Issue Oct 2004", "2000s", "mid", 25),
        ("Newtype", "Evangelion", "Magazine Issue", "Newtype Evangelion 3.0+1.0 Cover Special Issue 2021", "2020s", "mid", 30),
        ("Newtype", "Demon Slayer", "Magazine Issue", "Newtype Demon Slayer Hashira Training Arc Cover 2024", "2020s", "standard", 15),
        ("Newtype", "Various", "Magazine Issue", "Newtype 30th Anniversary Issue (Special Compilation)", "2010s", "high", 55),
        ("Newtype", "Jujutsu Kaisen", "Magazine Issue", "Newtype JJK Shibuya Incident Arc Cover Issue 2023", "2020s", "standard", 14),
        ("Newtype", "Frieren", "Magazine Issue", "Newtype Frieren Beyond Journey's End Special Feature 2024", "2020s", "standard", 15),
        ("Animage", "Gundam 0079", "Magazine Issue", "Animage Mobile Suit Gundam First Cover Issue 1979", "1970s", "grail", 250),
        ("Animage", "Macross", "Magazine Issue", "Animage Super Dimension Fortress Macross Cover 1982", "1980s", "high", 80),
        ("Animage", "Nausicaa", "Magazine Issue", "Animage Nausicaa Serialization Start Issue 1982", "1980s", "grail", 120),
        ("Animage", "Totoro", "Magazine Issue", "Animage My Neighbor Totoro Cover Issue 1988", "1980s", "high", 75),
        ("Animage", "Evangelion", "Magazine Issue", "Animage Evangelion TV Finale Special Issue 1996", "1990s", "high", 65),
        ("Animage", "Cardcaptor Sakura", "Magazine Issue", "Animage Cardcaptor Sakura Cover Issue 1999", "1990s", "mid", 35),
        ("Animedia", "Gundam Wing", "Magazine Issue", "Animedia Gundam Wing Endless Waltz Cover 1997", "1990s", "mid", 30),
        ("Animedia", "Cowboy Bebop", "Magazine Issue", "Animedia Cowboy Bebop Feature Issue 1998", "1990s", "mid", 35),
        ("Animedia", "Code Geass", "Magazine Issue", "Animedia Code Geass R2 Cover Issue 2008", "2000s", "mid", 22),
        ("Animedia", "Spy x Family", "Magazine Issue", "Animedia Spy x Family Season 2 Cover Issue 2023", "2020s", "standard", 14),
        ("Megami Magazine", "Fate/stay night", "Tapestry Insert", "Megami Magazine Fate/stay night Saber B2 Tapestry Insert", "2000s", "mid", 35),
        ("Megami Magazine", "Sword Art Online", "Tapestry Insert", "Megami Magazine SAO Asuna B2 Tapestry Insert", "2010s", "mid", 28),
        ("Megami Magazine", "Re:Zero", "Tapestry Insert", "Megami Magazine Re:Zero Rem & Ram B2 Tapestry", "2010s", "mid", 32),
        ("Megami Magazine", "Lycoris Recoil", "Tapestry Insert", "Megami Magazine Lycoris Recoil Chisato B2 Tapestry", "2020s", "mid", 25),
        ("Monthly Shonen Jump", "Dragon Ball", "Magazine Issue", "Monthly Shonen Jump Dragon Ball First Chapter Issue 1984", "1980s", "grail", 300),
        ("Weekly Shonen Jump", "One Piece", "Magazine Issue", "Shonen Jump One Piece Chapter 1 Issue #34 1997", "1990s", "grail", 250),
        ("Weekly Shonen Jump", "Naruto", "Magazine Issue", "Shonen Jump Naruto First Chapter Issue 1999", "1990s", "grail", 180),
        ("Weekly Shonen Jump", "Dragon Ball", "Magazine Issue", "Shonen Jump Dragon Ball Final Chapter Issue #25 1995", "1990s", "grail", 200),
        ("Weekly Shonen Jump", "Demon Slayer", "Magazine Issue", "Shonen Jump Demon Slayer First Chapter Issue 2016", "2010s", "high", 65),
        ("Weekly Shonen Jump", "Jujutsu Kaisen", "Magazine Issue", "Shonen Jump JJK First Chapter Issue 2018", "2010s", "high", 55),
        ("Weekly Shonen Jump", "Chainsaw Man", "Magazine Issue", "Shonen Jump Chainsaw Man Part 1 First Chapter 2019", "2010s", "high", 50),
        ("Weekly Shonen Jump", "My Hero Academia", "Magazine Issue", "Shonen Jump MHA First Chapter Issue 2014", "2010s", "mid", 40),
        ("B's-Log", "Ensemble Stars", "Insert Poster", "B's-Log Ensemble Stars Anniversary A2 Poster Insert", "2020s", "standard", 15),
        ("B's-Log", "Twisted Wonderland", "Insert Card", "B's-Log Twisted Wonderland Character Card Set Insert", "2020s", "standard", 12),
        ("Otomedia", "Touken Ranbu", "Insert Poster", "Otomedia Touken Ranbu Musical A2 Poster Insert", "2010s", "mid", 18),
        ("Otomedia", "Hypnosis Mic", "Clear File", "Otomedia Hypnosis Mic All Division Clear File Set", "2020s", "standard", 14),
        ("Weekly Shonen Jump", "Bleach", "Magazine Issue", "Shonen Jump Bleach First Chapter Issue 2001", "2000s", "high", 75),
        ("Weekly Shonen Jump", "Hunter x Hunter", "Magazine Issue", "Shonen Jump HxH First Chapter Issue 1998", "1990s", "high", 90),
        ("Weekly Shonen Jump", "Death Note", "Magazine Issue", "Shonen Jump Death Note First Chapter Issue 2003", "2000s", "high", 65),
        ("Megami Magazine", "Bocchi the Rock!", "Tapestry Insert", "Megami Magazine Bocchi the Rock! Band B2 Tapestry", "2020s", "mid", 22),
        ("Newtype", "Chainsaw Man", "Magazine Issue", "Newtype Chainsaw Man Anime Debut Cover Issue 2022", "2020s", "standard", 15),
        ("Animage", "Spirited Away", "Magazine Issue", "Animage Spirited Away Academy Award Cover 2003", "2000s", "high", 55),
        ("Newtype", "Spy x Family", "Magazine Issue", "Newtype Spy x Family S2 + Movie Cover Issue 2023", "2020s", "standard", 14),
        ("Megami Magazine", "My Dress-Up Darling", "Tapestry Insert", "Megami Magazine Sono Bisque Doll Marin B2 Tapestry", "2020s", "mid", 25),

        # ── Fashion/Culture Magazines with Anime (+20) ───────────────────
        ("VOGUE Japan", "Evangelion", "Magazine Issue", "VOGUE Japan x Evangelion Collaboration Cover Issue", "2020s", "high", 55),
        ("VOGUE Japan", "Sailor Moon", "Magazine Issue", "VOGUE Japan x Sailor Moon 30th Anniversary Cover", "2020s", "high", 60),
        ("Men's Non-No", "Voice Actors", "Magazine Issue", "Men's Non-No Kamiya Hiroshi Cover Feature Issue", "2020s", "mid", 25),
        ("Men's Non-No", "Voice Actors", "Magazine Issue", "Men's Non-No Hanae Natsuki Cover Feature Issue", "2020s", "mid", 22),
        ("anan", "Attack on Titan", "Magazine Issue", "anan Attack on Titan Final Season Special Cover 2023", "2020s", "mid", 30),
        ("anan", "Jujutsu Kaisen", "Magazine Issue", "anan Jujutsu Kaisen Gojo Satoru Special Feature 2023", "2020s", "mid", 35),
        ("anan", "Spy x Family", "Magazine Issue", "anan Spy x Family Movie Tie-in Cover Issue 2023", "2020s", "mid", 25),
        ("Rockin'On Japan", "LiSA", "Magazine Issue", "Rockin'On Japan LiSA Demon Slayer Feature Issue", "2020s", "mid", 20),
        ("Rockin'On Japan", "YOASOBI", "Magazine Issue", "Rockin'On Japan YOASOBI Oshi no Ko Feature 2023", "2020s", "mid", 22),
        ("BRUTUS", "Anime Special", "Magazine Issue", "BRUTUS Anime Culture Deep Dive Special Issue 2024", "2020s", "mid", 25),
        ("BRUTUS", "Studio Ghibli", "Magazine Issue", "BRUTUS Studio Ghibli Complete Works Special 2023", "2020s", "mid", 30),
        ("Casa BRUTUS", "Makoto Shinkai", "Magazine Issue", "Casa BRUTUS Makoto Shinkai World Special Issue", "2020s", "mid", 25),
        ("POPEYE", "Anime Fashion", "Magazine Issue", "POPEYE Anime x Street Fashion Cover Issue 2024", "2020s", "standard", 15),
        ("Pen", "Evangelion", "Magazine Issue", "Pen Magazine Complete Evangelion Issue", "2020s", "mid", 22),
        ("Pen", "Gundam", "Magazine Issue", "Pen Magazine Gundam 45th Anniversary Special Issue", "2020s", "mid", 22),
        ("GQ Japan", "Voice Actors", "Magazine Issue", "GQ Japan Miyano Mamoru Cover Feature Issue", "2020s", "mid", 25),
        ("SWITCH", "Makoto Shinkai", "Magazine Issue", "SWITCH Makoto Shinkai Suzume Interview Feature Issue", "2020s", "mid", 28),
        ("AERA", "Anime Culture", "Magazine Issue", "AERA Anime Industry Deep Dive Special Issue 2024", "2020s", "standard", 15),
        ("Da Vinci", "Light Novels", "Magazine Issue", "Da Vinci Magazine Light Novel Grand Prize Special 2024", "2020s", "standard", 12),
        ("Men's Non-No", "Anime Fashion", "Magazine Issue", "Men's Non-No Anime Collab Fashion Special 2024", "2020s", "mid", 20),

        # ── Artbooks (+30) ──────────────────────────────────────────────
        ("Artbook", "Various", "Animator Artbook", "Yoh Yoshinari Animation Works (Studio Trigger)", "2010s", "high", 80),
        ("Artbook", "Various", "Animator Artbook", "Takeshi Honda Animation Drawings Collection", "2000s", "high", 90),
        ("Artbook", "Kill la Kill", "Artbook", "Studio Trigger Kill la Kill Complete Artbook", "2010s", "mid", 45),
        ("Artbook", "Promare", "Artbook", "Studio Trigger Promare Official Artbook", "2010s", "mid", 40),
        ("Artbook", "Cyberpunk Edgerunners", "Artbook", "Studio Trigger Cyberpunk Edgerunners Artbook", "2020s", "mid", 48),
        ("Artbook", "Fate/stay night", "Artbook", "Ufotable Fate/stay night UBW Complete Artbook", "2010s", "high", 65),
        ("Artbook", "Demon Slayer", "Artbook", "Ufotable Demon Slayer Animation Art Complete", "2020s", "mid", 50),
        ("Artbook", "Fate/Zero", "Artbook", "Ufotable Fate/Zero Animation Material Complete", "2010s", "high", 60),
        ("Artbook", "Various", "Settei Collection", "Animation Settei Collection — Evangelion TV (Complete)", "1990s", "grail", 180),
        ("Artbook", "Various", "Settei Collection", "Animation Settei Collection — Ghost in the Shell SAC", "2000s", "high", 90),
        ("Artbook", "Your Name", "Artbook", "Makoto Shinkai Your Name Official Visual Guide", "2010s", "mid", 38),
        ("Artbook", "Weathering With You", "Artbook", "Makoto Shinkai Weathering With You Art Collection", "2010s", "mid", 35),
        ("Artbook", "Suzume", "Artbook", "Makoto Shinkai Suzume Official Art & Design Works", "2020s", "mid", 40),
        ("Artbook", "Violet Evergarden", "Artbook", "KyoAni Violet Evergarden Animation Art Complete", "2010s", "high", 70),
        ("Artbook", "Violet Evergarden", "Artbook", "KyoAni Violet Evergarden Movie Art & Design Works", "2020s", "mid", 45),
        ("Artbook", "Various", "Animator Artbook", "Akira Amemiya (SSSS.Gridman) Art Collection", "2010s", "mid", 40),
        ("Artbook", "Chainsaw Man", "Artbook", "Chainsaw Man Anime Official Artbook Vol. 1", "2020s", "mid", 42),
        ("Artbook", "Jujutsu Kaisen", "Artbook", "JJK Animation Complete Works Vol. 1 (Settei + Art)", "2020s", "mid", 48),
        ("Artbook", "One Piece", "Artbook", "One Piece Color Walk Compendium (Oda Eiichiro)", "2010s", "high", 55),
        ("Artbook", "Dragon Ball", "Artbook", "Dragon Ball Super Gallery Complete Art Collection", "2020s", "high", 60),
        ("Artbook", "Naruto", "Artbook", "Naruto Uzumaki Complete Artbook (Kishimoto)", "2010s", "mid", 45),
        ("Artbook", "Attack on Titan", "Artbook", "AoT Final Season Animation Art & Design Works", "2020s", "mid", 42),
        ("Artbook", "Spy x Family", "Artbook", "Spy x Family Animation Official Design Works", "2020s", "mid", 38),
        ("Artbook", "Bocchi the Rock!", "Artbook", "Bocchi the Rock! CloverWorks Animation Art Collection", "2020s", "mid", 35),
        ("Artbook", "Made in Abyss", "Artbook", "Made in Abyss Complete Visual Guide + Settei", "2010s", "mid", 45),
        ("Artbook", "86 EIGHTY-SIX", "Artbook", "86 EIGHTY-SIX A-1 Pictures Animation Art", "2020s", "mid", 38),
        ("Artbook", "Mob Psycho 100", "Artbook", "Mob Psycho 100 BONES Animation Art Complete", "2010s", "mid", 40),
        ("Artbook", "Cowboy Bebop", "Artbook", "Cowboy Bebop The Jazz Messengers Complete Art", "1990s", "high", 85),
        ("Artbook", "Studio Ghibli", "Artbook", "The Art of Studio Ghibli Complete (JP Edition)", "2010s", "high", 70),
        ("Artbook", "Hayao Miyazaki", "Artbook", "Hayao Miyazaki and the Ghibli Museum Art Collection", "2000s", "high", 80),

        # ── Light Novel First Prints (+20) ──────────────────────────────
        ("Dengeki Bunko", "Sword Art Online", "Light Novel", "SAO Vol. 1 First Print Edition (Dengeki Bunko 2009)", "2000s", "high", 75),
        ("MF Bunko J", "Re:Zero", "Light Novel", "Re:Zero Vol. 1 First Print Edition (MF Bunko J 2012)", "2010s", "high", 60),
        ("Kadokawa Sneaker", "Konosuba", "Light Novel", "Konosuba Vol. 1 First Print Edition (Sneaker 2013)", "2010s", "mid", 45),
        ("Kadokawa", "Overlord", "Light Novel", "Overlord Vol. 1 First Print Edition (Enterbrain 2012)", "2010s", "high", 55),
        ("Shosetsuka ni Narou", "Mushoku Tensei", "Light Novel", "Mushoku Tensei Vol. 1 First Print (MF Books 2014)", "2010s", "mid", 40),
        ("Shueisha", "The Apothecary Diaries", "Light Novel", "Apothecary Diaries Vol. 1 First Print (Hero Bunko 2012)", "2010s", "mid", 35),
        ("Dengeki Bunko", "Oregairu", "Light Novel", "Oregairu Vol. 1 First Print (Gagaga Bunko 2011)", "2010s", "mid", 40),
        ("Kadokawa", "The Familiar of Zero", "Light Novel", "Zero no Tsukaima Vol. 1 First Print (MF Bunko J 2004)", "2000s", "mid", 45),
        ("Kadokawa", "Haruhi Suzumiya", "Light Novel", "Haruhi Vol. 1 First Print Edition (Sneaker 2003)", "2000s", "high", 85),
        ("ASCII Media Works", "Toradora!", "Light Novel", "Toradora! Vol. 1 First Print (Dengeki Bunko 2006)", "2000s", "mid", 40),
        ("Kadokawa", "No Game No Life", "Light Novel", "NGNL Vol. 1 First Print Edition (MF Bunko J 2012)", "2010s", "mid", 35),
        ("Shueisha", "Monogatari Series", "Light Novel", "Bakemonogatari Vol. 1 First Print (Kodansha BOX 2006)", "2000s", "high", 70),
        ("Kadokawa", "Spice and Wolf", "Light Novel", "Spice and Wolf Vol. 1 First Print (Dengeki Bunko 2006)", "2000s", "high", 60),
        ("Dengeki Bunko", "A Certain Magical Index", "Light Novel", "Index Vol. 1 First Print (Dengeki Bunko 2004)", "2000s", "mid", 45),
        ("Kadokawa", "86 EIGHTY-SIX", "Light Novel", "86 Vol. 1 First Print Edition (Dengeki Bunko 2017)", "2010s", "mid", 35),
        ("Kadokawa", "Classroom of the Elite", "Light Novel", "Classroom of the Elite Vol. 1 First Print (MF Bunko J)", "2010s", "mid", 38),
        ("GA Bunko", "Goblin Slayer", "Light Novel", "Goblin Slayer Vol. 1 First Print (GA Bunko 2016)", "2010s", "mid", 30),
        ("Kadokawa", "That Time I Got Reincarnated", "Light Novel", "Tensura Vol. 1 First Print (GC Novels 2014)", "2010s", "mid", 35),
        ("Shueisha", "Demon Slayer", "Light Novel", "Demon Slayer Gaiden Novel First Print (Jump Books)", "2020s", "mid", 25),
        ("Kadokawa", "Frieren", "Light Novel", "Frieren Official Novel First Print (Shogakukan 2024)", "2020s", "standard", 15),

        # ── Visual Novels / Game Artbooks (+15) ─────────────────────────
        ("Artbook", "Fate/stay night", "Art Material", "Fate/stay night Art Material Complete (TYPE-MOON)", "2000s", "grail", 200),
        ("Artbook", "Tsukihime", "Art Material", "TYPE-MOON Tsukihime Remake Art Material", "2020s", "high", 65),
        ("Artbook", "Clannad", "Artbook", "Key Clannad Official Art Book (Visual Art's)", "2000s", "mid", 45),
        ("Artbook", "Air", "Artbook", "Key Air Original Art Collection", "2000s", "mid", 50),
        ("Artbook", "Persona 5", "Artbook", "Persona 5 Official Design Works (Atlus)", "2010s", "mid", 40),
        ("Artbook", "Persona 3", "Artbook", "Persona 3 Official Design Works (Atlus)", "2000s", "mid", 45),
        ("Artbook", "NieR Automata", "Artbook", "NieR Automata World Guide & Artbook (SE)", "2010s", "mid", 42),
        ("Artbook", "NieR Replicant", "Artbook", "NieR Replicant ver.1.22 Art & Design Works", "2020s", "mid", 38),
        ("Artbook", "Final Fantasy VII", "Artbook", "FFVII Remake Material Ultimania Plus", "2020s", "mid", 45),
        ("Artbook", "Final Fantasy", "Artbook", "Final Fantasy 25th Anniversary Art Collection", "2010s", "high", 70),
        ("Artbook", "Dark Souls", "Artbook", "Dark Souls Design Works (FromSoftware)", "2010s", "mid", 42),
        ("Artbook", "Elden Ring", "Artbook", "Elden Ring Official Artbook Vol. 1-2 Set", "2020s", "high", 65),
        ("Artbook", "Xenoblade Chronicles", "Artbook", "Xenoblade Chronicles 3 Official Artbook", "2020s", "mid", 38),
        ("Artbook", "Fire Emblem", "Artbook", "Fire Emblem 25th Anniversary Art Collection (Complete)", "2010s", "high", 60),
        ("Artbook", "Metal Gear Solid", "Artbook", "MGS Art of Metal Gear Solid Complete (Yoji Shinkawa)", "2000s", "high", 90),

        # ── Idol Magazines (+20) ────────────────────────────────────────
        ("Weekly Playboy", "Various", "Gravure Special", "Weekly Playboy Seiyuu Special Feature (Amamiya Sora)", "2020s", "mid", 25),
        ("Weekly Playboy", "Various", "Gravure Special", "Weekly Playboy Seiyuu Special Feature (Saito Shuka)", "2010s", "mid", 22),
        ("Flash", "Various", "Magazine Issue", "Flash Voice Actress Special Feature 2024", "2020s", "standard", 15),
        ("Friday", "Various", "Magazine Issue", "Friday Anime Voice Actress Feature Issue 2024", "2020s", "standard", 14),
        ("Seiyuu Grand Prix", "Various", "Magazine Issue", "Seiyuu Grand Prix Hanazawa Kana Cover Issue", "2020s", "mid", 18),
        ("Seiyuu Grand Prix", "Various", "Magazine Issue", "Seiyuu Grand Prix Hayami Saori Cover Issue", "2020s", "mid", 18),
        ("Seiyuu Grand Prix", "Various", "Magazine Issue", "Seiyuu Grand Prix Male VA Special Feature 2024", "2020s", "standard", 14),
        ("AKB48 Special", "AKB48", "Magazine Issue", "AKB48 General Election Official Guide Book 2012", "2010s", "mid", 25),
        ("AKB48 Special", "AKB48", "Magazine Issue", "AKB48 Senbatsu Sousenkyo Complete Issue 2014", "2010s", "mid", 22),
        ("Nogizaka46 Special", "Nogizaka46", "Magazine Issue", "Nogizaka46 10th Anniversary Special Photobook", "2020s", "mid", 30),
        ("Nogizaka46 Special", "Nogizaka46", "Magazine Issue", "Nogizaka46 Graduation Memorial Issue (Nishino Nanase)", "2010s", "mid", 28),
        ("Seiyuu Animedia", "Various", "Magazine Issue", "Seiyuu Animedia Complete VA Festival Issue 2024", "2020s", "standard", 14),
        ("Voice Newtype", "Various", "Magazine Issue", "Voice Newtype Male VA Feature (Kamiya Hiroshi Cover)", "2010s", "mid", 20),
        ("Voice Newtype", "Various", "Magazine Issue", "Voice Newtype Female VA Feature (Minase Inori Cover)", "2020s", "mid", 18),
        ("LisAni!", "Various", "Magazine Issue", "LisAni! Anime Music Festival Special Issue 2024", "2020s", "standard", 14),
        ("Seiyuu Grand Prix", "Aqours", "Magazine Issue", "Seiyuu Grand Prix Aqours Complete Feature Special", "2010s", "mid", 20),
        ("Weekly Playboy", "Various", "Gravure Special", "Weekly Playboy VTuber IRL Special Feature 2024", "2020s", "mid", 22),
        ("JUNON", "Male Seiyuu", "Magazine Issue", "JUNON Male Voice Actor Special Feature 2024", "2020s", "standard", 15),
        ("TV Guide", "Anime", "Magazine Issue", "TV Guide Anime Season Preview Complete Issue Spring 2024", "2020s", "standard", 12),
        ("Nikkei Entertainment", "Anime Industry", "Magazine Issue", "Nikkei Entertainment Anime Industry Report 2024", "2020s", "mid", 20),

        # ── Doujinshi / Independent Publishing (+15) ────────────────────
        ("Doujinshi", "CLAMP", "Doujinshi", "CLAMP Early Doujinshi Captain Tsubasa Collection (1988)", "1980s", "grail", 200),
        ("Doujinshi", "CLAMP", "Doujinshi", "CLAMP Early Doujinshi Saint Seiya Collection (1989)", "1980s", "grail", 180),
        ("Doujinshi", "Gainax", "Publication", "Gainax Early Works — DAICON III/IV Film Book", "1980s", "grail", 250),
        ("Doujinshi", "Gainax", "Publication", "Gainax General Products Catalog Complete Set (OOP)", "1980s", "high", 90),
        ("Doujinshi", "Key Animators", "Artbook", "Animator's Sketchbook Vol. 1-3 Set (Independent)", "2010s", "high", 65),
        ("Doujinshi", "Key Animators", "Artbook", "Bahi JD Independent Animation Works Collection", "2020s", "mid", 35),
        ("Doujinshi", "Key Animators", "Artbook", "web-gen Animator Anthology (C105 Release)", "2020s", "mid", 30),
        ("Doujinshi", "Comiket", "Catalog", "Comiket Catalog Compilation CD-ROM Set 1975-2000", "2000s", "high", 80),
        ("Doujinshi", "TYPE-MOON", "Doujinshi", "TYPE-MOON Tsukihime Original Doujin Game Manual (2000)", "2000s", "grail", 300),
        ("Doujinshi", "TYPE-MOON", "Doujinshi", "TYPE-MOON Mahoyo Early Draft Booklet", "2000s", "high", 90),
        ("Doujinshi", "Touhou Project", "Music CD", "ZUN Music Collection Complete Set (C62-C104)", "2000s", "grail", 150),
        ("Doujinshi", "Touhou Project", "Publication", "Touhou Project Perfect Memento in Strict Sense 1st Print", "2000s", "mid", 40),
        ("Doujinshi", "Various", "Anthology", "Comic Market 50th Anniversary Memorial Publication", "2020s", "mid", 35),
        ("Doujinshi", "Various", "Publication", "Manga Burikko (Otaku Culture Origin Magazine) 1983 Issue", "1980s", "grail", 120),
        ("Doujinshi", "Various", "Publication", "Animec (Early Anime Magazine) Complete Issue Set 1978", "1970s", "grail", 200),

        # ── Vintage / OOP Issues (+20) ──────────────────────────────────
        ("OUT Magazine", "Various", "Magazine Issue", "OUT Magazine First Issue 1977 (Anime Coverage Pioneer)", "1970s", "grail", 280),
        ("OUT Magazine", "Gundam", "Magazine Issue", "OUT Magazine Gundam Special Issue 1981", "1980s", "high", 90),
        ("OUT Magazine", "Macross", "Magazine Issue", "OUT Magazine Macross Complete Coverage 1982", "1980s", "high", 75),
        ("Animage", "Various", "Magazine Issue", "Animage Vol. 1 First Issue 1978", "1970s", "grail", 350),
        ("Newtype", "Various", "Magazine Issue", "Newtype First Issue March 1985", "1980s", "grail", 200),
        ("Newtype", "Char's Counterattack", "Magazine Issue", "Newtype Char's Counterattack Special Issue 1988", "1980s", "high", 80),
        ("Lemon People", "Various", "Magazine Issue", "Lemon People (Pioneering Manga Magazine) Issue #1 1982", "1980s", "grail", 180),
        ("Lemon People", "Various", "Magazine Issue", "Lemon People Final Issue 1998", "1990s", "high", 80),
        ("Fanroad", "Various", "Magazine Issue", "Fanroad First Issue 1980 (Fan Culture Magazine)", "1980s", "grail", 150),
        ("Fanroad", "Gundam", "Magazine Issue", "Fanroad Gundam Special Feature Issue 1981", "1980s", "high", 70),
        ("Comic Box", "Various", "Magazine Issue", "Comic Box Manga Critique Magazine First Issue 1982", "1980s", "high", 65),
        ("Animec", "Space Battleship Yamato", "Magazine Issue", "Animec Yamato Feature Issue 1978", "1970s", "grail", 160),
        ("Animec", "Gundam", "Magazine Issue", "Animec Mobile Suit Gundam Complete Coverage 1979", "1970s", "grail", 180),
        ("My Anime", "Macross", "Magazine Issue", "My Anime Macross Lynn Minmay Cover Issue 1983", "1980s", "high", 65),
        ("My Anime", "Various", "Magazine Issue", "My Anime Final Issue 1986 (Complete Run Collector)", "1980s", "high", 55),
        ("Figure King", "Various", "Magazine Issue", "Figure King Vol. 1 First Issue (Model Magazine)", "1990s", "mid", 30),
        ("Dengeki Hobby", "Gundam", "Magazine Issue", "Dengeki Hobby Magazine Gundam SEED Destiny Feature (OOP)", "2000s", "mid", 25),
        ("Dengeki Hobby", "Various", "Magazine Issue", "Dengeki Hobby Magazine Final Issue 2015 (Defunct)", "2010s", "mid", 30),
        ("Model Graphix", "Gundam", "Magazine Issue", "Model Graphix Gundam Sentinel Complete Issue 1988", "1980s", "high", 85),
        ("Hobby Japan", "Gundam", "Magazine Issue", "Hobby Japan MS-06 Zaku Complete Works Special", "1980s", "high", 70),

        # ── Additional Magazines & Artbooks (+25) ──────────────────────
        ("Newtype", "Bocchi the Rock!", "Magazine Issue", "Newtype Bocchi the Rock! Anime Debut Cover Issue 2022", "2020s", "standard", 14),
        ("Newtype", "Oshi no Ko", "Magazine Issue", "Newtype Oshi no Ko S2 Cover Issue 2025", "2020s", "standard", 15),
        ("Animage", "Demon Slayer", "Magazine Issue", "Animage Demon Slayer Infinity Castle Cover 2025", "2020s", "standard", 14),
        ("Megami Magazine", "Frieren", "Tapestry Insert", "Megami Magazine Frieren Journey's End B2 Tapestry", "2020s", "mid", 25),
        ("Megami Magazine", "Dandadan", "Clear File", "Megami Magazine Dandadan Momo Clear File Insert", "2020s", "standard", 12),
        ("Nyantype", "Lycoris Recoil", "Tapestry Insert", "Nyantype Lycoris Recoil Chisato & Takina B2 Tapestry", "2020s", "mid", 22),
        ("Nyantype", "Spy x Family", "Clear File", "Nyantype Spy x Family Yor Clear File Insert", "2020s", "standard", 12),
        ("Weekly Shonen Jump", "Sakamoto Days", "Magazine Issue", "Shonen Jump Sakamoto Days First Chapter Issue 2020", "2020s", "mid", 30),
        ("Weekly Shonen Jump", "Mashle", "Magazine Issue", "Shonen Jump Mashle First Chapter Issue 2020", "2020s", "mid", 25),
        ("Weekly Shonen Jump", "Dandadan", "Magazine Issue", "Shonen Jump Dandadan First Chapter Issue 2021", "2020s", "mid", 28),
        ("Artbook", "Blue Lock", "Artbook", "Blue Lock Animation Official Design Works Vol. 1", "2020s", "mid", 38),
        ("Artbook", "Frieren", "Artbook", "Frieren Madhouse Animation Art & Design Works", "2020s", "mid", 42),
        ("Artbook", "Solo Leveling", "Artbook", "Solo Leveling A-1 Pictures Animation Art Collection", "2020s", "mid", 40),
        ("Artbook", "Dandadan", "Artbook", "Dandadan Science SARU Animation Art Book", "2020s", "mid", 38),
        ("Artbook", "Trigun Stampede", "Artbook", "Trigun Stampede Orange Animation Art Book", "2020s", "mid", 40),
        ("V Jump", "Dragon Ball", "Magazine Issue", "V Jump Dragon Ball Super Card Game Promo Issue 2024", "2020s", "standard", 12),
        ("V Jump", "Yu-Gi-Oh!", "Magazine Issue", "V Jump Yu-Gi-Oh! OCG Promo Card Issue 2024", "2020s", "mid", 18),
        ("CoroCoro Comic", "Pokemon", "Magazine Issue", "CoroCoro Pokemon Scarlet/Violet Reveal Issue 2022", "2020s", "mid", 20),
        ("CoroCoro Comic", "Pokemon", "Magazine Issue", "CoroCoro Pokemon Legends Z-A Reveal Issue 2024", "2020s", "mid", 22),
        ("Hobby Japan", "Figure", "Magazine Issue", "Hobby Japan Figure Special 2024 (with Exclusive Mini Fig)", "2020s", "mid", 25),
        ("Model Graphix", "Gundam", "Magazine Issue", "Model Graphix Gundam Aerial Build Guide 2023", "2020s", "standard", 15),
        ("Comp Ace", "Fate/Grand Order", "Magazine Issue", "Comp Ace FGO Manga Anthology Special Issue 2024", "2020s", "standard", 14),
        ("Comp Ace", "Overlord", "Magazine Issue", "Comp Ace Overlord Manga Feature Cover Issue", "2020s", "standard", 14),
        ("Ultra Jump", "JoJo Part 9", "Magazine Issue", "Ultra Jump JoJo's Bizarre Adventure Part 9 First Chapter", "2020s", "mid", 30),
        ("Monthly Gangan", "Fullmetal Alchemist", "Magazine Issue", "Monthly Gangan FMA Final Chapter Issue 2010", "2010s", "high", 55),

        # ── Manga Anthology First Issues ──────────────────────────────────
        ("Monthly Afternoon", "Kodansha", "Magazine Issue", "Monthly Afternoon 1986 #1 Inaugural Issue", "1980s", "grail", 200),
        ("Monthly Afternoon", "Vinland Saga", "Magazine Issue", "Monthly Afternoon Vinland Saga First Chapter 2005", "2000s", "mid", 40),
        ("Monthly Afternoon", "Blue Giant", "Magazine Issue", "Monthly Afternoon Blue Giant Final Chapter Issue", "2020s", "mid", 30),
        ("Ultra Jump", "JoJo Part 7", "Magazine Issue", "Ultra Jump JoJo Steel Ball Run First Chapter 2004", "2000s", "high", 80),
        ("Ultra Jump", "JoJo Part 8", "Magazine Issue", "Ultra Jump JoJolion First Chapter 2011", "2010s", "high", 60),
        ("Big Comic Spirits", "Shogakukan", "Magazine Issue", "Big Comic Spirits 1980 Inaugural Issue", "1980s", "grail", 180),
        ("Big Comic Spirits", "20th Century Boys", "Magazine Issue", "Big Comic Spirits 20th Century Boys First Chapter 1999", "1990s", "high", 65),
        ("Big Comic Spirits", "Ping Pong", "Magazine Issue", "Big Comic Spirits Ping Pong Matsumoto Cover Feature 1996", "1990s", "high", 55),
        ("Monthly Comic Zenon", "Fist of the North Star", "Magazine Issue", "Monthly Comic Zenon Fist of the North Star 40th Feature", "2020s", "mid", 35),
        ...
        # ── Anime Staff Interview Compilations ────────────────────────────
        ("Newtype", "Makoto Shinkai", "Interview Book", "Newtype Makoto Shinkai Complete Works Interview Special", "2020s", "mid", 35),
        ("Newtype", "Studio Ghibli", "Interview Book", "Newtype Miyazaki Hayao Complete Interview Archive 2024", "2020s", "high", 60),
        ("Animage", "Hideaki Anno", "Interview Book", "Animage Hideaki Anno Evangelion Complete Interview Set", "2020s", "high", 55),
        ("Newtype", "Ufotable", "Interview Book", "Newtype Ufotable Studio Deep Dive Interview 2024", "2020s", "mid", 30),
        ("Newtype", "MAPPA", "Interview Book", "Newtype MAPPA Studio Feature Interview (JJK/CSM)", "2020s", "mid", 28),
        ("Famitsu", "Yoko Taro", "Interview Book", "Famitsu Yoko Taro Complete NieR Interview Archive", "2020s", "mid", 32),
        ("Animage", "Mamoru Hosoda", "Interview Book", "Animage Mamoru Hosoda Complete Works Interview 2024", "2020s", "mid", 30),

        # ── Settei/Genga Collections ──────────────────────────────────────
        ("Artbook", "Evangelion", "Genga Collection", "Evangelion Groundwork of Evangelion Vol. 1 (Genga)", "2000s", "grail", 120),
        ("Artbook", "Evangelion", "Genga Collection", "Evangelion Groundwork of Evangelion Vol. 2 (Genga)", "2000s", "grail", 110),
        ("Artbook", "Evangelion", "Genga Collection", "Evangelion 3.0+1.0 Settei Collection (Limited)", "2020s", "grail", 150),
        ("Artbook", "Akira", "Genga Collection", "Akira Animation Genga Collection Vol. 1", "1990s", "grail", 200),
        ("Artbook", "Akira", "Genga Collection", "Akira Storyboards Complete (Otomo Original)", "1990s", "grail", 250),
        ("Artbook", "Studio Ghibli", "Settei Collection", "The Art of Spirited Away (Original JP Settei)", "2000s", "high", 80),
        ("Artbook", "Studio Ghibli", "Settei Collection", "The Art of Princess Mononoke (Original JP Settei)", "1990s", "grail", 100),
        ("Artbook", "Cowboy Bebop", "Settei Collection", "Cowboy Bebop Complete Settei Collection (Limited)", "2000s", "grail", 130),
        ("Artbook", "Ghost in the Shell", "Genga Collection", "Ghost in the Shell 1995 Animation Genga (Original)", "1990s", "grail", 180),
        ("Artbook", "Demon Slayer", "Settei Collection", "Demon Slayer Ufotable Animation Settei Book Vol. 1", "2020s", "high", 55),
        ("Artbook", "Jujutsu Kaisen", "Settei Collection", "Jujutsu Kaisen MAPPA Settei & Design Works", "2020s", "high", 50),
        ("Artbook", "Chainsaw Man", "Settei Collection", "Chainsaw Man MAPPA Animation Art & Settei", "2020s", "high", 48),

        # ── Notable Magazine Covers/Features ──────────────────────────────
        ("Newtype", "Gundam SEED", "B2 Poster", "Newtype Gundam SEED Complete B2 Poster Set (12 issues)", "2000s", "high", 65),
        ("Newtype", "Sword Art Online", "B2 Poster", "Newtype SAO 10th Anniversary A2 Poster Insert", "2020s", "mid", 22),
        ("Animedia", "Inuyasha", "Pin-up Poster", "Animedia Inuyasha Complete Cast A3 Pin-up 2003", "2000s", "mid", 30),
        ("Animage", "Cardcaptor Sakura", "Insert Poster", "Animage CCS Final Episode Celebration Poster 2000", "2000s", "mid", 35),
        ("Megami Magazine", "Fate/stay night", "Tapestry", "Megami Magazine Fate/stay night Saber B2 Tapestry (LE)", "2010s", "high", 55),
        ("Megami Magazine", "Re:Zero", "Tapestry", "Megami Magazine Re:Zero Rem B2 Tapestry Insert", "2010s", "mid", 30),
        ("Newtype", "Violet Evergarden", "B2 Poster", "Newtype Violet Evergarden KyoAni Tribute B2 Poster", "2020s", "high", 50),
        ("Hobby Japan", "Frame Arms Girl", "Magazine Issue", "Hobby Japan Frame Arms Girl Complete Build Feature 2018", "2010s", "mid", 20),
        ("Model Graphix", "Evangelion", "Magazine Issue", "Model Graphix Evangelion Unit-01 Complete Build Guide", "2020s", "mid", 22),
        ("Famitsu", "Elden Ring", "Magazine Issue", "Famitsu Elden Ring Complete Guide Feature Issue 2022", "2020s", "mid", 18),

        # ── Specific Notable Magazine Issues ──────────────────────────────
        ("Weekly Shonen Jump", "Bleach", "Magazine Issue", "Shonen Jump Bleach Final Chapter Issue 2016 #38", "2010s", "mid", 30),
        ("Weekly Shonen Jump", "Naruto", "Magazine Issue", "Shonen Jump Naruto Final Chapter Issue 2014 #50", "2010s", "mid", 35),
        ("Weekly Shonen Jump", "Demon Slayer", "Magazine Issue", "Shonen Jump Demon Slayer Final Chapter Issue 2020 #24", "2020s", "mid", 30),
        ("Weekly Shonen Jump", "Jujutsu Kaisen", "Magazine Issue", "Shonen Jump JJK Gojo Returns Feature Cover 2024", "2020s", "mid", 25),
        ("Weekly Shonen Jump", "One Piece", "Magazine Issue", "Shonen Jump One Piece Chapter 1000 Issue 2021 #5-6", "2020s", "high", 50),
        ("Weekly Shonen Jump", "One Piece", "Magazine Issue", "Shonen Jump One Piece 25th Anniversary Triple Cover 2022", "2020s", "high", 55),
        ("Weekly Shonen Jump", "Hunter x Hunter", "Magazine Issue", "Shonen Jump Hunter x Hunter Return Issue 2022 #47", "2020s", "mid", 30),
        ("Newtype", "Frieren", "B2 Poster", "Newtype Frieren Beyond Journey's End B2 Poster Insert 2024", "2020s", "mid", 25),
        ("Animedia", "Solo Leveling", "Pin-up Poster", "Animedia Solo Leveling Sung Jinwoo A3 Poster 2024", "2020s", "mid", 20),
        ("Newtype", "Oshi no Ko", "Clear File", "Newtype Oshi no Ko Ai & Aqua Clear File Insert 2024", "2020s", "standard", 12),

        # ── V Jump / CoroCoro — Additional Promo Issues ───────────────────
        ("V Jump", "Yu-Gi-Oh!", "Promo Card Issue", "V Jump Yu-Gi-Oh! Blue-Eyes White Dragon Promo 2023", "2020s", "mid", 25),
        ("V Jump", "Dragon Ball", "Promo Card Issue", "V Jump Dragon Ball Super Card Game Vegito Promo 2024", "2020s", "mid", 20),
        ("CoroCoro Comic", "Pokemon", "Promo Card Issue", "CoroCoro Pokemon Charizard ex Promo Card Issue 2024", "2020s", "mid", 30),
        ("CoroCoro Comic", "Beyblade", "Magazine Issue", "CoroCoro Beyblade X Feature Issue with Mini Beyb 2024", "2020s", "mid", 18),
        ("CoroCoro Comic", "Doraemon", "Magazine Issue", "CoroCoro Doraemon 50th Anniversary Feature Issue", "2020s", "mid", 22),

        # ── More Settei/Genga Collections ─────────────────────────────────
        ("Artbook", "Naruto", "Settei Collection", "Naruto Shippuden Pierrot Animation Settei Book", "2010s", "high", 65),
        ("Artbook", "One Piece", "Settei Collection", "One Piece Toei Animation Settei Collection (Wano Arc)", "2020s", "high", 55),
        ("Artbook", "Dragon Ball", "Settei Collection", "Dragon Ball Z Toei Animation Settei Complete", "1990s", "grail", 140),
        ("Artbook", "Sailor Moon", "Settei Collection", "Sailor Moon Animation Settei Collection (Toei)", "1990s", "grail", 130),
        ("Artbook", "Gundam", "Settei Collection", "Mobile Suit Gundam Sunrise Settei Complete", "1980s", "grail", 150),
        ("Artbook", "Macross", "Settei Collection", "Super Dimension Fortress Macross Settei Collection", "1980s", "grail", 140),
        ("Artbook", "Your Name", "Settei Collection", "Kimi no Na wa (Your Name) CoMix Wave Settei Book", "2010s", "high", 70),
        ("Artbook", "Weathering with You", "Settei Collection", "Tenki no Ko CoMix Wave Animation Art Book", "2010s", "high", 60),
        ("Artbook", "Spy x Family", "Settei Collection", "Spy x Family WIT/CloverWorks Animation Design Works", "2020s", "mid", 42),
        ("Artbook", "Violet Evergarden", "Settei Collection", "Violet Evergarden KyoAni Animation Art Works", "2010s", "high", 75),

        # ── More Magazine-Specific Issues ─────────────────────────────────
        ("Newtype", "Gundam", "B2 Poster", "Newtype Gundam SEED Freedom Complete B2 Poster 2024", "2020s", "mid", 25),
        ("Newtype", "Spy x Family", "B2 Poster", "Newtype Spy x Family Season 2 B2 Poster Insert", "2020s", "mid", 20),
        ("Animedia", "Blue Lock", "Pin-up Poster", "Animedia Blue Lock Isagi A3 Pin-up Poster 2024", "2020s", "mid", 18),
        ("Animedia", "Haikyuu!!", "Pin-up Poster", "Animedia Haikyuu!! Final Movie Hinata A3 Poster", "2020s", "mid", 22),
        ("Megami Magazine", "Oshi no Ko", "Tapestry", "Megami Magazine Oshi no Ko Ai B2 Tapestry Insert", "2020s", "mid", 28),
        ("Megami Magazine", "Bocchi the Rock!", "Tapestry", "Megami Magazine Bocchi the Rock! B2 Tapestry Insert", "2020s", "mid", 25),
        ("Megami Magazine", "Blue Archive", "Tapestry", "Megami Magazine Blue Archive B2 Tapestry Insert", "2020s", "mid", 26),
        ("Nyantype", "Fate/Grand Order", "Clear File", "Nyantype FGO Saber Clear File Insert 2024", "2020s", "standard", 12),
        ("Nyantype", "Re:Zero", "Clear File", "Nyantype Re:Zero Emilia Clear File Insert 2024", "2020s", "standard", 10),
        ("Hobby Japan", "Evangelion", "Magazine Issue", "Hobby Japan Evangelion Model Build Feature 2024", "2020s", "mid", 22),
        ("Model Graphix", "Macross", "Magazine Issue", "Model Graphix Macross Frontier Complete Build Guide", "2010s", "mid", 20),
        ("Comp Ace", "Re:Zero", "Magazine Issue", "Comp Ace Re:Zero Manga Feature Cover Issue 2024", "2020s", "standard", 12),
        ("Weekly Shonen Jump", "Undead Unluck", "Magazine Issue", "Shonen Jump Undead Unluck Final Chapter Issue 2024", "2020s", "mid", 22),
        ("Weekly Shonen Jump", "My Hero Academia", "Magazine Issue", "Shonen Jump My Hero Academia Final Chapter Issue 2024 #36", "2020s", "high", 50),
        ("Weekly Shonen Jump", "Dragon Ball Super", "Magazine Issue", "Shonen Jump Dragon Ball Super Granolah Arc Feature", "2020s", "mid", 20),
        ("V Jump", "Dragon Ball", "Promo Card Issue", "V Jump Dragon Ball Super Gogeta Blue Promo 2025", "2020s", "mid", 22),
        ("CoroCoro Comic", "Pokemon", "Promo Card Issue", "CoroCoro Pokemon Pikachu Art Rare Promo Issue 2025", "2020s", "mid", 28),
        ("Famitsu", "Monster Hunter Wilds", "Magazine Issue", "Famitsu Monster Hunter Wilds Complete Guide 2025", "2020s", "mid", 20),
        ("Famitsu", "Final Fantasy VII Rebirth", "Clear File", "Famitsu FF7 Rebirth Clear File Set (Cloud & Aerith)", "2020s", "standard", 14),
        ("Nintendo Dream", "Pokemon", "Magazine Issue", "Nintendo Dream Pokemon Legends Z-A Feature 2025", "2020s", "mid", 22),

        # ── Extra items for 1020+ ─────────────────────────────────────────
        ("Artbook", "Attack on Titan", "Settei Collection", "Attack on Titan WIT/MAPPA Complete Settei Book", "2020s", "high", 60),
        ("Artbook", "Mob Psycho 100", "Settei Collection", "Mob Psycho 100 Bones Animation Art Book", "2020s", "mid", 45),
        ("Artbook", "Vinland Saga", "Settei Collection", "Vinland Saga WIT/MAPPA Animation Design Works", "2020s", "high", 50),
        ("Artbook", "Frieren", "Settei Collection", "Frieren Madhouse Animation Complete Settei Book", "2020s", "high", 55),
        ("Animage", "Castle in the Sky", "Insert Poster", "Animage Castle in the Sky (Laputa) 40th Anniv. Poster 2026", "2020s", "high", 70),
        ("Newtype", "Bocchi the Rock!", "B2 Poster", "Newtype Bocchi the Rock! Kessoku Band B2 Poster 2024", "2020s", "mid", 22),
        ("Newtype", "Dandadan", "Clear File", "Newtype Dandadan Momo & Okarun Clear File Insert 2024", "2020s", "standard", 10),
        ("Animedia", "Jujutsu Kaisen", "Pin-up Poster", "Animedia JJK Shibuya Incident A3 Poster Set 2024", "2020s", "mid", 25),
        ("Megami Magazine", "Genshin Impact", "Tapestry", "Megami Magazine Genshin Impact Nahida B2 Tapestry", "2020s", "mid", 28),
        ("Megami Magazine", "Honkai Star Rail", "Tapestry", "Megami Magazine Honkai Star Rail Firefly B2 Tapestry", "2020s", "mid", 26),
        ("Nyantype", "Blue Archive", "Clear File", "Nyantype Blue Archive Shiroko Clear File Insert", "2020s", "standard", 10),
        ("Nyantype", "Genshin Impact", "Clear File", "Nyantype Genshin Furina Clear File Insert", "2020s", "standard", 12),
        ("Weekly Shonen Jump", "Sakamoto Days", "Magazine Issue", "Shonen Jump Sakamoto Days Anime Feature Cover 2025", "2020s", "mid", 25),
        ("Weekly Shonen Jump", "Chainsaw Man", "Magazine Issue", "Shonen Jump Chainsaw Man Part 2 Feature Cover 2024", "2020s", "mid", 28),
        ("Famitsu", "Metaphor ReFantazio", "Magazine Issue", "Famitsu Metaphor ReFantazio Complete Guide Feature", "2020s", "mid", 18),
        ("Famitsu", "Persona 3 Reload", "Clear File", "Famitsu Persona 3 Reload Clear File Insert 2024", "2020s", "standard", 12),
        ("Hobby Japan", "30 Minute Sisters", "Magazine Issue", "Hobby Japan 30MS Complete Build Guide 2025", "2020s", "mid", 20),
    ...
    # Deduplicate by ('magazine', 'name') (keep first occurrence)
    _seen: set = set()
    _deduped: list = []
    for item in catalog:
        _key = (item["magazine"], item["name"])
