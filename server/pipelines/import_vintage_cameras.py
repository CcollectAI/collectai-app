...
def _round11_expansion() -> list[tuple]:
    """Round 11 — ~400 items: Leica M3/M6/IIIf, Hasselblad 500C/M & SWC, Rolleiflex,
    Mamiya RB67/RZ67, Pentax 67, Canon AE-1/F-1, Nikon FM2/F3, Contax T2/G2,
    Olympus OM-1, medium format backs, vintage lenses (Zeiss, Voigtlander)."""
    return [
        # ── Leica M3 Variants ──────────────────────────────────────────
        ("Leica M3 Double Stroke (Early Serial)", "Leica", "rangefinder", "1954-1957", 3500, "Good", False, "Rare", "First M-mount body, double-stroke advance, early serial collector premium"),
        ("Leica M3 Single Stroke (Chrome)", "Leica", "rangefinder", "1957-1966", 2800, "Good", False, "Standard", "Single stroke advance, chrome finish, most common M3 variant"),
        ("Leica M3 Single Stroke (Black Paint)", "Leica", "rangefinder", "1959-1966", 12000, "Good", False, "Rare", "Factory black paint, extremely rare, collector grail, museum piece"),
        ("Leica M3 + Summicron 50mm f/2 Rigid", "Leica", "rangefinder", "1954-1966", 4500, "Good", True, "Standard", "Classic M3 kit with rigid Summicron, the definitive vintage Leica"),
        ("Leica M3 Olive (Bundeswehr)", "Leica", "rangefinder", "1960-1963", 25000, "Good", False, "Rare", "German military olive paint, fewer than 500 made, museum grade"),

        # ── Leica M6 Variants ──────────────────────────────────────────
        ("Leica M6 Classic (Black Chrome, 0.72x)", "Leica", "rangefinder", "1984-1998", 3200, "Excellent", False, "Standard", "TTL metering, black chrome, 0.72x viewfinder, most popular M6"),
        ("Leica M6 Classic (Chrome, 0.72x)", "Leica", "rangefinder", "1984-1998", 3500, "Excellent", False, "Standard", "Silver chrome M6, slightly higher demand than black"),
        ("Leica M6 TTL (Black, 0.72x)", "Leica", "rangefinder", "1998-2002", 3800, "Excellent", False, "Standard", "Updated TTL metering, larger shutter speed dial, black finish"),
        ("Leica M6 TTL (Chrome, 0.85x)", "Leica", "rangefinder", "1998-2002", 4000, "Excellent", False, "Standard", "High-magnification viewfinder, chrome TTL, for 50/75/90mm users"),
        ("Leica M6 (2022 Reissue, Black)", "Leica", "rangefinder", "2022-present", 5300, "Mint", False, "Standard", "Modern reissue with improved rangefinder, ATOS II shutter"),
        ("Leica M6 (2022 Reissue, Silver Chrome)", "Leica", "rangefinder", "2022-present", 5300, "Mint", False, "Standard", "2022 reissue, silver chrome, original M6 design DNA"),
        ("Leica M6 'Ein Stuck Leica' (Titanium)", "Leica", "rangefinder", "1992", 8000, "Excellent", False, "Rare", "Titanium special edition, 'A Piece of Leica', 1500 units"),
        ("Leica M6J (40th Anniversary)", "Leica", "rangefinder", "1994", 6000, "Excellent", False, "Rare", "40th anniversary of M3, Elmar 50/2.8 kit, only 1640 made"),

        # ── Leica IIIf & Screw Mount ──────────────────────────────────
        ("Leica IIIf (Red Dial)", "Leica", "rangefinder", "1950-1956", 600, "Good", False, "Standard", "Red dial self-timer version, flash sync, screw mount classic"),
        ("Leica IIIf (Black Dial)", "Leica", "rangefinder", "1950-1953", 500, "Good", False, "Standard", "Black dial early version, 1/1000 shutter, M39 screw mount"),
        ("Leica IIIf + Elmar 50mm f/3.5 (Collapsible)", "Leica", "rangefinder", "1950-1956", 800, "Good", True, "Standard", "Classic kit with collapsible Elmar, iconic Leica setup"),
        ("Leica IIIg", "Leica", "rangefinder", "1957-1960", 800, "Good", False, "Standard", "Last screw-mount Leica, bright-line viewfinder, improved IIIf"),
        ("Leica IIIc (K-Model, Military)", "Leica", "rangefinder", "1940-1946", 1500, "Good", False, "Rare", "WWII-era military K-model, ball-bearing shutter, grey paint variants"),
        ("Leica IIIa (1936, Chrome)", "Leica", "rangefinder", "1935-1950", 700, "Good", False, "Standard", "Added 1/1000 shutter speed, pre-war screw mount"),
        ("Leica II (Model D)", "Leica", "rangefinder", "1932-1948", 600, "Good", False, "Standard", "First coupled rangefinder Leica, model D, historically important"),

        # ── Leica M-A, MP, M7, M4-P ───────────────────────────────────
        ("Leica M-A (Typ 127, Black Chrome)", "Leica", "rangefinder", "2014-present", 5200, "Mint", False, "Standard", "Pure mechanical M, no meter, no electronics, purist's dream"),
        ("Leica M-A (Typ 127, Silver Chrome)", "Leica", "rangefinder", "2014-present", 5200, "Mint", False, "Standard", "Silver chrome M-A, ISO dial on back, paired with Elmar-M 50/2.8"),
        ("Leica MP (Black Paint, 0.72x)", "Leica", "rangefinder", "2003-present", 5500, "Mint", False, "Standard", "Brass-top mechanical M, classic M3/M2 styling, brass wear patina"),
        ("Leica MP (Silver Chrome, 0.72x)", "Leica", "rangefinder", "2003-present", 5500, "Mint", False, "Standard", "Silver chrome MP, brass underneath, develops beautiful brassing"),
        ("Leica M7 (Black Chrome, 0.72x)", "Leica", "rangefinder", "2002-2018", 3500, "Excellent", False, "Standard", "AE mode M-body, electronic shutter, last mass-produced film M"),
        ("Leica M4-P (Black Chrome)", "Leica", "rangefinder", "1981-1987", 1800, "Good", False, "Standard", "Canadian-made M4-P, 28/75mm frame lines, budget M workhorse"),
        ("Leica M4-2 (Black Chrome)", "Leica", "rangefinder", "1977-1980", 1500, "Good", False, "Standard", "Canadian M4-2, hot shoe added, motor drive port, economical M"),
        ("Leica M2 (Chrome)", "Leica", "rangefinder", "1957-1968", 2200, "Good", False, "Standard", "35mm frame lines, self-resetting counter, preferred for wide lenses"),
        ("Leica M4 (Chrome)", "Leica", "rangefinder", "1967-1975", 2500, "Good", False, "Standard", "Angled rewind crank, improved film loading, last Wetzlar M4"),
        ("Leica M5 (Black Chrome, 3-Lug)", "Leica", "rangefinder", "1971-1975", 1800, "Good", False, "Standard", "TTL metering, controversial large body, underrated classic"),

        # ── Hasselblad 500C/M & System ─────────────────────────────────
        ("Hasselblad 500C/M Body (Chrome)", "Hasselblad", "medium format", "1970-1994", 1200, "Excellent", False, "Standard", "Classic 6x6 SLR, interchangeable back/lens/viewfinder, V-system"),
        ("Hasselblad 500C/M + Planar 80mm f/2.8 CF", "Hasselblad", "medium format", "1970-1994", 2200, "Excellent", True, "Standard", "Complete standard kit, Carl Zeiss Planar, iconic medium format"),
        ("Hasselblad 500C/M + Distagon 50mm f/4 CF", "Hasselblad", "medium format", "1970-1994", 2800, "Excellent", True, "Rare", "Wide-angle kit, Zeiss Distagon, architectural/landscape specialist"),
        ("Hasselblad 500C/M + Sonnar 150mm f/4 CF", "Hasselblad", "medium format", "1970-1994", 2400, "Excellent", True, "Standard", "Portrait kit, Zeiss Sonnar 150, beautiful compression"),
        ("Hasselblad 500C (Original, Chrome)", "Hasselblad", "medium format", "1957-1970", 1000, "Good", False, "Standard", "Original 500C, non-interchangeable screen, first V-system"),
        ("Hasselblad 500CM + A12 Back + WLF + 80mm", "Hasselblad", "medium format", "1970-1994", 2500, "Excellent", True, "Standard", "Complete shooting kit, A12 film back, waist-level finder"),
        ("Hasselblad 501CM Body", "Hasselblad", "medium format", "1994-2005", 1500, "Excellent", False, "Standard", "Updated 500C/M, acute-matte screen, Gliding Mirror System"),
        ("Hasselblad 503CW Body", "Hasselblad", "medium format", "1996-2013", 2000, "Excellent", False, "Standard", "Winder-compatible, last V-system SLR, acute-matte D screen"),
        ("Hasselblad 503CW + Planar 80mm f/2.8 CFE", "Hasselblad", "medium format", "1996-2013", 3200, "Excellent", True, "Standard", "Final 500-series kit, CFE lens for digital back compatibility"),

        # ── Hasselblad SWC/M & Wide ────────────────────────────────────
        ("Hasselblad SWC (Original)", "Hasselblad", "medium format", "1954-1982", 2000, "Good", False, "Rare", "Super Wide Camera, Biogon 38mm f/4.5, non-reflex, architecture specialist"),
        ("Hasselblad SWC/M", "Hasselblad", "medium format", "1982-2001", 2500, "Excellent", False, "Standard", "Modernized SWC, Biogon 38mm f/4.5 CF T*, spirit level built-in"),
        ("Hasselblad 903 SWC", "Hasselblad", "medium format", "2001-2006", 3500, "Excellent", False, "Rare", "Final SWC, Biogon 38/4.5, TTL flash, last non-reflex Hasselblad"),

        # ── Hasselblad Lenses & Backs ──────────────────────────────────
        ("Hasselblad Carl Zeiss Planar 80mm f/2.8 CF T*", "Hasselblad", "medium format", "1982-2006", 600, "Good", True, "Standard", "Standard V-system lens, Zeiss T* multicoating, workhorse"),
        ("Hasselblad Carl Zeiss Planar 100mm f/3.5 CF", "Hasselblad", "medium format", "1982-2006", 500, "Good", True, "Standard", "Short portrait lens, very sharp, compact for V-system"),
        ("Hasselblad Carl Zeiss Distagon 50mm f/4 CF FLE", "Hasselblad", "medium format", "1982-2006", 900, "Good", True, "Standard", "Floating element wide, architecture/interiors, excellent"),
        ("Hasselblad Carl Zeiss Sonnar 150mm f/4 CF", "Hasselblad", "medium format", "1982-2006", 400, "Good", True, "Standard", "Portrait telephoto, classic Sonnar rendering, compact"),
        ("Hasselblad Carl Zeiss Sonnar 250mm f/5.6 CF", "Hasselblad", "medium format", "1982-2006", 500, "Good", True, "Standard", "Telephoto for wildlife/portrait, supertelephoto in 6x6 format"),
        ("Hasselblad Carl Zeiss Makro-Planar 120mm f/4 CF", "Hasselblad", "medium format", "1982-2006", 800, "Good", True, "Rare", "1:1 macro capability, acclaimed close-up performance"),
        ("Hasselblad A12 Film Back (Chrome)", "Hasselblad", "medium format", "1970-2005", 200, "Good", False, "Standard", "12-exposure 6x6 film back, essential V-system accessory"),
        ("Hasselblad A24 Film Back (220 Film)", "Hasselblad", "medium format", "1970-2005", 150, "Good", False, "Standard", "24-exposure 220 film back, longer rolls for event work"),
        ("Hasselblad A16 Film Back (6x4.5)", "Hasselblad", "medium format", "1980-2005", 250, "Good", False, "Standard", "16-exposure 6x4.5 crop back, more frames per roll"),
        ("Hasselblad Polaroid Film Back 100", "Hasselblad", "medium format", "1975-2005", 150, "Good", False, "Standard", "Instant Polaroid back for proofing, FP-100C compatible"),
        ("Hasselblad PME Prism Viewfinder", "Hasselblad", "medium format", "1985-2005", 300, "Good", False, "Standard", "Metered prism finder, TTL metering for V-system bodies"),

        # ── Rolleiflex TLR Expanded ────────────────────────────────────
        ("Rolleiflex 2.8F Xenotar (White Face)", "Rolleiflex", "TLR", "1960-1981", 2200, "Good", True, "Standard", "Schneider Xenotar 80/2.8 taking lens, white-face meter"),
        ("Rolleiflex 2.8GX (Expression)", "Rolleiflex", "TLR", "1987-2000", 3000, "Excellent", True, "Rare", "Last Rolleiflex 2.8, HFT Planar 80/2.8, TTL metering, built-in meter"),
        ("Rolleiflex 3.5E (Xenotar)", "Rolleiflex", "TLR", "1956-1959", 800, "Good", True, "Standard", "Schneider Xenotar 75/3.5, pre-F model, uncoupled meter"),
        ("Rolleiflex 2.8C (Xenotar)", "Rolleiflex", "TLR", "1953-1955", 1200, "Good", True, "Standard", "Early 2.8 model, Schneider Xenotar 80/2.8, no meter"),
        ("Rolleiflex T (Grey, Tessar)", "Rolleiflex", "TLR", "1958-1976", 600, "Good", True, "Standard", "Budget Rolleiflex, Zeiss Tessar 75/3.5, grey body"),
        ("Rolleiflex Automat MX-EVS", "Rolleiflex", "TLR", "1954-1957", 500, "Good", True, "Standard", "Automated film advance, Schneider Xenar 75/3.5"),
        ("Rolleicord Vb", "Rolleiflex", "TLR", "1962-1977", 300, "Good", True, "Standard", "Budget twin-lens, Schneider Xenar 75/3.5, great entry TLR"),
        ("Rolleiflex 2.8FX (Planar)", "Rolleiflex", "TLR", "2003-2015", 4000, "Excellent", True, "Rare", "Penultimate Rolleiflex, HFT Planar 80/2.8, TTL flash sync"),
        ("Rolleiflex Hy6 Mod2", "Rolleiflex", "medium format", "2008-2015", 3000, "Excellent", False, "Rare", "Last Rollei SLR, AFD system, digital back compatible"),

        # ── Mamiya RB67/RZ67 Expanded ──────────────────────────────────
        ("Mamiya RB67 Pro S + 90mm f/3.8 C", "Mamiya", "medium format", "1974-1990", 600, "Good", True, "Standard", "Classic studio workhorse kit, 90mm standard lens, bellows focus"),
        ("Mamiya RB67 Pro S + 127mm f/3.8 C", "Mamiya", "medium format", "1974-1990", 650, "Good", True, "Standard", "Portrait kit, 127mm standard for 6x7, excellent rendering"),
        ("Mamiya RB67 Pro S + 65mm f/4.5 C", "Mamiya", "medium format", "1974-1990", 700, "Good", True, "Standard", "Wide-angle kit, 65mm C lens, landscape specialist"),
        ("Mamiya RB67 Pro SD Body", "Mamiya", "medium format", "1990-2005", 500, "Excellent", False, "Standard", "Final RB67, film/digital back compatible, improved mirror box"),
        ("Mamiya RZ67 Pro Body", "Mamiya", "medium format", "1982-1995", 600, "Good", False, "Standard", "Electronic shutter RB successor, 6x7, lighter than RB67"),
        ("Mamiya RZ67 Pro II + 110mm f/2.8 W", "Mamiya", "medium format", "1995-2005", 1200, "Excellent", True, "Standard", "Portrait dream kit, 110mm f/2.8 W lens, razor sharp"),
        ("Mamiya RZ67 Pro IID", "Mamiya", "medium format", "2004-2014", 1500, "Excellent", False, "Rare", "Digital-ready RZ67, HM401 digital back compatible, last pro MF SLR"),
        ("Mamiya Sekor C 180mm f/4.5 (RB67)", "Mamiya", "medium format", "1970-2005", 200, "Good", True, "Standard", "Telephoto for RB67, portrait compression, sharp at all apertures"),
        ("Mamiya Sekor Z 110mm f/2.8 W (RZ67)", "Mamiya", "medium format", "1982-2005", 400, "Good", True, "Standard", "Standard portrait lens for RZ67 system, floating element"),
        ("Mamiya Sekor Z 50mm f/4.5 W (RZ67)", "Mamiya", "medium format", "1982-2005", 500, "Good", True, "Rare", "Ultra-wide for RZ67, rectilinear, architecture specialist"),

        # ── Pentax 67 System Expanded ──────────────────────────────────
        ("Pentax 67 (Original, No MLU)", "Pentax", "medium format", "1969-1976", 500, "Good", False, "Standard", "First 6x7 SLR, no mirror lock-up, classic pentaprism design"),
        ("Pentax 67 + SMC Takumar 105mm f/2.4", "Pentax", "medium format", "1969-1989", 1200, "Good", True, "Standard", "Legendary portrait kit, 105/2.4 is the king of medium format portrait lenses"),
        ("Pentax 6x7 (TTL Prism, Early)", "Pentax", "medium format", "1976-1989", 700, "Good", False, "Standard", "TTL metered prism version, improved metering over original"),
        ("SMC Pentax 67 75mm f/4.5 AL", "Pentax", "medium format", "1980-2009", 250, "Good", True, "Standard", "Moderate wide for 67, aluminium barrel, sharp landscape lens"),
        ("SMC Pentax 67 45mm f/4", "Pentax", "medium format", "1980-2009", 400, "Good", True, "Standard", "Ultra-wide for 6x7, rectilinear, dramatic perspective"),
        ("SMC Pentax 67 165mm f/2.8", "Pentax", "medium format", "1980-2009", 500, "Good", True, "Standard", "Fast tele portrait, beautiful bokeh at f/2.8, studio favourite"),
        ("SMC Pentax 67 300mm f/4 ED IF", "Pentax", "medium format", "1989-2009", 600, "Good", True, "Rare", "ED glass telephoto, wildlife/sports in medium format, sharp"),
        ("Pentax 67 Wooden Grip", "Pentax", "medium format", "1969-2009", 80, "Good", False, "Standard", "Essential ergonomic accessory, walnut grip for 67 bodies"),

        # ── Canon AE-1 & F-1 Expanded ─────────────────────────────────
        ("Canon AE-1 (Chrome, First Version)", "Canon", "SLR", "1976-1984", 200, "Good", False, "Standard", "Original AE-1, started the electronic SLR revolution"),
        ("Canon F-1 (Original, Chrome)", "Canon", "SLR", "1971-1976", 350, "Good", False, "Standard", "First Canon professional SLR, modular system, FD mount flagship"),
        ("Canon F-1 (Original, Black)", "Canon", "SLR", "1971-1976", 400, "Good", False, "Standard", "Black F-1, slightly rarer, professional photojournalist camera"),
        ("Canon New F-1 (Eye Level Finder)", "Canon", "SLR", "1981-1992", 400, "Excellent", False, "Standard", "Eye-level prism, no AE, professional manual exposure body"),
        ("Canon New F-1 High Speed Motor Drive", "Canon", "SLR", "1981-1992", 600, "Excellent", False, "Rare", "With motor drive FN, 9fps pellicle mirror version"),
        ("Canon FD 50mm f/1.4 S.S.C.", "Canon", "SLR", "1973-1984", 200, "Good", True, "Standard", "Classic FD normal lens, Super Spectra Coating, sharp and contrasty"),
        ("Canon FD 85mm f/1.2 L", "Canon", "SLR", "1976-1989", 1200, "Excellent", True, "Rare", "Legendary L-series portrait, ultra-fast aperture, FD mount grail"),
        ("Canon FD 24mm f/1.4 L", "Canon", "SLR", "1978-1989", 1500, "Excellent", True, "Rare", "Ultra-fast wide-angle L, aspherical, FD mount flagship wide"),
        ("Canon FD 35mm f/2 S.S.C.", "Canon", "SLR", "1973-1990", 250, "Good", True, "Standard", "Classic FD wide, concave front element, contrasty rendering"),
        ("Canon FD 135mm f/2 (Rare)", "Canon", "SLR", "1977-1989", 800, "Excellent", True, "Rare", "Rare fast 135, portrait compression, few made in FD mount"),
        ("Canon FD 200mm f/2.8 IF S.S.C.", "Canon", "SLR", "1976-1989", 400, "Good", True, "Standard", "Internal focus telephoto, sports/wildlife, sharp edge-to-edge"),

        # ── Nikon FM2 & F3 Expanded ────────────────────────────────────
        ("Nikon FM2 (Chrome, Early)", "Nikon", "SLR", "1982-1984", 500, "Good", False, "Standard", "Original FM2, titanium honeycomb shutter, 1/4000 sync"),
        ("Nikon FM2/T (Titanium, Black)", "Nikon", "SLR", "1994-2001", 1800, "Mint", False, "Rare", "Black titanium finish, extremely limited, collector premium"),
        ("Nikon F3HP (Black)", "Nikon", "SLR", "1982-2001", 500, "Excellent", False, "Standard", "High eyepoint finder, Giugiaro design, electronic pro body"),
        ("Nikon F3/T (Titanium, Champagne)", "Nikon", "SLR", "1982-2001", 1200, "Excellent", False, "Rare", "Titanium F3, champagne finish, lighter and more durable"),
        ("Nikon F3/T (Titanium, Black)", "Nikon", "SLR", "1984-2001", 1500, "Excellent", False, "Rare", "Black titanium F3, rarer than champagne, high collector demand"),
        ("Nikon F3P (Press Model)", "Nikon", "SLR", "1983-2001", 800, "Excellent", False, "Rare", "Press/NASA variant, no self-timer, no nameplate, weathersealed"),
        ("Nikon F3AF (Autofocus Prototype)", "Nikon", "SLR", "1983-1986", 600, "Good", False, "Rare", "First AF Nikon SLR, AF-Nikkor 80mm f/2.8 only, historical piece"),
        ("Nikon F2AS Photomic (Black)", "Nikon", "SLR", "1977-1980", 500, "Good", False, "Standard", "Last F2 variant, AI metering, titanium shutter, pro workhorse"),
        ("Nikon F2A Photomic (Chrome)", "Nikon", "SLR", "1977-1980", 400, "Good", False, "Standard", "Chrome F2A, AI coupling, robust mechanical body"),
        ("Nikon FE2 (Chrome)", "Nikon", "SLR", "1983-1987", 350, "Excellent", False, "Standard", "1/4000 shutter, titanium honeycomb, compact electronic SLR"),
        ("Nikon FA (Black)", "Nikon", "SLR", "1983-1987", 250, "Good", False, "Standard", "First matrix metering, multi-pattern AMP system, innovative"),
        ("Nikon Nikkor-S 50mm f/1.4 (AI Converted)", "Nikon", "SLR", "1962-1977", 150, "Good", True, "Standard", "Classic single-coated 50, AI-converted for modern bodies, character lens"),
        ("Nikon Micro-Nikkor 55mm f/2.8 AI-s", "Nikon", "SLR", "1981-2006", 250, "Good", True, "Standard", "Reference macro lens, 1:2 reproduction, excellent for copy work"),
        ("Nikon Nikkor 20mm f/2.8 AI-s", "Nikon", "SLR", "1984-2005", 350, "Good", True, "Standard", "Ultra-wide AI-s, CRC floating element, architecture/landscape"),

        # ── Contax T2/G2 Expanded ──────────────────────────────────────
        ("Contax T2 (Gold, Limited Edition)", "Contax", "compact", "1993", 2500, "Excellent", True, "Rare", "Gold-plated limited edition, Sonnar 38/2.8, extremely rare collector piece"),
        ("Contax T (Original)", "Contax", "compact", "1984-1990", 600, "Excellent", True, "Rare", "First T-series, Sonnar 38/2.8, Porsche Design, titanium pioneer"),
        ("Contax TVS (Vario Sonnar)", "Contax", "compact", "1993-2000", 300, "Good", True, "Standard", "Vario-Sonnar 28-56mm f/3.5-6.5, zoom compact, titanium body"),
        ("Contax TVS III", "Contax", "compact", "2000-2005", 400, "Good", True, "Standard", "Final TVS, Vario-Sonnar 30-60mm f/3.7-6.7, compact zoom"),
        ("Contax G1 (Chrome)", "Contax", "rangefinder", "1994-2001", 350, "Good", False, "Standard", "AF rangefinder, Zeiss G lenses, chrome body, iconic design"),
        ("Contax G2 (Black, Complete Kit)", "Contax", "rangefinder", "1996-2005", 1500, "Excellent", True, "Rare", "G2 with Planar 45/2, Biogon 28/2.8, Sonnar 90/2.8, flash TLA200"),
        ("Zeiss Biogon 21mm f/2.8 (G-mount)", "Contax", "rangefinder", "1994-2005", 800, "Good", True, "Rare", "Ultra-wide for G system, rectilinear, architecture specialist"),
        ("Zeiss Planar 35mm f/2 (G-mount)", "Contax", "rangefinder", "1994-2005", 500, "Good", True, "Standard", "Fast wide for G system, excellent rendering, versatile"),
        ("Zeiss Sonnar 90mm f/2.8 (G-mount)", "Contax", "rangefinder", "1994-2005", 300, "Good", True, "Standard", "Portrait tele for G system, classic Sonnar bokeh"),

        # ── Olympus OM-1 & System ──────────────────────────────────────
        ("Olympus OM-1n (Chrome)", "Olympus", "SLR", "1979-1987", 250, "Good", False, "Standard", "Updated OM-1, improved flash sync, mechanical excellence"),
        ("Olympus OM-1 (Chrome, Early)", "Olympus", "SLR", "1972-1979", 200, "Good", False, "Standard", "Revolutionary compact SLR, Maitani design, whisper-quiet shutter"),
        ("Olympus OM-1 (Black, Early)", "Olympus", "SLR", "1972-1979", 250, "Good", False, "Standard", "Black OM-1, slightly rarer, same legendary build quality"),
        ("Olympus OM-2n (Chrome)", "Olympus", "SLR", "1979-1984", 200, "Good", False, "Standard", "Auto exposure OM-2 update, OTF flash metering, compact body"),
        ("Olympus OM-3Ti (Titanium)", "Olympus", "SLR", "1994-2002", 800, "Excellent", False, "Rare", "Titanium OM-3, spot/multi-spot metering, mechanical, last OM"),
        ("Olympus OM-4Ti (Titanium, Black)", "Olympus", "SLR", "1989-2002", 600, "Excellent", False, "Standard", "Titanium OM-4, multi-spot/highlight-shadow metering, professional"),
        ("Olympus OM-10 (Chrome)", "Olympus", "SLR", "1979-1987", 80, "Good", False, "Standard", "Entry-level OM, aperture-priority auto, Quartz timer, affordable"),
        ("Olympus Zuiko 50mm f/1.4", "Olympus", "SLR", "1973-2002", 150, "Good", True, "Standard", "Fast normal Zuiko, excellent rendering, compact for f/1.4"),
        ("Olympus Zuiko 50mm f/1.2", "Olympus", "SLR", "1973-2002", 500, "Good", True, "Rare", "Ultra-fast Zuiko, beautiful bokeh, rare in good condition"),
        ("Olympus Zuiko 28mm f/2.8", "Olympus", "SLR", "1973-2002", 100, "Good", True, "Standard", "Compact wide Zuiko, excellent sharpness, affordable"),
        ("Olympus Zuiko 21mm f/3.5", "Olympus", "SLR", "1973-2002", 250, "Good", True, "Standard", "Ultra-wide Zuiko, rectilinear, architectural specialist"),
        ("Olympus Zuiko 85mm f/2", "Olympus", "SLR", "1973-2002", 250, "Good", True, "Standard", "Portrait Zuiko, sharp and contrasty, excellent focal length"),
        ("Olympus Zuiko 135mm f/2.8", "Olympus", "SLR", "1973-2002", 100, "Good", True, "Standard", "Compact telephoto Zuiko, portrait compression, lightweight"),
        ("Olympus Zuiko Macro 90mm f/2", "Olympus", "SLR", "1978-2002", 350, "Good", True, "Rare", "Fast macro/portrait, 1:2 reproduction, dual-purpose lens"),
        ("Olympus Zuiko Shift 24mm f/3.5", "Olympus", "SLR", "1978-2002", 500, "Good", True, "Rare", "Perspective control lens, architecture specialist, rare Zuiko"),

        # ── Medium Format Film Backs & Accessories ─────────────────────
        ("Mamiya 645 Pro TL Body", "Mamiya", "medium format", "1999-2006", 300, "Good", False, "Standard", "Motor-driven 645, TTL flash, modular film/digital back system"),
        ("Mamiya 645 Pro TL + 80mm f/2.8 N", "Mamiya", "medium format", "1999-2006", 500, "Good", True, "Standard", "Standard 645 kit, Sekor 80mm normal lens, versatile"),
        ("Mamiya 645 Super Body", "Mamiya", "medium format", "1985-1999", 200, "Good", False, "Standard", "Winder-built-in 645, modular back, affordable medium format entry"),
        ("Mamiya 645AF Body", "Mamiya", "medium format", "1999-2005", 400, "Good", False, "Standard", "Autofocus 645, Phase One compatible, affordable AF medium format"),
        ("Bronica GS-1 Body + 100mm f/3.5", "Bronica", "medium format", "1983-1997", 500, "Good", True, "Standard", "6x7 SLR with motor, Zenzanon PG 100mm, Hasselblad competitor"),
        ("Bronica ETR Body", "Bronica", "medium format", "1976-1989", 200, "Good", False, "Standard", "6x4.5 SLR system, modular, Zenzanon lenses, affordable entry"),
        ("Horseman 6x12 Rollfilm Back", "Horseman", "large format", "1990-2005", 600, "Good", False, "Rare", "Panoramic 6x12 rollfilm back for 4x5 cameras, stunning panoramas"),
        ("Graflex 4x5 Rollfilm Back (6x7)", "Graflex", "large format", "1960-1990", 200, "Good", False, "Standard", "6x7 rollfilm back for 4x5 cameras, convenient sheet film alternative"),
        ("Fidelity Elite 4x5 Film Holders (10 Pack)", "Fidelity", "large format", "1980-2005", 100, "Good", False, "Standard", "Standard 4x5 sheet film holders, essential large format accessory"),
        ("Toyo Super Graphic 45 (4x5 Press Camera)", "Toyo", "large format", "1970-1990", 400, "Good", True, "Standard", "Japanese press camera, rangefinder, movements, field-portable"),

        # ── Vintage Lenses (Zeiss, Voigtlander, Other) ─────────────────
        ("Carl Zeiss Planar T* 50mm f/1.4 ZF.2 (Nikon F)", "Zeiss", "SLR", "2006-2019", 500, "Excellent", True, "Standard", "Modern classic Planar for Nikon F, manual focus, ZF.2 chip"),
        ("Carl Zeiss Distagon T* 35mm f/1.4 ZF.2 (Nikon F)", "Zeiss", "SLR", "2010-2019", 700, "Excellent", True, "Standard", "Wide-angle Distagon for Nikon F, excellent rendering, cult lens"),
        ("Carl Zeiss Makro-Planar T* 50mm f/2 ZF.2", "Zeiss", "SLR", "2008-2019", 600, "Excellent", True, "Standard", "Macro Planar for Nikon F, 1:2 macro, stellar sharpness"),
        ("Carl Zeiss Makro-Planar T* 100mm f/2 ZF.2", "Zeiss", "SLR", "2009-2019", 800, "Excellent", True, "Rare", "Macro/portrait tele, 1:2 macro, reference optics, heavy"),
        ("Carl Zeiss Otus 55mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2013-2019", 2500, "Mint", True, "Rare", "Reference-class standard lens, no compromises, 1kg+ optics"),
        ("Carl Zeiss Milvus 85mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2016-2019", 1200, "Mint", True, "Standard", "Weather-sealed Zeiss portrait, de-click ring, modern manual focus"),
        ("Voigtlander Nokton 40mm f/1.2 Aspherical (M-mount)", "Voigtlander", "rangefinder", "2017-present", 900, "Mint", True, "Standard", "Ultra-fast 40 for Leica M, tiny package, dreamy wide-open"),
        ("Voigtlander Nokton 35mm f/1.2 Aspherical III (M-mount)", "Voigtlander", "rangefinder", "2020-present", 800, "Mint", True, "Standard", "Fast 35 v3 for Leica M, improved optical formula, compact"),
        ("Voigtlander Nokton 75mm f/1.5 Aspherical (M-mount)", "Voigtlander", "rangefinder", "2013-present", 800, "Mint", True, "Standard", "Fast portrait tele for Leica M, Sonnar design, beautiful bokeh"),
        ("Voigtlander Heliar 50mm f/3.5 (M-mount)", "Voigtlander", "rangefinder", "2000-present", 300, "Mint", True, "Standard", "Tiny pancake for Leica M, classic Heliar rendering, pocketable"),
        ("Voigtlander Super Wide-Heliar 15mm f/4.5 III (M-mount)", "Voigtlander", "rangefinder", "2014-present", 600, "Mint", True, "Standard", "Ultra-ultra-wide for Leica M, rectilinear, architectural use"),
        ("Voigtlander Ultron 28mm f/2 (M-mount)", "Voigtlander", "rangefinder", "2020-present", 600, "Mint", True, "Standard", "Fast wide-angle for Leica M, 10-blade aperture, tiny"),
        ("Leitz Thambar 90mm f/2.2 (1935 Original)", "Leica", "rangefinder", "1935-1940", 5000, "Good", True, "Rare", "Intentional soft-focus portrait lens, extremely rare, collector piece"),
        ("Leica Summilux-M 35mm f/1.4 (V2, Pre-ASPH, Titanium)", "Leica", "rangefinder", "1990-1994", 5000, "Good", True, "Rare", "Titanium barrel pre-ASPH Summilux, rare variant, excellent rendering"),
        ("Schneider Super-Angulon 90mm f/8 (Large Format)", "Schneider", "large format", "1960-2000", 400, "Good", True, "Standard", "Ultra-wide for 4x5, huge image circle, architecture standard"),
        ("Rodenstock Sironar-S 210mm f/5.6", "Rodenstock", "large format", "1990-2010", 500, "Good", True, "Standard", "Standard 4x5 lens, Plasmat design, reference sharpness"),
        ("Nikkor-SW 90mm f/8 (Large Format)", "Nikon", "large format", "1980-2005", 500, "Good", True, "Standard", "Nikon large format wide, huge image circle, excellent coverage"),
        ("Fujinon-W 150mm f/5.6 (Large Format)", "Fuji", "large format", "1985-2005", 300, "Good", True, "Standard", "Standard 4x5 lens, EBC multicoating, lightweight, sharp"),
        ("Fujinon-C 450mm f/12.5 (Large Format)", "Fuji", "large format", "1985-2005", 400, "Good", True, "Standard", "Compact telephoto for 4x5, tiny barrel, portrait compression"),

        # ── Point-and-Shoot Expanded ───────────────────────────────────
        ("Olympus Mju II (Stylus Epic, Limited Blue)", "Olympus", "point-and-shoot", "1997-2003", 500, "Good", True, "Rare", "Limited blue edition, 35mm f/2.8, extremely rare color variant"),
        ("Olympus Mju Zoom 105", "Olympus", "point-and-shoot", "1993-2000", 80, "Good", True, "Standard", "Budget zoom P&S, 38-105mm, weatherproof, affordable film camera"),
        ("Nikon L35AF (Pikaichi)", "Nikon", "point-and-shoot", "1983-1986", 150, "Good", True, "Standard", "First AF P&S ever, Nikkor 35mm f/2.8, landmark camera"),
        ("Nikon L35AF2 (One Touch)", "Nikon", "point-and-shoot", "1985-1990", 100, "Good", True, "Standard", "Improved L35AF, 35mm f/2.8, autofocus, popular 80s compact"),
        ("Konica C35 EF (First Flash P&S)", "Konica", "point-and-shoot", "1975-1982", 80, "Good", True, "Standard", "First built-in flash compact, Hexanon 38mm f/2.8, milestone camera"),
        ("Konica Big Mini BM-301", "Konica", "point-and-shoot", "1990-1999", 200, "Good", True, "Standard", "35mm f/3.5, ultra-compact, zone focus, popular street camera"),
        ("Canon Autoboy 2 (Sure Shot II)", "Canon", "point-and-shoot", "1984-1989", 60, "Good", True, "Standard", "Budget AF compact, 38mm f/2.8, clamshell, 80s nostalgia"),
        ("Canon Sureshot 80 Tele", "Canon", "point-and-shoot", "1988-1993", 50, "Good", True, "Standard", "Dual-lens P&S, 38/80mm, affordable zoom alternative"),
        ("Minolta Hi-Matic 7s II", "Minolta", "compact", "1977-1981", 120, "Good", True, "Standard", "Rokkor 40mm f/1.7, rangefinder compact, fast lens on budget"),
        ("Minolta CLE (Leitz-Minolta)", "Minolta", "rangefinder", "1981-1985", 800, "Excellent", False, "Rare", "M-mount rangefinder, TTL flash, AE mode, Leica/Minolta collab"),

        # ── Russian & Eastern European ─────────────────────────────────
        ("Zorki 4K + Jupiter 50mm f/2", "Zorki", "rangefinder", "1972-1978", 80, "Good", True, "Standard", "Soviet Leica copy, Jupiter-8 lens, affordable rangefinder entry"),
        ("FED-2 (Type B) + Industar 26m 50mm f/2.8", "FED", "rangefinder", "1955-1970", 60, "Good", True, "Standard", "Ukrainian Leica copy, Industar lens, budget vintage rangefinder"),
        ("Kiev 60 TTL + Vega 90mm f/2.8", "Kiev", "medium format", "1984-2000", 250, "Good", True, "Standard", "Ukrainian Pentacon Six copy, 6x6 SLR, cheap medium format"),
        ("Pentacon Six TL + Biometar 80mm f/2.8", "Pentacon", "medium format", "1968-1990", 200, "Good", True, "Standard", "East German 6x6 SLR, Carl Zeiss Jena Biometar, historic"),
        ("Jupiter-3 50mm f/1.5 (L39 Screw Mount)", "Jupiter", "rangefinder", "1950-1990", 200, "Good", True, "Standard", "Soviet Sonnar copy, f/1.5 fast, beautiful rendering, bargain fast lens"),
        ("Jupiter-9 85mm f/2 (M42 Mount)", "Jupiter", "SLR", "1957-1992", 100, "Good", True, "Standard", "Soviet Sonnar 85/2 copy, M42 mount, portrait lens, swirly bokeh"),
        ("Helios 44-2 58mm f/2 (M42 Mount)", "Helios", "SLR", "1960-1990", 50, "Good", True, "Standard", "Soviet Biotar copy, famous swirly bokeh, cult vintage lens"),

        # ── Miscellaneous / Accessories ─────────────────────────────────
        ("Nikon F Photomic FTn (Chrome, Early)", "Nikon", "SLR", "1968-1974", 400, "Good", False, "Standard", "Through-the-lens metering F, center-weighted, iconic prism hump"),
        ("Nikon F (Plain Prism, Chrome)", "Nikon", "SLR", "1959-1974", 600, "Good", False, "Standard", "Original Nikon F with eye-level prism, revolutionary SLR, milestone"),
        ("Nikon F (Eyelevel, Black, NASA)", "Nikon", "SLR", "1959-1974", 3000, "Good", False, "Rare", "Black F bodies used by NASA, extremely rare, space heritage"),
        ("Canon Pellix QL", "Canon", "SLR", "1965-1970", 200, "Good", False, "Standard", "Fixed pellicle mirror SLR, no blackout, unique FD predecessor"),
        ("Pentax Spotmatic F (Black)", "Pentax", "SLR", "1973-1976", 120, "Good", False, "Standard", "Open-aperture TTL metering, M42 mount, excellent build quality"),
        ("Pentax MX (Black)", "Pentax", "SLR", "1976-1985", 250, "Good", False, "Standard", "Compact mechanical SLR, K-mount, smallest full-feature SLR of its era"),
        ("Pentax LX (Black)", "Pentax", "SLR", "1980-2001", 500, "Excellent", False, "Standard", "Professional K-mount, modular viewfinders, weather-sealed, underrated"),
        ("Minolta SRT-101 (Chrome)", "Minolta", "SLR", "1966-1975", 100, "Good", False, "Standard", "CLC metering pioneer, MC Rokkor lenses, popular student SLR"),
        ("Minolta X-700 (Black)", "Minolta", "SLR", "1981-1999", 150, "Good", False, "Standard", "Program mode SLR, MD mount, last great Minolta manual focus body"),
        ("Minolta XD-7 (XD-11 in USA)", "Minolta", "SLR", "1977-1981", 250, "Good", False, "Standard", "First dual-mode AE SLR, aperture + shutter priority, Leitz collaboration"),
        ("Gossen Luna-Pro F Light Meter", "Gossen", "SLR", "1980-2000", 100, "Good", False, "Standard", "Ambient/flash incident meter, analog, reliable professional tool"),
        ("Weston Master V Light Meter", "Weston", "SLR", "1963-1975", 60, "Good", False, "Standard", "Classic selenium cell meter, no batteries needed, vintage charm"),
        ("Horseman 45FA Field Camera (4x5)", "Horseman", "large format", "1985-2005", 600, "Good", False, "Standard", "Metal field 4x5, full movements, compact folding, Japanese quality"),
        ("Wista 45D Field Camera (4x5)", "Wista", "large format", "1980-2005", 500, "Good", False, "Standard", "Cherry wood 4x5 field camera, classic Japanese woodcraft, full movements"),
        ("Chamonix 045N-2 Field Camera (4x5)", "Chamonix", "large format", "2010-present", 800, "Mint", False, "Standard", "Modern lightweight 4x5, carbon fiber/wood hybrid, ultralight"),
    ]


def _round12_expansion() -> list[tuple]:
    """Round 12 — 430+ items across Leica, Hasselblad, Rolleiflex, Mamiya,
    Pentax, Canon, Nikon, Contax, Olympus, digital backs, Zeiss/Voigtlander/Summicron
    lenses, Polaroid, Holga/Diana/LOMO, to push catalog past 800 items."""
    return [
        # ── Leica M-bodies (additional serial/finish variants) ────────────
        ("Leica M3 Original Kit (With Leica Meter MR)", "Leica", "rangefinder", "1954-1966", 3200, "Good", False, "Standard", "M3 with clip-on Leica Meter MR selenium meter, complete vintage kit"),
        ("Leica M3 Mid-Production (Chrome)", "Leica", "rangefinder", "1958-1962", 2600, "Good", False, "Standard", "Mid-production single stroke M3, known for quality of assembly"),
        ("Leica M3 Late Production (Chrome)", "Leica", "rangefinder", "1962-1966", 2400, "Good", False, "Standard", "Late M3 production, refined tooling, reliable user camera"),
        ("Leica M3 Press (Rapid Wind Trigger)", "Leica", "rangefinder", "1955-1966", 3800, "Good", False, "Rare", "M3 with Leicavit MP rapid wind trigger, press photographer's kit"),
        ("Leica M6 Wetzlar (Early Production)", "Leica", "rangefinder", "1984-1987", 3600, "Excellent", False, "Rare", "Early Wetzlar-assembled M6, pre-Solms production, collector premium"),
        ("Leica M6 Millennium Edition", "Leica", "rangefinder", "2000", 4800, "Mint", False, "Rare", "Y2K limited edition M6 TTL, black paint, only 2000 made"),
        ("Leica M6 'Historica' (Leitz Park)", "Leica", "rangefinder", "1994", 6000, "Excellent", False, "Rare", "Leica Historica Society edition, engraved, very limited"),
        ("Leica M6 Colombo '92 Edition", "Leica", "rangefinder", "1992", 5500, "Excellent", False, "Rare", "Colombo 500 years anniversary, gold-plated, 200 units"),
        ("Leica M6 Anton Bruckner Edition", "Leica", "rangefinder", "1996", 5800, "Mint", False, "Rare", "Austria-only Bruckner edition, engraved top plate, 200 units"),
        ("Leica M6 Royal Photographic Society", "Leica", "rangefinder", "1994", 5200, "Excellent", False, "Rare", "RPS UK edition, limited run of 150 units"),
        ("Leica M6 Schmidt 100 Years Edition", "Leica", "rangefinder", "1996", 5500, "Excellent", False, "Rare", "Schmidt Taiwan centenary, 300 units, gold-trim details"),
        ("Leica M7 0.58x Black", "Leica", "rangefinder", "2002-2018", 3800, "Excellent", False, "Standard", "Wide-angle viewfinder M7, ideal for 28/35mm shooters"),
        ("Leica M7 0.85x Chrome", "Leica", "rangefinder", "2002-2018", 4200, "Excellent", False, "Rare", "Tele viewfinder M7 chrome, ideal for 50/75/90mm"),
        ("Leica M7 à la Carte (Custom)", "Leica", "rangefinder", "2005-2015", 5500, "Mint", False, "Rare", "Custom à la Carte build, personalised engravings/leathers"),
        ("Leica MP à la Carte (Custom)", "Leica", "rangefinder", "2005-2015", 6500, "Mint", False, "Rare", "Custom à la Carte MP, choose finish/covering/viewfinder"),
        ("Leica MP Classic (Black Paint, Brass)", "Leica", "rangefinder", "2003-present", 5800, "Mint", False, "Standard", "Brass top/bottom, classic engraved script logo, black paint"),
        ("Leica MP 3 'LHSA Edition' Chrome", "Leica", "rangefinder", "2004", 7500, "Mint", False, "Rare", "LHSA 35th anniversary, classic M3 styling, 1000 units"),
        ("Leica MP 6 Chrome", "Leica", "rangefinder", "2003", 8200, "Mint", False, "Rare", "Hybrid M6-style MP, only 700 made, collector grail"),
        ("Leica M7 Hermès Edition", "Leica", "rangefinder", "2003-2004", 12000, "Mint", False, "Rare", "Hermès-covered M7, leather goods brand collab, 200 units"),
        ("Leica M4-P 70th Anniversary", "Leica", "rangefinder", "1984", 4500, "Excellent", False, "Rare", "70 years of Leica 1914-1984, commemorative engraving, 2500 units"),
        ("Leica M4 50 Jahre Gold", "Leica", "rangefinder", "1975", 14000, "Mint", False, "Rare", "Gold-plated 50 years edition, Oskar Barnack tribute, 1200 units"),
        ("Leica IIIf (Red Dial, Self-Timer)", "Leica", "rangefinder", "1954-1956", 900, "Good", False, "Standard", "Red dial late IIIf with ST flash sync, screw mount"),
        ("Leica IIIg (Late Production, Chrome)", "Leica", "rangefinder", "1958-1960", 1400, "Excellent", False, "Standard", "Late IIIg production, best build of screw-mount Leicas"),
        ("Leica IIIc (Grey Paint, Wartime)", "Leica", "rangefinder", "1940-1946", 2000, "Good", False, "Rare", "Grey-painted wartime IIIc, scarce Luftwaffe variant"),

        # ── Leica R-system bodies ─────────────────────────────────────
        ("Leica R3 Safari (Olive)", "Leica", "SLR", "1977", 1200, "Excellent", False, "Rare", "Safari olive R3, Minolta-collab body, limited run"),
        ("Leica R4 MOT Electronic", "Leica", "SLR", "1980-1987", 550, "Good", False, "Standard", "R4 with motor drive connector, multi-mode electronic R-mount"),
        ("Leica R4s Mod P", "Leica", "SLR", "1983-1987", 500, "Good", False, "Standard", "Stripped-down R4s, aperture-priority and manual only"),
        ("Leica R5 Black Chrome", "Leica", "SLR", "1987-1992", 500, "Good", False, "Standard", "TTL flash, multi-mode R-mount SLR, robust build"),
        ("Leica R6.2 Chrome", "Leica", "SLR", "1992-2002", 1000, "Excellent", False, "Standard", "Chrome R6.2, mechanical aperture-priority, battery only for metering"),
        ("Leica R7 Anthracite", "Leica", "SLR", "1992-1997", 550, "Good", False, "Standard", "Anthracite grey R7, fast 1/2000 shutter, matrix meter"),
        ("Leica R8 Silver Chrome", "Leica", "SLR", "1996-2002", 700, "Excellent", False, "Standard", "Silver chrome R8, Audi Design, DMR back compatible"),
        ("Leica R9 Anthracite", "Leica", "SLR", "2002-2009", 900, "Excellent", False, "Standard", "Lightweight R9 anthracite, last film Leica R-mount SLR"),

        # ── Leica Summicron/Summilux/Noctilux lenses ──────────────────
        ("Leica Summicron-M 35mm f/2 ASPH (6-bit)", "Leica", "rangefinder", "2005-2015", 2500, "Excellent", True, "Standard", "Aspherical Summicron 35, 6-bit coded for digital M, modern classic"),
        ("Leica Summicron-M 35mm f/2 ASPH II (2016)", "Leica", "rangefinder", "2016-present", 2800, "Mint", True, "Standard", "Updated ASPH Summicron 35, improved coatings, compact"),
        ("Leica Summicron-M 50mm f/2 V5 (6-bit)", "Leica", "rangefinder", "2012-present", 2200, "Mint", True, "Standard", "Current Summicron 50, 6-bit coded, floating element, reference"),
        ("Leica Summicron-M 50mm f/2 Type IV (Black Chrome)", "Leica", "rangefinder", "1979-2013", 1800, "Excellent", True, "Standard", "Type IV Summicron 50, black chrome, renowned optical formula"),
        ("Leica Summicron-M 75mm f/2 APO ASPH", "Leica", "rangefinder", "2005-present", 3800, "Mint", True, "Rare", "APO Summicron 75, reference portrait, 6-bit coded"),
        ("Leica Summicron-M 90mm f/2 APO ASPH", "Leica", "rangefinder", "1998-present", 3500, "Excellent", True, "Standard", "APO Summicron 90, razor-sharp tele, floating element"),
        ("Leica Summicron-M 28mm f/2 ASPH", "Leica", "rangefinder", "2000-present", 3200, "Mint", True, "Standard", "Fast wide ASPH Summicron, compact 28, 6-bit coded"),
        ("Leica Summilux-M 35mm f/1.4 ASPH (6-bit)", "Leica", "rangefinder", "2010-present", 4200, "Mint", True, "Standard", "Current Summilux 35 ASPH, floating element, reference fast wide"),
        ("Leica Summilux-M 35mm f/1.4 ASPH FLE (Black Paint)", "Leica", "rangefinder", "2010-present", 5200, "Mint", True, "Rare", "Black paint FLE Summilux 35, brass barrel, coveted variant"),
        ("Leica Summilux-M 50mm f/1.4 ASPH (Black Chrome)", "Leica", "rangefinder", "2004-present", 3800, "Mint", True, "Standard", "Current Summilux 50 ASPH, floating element, modern classic"),
        ("Leica Summilux-M 50mm f/1.4 ASPH Silver Chrome", "Leica", "rangefinder", "2004-present", 4000, "Mint", True, "Standard", "Silver chrome Summilux 50 ASPH, brass barrel, elegant pairing"),
        ("Leica Summilux-M 75mm f/1.4 E60", "Leica", "rangefinder", "1980-2007", 3000, "Good", True, "Rare", "Fast portrait tele, E60 filter, famous glow wide open"),
        ("Leica Summilux-M 21mm f/1.4 ASPH", "Leica", "rangefinder", "2008-present", 5500, "Mint", True, "Rare", "Ultra-fast wide ASPH, premium reportage lens"),
        ("Leica Summilux-M 24mm f/1.4 ASPH", "Leica", "rangefinder", "2008-present", 4800, "Mint", True, "Rare", "Fast 24 ASPH, reference wide-angle for Leica M"),
        ("Leica Noctilux-M 50mm f/0.95 ASPH", "Leica", "rangefinder", "2008-present", 9500, "Mint", True, "Rare", "Flagship Noctilux, aspherical, unmatched low-light aperture"),
        ("Leica Noctilux-M 50mm f/1.0 V4", "Leica", "rangefinder", "2000-2008", 6500, "Excellent", True, "Rare", "Late V4 Noctilux 50/1, 6-bit codable, dream bokeh"),
        ("Leica Noctilux-M 50mm f/1.2 (1966)", "Leica", "rangefinder", "1966-1975", 25000, "Good", True, "Rare", "Original hand-ground aspherical Noctilux, legendary grail"),
        ("Leica APO-Summicron-M 35mm f/2 ASPH", "Leica", "rangefinder", "2021-present", 7200, "Mint", True, "Rare", "APO-corrected 35 Summicron, modern optical pinnacle"),
        ("Leica APO-Summicron-M 50mm f/2 ASPH Black Chrome", "Leica", "rangefinder", "2012-present", 7800, "Mint", True, "Rare", "APO Summicron 50, reference-class standard lens"),
        ("Leica Elmarit-M 21mm f/2.8 ASPH", "Leica", "rangefinder", "1997-2008", 2200, "Excellent", True, "Standard", "Wide Elmarit 21 ASPH, excellent rectilinear performance"),
        ("Leica Elmarit-M 24mm f/2.8 ASPH", "Leica", "rangefinder", "1996-2008", 2000, "Good", True, "Standard", "Wide Elmarit 24 ASPH, compact reportage lens"),
        ("Leica Elmarit-M 28mm f/2.8 ASPH", "Leica", "rangefinder", "2006-present", 2500, "Mint", True, "Standard", "Compact ASPH wide-angle, 6-bit coded"),
        ("Leica Tri-Elmar-M 16-18-21mm f/4 ASPH WATE", "Leica", "rangefinder", "2006-present", 4500, "Mint", True, "Rare", "Ultra-wide tri-focal, Wide-Angle Tri-Elmar (WATE)"),
        ("Leica Tri-Elmar-M 28-35-50mm f/4 ASPH MATE", "Leica", "rangefinder", "1998-2007", 2200, "Good", True, "Standard", "Mid-range tri-focal, MATE, versatile travel lens"),
        ("Leica Elmar-M 50mm f/2.8 Collapsible (Current)", "Leica", "rangefinder", "1994-2007", 1200, "Good", True, "Standard", "Modern collapsible Elmar 50, compact and classic"),
        ("Leica Summarit-M 35mm f/2.5", "Leica", "rangefinder", "2007-2014", 1400, "Excellent", True, "Standard", "Budget-friendly Summarit 35, compact and sharp"),
        ("Leica Summarit-M 50mm f/2.5", "Leica", "rangefinder", "2007-2014", 1200, "Excellent", True, "Standard", "Entry-level M lens, excellent value for the Leica glass tier"),
        ("Leica Summarit-M 75mm f/2.5", "Leica", "rangefinder", "2007-2014", 1400, "Excellent", True, "Standard", "Short-tele Summarit, portrait lens, affordable Leica option"),
        ("Leica Summarit-M 90mm f/2.5", "Leica", "rangefinder", "2007-2014", 1500, "Excellent", True, "Standard", "Compact 90 Summarit, great portrait tele, modern design"),
        ("Leica Summarex 85mm f/1.5 (LTM)", "Leica", "rangefinder", "1943-1962", 3800, "Good", True, "Rare", "Ultra-fast portrait LTM lens, 85/1.5, rare early tele"),

        # ── Hasselblad (additional V-system + H-series + backs) ───────
        ("Hasselblad 500EL (Original, NASA Lineage)", "Hasselblad", "medium format", "1964-1971", 1200, "Good", False, "Standard", "Motorised 500EL, direct NASA Apollo heritage"),
        ("Hasselblad 553ELX Chrome", "Hasselblad", "medium format", "1988-1999", 1500, "Good", False, "Standard", "Chrome 553ELX, motorised V-system, studio workhorse"),
        ("Hasselblad 555ELD", "Hasselblad", "medium format", "1998-2006", 1800, "Excellent", False, "Standard", "Last ELD motorised V, digital back interface on body"),
        ("Hasselblad 205TCC", "Hasselblad", "medium format", "1991-1995", 1800, "Good", False, "Rare", "Zone System metering, focal plane shutter, TCC F-lenses"),
        ("Hasselblad 203FE", "Hasselblad", "medium format", "1994-2004", 1600, "Good", False, "Standard", "Focal plane shutter, F-series lens compatible, spot metering"),
        ("Hasselblad 2003FCW", "Hasselblad", "medium format", "1988-1991", 1400, "Good", False, "Standard", "Focal plane shutter V-system, winder-compatible"),
        ("Hasselblad Flexbody (Tilt-Shift)", "Hasselblad", "medium format", "1995-2003", 1000, "Good", False, "Standard", "Tilt-shift V body, architecture/product specialist"),
        ("Hasselblad ArcBody Kit (Rodenstock 35mm)", "Hasselblad", "medium format", "1997-2005", 2500, "Good", True, "Rare", "ArcBody with Rodenstock Apo-Grandagon 35mm, rare kit"),
        ("Hasselblad 503CX", "Hasselblad", "medium format", "1988-1994", 1700, "Good", False, "Standard", "Databus, acute-matte D screen, pre-CW V-system"),
        ("Hasselblad 501C (Blue Leatherette)", "Hasselblad", "medium format", "1994-1997", 1800, "Excellent", False, "Rare", "Blue leatherette special edition 501C"),
        ("Hasselblad H1 Body", "Hasselblad", "medium format", "2002-2007", 1500, "Excellent", False, "Standard", "First H-system AF medium format, Fuji co-developed"),
        ("Hasselblad H2 Body", "Hasselblad", "medium format", "2006-2010", 1800, "Excellent", False, "Standard", "Improved H-system body, digital back compatible"),
        ("Hasselblad H3D-39 Back", "Hasselblad", "medium format", "2008-2010", 3500, "Excellent", False, "Rare", "39MP digital back, H-system, studio/product photography"),
        ("Hasselblad H3DII-50 Back", "Hasselblad", "medium format", "2009-2012", 4500, "Excellent", False, "Rare", "50MP digital back, H-system flagship of era"),
        ("Hasselblad CFV-50 Back (V-mount)", "Hasselblad", "medium format", "2006-2012", 3500, "Excellent", False, "Rare", "Digital back for V-system bodies, 50MP CCD"),
        ("Hasselblad CFV-50c Back (V-mount, CMOS)", "Hasselblad", "medium format", "2014-2020", 4800, "Excellent", False, "Rare", "CMOS-based digital back for V-system, tilt LCD"),
        ("Hasselblad CFV II 50c Back", "Hasselblad", "medium format", "2020-present", 5500, "Mint", False, "Rare", "Modern digital back, tiltable touch display, V-system"),
        ("Hasselblad Carl Zeiss Distagon 40mm f/4 CF FLE", "Hasselblad", "medium format", "1982-2006", 1500, "Excellent", True, "Rare", "Ultra-wide V-system lens, floating element, architecture"),
        ("Hasselblad Carl Zeiss Distagon 60mm f/3.5 CF", "Hasselblad", "medium format", "1982-2006", 700, "Good", True, "Standard", "Moderate wide V-system, versatile focal length"),
        ("Hasselblad Carl Zeiss Sonnar 180mm f/4 CF", "Hasselblad", "medium format", "1982-2006", 600, "Good", True, "Standard", "Short tele Sonnar, great for portraits/sports"),
        ("Hasselblad Carl Zeiss Tele-Tessar 350mm f/5.6", "Hasselblad", "medium format", "1982-2006", 800, "Good", True, "Rare", "Long telephoto for V-system, wildlife/sports"),
        ("Hasselblad PME45 Prism Finder", "Hasselblad", "medium format", "1995-2006", 500, "Good", False, "Standard", "45-degree metered prism finder, comfortable eye-level viewing"),
        ("Hasselblad PME90 Prism Finder", "Hasselblad", "medium format", "1990-2005", 400, "Good", False, "Standard", "Eye-level metered prism, TTL metering for V-system"),
        ("Hasselblad Winder CW", "Hasselblad", "medium format", "1996-2013", 350, "Good", False, "Standard", "Winder for 503CW, 1.3fps advance, IR remote compatible"),

        # ── Rolleiflex additional ────────────────────────────────────
        ("Rolleiflex 2.8F Platinum Edition", "Rolleiflex", "TLR", "1981", 6000, "Mint", True, "Rare", "Platinum-plated 2.8F, extremely limited, collector piece"),
        ("Rolleiflex 2.8F Aurum (Gold Plated)", "Rolleiflex", "TLR", "1983", 5500, "Mint", True, "Rare", "Gold-plated 2.8F Aurum, 444 units, crocodile leather"),
        ("Rolleiflex 2.8F Gold Edition 75 Years", "Rolleiflex", "TLR", "1995", 5200, "Excellent", True, "Rare", "Franke & Heidecke 75-year anniversary gold edition"),
        ("Rolleiflex 3.5F Type 3 Planar", "Rolleiflex", "TLR", "1962-1976", 1700, "Excellent", True, "Standard", "Late 3.5F with Planar 75/3.5, refined meter"),
        ("Rolleiflex 3.5F Type 3 Xenotar", "Rolleiflex", "TLR", "1962-1976", 1600, "Good", True, "Standard", "3.5F with Schneider Xenotar 75/3.5, sharp taking lens"),
        ("Rolleiflex Automat K4B (MX-EVS)", "Rolleiflex", "TLR", "1956-1960", 550, "Good", True, "Standard", "Knob-advance Automat, coupled EV system, Tessar lens"),
        ("Rolleiflex 4x4 Baby Grey", "Rolleiflex", "TLR", "1957-1963", 400, "Good", True, "Standard", "127 film 4x4 baby TLR, grey leatherette"),
        ("Rolleiflex 4x4 Baby Black", "Rolleiflex", "TLR", "1957-1963", 450, "Good", True, "Standard", "127 film 4x4 baby TLR, black, collectible"),
        ("Rolleiflex Magic II", "Rolleiflex", "TLR", "1959-1962", 350, "Good", True, "Standard", "Auto-exposure TLR, light meter coupled, Xenar 75/3.5"),
        ("Rollei 35 Classic Gold", "Rolleiflex", "compact", "1992", 1400, "Mint", True, "Rare", "Gold-plated Rollei 35 Classic, HFT Sonnar, only 1500 made"),
        ("Rollei 35 Classic Platinum", "Rolleiflex", "compact", "1992", 1800, "Mint", True, "Rare", "Platinum Rollei 35 Classic, ultra-limited anniversary edition"),
        ("Rollei 35 Platin", "Rolleiflex", "compact", "1986", 1200, "Mint", True, "Rare", "Platinum Rollei 35, lizard leather, Sonnar 40/2.8"),
        ("Rollei 35 Royal Singapore", "Rolleiflex", "compact", "1979", 600, "Good", True, "Standard", "Royal-engraved 35, Singapore-production years"),
        ("Rollei 35 Original Germany", "Rolleiflex", "compact", "1966-1974", 500, "Good", True, "Standard", "Germany-built original Rollei 35, Tessar 40/3.5, prized variant"),
        ("Rollei 35 SE (Black)", "Rolleiflex", "compact", "1979-1981", 350, "Good", True, "Standard", "Sonnar 40/2.8 HFT black 35 SE, LED metering"),
        ("Rollei 35 LED", "Rolleiflex", "compact", "1978-1980", 250, "Good", True, "Standard", "LED-metered 35, HFT Tessar 40/3.5, zone focus"),
        ("Rollei AFM 35", "Rolleiflex", "compact", "2002-2005", 400, "Excellent", True, "Standard", "AF Rollei compact, HFT Sonnar 38/2.6, titanium"),
        ("Rollei 35 Classic Titanium", "Rolleiflex", "compact", "1990-1995", 600, "Excellent", True, "Standard", "Titanium Rollei 35 Classic, HFT Sonnar 40/2.8"),

        # ── Mamiya additional (RB67/RZ67/7/7II/C330/Press) ────────────
        ("Mamiya 7 Body Only (Black)", "Mamiya", "rangefinder", "1995-1999", 1800, "Good", False, "Rare", "Original Mamiya 7 6x7 rangefinder body, ultra-compact medium format"),
        ("Mamiya 7 + 80mm f/4 N", "Mamiya", "rangefinder", "1995-1999", 2600, "Excellent", True, "Rare", "Classic Mamiya 7 kit, 80/4 N standard lens"),
        ("Mamiya 7 II + 80mm f/4 N (Chrome)", "Mamiya", "rangefinder", "1999-2014", 3200, "Excellent", True, "Rare", "Chrome Mamiya 7 II with 80/4 N, highly sought travel kit"),
        ("Mamiya 7 II + 43mm f/4.5 L (Ultra-Wide)", "Mamiya", "rangefinder", "1999-2014", 4500, "Excellent", True, "Rare", "7II with 43/4.5 L + external finder, ultra-wide kit"),
        ("Mamiya 7 II + 65mm f/4 L (Wide)", "Mamiya", "rangefinder", "1999-2014", 3500, "Excellent", True, "Rare", "7II with 65/4 L, wide-angle landscape kit"),
        ("Mamiya 7 II + 150mm f/4.5 L (Tele)", "Mamiya", "rangefinder", "1999-2014", 3200, "Excellent", True, "Rare", "7II with 150/4.5 L + external finder, portrait tele"),
        ("Mamiya 7 43mm f/4.5 L Lens", "Mamiya", "rangefinder", "1999-2014", 2200, "Good", True, "Rare", "Ultra-wide lens for Mamiya 7, requires external finder"),
        ("Mamiya 7 50mm f/4.5 L Lens", "Mamiya", "rangefinder", "1995-2014", 1500, "Good", True, "Standard", "Wide 50/4.5 for Mamiya 7, sharp across frame"),
        ("Mamiya 7 65mm f/4 L Lens", "Mamiya", "rangefinder", "1995-2014", 1100, "Good", True, "Standard", "Moderate wide 65/4 for Mamiya 7, landscape favourite"),
        ("Mamiya 7 150mm f/4.5 L Lens", "Mamiya", "rangefinder", "1995-2014", 900, "Good", True, "Standard", "Short tele for Mamiya 7, requires external finder"),
        ("Mamiya 7 210mm f/8 L Lens", "Mamiya", "rangefinder", "2000-2014", 1600, "Good", True, "Rare", "Long tele for Mamiya 7, extremely rare rangefinder lens"),
        ("Mamiya C330 Pro", "Mamiya", "TLR", "1969-1982", 400, "Good", True, "Standard", "Interchangeable-lens 6x6 TLR, bellows focusing, parallax correction"),
        ("Mamiya C330 Pro S", "Mamiya", "TLR", "1982-1994", 550, "Good", True, "Standard", "Updated C330, improved parallax indicator, bright screen"),
        ("Mamiya C220 Pro F", "Mamiya", "TLR", "1982-1995", 400, "Good", True, "Standard", "Budget C-series TLR, no crank, knob advance, interchangeable lenses"),
        ("Mamiya Sekor 55mm f/4.5 (C-series)", "Mamiya", "TLR", "1970-1994", 250, "Good", True, "Standard", "Wide-angle TLR lens pair for C-series, rectilinear"),
        ("Mamiya Sekor 80mm f/2.8 Blue Dot (C-series)", "Mamiya", "TLR", "1975-1994", 300, "Excellent", True, "Standard", "Updated coating Blue Dot 80/2.8, standard TLR lens"),
        ("Mamiya Sekor 180mm f/4.5 (C-series)", "Mamiya", "TLR", "1970-1994", 250, "Good", True, "Standard", "Tele TLR lens pair, portrait compression"),
        ("Mamiya Sekor 250mm f/6.3 (C-series)", "Mamiya", "TLR", "1972-1994", 350, "Good", True, "Rare", "Long tele for C-series TLR, rare and specialised"),
        ("Mamiya RB67 Pro", "Mamiya", "medium format", "1970-1974", 400, "Good", False, "Standard", "Original RB67, revolving back 6x7, fully mechanical"),
        ("Mamiya RB67 ProSD + 90mm KL", "Mamiya", "medium format", "1990-2005", 1000, "Excellent", True, "Standard", "ProSD with 90/3.5 KL, modern coatings, studio standard"),
        ("Mamiya RZ67 Pro IID + 110mm f/2.8 W", "Mamiya", "medium format", "2004-2014", 2000, "Excellent", True, "Rare", "Digital-ready IID, 110/2.8 W portrait kit"),
        ("Mamiya Sekor Z 90mm f/3.5 W (RZ67)", "Mamiya", "medium format", "1982-2005", 300, "Good", True, "Standard", "Standard wide for RZ67, floating element, sharp"),
        ("Mamiya Sekor Z 75mm f/4.5 SB (RZ67)", "Mamiya", "medium format", "1985-2005", 500, "Good", True, "Standard", "Shift lens for RZ67, architecture/product"),
        ("Mamiya Sekor Z 350mm f/5.6 APO (RZ67)", "Mamiya", "medium format", "1990-2005", 800, "Good", True, "Rare", "Long tele APO for RZ67, sports/wildlife in MF"),

        # ── Pentax additional (67/67II/LX/K1000/Spotmatic) ────────────
        ("Pentax 67 (MLU, Wooden Grip)", "Pentax", "medium format", "1976-1989", 700, "Good", False, "Standard", "6x7 with mirror lock-up, walnut grip, landscape/portrait standard"),
        ("Pentax 67II (AE Prism, Silver)", "Pentax", "medium format", "1998-2005", 1400, "Excellent", True, "Limited Edition", "Updated 67II, AE prism, modern viewfinder"),
        ("Pentax 67II + SMC 105mm f/2.4 Kit", "Pentax", "medium format", "1998-2005", 2200, "Excellent", True, "Rare", "67II + legendary 105/2.4 portrait kit"),
        ("Pentax 6x7 (Non-TTL, Early)", "Pentax", "medium format", "1969-1976", 450, "Good", False, "Standard", "Pre-TTL 6x7, plain prism, mechanical warhorse"),
        ("Pentax 67 TTL Prism Finder", "Pentax", "medium format", "1976-1989", 200, "Good", False, "Standard", "TTL metering prism for Pentax 67, center-weighted"),
        ("SMC Pentax 67 55mm f/4", "Pentax", "medium format", "1980-2009", 350, "Good", True, "Standard", "Moderate wide for 67, compact and affordable"),
        ("SMC Pentax 67 90mm f/2.8 Leaf Shutter", "Pentax", "medium format", "1980-2009", 800, "Good", True, "Rare", "Leaf-shutter 90mm for 67, flash sync to 1/500, studio favourite"),
        ("SMC Pentax 67 200mm f/4", "Pentax", "medium format", "1980-2009", 250, "Good", True, "Standard", "Classic tele for 67, compact, portrait compression"),
        ("SMC Pentax 67 400mm f/4 ED IF", "Pentax", "medium format", "1990-2009", 900, "Good", True, "Rare", "ED long tele for 67, wildlife/sports medium format"),
        ("Pentax LX Chrome", "Pentax", "SLR", "1980-2001", 650, "Excellent", False, "Limited Edition", "Chrome LX variant, weather-sealed pro K-mount flagship"),
        ("Pentax LX 2000 (Anniversary Edition)", "Pentax", "SLR", "2001", 1800, "Mint", False, "Rare", "Final LX anniversary edition, only 300 units, gold-plated nameplate"),
        ("Pentax LX Titan (Titanium)", "Pentax", "SLR", "1994", 2500, "Excellent", False, "Rare", "Titanium LX, limited production, professional flagship variant"),
        ("Pentax K1000 SE Brown Leatherette", "Pentax", "SLR", "1976-1997", 200, "Excellent", True, "Standard", "Brown leatherette SE variant, split-image focus screen"),
        ("Pentax ME", "Pentax", "SLR", "1976-1984", 120, "Good", True, "Standard", "Aperture-priority only, compact K-mount SLR, student favourite"),
        ("Pentax MV", "Pentax", "SLR", "1979-1981", 100, "Good", True, "Standard", "Budget M-series, aperture-priority, ultra-compact"),
        ("Pentax Spotmatic II (Chrome)", "Pentax", "SLR", "1971-1974", 150, "Good", True, "Standard", "Updated Spotmatic, open-aperture TTL, M42 mount"),
        ("Pentax Spotmatic SP II (Black)", "Pentax", "SLR", "1971-1974", 200, "Good", True, "Standard", "Black Spotmatic II, rarer variant, M42 classic"),
        ("Pentax ES (Electro Spotmatic)", "Pentax", "SLR", "1971-1973", 180, "Good", False, "Standard", "First Pentax AE SLR, electronic shutter, M42 mount"),
        ("Pentax K2 DMD", "Pentax", "SLR", "1976-1980", 250, "Good", False, "Rare", "Data Motor Drive variant of K2, rare early K-mount"),
        ("Pentax SV (Classic Screw Mount)", "Pentax", "SLR", "1962-1968", 150, "Good", True, "Standard", "M42 mount, self-timer, pre-Spotmatic classic"),
        ("Pentax SP1000", "Pentax", "SLR", "1973-1975", 120, "Good", True, "Standard", "Budget Spotmatic variant, no self-timer, stop-down metering"),
        ("Pentax H1a", "Pentax", "SLR", "1963-1966", 150, "Good", True, "Standard", "Early M42 Pentax, self-timer, classic Japanese SLR"),
        ("Pentax K-mount 50mm f/1.2", "Pentax", "SLR", "1975-1985", 600, "Excellent", True, "Rare", "Fast K-mount normal, rare Pentax 50/1.2 optic"),

        # ── Canon additional (AE-1/F-1/A-1/EOS-1v/rangefinders) ──────
        ("Canon AE-1 Program (Chrome)", "Canon", "SLR", "1981-1987", 220, "Good", True, "Standard", "Chrome AE-1 Program, program auto mode, FD mount"),
        ("Canon A-1 Chrome Trim", "Canon", "SLR", "1978-1985", 320, "Good", False, "Standard", "Rare chrome-trim A-1 variant, multi-mode AE"),
        ("Canon AT-1", "Canon", "SLR", "1976-1985", 150, "Good", True, "Standard", "Manual-only version of AE-1, mechanical sibling"),
        ("Canon AV-1 Chrome", "Canon", "SLR", "1979-1984", 140, "Good", True, "Standard", "Aperture-priority only AE-1 sibling, compact FD body"),
        ("Canon F-1n (New F-1) + AE Motor Drive FN", "Canon", "SLR", "1981-1992", 700, "Excellent", False, "Rare", "New F-1 with motor drive FN, pro sports package"),
        ("Canon F-1 High Speed Motor Drive MF", "Canon", "SLR", "1972-1976", 1800, "Good", False, "Rare", "Olympic press F-1 pellicle mirror, 9fps, ultra-rare"),
        ("Canon F-1 Olympic Edition 1980", "Canon", "SLR", "1980", 1500, "Excellent", False, "Rare", "Olympic commemorative F-1, rare collector piece"),
        ("Canon EOS-1V HS (High Speed)", "Canon", "SLR", "2000-2012", 700, "Excellent", False, "Rare", "EOS-1V with PB-E2 booster, 10fps, final pro Canon film SLR"),
        ("Canon EOS-1N RS (Pellicle Mirror)", "Canon", "SLR", "1995-2000", 500, "Good", False, "Rare", "Pellicle mirror EOS-1N, 10fps, sports specialist"),
        ("Canon EOS 5 (EOS A2 USA)", "Canon", "SLR", "1992-1998", 200, "Good", False, "Standard", "Eye-control AF consumer SLR, 5fps, EF mount"),
        ("Canon EOS 7 (EOS 30 EU)", "Canon", "SLR", "2000-2004", 180, "Good", False, "Standard", "Eye-control AF EF-mount film SLR, enthusiast level"),
        ("Canon EOS Elan 7NE (EOS 33V)", "Canon", "SLR", "2001-2004", 220, "Good", False, "Standard", "Updated eye-control AF EF SLR, quiet film advance"),
        ("Canon IVSB (LTM)", "Canon", "rangefinder", "1952-1955", 700, "Good", False, "Standard", "Classic Canon LTM rangefinder, slow-speed dial"),
        ("Canon IVSB2 (LTM)", "Canon", "rangefinder", "1954-1956", 750, "Good", False, "Standard", "Updated IVSB, fully coupled rangefinder, LTM mount"),
        ("Canon VI-T (Trigger Advance)", "Canon", "rangefinder", "1958-1960", 650, "Good", False, "Rare", "Trigger-wind Canon rangefinder, unique base advance"),
        ("Canon 7sZ", "Canon", "rangefinder", "1965-1967", 800, "Excellent", False, "Rare", "Final Canon LTM rangefinder, improved 7s variant"),
        ("Canon Canonet 28", "Canon", "rangefinder", "1971-1976", 120, "Good", True, "Standard", "Compact fixed-lens 40/2.8 rangefinder, program auto"),
        ("Canon Canonet GIII QL19", "Canon", "rangefinder", "1972-1982", 250, "Good", True, "Standard", "40mm f/1.9 rangefinder, quick-load, smaller than GIII QL17"),
        ("Canon Demi (Half Frame)", "Canon", "compact", "1963-1966", 150, "Good", True, "Standard", "Half-frame compact, 28mm f/2.8 SH, selenium meter"),
        ("Canon Demi EE17 (Half Frame)", "Canon", "compact", "1966-1968", 250, "Good", True, "Standard", "Half-frame with 30/1.7 fast lens, rangefinder focus"),

        # ── Nikon additional (FM2/FM3A/F3/F6/S3/rangefinders) ─────────
        ("Nikon FM2n (Chrome, Classic Shutter)", "Nikon", "SLR", "1984-1989", 420, "Good", False, "Standard", "Original titanium honeycomb FM2n, 1/4000 shutter"),
        ("Nikon FM2n (Black, Later Shutter)", "Nikon", "SLR", "1989-2001", 450, "Excellent", False, "Standard", "Revised aluminium-blade FM2n, more durable shutter"),
        ("Nikon FM2/T (Titanium, Chrome)", "Nikon", "SLR", "1994-2001", 1600, "Excellent", False, "Rare", "Chrome titanium FM2/T, limited production"),
        ("Nikon FM3A Chrome", "Nikon", "SLR", "2001-2006", 1300, "Excellent", False, "Rare", "Chrome FM3A, hybrid shutter, aperture-priority"),
        ("Nikon FM3A Black", "Nikon", "SLR", "2001-2006", 1400, "Excellent", False, "Rare", "Black FM3A, final hybrid mechanical/electronic Nikon"),
        ("Nikon FM3A Millennium", "Nikon", "SLR", "2001", 2000, "Mint", False, "Rare", "Millennium commemorative FM3A, extremely limited"),
        ("Nikon F3 HP Press", "Nikon", "SLR", "1983-2001", 700, "Excellent", False, "Rare", "Press variant F3HP, no self-timer, pro-only"),
        ("Nikon F3 Limited (Chrome)", "Nikon", "SLR", "1993-1994", 1400, "Excellent", False, "Rare", "Limited chrome F3 run, Japan market, collector variant"),
        ("Nikon F3HP + MD-4 Motor Drive", "Nikon", "SLR", "1980-2001", 800, "Excellent", False, "Standard", "F3HP with MD-4 motor, 5.5fps, pro kit"),
        ("Nikon F3/T Titanium Black (Late)", "Nikon", "SLR", "1984-2001", 1800, "Mint", False, "Rare", "Late F3/T titanium, finest finish and refinement"),
        ("Nikon F6 (Final Production)", "Nikon", "SLR", "2004-2020", 1800, "Mint", False, "Rare", "Last batch F6, modern AF, EXIF on film, unicorn Nikon"),
        ("Nikon F6 + MB-40 Grip", "Nikon", "SLR", "2004-2020", 2000, "Excellent", False, "Rare", "F6 with vertical battery grip, pro flagship kit"),
        ("Nikon F5 50th Anniversary", "Nikon", "SLR", "1998", 1200, "Mint", False, "Rare", "Nikon 50th anniversary F5, gold logo, limited run"),
        ("Nikon F4 Press Kit", "Nikon", "SLR", "1988-1996", 700, "Excellent", False, "Rare", "F4 with HP finder, MF-22 data back, MB-23 grip"),
        ("Nikon S2 Chrome + Nikkor-H 5cm f/2", "Nikon", "rangefinder", "1954-1958", 1200, "Good", True, "Rare", "S2 kit with 5cm f/2, classic Nikon rangefinder setup"),
        ("Nikon S3 Millennium 2000 Black Paint", "Nikon", "rangefinder", "2000-2001", 4200, "Excellent", True, "Rare", "Black paint S3 2000, even more limited than chrome"),
        ("Nikon SP Limited 2005 Black Paint", "Nikon", "rangefinder", "2005", 7500, "Mint", True, "Rare", "Black paint SP 2005, ~500 units, ultra-rare collector grail"),
        ("Nikon S4", "Nikon", "rangefinder", "1959-1961", 1500, "Good", True, "Rare", "Rare S4 rangefinder, simplified S3, Japan domestic market"),
        ("Nikon S3M Half-Frame", "Nikon", "rangefinder", "1960-1964", 2500, "Good", True, "Rare", "Half-frame S3M, rare specialised rangefinder"),
        ("Nikon SP Black Paint (Original)", "Nikon", "rangefinder", "1957-1965", 12000, "Good", True, "Rare", "Original-production black paint SP, museum-grade rarity"),
        ("Nikon S3 Original Chrome", "Nikon", "rangefinder", "1958-1960", 1800, "Good", True, "Rare", "Original chrome S3 production, classic Nikon RF"),
        ("Nikon Nikkor-S 5cm f/1.4 (S-mount)", "Nikon", "rangefinder", "1950-1962", 400, "Good", True, "Standard", "Fast normal for S-mount rangefinders, Sonnar-derived"),
        ("Nikon Nikkor 3.5cm f/1.8 (S-mount)", "Nikon", "rangefinder", "1956-1965", 800, "Good", True, "Rare", "Legendary wide for Nikon S, reissued with SP 2005"),
        ("Nikon Nikkor-P 10.5cm f/2.5 (S-mount)", "Nikon", "rangefinder", "1954-1962", 500, "Good", True, "Standard", "Short tele for S-mount, sharp portrait rendering"),

        # ── Contax additional (T2/T3/G2/RTS/645) ──────────────────────
        ("Contax T2 (Black, Matte Finish)", "Contax", "compact", "1990-2002", 1600, "Excellent", True, "Rare", "Black matte T2, Sonnar T* 38/2.8, rarer than chrome"),
        ("Contax T2 Platinum Edition", "Contax", "compact", "1991", 2800, "Mint", True, "Rare", "Platinum-plated T2, only 500 units, true collector piece"),
        ("Contax T2 70 Years Edition", "Contax", "compact", "2002", 2400, "Mint", True, "Rare", "Zeiss 70 years, limited T2 with engraving"),
        ("Contax T3 Double Teeth Silver", "Contax", "compact", "2001-2003", 3200, "Excellent", True, "Rare", "Early T3 double-tooth sprocket, prized production variant"),
        ("Contax T3 Single Teeth Black", "Contax", "compact", "2003-2005", 3000, "Excellent", True, "Rare", "Later T3 single-tooth version, refined mechanism"),
        ("Contax T3 Black 70 Years Edition", "Contax", "compact", "2002", 3800, "Mint", True, "Rare", "Limited Zeiss 70 years T3 black, extremely rare"),
        ("Contax G2 Chrome + Planar 45mm f/2", "Contax", "rangefinder", "1996-2005", 1400, "Excellent", True, "Standard", "G2 kit with normal Planar 45/2, versatile AF RF"),
        ("Contax G1 Green Label Black", "Contax", "rangefinder", "1994-2001", 600, "Good", False, "Standard", "Black Green Label G1, updated firmware for 35/90 framelines"),
        ("Contax RTS III (Chrome)", "Contax", "SLR", "1990-2000", 800, "Excellent", False, "Rare", "Chrome RTS III, real-time vacuum, pro SLR"),
        ("Contax RX II", "Contax", "SLR", "2002-2005", 350, "Good", False, "Standard", "Final RX-series SLR, aperture-priority AE, C/Y mount"),
        ("Contax AX (Auto-Focus)", "Contax", "SLR", "1996-2000", 600, "Good", False, "Rare", "Unique moving-sensor AF, works with any C/Y lens"),
        ("Contax ST (Black)", "Contax", "SLR", "1992-1998", 400, "Good", False, "Standard", "Multi-mode C/Y SLR, 5-zone metering, quartz timing"),
        ("Contax 645 Body Only", "Contax", "medium format", "1999-2005", 1400, "Excellent", False, "Rare", "Contax 645 AF medium format body, Zeiss glass compatible"),
        ("Contax 645 + Zeiss Planar 80mm f/2 T*", "Contax", "medium format", "1999-2005", 2400, "Excellent", True, "Rare", "Contax 645 with legendary 80/2 Planar, portrait dream kit"),
        ("Contax 645 + 120mm f/4 Apo-Makro-Planar", "Contax", "medium format", "1999-2005", 3000, "Excellent", True, "Rare", "645 with APO macro 120, reference macro MF system"),
        ("Contax 645 35mm f/3.5 Distagon T*", "Contax", "medium format", "1999-2005", 1400, "Good", True, "Rare", "Wide-angle for Contax 645, rectilinear, architecture"),
        ("Contax 645 210mm f/4 Sonnar T*", "Contax", "medium format", "1999-2005", 1000, "Good", True, "Standard", "Short tele for 645, portrait compression"),
        ("Contax N1 + 50mm f/1.4 Planar N", "Contax", "SLR", "2000-2005", 600, "Good", True, "Rare", "N-mount SLR with fast Planar, last Contax system"),
        ("Contax Nx (Amateur N-System)", "Contax", "SLR", "2002-2005", 350, "Good", False, "Standard", "Budget N-system SLR, final Contax consumer SLR"),
        ("Contax N Digital", "Contax", "SLR", "2002-2005", 500, "Good", False, "Rare", "First full-frame DSLR ever made, 6MP, N-mount legacy"),
        ("Contax 139 Quartz", "Contax", "SLR", "1979-1987", 200, "Good", False, "Standard", "Compact C/Y SLR, quartz AE, Zeiss glass affordable entry"),

        # ── Olympus additional (OM-1/OM-4/XA/Pen F) ──────────────────
        ("Olympus OM-1 MD Black Body", "Olympus", "SLR", "1974-1979", 450, "Excellent", False, "Standard", "Black OM-1 with motor drive port, Maitani classic"),
        ("Olympus OM-2 SP (Spot Meter)", "Olympus", "SLR", "1984-1987", 350, "Good", False, "Rare", "Spot-metering OM-2, mechanical backup, rare pro-spec variant"),
        ("Olympus OM-3 (Mechanical)", "Olympus", "SLR", "1983-1986", 900, "Excellent", False, "Rare", "Pre-Ti mechanical OM-3, multi-spot metering, rare"),
        ("Olympus OM-4 Titanium Champagne", "Olympus", "SLR", "1986-1989", 550, "Good", False, "Standard", "Champagne-finish titanium OM-4, multi-spot metering"),
        ("Olympus XA (Original)", "Olympus", "rangefinder", "1979-1985", 280, "Good", True, "Standard", "Clamshell 35/2.8 Zuiko, aperture-priority, Maitani classic"),
        ("Olympus XA1", "Olympus", "compact", "1982-1985", 120, "Good", True, "Standard", "Selenium-metered XA1, zone focus, budget clamshell"),
        ("Olympus Pen F (Original, Half Frame)", "Olympus", "SLR", "1963-1966", 650, "Excellent", True, "Rare", "Rotary-shutter half-frame SLR, revolutionary Maitani design"),
        ("Olympus Pen FT (Half Frame, TTL)", "Olympus", "SLR", "1966-1972", 550, "Good", True, "Standard", "TTL-metered Pen F, half-frame, interchangeable lenses"),
        ("Olympus Pen FV (Half Frame, No Meter)", "Olympus", "SLR", "1967-1970", 400, "Good", True, "Standard", "Budget half-frame SLR, no metering, rotary shutter"),
        ("Olympus Pen EE-2 (Half Frame)", "Olympus", "compact", "1968-1977", 120, "Good", True, "Standard", "Selenium-metered half-frame, zone focus, D.Zuiko 28/3.5"),
        ("Olympus Pen D3 (Half Frame)", "Olympus", "compact", "1965-1972", 250, "Good", True, "Standard", "Half-frame compact, F.Zuiko 32/1.7 fast lens, CdS metering"),
        ("Olympus 35 SP (Fixed Rangefinder)", "Olympus", "rangefinder", "1969-1975", 200, "Good", True, "Standard", "G.Zuiko 42/1.7, spot/average metering rangefinder, unique"),
        ("Olympus 35 RC (Compact Rangefinder)", "Olympus", "rangefinder", "1970-1978", 150, "Good", True, "Standard", "Compact rangefinder, E.Zuiko 42/2.8, manual/shutter-priority"),
        ("Olympus Zuiko 35mm f/2 (OM)", "Olympus", "SLR", "1973-2002", 250, "Good", True, "Standard", "Fast Zuiko 35, classic reportage wide-angle"),
        ("Olympus Zuiko 24mm f/2 (OM)", "Olympus", "SLR", "1977-2002", 600, "Excellent", True, "Rare", "Fast ultra-wide Zuiko, limited production, rare OM lens"),
        ("Olympus Zuiko 180mm f/2 (OM)", "Olympus", "SLR", "1978-2002", 1200, "Excellent", True, "Rare", "Fast tele Zuiko, super-rare portrait monster"),
        ("Olympus Zuiko 200mm f/4 (OM)", "Olympus", "SLR", "1973-2002", 150, "Good", True, "Standard", "Compact 200 tele for OM, affordable wildlife lens"),
        ("Olympus Zuiko 250mm f/2 (OM)", "Olympus", "SLR", "1977-2002", 3500, "Good", True, "Rare", "Legendary super-tele Zuiko, extremely rare, telephoto grail"),
        ("Olympus Zuiko Auto Macro 80mm f/4", "Olympus", "SLR", "1978-2002", 300, "Good", True, "Standard", "Bellows-mount macro 80 for OM, 1:1 reproduction"),

        # ── Medium format digital backs ───────────────────────────────
        ("Phase One P21 Back (Hasselblad V)", "Phase One", "medium format", "2005-2010", 1500, "Good", False, "Rare", "18MP digital back for V-system, entry pro-grade"),
        ("Phase One P25+ (Hasselblad V)", "Phase One", "medium format", "2007-2011", 3000, "Good", False, "Rare", "22MP digital back, 48x36mm sensor, V-mount"),
        ("Phase One P30+ Back (Hasselblad V)", "Phase One", "medium format", "2007-2012", 3500, "Good", False, "Rare", "31.6MP, widely used studio digital back, V-mount"),
        ("Phase One P45+ Back (Mamiya 645)", "Phase One", "medium format", "2008-2013", 4500, "Excellent", False, "Rare", "39MP back, Mamiya 645 mount, high-end studio"),
        ("Phase One IQ140 Back (Hasselblad V)", "Phase One", "medium format", "2011-2015", 5500, "Excellent", False, "Rare", "40MP IQ-series, touch-screen, studio flagship of era"),
        ("Phase One IQ180 Back (Hasselblad V)", "Phase One", "medium format", "2011-2015", 8000, "Excellent", False, "Rare", "80MP full-frame medium format back, ultra-high resolution"),
        ("Phase One IQ3 100MP Back", "Phase One", "medium format", "2016-2020", 15000, "Excellent", False, "Rare", "100MP full-frame MF back, Sony IMX211 sensor"),
        ("Phase One XF IQ4 150MP Kit", "Phase One", "medium format", "2018-present", 32000, "Mint", False, "Rare", "Flagship 150MP system, XF body + IQ4 back + lens"),
        ("Leaf Credo 40 Back (Hasselblad V)", "Leaf", "medium format", "2012-2017", 2500, "Good", False, "Rare", "40MP Leaf back, V-mount, studio alternative"),
        ("Leaf Credo 80 Back (Mamiya 645)", "Leaf", "medium format", "2012-2017", 4500, "Excellent", False, "Rare", "80MP Leaf Credo, Mamiya 645 mount, ultra-high-res"),
        ("Leaf Aptus-II 6 (Hasselblad V)", "Leaf", "medium format", "2009-2013", 1800, "Good", False, "Rare", "28MP Leaf Aptus II, V-mount, studio back"),
        ("Leaf Aptus-II 10R", "Leaf", "medium format", "2009-2013", 2500, "Good", False, "Rare", "56MP Aptus II, rotating sensor, V-mount compatible"),
        ("Hasselblad CFV-39 Back", "Hasselblad", "medium format", "2008-2014", 2500, "Good", False, "Rare", "39MP CFV back, V-mount, Hasselblad in-house digital"),
        ("Hasselblad CFV II 100c Back", "Hasselblad", "medium format", "2022-present", 7500, "Mint", False, "Rare", "100MP BSI-CMOS V-mount back, modern flagship"),

        # ── Vintage lenses (Zeiss, Voigtlander, Nikkor, Summicron extras) ──
        ("Zeiss ZM Biogon 21mm f/2.8 (M-mount)", "Zeiss", "rangefinder", "2005-present", 1200, "Excellent", True, "Standard", "ZM Biogon 21, ultra-wide for Leica M, rectilinear"),
        ("Zeiss ZM Biogon 25mm f/2.8 (M-mount)", "Zeiss", "rangefinder", "2005-present", 1000, "Excellent", True, "Standard", "ZM Biogon 25, wide-angle Leica M, sharp"),
        ("Zeiss ZM Biogon 35mm f/2 (M-mount)", "Zeiss", "rangefinder", "2005-present", 1100, "Excellent", True, "Standard", "ZM Biogon 35/2, alternative to Summicron, excellent value"),
        ("Zeiss ZM C Biogon 35mm f/2.8 (M-mount)", "Zeiss", "rangefinder", "2005-present", 700, "Excellent", True, "Standard", "Compact C Biogon 35/2.8, smaller than Summicron"),
        ("Zeiss ZM Planar 50mm f/2 (M-mount)", "Zeiss", "rangefinder", "2005-present", 900, "Excellent", True, "Standard", "Planar 50/2 ZM, classic rendering, alternative to Summicron"),
        ("Zeiss ZM C Sonnar 50mm f/1.5 (M-mount)", "Zeiss", "rangefinder", "2005-present", 1100, "Excellent", True, "Standard", "Classic C Sonnar 50/1.5, vintage character rendering"),
        ("Zeiss ZM Sonnar 85mm f/2 (M-mount)", "Zeiss", "rangefinder", "2005-present", 1500, "Excellent", True, "Rare", "Fast portrait tele for Leica M, Sonnar design, compact"),
        ("Zeiss ZF.2 Distagon 21mm f/2.8 (Nikon F)", "Zeiss", "SLR", "2010-2019", 1200, "Excellent", True, "Standard", "ZF.2 Distagon 21, manual focus wide, Nikon F chip"),
        ("Zeiss ZF.2 Distagon 28mm f/2 (Nikon F)", "Zeiss", "SLR", "2010-2019", 1000, "Excellent", True, "Standard", "Fast 28 Distagon, manual focus, Nikon F"),
        ("Zeiss ZF.2 Planar 85mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2007-2019", 900, "Excellent", True, "Standard", "Reference portrait Planar, manual focus, Nikon F"),
        ("Zeiss ZF.2 Sonnar 135mm f/2 APO", "Zeiss", "SLR", "2013-2019", 1800, "Mint", True, "Rare", "APO Sonnar tele, reference sharpness, Nikon F"),
        ("Zeiss Otus 28mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2015-2019", 3500, "Mint", True, "Rare", "Otus-class 28/1.4, flagship wide, no compromises"),
        ("Zeiss Otus 85mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2014-2019", 3000, "Mint", True, "Rare", "Reference 85 Otus, manual focus, Nikon F"),
        ("Zeiss Milvus 35mm f/1.4 (Nikon F)", "Zeiss", "SLR", "2015-2019", 1400, "Excellent", True, "Standard", "Weather-sealed Milvus 35/1.4, de-click, manual focus"),
        ("Zeiss Contax C/Y Distagon 21mm f/2.8", "Contax", "SLR", "1984-2005", 1500, "Good", True, "Rare", "Legendary C/Y 21/2.8, coveted wide-angle, Hollywood-used"),
        ("Zeiss Contax C/Y Tele-Tessar 300mm f/4", "Contax", "SLR", "1975-2005", 800, "Good", True, "Standard", "Long telephoto C/Y, sharp Zeiss rendering"),
        ("Voigtlander Ultron 35mm f/1.7 Vintage Line", "Voigtlander", "rangefinder", "2019-present", 700, "Mint", True, "Standard", "Vintage Line Ultron 35/1.7 Aspherical, M-mount, retro design"),
        ("Voigtlander APO-Lanthar 50mm f/2 VM", "Voigtlander", "rangefinder", "2020-present", 1200, "Mint", True, "Standard", "APO-corrected Lanthar 50/2 VM, reference rangefinder 50"),
        ("Voigtlander APO-Lanthar 65mm f/2 Macro", "Voigtlander", "rangefinder", "2017-present", 1000, "Mint", True, "Standard", "APO Lanthar 65/2 macro, 1:2 reproduction"),
        ("Voigtlander Color-Skopar 21mm f/4 Pancake VM", "Voigtlander", "rangefinder", "2013-present", 450, "Excellent", True, "Standard", "Pancake 21/4 for Leica M, ultra-compact wide"),
        ("Voigtlander Nokton 50mm f/1.1 (M-mount)", "Voigtlander", "rangefinder", "2009-2017", 900, "Excellent", True, "Standard", "Fast 50/1.1 Nokton, alternative to Noctilux"),
        ("Voigtlander Heliar 40mm f/2.8 VM", "Voigtlander", "rangefinder", "2020-present", 500, "Mint", True, "Standard", "Vintage Line pancake Heliar 40/2.8, M-mount"),
        ("Voigtlander Nokton 21mm f/1.4 Aspherical VM", "Voigtlander", "rangefinder", "2020-present", 1100, "Mint", True, "Standard", "Fast 21/1.4 wide-angle, Leica M-mount, rectilinear"),
        ("Voigtlander Super-Wide Heliar 12mm f/5.6 III", "Voigtlander", "rangefinder", "2016-present", 800, "Mint", True, "Standard", "Ultra-wide 12mm Heliar, architecture specialist"),
        ("Nikkor-O 35mm f/2 Auto (AI Converted)", "Nikon", "SLR", "1965-1977", 250, "Good", True, "Standard", "Classic pre-AI 35/2, converted for AI bodies"),
        ("Nikkor 200mm f/2 ED IF AI-S", "Nikon", "SLR", "1981-2005", 1800, "Good", True, "Rare", "Fast long tele, ED IF, sports/portrait grail"),
        ("Nikkor 300mm f/2.8 ED IF AI-S", "Nikon", "SLR", "1981-2005", 1200, "Good", True, "Rare", "Fast telephoto ED IF, sports/wildlife classic"),
        ("Nikkor 28mm f/2 AI-S", "Nikon", "SLR", "1981-2005", 500, "Excellent", True, "Standard", "Fast wide AI-S Nikkor, CRC, sharp"),
        ("Nikkor 180mm f/2.8 ED AI-S", "Nikon", "SLR", "1981-2005", 400, "Good", True, "Standard", "ED telephoto, sharp and compact, portrait/sports"),
        ("Canon FD 200mm f/1.8 L", "Canon", "SLR", "1988-1992", 3500, "Excellent", True, "Rare", "Ultra-fast FD L tele, rare and coveted sports lens"),
        ("Canon FD 500mm f/4.5 L", "Canon", "SLR", "1979-1989", 1800, "Good", True, "Rare", "Long FD L telephoto, fluorite glass, wildlife specialist"),
        ("Canon FD 300mm f/2.8 L Fluorite", "Canon", "SLR", "1975-1989", 1500, "Good", True, "Rare", "Fluorite L telephoto FD, fast sports lens"),
        ("Canon FD 50mm f/1.2 L Aspherical", "Canon", "SLR", "1980-1989", 1800, "Excellent", True, "Rare", "L-series aspherical 50/1.2 FD, fast portrait"),
        ("Olympus Zuiko 18mm f/3.5 (OM)", "Olympus", "SLR", "1979-2002", 800, "Good", True, "Rare", "Ultra-wide Zuiko 18, rectilinear, rare OM lens"),
        ("Minolta MC W.Rokkor HH 35mm f/1.8", "Minolta", "SLR", "1970-1977", 400, "Good", True, "Standard", "Fast wide MC Rokkor, excellent colour rendering"),
        ("Minolta MD Rokkor-X 85mm f/2", "Minolta", "SLR", "1977-1981", 300, "Good", True, "Standard", "Portrait MD Rokkor, rare North American version"),
        ("Pentax SMC K 85mm f/1.8", "Pentax", "SLR", "1975-1985", 400, "Good", True, "Rare", "K-mount fast portrait, rare SMC coated"),
        ("Pentax SMC Takumar 35mm f/3.5 (M42)", "Pentax", "SLR", "1962-1972", 120, "Good", True, "Standard", "Budget wide Takumar, M42 mount, sharp"),
        ("Pentax Super-Multi-Coated Takumar 85mm f/1.8", "Pentax", "SLR", "1971-1974", 350, "Good", True, "Standard", "Fast portrait Takumar, SMC coating, M42 classic"),

        # ── Polaroid (SX-70/600/Spectra/Land Camera) ──────────────────
        ("Polaroid SX-70 Alpha 1 Executive (Silver)", "Polaroid", "instant", "1977-1981", 450, "Excellent", True, "Rare", "Executive silver SX-70 Alpha 1, presentation box"),
        ("Polaroid SX-70 Model 3 (Non-Folding)", "Polaroid", "instant", "1975-1978", 150, "Good", True, "Standard", "Non-folding SX-70 budget model, fixed focus"),
        ("Polaroid SX-70 Sonar AutoFocus Alpha", "Polaroid", "instant", "1978-1981", 280, "Good", True, "Standard", "Sonar AF SX-70, electronic range-finding"),
        ("Polaroid SX-70 Time Zero (Peel Apart Era)", "Polaroid", "instant", "1979-1981", 300, "Good", True, "Standard", "Updated SX-70 for Time-Zero film, faster development"),
        ("Polaroid SLR 680 SE", "Polaroid", "instant", "1996-2001", 450, "Excellent", True, "Rare", "Second edition SLR 680, improved electronics, rare variant"),
        ("Polaroid OneStep 600 Classic", "Polaroid", "instant", "1982-1992", 50, "Good", True, "Standard", "Original 600-film OneStep, rainbow stripe, iconic 80s"),
        ("Polaroid OneStep Flash (600)", "Polaroid", "instant", "1988-1997", 40, "Good", True, "Standard", "Classic 600 OneStep with built-in flash, everyday snapshot"),
        ("Polaroid Sun 600 LMS", "Polaroid", "instant", "1983-1990", 60, "Good", True, "Standard", "Sun 600 with Light Management System, consumer camera"),
        ("Polaroid Spectra 1200si", "Polaroid", "instant", "1998-2008", 100, "Good", True, "Standard", "Spectra System pro, wide film, external flash"),
        ("Polaroid Spectra AF", "Polaroid", "instant", "1986-1990", 80, "Good", True, "Standard", "Original Spectra AF, wide format, sonar AF"),
        ("Polaroid Image Elite", "Polaroid", "instant", "1990-1995", 90, "Good", True, "Standard", "Image/Spectra System, Quintic lens, sonar AF"),
        ("Polaroid 250 Land Camera", "Polaroid", "instant", "1967-1969", 280, "Good", True, "Standard", "Zeiss rangefinder, pack film, converted to FP-100C"),
        ("Polaroid 350 Land Camera", "Polaroid", "instant", "1969-1971", 250, "Good", True, "Standard", "Pack film Land Camera, Zeiss finder, CdS meter"),
        ("Polaroid 360 Land Camera", "Polaroid", "instant", "1969-1971", 260, "Good", True, "Standard", "Electronic flash Land Camera, Zeiss finder"),
        ("Polaroid 450 Land Camera", "Polaroid", "instant", "1971-1974", 300, "Good", True, "Standard", "Late-production Land Camera, Zeiss finder, CdS"),
        ("Polaroid Big Shot (Portrait)", "Polaroid", "instant", "1971-1973", 350, "Good", True, "Rare", "Andy Warhol's camera, portrait-only, fixed focus Polaroid"),
        ("Polaroid Swinger Model 20", "Polaroid", "instant", "1965-1970", 60, "Good", True, "Standard", "Budget plastic instant, roll film, 1960s icon"),
        ("Polaroid Colorpack II", "Polaroid", "instant", "1969-1972", 80, "Good", True, "Standard", "Colorpack series pack film, all-plastic Land Camera"),
        ("Polaroid Automatic 100 (Original Pack Film)", "Polaroid", "instant", "1963-1966", 250, "Good", True, "Standard", "First pack-film Land Camera, triplet lens, classic"),
        ("Polaroid Countdown M60", "Polaroid", "instant", "1970-1972", 200, "Good", True, "Standard", "Folding pack film with countdown timer, CdS meter"),
        ("Polaroid Mint SX-70 Restoration", "Polaroid", "instant", "2020-present", 550, "Mint", True, "Rare", "Professionally restored SX-70 by Mint Camera, warranty"),
        ("Polaroid Now i-Type (Original)", "Polaroid", "instant", "2020-2022", 100, "Excellent", True, "Standard", "Modern Polaroid Now, i-Type film, autofocus"),
        ("Polaroid Lab (Phone-to-Print)", "Polaroid", "instant", "2019-present", 100, "Excellent", False, "Standard", "Phone-to-Polaroid printer, i-Type film, printing accessory"),

        # ── Plastic toy cameras (Holga, Diana, LOMO) ──────────────────
        ("Holga 120 CFN (Color Flash)", "Holga", "medium format", "2003-2015", 60, "Good", True, "Standard", "120 film Holga with built-in colour flash, 4 filter gels"),
        ("Holga 120 GCFN (Glass Lens)", "Holga", "medium format", "2008-2015", 80, "Good", True, "Standard", "Glass-lens Holga with colour flash, sharper rendering"),
        ("Holga 120 GN (Glass Lens)", "Holga", "medium format", "2008-2015", 70, "Good", True, "Standard", "Glass-lens Holga without flash, 6x6 cult lo-fi"),
        ("Holga 120 Pan (Panoramic)", "Holga", "medium format", "2011-2015", 90, "Good", True, "Rare", "6x12 panoramic Holga, ultra-wide plastic lens"),
        ("Holga 120 Stereo (Stereo 3D)", "Holga", "medium format", "2010-2015", 120, "Good", True, "Rare", "Stereoscopic 3D Holga, dual lenses, stereo pairs"),
        ("Holga 120 WPC (Wide Pinhole)", "Holga", "medium format", "2007-2015", 70, "Good", False, "Standard", "Wide-angle pinhole Holga, 120 film, lens-less"),
        ("Holga 120 TLR", "Holga", "TLR", "2012-2015", 100, "Good", True, "Standard", "Lo-fi plastic TLR, 6x6, budget twin-lens"),
        ("Holga 135 (35mm Plastic)", "Holga", "compact", "2005-2015", 40, "Good", True, "Standard", "35mm version of Holga, plastic lens, lo-fi look"),
        ("Holga 135BC (Built-in Cross)", "Holga", "compact", "2007-2015", 45, "Good", True, "Standard", "135 Holga with black corners / vignette mask"),
        ("Holga 120N (Matte Black)", "Holga", "medium format", "1982-2015", 35, "Good", True, "Standard", "Classic matte black 120N, light leaks and vignette charm"),
        ("Diana F+ Deluxe Kit", "Lomography", "medium format", "2007-present", 120, "Excellent", True, "Standard", "Deluxe Diana F+ with flash, fisheye, 35mm back adapters"),
        ("Diana Mini (35mm)", "Lomography", "compact", "2009-present", 60, "Good", True, "Standard", "35mm Diana, half-frame or square format, plastic lens"),
        ("Diana Instant Square", "Lomography", "instant", "2018-present", 120, "Excellent", True, "Standard", "Instax Square Diana, plastic lens, instant lo-fi"),
        ("Diana Baby 110 (Cartridge Film)", "Lomography", "compact", "2012-present", 50, "Good", True, "Standard", "110 cartridge Diana Baby, ultra-compact toy camera"),
        ("Lomo LC-A (Original USSR)", "Lomography", "compact", "1984-2005", 400, "Good", True, "Rare", "Original Soviet LOMO LC-A, Minitar-1 32/2.8, cult classic"),
        ("Lomo LC-A 120 (Medium Format)", "Lomography", "medium format", "2014-present", 350, "Excellent", True, "Standard", "120 film Lomo LC-A variant, Minigon 38/4.5 lens"),
        ("Lomo LC-Wide", "Lomography", "compact", "2011-present", 300, "Excellent", True, "Standard", "17mm ultra-wide Minigon lens, LC-A ergonomics"),
        ("Lomography Sprocket Rocket", "Lomography", "compact", "2010-present", 80, "Good", True, "Standard", "Panoramic 35mm with sprocket holes, plastic lens"),
        ("Lomography Belair X 6-12 Jetsetter", "Lomography", "medium format", "2012-2018", 200, "Good", True, "Standard", "120 film foldable 6x12 panoramic, interchangeable lenses"),
        ("Lomography Konstruktor DIY SLR", "Lomography", "SLR", "2013-present", 50, "Good", True, "Standard", "Build-your-own plastic SLR kit, 35mm film"),
        ("Lomography Fisheye One", "Lomography", "compact", "2005-present", 50, "Good", True, "Standard", "170-degree fisheye 35mm compact, plastic lens"),
        ("Lomography Actionsampler", "Lomography", "compact", "2001-2012", 40, "Good", True, "Standard", "4-lens sequential 35mm, 4 images per frame"),
        ("Lomography La Sardina Fischer's Fritze", "Lomography", "compact", "2011-2015", 70, "Good", True, "Standard", "Sardine-can styled 35mm, 22mm wide lens"),
        ("Superheadz White Slim Angel", "Lomography", "compact", "2006-2012", 80, "Good", True, "Standard", "22mm ultra-wide 35mm plastic compact, cult 2000s"),
        ("Blackbird, Fly (Plastic TLR)", "Lomography", "TLR", "2008-2014", 90, "Good", True, "Standard", "35mm plastic TLR Blackbird, waist-level lo-fi"),

        # ── Miscellaneous additional ──────────────────────────────────
        ("Voigtlander Bessa R3A (M-mount)", "Voigtlander", "rangefinder", "2004-2015", 800, "Excellent", False, "Standard", "M-mount rangefinder, 1:1 viewfinder, ideal for 40/50mm"),
        ("Voigtlander Bessa R4M (M-mount)", "Voigtlander", "rangefinder", "2006-2015", 900, "Excellent", False, "Rare", "Wide-angle viewfinder, 21-28-35mm framelines, rare"),
        ("Voigtlander Bessa T (M-mount)", "Voigtlander", "rangefinder", "2001-2004", 500, "Good", False, "Standard", "M-mount with separate viewfinder, focusing only RF"),
        ("Voigtlander Bessa L (LTM)", "Voigtlander", "rangefinder", "1999-2003", 300, "Good", False, "Standard", "Viewfinder-less LTM body, wide-angle specialist"),
        ("Zeiss Ikon ZM (M-mount)", "Zeiss", "rangefinder", "2004-2012", 1500, "Excellent", False, "Rare", "Modern M-mount rangefinder by Zeiss, Cosina-built"),
        ("Konica Hexar RF Silver", "Konica", "rangefinder", "1999-2003", 1600, "Excellent", False, "Rare", "Silver Hexar RF, M-mount AE rangefinder, rarer variant"),
        ("Plaubel Makina 67", "Plaubel", "rangefinder", "1978-1981", 1800, "Good", True, "Rare", "Folding 6x7 rangefinder, Nikkor 80/2.8, compact MF"),
        ("Plaubel Makina W67", "Plaubel", "rangefinder", "1982-1986", 2400, "Good", True, "Rare", "Wide-angle Plaubel 6x7, Nikkor 55/4.5, architecture"),
        ("Fuji GF670W Professional", "Fuji", "rangefinder", "2009-2014", 3000, "Excellent", True, "Rare", "Wide variant Fuji 6x7 folding rangefinder, 55/4.5"),
        ("Fuji GSW690III", "Fuji", "rangefinder", "1992-2000", 1200, "Good", True, "Standard", "Wide-angle Texas Leica, 65/5.6, 6x9 rangefinder"),
        ("Fuji GX617 Panoramic", "Fuji", "medium format", "1993-2005", 4000, "Good", True, "Rare", "6x17 panoramic MF, interchangeable lenses, Fujinon"),
        ("Horseman SW612 (6x12 Panoramic)", "Horseman", "medium format", "1990-2005", 1500, "Good", False, "Rare", "6x12 panoramic field, 65-150mm lens options"),
        ("Linhof Technorama 612 PC II", "Linhof", "medium format", "1990-2010", 4500, "Excellent", True, "Rare", "6x12 panoramic, Schneider Super-Angulon 58/5.6, premium"),
        ("Linhof Technorama 617s III", "Linhof", "medium format", "2000-2010", 7500, "Excellent", True, "Rare", "Flagship 6x17 panoramic, Schneider Super-Angulon"),
        ("Alpa 12 TC (Current Production)", "Alpa", "medium format", "1996-present", 8000, "Mint", False, "Rare", "Swiss-made technical MF camera, Rodenstock lenses"),
        ("Noblex Pro 6/150 HS (Swing Lens Panoramic)", "Noblex", "medium format", "1992-2010", 2500, "Good", True, "Rare", "Rotating lens 6x12 panoramic, East German engineering"),
        ("Widelux F8 (Panoramic)", "Widelux", "compact", "1990-2000", 2200, "Good", True, "Rare", "35mm swing-lens panoramic, 140-degree view"),
        ("Linhof Master Technika Classic", "Linhof", "large format", "2003-present", 3500, "Excellent", False, "Rare", "Current-production Master Technika, precision 4x5 field"),
        ("Ebony SV45Ti II (Field Camera)", "Wista", "large format", "2000-2015", 3500, "Excellent", False, "Rare", "Ebony 4x5 titanium/ebony field camera, legendary craft"),
        ("Shen-Hao PTB45 (4x5 Field)", "Wista", "large format", "2005-present", 600, "Excellent", False, "Standard", "Chinese teak 4x5 field camera, budget full-movement"),
        ("Tachihara 45 Hope (Field Camera)", "Wista", "large format", "1980-2010", 600, "Good", False, "Standard", "Japanese cherry wood 4x5 field, compact and lightweight"),
        ("Nagaoka Seisakusho 4x5 Field", "Wista", "large format", "1985-2005", 800, "Good", False, "Rare", "Handmade Japanese wood 4x5 field, artisan craft"),
        ("Deardorff V8 (8x10)", "Wista", "large format", "1945-1988", 2800, "Good", False, "Rare", "Legendary American 8x10 field, mahogany and brass"),
        ("Sinar P2 (4x5 Monorail)", "Wista", "large format", "1983-present", 1500, "Good", False, "Standard", "Swiss precision 4x5 monorail, asymmetric movements"),
        ("Cambo SC (4x5 Monorail)", "Wista", "large format", "1970-2000", 500, "Good", False, "Standard", "Dutch 4x5 monorail, robust studio camera"),
        ("Toyo Field 45CF Carbon", "Wista", "large format", "2000-present", 1200, "Excellent", False, "Rare", "Carbon fibre 4x5 field, ultralight, full movements"),
        ("Gandolfi Variant (4x5 Field)", "Wista", "large format", "1985-2000", 1200, "Good", False, "Rare", "British handmade 4x5 field, walnut and brass"),
        ("Polaroid 110A Converted to FP-100", "Polaroid", "instant", "1957-1960", 500, "Good", True, "Rare", "110A with Ysarex or Rodenstock, pack film converted"),
        ("Polaroid 110B Converted to FP-100", "Polaroid", "instant", "1960-1964", 550, "Good", True, "Rare", "110B with coated Rodenstock, pack film converted"),
        ("Polaroid 195 Land Camera Deluxe", "Polaroid", "instant", "1974-1976", 800, "Excellent", True, "Rare", "Tominon 114/3.8, manual controls, pro pack camera"),
        ("Hasselblad PM Prism Viewfinder", "Hasselblad", "medium format", "1985-2005", 250, "Good", False, "Standard", "Non-metered eye-level prism for V-system bodies"),
        ("Hasselblad WLF (Waist-Level Finder)", "Hasselblad", "medium format", "1970-2005", 150, "Good", False, "Standard", "Standard waist-level finder for V-system"),
        ("Hasselblad Extension Tubes (10/21/55mm)", "Hasselblad", "medium format", "1970-2005", 200, "Good", False, "Standard", "V-system extension tube set for macro work"),
        ("Leica Motor-M (M4-2/M4-P)", "Leica", "rangefinder", "1977-2002", 500, "Good", False, "Standard", "Motor winder for M4-2/M4-P/M6, 3fps"),
        ("Leica Leicavit MP (Trigger Wind)", "Leica", "rangefinder", "1951-1966", 1500, "Good", False, "Rare", "Rapid trigger-wind base plate, press use, rare"),
        ("Leica Visoflex III", "Leica", "rangefinder", "1964-1983", 400, "Good", False, "Standard", "Reflex housing for M-mount, enables SLR telephoto use"),
        ("Nikon MD-12 Motor Drive (for FM2/FE2)", "Nikon", "SLR", "1982-2001", 100, "Good", False, "Standard", "Motor drive for FM2/FE2/FA/FM3A, 3.2fps"),
        ("Nikon MF-27 Data Back (for F4)", "Nikon", "SLR", "1988-1996", 150, "Good", False, "Standard", "Databack for F4 system, imprints date/time"),
        ("Nikon SB-28 Speedlight", "Nikon", "SLR", "1997-2004", 120, "Good", False, "Standard", "Classic TTL flash, compatible with F-series film SLRs"),
        ("Nikon SB-800 Speedlight", "Nikon", "SLR", "2003-2008", 200, "Excellent", False, "Standard", "i-TTL flash, compatible with F6 and late film SLRs"),
        ("Canon Speedlite 540EZ", "Canon", "SLR", "1990-1995", 100, "Good", False, "Standard", "TTL flash for EOS film SLRs, powerful guide number"),
        ("Canon PowerWinder A", "Canon", "SLR", "1976-1984", 60, "Good", False, "Standard", "Power winder for AE-1/AT-1/A-1, 2fps"),
        ("Canon Motor Drive FN (for New F-1)", "Canon", "SLR", "1981-1992", 250, "Good", False, "Standard", "Motor drive for New F-1, 5fps with battery pack"),
        ("Contax TLA 200 Flash", "Contax", "SLR", "1996-2005", 150, "Good", False, "Standard", "TTL flash for Contax G-series rangefinders"),
        ("Hasselblad D40 Flash", "Hasselblad", "medium format", "1996-2006", 250, "Good", False, "Standard", "Metz-made TTL flash for V-system cameras"),
        ("Minox B (Subminiature)", "Minolta", "compact", "1958-1972", 250, "Good", True, "Rare", "Subminiature 8x11mm spy camera, Complan 15/3.5"),
        ("Minox LX (Subminiature)", "Minolta", "compact", "1978-1996", 350, "Excellent", True, "Rare", "Updated Minox subminiature, auto exposure"),
        ("Rollei A110 Subminiature", "Rolleiflex", "compact", "1975-1978", 300, "Good", True, "Rare", "Rollei-branded 110 subminiature, Tessar 23/2.8"),
        ("Rollei 16 Subminiature", "Rolleiflex", "compact", "1963-1966", 400, "Good", True, "Rare", "16mm film subminiature, Zeiss Tessar lens"),
        ("Pentax Auto 110 Super", "Pentax", "SLR", "1982-1985", 300, "Good", True, "Rare", "Updated 110 film SLR, interchangeable lenses"),
        ("Minolta 110 Zoom SLR Mk II", "Minolta", "SLR", "1979-1983", 250, "Good", True, "Rare", "110 film SLR with built-in zoom, unique design"),
        ("Canon 110ED", "Canon", "compact", "1975-1978", 120, "Good", True, "Standard", "110 film compact, Canon ED lens, zone focus"),
        ("Kodak Retina IIIc (Folding Rangefinder)", "Kodak", "rangefinder", "1954-1957", 300, "Good", True, "Standard", "Folding 35mm rangefinder, Schneider Xenon 50/2"),
        ("Kodak Retina IIIC Big C (Late)", "Kodak", "rangefinder", "1957-1960", 500, "Good", True, "Rare", "Updated IIIC Big C, bright-line finder, Xenon 50/2"),
        ("Kodak Retina Reflex IV", "Kodak", "SLR", "1964-1966", 200, "Good", True, "Standard", "Final Retina Reflex, DKL mount, Schneider lenses"),
        ("Kodak Ektra", "Kodak", "rangefinder", "1941-1948", 1500, "Good", True, "Rare", "Luxury American 35mm rangefinder, interchangeable lenses"),
        ("Agfa Super Silette (Rangefinder)", "Agfa", "rangefinder", "1956-1960", 150, "Good", True, "Standard", "Compact German rangefinder, Solinar 50/2.8"),
        ("Voigtlander Vitessa T (Folding Rangefinder)", "Voigtlander", "rangefinder", "1957-1962", 250, "Good", True, "Standard", "Unique plunger-advance 35mm rangefinder, Skoparet 50/2.8"),
        ("Voigtlander Prominent II", "Voigtlander", "rangefinder", "1957-1960", 600, "Good", True, "Rare", "Premium rangefinder, Nokton 50/1.5, unusual mount"),
        ("Zeiss Ikon Contessa LK", "Zeiss", "rangefinder", "1960-1965", 180, "Good", True, "Standard", "Folding 35mm rangefinder, Tessar 50/2.8, CdS meter"),
        ("Zeiss Ikon Contessa 35 (Original)", "Zeiss", "rangefinder", "1950-1955", 300, "Good", True, "Rare", "Original folding 35mm Contessa, Tessar 45/2.8"),
    ]
...
def get_curated_catalog() -> list[dict]:
    ...
    # Round 11 — Leica M3/M6/IIIf, Hasselblad 500C/M & SWC, Rolleiflex, Mamiya,
    # Pentax 67, Canon F-1, Nikon F3, Contax, Olympus OM, lenses, accessories
    all_tuples.extend(_round11_expansion())
    # Round 12 — Leica variants, Hasselblad H-series + digital backs, Rolleiflex
    # special editions, Mamiya 7/C330, Pentax 67/LX, Canon AE-1/EOS-1v, Nikon
    # FM3A/F6/S3/rangefinders, Contax T2/T3/G2/645, Olympus OM/XA/Pen F, Phase
    # One/Leaf backs, Zeiss/Voigtlander/Summicron lenses, Polaroid, Holga/Diana/LOMO
    all_tuples.extend(_round12_expansion())
