...
def get_curated_catalog() -> list[dict]:
    ...
    cards: list[tuple] = [
        ...
        # =================================================================
        # ROUND 5 — 700+ Expansion: BT-14 through BT-17, Vital Bracelet, Digivolving Spirits, Figures
        # =================================================================

        # ── BT-14 Blast Ace Chase Cards ──────────────────────────────────
        ("Jesmon GX", "BT14", "BT14-041", "Secret Rare", "Red", 45.00,
         "Mega", "BT14 Secret Rare Jesmon GX, Royal Knight ace"),
        ("Rapidmon (Armor)", "BT14", "BT14-035", "Super Rare", "Green", 18.00,
         "Ultimate", "BT14 Super Rare Rapidmon Armor digivolve"),
        ("Fenriloogamon", "BT14", "BT14-082", "Secret Rare", "Purple", 55.00,
         "Mega", "BT14 Secret Rare Fenriloogamon, dark wolf form"),
        ("ShineGreymon: Burst Mode (Alt Art)", "BT14", "BT14-020-AA", "Alt Art", "Red", 85.00,
         "Mega", "BT14 Alt Art ShineGreymon Burst Mode, Data Squad fan-favorite"),
        ("Rosemon: Burst Mode", "BT14", "BT14-044", "Super Rare", "Green", 15.00,
         "Mega", "BT14 Super Rare Rosemon Burst Mode, plant mega"),
        ("MirageGaogamon: Burst Mode (Alt Art)", "BT14", "BT14-030-AA", "Alt Art", "Blue", 70.00,
         "Mega", "BT14 Alt Art MirageGaogamon Burst Mode"),
        ("Ravemon: Burst Mode", "BT14", "BT14-076", "Super Rare", "Purple", 14.00,
         "Mega", "BT14 Ravemon Burst Mode, Falcomon line boss"),

        # ── BT-15 Exceed Apocalypse Chase Cards ─────────────────────────
        ("Susanoomon", "BT15", "BT15-044", "Secret Rare", "Red", 65.00,
         "Mega", "BT15 Secret Rare Susanoomon, Frontier fusion boss"),
        ("Alphamon: Ouryuken", "BT15", "BT15-075", "Secret Rare", "Black", 72.00,
         "Mega", "BT15 Secret Rare Alphamon Ouryuken, Royal Knight elite"),
        ("Examon", "BT15", "BT15-070", "Super Rare", "Red", 22.00,
         "Mega", "BT15 Super Rare Examon, dragon Royal Knight"),
        ("Gallantmon: Crimson Mode (Alt Art)", "BT15", "BT15-025-AA", "Alt Art", "Red", 95.00,
         "Mega", "BT15 Alt Art Gallantmon Crimson Mode, Tamers ultimate"),
        ("Imperialdramon: Paladin Mode", "BT15", "BT15-042", "Super Rare", "White", 28.00,
         "Mega", "BT15 Super Rare Imperialdramon Paladin Mode"),
        ("Omnimon X (Alt Art)", "BT15", "BT15-080-AA", "Alt Art", "White", 110.00,
         "Mega", "BT15 Alt Art Omnimon X, X-Antibody premium"),
        ("Dynasmon X", "BT15", "BT15-068", "Super Rare", "Purple", 20.00,
         "Mega", "BT15 Super Rare Dynasmon X-Antibody form"),

        # ── BT-16 Beginning Observer Chase Cards ────────────────────────
        ("Agumon -Bond of Bravery-", "BT16", "BT16-012", "Secret Rare", "Red", 48.00,
         "Mega", "BT16 Secret Rare bond Agumon, Last Evolution tie-in"),
        ("Gabumon -Bond of Friendship-", "BT16", "BT16-030", "Secret Rare", "Blue", 45.00,
         "Mega", "BT16 Secret Rare bond Gabumon, Last Evolution tie-in"),
        ("Omnimon (Alt Art, BT16)", "BT16", "BT16-084-AA", "Alt Art", "White", 130.00,
         "Mega", "BT16 Alt Art Omnimon, new panoramic art"),
        ("WarGreymon (Alt Art, BT16)", "BT16", "BT16-015-AA", "Alt Art", "Red", 75.00,
         "Mega", "BT16 Alt Art WarGreymon, dynamic pose"),
        ("MetalGarurumon (Alt Art, BT16)", "BT16", "BT16-033-AA", "Alt Art", "Blue", 68.00,
         "Mega", "BT16 Alt Art MetalGarurumon, ice breath art"),
        ("Patamon (Alt Art, BT16)", "BT16", "BT16-040-AA", "Alt Art", "Yellow", 55.00,
         "Rookie", "BT16 Alt Art Patamon, nostalgic Adventure art"),
        ("Pulsemon", "BT16", "BT16-048", "Super Rare", "Yellow", 16.00,
         "Champion", "BT16 Super Rare Pulsemon, Vital Bracelet mascot"),

        # ── BT-17 Secret Crisis Chase Cards ─────────────────────────────
        ("Chaosmon", "BT17", "BT17-090", "Secret Rare", "White", 58.00,
         "Mega", "BT17 Secret Rare Chaosmon, BanchoLeomon fusion"),
        ("Huanglongmon", "BT17", "BT17-085", "Secret Rare", "Yellow", 62.00,
         "Mega", "BT17 Secret Rare Huanglongmon, sovereign dragon"),
        ("Ogudomon", "BT17", "BT17-088", "Secret Rare", "Purple", 55.00,
         "Mega", "BT17 Secret Rare Ogudomon, Super Demon Lord"),
        ("Beelzemon: Blast Mode (Alt Art, BT17)", "BT17", "BT17-068-AA", "Alt Art", "Purple", 90.00,
         "Mega", "BT17 Alt Art Beelzemon Blast Mode, Tamers iconic"),
        ("Sakuyamon (Alt Art, BT17)", "BT17", "BT17-045-AA", "Alt Art", "Yellow", 72.00,
         "Mega", "BT17 Alt Art Sakuyamon, Renamon line boss"),
        ("MegaGargomon (Alt Art, BT17)", "BT17", "BT17-035-AA", "Alt Art", "Green", 65.00,
         "Mega", "BT17 Alt Art MegaGargomon, Terriermon line boss"),

        # ── Vital Bracelet Accessories & DiM Cards ──────────────────────
        ("Vital Bracelet BE (White)", "VITAL", "VB-BE-W", "Super Rare", "White", 48.00,
         "Item", "Vital Bracelet BE base device, white edition"),
        ("Vital Bracelet BE (Black)", "VITAL", "VB-BE-B", "Super Rare", "Black", 48.00,
         "Item", "Vital Bracelet BE base device, black edition"),
        ("DiM Card Set Vol.1 (Volcanic Beat & Blizzard Fang)", "VITAL", "VB-DIM-V1", "Rare", "Red", 35.00,
         "Item", "DiM cards for Agumon & Gabumon lines, original set"),
        ("DiM Card Set Vol.2 (Infinite Tide & Titan of Dust)", "VITAL", "VB-DIM-V2", "Rare", "Blue", 35.00,
         "Item", "DiM cards for Betamon & Gotsumon lines"),
        ("DiM Card GP Vol.1 (Impulse City)", "VITAL", "VB-DIM-GP1", "Rare", "Yellow", 28.00,
         "Item", "Gashapon DiM card, random Digimon line"),
        ("DiM Card GP Vol.2 (Hermit in the Jungle)", "VITAL", "VB-DIM-GP2", "Rare", "Green", 28.00,
         "Item", "Gashapon DiM card, jungle Digimon line"),
        ("DiM Card Medarot Collaboration", "VITAL", "VB-DIM-MED", "Super Rare", "Yellow", 55.00,
         "Item", "Limited collab DiM card, Medarot crossover"),
        ("DiM Card Dynasty of the Evil", "VITAL", "VB-DIM-DOE", "Rare", "Purple", 30.00,
         "Item", "DiM card featuring Dark Masters line"),
        ("Vital Bracelet BE (Digimon Seekers Edition)", "VITAL", "VB-BE-SEEK", "Super Rare", "Blue", 65.00,
         "Item", "Seekers special edition Vital Bracelet BE"),

        # ── Digivolving Spirits Figures ──────────────────────────────────
        ("Digivolving Spirits 01 WarGreymon", "FIGURE", "DS-01", "Secret Rare", "Red", 120.00,
         "Mega", "Bandai Digivolving Spirits WarGreymon, transforms from Agumon"),
        ("Digivolving Spirits 02 MetalGarurumon", "FIGURE", "DS-02", "Secret Rare", "Blue", 115.00,
         "Mega", "Digivolving Spirits MetalGarurumon, transforms from Gabumon"),
        ("Digivolving Spirits 03 Diaboromon", "FIGURE", "DS-03", "Secret Rare", "White", 130.00,
         "Mega", "Digivolving Spirits Diaboromon, Our War Game movie villain"),
        ("Digivolving Spirits 04 Angewomon", "FIGURE", "DS-04", "Secret Rare", "Yellow", 140.00,
         "Ultimate", "Digivolving Spirits Angewomon, holy angel figure"),
        ("Digivolving Spirits 05 Alphamon", "FIGURE", "DS-05", "Secret Rare", "Black", 150.00,
         "Mega", "Digivolving Spirits Alphamon, Royal Knight premium"),
        ("Digivolving Spirits 06 AtlurKabuterimon", "FIGURE", "DS-06", "Secret Rare", "Blue", 125.00,
         "Ultimate", "Digivolving Spirits AtlurKabuterimon, insect warrior"),
        ("Digivolving Spirits 07 Holy Angemon", "FIGURE", "DS-07", "Secret Rare", "Yellow", 135.00,
         "Ultimate", "Digivolving Spirits HolyAngemon (MagnaAngemon)"),
        ("Digivolving Spirits 08 BlackWarGreymon", "FIGURE", "DS-08", "Secret Rare", "Black", 160.00,
         "Mega", "Digivolving Spirits BlackWarGreymon, virus counterpart"),

        # ── GEM Series & Precious GEM Figures ────────────────────────────
        ("G.E.M. Series Taichi & Agumon (20th Anniversary)", "FIGURE", "GEM-TA20", "Super Rare", "Red", 145.00,
         "Item", "MegaHouse G.E.M. Taichi & Agumon 20th anniversary figure"),
        ("G.E.M. Series Yamato & Gabumon (20th Anniversary)", "FIGURE", "GEM-YG20", "Super Rare", "Blue", 140.00,
         "Item", "MegaHouse G.E.M. Yamato & Gabumon 20th anniversary"),
        ("Precious G.E.M. WarGreymon & Agumon", "FIGURE", "PGEM-WA", "Secret Rare", "Red", 280.00,
         "Mega", "Precious G.E.M. large scale WarGreymon & Agumon diorama"),
        ("Precious G.E.M. Omnimon", "FIGURE", "PGEM-OM", "Secret Rare", "White", 320.00,
         "Mega", "Precious G.E.M. Omnimon, premium large scale figure"),
        ("Precious G.E.M. Beelzemon & Behemoth", "FIGURE", "PGEM-BB", "Secret Rare", "Purple", 350.00,
         "Mega", "Precious G.E.M. Beelzemon on Behemoth motorcycle"),
        ("G.E.M. Series Koushiro & Tentomon", "FIGURE", "GEM-KT", "Super Rare", "Red", 120.00,
         "Item", "MegaHouse G.E.M. Koushiro & Tentomon figure set"),
        ("G.E.M. Series Sora & Piyomon", "FIGURE", "GEM-SP", "Super Rare", "Red", 125.00,
         "Item", "MegaHouse G.E.M. Sora & Piyomon (Biyomon) figure"),

        # ── Vintage Digivice Releases ────────────────────────────────────
        ("Digivice Ver. Complete (White)", "DIGIVICE", "DV-COMP-W", "Super Rare", "White", 75.00,
         "Item", "Premium Bandai Digivice Ver. Complete, all Adventure Digimon"),
        ("Digivice Ver. Complete (Black)", "DIGIVICE", "DV-COMP-B", "Super Rare", "Black", 78.00,
         "Item", "Premium Bandai Digivice Ver. Complete black edition"),
        ("Digimon Pendulum Ver.20th (Original Silver)", "DIGIVICE", "DP-20TH-S", "Rare", "White", 55.00,
         "Item", "Pendulum 20th anniversary, silver casing, original Deep Savers/Nightmare Soldiers"),
        ("Digimon Pendulum Ver.20th (Original Black)", "DIGIVICE", "DP-20TH-B", "Rare", "Black", 55.00,
         "Item", "Pendulum 20th anniversary, black casing"),
        ("Digivice: (Digimon Adventure tri.)", "DIGIVICE", "DV-TRI", "Super Rare", "White", 65.00,
         "Item", "Digivice: from Digimon Adventure tri., crest activation"),
        ("D-3 Digivice (Paildramon Color)", "DIGIVICE", "DV-D3-PAIL", "Rare", "Blue", 48.00,
         "Item", "D-3 Digivice in Paildramon color scheme"),
        ("D-Ark (Takato Red)", "DIGIVICE", "DV-DARK-R", "Rare", "Red", 52.00,
         "Item", "D-Ark Digivice, Takato's red edition, Tamers series"),
        ("Digital Monster X (Black)", "DIGIVICE", "DV-DMX-B", "Super Rare", "Black", 70.00,
         "Item", "Digital Monster X vpet, X-Antibody Digimon exclusive"),
        ("Digital Monster X Ver.2 (Red)", "DIGIVICE", "DV-DMX2-R", "Super Rare", "Red", 72.00,
         "Item", "Digital Monster X Ver.2 vpet, Jesmon line"),
        ("Digital Monster Ver.20th (Brown, Original)", "DIGIVICE", "DV-DM20-BR", "Rare", "Yellow", 45.00,
         "Item", "Digital Monster 20th anniversary vpet, classic brown shell"),

        # === EXPANSION ROUND 6 — 28 new items to reach 700+ ===

        # ── BT-18 / EX-08 Chase Cards (+8) ─────────────────────────────
        ("Gallantmon (Alt Art, EX08)", "EX08", "EX08-015-AA", "Alt Art", "Red", 80.00,
         "Mega", "EX08 Alt Art Gallantmon, Royal Knight premium art"),
        ("ShineGreymon (BT18)", "BT18", "BT18-020", "Secret Rare", "Red", 52.00,
         "Mega", "BT18 Secret Rare ShineGreymon, Data Squad ace"),
        ("Magnamon X (BT18)", "BT18", "BT18-065", "Secret Rare", "Yellow", 60.00,
         "Mega", "BT18 Secret Rare Magnamon X-Antibody, Royal Knight"),
        ("Lucemon Falldown Mode (Alt Art, BT18)", "BT18", "BT18-078-AA", "Alt Art", "Purple", 75.00,
         "Mega", "BT18 Alt Art Lucemon Falldown Mode, Demon Lord"),
        ("Ophanimon (BT18)", "BT18", "BT18-042", "Super Rare", "Yellow", 22.00,
         "Mega", "BT18 Super Rare Ophanimon, celestial angel"),
        ("Leopardmon (BT18)", "BT18", "BT18-070", "Super Rare", "Black", 18.00,
         "Mega", "BT18 Super Rare Leopardmon, Royal Knight strategist"),
        ("Belphemon Sleep Mode (EX08)", "EX08", "EX08-058", "Super Rare", "Purple", 16.00,
         "Mega", "EX08 Super Rare Belphemon Sleep Mode, Demon Lord"),
        ("Ordinemon (EX08)", "EX08", "EX08-072", "Secret Rare", "White", 55.00,
         "Mega", "EX08 Secret Rare Ordinemon, tri. fusion"),

        # ── Vital Bracelet BE Expansion (+5) ───────────────────────────
        ("Vital Bracelet BE (25th Anniversary Gold)", "VITAL", "VB-BE-25TH", "Secret Rare", "Yellow", 95.00,
         "Item", "Vital Bracelet BE 25th anniversary gold edition, limited 2500 units"),
        ("DiM Card Set EX (Royal Knights)", "VITAL", "VB-DIM-RK", "Super Rare", "White", 50.00,
         "Item", "DiM card set featuring all 13 Royal Knights"),
        ("DiM Card Set EX (Demon Lords)", "VITAL", "VB-DIM-DL", "Super Rare", "Purple", 50.00,
         "Item", "DiM card set featuring all 7 Great Demon Lords"),
        ("Vital Bracelet BE (Guilmon Red Edition)", "VITAL", "VB-BE-GUIL", "Super Rare", "Red", 68.00,
         "Item", "Vital Bracelet BE Tamers Guilmon special red edition"),
        ("DiM Card GP Vol.3 (Volcanic Beat EX)", "VITAL", "VB-DIM-GP3", "Rare", "Red", 30.00,
         "Item", "Gashapon DiM card Vol.3, enhanced Greymon line"),

        # ── Figure-rise & Model Kits (+6) ──────────────────────────────
        ("Figure-rise Standard Amplified WarGreymon", "FIGURE", "FRS-AMP-WG", "Super Rare", "Red", 42.00,
         "Mega", "Bandai Figure-rise Standard Amplified WarGreymon, dynamic pose"),
        ("Figure-rise Standard Amplified MetalGarurumon", "FIGURE", "FRS-AMP-MG", "Super Rare", "Blue", 42.00,
         "Mega", "Bandai Figure-rise Standard Amplified MetalGarurumon"),
        ("Figure-rise Standard Amplified BlackWarGreymon", "FIGURE", "FRS-AMP-BWG", "Super Rare", "Black", 45.00,
         "Mega", "Bandai Figure-rise Standard Amplified BlackWarGreymon"),
        ("Figure-rise Standard Imperialdramon Dragon Mode", "FIGURE", "FRS-IMP-DM", "Super Rare", "Blue", 48.00,
         "Mega", "Figure-rise Standard Imperialdramon Dragon Mode, 02 DNA Digimon"),
        ("Figure-rise Standard Dukemon", "FIGURE", "FRS-DKM", "Super Rare", "Red", 40.00,
         "Mega", "Figure-rise Standard Dukemon/Gallantmon, Tamers royal knight"),
        ("Figure-rise Standard Beelzemon", "FIGURE", "FRS-BLZ", "Super Rare", "Purple", 45.00,
         "Mega", "Figure-rise Standard Beelzemon, Tamers Demon Lord"),

        # ── Digimon Adventure Sealed Product (+5) ──────────────────────
        ("Digimon Card Game Booster Box BT-18 Sealed", "BT18", "BOX-BT18", "Rare", "Red", 80.00,
         "Item", "Sealed BT-18 booster box, 24 packs, chase cards included"),
        ("Digimon Card Game Booster Box EX-08 Sealed", "EX08", "BOX-EX08", "Rare", "White", 75.00,
         "Item", "Sealed EX-08 booster box, 24 packs"),
        ("Digimon TCG Official Playmat: Royal Knights Complete", "ACC", "ACC-PM-RKC", "Rare", "White", 40.00,
         "Item", "Official Digimon Card Game playmat, all 13 Royal Knights panorama"),
        ("Digimon Adventure Last Evolution Kizuna Blu-ray LE", "MEDIA", "MEDIA-KIZUNA", "Super Rare", "Blue", 85.00,
         "Item", "Last Evolution Kizuna limited Blu-ray with art book and soundtrack CD"),
        ("Digimon Survive Collector's Edition (Switch)", "GAME", "GAME-SURV-CE", "Rare", "Green", 90.00,
         "Item", "Digimon Survive collector's edition with Agumon figurine and art book"),

        # ── Appmon & Seekers (+4) ──────────────────────────────────────
        ("Appmon Appli Drive DUO", "MERCH", "MERCH-APP-DUO", "Super Rare", "Red", 65.00,
         "Item", "Appmon Appli Drive DUO device, Appmon Universe series"),
        ("Digimon Seekers DiM Card (Ryudamon)", "VITAL", "VB-DIM-SEEK-R", "Rare", "Blue", 35.00,
         "Item", "Seekers web novel DiM card featuring Ryudamon line"),
        ("G.E.M. Series Joe & Gomamon", "FIGURE", "GEM-JG", "Super Rare", "Blue", 118.00,
         "Item", "MegaHouse G.E.M. Joe & Gomamon figure, Adventure series"),
        ("G.E.M. Series Mimi & Palmon (Casual)", "FIGURE", "GEM-MP-C", "Super Rare", "Green", 115.00,
