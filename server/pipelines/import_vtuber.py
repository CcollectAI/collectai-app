...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ── VSPO! — Additional Members (+10) ─────────────────────────────
        ("VSPO!", "Tosaki Mimi", "Birthday Set", "Tosaki Mimi Birthday 2025 Complete Set", "Birthday", "mid", 45),
        ("VSPO!", "Tosaki Mimi", "Acrylic Stand", "Tosaki Mimi 2nd Anniversary Acrylic Stand", "Anniversary", "mid", 22),
        ("VSPO!", "Shinomiya Runa", "Birthday Set", "Shinomiya Runa Birthday 2025 Merch Set", "Birthday", "mid", 42),
        ("VSPO!", "Yakumo Beni", "Tapestry", "Yakumo Beni 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 24),
        ("VSPO!", "Ichinose Uruha", "Birthday Set", "Ichinose Uruha Birthday 2025 Full Set", "Birthday", "mid", 48),
        ("VSPO!", "Kurumi Noah", "Birthday Set", "Kurumi Noah Birthday 2025 Complete Set", "Birthday", "mid", 45),
        ("VSPO!", "Various", "Concert Goods", "VSPO! Arena Live 2025 Penlight + Badge Set", "Concert", "mid", 40),
        ("VSPO!", "Various", "Concert Goods", "VSPO! Arena Live 2025 Venue-Limited Acrylic Stand Set (8pc)", "Concert", "high", 65),
        ("VSPO!", "Various", "Merch Box", "VSPO! 3rd Anniversary Complete Box", "Anniversary", "high", 75),
        ("VSPO!", "Various", "Collab Goods", "VSPO! x Valorant JP Collab Acrylic Stand Set", "Standard", "mid", 38),
        ...
        ("Phase Connect", "Various", "Concert Goods", "Phase Connect Phase Fes 2025 Venue Goods Set", "Concert", "high", 55),
        ("Phase Connect", "Various", "Merch Box", "Phase Connect Gen 3 Anniversary Box", "Generation", "high", 60),
        ("Phase Connect", "Kaneko Lumi", "Birthday Set", "Kaneko Lumi Birthday 2025 Complete Set", "Birthday", "mid", 40),
        ("Phase Connect", "Chisaka Airi", "Tapestry", "Chisaka Airi 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 24),
        ("Phase Connect", "Fuura Yuri", "Acrylic Stand", "Fuura Yuri 1st Anniversary Acrylic Stand", "Anniversary", "mid", 20),

        # ── idol corp / Brave Group — Additional (+8) ────────────────────
        ("idol corp", "Rin Penrose", "Birthday Set", "Rin Penrose Birthday 2025 Complete Set", "Birthday", "mid", 38),
        ("idol corp", "Yuko Yurei", "Acrylic Stand", "Yuko Yurei 2nd Anniversary Acrylic Stand", "Anniversary", "mid", 20),
        ("idol corp", "Various", "Merch Box", "idol corp EN Anniversary Complete Box", "Anniversary", "high", 52),
        ("Brave Group", "Aogiri High School", "Merch Box", "Aogiri High School 3rd Anniversary Goods Set", "Anniversary", "mid", 42),
        ("Brave Group", "Nanahoshi Suzu", "Birthday Set", "Nanahoshi Suzu Birthday 2025 Full Set", "Birthday", "mid", 35),
        ("Brave Group", "V4Mirai", "Merch Box", "V4Mirai Debut Anniversary Merch Box", "Debut", "mid", 38),
        ("idol corp", "Kai Saikota", "Birthday Set", "Kai Saikota Birthday 2025 Complete Set", "Birthday", "mid", 35),
        ("idol corp", "Poko Rakun", "Acrylic Stand", "Poko Rakun 1st Anniversary Acrylic Stand", "Anniversary", "mid", 18),

        # ── VTuber Game Merchandise — HoloCure, etc. (+10) ───────────────
        ("Hololive", "Various", "Game Merch", "HoloCure Merch Set (Official T-Shirt + Stickers)", "Standard", "mid", 35),
        ("Hololive", "Various", "Game Merch", "HoloCure Acrylic Stand Set (Myth + Council)", "Standard", "mid", 45),
        ("Hololive", "Various", "Game Merch", "HoloCure Keychain Collection (12pc Complete)", "Standard", "mid", 50),
        ("Hololive", "Various", "Game Merch", "Hololive ERROR Game Merch Set (Tapestry + Clear File)", "Standard", "mid", 38),
        ("Nijisanji", "Various", "Game Merch", "NIJISANJI Niji Quiz Official Merch Set", "Standard", "mid", 28),
        ("Nijisanji", "Various", "Game Merch", "NIJISANJI Niji Gaku Official Tapestry", "Standard", "mid", 25),
        ("VShojo", "Ironmouse", "Game Merch", "Ironmouse x Hades II Collab Acrylic Stand", "Standard", "mid", 32),
        ("Hololive", "Various", "Game Merch", "Hololive Idol Showdown Official Acrylic Stand Set", "Standard", "mid", 40),
        ("Hololive", "Various", "Game Merch", "HoloParade Official Poster Set (A3 x4)", "Standard", "mid", 25),
        ("Hololive", "Various", "Game Merch", "HoloCure OST Vinyl LP (Limited Edition)", "Standard", "grail", 120),

        # ── Specific Birthday Sets with Years (+12) ──────────────────────
        ("Hololive", "Gawr Gura", "Birthday Set", "Gawr Gura Birthday 2025 Premium Box", "Birthday", "grail", 120),
        ("Hololive", "Mori Calliope", "Birthday Set", "Mori Calliope Birthday 2025 Complete Set", "Birthday", "high", 90),
        ("Hololive", "Usada Pekora", "Birthday Set", "Usada Pekora Birthday 2025 Full Set", "Birthday", "high", 88),
        ("Hololive", "Hoshimachi Suisei", "Birthday Set", "Hoshimachi Suisei Birthday 2025 Premium Set", "Birthday", "high", 92),
        ("Hololive", "Sakura Miko", "Birthday Set", "Sakura Miko Birthday 2025 Full Set", "Birthday", "high", 85),
        ("Hololive", "Houshou Marine", "Birthday Set", "Houshou Marine Birthday 2025 Premium Box", "Birthday", "high", 90),
        ("Nijisanji", "Kuzuha", "Birthday Set", "Kuzuha Birthday 2025 Premium Merch Set", "Birthday", "high", 98),
        ("Nijisanji", "Kanae", "Birthday Set", "Kanae Birthday 2025 Complete Set", "Birthday", "high", 88),
        ("Nijisanji", "Various", "Concert Goods", "NijiFes 2025 Premium Venue Box", "Concert", "grail", 160),
        ("Hololive", "Various", "Concert Goods", "Hololive 6th Fes. Premium Venue Box", "Concert", "grail", 180),
        ("VShojo", "Ironmouse", "Birthday Set", "Ironmouse Birthday 2025 Complete Set", "Birthday", "high", 72),
        ("VShojo", "Henya the Genius", "Birthday Set", "Henya Birthday 2025 Full Merch Set", "Birthday", "high", 58),

        # ── Anniversary Merch — Specific Items (+10) ─────────────────────
        ("Hololive", "Various", "Anniversary Set", "Hololive EN Myth 4th Anniversary Complete Box", "Anniversary", "grail", 200),
        ("Hololive", "Various", "Anniversary Set", "Hololive JP Gen 3 5th Anniversary Set", "Anniversary", "grail", 160),
        ("Hololive", "Various", "Anniversary Set", "Hololive ID 4th Anniversary Complete Set", "Anniversary", "high", 80),
        ("Nijisanji", "Various", "Anniversary Set", "Nijisanji EN 3rd Anniversary Complete Box", "Anniversary", "high", 95),
        ("Hololive", "Gawr Gura", "Anniversary Set", "Gawr Gura 4th Anniversary Premium Box", "Anniversary", "grail", 140),
        ("Hololive", "Tokino Sora", "Anniversary Set", "Tokino Sora 8th Anniversary Premium Box", "Anniversary", "grail", 160),
        ("Nijisanji", "Tsukino Mito", "Anniversary Set", "Tsukino Mito 7th Anniversary Premium Box", "Anniversary", "grail", 130),
        ("Hololive", "Various", "Collab Goods", "Hololive x Tower Records Cafe 2025 Full Set", "Tower Records Collab", "high", 65),
        ("Hololive", "Various", "Collab Goods", "Hololive x Animate 2025 Fair Complete Goods Set", "Animate Collab", "high", 58),
        ("Nijisanji", "Various", "Collab Goods", "Nijisanji x Lawson 2025 Spring Clear File Set", "Standard", "mid", 25),

        # ── More Specific Items (+20) ────────────────────────────────────
        ("Hololive", "Gawr Gura", "Tapestry", "Gawr Gura 4th Anniversary B2 Tapestry", "Anniversary", "mid", 40),
        ("Hololive", "Mori Calliope", "Tapestry", "Mori Calliope 4th Anniversary B2 Tapestry", "Anniversary", "mid", 38),
        ("Hololive", "IRyS", "Tapestry", "IRyS 3rd Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        ("Hololive", "Nerissa Ravencroft", "Birthday Set", "Nerissa Ravencroft Birthday 2025 Full Set", "Birthday", "high", 68),
        ("Hololive", "Koseki Bijou", "Birthday Set", "Koseki Bijou Birthday 2025 Complete Set", "Birthday", "high", 65),
        ("Hololive", "FUWAMOCO", "Birthday Set", "FUWAMOCO Birthday 2025 Twin Set", "Birthday", "high", 82),
        ("Hololive", "Shiori Novella", "Birthday Set", "Shiori Novella Birthday 2025 Complete Set", "Birthday", "high", 62),
        ("Nijisanji", "Vox Akuma", "Tapestry", "Vox Akuma 3rd Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        ("Nijisanji", "Luca Kaneshiro", "Birthday Set", "Luca Kaneshiro Birthday 2025 Complete Set", "Birthday", "high", 60),
        ("VShojo", "Kson", "Birthday Set", "Kson Birthday 2025 Complete Set", "Birthday", "high", 60),
        ("VShojo", "Froot", "Birthday Set", "Apricot (Froot) Birthday 2025 Complete Set", "Birthday", "mid", 48),
        ("VShojo", "Matara Kan", "Birthday Set", "Matara Kan Birthday 2025 Full Set", "Birthday", "high", 62),
        ("Indie", "Bao The Whale", "Birthday Set", "Bao The Whale Birthday 2025 Complete Set", "Birthday", "mid", 45),
        ("Indie", "Snuffy", "Birthday Set", "Snuffy Birthday 2025 Full Merch Set", "Birthday", "mid", 42),
        ("Indie", "Neuro-sama", "Anniversary Set", "Neuro-sama 3rd Anniversary Premium Box", "Anniversary", "high", 70),
        ("Hololive", "Various", "Collab Goods", "Hololive x GiGO Crane Game Prizes Full Set (2025)", "Standard", "mid", 35),
        ("Nijisanji", "Various", "Collab Goods", "Nijisanji x Pizza-La 2025 Collab Clear File Set", "Standard", "mid", 22),
        ("Hololive", "Various", "Concert Blu-ray", "Hololive 5th Fes. Capture the Moment Blu-ray Box", "Concert", "high", 80),
        ("Hololive", "Various", "Concert Blu-ray", "Hololive SUPER EXPO 2024 Blu-ray Box", "Concert", "high", 75),
        ("Nijisanji", "Various", "Concert Blu-ray", "NijiFes 2024 Complete Blu-ray Box", "Concert", "high", 72),

        # ── Extra items for 1020+ ─────────────────────────────────────────
        ("Hololive", "Takanashi Kiara", "Anniversary Set", "Takanashi Kiara 4th Anniversary Full Set", "Anniversary", "high", 72),
        ("Hololive", "Ninomae Ina'nis", "Tapestry", "Ninomae Ina'nis 4th Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Hololive", "Watson Amelia", "Tapestry", "Watson Amelia Graduation Memorial Tapestry", "Anniversary", "high", 60),
        ("Hololive", "Shiranui Flare", "Birthday Set", "Shiranui Flare Birthday 2025 Full Set", "Birthday", "high", 65),
        ("Hololive", "Shirogane Noel", "Birthday Set", "Shirogane Noel Birthday 2025 Full Set", "Birthday", "high", 75),
        ("Hololive", "Akai Haato", "Birthday Set", "Akai Haato Birthday 2025 Merch Set", "Birthday", "high", 60),
        ("Hololive", "Murasaki Shion", "Birthday Set", "Murasaki Shion Birthday 2025 Full Set", "Birthday", "high", 68),
        ("Hololive", "Nakiri Ayame", "Birthday Set", "Nakiri Ayame Birthday 2025 Complete Set", "Birthday", "high", 82),
        ("Hololive", "Nekomata Okayu", "Birthday Set", "Nekomata Okayu Birthday 2025 Full Set", "Birthday", "high", 70),
        ("Hololive", "Inugami Korone", "Birthday Set", "Inugami Korone Birthday 2025 Complete Set", "Birthday", "high", 75),
        ("Hololive", "Ookami Mio", "Birthday Set", "Ookami Mio Birthday 2025 Full Set", "Birthday", "high", 62),
        ("Hololive", "Amane Kanata", "Birthday Set", "Amane Kanata Birthday 2025 Complete Set", "Birthday", "high", 70),
        ("Hololive", "Tsunomaki Watame", "Birthday Set", "Tsunomaki Watame Birthday 2025 Full Set", "Birthday", "high", 68),
        ("Hololive", "Tokoyami Towa", "Birthday Set", "Tokoyami Towa Birthday 2025 Complete Set", "Birthday", "high", 70),
        ("Hololive", "Himemori Luna", "Birthday Set", "Himemori Luna Birthday 2025 Complete Set", "Birthday", "high", 62),
        ("Hololive", "Yukihana Lamy", "Birthday Set", "Yukihana Lamy Birthday 2025 Complete Set", "Birthday", "high", 72),
        ("Hololive", "Momosuzu Nene", "Birthday Set", "Momosuzu Nene Birthday 2025 Full Set", "Birthday", "high", 65),
        ("Hololive", "Shishiro Botan", "Birthday Set", "Shishiro Botan Birthday 2025 Complete Set", "Birthday", "high", 72),
        ("Hololive", "Omaru Polka", "Birthday Set", "Omaru Polka Birthday 2025 Full Set", "Birthday", "high", 68),
        ("Nijisanji", "Ibrahim", "Birthday Set", "Ibrahim Birthday 2025 Complete Set", "Birthday", "high", 62),
        ("Nijisanji", "Sasaki Saku", "Birthday Set", "Sasaki Saku Birthday 2025 Full Set", "Birthday", "high", 65),
        ("Nijisanji", "Honma Himawari", "Birthday Set", "Honma Himawari Birthday 2025 Complete Set", "Birthday", "high", 60),
        ("Nijisanji", "Fuwa Minato", "Birthday Set", "Fuwa Minato Birthday 2025 Full Set", "Birthday", "high", 58),
        ("Nijisanji", "Lize Helesta", "Birthday Set", "Lize Helesta Birthday 2025 Complete Set", "Birthday", "high", 70),
        ("Nijisanji", "Ange Katrina", "Birthday Set", "Ange Katrina Birthday 2025 Full Set", "Birthday", "high", 65),
        ("VSPO!", "Various", "Birthday Box", "VSPO! Member Select Birthday Box 2025 (Random)", "Birthday", "mid", 40),
        ("Phase Connect", "Various", "Anniversary Box", "Phase Connect 3rd Anniversary Complete Box", "Anniversary", "high", 68),
        ("VShojo", "Various", "Anniversary Set", "VShojo 3rd Anniversary Complete Merch Set", "Anniversary", "high", 65),
        ("Indie", "Various", "Collab Set", "Indie VTuber Collab Charity Merch Set 2025", "Standard", "mid", 35),
        ("Hololive", "Various", "Music Merch", "Hololive Original Song Collection Vinyl LP (LE)", "Standard", "grail", 130),
        ("Hololive", "Various", "Music Merch", "Hololive Rapping Compilation CD + Goods Set", "Standard", "high", 55),
        ("Nijisanji", "Various", "Music Merch", "Nijisanji Music Festival 2025 Blu-ray + Goods Set", "Concert", "high", 80),
        ("Hololive", "Various", "Game Merch", "HoloEarth Official Goods Set (Beta Tester Exclusive)", "Standard", "high", 65),
    ]
...
def _expanded_batch_3() -> list[tuple]:
    """165 additional VTuber merch — Hololive EN/JP deep catalog, Nijisanji,
    indies, brand collabs, concert/event goods, figures, graduated merch, music."""
    return [
        # ── Hololive EN — Gawr Gura ──
        ("Hololive", "Gawr Gura", "Plush", "Gawr Gura Sameface Plush (Large 30cm)", "Birthday", "high", 65),
        ("Hololive", "Gawr Gura", "Nendoroid", "Gawr Gura Nendoroid #1688", "Standard", "high", 55),
        ("Hololive", "Gawr Gura", "Voice Pack", "Gawr Gura Birthday 2023 Special Voice Pack", "Birthday", "mid", 25),
        ("Hololive", "Gawr Gura", "Rubber Strap", "Gawr Gura Chibi Rubber Strap Collection (6pc)", "Standard", "standard", 18),
        ("Hololive", "Gawr Gura", "Keychain", "Gawr Gura Metal Keychain (Trident Ver.)", "Standard", "standard", 15),
        # ── Hololive EN — Mori Calliope ──
        ("Hololive", "Mori Calliope", "Nendoroid", "Mori Calliope Nendoroid #1884", "Standard", "high", 55),
        ("Hololive", "Mori Calliope", "Plush", "Mori Calliope Death-sensei Plush (25cm)", "Birthday", "high", 60),
        ("Hololive", "Mori Calliope", "Voice Pack", "Mori Calliope 3rd Anniversary Voice Pack Set", "Anniversary", "mid", 28),
        ("Hololive", "Mori Calliope", "Keychain", "Mori Calliope Scythe Metal Keychain", "Standard", "standard", 16),
        # ── Hololive EN — Watson Amelia ──
        ("Hololive", "Watson Amelia", "Birthday Set", "Watson Amelia Birthday 2023 Complete Merch Set", "Birthday", "high", 75),
        ("Hololive", "Watson Amelia", "Tapestry", "Watson Amelia 3rd Anniversary B2 Tapestry", "Anniversary", "mid", 38),
        ("Hololive", "Watson Amelia", "Acrylic Stand", "Watson Amelia Detective Outfit Acrylic Stand", "Outfit Reveal", "mid", 24),
        ("Hololive", "Watson Amelia", "Plush", "Watson Amelia Bubba Plush (20cm)", "Standard", "mid", 45),
        # ── Hololive EN — IRyS ──
        ("Hololive", "IRyS", "Birthday Set", "IRyS Birthday 2024 Premium Merch Set", "Birthday", "high", 78),
        ("Hololive", "IRyS", "Tapestry", "IRyS 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Hololive", "IRyS", "Voice Pack", "IRyS Birthday 2024 Special Voice Pack", "Birthday", "mid", 25),
        ("Hololive", "IRyS", "Acrylic Stand", "IRyS New Year Outfit Acrylic Stand", "Outfit Reveal", "mid", 26),
        # ── Hololive EN — Fauna, Kronii, Mumei, Baelz ──
        ("Hololive", "Ceres Fauna", "Birthday Set", "Ceres Fauna Birthday 2024 Complete Set", "Birthday", "high", 72),
        ("Hololive", "Ceres Fauna", "Tapestry", "Ceres Fauna 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 32),
        ("Hololive", "Ceres Fauna", "Plush", "Ceres Fauna Saplings Plush Set (3pc)", "Standard", "mid", 48),
        ("Hololive", "Ouro Kronii", "Birthday Set", "Ouro Kronii Birthday 2024 Complete Merch Set", "Birthday", "high", 70),
        ("Hololive", "Ouro Kronii", "Acrylic Stand", "Ouro Kronii Clock Tower Acrylic Stand", "Standard", "mid", 28),
        ("Hololive", "Nanashi Mumei", "Birthday Set", "Nanashi Mumei Birthday 2024 Premium Set", "Birthday", "high", 68),
        ("Hololive", "Nanashi Mumei", "Tapestry", "Nanashi Mumei 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        ("Hololive", "Hakos Baelz", "Acrylic Stand", "Hakos Baelz Dice Acrylic Stand", "Standard", "mid", 24),
        # ── Hololive EN — Advent (Nerissa, Shiori, Bijou, FUWAMOCO) ──
        ("Hololive", "Nerissa Ravencroft", "Debut Set", "Nerissa Ravencroft Debut Celebration Merch Set", "Debut", "high", 62),
        ("Hololive", "Nerissa Ravencroft", "Acrylic Stand", "Nerissa Ravencroft Wings Acrylic Stand", "Standard", "mid", 24),
        ("Hololive", "Koseki Bijou", "Debut Set", "Koseki Bijou Debut Celebration Merch Set", "Debut", "high", 60),
        ("Hololive", "Koseki Bijou", "Tapestry", "Koseki Bijou 1st Anniversary B2 Tapestry", "Anniversary", "mid", 28),
        ("Hololive", "Shiori Novella", "Debut Set", "Shiori Novella Debut Celebration Merch Set", "Debut", "high", 58),
        ("Hololive", "Shiori Novella", "Acrylic Stand", "Shiori Novella Library Acrylic Stand", "Standard", "mid", 26),
        ("Hololive", "FUWAMOCO", "Debut Set", "FUWAMOCO Debut Celebration Merch Set (Twin Pack)", "Debut", "high", 75),
        ("Hololive", "FUWAMOCO", "Plush", "FUWAMOCO Twin Plush Set (20cm x2)", "Standard", "high", 68),
        ("Hololive", "FUWAMOCO", "Tapestry", "FUWAMOCO 1st Anniversary B2 Tapestry", "Anniversary", "mid", 32),
        # ── Hololive JP — Pekora, Marine, Suisei, Miko, Korone, Okayu, Aqua, Shion, Subaru, Noel, Flare, Rushia ──
        ("Hololive", "Usada Pekora", "Nendoroid", "Usada Pekora Nendoroid #1912", "Standard", "high", 55),
        ("Hololive", "Usada Pekora", "Voice Pack", "Usada Pekora Birthday 2024 Voice Pack Set", "Birthday", "mid", 28),
        ("Hololive", "Houshou Marine", "Nendoroid", "Houshou Marine Nendoroid #1764", "Standard", "high", 58),
        ("Hololive", "Houshou Marine", "Voice Pack", "Houshou Marine Birthday 2024 Voice Pack", "Birthday", "mid", 30),
        ("Hololive", "Hoshimachi Suisei", "Nendoroid", "Hoshimachi Suisei Nendoroid #2066", "Standard", "high", 60),
        ("Hololive", "Sakura Miko", "Birthday Set", "Sakura Miko Birthday 2024 Premium Set", "Birthday", "high", 80),
        ("Hololive", "Sakura Miko", "Nendoroid", "Sakura Miko Nendoroid #1844", "Standard", "high", 55),
        ("Hololive", "Sakura Miko", "Tapestry", "Sakura Miko 5th Anniversary B2 Tapestry", "Anniversary", "mid", 38),
        ("Hololive", "Inugami Korone", "Birthday Set", "Inugami Korone Birthday 2024 Complete Set", "Birthday", "high", 72),
        ("Hololive", "Inugami Korone", "Plush", "Inugami Korone Listener-san Plush (25cm)", "Standard", "mid", 42),
        ("Hololive", "Nekomata Okayu", "Tapestry", "Nekomata Okayu 5th Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Hololive", "Minato Aqua", "Graduation Set", "Minato Aqua Graduation Memorial Complete Set", "Anniversary", "grail", 200),
        ("Hololive", "Minato Aqua", "Graduation Tapestry", "Minato Aqua Graduation Memorial B2 Tapestry", "Anniversary", "high", 95),
        ("Hololive", "Minato Aqua", "Nendoroid", "Minato Aqua Nendoroid #1663", "Standard", "high", 65),
        ("Hololive", "Murasaki Shion", "Birthday Set", "Murasaki Shion Birthday 2024 Premium Set", "Birthday", "high", 65),
        ("Hololive", "Murasaki Shion", "Acrylic Stand", "Murasaki Shion Witch Outfit Acrylic Stand", "Outfit Reveal", "mid", 26),
        ("Hololive", "Oozora Subaru", "Birthday Set", "Oozora Subaru Birthday 2024 Complete Set", "Birthday", "high", 70),
        ("Hololive", "Oozora Subaru", "Plush", "Oozora Subaru Shuba Duck Plush (Large 30cm)", "Standard", "mid", 48),
        ("Hololive", "Shirogane Noel", "Birthday Set", "Shirogane Noel Birthday 2024 Complete Set", "Birthday", "high", 68),
        ("Hololive", "Shirogane Noel", "Tapestry", "Shirogane Noel 5th Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Hololive", "Shiranui Flare", "Birthday Set", "Shiranui Flare Birthday 2024 Complete Set", "Birthday", "high", 60),
        ("Hololive", "Uruha Rushia", "Graduation Set", "Uruha Rushia Pre-Graduation Merch Complete Set (Rare)", "Anniversary", "grail", 250),
        ("Hololive", "Uruha Rushia", "Tapestry", "Uruha Rushia Final Stream Memorial B2 Tapestry", "Anniversary", "grail", 180),
        # ── Hololive ID — Moona, Reine, Kaela ──
        ("Hololive", "Moona Hoshinova", "Birthday Set", "Moona Hoshinova Birthday 2024 Complete Set", "Birthday", "high", 55),
        ("Hololive", "Moona Hoshinova", "Tapestry", "Moona Hoshinova 4th Anniversary B2 Tapestry", "Anniversary", "mid", 28),
        ("Hololive", "Pavolia Reine", "Birthday Set", "Pavolia Reine Birthday 2024 Complete Set", "Birthday", "high", 58),
        ("Hololive", "Kaela Kovalskia", "Acrylic Stand", "Kaela Kovalskia Mining Outfit Acrylic Stand", "Standard", "mid", 24),
        # ── Nijisanji EN — Vox, Ike, Shu, Luca ──
        ("Nijisanji", "Vox Akuma", "Birthday Set", "Vox Akuma Birthday 2024 Premium Merch Set", "Birthday", "high", 72),
        ("Nijisanji", "Vox Akuma", "Voice Pack", "Vox Akuma ASMR Voice Pack Collection Vol. 3", "Standard", "mid", 30),
        ("Nijisanji", "Vox Akuma", "Tapestry", "Vox Akuma 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Nijisanji", "Ike Eveland", "Birthday Set", "Ike Eveland Birthday 2024 Complete Set", "Birthday", "high", 65),
        ("Nijisanji", "Ike Eveland", "Acrylic Stand", "Ike Eveland Piano Recital Acrylic Stand", "Standard", "mid", 26),
        ("Nijisanji", "Shu Yamino", "Birthday Set", "Shu Yamino Birthday 2024 Complete Set", "Birthday", "high", 62),
        ("Nijisanji", "Shu Yamino", "Tapestry", "Shu Yamino 2nd Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        ("Nijisanji", "Luca Kaneshiro", "Birthday Set", "Luca Kaneshiro Birthday 2024 Premium Set", "Birthday", "high", 68),
        # ── Nijisanji JP — Kuzuha, Kanae, Lauren, Fuwa, Ange, Lize, Sasaki ──
        ("Nijisanji", "Lauren Iroas", "Birthday Set", "Lauren Iroas Birthday 2024 Complete Set", "Birthday", "high", 60),
        ("Nijisanji", "Lauren Iroas", "Acrylic Stand", "Lauren Iroas 3rd Anniversary Acrylic Stand", "Anniversary", "mid", 26),
        ("Nijisanji", "Fuwa Minato", "Birthday Set", "Fuwa Minato Birthday 2024 Premium Set", "Birthday", "high", 65),
        ("Nijisanji", "Fuwa Minato", "Voice Pack", "Fuwa Minato Birthday 2024 Voice Pack", "Birthday", "mid", 25),
        ("Nijisanji", "Ange Katrina", "Birthday Set", "Ange Katrina Birthday 2024 Complete Set", "Birthday", "high", 58),
        ("Nijisanji", "Ange Katrina", "Tapestry", "Ange Katrina 5th Anniversary B2 Tapestry", "Anniversary", "mid", 32),
        ("Nijisanji", "Lize Helesta", "Birthday Set", "Lize Helesta Birthday 2024 Complete Set", "Birthday", "high", 55),
        ("Nijisanji", "Sasaki Saku", "Birthday Set", "Sasaki Saku Birthday 2024 Premium Set", "Birthday", "high", 62),
        ("Nijisanji", "Sasaki Saku", "Tapestry", "Sasaki Saku 5th Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        # ── Independent VTubers ──
        ("Indie", "Shylily", "Birthday Set", "Shylily Birthday 2024 Complete Merch Set", "Birthday", "high", 65),
        ("Indie", "Shylily", "Plush", "Shylily Orca Plush (25cm)", "Standard", "mid", 45),
        ("Indie", "Shylily", "Acrylic Stand", "Shylily Beach Episode Acrylic Stand", "Seasonal", "mid", 28),
        ("Indie", "Nyanners", "Birthday Set", "Nyanners Birthday 2024 Merch Set", "Birthday", "high", 55),
        ("Indie", "Nyanners", "Acrylic Stand", "Nyanners Cat Form Acrylic Stand", "Standard", "mid", 22),
        ("VShojo", "Veibae", "Tapestry", "Veibae Farewell Memorial B2 Tapestry", "Anniversary", "high", 75),
        ("VShojo", "Kson", "Birthday Set", "Kson Birthday 2024 Complete Merch Set", "Birthday", "high", 62),
        ("VShojo", "Henya the Genius", "Debut Set", "Henya the Genius VShojo Debut Merch Set", "Debut", "high", 55),
        ("VShojo", "Henya the Genius", "Acrylic Stand", "Henya the Genius 1st Anniversary Acrylic Stand", "Anniversary", "mid", 26),
        ("Indie", "Filian", "Birthday Set", "Filian Birthday 2024 Complete Merch Set", "Birthday", "high", 58),
        ("Indie", "Filian", "Plush", "Filian Chibi Plush (20cm)", "Standard", "mid", 38),
        ("Indie", "Projekt Melody", "Tapestry", "Projekt Melody Anniversary B2 Tapestry", "Anniversary", "mid", 35),
        ("Indie", "Pipkin Pippa", "Acrylic Stand", "Pipkin Pippa Rabbit Hole Acrylic Stand", "Standard", "mid", 24),
        # ── VTuber x Brand Collabs ──
        ("Hololive", "Various", "Collab Goods", "Hololive x Lawson Winter Campaign Clear File Set (12pc)", "Lawson Collab", "mid", 42),
        ("Hololive", "Various", "Collab Goods", "Hololive x Lawson Spring Campaign Acrylic Stand Set", "Lawson Collab", "high", 58),
        ("Hololive", "Various", "Collab Goods", "Hololive x Aeon Mall Exclusive Tapestry Set (5pc)", "Animate Collab", "mid", 45),
        ("Hololive", "Various", "Collab Goods", "Hololive x Don Quijote Collab Goods Set", "Standard", "mid", 35),
        ("Nijisanji", "Various", "Collab Goods", "Nijisanji x FamilyMart Campaign Clear File Set (8pc)", "Standard", "mid", 32),
        ("Nijisanji", "Various", "Collab Goods", "Nijisanji x FamilyMart Acrylic Stand Campaign Set", "Standard", "mid", 38),
        ("Hololive", "Various", "Collab Goods", "Hololive x Sanrio Characters Collab Merch Set", "Standard", "high", 65),
        ("Hololive", "Various", "Collab Goods", "Hololive x Curry Meshi Collab Campaign Set", "Standard", "mid", 28),
        ("Hololive", "Various", "Collab Cafe", "Hololive x Capcom Cafe Resident Evil Collab Set", "Collab Cafe", "mid", 42),
        ("Nijisanji", "Various", "Collab Goods", "Nijisanji x Mos Burger Collab Campaign Goods", "Standard", "standard", 18),
        ("Hololive", "Various", "Collab Goods", "Hololive x Toei Kyoto Studio Park Collab Set", "Standard", "mid", 38),
        ("Hololive", "Various", "Collab Cafe", "Hololive x Cure Maid Cafe Collab Acrylic Set", "Collab Cafe", "mid", 35),
        ("Nijisanji", "Various", "Collab Cafe", "Nijisanji x Sweets Paradise Cafe Collab Set", "Collab Cafe", "mid", 40),
        ("Hololive", "Various", "Collab Goods", "Hololive x Village Vanguard Exclusive Goods Set", "Standard", "mid", 30),
        ("Hololive", "Various", "Collab Goods", "Hololive x GiGO Crane Game Prize Set (Full)", "Standard", "mid", 45),
        # ── Concert/Event Goods ──
        ("Hololive", "Various", "Concert Goods", "Hololive SUPER EXPO 2024 Acrylic Keychain Full Set (40pc)", "Concert", "grail", 160),
        ("Hololive", "Various", "Concert Goods", "Hololive Beyond the Stage 2023 Penlight", "Concert", "mid", 42),
        ("Hololive", "Various", "Concert Goods", "Hololive Connect the World 2023 T-Shirt (All Members)", "Concert", "mid", 48),
        ("Hololive", "Various", "Concert Goods", "Holofes 5th Premium Ticket Holder Set", "Concert", "mid", 35),
        ("Hololive", "Various", "Concert Goods", "Holofes 4th Stage Photo Set (Complete)", "Concert", "high", 55),
        ("Hololive", "Various", "Concert Goods", "Holofes 3rd Venue-Limited Poster Set (A2 x8)", "Concert", "high", 65),
        ("Nijisanji", "Various", "Concert Goods", "Nijisanji AR LIVE 2024 Penlight", "Concert", "mid", 38),
        ("Nijisanji", "Various", "Concert Goods", "Nijisanji AR LIVE 2024 T-Shirt", "Concert", "mid", 42),
        ("Nijisanji", "Various", "Concert Goods", "NijiFes 2024 Venue-Limited Acrylic Stand Set (10pc)", "Concert", "high", 72),
        ("Hololive", "Various", "Concert Goods", "VTuber Fes Japan 2024 Collab Goods Set", "Concert", "mid", 48),
        ("Hololive", "Various", "Concert Goods", "Hololive 5th Fes Venue-Only Random Can Badge Box (50pc)", "Concert", "high", 85),
        # ── Figures & Statues ──
        ("Hololive", "Usada Pekora", "Nendoroid", "Usada Pekora Nendoroid Prison Ver.", "Standard", "high", 65),
        ...
        # ── Graduated/Retired VTuber Merch (Rare Collectibles) ──
        ("Hololive", "Kiryu Coco", "Graduation Set", "Kiryu Coco Graduation Memorial Complete Set (Full)", "Anniversary", "grail", 350),
        ("Hololive", "Kiryu Coco", "Graduation Tapestry", "Kiryu Coco Graduation Memorial B2 Tapestry", "Anniversary", "grail", 150),
        ("Hololive", "Tsukumo Sana", "Graduation Set", "Tsukumo Sana Graduation Memorial Complete Set", "Anniversary", "grail", 180),
        ("Hololive", "Tsukumo Sana", "Graduation Tapestry", "Tsukumo Sana Graduation Memorial B2 Tapestry", "Anniversary", "high", 90),
        ("Nijisanji", "Selen Tatsuki", "Graduation Set", "Selen Tatsuki Complete Merch Collection (Pre-Graduation)", "Anniversary", "grail", 200),
        ("Nijisanji", "Nina Kosaka", "Graduation Set", "Nina Kosaka Graduation Memorial Complete Set", "Anniversary", "high", 95),
        ("Nijisanji", "Nina Kosaka", "Tapestry", "Nina Kosaka Farewell B2 Tapestry", "Anniversary", "high", 70),
        # ── Music / Albums ──
        ("Hololive", "Hoshimachi Suisei", "CD Album", "Hoshimachi Suisei Still Still Stellar Limited Edition CD", "Album Release", "high", 55),
        ("Hololive", "Mori Calliope", "CD Album", "Mori Calliope UnAlive Limited Edition CD + Blu-ray", "Album Release", "high", 65),
        ("Hololive", "Gawr Gura", "CD Single", "Gawr Gura Reflect Limited Edition CD", "Album Release", "mid", 35),
        ("Hololive", "IRyS", "CD Album", "IRyS Caesura of Despair Limited Edition CD", "Album Release", "high", 50),
        ("Hololive", "Hoshimachi Suisei", "Vinyl", "Hoshimachi Suisei Still Still Stellar Vinyl LP", "Album Release", "grail", 120),
        ("Hololive", "Mori Calliope", "Vinyl", "Mori Calliope Sinderella Vinyl LP (Signed)", "Album Release", "grail", 180),
        ("Hololive", "Various", "CD Album", "Hololive Idol Project Compilation Album Vol. 1", "Group", "mid", 32),
        ("Hololive", "Various", "CD Album", "Hololive English -Myth- Cover Album", "Group", "mid", 35),
        ("Nijisanji", "Various", "CD Album", "Nijisanji Music Festival Compilation Album", "Group", "mid", 28),
        ("Hololive", "Tokoyami Towa", "CD Album", "Tokoyami Towa Ashes to Ashes Limited Edition", "Album Release", "mid", 40),
        ("Hololive", "Shiranui Flare", "CD Album", "Shiranui Flare Smile & Go!! Limited Edition CD", "Album Release", "mid", 35),
        ("Hololive", "Ouro Kronii", "CD Single", "Ouro Kronii Daydream Limited Edition CD", "Album Release", "mid", 30),
        ("Hololive", "Hakos Baelz", "CD Single", "Hakos Baelz Play Dice! Limited Edition CD", "Album Release", "mid", 30),
        ("Hololive", "Gawr Gura", "CD Album", "Gawr Gura Reincarnation Album Limited CD", "Album Release", "high", 55),
        ("Nijisanji", "Kuzuha", "CD Album", "Kuzuha First Solo Album Limited Edition", "Album Release", "high", 50),

        # ── Additional Hololive JP Talents ──
        ("Hololive", "Shirakami Fubuki", "Birthday Set", "Shirakami Fubuki Birthday 2024 Complete Set", "Birthday", "high", 72),
        ("Hololive", "Shirakami Fubuki", "Plush", "Shirakami Fubuki Kitsune Plush (25cm)", "Standard", "mid", 40),
        ("Hololive", "Natsuiro Matsuri", "Birthday Set", "Natsuiro Matsuri Birthday 2024 Complete Set", "Birthday", "high", 60),
        ("Hololive", "Akai Haato", "Birthday Set", "Akai Haato Birthday 2024 Complete Set", "Birthday", "high", 62),
        ("Hololive", "Tokoyami Towa", "Birthday Set", "Tokoyami Towa Birthday 2024 Complete Merch Set", "Birthday", "high", 70),
        ("Hololive", "Tokoyami Towa", "Acrylic Stand", "Tokoyami Towa Devil Outfit Acrylic Stand", "Outfit Reveal", "mid", 28),
        ("Hololive", "Amane Kanata", "Tapestry", "Amane Kanata 4th Anniversary B2 Tapestry", "Anniversary", "mid", 32),
        ("Hololive", "Himemori Luna", "Birthday Set", "Himemori Luna Birthday 2024 Complete Set", "Birthday", "high", 58),
        ("Hololive", "Tsunomaki Watame", "Birthday Set", "Tsunomaki Watame Birthday 2024 Complete Set", "Birthday", "high", 65),
        ("Hololive", "Tsunomaki Watame", "Plush", "Tsunomaki Watame Sheep Plush (30cm)", "Standard", "mid", 45),
        # ── Additional Nijisanji ──
        ("Nijisanji", "Hoshikawa Sara", "Birthday Set", "Hoshikawa Sara Birthday 2024 Complete Set", "Birthday", "high", 60),
        ("Nijisanji", "Honma Himawari", "Birthday Set", "Honma Himawari Birthday 2024 Complete Set", "Birthday", "high", 55),
        ("Nijisanji", "Inui Toko", "Tapestry", "Inui Toko 5th Anniversary B2 Tapestry", "Anniversary", "mid", 30),
        ("Nijisanji", "Shiina Yuika", "Birthday Set", "Shiina Yuika Birthday 2024 Complete Set", "Birthday", "high", 58),
        ("Nijisanji", "Hayama Marin", "Acrylic Stand", "Hayama Marin 4th Anniversary Acrylic Stand", "Anniversary", "mid", 24),
        ("Nijisanji", "Uki Violeta", "Birthday Set", "Uki Violeta Birthday 2024 Complete Set", "Birthday", "high", 55),
        ("Nijisanji", "Sonny Brisko", "Birthday Set", "Sonny Brisko Birthday 2024 Complete Set", "Birthday", "high", 58),
        # ── VTuber Miscellaneous ──
        ("Hololive", "Various", "Rubber Strap Set", "Hololive EN Council Rubber Strap Set (5pc)", "Generation", "mid", 35),
        ("Hololive", "Various", "Clear File Set", "Hololive EN Myth Clear File Collection (5pc)", "Generation", "mid", 28),
        ("Hololive", "Various", "Trading Acrylic", "Hololive JP Gen 3 Trading Acrylic Stand (Full Set 5pc)", "Generation", "mid", 42),
        ("Nijisanji", "Various", "Rubber Strap Set", "Nijisanji EN Luxiem Rubber Strap Set (5pc)", "Group", "mid", 32),
        ("Nijisanji", "Various", "Clear File Set", "Nijisanji JP Selejo Clear File Collection (6pc)", "Group", "mid", 28),
        ("Hololive", "Gawr Gura", "Pop Up Parade", "Gawr Gura Pop Up Parade Figure", "Standard", "mid", 38),
        ("Hololive", "Mori Calliope", "Pop Up Parade", "Mori Calliope Pop Up Parade Figure", "Standard", "mid", 40),
        ("Hololive", "IRyS", "Pop Up Parade", "IRyS Pop Up Parade Figure (Hope Ver.)", "Standard", "mid", 38),
        ("Hololive", "Usada Pekora", "Scale Figure", "Usada Pekora 1/7 Scale Figure (War Criminal Ver.)", "Standard", "grail", 190),
        ("Hololive", "Hoshimachi Suisei", "Scale Figure", "Hoshimachi Suisei 1/7 Scale Figure (Stellar Ver.)", "Standard", "grail", 185),
        ("Indie", "Veibae", "Acrylic Stand", "Veibae Succubus Acrylic Stand", "Standard", "mid", 22),
        ("Phase Connect", "Tenma Maemi", "Birthday Set", "Tenma Maemi Birthday 2024 Merch Set", "Birthday", "high", 52),
        ("Phase Connect", "Lia Rinkou", "Acrylic Stand", "Lia Rinkou Anniversary Acrylic Stand", "Anniversary", "mid", 22),
        # ── More Misc ──
        ("Hololive", "Various", "Advent Calendar", "Hololive Advent Calendar 2024 (24 Mini Goods)", "Seasonal", "high", 75),
        ("Hololive", "Various", "Chibi Figures", "Hololive EN Myth Chibi Figure Set (5pc Blind Box)", "Standard", "mid", 42),
        ("Nijisanji", "Various", "Chibi Figures", "Nijisanji EN Noctyx Chibi Figure Set (5pc)", "Standard", "mid", 38),
        ("Hololive", "Gawr Gura", "Dakimakura", "Gawr Gura Official Dakimakura Cover (Both Sides)", "Birthday", "high", 75),
        ("Hololive", "Houshou Marine", "Dakimakura", "Houshou Marine Official Dakimakura Cover (Both Sides)", "Birthday", "high", 80),
        ("Hololive", "Various", "Playing Cards", "Hololive JP Official Playing Card Deck Set", "Standard", "mid", 28),
        ("Nijisanji", "Various", "Playing Cards", "Nijisanji Official Playing Card Deck (Luxiem Edition)", "Standard", "mid", 26),
    ]
