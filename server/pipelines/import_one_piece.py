...
def _expanded_batch_9() -> list[tuple]:
    ...
    return [
        ...
        # ── Banpresto — King of Artist (~15) ──────────────────────────────
        ("King of Artist", "Monkey D. Luffy", "King of Artist Luffy (Gear 5)", "high", 80),
        ("King of Artist", "Roronoa Zoro", "King of Artist Zoro (Wano)", "mid", 55),
        ("King of Artist", "Portgas D. Ace", "King of Artist Ace (Fire Fist)", "mid", 60),
        ("King of Artist", "Trafalgar Law", "King of Artist Law (Room)", "mid", 50),
        ("King of Artist", "Sanji", "King of Artist Sanji (Diable Jambe)", "mid", 45),
        ("King of Artist", "Shanks", "King of Artist Shanks", "mid", 65),
        ("King of Artist", "Boa Hancock", "King of Artist Hancock", "mid", 55),
        ("King of Artist", "Katakuri", "King of Artist Katakuri", "mid", 60),
        ("King of Artist", "Sabo", "King of Artist Sabo (Fire Dragon)", "mid", 50),
        ("King of Artist", "Monkey D. Luffy", "King of Artist Luffy (Snakeman)", "high", 75),
        ("King of Artist", "Kaido", "King of Artist Kaido (Beast Form)", "high", 85),
        ("King of Artist", "Roronoa Zoro", "King of Artist Zoro (Enma)", "mid", 60),
        ("King of Artist", "Yamato", "King of Artist Yamato", "mid", 55),
        ("King of Artist", "Nico Robin", "King of Artist Robin (Demon Form)", "mid", 50),
        ("King of Artist", "Jinbe", "King of Artist Jinbe", "mid", 45),

        # ── Banpresto — Grandista & DXF (~15) ────────────────────────────
        ("Grandista", "Monkey D. Luffy", "Grandista Luffy (Manga Dimensions)", "high", 90),
        ("Grandista", "Roronoa Zoro", "Grandista Zoro (Manga Dimensions)", "high", 85),
        ("Grandista", "Portgas D. Ace", "Grandista Ace (Manga Dimensions)", "mid", 70),
        ("Grandista", "Trafalgar Law", "Grandista Law (Manga Dimensions)", "mid", 65),
        ("Grandista", "Nami", "Grandista Nami (Manga Dimensions)", "mid", 60),
        ("DXF", "Monkey D. Luffy", "DXF Luffy (The Grandline Men, Wano)", "mid", 40),
        ("DXF", "Roronoa Zoro", "DXF Zoro (The Grandline Men, Wano)", "mid", 40),
        ("DXF", "Sanji", "DXF Sanji (The Grandline Men, Wano)", "standard", 35),
        ("DXF", "Nico Robin", "DXF Robin (The Grandline Lady, Wano)", "mid", 45),
        ("DXF", "Nami", "DXF Nami (The Grandline Lady, Wano)", "mid", 42),
        ("DXF", "Yamato", "DXF Yamato (The Grandline Men)", "mid", 50),
        ("DXF", "Shanks", "DXF Shanks (The Grandline Men, Film Red)", "mid", 55),
        ("DXF", "Uta", "DXF Uta (The Grandline Lady, Film Red)", "mid", 45),
        ("DXF", "Kaido", "DXF Kaido (The Grandline Men, Dragon)", "mid", 60),
        ("DXF", "Big Mom", "DXF Big Mom (The Grandline Series)", "mid", 50),

        # ── Portrait of Pirates — Additional (~15) ────────────────────────
        ("P.O.P. Limited", "Yamato", "Yamato (Thunder Bagua)", "high", 200),
        ("P.O.P. Limited", "Uta", "Uta (Film Red Ver.)", "high", 180),
        ("P.O.P. Warriors Alliance", "Jinbe", "Jinbe (Wano)", "high", 130),
        ("P.O.P. Warriors Alliance", "Killer", "Killer (Wano)", "high", 120),
        ("P.O.P. Warriors Alliance", "Kid", "Eustass Kid (Wano)", "high", 140),
        ("P.O.P. SOC", "Tony Tony Chopper", "Chopper (Cotton Candy Lover)", "high", 100),
        ("P.O.P. SOC", "Brook", "Brook (Soul King)", "high", 110),
        ("P.O.P. SOC", "Usopp", "Usopp (Sogeking)", "mid", 90),
        ("P.O.P. NEO-DX", "Doflamingo", "Donquixote Doflamingo", "high", 180),
        ("P.O.P. NEO-DX", "Mihawk", "Dracule Mihawk", "grail", 250),
        ("P.O.P. NEO-DX", "Smoker", "Smoker (Marine)", "high", 140),
        ("P.O.P. NEO-DX", "Kuma", "Bartholomew Kuma", "high", 160),
        ("P.O.P. Maximum", "Yamato", "Yamato (Dragon Form)", "grail", 350),
        ("P.O.P. Maximum", "Gear 5 Luffy", "Luffy Gear 5 (Giant Fist)", "grail", 380),
        ("P.O.P. Playback Memories", "Nami", "Nami (Arlong Park)", "high", 150),

        # ── One Piece Card Game — OP06-OP10 (~30) ────────────────────────
        ("OP Card Game", "OP06 Booster Box", "OP06 Wings of the Captain Booster Box (24 packs)", "high", 120),
        ("OP Card Game", "OP07 Booster Box", "OP07 500 Years in the Future Booster Box (24 packs)", "high", 130),
        ("OP Card Game", "OP08 Booster Box", "OP08 Two Legends Booster Box (24 packs)", "high", 140),
        ("OP Card Game", "OP09 Booster Box", "OP09 The Four Emperors Booster Box (24 packs)", "high", 150),
        ("OP Card Game", "OP10 Booster Box", "OP10 Royal Blood Booster Box (24 packs)", "high", 160),
        ("OP Card Game", "Monkey D. Luffy", "OP06 Luffy (Gear 5) Secret Rare", "grail", 200),
        ("OP Card Game", "Roronoa Zoro", "OP06 Zoro (King of Hell) Alt Art", "high", 120),
        ("OP Card Game", "Portgas D. Ace", "OP07 Ace (Flame Emperor) Secret Rare", "high", 150),
        ("OP Card Game", "Shanks", "OP07 Shanks (Film Red) Alt Art Leader", "high", 180),
        ("OP Card Game", "Trafalgar Law", "OP08 Law (K-ROOM) Secret Rare", "high", 130),
        ("OP Card Game", "Kaido", "OP08 Kaido (Flame Dragon) Alt Art", "grail", 200),
        ("OP Card Game", "Boa Hancock", "OP09 Hancock Secret Rare", "high", 100),
        ("OP Card Game", "Yamato", "OP09 Yamato (Thunder Bagua) Alt Art", "high", 120),
        ("OP Card Game", "Nika Luffy", "OP10 Nika Luffy Secret Rare", "grail", 250),
        ("OP Card Game", "Blackbeard", "OP10 Blackbeard (Yami Yami) Alt Art", "high", 140),
        ("OP Card Game", "Monkey D. Luffy", "OP01 Luffy Leader Card (Parallel Art)", "grail", 300),
        ("OP Card Game", "Nami", "OP01 Nami Leader Card (Parallel Art)", "high", 150),
        ("OP Card Game", "Roronoa Zoro", "OP01 Zoro Leader Card (Parallel Art)", "grail", 200),
        ("OP Card Game", "Trafalgar Law", "OP01 Law Leader Card (Parallel Art)", "high", 180),
        ("OP Card Game", "Sanji", "OP03 Sanji (Ifrit Jambe) Secret Rare", "high", 110),
        ("OP Card Game", "Nico Robin", "OP04 Robin (Demon Form) Secret Rare", "high", 100),
        ("OP Card Game", "Mihawk", "OP05 Mihawk (World's Strongest) Alt Art", "high", 130),
        ("OP Card Game", "Sabo", "OP05 Sabo (Flame Dragon) Secret Rare", "high", 120),
        ("OP Card Game", "Monkey D. Luffy", "OP02 Luffy (Red Hawk) Secret Rare", "high", 170),
        ("OP Card Game", "Enel", "OP05 Enel (Lightning) Alt Art", "high", 100),
        ("OP Card Game", "Don Flamingo", "OP04 Doflamingo Leader Card (Alt Art)", "high", 110),
        ("OP Card Game", "Katakuri", "OP03 Katakuri Leader Card (Alt Art)", "high", 120),
        ("OP Card Game", "Big Mom", "OP03 Big Mom (Napoleon) Secret Rare", "high", 100),
        ("OP Card Game", "Crocodile", "OP04 Crocodile (Alt Art Secret Rare)", "high", 90),
        ("OP Card Game", "Rob Lucci", "OP05 Lucci (Awakened) Secret Rare", "mid", 80),

        # ── Ichiban Kuji — Last One & A Prizes (~15) ─────────────────────
        ("Ichiban Kuji", "Monkey D. Luffy", "Ichiban Kuji Last One Luffy (Gear 5, Chrome)", "grail", 300),
        ("Ichiban Kuji", "Roronoa Zoro", "Ichiban Kuji Last One Zoro (Enma, Gold)", "grail", 280),
        ("Ichiban Kuji", "Kaido", "Ichiban Kuji Last One Kaido (Dragon, Silver)", "grail", 320),
        ("Ichiban Kuji", "Shanks", "Ichiban Kuji Last One Shanks (Film Red)", "grail", 260),
        ("Ichiban Kuji", "Yamato", "Ichiban Kuji A Prize Yamato", "high", 120),
        ("Ichiban Kuji", "Boa Hancock", "Ichiban Kuji A Prize Hancock", "high", 100),
        ("Ichiban Kuji", "Portgas D. Ace", "Ichiban Kuji A Prize Ace (Flames)", "high", 110),
        ("Ichiban Kuji", "Trafalgar Law", "Ichiban Kuji A Prize Law (K-ROOM)", "high", 100),
        ("Ichiban Kuji", "Sabo", "Ichiban Kuji A Prize Sabo (Dragon Breath)", "high", 90),
        ("Ichiban Kuji", "Nico Robin", "Ichiban Kuji B Prize Robin (Demon Form)", "mid", 70),
        ("Ichiban Kuji", "Nami", "Ichiban Kuji B Prize Nami (Zeus)", "mid", 65),
        ("Ichiban Kuji", "Sanji", "Ichiban Kuji B Prize Sanji (Ifrit)", "mid", 60),
        ("Ichiban Kuji", "Monkey D. Luffy", "Ichiban Kuji EX Luffy (Gear 5, Egghead)", "grail", 350),
        ("Ichiban Kuji", "Vegapunk", "Ichiban Kuji A Prize Vegapunk (Stella)", "high", 80),
        ("Ichiban Kuji", "Bonney", "Ichiban Kuji A Prize Bonney (Nika Form)", "high", 100),

        # ── WCF — World Collectable Figure (~15) ─────────────────────────
        ("WCF", "Straw Hat Crew", "WCF Vol. 1 Complete Set (8 figures)", "high", 80),
        ("WCF", "Straw Hat Crew", "WCF Vol. 2 Complete Set (8 figures)", "high", 80),
        ("WCF", "Wano Country", "WCF Wano Complete Set (8 figures)", "high", 90),
        ("WCF", "Film Red", "WCF Film Red Complete Set (6 figures)", "mid", 60),
        ("WCF", "Egghead", "WCF Egghead Complete Set (8 figures)", "high", 100),
        ("WCF", "Marine Ford", "WCF Marine Ford Complete Set (8 figures)", "high", 120),
        ("WCF", "Whole Cake Island", "WCF Whole Cake Island Complete Set (6 figures)", "mid", 70),
        ("WCF", "Dressrosa", "WCF Dressrosa Complete Set (6 figures)", "mid", 65),
        ("WCF", "Reverie", "WCF Reverie Complete Set (6 figures)", "high", 100),
        ("WCF", "Monkey D. Luffy", "WCF Mega Luffy (Gear 5, Gold)", "high", 150),
        ("WCF", "Shanks", "WCF Mega Shanks", "high", 100),
        ("WCF", "Kaido", "WCF Mega Kaido (Dragon Form)", "high", 120),
        ("WCF", "Roronoa Zoro", "WCF Mega Zoro (Santoryu)", "mid", 80),
        ("WCF", "Whitebeard", "WCF Mega Whitebeard", "high", 110),
        ("WCF", "Blackbeard", "WCF Mega Blackbeard", "mid", 90),

        # ── Manga Box Sets & Books (~15) ──────────────────────────────────
        ("Manga Box Set", "One Piece", "One Piece Manga Box Set 1 (Vol. 1-23)", "high", 170),
        ("Manga Box Set", "One Piece", "One Piece Manga Box Set 2 (Vol. 24-46)", "high", 180),
        ("Manga Box Set", "One Piece", "One Piece Manga Box Set 3 (Vol. 47-70)", "high", 180),
        ("Manga Box Set", "One Piece", "One Piece Manga Box Set 4 (Vol. 71-90)", "high", 190),
        ("Manga Box Set", "One Piece", "One Piece Manga Vol. 1 (1st Print, English)", "grail", 300),
        ("Manga Box Set", "One Piece", "One Piece Color Walk Compendium 1", "mid", 50),
        ("Manga Box Set", "One Piece", "One Piece Color Walk Compendium 2", "mid", 55),
        ("Manga Box Set", "One Piece", "One Piece Color Walk 9 (Tiger)", "mid", 45),
        ("Manga Box Set", "One Piece", "One Piece Magazine Vol. 1-15 Complete", "high", 120),
        ("Manga Box Set", "One Piece", "One Piece Vivre Card Complete Set (Binder)", "high", 150),
        ("Manga Box Set", "One Piece", "One Piece Databook Red (Grand Characters)", "standard", 25),
        ("Manga Box Set", "One Piece", "One Piece Databook Blue (Grand Data File)", "standard", 25),
        ("Manga Box Set", "One Piece", "One Piece Art Book: Eiichiro Oda Illustration Works", "mid", 60),
        ("Manga Box Set", "One Piece", "One Piece Film Red Pamphlet (Theater LE)", "standard", 20),
        ("Manga Box Set", "One Piece", "One Piece Novel A (Ace Story) 1-2 Set", "standard", 30),
    ]
