...
def get_curated_catalog() -> list[dict]:
    ...
    items = [
        ...
        # ── Studio Ghibli / Joe Hisaishi Vinyl (~20) ─────────────────────
        ("Studio Ghibli Records", "Spirited Away Soundtrack (Joe Hisaishi) 2LP", "Spirited Away", "Japanese Pressing", "Black", "high", 80),
        ("Studio Ghibli Records", "Spirited Away Image Album (Joe Hisaishi)", "Spirited Away", "Japanese Pressing", "Clear Blue", "grail", 120),
        ("Studio Ghibli Records", "Princess Mononoke Symphonic Suite (Joe Hisaishi)", "Princess Mononoke", "Japanese Pressing", "Black", "high", 75),
        ("Studio Ghibli Records", "My Neighbor Totoro Soundtrack (Joe Hisaishi)", "My Neighbor Totoro", "Japanese Pressing", "Black", "high", 70),
        ("Studio Ghibli Records", "Howl's Moving Castle Soundtrack (Joe Hisaishi)", "Howl's Moving Castle", "Japanese Pressing", "Black", "high", 70),
        ("Studio Ghibli Records", "Ponyo Soundtrack (Joe Hisaishi)", "Ponyo", "Japanese Pressing", "Black", "high", 65),
        ("Studio Ghibli Records", "Castle in the Sky Soundtrack (Joe Hisaishi)", "Castle in the Sky", "Japanese Pressing", "Black", "high", 75),
        ("Studio Ghibli Records", "Nausicaa Soundtrack (Joe Hisaishi)", "Nausicaa", "Japanese Pressing", "Black", "high", 80),
        ("Studio Ghibli Records", "Kiki's Delivery Service Soundtrack (Joe Hisaishi)", "Kiki's Delivery Service", "Japanese Pressing", "Black", "high", 70),
        ("Studio Ghibli Records", "The Wind Rises Soundtrack (Joe Hisaishi)", "The Wind Rises", "Japanese Pressing", "Black", "high", 65),
        ("Studio Ghibli Records", "Porco Rosso Soundtrack (Joe Hisaishi)", "Porco Rosso", "Japanese Pressing", "Black", "high", 65),
        ("Studio Ghibli Records", "The Tale of Princess Kaguya Soundtrack (Joe Hisaishi)", "Princess Kaguya", "Japanese Pressing", "Black", "high", 70),
        ("Studio Ghibli Records", "The Boy and the Heron Soundtrack (Joe Hisaishi)", "The Boy and the Heron", "Japanese Pressing", "Black", "high", 80),
        ("Joe Hisaishi", "Joe Hisaishi: Dream Songs — The Essential (3LP)", "Joe Hisaishi", "EU Pressing", "Black", "high", 65),
        ("Joe Hisaishi", "Joe Hisaishi: A Symphonic Celebration (2LP)", "Joe Hisaishi", "EU Pressing", "Blue Translucent", "high", 75),
        ("Joe Hisaishi", "Joe Hisaishi in Budokan: Studio Ghibli 25th Live (3LP)", "Joe Hisaishi", "Japanese Pressing", "Black", "grail", 150),
        ("Milan Records", "Princess Mononoke Soundtrack (Deluxe Reissue 2LP)", "Princess Mononoke", "EU/US Pressing", "Forest Green", "high", 55),
        ("Milan Records", "Spirited Away Soundtrack (Deluxe Reissue 2LP)", "Spirited Away", "EU/US Pressing", "Transparent Blue", "high", 55),
        ("Milan Records", "My Neighbor Totoro Soundtrack (Color Reissue)", "My Neighbor Totoro", "EU/US Pressing", "Leaf Green", "high", 50),
        ("Milan Records", "Castle in the Sky Soundtrack (Color Reissue)", "Castle in the Sky", "EU/US Pressing", "Sky Blue", "high", 50),

        # ── Popular Anime OST Vinyl (~20) ────────────────────────────────
        ("Milan Records", "Cowboy Bebop OST 2 (No Disc)", "Cowboy Bebop", "EU/US Pressing", "Black", "mid", 38),
        ("Milan Records", "Cowboy Bebop: Knockin' On Heaven's Door OST", "Cowboy Bebop", "EU/US Pressing", "Black", "mid", 40),
        ("King Records", "Neon Genesis Evangelion OST Vol.1 (Shiro Sagisu)", "Evangelion", "Japanese Pressing", "Black", "high", 90),
        ("King Records", "Neon Genesis Evangelion OST Vol.2 (Shiro Sagisu)", "Evangelion", "Japanese Pressing", "Black", "high", 85),
        ("King Records", "Evangelion: 3.0+1.0 OST (Shiro Sagisu) 3LP", "Evangelion", "Japanese Pressing", "Black", "grail", 130),
        ("Milan Records", "Attack on Titan Season 1 OST (Hiroyuki Sawano) 2LP", "Attack on Titan", "EU/US Pressing", "Red Marble", "high", 65),
        ("Milan Records", "Attack on Titan Season 2 OST (Hiroyuki Sawano) 2LP", "Attack on Titan", "EU/US Pressing", "Crimson", "high", 65),
        ("Milan Records", "Attack on Titan Final Season OST (KOHTA YAMAMOTO)", "Attack on Titan", "EU/US Pressing", "Black", "mid", 45),
        ("Aniplex", "Demon Slayer: Kimetsu no Yaiba OST 2LP", "Demon Slayer", "Japanese Pressing", "Flame Orange", "high", 80),
        ("Aniplex", "Demon Slayer: Mugen Train OST LP", "Demon Slayer", "Japanese Pressing", "Black", "high", 60),
        ("Aniplex", "Jujutsu Kaisen Season 1 OST 2LP", "Jujutsu Kaisen", "Japanese Pressing", "Purple Splatter", "high", 75),
        ("Aniplex", "Jujutsu Kaisen Season 2 OST 2LP (Shibuya Incident)", "Jujutsu Kaisen", "Japanese Pressing", "Black", "high", 70),
        ("Crunchyroll Vinyl", "Chainsaw Man OST (Kensuke Ushio) 2LP", "Chainsaw Man", "US Pressing", "Blood Red Splatter", "high", 75),
        ("Crunchyroll Vinyl", "Chainsaw Man: KICK BACK / FIRST DEATH 7\" Single", "Chainsaw Man", "US Pressing", "Black", "mid", 30),
        ("Crunchyroll Vinyl", "Spy x Family OST (K)NoW_NAME 2LP", "Spy x Family", "US Pressing", "Pink/Green Split", "high", 60),
        ("Crunchyroll Vinyl", "Spy x Family Mixed Nuts / Comedy 7\" Single", "Spy x Family", "US Pressing", "Black", "mid", 28),
        ("Tiger Lab Vinyl", "Trigun OST (Tsuneo Imahori)", "Trigun", "US Pressing", "Black", "mid", 45),
        ("Tiger Lab Vinyl", "Trigun OST (Tsuneo Imahori)", "Trigun", "US Pressing", "Desert Gold", "high", 80),
        ("Milan Records", "Frieren: Beyond Journey's End OST (Evan Call) 2LP", "Frieren", "EU/US Pressing", "Black", "high", 55),
        ("Milan Records", "Frieren: Beyond Journey's End OST (Evan Call) 2LP", "Frieren", "EU/US Pressing", "Purple Translucent", "high", 70),

        # ── Tiger Lab & Milan Additional (~15) ───────────────────────────
        ("Tiger Lab Vinyl", "Lupin III: The Castle of Cagliostro OST", "Lupin III", "US Pressing", "Black", "mid", 42),
        ("Tiger Lab Vinyl", "Lupin III: The Castle of Cagliostro OST", "Lupin III", "US Pressing", "Gold", "high", 75),
        ("Tiger Lab Vinyl", "Afro Samurai OST (The RZA)", "Afro Samurai", "US Pressing", "Black", "mid", 40),
        ("Tiger Lab Vinyl", "Afro Samurai OST (The RZA)", "Afro Samurai", "US Pressing", "Red/Black Splatter", "high", 70),
        ("Tiger Lab Vinyl", "Vampire Hunter D: Bloodlust OST", "Vampire Hunter D", "US Pressing", "Black", "mid", 45),
        ("Tiger Lab Vinyl", "Vampire Hunter D: Bloodlust OST", "Vampire Hunter D", "US Pressing", "Blood Red", "high", 80),
        ("Milan Records", "Oshi no Ko OST (Takeshi Nakatsuka) LP", "Oshi no Ko", "EU/US Pressing", "Black", "mid", 40),
        ("Milan Records", "Solo Leveling OST LP", "Solo Leveling", "EU/US Pressing", "Shadow Purple", "high", 55),
        ("Milan Records", "Dandadan OST LP", "Dandadan", "EU/US Pressing", "Alien Green", "mid", 45),
        ("Milan Records", "Kaiju No. 8 OST LP", "Kaiju No. 8", "EU/US Pressing", "Black", "mid", 40),
        ("Milan Records", "Vinland Saga Season 2 OST 2LP", "Vinland Saga", "EU/US Pressing", "Black", "high", 55),
        ("Milan Records", "Hell's Paradise OST LP", "Hell's Paradise", "EU/US Pressing", "Clear", "mid", 42),
        ("Milan Records", "Mushoku Tensei OST 2LP", "Mushoku Tensei", "EU/US Pressing", "Black", "high", 50),
        ("Milan Records", "Ranking of Kings OST LP", "Ranking of Kings", "EU/US Pressing", "Gold", "mid", 45),
        ("Milan Records", "Bocchi the Rock! OST LP", "Bocchi the Rock!", "EU/US Pressing", "Pink", "mid", 40),

        # ── Video Game Crossover OST Vinyl (~15) ─────────────────────────
        ("iam8bit", "Final Fantasy VII Remake OST (4LP Box)", "Final Fantasy VII", "US Pressing", "Mako Green Splatter", "grail", 140),
        ("iam8bit", "Final Fantasy X HD Remaster OST (4LP)", "Final Fantasy X", "US Pressing", "Blue Ocean", "grail", 120),
        ("iam8bit", "The Legend of Zelda: Breath of the Wild OST (4LP)", "Zelda", "US Pressing", "Green Marble", "grail", 130),
        ("iam8bit", "The Legend of Zelda: Tears of the Kingdom OST (3LP)", "Zelda", "US Pressing", "Sky Blue", "grail", 120),
        ("iam8bit", "Persona 5 Royal OST (Deluxe 6LP Box)", "Persona 5", "US Pressing", "Red/Black", "grail", 200),
        ("iam8bit", "Persona 5 Strikers OST (3LP)", "Persona 5 Strikers", "US Pressing", "Phantom Red", "high", 85),
        ("Square Enix", "NieR:Automata OST (Vinyl Box Edition 4LP)", "NieR: Automata", "Japanese Pressing", "Black", "grail", 180),
        ("Square Enix", "NieR Replicant ver.1.22 OST (4LP Box)", "NieR Replicant", "Japanese Pressing", "White", "grail", 160),
        ("Laced Records", "Dark Souls Trilogy OST (6LP Box)", "Dark Souls", "EU Pressing", "Black", "grail", 200),
        ("Laced Records", "Bloodborne OST (2LP)", "Bloodborne", "EU Pressing", "Crimson Red", "high", 80),
        ("Data Discs", "Streets of Rage 2 OST", "Streets of Rage", "EU Pressing", "Clear Red", "high", 60),
        ("Data Discs", "Shenmue OST (5LP Definitive Edition)", "Shenmue", "EU Pressing", "Black", "grail", 150),
        ("Materia Collective", "Undertale OST (2LP)", "Undertale", "US Pressing", "Blue/Purple Splatter", "high", 65),
        ("Fangamer", "Celeste OST (2LP)", "Celeste", "US Pressing", "Berry Pink", "high", 60),
        ("Laced Records", "Elden Ring OST (4LP Box)", "Elden Ring", "EU Pressing", "Gold/Black Splatter", "grail", 140),

        # ── Classic Anime Vinyl (~15) ────────────────────────────────────
        ("Mondo", "Akira Symphonic Suite (2LP)", "Akira", "US Pressing", "Neon Pink/Blue", "grail", 120),
        ("Mondo", "Akira OST (2LP Geinoh Yamashirogumi)", "Akira", "US Pressing", "Black", "high", 80),
        ("Mondo", "Ghost in the Shell OST (Kenji Kawai) LP", "Ghost in the Shell", "US Pressing", "Clear", "high", 70),
        ("Mondo", "Ghost in the Shell: SAC OST (Yoko Kanno) 2LP", "Ghost in the Shell: SAC", "US Pressing", "Purple/Teal Split", "grail", 110),
        ("Tiger Lab Vinyl", "Macross Plus OST (Yoko Kanno) 2LP", "Macross Plus", "US Pressing", "Black", "high", 55),
        ("Tiger Lab Vinyl", "Macross Plus OST (Yoko Kanno) 2LP", "Macross Plus", "US Pressing", "Valkyrie Blue", "high", 90),
        ("King Records", "Macross: Do You Remember Love? OST", "Macross", "Japanese OG Pressing", "Black", "grail", 150),
        ("King Records", "Bubblegum Crisis OST Complete (3LP Box)", "Bubblegum Crisis", "Japanese OG Pressing", "Black", "grail", 200),
        ("King Records", "Megazone 23 OST (Shiro Sagisu)", "Megazone 23", "Japanese OG Pressing", "Black", "high", 90),
        ("Columbia Japan", "Galaxy Express 999 OST", "Galaxy Express 999", "Japanese OG Pressing", "Black", "high", 80),
        ("King Records", "Patlabor OST (Kenji Kawai) LP", "Patlabor", "Japanese OG Pressing", "Black", "high", 75),
        ("Columbia Japan", "Urusei Yatsura OST (Various) 2LP", "Urusei Yatsura", "Japanese OG Pressing", "Black", "high", 85),
        ("King Records", "Dirty Pair OST LP", "Dirty Pair", "Japanese OG Pressing", "Black", "high", 70),
        ("Victor Entertainment", "Initial D OST (Eurobeat Collection) 2LP", "Initial D", "Japanese Pressing", "Racing Red", "high", 95),
        ("Aniplex", "Berserk (1997) OST (Susumu Hirasawa) LP Forces", "Berserk", "Japanese Pressing", "Black", "high", 85),

        # ── Limited Color Pressings & Event Exclusives (~15) ─────────────
        ("Mondo", "Dragon Ball Z: The Saiyan Saga (2LP)", "Dragon Ball Z", "US Pressing", "Vegeta Blue/Orange", "high", 70),
        ("Mondo", "Dragon Ball Z: The Namek Saga (2LP)", "Dragon Ball Z", "US Pressing", "Frieza Purple", "high", 70),
        ("Mondo", "Dragon Ball Z: The Android Saga (2LP)", "Dragon Ball Z", "US Pressing", "Cell Green", "high", 75),
        ("Mondo", "Attack on Titan Season 3 OST (Hiroyuki Sawano)", "Attack on Titan", "US Pressing", "Titan Flesh Pink", "high", 65),
        ("Mondo", "My Hero Academia OST (Yuki Hayashi) 2LP", "My Hero Academia", "US Pressing", "Green/Yellow Split", "high", 55),
        ("Crunchyroll Vinyl", "IDOL / Sign wa B (Oshi no Ko) 12\" Single", "Oshi no Ko", "US Pressing", "Star Pink", "mid", 35),
        ("Aniplex", "Sword Art Online OST (Yuki Kajiura) 2LP", "Sword Art Online", "Japanese Pressing", "Aincrad Blue", "high", 75),
        ("Aniplex", "Fate/Zero OST (Yuki Kajiura) 2LP", "Fate/Zero", "Japanese Pressing", "Black", "high", 80),
        ("Aniplex", "Madoka Magica OST (Yuki Kajiura) 2LP", "Madoka Magica", "Japanese Pressing", "Soul Gem Purple", "high", 85),
        ("Aniplex", "Kill la Kill OST (Hiroyuki Sawano) 2LP", "Kill la Kill", "Japanese Pressing", "Scissor Blade Red", "high", 70),
        ("RSD Exclusive", "Cowboy Bebop OST (2024 RSD) (Seatbelts)", "Cowboy Bebop", "RSD Exclusive", "Gold Translucent", "grail", 120),
        ("RSD Exclusive", "Akira OST (2024 RSD)", "Akira", "RSD Exclusive", "Neon Red", "grail", 110),
        ("RSD Exclusive", "Ghost in the Shell OST (2024 RSD)", "Ghost in the Shell", "RSD Exclusive", "Cyber Green", "grail", 100),
        ("Convention Exclusive", "Evangelion OST (Anime Expo 2024 LE)", "Evangelion", "Event Exclusive", "Angel White/Red", "grail", 130),
        ("Convention Exclusive", "Cowboy Bebop Blue (Anime NYC 2024 LE)", "Cowboy Bebop", "Event Exclusive", "Midnight Blue Marble", "grail", 110),

        # ── Data Discs (Sega Game Vinyl) ──────────────────────────────────
        ("Data Discs", "Jet Set Radio OST", "Jet Set Radio", "Standard", "Black", "mid", 35),
        ("Data Discs", "Jet Set Radio OST", "Jet Set Radio", "Limited", "Tricolor Splatter", "high", 80),
        ("Data Discs", "Jet Set Radio Future OST (2LP)", "Jet Set Radio Future", "Standard", "Black", "mid", 38),
        ("Data Discs", "Shenmue OST (4LP Box)", "Shenmue", "Standard", "Black", "high", 90),
        ("Data Discs", "Shenmue OST (4LP Box)", "Shenmue", "Limited", "Marble Blue", "grail", 150),
        ("Data Discs", "Streets of Rage OST", "Streets of Rage", "Standard", "Black", "mid", 30),
        ("Data Discs", "Streets of Rage 2 OST", "Streets of Rage 2", "Standard", "Black", "mid", 32),
        ("Data Discs", "Streets of Rage 2 OST", "Streets of Rage 2", "Limited", "Clear Red", "high", 65),
        ("Data Discs", "Streets of Rage 3 OST", "Streets of Rage 3", "Standard", "Black", "mid", 30),
        ("Data Discs", "Panzer Dragoon OST", "Panzer Dragoon", "Standard", "Black", "mid", 35),
        ("Data Discs", "Panzer Dragoon OST", "Panzer Dragoon", "Limited", "Crystal Clear", "high", 70),
        ("Data Discs", "Sonic the Hedgehog 1 & 2 (2LP)", "Sonic the Hedgehog", "Standard", "Black", "mid", 35),
        ("Data Discs", "Sonic the Hedgehog 1 & 2 (2LP)", "Sonic the Hedgehog", "Limited", "Blue/Red Splatter", "high", 75),
        ("Data Discs", "Sonic CD OST (2LP)", "Sonic CD", "Standard", "Black", "mid", 35),
        ("Data Discs", "NiGHTS into Dreams OST", "NiGHTS into Dreams", "Standard", "Black", "mid", 32),
        ("Data Discs", "NiGHTS into Dreams OST", "NiGHTS into Dreams", "Limited", "Purple Splatter", "high", 70),
        ("Data Discs", "Virtua Fighter OST", "Virtua Fighter", "Standard", "Black", "mid", 30),
        ("Data Discs", "Thunder Force IV OST", "Thunder Force IV", "Limited", "Red/Blue Split", "high", 65),
        ("Data Discs", "OutRun OST", "OutRun", "Standard", "Black", "mid", 32),
        ("Data Discs", "OutRun OST", "OutRun", "Limited", "Sunset Orange", "high", 70),

        # ── Fangamer Vinyl ────────────────────────────────────────────────
        ("Fangamer", "Undertale OST (2LP)", "Undertale", "Standard", "Black", "mid", 35),
        ("Fangamer", "Undertale OST (2LP)", "Undertale", "Limited", "Blue/Orange Split", "high", 80),
        ("Fangamer", "Celeste OST (2LP)", "Celeste", "Standard", "Black", "mid", 35),
        ("Fangamer", "Celeste OST (2LP)", "Celeste", "Limited", "Crystal Clear", "high", 75),
        ("Fangamer", "Hollow Knight OST (2LP)", "Hollow Knight", "Standard", "Black", "mid", 38),
        ("Fangamer", "Hollow Knight OST (2LP)", "Hollow Knight", "Limited", "Clear Blue", "high", 85),
        ("Fangamer", "Stardew Valley OST (4LP Box)", "Stardew Valley", "Standard", "Black", "high", 70),
        ("Fangamer", "Stardew Valley OST (4LP Box)", "Stardew Valley", "Limited", "Seasonal Color 4LP Set", "grail", 140),
        ("Fangamer", "Deltarune Chapter 1 & 2 OST (2LP)", "Deltarune", "Standard", "Black", "mid", 35),
        ("Fangamer", "OMORI OST (3LP)", "OMORI", "Standard", "Black", "mid", 45),
        ("Fangamer", "OMORI OST (3LP)", "OMORI", "Limited", "White/Black Split", "high", 90),
        ("Fangamer", "Hades OST (4LP Box)", "Hades", "Standard", "Black", "high", 65),
        ("Fangamer", "Hades OST (4LP Box)", "Hades", "Limited", "Blood Red Marble", "grail", 130),

        # ── Light in the Attic Releases ───────────────────────────────────
        ("Light in the Attic", "Katamari Damacy OST (2LP)", "Katamari Damacy", "Standard", "Black", "mid", 38),
        ("Light in the Attic", "Katamari Damacy OST (2LP)", "Katamari Damacy", "Limited", "Rainbow Roll", "high", 80),
        ("Light in the Attic", "We Love Katamari OST (2LP)", "We Love Katamari", "Standard", "Black", "mid", 38),
        ("Light in the Attic", "Beautiful Katamari OST (2LP)", "Beautiful Katamari", "Limited", "Cosmic Purple", "high", 75),
        ("Light in the Attic", "Okami OST (4LP Box)", "Okami", "Standard", "Black", "high", 90),
        ("Light in the Attic", "Okami OST (4LP Box)", "Okami", "Limited", "Cherry Blossom Pink", "grail", 160),

        # ── iam8bit Releases ──────────────────────────────────────────────
        ("iam8bit", "Journey OST (2LP)", "Journey", "Standard", "Black", "mid", 35),
        ("iam8bit", "Journey OST (2LP)", "Journey", "Limited", "White Marble", "high", 80),
        ("iam8bit", "Shadow of the Colossus OST (2LP)", "Shadow of the Colossus", "Standard", "Black", "mid", 38),
        ("iam8bit", "Shadow of the Colossus OST (2LP)", "Shadow of the Colossus", "Limited", "Stone Grey Marble", "high", 85),
        ("iam8bit", "The Last of Us OST (2LP)", "The Last of Us", "Standard", "Black", "mid", 38),
        ("iam8bit", "The Last of Us OST (2LP)", "The Last of Us", "Limited", "Moss Green", "high", 80),
        ("iam8bit", "Persona 5 OST (3LP)", "Persona 5", "Standard", "Black", "high", 60),
        ("iam8bit", "Persona 5 OST (3LP)", "Persona 5", "Limited", "Red/Black Splatter", "grail", 120),
        ("iam8bit", "Uncharted: Nathan Drake Collection (3LP)", "Uncharted", "Limited", "Gold Marble", "high", 90),
        ("iam8bit", "God of War (2018) OST (2LP)", "God of War", "Standard", "Black", "mid", 38),
        ("iam8bit", "God of War (2018) OST (2LP)", "God of War", "Limited", "Leviathan Blue", "high", 80),
        ("iam8bit", "Returnal OST (2LP)", "Returnal", "Standard", "Black", "mid", 35),
        ("iam8bit", "Death Stranding OST (3LP)", "Death Stranding", "Standard", "Black", "mid", 45),
        ("iam8bit", "Death Stranding OST (3LP)", "Death Stranding", "Limited", "Crystal Clear", "high", 90),

        # ── Mondo Vinyl (Anime & Game) ────────────────────────────────────
        ("Mondo", "Akira OST (2LP)", "Akira", "Standard", "Black", "high", 55),
        ("Mondo", "Akira OST (2LP)", "Akira", "Limited", "Neo Tokyo Red", "grail", 120),
        ("Mondo", "Ghost in the Shell OST", "Ghost in the Shell", "Standard", "Black", "high", 50),
        ("Mondo", "Ghost in the Shell OST", "Ghost in the Shell", "Limited", "Tachikoma Blue", "grail", 110),
        ("Mondo", "Dragon Ball Z — Hit Song Collection (2LP)", "Dragon Ball Z", "Standard", "Black", "mid", 40),
        ("Mondo", "Dragon Ball Z — Hit Song Collection (2LP)", "Dragon Ball Z", "Limited", "Orange Splatter", "high", 80),
        ("Mondo", "Attack on Titan OST (2LP)", "Attack on Titan", "Standard", "Black", "mid", 45),
        ("Mondo", "Attack on Titan OST (2LP)", "Attack on Titan", "Limited", "Crimson Red", "high", 90),
        ("Mondo", "Demon Slayer OST (2LP)", "Demon Slayer", "Standard", "Black", "mid", 42),
        ("Mondo", "Demon Slayer OST (2LP)", "Demon Slayer", "Limited", "Flame Orange/Blue Split", "high", 85),
        ("Mondo", "Castlevania: Symphony of the Night OST (2LP)", "Castlevania SotN", "Standard", "Black", "high", 55),
        ("Mondo", "Castlevania: Symphony of the Night OST (2LP)", "Castlevania SotN", "Limited", "Blood Red", "grail", 120),
        ("Mondo", "Mega Man 2 OST", "Mega Man 2", "Standard", "Black", "mid", 35),
        ("Mondo", "Mega Man 2 OST", "Mega Man 2", "Limited", "Blue/Yellow Split", "high", 70),
        ("Mondo", "Silent Hill 2 OST (2LP)", "Silent Hill 2", "Standard", "Black", "high", 55),
        ("Mondo", "Silent Hill 2 OST (2LP)", "Silent Hill 2", "Limited", "Fog Grey", "grail", 130),

        # ── Ship to Shore PhonoCo ─────────────────────────────────────────
        ("Ship to Shore", "Mega Man 3 OST", "Mega Man 3", "Standard", "Black", "mid", 30),
        ("Ship to Shore", "Mega Man 3 OST", "Mega Man 3", "Limited", "Blue Marble", "high", 65),
        ("Ship to Shore", "Castlevania III: Dracula's Curse OST", "Castlevania III", "Standard", "Black", "mid", 32),
        ("Ship to Shore", "Castlevania III: Dracula's Curse OST", "Castlevania III", "Limited", "Pumpkin Orange", "high", 70),
        ("Ship to Shore", "Contra OST", "Contra", "Standard", "Black", "mid", 28),
        ("Ship to Shore", "Contra OST", "Contra", "Limited", "Red/Blue Split", "high", 60),
        ("Ship to Shore", "Double Dragon OST", "Double Dragon", "Standard", "Black", "mid", 28),
        ("Ship to Shore", "Gradius OST", "Gradius", "Standard", "Black", "mid", 30),
        ("Ship to Shore", "Snatcher OST (2LP)", "Snatcher", "Standard", "Black", "mid", 38),
        ("Ship to Shore", "Snatcher OST (2LP)", "Snatcher", "Limited", "Neon Blue", "high", 80),

        # ── Black Screen Records ──────────────────────────────────────────
        ("Black Screen Records", "Ori and the Blind Forest OST (2LP)", "Ori and the Blind Forest", "Standard", "Black", "mid", 38),
        ("Black Screen Records", "Ori and the Blind Forest OST (2LP)", "Ori and the Blind Forest", "Limited", "Glow in Dark", "high", 85),
        ("Black Screen Records", "Ori and the Will of the Wisps OST (2LP)", "Ori WotW", "Standard", "Black", "mid", 38),
        ("Black Screen Records", "Ori and the Will of the Wisps OST (2LP)", "Ori WotW", "Limited", "Blue/Purple Swirl", "high", 80),
        ("Black Screen Records", "Divinity: Original Sin 2 OST (3LP)", "Divinity OS2", "Standard", "Black", "mid", 45),
        ("Black Screen Records", "Divinity: Original Sin 2 OST (3LP)", "Divinity OS2", "Limited", "Fire Red/Ice Blue", "high", 90),
        ("Black Screen Records", "Cuphead OST (3LP)", "Cuphead", "Standard", "Black", "high", 50),
        ("Black Screen Records", "Cuphead OST (3LP)", "Cuphead", "Limited", "Inkwell Isle Blue", "grail", 100),
        ("Black Screen Records", "Disco Elysium OST (2LP)", "Disco Elysium", "Standard", "Black", "mid", 40),
        ("Black Screen Records", "Disco Elysium OST (2LP)", "Disco Elysium", "Limited", "Orange/Black Split", "high", 80),
        ("Black Screen Records", "Outer Wilds OST (2LP)", "Outer Wilds", "Standard", "Black", "mid", 38),
        ("Black Screen Records", "Outer Wilds OST (2LP)", "Outer Wilds", "Limited", "Galaxy Purple Splatter", "high", 85),

        # ── More Anime Vinyl Labels ───────────────────────────────────────
        ("Vinyl Me Please", "Cowboy Bebop OST 1 (VMP Edition)", "Cowboy Bebop", "VMP Exclusive", "Tangerine Orange", "high", 90),
        ("Vinyl Me Please", "Akira OST (VMP Edition 2LP)", "Akira", "VMP Exclusive", "Red/Blue Split", "grail", 130),
        ("Square Enix", "Final Fantasy VII OST (4LP Box)", "Final Fantasy VII", "Japanese Pressing", "Black", "grail", 200),
        ("Square Enix", "NieR: Automata Vinyl Box Set (4LP)", "NieR: Automata", "Japanese Pressing", "White", "grail", 180),
        ("Square Enix", "Final Fantasy XIV: Endwalker OST (2LP)", "Final Fantasy XIV", "Japanese Pressing", "Black", "high", 80),
        ("Atlus", "Persona 3 OST (3LP)", "Persona 3", "Japanese Pressing", "Black", "high", 70),
        ("Wayo Records", "NieR: Gestalt & Replicant OST (2LP)", "NieR", "Standard", "Black", "mid", 40),
        ("Wayo Records", "NieR: Gestalt & Replicant OST (2LP)", "NieR", "Limited", "Snow White", "high", 85),

        # ── Additional Tiger Lab / Milan / Japanese Anime Pressings ───────
        ("Tiger Lab Vinyl", "Samurai Champloo: Music Record: Masta", "Samurai Champloo", "US Pressing", "Black", "mid", 38),
        ...
        ("Aniplex", "Fate/Zero OST (2LP)", "Fate/Zero", "Japanese Pressing", "Black", "high", 75),
        ("Aniplex", "Madoka Magica OST (2LP)", "Puella Magi Madoka Magica", "Japanese Pressing", "Pink Marble", "grail", 100),
        ("Crunchyroll Vinyl", "Jujutsu Kaisen S1 OST (2LP)", "Jujutsu Kaisen", "US Pressing", "Black", "mid", 40),
        ("Crunchyroll Vinyl", "Jujutsu Kaisen S1 OST (2LP)", "Jujutsu Kaisen", "Limited", "Purple Splatter", "high", 80),
        ("Crunchyroll Vinyl", "Chainsaw Man OST (2LP)", "Chainsaw Man", "US Pressing", "Black", "mid", 42),
        ("Crunchyroll Vinyl", "Chainsaw Man OST (2LP)", "Chainsaw Man", "Limited", "Blood Red Splatter", "high", 85),
        ("Crunchyroll Vinyl", "Spy x Family OST (2LP)", "Spy x Family", "US Pressing", "Black", "mid", 38),
        ("Crunchyroll Vinyl", "Spy x Family OST (2LP)", "Spy x Family", "Limited", "Pink/White Split", "high", 75),
        ("King Records", "Dragon Ball Z: Complete Song Collection (3LP)", "Dragon Ball Z", "Japanese Pressing", "Black", "grail", 120),
        ("King Records", "Sailor Moon Complete Vocal Collection (3LP)", "Sailor Moon", "Japanese Pressing", "Pink", "grail", 130),
        ("King Records", "Yu Yu Hakusho OST (2LP)", "Yu Yu Hakusho", "Japanese Pressing", "Black", "high", 80),
        ("Flying Dog", "Macross Frontier Vocal Collection (2LP)", "Macross Frontier", "Japanese Pressing", "Crystal Clear", "high", 85),
        ("Lantis", "Love Live! School Idol Project Best (2LP)", "Love Live!", "Japanese Pressing", "Multicolor", "high", 70),
        ("Pony Canyon", "Bocchi the Rock! OST (LP)", "Bocchi the Rock!", "Japanese Pressing", "Pink", "high", 65),
        ("Pony Canyon", "Oshi no Ko OST (LP)", "Oshi no Ko", "Japanese Pressing", "Star Purple", "high", 70),

        # ── More iam8bit / Fangamer ───────────────────────────────────────
        ("iam8bit", "Final Fantasy VI OST (3LP)", "Final Fantasy VI", "Standard", "Black", "high", 55),
        ("iam8bit", "Final Fantasy VI OST (3LP)", "Final Fantasy VI", "Limited", "Esper Blue Splatter", "grail", 120),
        ("iam8bit", "Bloodborne OST (2LP)", "Bloodborne", "Standard", "Black", "mid", 40),
        ("iam8bit", "Bloodborne OST (2LP)", "Bloodborne", "Limited", "Blood Red", "high", 85),
        ("iam8bit", "Horizon Zero Dawn OST (4LP Box)", "Horizon Zero Dawn", "Standard", "Black", "high", 60),
        ("iam8bit", "Horizon Zero Dawn OST (4LP Box)", "Horizon Zero Dawn", "Limited", "Forest Green Marble", "grail", 120),
        ("iam8bit", "Ghost of Tsushima OST (3LP)", "Ghost of Tsushima", "Standard", "Black", "high", 55),
        ("iam8bit", "Ghost of Tsushima OST (3LP)", "Ghost of Tsushima", "Limited", "Samurai Red", "grail", 110),
        ("Fangamer", "Shovel Knight OST (2LP)", "Shovel Knight", "Standard", "Black", "mid", 32),
        ("Fangamer", "Shovel Knight OST (2LP)", "Shovel Knight", "Limited", "Gold/Blue Split", "high", 70),
        ("Fangamer", "Hyper Light Drifter OST (2LP)", "Hyper Light Drifter", "Standard", "Black", "mid", 35),
        ("Fangamer", "Hyper Light Drifter OST (2LP)", "Hyper Light Drifter", "Limited", "Neon Pink/Blue", "high", 80),
        ("Fangamer", "Katana ZERO OST", "Katana ZERO", "Standard", "Black", "mid", 30),
        ("Fangamer", "Katana ZERO OST", "Katana ZERO", "Limited", "Splatter", "high", 65),
        ("Fangamer", "Chicory: A Colorful Tale OST (2LP)", "Chicory", "Standard", "Black", "mid", 30),

        # ── More Mondo Anime & Game ───────────────────────────────────────
        ("Mondo", "My Neighbor Totoro OST (Joe Hisaishi)", "My Neighbor Totoro", "US Pressing", "Green", "high", 60),
        ("Mondo", "Spirited Away OST (Joe Hisaishi) (2LP)", "Spirited Away", "US Pressing", "Blue", "high", 65),
        ("Mondo", "Princess Mononoke OST (Joe Hisaishi) (2LP)", "Princess Mononoke", "US Pressing", "Forest Green", "high", 60),
        ("Mondo", "Nausicaa OST (Joe Hisaishi)", "Nausicaa", "US Pressing", "Sky Blue", "high", 65),
        ("Mondo", "Neon Genesis Evangelion OST (2LP)", "Evangelion", "US Pressing", "Black", "high", 50),
        ("Mondo", "Neon Genesis Evangelion OST (2LP)", "Evangelion", "Limited", "Eva Unit-01 Purple/Green", "grail", 110),
        ("Mondo", "Resident Evil 2 OST (2LP)", "Resident Evil 2", "Standard", "Black", "mid", 40),
        ("Mondo", "Resident Evil 2 OST (2LP)", "Resident Evil 2", "Limited", "Blood Splatter Clear", "high", 90),
        ("Mondo", "Doom 2016 OST (3LP)", "Doom", "Standard", "Black", "high", 55),
        ("Mondo", "Doom 2016 OST (3LP)", "Doom", "Limited", "Demon Red", "grail", 110),
        ("Mondo", "Zelda: Breath of the Wild OST (5LP Box)", "Zelda: BotW", "Standard", "Black", "grail", 120),
        ("Mondo", "Zelda: Breath of the Wild OST (5LP Box)", "Zelda: BotW", "Limited", "Champion Blue", "grail", 200),

        # ── More Ship to Shore ────────────────────────────────────────────
        ("Ship to Shore", "Castlevania: Rondo of Blood OST", "Castlevania Rondo", "Standard", "Black", "mid", 32),
        ("Ship to Shore", "Castlevania: Rondo of Blood OST", "Castlevania Rondo", "Limited", "Blood Red", "high", 70),
        ("Ship to Shore", "Mega Man X OST (2LP)", "Mega Man X", "Standard", "Black", "mid", 35),
        ("Ship to Shore", "Mega Man X OST (2LP)", "Mega Man X", "Limited", "X-Blue Splatter", "high", 75),
        ("Ship to Shore", "Contra III: The Alien Wars OST", "Contra III", "Standard", "Black", "mid", 28),
        ("Ship to Shore", "Castlevania: Bloodlines OST", "Castlevania Bloodlines", "Standard", "Black", "mid", 30),
        ("Ship to Shore", "Castlevania: Bloodlines OST", "Castlevania Bloodlines", "Limited", "Crimson", "high", 65),
        ("Ship to Shore", "Life Force / Salamander OST", "Life Force", "Standard", "Black", "mid", 28),

        # ── More Black Screen Records ─────────────────────────────────────
        ("Black Screen Records", "Slay the Spire OST (2LP)", "Slay the Spire", "Standard", "Black", "mid", 35),
        ("Black Screen Records", "Slay the Spire OST (2LP)", "Slay the Spire", "Limited", "Card Crimson", "high", 75),
        ("Black Screen Records", "Baldur's Gate 3 OST (3LP)", "Baldur's Gate 3", "Standard", "Black", "high", 55),
        ("Black Screen Records", "Baldur's Gate 3 OST (3LP)", "Baldur's Gate 3", "Limited", "Mindflayer Purple", "grail", 110),
        ("Black Screen Records", "Into the Breach OST", "Into the Breach", "Standard", "Black", "mid", 28),
        ("Black Screen Records", "Inscryption OST (2LP)", "Inscryption", "Standard", "Black", "mid", 35),
        ("Black Screen Records", "Inscryption OST (2LP)", "Inscryption", "Limited", "Forest Green", "high", 75),
        ("Black Screen Records", "Dead Cells OST (2LP)", "Dead Cells", "Standard", "Black", "mid", 35),
        ("Black Screen Records", "Dead Cells OST (2LP)", "Dead Cells", "Limited", "Toxic Green Splatter", "high", 80),
        ("Black Screen Records", "Hades II OST (2LP)", "Hades II", "Standard", "Black", "mid", 40),
        ("Black Screen Records", "Tunic OST (2LP)", "Tunic", "Standard", "Black", "mid", 32),
        ("Black Screen Records", "Tunic OST (2LP)", "Tunic", "Limited", "Crystal Clear", "high", 70),

        # ── More Japanese Label Anime Vinyl ───────────────────────────────
        ("Nippon Columbia", "Galaxy Express 999 OST (2LP)", "Galaxy Express 999", "Japanese Pressing", "Black", "high", 90),
        ("Nippon Columbia", "Space Battleship Yamato OST (2LP)", "Space Battleship Yamato", "Japanese Pressing", "Black", "high", 85),
        ("Nippon Columbia", "Captain Harlock OST", "Captain Harlock", "Japanese Pressing", "Black", "high", 75),
        ("King Records", "Fist of the North Star Complete Vocal (2LP)", "Fist of the North Star", "Japanese Pressing", "Black", "high", 80),
        ("King Records", "Saint Seiya OST (2LP)", "Saint Seiya", "Japanese Pressing", "Black", "high", 75),
        ("King Records", "City Hunter OST Get Wild Collection (2LP)", "City Hunter", "Japanese Pressing", "Black", "high", 80),
        ("King Records", "Lupin III '79 TV OST (2LP)", "Lupin III", "Japanese Pressing", "Black", "high", 85),
        ("Flying Dog", "Macross Do You Remember Love Soundtrack (2LP)", "Macross DYRL", "Japanese Pressing", "Black", "grail", 120),
        ("Tokuma Japan", "My Neighbor Totoro Image Album (OG 1988)", "My Neighbor Totoro", "Japanese OG Pressing", "Black", "grail", 150),
        ("Tokuma Japan", "Castle in the Sky OST (OG 1986)", "Castle in the Sky", "Japanese OG Pressing", "Black", "grail", 140),
        ("Tokuma Japan", "Kiki's Delivery Service OST (OG 1989)", "Kiki's Delivery Service", "Japanese OG Pressing", "Black", "grail", 130),
        ("Victor Entertainment", "Bubblegum Crisis OST (2LP)", "Bubblegum Crisis", "Japanese Pressing", "Black", "high", 90),
        ("Victor Entertainment", "Gunbuster OST", "Gunbuster", "Japanese Pressing", "Black", "high", 80),
        ("Columbia", "Urusei Yatsura OST (2LP)", "Urusei Yatsura", "Japanese Pressing", "Black", "high", 85),

        # ── More Square Enix / Atlus Game Vinyl ───────────────────────────
        ("Square Enix", "Final Fantasy X OST (4LP Box)", "Final Fantasy X", "Japanese Pressing", "Black", "grail", 180),
        ("Square Enix", "Final Fantasy IX OST (4LP Box)", "Final Fantasy IX", "Japanese Pressing", "Black", "grail", 170),
        ("Square Enix", "Chrono Trigger OST (3LP)", "Chrono Trigger", "Japanese Pressing", "Black", "grail", 150),
        ("Square Enix", "Chrono Cross OST (3LP)", "Chrono Cross", "Japanese Pressing", "Black", "grail", 140),
        ("Square Enix", "Kingdom Hearts OST (3LP)", "Kingdom Hearts", "Japanese Pressing", "Black", "high", 90),
        ("Atlus", "Persona 4 OST (3LP)", "Persona 4", "Japanese Pressing", "Yellow", "high", 80),
        ("Atlus", "Persona 5 Royal OST (3LP)", "Persona 5 Royal", "Japanese Pressing", "Red", "high", 85),
        ("Atlus", "Catherine Full Body OST (2LP)", "Catherine", "Japanese Pressing", "Black", "high", 65),
        ("Atlus", "Shin Megami Tensei V OST (2LP)", "SMT V", "Japanese Pressing", "Black", "high", 70),
        ("Square Enix", "NieR: Automata Arranged & Unreleased (2LP)", "NieR: Automata", "Japanese Pressing", "White", "high", 80),

        # ── More Convention / RSD Exclusive Pressings ─────────────────────
        ("Convention Exclusive", "Akira OST (Anime NYC 2024 LE)", "Akira", "Event Exclusive", "Neo Tokyo Neon Splatter", "grail", 130),
        ("Convention Exclusive", "Dragon Ball Z OST (SDCC 2024 LE)", "Dragon Ball Z", "Event Exclusive", "Saiyan Gold", "grail", 120),
        ("Convention Exclusive", "Evangelion OST (Anime Expo 2024 LE)", "Evangelion", "Event Exclusive", "Eva-01 Purple", "grail", 120),
        ("RSD Exclusive", "Cowboy Bebop OST (RSD 2024)", "Cowboy Bebop", "RSD 2024", "Amber Translucent", "high", 80),
        ("RSD Exclusive", "Samurai Champloo Way of the Samurai (RSD 2024)", "Samurai Champloo", "RSD 2024", "Cherry Blossom Pink", "high", 85),
        ("RSD Exclusive", "Spirited Away OST (RSD 2023)", "Spirited Away", "RSD 2023", "Spirit Blue", "high", 90),
        ("RSD Exclusive", "My Neighbor Totoro Image Album (RSD 2024)", "My Neighbor Totoro", "RSD 2024", "Forest Green", "high", 80),
        ("Numbered LE", "Ghost in the Shell SAC OST (Numbered /1000)", "Ghost in the Shell SAC", "Numbered", "Clear Blue", "grail", 120),
        ("Numbered LE", "FLCL OST Vol. 1 (The Pillows, Numbered /2000)", "FLCL", "Numbered", "Orange Crush", "high", 90),
        ("Numbered LE", "Trigun Stampede OST (Numbered /1500)", "Trigun Stampede", "Numbered", "Desert Tan", "high", 75),

        # ── More Anime-Specific Color Pressings ──────────────────────────
        ("Crunchyroll Vinyl", "Solo Leveling OST (2LP)", "Solo Leveling", "US Pressing", "Black", "mid", 40),
        ("Crunchyroll Vinyl", "Solo Leveling OST (2LP)", "Solo Leveling", "Limited", "Shadow Purple", "high", 80),
        ("Crunchyroll Vinyl", "Frieren OST (2LP)", "Frieren: Beyond Journey's End", "US Pressing", "Black", "mid", 38),
        ("Crunchyroll Vinyl", "Frieren OST (2LP)", "Frieren: Beyond Journey's End", "Limited", "Magic Blue", "high", 78),
        ("Crunchyroll Vinyl", "Dandadan OST (LP)", "Dandadan", "US Pressing", "Black", "mid", 35),
        ("Crunchyroll Vinyl", "Dandadan OST (LP)", "Dandadan", "Limited", "Turbo Granny Green", "high", 70),
        ("Crunchyroll Vinyl", "Blue Lock OST (2LP)", "Blue Lock", "US Pressing", "Black", "mid", 38),
        ("Crunchyroll Vinyl", "Blue Lock OST (2LP)", "Blue Lock", "Limited", "Goal Blue Marble", "high", 75),
        ("Aniplex", "Bocchi the Rock! OST (LP)", "Bocchi the Rock!", "Japanese Pressing", "Pink Marble", "high", 70),
        ("Aniplex", "Lycoris Recoil OST (LP)", "Lycoris Recoil", "Japanese Pressing", "Black", "mid", 45),
        ("Aniplex", "Kaguya-sama OST (LP)", "Kaguya-sama: Love Is War", "Japanese Pressing", "Pink", "mid", 50),
        ("Lantis", "Mobile Suit Gundam SEED OST (2LP)", "Gundam SEED", "Japanese Pressing", "Black", "high", 75),

        # ── Glow-in-Dark / Splatter / Clear Special Editions ──────────────
        ("Special Edition", "Evangelion Finally (Glow-in-Dark 2LP)", "Evangelion", "Limited", "Glow-in-Dark Green", "grail", 130),
        ("Special Edition", "Dragon Ball Z (Glow-in-Dark Frieza LP)", "Dragon Ball Z", "Limited", "Glow-in-Dark Purple", "grail", 110),
        ("Special Edition", "Sailor Moon OST (Pink Glitter LP)", "Sailor Moon", "Limited", "Pink Glitter", "grail", 120),
        ("Special Edition", "Jujutsu Kaisen OST (Clear/Purple Splatter 2LP)", "Jujutsu Kaisen", "Limited", "Clear Purple Splatter", "high", 90),
        ("Special Edition", "One Piece OST (Straw Hat Gold 2LP)", "One Piece", "Limited", "Gold Marble", "high", 85),
        ("Special Edition", "Demon Slayer OST (Water Breathing Blue Clear LP)", "Demon Slayer", "Limited", "Water Blue Clear", "high", 80),
        ("Special Edition", "Chainsaw Man OST (Blood Splatter Red/Black LP)", "Chainsaw Man", "Limited", "Blood Red/Black Splatter", "high", 85),
