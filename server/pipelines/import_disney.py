...
def _wave2_expansion() -> list[dict]:
    ...
    variants = [
        ...
        # ── Disney Infinity Figures (~20) ─────────────────────────────────
        ("infinity", "Disney Infinity 1.0 Sorcerer Mickey", "Standard", "mid", 35),
        ("infinity", "Disney Infinity 1.0 Jack Sparrow (Crystal)", "Crystal Variant", "high", 120),
        ("infinity", "Disney Infinity 1.0 Buzz Lightyear (Crystal)", "Crystal Variant", "high", 100),
        ("infinity", "Disney Infinity 1.0 Sulley (Crystal)", "Crystal Variant", "high", 90),
        ("infinity", "Disney Infinity 1.0 Elsa", "Standard", "mid", 30),
        ("infinity", "Disney Infinity 2.0 Maleficent", "Standard", "mid", 40),
        ("infinity", "Disney Infinity 2.0 Hiro", "Standard", "mid", 35),
        ("infinity", "Disney Infinity 2.0 Stitch", "Standard", "mid", 45),
        ("infinity", "Disney Infinity 2.0 Tinker Bell", "Standard", "mid", 35),
        ("infinity", "Disney Infinity 2.0 Donald Duck", "Standard", "standard", 25),
        ("infinity", "Disney Infinity 3.0 Boba Fett", "Standard", "mid", 50),
        ("infinity", "Disney Infinity 3.0 Darth Vader", "Standard", "mid", 40),
        ("infinity", "Disney Infinity 3.0 Spot (The Good Dinosaur)", "Standard", "mid", 60),
        ("infinity", "Disney Infinity 3.0 Nick Wilde", "Standard", "mid", 45),
        ("infinity", "Disney Infinity 3.0 Judy Hopps", "Standard", "mid", 40),
        ("infinity", "Disney Infinity 3.0 Olaf", "Standard", "standard", 28),
        ("infinity", "Disney Infinity 3.0 Peter Pan", "Standard", "mid", 55),
        ("infinity", "Disney Infinity 3.0 Alice", "Standard", "mid", 50),
        ("infinity", "Disney Infinity 3.0 Baloo", "Standard", "mid", 65),
        ("infinity", "Disney Infinity Complete Starter Pack 1.0 (Sealed)", "Sealed", "high", 120),

        # ── Jim Shore / Disney Traditions (~20) ───────────────────────────
        ("jim_shore", "Jim Shore Disney Traditions Mickey & Minnie Kissing", "Disney Traditions", "mid", 65),
        ("jim_shore", "Jim Shore Disney Traditions Cinderella Transformation", "Disney Traditions", "high", 90),
        ("jim_shore", "Jim Shore Disney Traditions The Little Mermaid (Ariel)", "Disney Traditions", "mid", 75),
        ("jim_shore", "Jim Shore Disney Traditions Beauty and the Beast (Dance)", "Disney Traditions", "high", 85),
        ("jim_shore", "Jim Shore Disney Traditions Stitch (Ohana)", "Disney Traditions", "mid", 55),
        ("jim_shore", "Jim Shore Disney Traditions Snow White (Deluxe)", "Disney Traditions", "high", 100),
        ("jim_shore", "Jim Shore Disney Traditions Sleeping Beauty (Aurora)", "Disney Traditions", "mid", 70),
        ("jim_shore", "Jim Shore Disney Traditions Rapunzel (Tower)", "Disney Traditions", "high", 95),
        ("jim_shore", "Jim Shore Disney Traditions Dumbo (Flying)", "Disney Traditions", "mid", 60),
        ("jim_shore", "Jim Shore Disney Traditions Maleficent (Dragon Form)", "Disney Traditions", "high", 120),
        ("jim_shore", "Jim Shore Disney Traditions Fantasia Sorcerer Mickey", "Disney Traditions", "high", 110),
        ("jim_shore", "Jim Shore Disney Traditions Bambi (Thumper, Flower Set)", "Disney Traditions", "mid", 65),
        ("jim_shore", "Jim Shore Disney Traditions Aladdin (Magic Carpet Ride)", "Disney Traditions", "high", 85),
        ("jim_shore", "Jim Shore Disney Traditions Mulan (Brave)", "Disney Traditions", "mid", 70),
        ("jim_shore", "Jim Shore Disney Traditions Peter Pan (Flight)", "Disney Traditions", "mid", 75),
        ("jim_shore", "Jim Shore Disney Traditions Alice in Wonderland", "Disney Traditions", "mid", 65),
        ("jim_shore", "Jim Shore Disney Traditions Pinocchio (Jiminy Cricket)", "Disney Traditions", "mid", 60),
        ("jim_shore", "Jim Shore Disney Traditions Lion King (Pride Rock)", "Disney Traditions", "high", 95),
        ("jim_shore", "Jim Shore Disney Traditions Winnie the Pooh (Honey Pot)", "Disney Traditions", "mid", 55),
        ("jim_shore", "Jim Shore Disney Traditions Moana (Voyager)", "Disney Traditions", "mid", 70),

        # ── Disney Doorables (~15) ────────────────────────────────────────
        ("doorables", "Disney Doorables Series 10 Super Rare (Elsa)", "Super Rare", "high", 80),
        ("doorables", "Disney Doorables Series 10 Super Rare (Rapunzel)", "Super Rare", "high", 75),
        ("doorables", "Disney Doorables Let's Go! Complete Playset", "Standard", "mid", 45),
        ("doorables", "Disney Doorables Villain Collection (Complete)", "Standard", "mid", 55),
        ("doorables", "Disney Doorables Multi Peek (8-Pack, Sealed)", "Sealed", "standard", 22),
        ("doorables", "Disney Doorables Grand Entrance Playset", "Standard", "mid", 40),
        ("doorables", "Disney Doorables Series 9 Mega Peek (24-Pack)", "Sealed", "mid", 50),
        ("doorables", "Disney Doorables Princess Collection (Complete 12)", "Standard", "mid", 60),
        ("doorables", "Disney Doorables Puffables Stitch", "Standard", "mid", 35),
        ("doorables", "Disney Doorables Puffables Mickey", "Standard", "standard", 28),
        ("doorables", "Disney Doorables Movie Moments (Frozen)", "Standard", "mid", 38),
        ("doorables", "Disney Doorables Collector Pack (50 Figures)", "Standard", "high", 90),
        ("doorables", "Disney Doorables Series 8 Ultra Rare (Sorcerer Mickey)", "Super Rare", "high", 100),
        ("doorables", "Disney Doorables Crystal Edition (Sealed Box)", "Crystal Variant", "high", 80),
        ("doorables", "Disney Doorables Tag-A-Longs (Surprise)", "Standard", "standard", 18),

        # ── Disney Squishmallows (~15) ────────────────────────────────────
        ("squishmallows", "Squishmallows Disney Stitch (12\")", "Standard", "mid", 35),
        ("squishmallows", "Squishmallows Disney Mickey Mouse (16\")", "Standard", "mid", 40),
        ("squishmallows", "Squishmallows Disney Winnie the Pooh (14\")", "Standard", "mid", 35),
        ("squishmallows", "Squishmallows Disney Jack Skellington (12\")", "Standard", "mid", 45),
        ("squishmallows", "Squishmallows Disney Oogie Boogie (12\")", "Standard", "mid", 40),
        ("squishmallows", "Squishmallows Disney Zero (10\")", "Standard", "mid", 38),
        ("squishmallows", "Squishmallows Disney Lotso (14\", Scented)", "Standard", "mid", 50),
        ("squishmallows", "Squishmallows Disney Sulley (16\")", "Standard", "mid", 40),
        ("squishmallows", "Squishmallows Disney Dumbo (10\")", "Standard", "standard", 28),
        ("squishmallows", "Squishmallows Disney Grogu (12\")", "Standard", "mid", 45),
        ("squishmallows", "Squishmallows Disney Simba (12\")", "Standard", "mid", 35),
        ("squishmallows", "Squishmallows Disney Tinker Bell (10\")", "Standard", "mid", 38),
        ("squishmallows", "Squishmallows Disney Ariel (12\")", "Standard", "mid", 35),
        ("squishmallows", "Squishmallows Disney Donald Duck (10\")", "Standard", "standard", 28),
        ("squishmallows", "Squishmallows Disney Cheshire Cat (12\")", "Standard", "mid", 42),

        # ── Loungefly Disney Bags (~20) ───────────────────────────────────
        ("loungefly", "Loungefly Disney Villains Scenes Mini Backpack", "Standard", "mid", 70),
        ("loungefly", "Loungefly Disney Haunted Mansion Mini Backpack", "Standard", "mid", 75),
        ("loungefly", "Loungefly Disney Little Mermaid Sequin Mini Backpack", "Standard", "mid", 65),
        ("loungefly", "Loungefly Disney Sleeping Beauty Castle Mini Backpack", "Standard", "mid", 70),
        ("loungefly", "Loungefly Disney Stitch (Pineapple) Mini Backpack", "Standard", "mid", 60),
        ("loungefly", "Loungefly Disney Peter Pan Clock Mini Backpack", "Standard", "mid", 65),
        ("loungefly", "Loungefly Disney Princess Books Mini Backpack", "Standard", "mid", 70),
        ("loungefly", "Loungefly NBC Jack & Sally (Glow) Mini Backpack", "Standard", "mid", 75),
        ("loungefly", "Loungefly Disney Mickey Rainbow Mini Backpack", "Standard", "mid", 55),
        ("loungefly", "Loungefly Disney Rapunzel Swing Mini Backpack", "Standard", "mid", 68),
        ("loungefly", "Loungefly Disney Fantasia Sorcerer Mickey Mini Backpack", "Standard", "mid", 72),
        ("loungefly", "Loungefly Disney Alice in Wonderland Mini Backpack", "Standard", "mid", 65),
        ("loungefly", "Loungefly Disney Pocahontas Mini Backpack", "Standard", "mid", 60),
        ("loungefly", "Loungefly Disney Winnie the Pooh (Bee) Mini Backpack", "Standard", "mid", 58),
        ("loungefly", "Loungefly Disney Coco Guitar Mini Backpack", "Standard", "mid", 65),
        ("loungefly", "Loungefly Disney Snow White Evil Queen Mini Backpack", "Standard", "mid", 70),
        ("loungefly", "Loungefly Disney Bambi Mini Backpack", "Standard", "mid", 55),
        ("loungefly", "Loungefly Disney Dumbo (Timothy) Mini Backpack", "Standard", "mid", 55),
        ("loungefly", "Loungefly Disney Hocus Pocus Mini Backpack", "Standard", "mid", 75),
        ("loungefly", "Loungefly Disney 100 Anniversary Mini Backpack", "D100 LE", "high", 95),

        # ── D23 Exclusives (~10) ──────────────────────────────────────────
        ("d23", "D23 Expo 2024 Mickey & Minnie Figurine Set", "D23 Expo", "high", 150),
        ("d23", "D23 Gold Member Exclusive Sorcerer Mickey Pin", "D23 Gold", "grail", 200),
        ("d23", "D23 Expo 2024 Exclusive Stitch Plush", "D23 Expo", "high", 100),
        ("d23", "D23 Expo 2024 Disney Villains Art Print (Signed)", "Signed Print", "grail", 250),
        ("d23", "D23 Expo 2024 Fantasia Cel Reproduction", "Limited Print", "high", 180),
        ("d23", "D23 Expo 2024 Imagineering Pin Set (LE 500)", "LE 500", "grail", 300),
        ("d23", "D23 Gold Member Exclusive Walt & Mickey Statue", "D23 Gold", "grail", 350),
        ("d23", "D23 Expo 2024 Princess Designer Doll Set", "D23 Expo", "grail", 280),
        ("d23", "D23 Expo 2024 Haunted Mansion Ghost Host Bust", "D23 Expo", "high", 150),
        ("d23", "D23 Expo 2024 Cars Land Exclusive Pin Board", "D23 Expo", "high", 120),

        # ── WDCC (Walt Disney Classics Collection) (~15) ──────────────────
        ("wdcc", "WDCC Cinderella (A Lovely Dress for Cinderelly)", "WDCC", "high", 180),
        ("wdcc", "WDCC Snow White (The Fairest One of All)", "WDCC", "high", 200),
        ("wdcc", "WDCC Pinocchio (Jiminy Cricket, Give a Little Whistle)", "WDCC", "high", 150),
        ("wdcc", "WDCC Bambi (Bambi & Thumper)", "WDCC", "high", 160),
        ("wdcc", "WDCC The Little Mermaid (Ariel, Part of Your World)", "WDCC", "grail", 250),
        ("wdcc", "WDCC Peter Pan (Off to Neverland)", "WDCC", "high", 180),
        ("wdcc", "WDCC Fantasia Sorcerer Mickey (Summoning the Stars)", "WDCC", "grail", 300),
        ("wdcc", "WDCC Alice in Wonderland (Curiouser and Curiouser)", "WDCC", "high", 170),
        ("wdcc", "WDCC Lion King (Simba & Nala, Circle of Life)", "WDCC", "high", 190),
        ("wdcc", "WDCC Lady and the Tramp (Spaghetti Scene)", "WDCC", "grail", 280),
        ("wdcc", "WDCC Beauty and the Beast (Tale as Old as Time)", "WDCC", "grail", 260),
        ("wdcc", "WDCC Dumbo (When I See an Elephant Fly)", "WDCC", "high", 150),
        ("wdcc", "WDCC Sleeping Beauty (Aurora & Philip)", "WDCC", "high", 180),
        ("wdcc", "WDCC Aladdin (A Whole New World)", "WDCC", "high", 190),
        ("wdcc", "WDCC Maleficent (Now You Shall Deal With Me)", "WDCC", "grail", 350),

        # ── Enchanted Collection & Ornaments (~15) ────────────────────────
        ("enchanted", "Disney Enchanted Collection Cinderella Glass Slipper", "Enchanted", "high", 120),
        ("enchanted", "Disney Enchanted Collection Ariel Seashell Pendant", "Enchanted", "high", 110),
        ("enchanted", "Disney Enchanted Collection Belle Rose Dome", "Enchanted", "high", 130),
        ("enchanted", "Disney Enchanted Collection Rapunzel Lantern", "Enchanted", "high", 100),
        ("enchanted", "Disney Enchanted Collection Snow White Apple", "Enchanted", "mid", 75),
        ("ornaments", "Hallmark Disney Cinderella Castle Ornament 2025", "Hallmark Exclusive", "mid", 50),
        ("ornaments", "Hallmark Disney Mickey Mouse 100th Ornament", "Hallmark Exclusive", "mid", 45),
        ("ornaments", "Hallmark Disney Nightmare Before Christmas Set", "Hallmark Exclusive", "mid", 55),
        ("ornaments", "Swarovski Disney Cinderella Crystal Figurine", "Swarovski LE", "grail", 400),
        ("ornaments", "Swarovski Disney Mickey Mouse Crystal (2025)", "Swarovski LE", "grail", 350),
        ("ornaments", "Disney100 Platinum Ornament Set (12)", "D100 LE", "high", 180),
        ("ornaments", "Disney Parks Haunted Mansion Holiday Ornament Set", "Park Exclusive", "high", 85),
        ("ornaments", "Disney Parks Glass Blown Cinderella Castle Ornament", "Park Exclusive", "high", 120),
        ("ornaments", "Disney Store Mickey & Friends Advent Ornament Calendar", "Store Exclusive", "mid", 65),
        ("ornaments", "Disney100 Celebration Musical Snow Globe", "D100 LE", "high", 150),

        # ── Kingdom Hearts Merch (~15) ────────────────────────────────────
        ("kingdom_hearts", "Kingdom Hearts Sora Play Arts Kai", "Standard", "high", 120),
        ("kingdom_hearts", "Kingdom Hearts Riku Play Arts Kai", "Standard", "high", 110),
        ("kingdom_hearts", "Kingdom Hearts Keyblade Replica (Kingdom Key)", "Standard", "mid", 75),
        ("kingdom_hearts", "Kingdom Hearts Keyblade Replica (Oathkeeper)", "Standard", "mid", 80),
        ("kingdom_hearts", "Kingdom Hearts Keyblade Replica (Oblivion)", "Standard", "mid", 80),
        ("kingdom_hearts", "Kingdom Hearts III Sora Bring Arts", "Standard", "high", 90),
        ("kingdom_hearts", "Kingdom Hearts King Mickey Nendoroid", "Standard", "mid", 55),
        ("kingdom_hearts", "Kingdom Hearts Sora Nendoroid", "Standard", "mid", 50),
        ("kingdom_hearts", "Kingdom Hearts Roxas Nendoroid", "Standard", "mid", 55),
        ("kingdom_hearts", "Kingdom Hearts Aqua Nendoroid", "Standard", "mid", 60),
        ("kingdom_hearts", "Kingdom Hearts Organization XIII Cloak Replica", "Standard", "high", 100),
        ("kingdom_hearts", "Kingdom Hearts Trading Card Game Booster Box", "Sealed", "mid", 50),
        ("kingdom_hearts", "Kingdom Hearts 20th Anniversary Vinyl LP", "Limited", "high", 120),
        ("kingdom_hearts", "Kingdom Hearts III Deluxe Edition (Sealed)", "Sealed", "mid", 75),
        ("kingdom_hearts", "Kingdom Hearts Artbook & Poster Collection", "Standard", "mid", 45),

        # ── Disney Designer Dolls & Misc (~15) ───────────────────────────
        ("designer", "Disney Designer Princess Collection Ariel Doll (LE)", "LE 6000", "high", 180),
        ("designer", "Disney Designer Princess Collection Belle Doll (LE)", "LE 6000", "high", 180),
        ("designer", "Disney Designer Princess Collection Rapunzel Doll (LE)", "LE 6000", "high", 170),
        ("designer", "Disney Designer Villains Collection Maleficent Doll (LE)", "LE 5000", "grail", 220),
        ("designer", "Disney Designer Villains Collection Ursula Doll (LE)", "LE 5000", "grail", 210),
        ("designer", "Disney Designer Couples Collection Ariel & Eric (LE)", "LE 6000", "grail", 300),
        ("designer", "Disney Limited Edition Elsa Doll (17\", LE 5000)", "LE 5000", "high", 150),
        ("designer", "Disney Limited Edition Anna Doll (17\", LE 5000)", "LE 5000", "high", 140),
        ("designer", "Disney Limited Edition Moana Doll (17\", LE 5500)", "LE 5500", "high", 130),
        ("designer", "Disney Limited Edition Tiana Doll (17\", LE 5000)", "LE 5000", "high", 160),
        ("vintage", "Vintage Mickey Mouse Watch (1933 Ingersoll)", "Vintage", "grail", 800),
        ("vintage", "Disneyland Opening Day Map Reproduction", "Vintage", "high", 120),
        ("vintage", "Walt Disney World 1971 Opening Year Program", "Vintage", "grail", 500),
        ("vintage", "Vintage Disneyland Silk Map (1958)", "Vintage", "grail", 600),
        ("vintage", "Disney Store 1990s Mickey Bean Bag (Complete Set 12)", "Vintage", "high", 100),
    ]
