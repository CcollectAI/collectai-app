...
def _render_html_report(data: InsuranceReportData) -> str:
    ...
    user_display = data.user_name or data.user_email or "Sparrow Collect User"
...
<body>
    <div class="header">
        <div class="logo-text">Sparrow Collect</div>
    ...
    <div class="footer">
        <p>Generated by Sparrow Collect &middot; {gen_date}</p>
    ...
    try:
        async with pool.acquire() as conn:
            ...
            data = InsuranceReportData(
                ...
                currency=currency,
                methodology=(
                    "Values are estimated using Sparrow Collect's pricing algorithm, which analyzes "
