...
class TestErrorResponseModel:
    ...
    def test_custom_code(self):
        resp = ErrorResponse(message="Not found", code="ITEM_NOT_FOUND")
    ...
    def test_custom_request_id(self):
        resp = ErrorResponse(message="fail", request_id="abc123")
        assert resp.request_id == "abc123"

    def test_serialization(self):
        resp = ErrorResponse(message="bad input", code="VALIDATION_ERROR", request_id="req-42")
