...
function DataProcessingScreenInner() {
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['left', 'right']}>
      ...
      <ScreenHeader title="Data Processing Agreement" showActions={!!user} />
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={[styles.body, { color: colors.text }]}>
          <Text style={styles.bold}>Collection Data:</Text> Item titles, descriptions, categories, valuations, condition grades, category-specific attributes, and curated catalog items used for matching and identification.{'\n\n'}
          ...
          <Text style={styles.bold}>Marketplace Data:</Text> Aggregated pricing, availability, and listing data from third-party marketplace sources used for price estimates, deal detection, and market analysis.{'\n\n'}
        ...
        <Text style={[styles.body, { color: colors.text }]}>
          ...
          <Text style={styles.bold}>Catalog Aggregation:</Text> Our catalog contains curated items across every supported category, priced from market data observed on public marketplace sources. Catalog data is public reference information and does not contain personal data.{'\n\n'}
